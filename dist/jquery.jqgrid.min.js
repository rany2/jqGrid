...
k=this.$tdInput;void 0!==h.buildSelect?(a=h.buildSelect.call(c,a,f,e,g))&&k.append(a):k.append(a);f=k.children("select");f.attr({name:e.index||e.name,id:x(e.name)});h.attr&&f.attr(h.attr);f.addClass(A);f.css({width:"100%"});0===f.find("option[value='']").length&&"string"===typeof d.noFilterText&&(a=document.createElement("option"),a.value="",a.innerHTML=d.noFilterText,f.prepend(a),null!=b(f[0].options[f[0].selectedIndex]).attr("selected")||f[0].multiple||(f[0].selectedIndex=0));void 0!==h.defaultValue&&
f.val(h.defaultValue);t.bindEv.call(c,f[0],h);t.fullBoolFeedback.call(c,h.selectFilled,"jqGridSelectFilled",{elem:f[0],options:h,cm:e,cmName:e.name,iCol:g,mode:"filter"});!0===l.autosearch&&f.change(function(){z();return!1})}},t.ajaxOptions,g.ajaxSelectOptions||{}));else{var S,fa,ca;this.searchoptions?(S=void 0===w.value?H.value||"":w.value,fa=void 0===w.separator?H.separator||":":w.separator,ca=void 0===w.delimiter?H.delimiter||";":w.delimiter):this.editoptions&&(S=void 0===H.value?"":H.value,fa=
void 0===H.separator?":":H.separator,ca=void 0===H.delimiter?";":H.delimiter);S&&(e=document.createElement("select"),e.style.width="100%",w=b(e).attr({name:this.index||this.name,role:"search",id:x(this.name),"aria-describedby":g.id+"_"+this.name}),d.attr&&w.attr(d.attr),t.fillSelectOptions(e,S,fa,ca,null!=d.attr&&d.attr.multiple)||"string"!==typeof d.noFilterText||(S=document.createElement("option"),S.value="",S.innerHTML=d.noFilterText,S.selected=!0,w.prepend(S)),void 0!==d.defaultValue&&w.val(d.defaultValue),
w.addClass(A),K.push({elem:e,options:d}),Y.append(e),t.fullBoolFeedback.call(c,d.selectFilled,"jqGridSelectFilled",{elem:e,options:this.searchoptions||H,cm:this,cmName:this.name,iCol:a,mode:"filter"}),!0===l.autosearch&&w.change(function(){z();return!1}))}break;case "text":w=b("<input role='search' type='text' class='"+A+"' name='"+(this.index||this.name)+"' id='"+x(this.name)+"' aria-labelledby='jqgh_"+g.id+"_"+this.name+"' value='"+(void 0!==d.defaultValue?d.defaultValue:"")+"'/>");Y.append(w);
d.attr&&w.attr(d.attr);K.push({elem:w[0],options:d});!0===l.autosearch&&(l.searchOnEnter?w.keypress(function(b){return 13===(b.charCode||b.keyCode||0)?(z(),!1):this}):w.keydown(function(b){switch(b.which){case 13:return!1;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:L&&clearTimeout(L),L=setTimeout(function(){z()},l.autosearchDelay)}}));break;case "custom":Y.append("<span style='width:100%;padding:0;box-sizing:border-box;' class='"+A+"' name='"+(this.index||this.name)+"' id='"+
x(this.name)+"'/>");try{if(b.isFunction(d.custom_element)){var O=d.custom_element.call(c,void 0!==d.defaultValue?d.defaultValue:"",d);if(O)O=b(O).addClass("customelement"),T.find("span[name='"+(this.index||this.name)+"']").append(O);else throw"e2";}else throw"e1";}catch(wa){"e1"===wa&&f.call(c,p,"function 'custom_element' "+r.nodefined,q),"e2"===wa?f.call(c,p,"function 'custom_element' "+r.novalue,q):f.call(c,p,"string"===typeof wa?wa:wa.message,q)}}}B.append(T);B.find(".ui-search-oper .soptclass,.ui-search-clear .clearsearchclass").hover(function(){b(this).addClass(u)},
