...
l.u);e.userLocalTime&&0===m&&(m-=(new Date).getTimezoneOffset(),0<m&&l.setTime(Number(Number(l)+6E4*m)));if(void 0===d)return l;e.masks.hasOwnProperty(d)?d=e.masks[d]:d||(d="Y-m-d");m=l.getHours();a=l.getMinutes();c=l.getDate();p=l.getMonth()+1;g=l.getTimezoneOffset();f=l.getSeconds();k=l.getMilliseconds();var q=l.getDay(),r=l.getFullYear(),u=(q+6)%7+1,A=(new Date(r,p-1,c)-new Date(r,0,1))/864E5,B=5>u?Math.floor((A+u-1)/7)+1:Math.floor((A+u-1)/7)||(4>((new Date(r-1,0,1)).getDay()+6)%7?53:52),v={d:n(c),
D:e.dayNames[q],j:c,l:e.dayNames[q+7],N:u,S:e.S(c),w:q,z:A,W:B,F:e.monthNames[p-1+12],m:n(p),M:e.monthNames[p-1],n:p,t:"?",L:"?",o:"?",Y:r,y:String(r).substring(2),a:12>m?e.AmPm[0]:e.AmPm[1],A:12>m?e.AmPm[2]:e.AmPm[3],B:"?",g:m%12||12,G:m,h:n(m%12||12),H:n(m),i:n(a),s:n(f),u:k,e:"?",I:"?",O:(0<g?"-":"+")+n(100*Math.floor(Math.abs(g)/60)+Math.abs(g)%60,4),P:"?",T:(String(l).match(/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[\-+]\d{4})?)\b/g)||
...
m.datatype&&!m.deselectAfterSort||m.multiPageSelection)x=!0;f&&(h*=f+1);for(f=0;f<Math.min(a,h);f++){u=c[f];A=d[f];B=null!=e?e[f]:A;p=1===g?0:g;q=1===(p+f)%2?C:"";x?m.multiselect?(r=-1!==b.inArray(u,m.selarrrow))&&null===m.selrow&&(m.selrow=u):r=u===m.selrow:r=!1;v=w.length;w.push("");for(p=0;p<m.colModel.length;p++)switch(E=m.colModel[p].name,E){case "rn":w.push(F(p,f,m.page,m.rowNum));break;case "cb":w.push(Q(u,p,f,r,A));break;case "subgrid":w.push(H.addSubGridCell.call(n,p,f+g,u,A));break;default:w.push(aa(u,
A[E],p,f+g,B,A))}m.grouping&&H.groupingPrepare&&!m.groupingView._locgr&&(H.groupingPrepare.call(n,A,f),b.isFunction(m.groupingView.groupCollapse)&&(z=m.groupingView.groupCollapse.call(l,{group:m.groupingView.groups[m.groupingView.groups.length-1],rowid:u,data:A})));w[v]=l.constructTr(u,z,q,A,B,r);w.push("</tr>");m.rowIndexes[u]=L;L++;m.grouping&&(y.push(w),w=[]);w.length>m.maxItemsToJoin&&(w=[w.join("")])}m.grouping&&H.groupingRender&&(k&&(m.groupingView._locgr=!0),w=[H.groupingRender.call(n,y,h)],
...
a.unshift(this.p);return t.feedback.apply(this,a)};b.fn.jqGrid=function(a){var c=b.fn.jqGrid,d;if("string"===typeof a){d=c[a];if(!d)throw"jqGrid - No such method: "+a;return d.apply(this,b.makeArray(arguments).slice(1))}return this.each(function(){if(!this.grid){var d=this,g,f,k=b(d),l=b.isFunction,m=b.isArray,n=b.extend,p=b.inArray,q=b.trim,r=b.each,u=c.setSelection,A=c.getGridRes,B=l(qa.fatalError)?qa.fatalError:alert,v=a.locale||qa.locale||"en-US",x=null!=ea[v]&&"boolean"===typeof ea[v].isRTL?
ea[v].isRTL?"rtl":"ltr":"ltr",w=a.iconSet||qa.iconSet||("bootstrap"===(a.guiStyle||qa.guiStyle)||"bootstrapPrimary"===(a.guiStyle||qa.guiStyle)?"glyph":"jQueryUI"),y=a.guiStyle||qa.guiStyle||"jQueryUI",C=function(b){return c.getIconRes.call(d,b)},z=function(b,a){return k.jqGrid("getGuiStyles",b,a)};null==a&&(a={datatype:"local"});void 0!==a.datastr&&m(a.datastr)&&(f=a.datastr,a.datastr=[]);void 0!==a.data&&(g=a.data,a.data=[]);null!=t.formatter&&null!=t.formatter.unused||B("CRITICAL ERROR!!!\n\n\nOne uses probably\n\n\t$.extend($.jgrid.defaults, {...});\n\nto set default settings of jqGrid instead of the usage the DEEP version of jQuery.extend (with true as the first parameter):\n\n\t$.extend(true, $.jgrid.defaults, {...});\n\nOne other possible reason:\n\nyou included some OLD version of language file (grid.locale-en.js for example) AFTER jquery.jqGrid.min.js. For example all language files of jqGrid 4.7.0 uses non-deep call of jQuery.extend.\n\n\nSome options of jqGrid could still work, but another one will be broken.");
...
t.search||{}),formViewing:n(!0,{commonIconClass:C("form.common"),prevIcon:C("form.prev"),nextIcon:C("form.next"),closeicon:[!0,"left",C("form.cancel")]},t.view||{}),formDeleting:n(!0,{commonIconClass:C("form.common"),delicon:[!0,"left",C("form.del")],cancelicon:[!0,"left",C("form.cancel")]},t.del||{})},a||{}),E=function(b){var a=t.getRes(h,b);return void 0!==a?a:A.call(k,"defaults."+b)};h.recordpos=h.recordpos||("rtl"===h.direction?"left":"right");h.subGridOptions.openicon="rtl"===h.direction?C("subgrid.openRtl"):
...
setTimeout(function(){G.populateVisible.call(d)},h.scrollTimeout))}G.hDiv.scrollLeft=this.scrollLeft;h.footerrow&&(G.sDiv.scrollLeft=this.scrollLeft);return!1},selectionPreserver:function(){var a=b(this),c=h.selrow,d=h.selarrrow?b.makeArray(h.selarrrow):null,e=this.grid.bDiv,g=e.scrollLeft,f=function(){var b;h.selrow=null;if(!h.multiPageSelection){V(h.selarrrow);if(h.multiselect&&d&&0<d.length)for(b=0;b<d.length;b++)d[b]!==c&&u.call(a,d[b],!1,null);c&&u.call(a,c,!1,null)}e.scrollLeft=g;a.off(".selectionPreserver",
f)};a.on("jqGridGridComplete.selectionPreserver",f)}};d.grid=G;N.call(d,"beforeInitGrid");h.iColByName=L(h.colModel);h.iPropByName=J(h.additionalProperties);var x=b("<div class='"+z("gView","ui-jqgrid-view")+"' role='grid' aria-multiselectable='"+!!h.multiselect+"'></div>"),v=t.msie,M;h.direction=q(h.direction.toLowerCase());-1===p(h.direction,["ltr","rtl"])&&(h.direction="ltr");M=h.direction;b(x).insertBefore(d);k.removeClass("scroll").appendTo(x);g=b("<div class='"+z("gBox","ui-jqgrid")+"'></div>");
b(g).attr({id:h.gBoxId,dir:M}).insertBefore(x);b(x).attr("id",h.gViewId).appendTo(g);b("<div class='"+z("overlay","jqgrid-overlay")+"' id='lui_"+h.id+"'></div>").insertBefore(x);b("<div class='"+z("loading","loading")+"' id='load_"+h.id+"'>"+E("loadtext")+"</div>").insertBefore(x);k.attr({role:"presentation","aria-labelledby":"gbox_"+d.id});var ga=function(b,a,c,e,g,f){var k=h.colModel[b],m=c,n=k.classes,p=k.align?"text-align:"+k.align+";":"",q,r=function(b){return"string"===typeof b?b.replace(/\'/g,
...
break;case "json":case "jsonp":case "jsonstring":r=h.jsonReader}var u,w,x,v,C,E={},z,A=h.colModel,H=A.length,B,J,ma,L,ka,Q=h.arrayReaderInfos,Ia={},ga=function(b){return function(a){a=null!=a&&l(a.getAttribute)?a.getAttribute(b):null;return null!==a?a:void 0}},qb=function(b){return function(){var a=Ia[b];if(null!=a)return a=a.childNodes,0<a.length?a[0].nodeValue:void 0}};h.page=F(y(a,r.page),h.page);h.lastpage=F(y(a,r.total),1);h.records=F(y(a,r.records));l(r.userdata)?h.userData=r.userdata.call(this,
...
c;l(c)||ia(a,c)};for(u=0;u<H;u++)sa(A[u]);H=M.length;for(u=0;u<H;u++)J=M[u],"object"===typeof J&&null!=J?sa(J):ia(J,J);v=!1===h.keyName?l(r.id)?r.id.call(this,a):r.id:h.keyName;isNaN(v)?l(v)||(Q[v]&&(C=Q[v].order),q&&("string"===typeof v&&/^\[\w+\]$/.test(v)?v=ga(v.substring(1,v.length-1)):"string"===typeof v&&/^\w+$/.test(v)&&(v=qb(v)))):C=Number(v);x=y(a,r.root,!0);if(r.row)if(1===x.length&&"string"===typeof r.row&&/^\w+$/.test(r.row)){H=[];ma=x[0].childNodes;L=ma.length;for(J=0;J<L;J++)ka=ma[J],
1===ka.nodeType&&ka.nodeName===r.row&&H.push(ka);x=H}else x=y(x,r.row,!0);null==x&&m(a)&&(x=a);x||(x=[]);a=x.length;0<a&&0>=h.page&&(h.page=1);sa=parseInt(h.rowNum,10);g&&(sa*=g+1);var A=[],pa=[],ja,H=[];for(u=0;u<a;u++){ja=x[u];w=r.repeatitems&&r.cell?y(ja,r.cell,!0)||ja:ja;z=r.repeatitems&&(q||m(w));E={};Ia={};if(q&&!z&&null!=w)for(ma=w.childNodes,L=ma.length,J=0;J<L;J++)ka=ma[J],1===ka.nodeType&&(Ia[ka.nodeName]=ka);for(B in Q)Q.hasOwnProperty(B)&&(J=Q[B],z?(ma=w[J.order],q&&null!=ma&&(ma=ma.textContent||
ma.text)):ma=null!=ca[B]&&"string"!==typeof ca[B]?ca[B](w):y(w,"string"===typeof ca[B]?ca[B]:J.name),1===J.type&&(J=M[J.index],null!=J&&l(J.convert)&&(ma=J.convert(ma,w))),void 0!==ma&&(E[B]=ma));void 0!==E[v]?ja=void 0!==E[v]?E[v]:ya():(ja=y(ja,m(ja)?C:v),void 0===ja&&(ja=y(w,m(w)?C:v)),void 0===ja&&(ja=ya()));void 0===E[v]&&(E[v]=ja);ja=String(ja);z=h.idPrefix+ja;h.treeGrid&&D(E);if(u<sa)pa.push(z),A.push(w),H.push(E);else if(!p)break;if(p||!0===h.treeGrid)E._id_=ja,h.data.push(E),h._index[E._id_]=
h.data.length-1}if(!p||!h.forceClientSorting||!0===h.treeGrid){d=t.parseDataToHtml.call(this,a,pa,H,A,d,g,p);rb(!0);g=-1<h.treeANode?h.treeANode:0;r=b(this.tBodies[0]);!0===h.treeGrid&&0<g?b(this.rows[g]).after(d.join("")):h.scroll?r.append(d.join("")):(null==this.firstElementChild||void 0!==document.documentMode&&9>=document.documentMode?r.html(r.html()+d.join("")):this.firstElementChild.innerHTML+=d.join(""),this.grid.cols=this.rows[0].cells);h.grouping&&aa.call(this);if(!0===h.subGrid)try{c.addSubGrid.call(f,
h.iColByName.subgrid)}catch(Cb){}if(!1===h.gridview||l(h.afterInsertRow))for(u=0;u<Math.min(a,sa);u++)N.call(this,"afterInsertRow",pa[u],H[u],A[u]);h.totaltime=new Date-k;0<u&&0===h.records&&(h.records=a);V(d);if(!0===h.treeGrid)try{c.setTreeNode.call(f,g+1,u+g+1)}catch(Cb){}h.reccount=Math.min(a,sa);h.treeANode=-1;h.userDataOnFooter&&c.footerData.call(f,"set",h.userData,!0);p&&(h.records=a,h.lastpage=Math.ceil(a/sa));e||this.updatepager(!1,!0);oa.call(this)}}},X=function(){function a(b){var c=0,
...
b.andNot().inSet},"in":function(b){return b.inSet},nu:function(b){return b.isNull},nn:function(b,a){return"OR"===a?b.orNot().isNull:b.andNot().isNull}},F=t.from.call(this,h.data);h.ignoreCase&&(F=F.ignoreCase());if(!0===h.search){var z=h.postData.filters;if(z)"string"===typeof z&&(z=b.parseJSON(z)),a(z);else try{var H=n[h.postData.searchField],F=E[h.postData.searchOper](F)(l(H.reader)?'jQuery.jgrid.getAccessor(this,jQuery("'+h.idSel+'")[0].p.colModel['+H.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+
H.reader+"')",h.postData.searchString,n[h.postData.searchField])}catch(Ib){}}if(h.grouping)for(v=0;v<x;v++)F.orderBy(q[v],w.groupOrder[v],p[v].stype,p[v].srcfmt);h.multiSort?r(e,function(){F.orderBy(this,g[this],n[this].stype,n[this].srcfmt,n[this].sfunc)}):e&&h.sortorder&&f&&F.orderBy(h.sortname,"DESC"===h.sortorder.toUpperCase()?"d":"a",n[e].stype,n[e].srcfmt,n[e].sfunc);h.lastSelectedData=F.select();var z=parseInt(h.rowNum,10),H=h.lastSelectedData.length,J=parseInt(h.page,10),G=Math.ceil(H/z),
L={};if(h.grouping&&h.groupingView._locgr){h.groupingView.groups=[];var ka,Q,ga;if(h.footerrow&&h.userDataOnFooter){for(Q in h.userData)h.userData.hasOwnProperty(Q)&&(h.userData[Q]=0);ga=!0}for(ka=0;ka<H;ka++){if(ga)for(Q in h.userData)h.userData.hasOwnProperty(Q)&&(h.userData[Q]+=parseFloat(h.lastSelectedData[ka][Q]||0));c.groupingPrepare.call(d,h.lastSelectedData[ka],ka,z)}}n=F=null;d=h.localReader;L[d.total]=G;L[d.page]=J;L[d.records]=H;L[d.root]=h.lastSelectedData.slice((J-1)*z,J*z);L[d.userdata]=
...
M+"' style='text-align:"+h.recordpos+"' class='ui-paging-info'></span>");var w=b("td"+a+"_"+h.pagerpos,n);w.append(l);f=O.call(this,w.children(".ui-pg-table"));h._nvtd=[];h._nvtd[0]=f?Math.floor((h.width-f)/2):Math.floor(h.width/3);h._nvtd[1]=0;l=null;b(".ui-pg-selbox",n).on("change",function(){var a=F(this.value,10),c=Math.round(h.rowNum*(h.page-1)/a-.5)+1;if(!u("records",c,a))return!1;h.page=c;h.rowNum=a;h.pager&&b(".ui-pg-selbox",h.pager).val(a);h.toppager&&b(".ui-pg-selbox",h.toppager).val(a);
...
0===b&&(p=n=!1,b=f-1);this.id==="first"+c&&l&&(e="first",a=1,k=!0);this.id==="prev"+c&&m&&(e="prev",a=b-1,k=!0);this.id==="next"+c&&n&&(e="next",a=b+1,k=!0);this.id==="last"+c&&p&&(e="last",a=f,k=!0);if(!u(e,a,F(h.rowNum,10)))return!1;h.page=a;k&&ba.call(d);return!1}));if(!0===h.pginput)b("input.ui-pg-input",n).on("keypress.jqGrid",function(a){a=a.charCode||a.keyCode||0;var c=F(b(this).val(),1);if(13===a){if(!u("user",c,F(h.rowNum,10)))return!1;b(this).val(c);h.page=0<b(this).val()?b(this).val():
...
h.colModel[c].hidden){a=c;break}return a-b},ca;-1===p(h.multikey,["shiftKey","altKey","ctrlKey"])&&(h.multikey=!1);h.keyName=!1;h.sortorder=h.sortorder.toLowerCase();t.cell_width=t.cellWidth();for(var pa=t.cmTemplate,w=0;w<h.colModel.length;w++)y=h.colModel[w],ca="string"===typeof y.template?null==pa||"object"!==typeof pa[y.template]&&!b.isFunction(pa[y.template])?{}:pa[y.template]:y.template,l(ca)&&(ca=ca.call(d,{cm:y,iCol:w})),y=n(!0,{},h.cmTemplate,ca||{},y),!1===h.keyName&&!0===y.key&&(h.keyName=
y.name),h.colModel[w]=y;for(w=0;w<h.additionalProperties.length;w++)y=h.additionalProperties[w],!1===h.keyName&&!0===y.key&&(h.keyName=y.name);if(0===h.colNames.length)for(w=0;w<h.colModel.length;w++)h.colNames[w]=void 0!==h.colModel[w].label?h.colModel[w].label:h.colModel[w].name;if(h.colNames.length!==h.colModel.length)B(A.call(k,"errors.model"));else{!0===h.grouping&&(h.scroll=!1,h.rownumbers=!1,h.treeGrid=!1,h.gridview=!0);if(h.subGrid)try{c.setSubGrid.call(k)}catch(Ia){}!h.multiselect||"left"!==
...
h.colModel.length-1;0<=w;w--)if(!0!==h.colModel[w].hidden){h.colModel[w].resizable=!1;break}var $a,Oa,Pa,la,P,L=[],J=[];la=[];ca="<thead><tr class='ui-jqgrid-labels' role='row'>";var pa="<tbody><tr style='display:none;'>",Ja=z("states.hover"),Fa=z("states.disabled");if(h.multiSort)for(L=h.sortname.split(","),w=0;w<L.length;w++)la=q(L[w]).split(" "),L[w]=q(la[0]),J[w]=la[1]?q(la[1]):h.sortorder||"asc";for(w=0;w<h.colNames.length;w++){y=h.colModel[w];q=h.headertitles||y.headerTitle?" title='"+ib("string"===
typeof y.headerTitle?y.headerTitle:h.colNames[w])+"'":"";ca+="<th id='"+h.id+"_"+y.name+"' class='"+z("colHeaders","ui-th-column ui-th-"+M+" "+(y.labelClasses||""))+"'"+q+">";q=y.index||y.name;switch(y.labelAlign){case "left":la="text-align:left;";break;case "right":la="text-align:right;"+(!1===y.sortable?"":"padding-right:"+h.autoResizing.widthOfVisiblePartOfSortIcon+"px;");break;case "likeData":la=void 0===y.align||"left"===y.align?"text-align:left;":"right"===y.align?"text-align:right;"+(!1===
y.sortable?"":"padding-right:"+h.autoResizing.widthOfVisiblePartOfSortIcon+"px;"):"";break;default:la=""}ca+="<div id='jqgh_"+h.id+"_"+y.name+"'"+(v?" class='ui-th-div-ie'":"")+(""===la?"":" style='"+la+"'")+" role='columnheader'>";la=y.autoResizable&&"actions"!==y.formatter?"<span class='"+h.autoResizing.wrapperClassName+"'>"+h.colNames[w]+"</span>":h.colNames[w];h.sortIconsBeforeText?(ca+=(h.builderSortIcons||t.builderSortIcons).call(d,w),ca+=la):(ca+=la,ca+=(h.builderSortIcons||t.builderSortIcons).call(d,
w));ca+="</div></th>";pa+="<td></td>";y.width=y.width?parseInt(y.width,10):150;"boolean"!==typeof y.title&&(y.title=!0);y.lso="";q===h.sortname&&(h.lastsort=w,y.lso=h.sortorder||y.firstsortorder||"asc");h.multiSort&&(la=p(q,L),-1!==la&&(y.lso=J[la]))}ca+="</tr></thead>";pa+="</tr></tbody>";w=b("<table class='"+z("hTable","ui-jqgrid-htable")+"' style='width:1px' role='presentation' aria-labelledby='gbox_"+h.id+"'>"+ca+pa+"</table>");b(w[0].tHead).children("tr").children("th").hover(function(){b(this).addClass(Ja)},
...
a*c+l,h.tblwidth>h.width&&(h.colModel[d].width-=h.tblwidth-parseInt(h.width,10),h.tblwidth=h.width))})();b(g).css("width",G.width+"px").append("<div class='"+z("resizer","ui-jqgrid-resize-mark")+"' id='"+h.rsId+"'>&#160;</div>");b(h.rs).on("selectstart",function(){return!1}).click(Q).dblclick(function(a){var e=b(this).data("idx"),g=b(this).data("pageX"),f=h.colModel[e];if(null==g||null==f)return!1;var g=String(g).split(";"),l=parseFloat(g[0]),m=parseFloat(g[1]);if(2===g.length&&(5<Math.abs(l-m)||
5<Math.abs(a.pageX-l)||5<Math.abs(a.pageX-m)))return!1;N.call(d,"resizeDblClick",e,f,a)&&f.autoResizable&&c.autoResizeColumn.call(k,e);N.call(d,"afterResizeDblClick",{iCol:e,cm:f,cmName:f.name});return!1});b(x).css("width",G.width+"px");var ab="";h.footerrow&&(ab+="<table role='presentation' style='width:1px' class='"+z("gridFooter","ui-jqgrid-ftable")+"'><tbody><tr role='row' class='"+z("rowFooter","footrow footrow-"+M)+"'>");var kb="<tr class='"+z("gridRow","jqgfirstrow ui-row-"+h.direction)+"' role='row' style='height:auto'>";
...
b(w[0].tHead.rows[0]))}catch(Ia){}h.footerrow&&(ab+="</tr></tbody></table>");kb+="</tr>";k.html("<tbody>"+kb+"</tbody>");k.addClass(z("grid","ui-jqgrid-btable"+(!0===h.altRows&&k.jqGrid("isBootstrapGuiStyle")?" table-striped":"")));var xa=h.caption&&!0===h.hiddengrid?!0:!1,x=b("<div class='ui-jqgrid-hbox"+("rtl"===M?"-rtl":"")+"'></div>"),q=z("top"),Ca=z("bottom");G.hDiv=document.createElement("div");b(G.hDiv).css({width:G.width+"px"}).addClass(z("hDiv","ui-jqgrid-hdiv")).append(x).scroll(function(){var a=
...
Ca)).appendTo(g),xa&&x.hide(),f.call(d,w,""),h.pager="#"+I(w)):h.pager="");if(!1===h.cellEdit&&!0===h.hoverrows)k.on("mouseover.jqGrid",function(a){P=b(a.target).closest("tr.jqgrow");"ui-subgrid"!==b(P).attr("class")&&b(P).addClass(Ja)}).on("mouseout.jqGrid",function(a){P=b(a.target).closest("tr.jqgrow");b(P).removeClass(Ja)});var ua,U,W,S=function(a){var c,d;do if(c=b(a).closest("td"),0<c.length){a=c.parent();d=a.parent().parent();if(a.is(".jqgrow")&&(d[0]===this||d.is("table.ui-jqgrid-btable")&&
(d[0].id||"").replace("_frozen","")===this.id))break;a=c.parent()}while(0<c.length);return c};k.before(G.hDiv).click(function(a){var e=z("states.select"),g=a.target,f=S.call(d,g),l=f.parent();if(0!==l.length&&!Y(l,Fa)){ua=l[0].id;var m=b(g).hasClass("cbox")&&b(g).is(":enabled")&&!Y(g,Fa),n=N.call(d,"beforeSelectRow",ua,a),p=t.detectRowEditing.call(d,ua),p=null!=p&&"cellEditing"!==p.mode;if("A"!==g.tagName&&(!p||m))if(U=f[0].cellIndex,W=f.html(),N.call(d,"onCellSelect",ua,U,W,a),!0===h.cellEdit)if(h.multiselect&&
m&&n)u.call(k,ua,!0,a);else{ua=l[0].rowIndex;try{c.editCell.call(k,ua,U,!0)}catch(Hb){}}else if(n)if(h.multikey)a[h.multikey]?u.call(k,ua,!0,a):h.multiselect&&m&&(m=b("#jqg_"+I(h.id)+"_"+ua).is(":checked"),b("#jqg_"+I(h.id)+"_"+ua).prop("checked",!m));else if(h.multiselect&&h.multiboxonly){if(!m){var q=h.frozenColumns?h.id+"_frozen":"";b(h.selarrrow).each(function(a,d){var g=c.getGridRowById.call(k,d);g&&b(g).removeClass(e);b("#jqg_"+I(h.id)+"_"+I(d)).prop("checked",!1);q&&(b("#"+I(d),"#"+I(q)).removeClass(e),
b("#jqg_"+I(h.id)+"_"+I(d),"#"+I(q)).prop("checked",!1))});V(h.selarrrow)}u.call(k,ua,!0,a)}else g=h.selrow,u.call(k,ua,!0,a),"toggle"!==h.singleSelectClickMode||h.multiselect||g!==ua||(d.grid.fbRows&&(l=l.add(d.grid.fbRows[l[0].rowIndex]===l[0]?d.rows[l[0].rowIndex]:d.grid.fbRows[l[0].rowIndex])),l.removeClass(e).attr({"aria-selected":"false",tabindex:"-1"}),h.selrow=null);else m&&b(g).prop("checked",!1)}}).on("reloadGrid",function(a,d){var e=this.grid,g=b(this);!0===h.treeGrid&&(h.datatype=h.treedatatype);
...
"local",b(".ui-jqgrid-titlebar-close",G.cDiv).trigger("click")))}else b(G.cDiv).hide(),b(G.cDiv).nextAll("div:visible").first().addClass("ui-corner-top");b(G.hDiv).after(G.bDiv);G.eDiv=b("<div class='"+z("gridError","ui-jqgrid-errorbar ui-jqgrid-errorbar-"+M)+"' style='display:none;'><span class='"+z("gridErrorText","ui-jqgrid-error")+"'></span></div>")[0];b(G.hDiv).after(G.eDiv);b(g).click(Q).dblclick(function(a){var e=b(h.rs),g=e.offset(),f=e.data("idx"),l=e.data("delta"),m=h.colModel[f],n=b(this).data("pageX")||
...
b(c).removeClass(e))));V(d.savedRow)})},getRowData:function(a,c){var d={},e;"object"===typeof a&&(c=a,a=void 0);c=c||{};this.each(function(){var g=this.p,f=!1,k,l=1,m,n=this.rows,p,q,r,u,t;if(void 0===a)f=!0,e=[],l=n.length;else if(k=D.getGridRowById.call(b(this),a),!k)return d;for(m=0;m<l;m++)if(f&&(k=n[m]),b(k).hasClass("jqgrow")){q=b(k).find("td[role=gridcell]");for(p=0;p<q.length;p++)if(r=g.colModel[p],u=r.name,0>b.inArray(u,g.reservedColumnNames)&&"actions"!==r.formatter&&(!c.skipHidden||!r.hidden))if(t=
q[p],!0===g.treeGrid&&u===g.ExpandColumn)d[u]=Ma(b("span",t).first().html());else try{d[u]=b.unformat.call(this,t,{rowId:k.id,colModel:r},p)}catch(B){d[u]=Ma(b(t).html())}!c.includeId||!1!==g.keyName&&null!=d[g.keyName]||(d[g.prmNames.id]=Ba(g.idPrefix,k.id));f&&(e.push(d),d={})}});return e||d},delRowData:function(a){var c=!1,d,e,g;this.each(function(){var f=this.p;d=D.getGridRowById.call(b(this),a);if(!d)return!1;f.subGrid&&(g=b(d).next(),g.hasClass("ui-subgrid")&&g.remove());b(d).remove();f.records--;
...
f.ExpandColumn&&(q=q.children("span.cell-wrapperleaf,span.cell-wrapper").first()),q.html(n).attr(l))}});if("local"===f.datatype){if(f.treeGrid)for(p in f.treeReader)f.treeReader.hasOwnProperty(p)&&delete m[f.treeReader[p]];void 0!==u&&(f.data[q]=b.extend(!0,u,m))}N.call(g,"afterSetRow",{rowid:a,inputData:c,iData:q,iRow:k.rowIndex,tr:k,localData:m,cssProp:d})}catch(A){e=!1}e&&("string"===l?b(k).addClass(d):null!==d&&"object"===l&&b(k).css(d))});return e},addRowData:function(a,c,d,e){0>b.inArray(d,
"first last before after afterSelected beforeSelected".split(" "))&&(d="last");var g=!1,f,k,l,m,n,p,q,r,u,A,B;c&&(b.isArray(c)?(p=!0,q=a):(c=[c],p=!1),this.each(function(){var v=this.p,x=c.length,w=b(this),y=this.rows,C=0,z=D.getGridRowById,h=v.colModel,E,H=v.additionalProperties;p||(void 0!==a?a=String(a):(a=ya(),!1!==v.keyName&&(q=v.keyName,void 0!==c[0][q]&&(a=c[0][q]))));for(r=v.altclass;C<x;){u=c[C];k=[];if(p)try{a=u[q],void 0===a&&(a=ya())}catch(L){a=ya()}B=a;E={};for(m=0;m<h.length;m++)A=h[m],
f=A.name,"rn"!==f&&"cb"!==f&&"subgrid"!==f&&(n=hb.call(this,u[f],A,void 0,B,{},m),b.isFunction(A.saveLocally)?A.saveLocally.call(this,{newValue:n,newItem:E,oldItem:{},id:B,cm:A,cmName:f,iCol:m}):void 0!==n&&(E[f]=n));for(m=0;m<H.length;m++)f=H[m],"object"===typeof f&&f.hasOwnProperty("name")&&(f=f.name),n=ra(u,f),void 0!==n&&(E[f]=n);"local"===v.datatype&&(E[v.localReader.id]=B,v._index[B]=v.data.length,v.data.push(E));k=t.parseDataToHtml.call(this,1,[a],[u]);k=k.join("");if(0===y.length)b(this.tBodies[0]).append(k);
...
D.addSubGrid.call(w,v.iColByName.subgrid,l);v.records++;v.reccount++;0===v.lastpage&&(v.lastpage=1);N.call(this,"afterAddRow",{rowid:a,inputData:c,position:d,srcRowid:e,iRow:l,localData:E,iData:v.data.length-1});C++}!0!==v.altRows||p||w.jqGrid("isBootstrapGuiStyle")||("last"===d?0===(y.length-1)%2&&b(y[y.length-1]).addClass(r):b(y).each(function(a){1===a%2?b(this).addClass(r):b(this).removeClass(r)}));this.rebuildRowIndexes();this.updatepager(!0,!0);g=!0}));return g},footerData:function(a,c,d){var e=
...
c&&(k.each(function(){var a=b("[id^=jqgh_]",this),d=a.children("span.ui-jqgrid-cell-wrapper");0<d.length?d.html(c):(d=b(".s-ico",this),a.empty().html(c)[f.sortIconsBeforeText?"prepend":"append"](d))}),f.colNames[g]=c),d&&("string"===typeof d?k.addClass(d):k.css(d)),"object"===typeof e&&k.attr(e))}})},setCell:function(a,c,d,e,g,f){return this.each(function(){var k=this.p,l,m=k.colModel,n,p,q,r,u,A,B,v={},x;if(this.grid&&(l=isNaN(c)?k.iColByName[c]:parseInt(c,10),0<=l&&(r=D.getGridRowById.call(b(this),
a)))){u=t.getCell.call(this,r,l);if(""!==d||!0===f){p=m[l];"local"===k.datatype&&(x=Ba(k.idPrefix,a),n=k._index[x],void 0!==n&&(q=k.data[n]));if(null==q)for(n=0;n<r.cells.length;n++){if(n!==l&&(A=t.getDataFieldOfCell.call(this,r,n),0<A.length)){try{B=b.unformat.call(this,A,{rowId:a,colModel:m[n]},n)}catch(w){B=Ma(A[0].innerHTML)}v[m[n].name]=B}}else v=q;v[p.name]=d;m=this.formatter(a,d,l,v,"edit");B=u;!0===k.treeGrid&&p.name===k.ExpandColumn&&(B=B.children("span.cell-wrapperleaf,span.cell-wrapper").first());
B.html(m);p.title&&u.attr({title:d});null!=q&&(m=hb.call(this,d,p,q[p.name],x,q,l),b.isFunction(p.saveLocally)?p.saveLocally.call(this,{newValue:m,newItem:q,oldItem:q,id:x,cm:p,cmName:p.name,iCol:l}):q[p.name]=m)}if(e||g){u=t.getCell.call(this,r,l);if(e)u["string"===typeof e?"addClass":"css"](e);"object"===typeof g&&u.attr(g)}}})},getCell:function(a,c){var d=!1;this.each(function(){var e,g=this.p,f,k;if(this.grid&&(e=isNaN(c)?g.iColByName[c]:parseInt(c,10),0<=e&&(f=D.getGridRowById.call(b(this),a)))){k=
t.getDataFieldOfCell.call(this,f,e).first();try{d=b.unformat.call(this,k,{rowId:f.id,colModel:g.colModel[e]},e)}catch(l){d=Ma(k.html())}}});return d},getCol:function(a,c,d){var e=[],g,f=0,k,l,m;c="boolean"!==typeof c?!1:c;void 0===d&&(d=!1);this.each(function(){var n,p=this.p,q;if(this.grid&&(n=isNaN(a)?p.iColByName[a]:parseInt(a,10),0<=n)){var r=this.rows,u=r.length,A=0,B=0,v;if(u&&0<u){for(;A<u;){v=r[A];if(b(v).hasClass("jqgrow")){q=t.getDataFieldOfCell.call(this,v,n).first();try{g=b.unformat.call(this,
q,{rowId:v.id,colModel:p.colModel[n]},n)}catch(x){g=Ma(q.html())}d?(m=parseFloat(g),isNaN(m)||(f+=m,void 0===l&&(l=k=m),k=Math.min(k,m),l=Math.max(l,m),B++)):c?e.push({id:v.id,value:g}):e.push(g)}A++}if(d)switch(d.toLowerCase()){case "sum":e=f;break;case "avg":e=f/B;break;case "count":e=u-1;break;case "min":e=k;break;case "max":e=l}}}});return e},clearGridData:function(a){return this.each(function(){var c=this.p,d=this.rows,e=this.grid;e&&c&&d&&("boolean"!==typeof a&&(a=!1),b(this).off(".jqGridFormatter"),
...
b(p),u=parseInt(f.iCol,10),A=parseInt(f.iRow,10),B=b(k[A]),v=f.savedRow;if(null!=q){f.selrow=q;f.knv||g.jqGrid("GridNav");if(0<v.length){if(!0===d&&a===A&&c===u)return;g.jqGrid("saveCell",v[0].id,v[0].ic)}else setTimeout(function(){b("#"+t.jqID(f.knv)).attr("tabindex","-1").focus()},1);n=f.colModel[c];k=n.name;if("subgrid"!==k&&"cb"!==k&&"rn"!==k){m=Ka.call(e,p,c);p=n.editable;b.isFunction(p)&&(p=p.call(e,{rowid:q,iCol:c,iRow:a,name:k,cm:n,mode:"cell"}));var x=g.jqGrid("getGuiStyles","states.select",
"edit-cell"),w=g.jqGrid("getGuiStyles","states.hover","selected-row");if(!0!==p||!0!==d||m.hasClass("not-editable-cell"))0<=u&&0<=A&&(Ka.call(e,B[0],u).removeClass(x),B.removeClass(w)),m.addClass(x),r.addClass(w),l=m.html().replace(/&#160;/ig,""),N.call(e,"onSelectCell",q,k,l,a,c);else{0<=u&&0<=A&&(Ka.call(e,B[0],u).removeClass(x),B.removeClass(w));m.addClass(x);r.addClass(w);n.edittype||(n.edittype="text");r=n.edittype;try{l=b.unformat.call(e,m,{rowId:q,colModel:n},c)}catch(C){l="textarea"===r?m.text():
m.html()}f.autoEncodeOnEdit&&(l=t.oldDecodePostedData(l));v.push({id:a,ic:c,name:k,v:l});if("&nbsp;"===l||"&#160;"===l||1===l.length&&160===l.charCodeAt(0))l="";b.isFunction(f.formatCell)&&(u=f.formatCell.call(e,q,k,l,a,c),void 0!==u&&(l=u));N.call(e,"beforeEditCell",q,k,l,a,c);n=b.extend({},n.editoptions||{},{id:a+"_"+k,name:k,rowId:q,mode:"cell",cm:n,iCol:c});var y=t.createEl.call(e,r,n,l,!0,b.extend({},t.ajaxOptions,f.ajaxSelectOptions||{})),r=m;(u=!0===f.treeGrid&&k===f.ExpandColumn)&&(r=m.children("span.cell-wrapperleaf,span.cell-wrapper"));
...
d.shiftKey?g.jqGrid("prevCell",a,c):g.jqGrid("nextCell",a,c)}d.stopPropagation()});N.call(e,"afterEditCell",q,k,l,a,c);g.triggerHandler("jqGridAfterEditCell",[q,k,l,a,c])}f.iCol=c;f.iRow=a}}}})},saveCell:function(a,c){return this.each(function(){var d=this,e=b(d),g=d.p,f=d.grid,k=t.info_dialog,l=t.jqID;if(f&&!0===g.cellEdit){var m=e.jqGrid("getGridRes","errors"),n=m.errcap,p=e.jqGrid("getGridRes","edit").bClose,q=g.savedRow,r=1<=q.length?0:null;if(null!==r){var u=d.rows[a],A=u.id,B=b(u),v=g.colModel[c],
x=v.name,w,y=Ka.call(d,u,c),C={},z=t.getEditedValue.call(d,y,v,C);if(z!==q[r].v){w=e.triggerHandler("jqGridBeforeSaveCell",[A,x,z,a,c]);void 0!==w&&(z=w);b.isFunction(g.beforeSaveCell)&&(w=g.beforeSaveCell.call(d,A,x,z,a,c),void 0!==w&&(z=w));var h=t.checkValues.call(d,z,c,void 0,void 0,{oldValue:q[r].v,newValue:z,cmName:x,rowid:A,iCol:c,iRow:a,cm:v,tr:u,td:y,mode:"cell"}),u=v.formatoptions||{};if(null==h||!0===h||!0===h[0]){r=e.triggerHandler("jqGridBeforeSubmitCell",[A,x,z,a,c])||{};b.isFunction(g.beforeSubmitCell)&&
((r=g.beforeSubmitCell.call(d,A,x,z,a,c))||(r={}));0<b("input.hasDatepicker",y).length&&b("input.hasDatepicker",y).datepicker("hide");"date"===v.formatter&&!0!==u.sendFormatted&&(z=b.unformat.date.call(d,z,v));if("remote"===g.cellsubmit)if(g.cellurl){var E={};E[x]=z;m=g.prmNames;u=m.oper;E[m.id]=t.stripPref(g.idPrefix,A);E[u]=m.editoper;E=b.extend(r,E);g.autoEncodeOnEdit&&b.each(E,function(a,c){b.isFunction(c)||(E[a]=t.oldEncodePostedData(c))});e.jqGrid("progressBar",{method:"show",loadtype:g.loadui,
htmlcontent:e.jqGrid("getGridRes","defaults.savetext")||"Saving..."});f.hDiv.loading=!0;b.ajax(b.extend({url:b.isFunction(g.cellurl)?g.cellurl.call(d,g.cellurl,a,c,A,z,x):g.cellurl,data:t.serializeFeedback.call(d,g.serializeCellData,"jqGridSerializeCellData",E),type:"POST",complete:function(h){f.endReq.call(d);if((300>h.status||304===h.status)&&(0!==h.status||4!==h.readyState)){var l=e.triggerHandler("jqGridAfterSubmitCell",[d,h,E.id,x,z,a,c])||[!0,""];if(!0===l||!0===l[0]&&b.isFunction(g.afterSubmitCell))l=
g.afterSubmitCell.call(d,h,E.id,x,z,a,c);null==l||!0===l||!0===l[0]?(e.jqGrid("setCell",A,c,z,!1,!1,!0),y.addClass("dirty-cell"),B.addClass("edited"),N.call(d,"afterSaveCell",A,x,z,a,c),q.splice(0,1)):(k.call(d,n,l[1],p),e.jqGrid("restoreCell",a,c))}},error:function(f,h,l){e.triggerHandler("jqGridErrorCell",[f,h,l]);b.isFunction(g.errorCell)?g.errorCell.call(d,f,h,l):k.call(d,n,f.status+" : "+f.statusText+"<br/>"+h,p);e.jqGrid("restoreCell",a,c)}},t.ajaxOptions,g.ajaxCellOptions||{}))}else try{k.call(d,
n,m.nourl,p),e.jqGrid("restoreCell",a,c)}catch(H){}"clientArray"===g.cellsubmit&&(e.jqGrid("setCell",A,c,"select"===v.edittype&&"select"!==v.formatter?C.text:z,!1,!1,!0),y.addClass("dirty-cell"),B.addClass("edited"),N.call(d,"afterSaveCell",A,x,z,a,c),q.splice(0,1))}else try{setTimeout(function(){var a=t.getRelativeRect.call(d,y);k.call(d,n,z+" "+h[1],p,{top:a.top,left:a.left+b(d).closest(".ui-jqgrid").offset().left})},50),e.jqGrid("restoreCell",a,c)}catch(H){}}else e.jqGrid("restoreCell",a,c)}setTimeout(function(){b("#"+
...
O.call(this,"dialog.window","ui-jqdialog");m.id=a.themodal;m.dir=p?"rtl":"ltr";var r=document.createElement("div");r.className=O.call(this,"dialog.document");b(r).attr("role","document");var u=document.createElement("div");u.className=O.call(this,"dialog.subdocument");r.appendChild(u);m.appendChild(r);r=document.createElement("div");r.className=O.call(this,"dialog.header","ui-jqdialog-titlebar "+(p?"ui-jqdialog-titlebar-rtl":"ui-jqdialog-titlebar-ltr"));r.id=a.modalhead;b(r).append("<span class='ui-jqdialog-title'>"+
d.caption+"</span>");var A=O.call(this,"states.hover"),B=b("<a aria-label='Close' class='"+O.call(this,"dialog.closeButton","ui-jqdialog-titlebar-close")+"'></a>").hover(function(){B.addClass(A)},function(){B.removeClass(A)}).append("<span class='"+D.getIconRes.call(this,"form.close")+"'></span>");b(r).append(B);p=document.createElement("div");b(p).addClass(O.call(this,"dialog.content","ui-jqdialog-content")).attr("id",a.modalcontent);b(p).append(c);u.appendChild(p);b(u).prepend(r);!0===f?b("body").append(m):
...
"button"===a?"button":"textbox";k=document.createElement("input");k.type=a;f(k,c);k.value=d;"button"!==a&&(e?c.size||b(k).css({width:"100%","box-sizing":"border-box"}):c.size||(c.size=20));b(k).attr("role",g);break;case "image":case "file":k=document.createElement("input");k.type=a;f(k,c);break;case "custom":k=document.createElement("span");try{if(b.isFunction(c.custom_element)){var A=c.custom_element.call(l,d,c);if(A instanceof jQuery||t.isHTMLElement(A)||"string"===typeof A)A=b(A).addClass("customelement").attr({id:c.id,
name:c.name}),b(k).empty().append(A);else throw"editoptions.custom_element returns value of a wrong type";}else throw"editoptions.custom_element is not a function";}catch(B){"e1"===B&&n.call(l,p,"function 'custom_element' "+r.nodefined,q),"e2"===B?n.call(l,p,"function 'custom_element' "+r.novalue,q):n.call(l,p,"string"===typeof B?B:B.message,q)}}return k},checkDate:function(b,c){var a={},e;b=b.toLowerCase();e=-1!==b.indexOf("/")?"/":-1!==b.indexOf("-")?"-":-1!==b.indexOf(".")?".":"/";b=b.split(e);
...
f.val(h.defaultValue);t.bindEv.call(c,f[0],h);t.fullBoolFeedback.call(c,h.selectFilled,"jqGridSelectFilled",{elem:f[0],options:h,cm:e,cmName:e.name,iCol:g,mode:"filter"});!0===l.autosearch&&f.change(function(){z();return!1})}},t.ajaxOptions,g.ajaxSelectOptions||{}));else{var T,fa,ba;this.searchoptions?(T=void 0===w.value?H.value||"":w.value,fa=void 0===w.separator?H.separator||":":w.separator,ba=void 0===w.delimiter?H.delimiter||";":w.delimiter):this.editoptions&&(T=void 0===H.value?"":H.value,fa=
void 0===H.separator?":":H.separator,ba=void 0===H.delimiter?";":H.delimiter);T&&(e=document.createElement("select"),e.style.width="100%",w=b(e).attr({name:this.index||this.name,role:"search",id:x(this.name),"aria-describedby":g.id+"_"+this.name}),d.attr&&w.attr(d.attr),t.fillSelectOptions(e,T,fa,ba,null!=d.attr&&d.attr.multiple)||"string"!==typeof d.noFilterText||(T=document.createElement("option"),T.value="",T.innerHTML=d.noFilterText,T.selected=!0,w.prepend(T)),void 0!==d.defaultValue&&w.val(d.defaultValue),
w.addClass(B),J.push({elem:e,options:d}),X.append(e),t.fullBoolFeedback.call(c,d.selectFilled,"jqGridSelectFilled",{elem:e,options:this.searchoptions||H,cm:this,cmName:this.name,iCol:a,mode:"filter"}),!0===l.autosearch&&w.change(function(){z();return!1}))}break;case "text":w=b("<input role='search' type='text' class='"+B+"' name='"+(this.index||this.name)+"' id='"+x(this.name)+"' aria-labelledby='jqgh_"+g.id+"_"+this.name+"' value='"+(void 0!==d.defaultValue?d.defaultValue:"")+"'/>");X.append(w);
d.attr&&w.attr(d.attr);J.push({elem:w[0],options:d});!0===l.autosearch&&(l.searchOnEnter?w.keypress(function(b){return 13===(b.charCode||b.keyCode||0)?(z(),!1):this}):w.keydown(function(b){switch(b.which){case 13:return!1;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:L&&clearTimeout(L),L=setTimeout(function(){z()},l.autosearchDelay)}}));break;case "custom":X.append("<span style='width:100%;padding:0;box-sizing:border-box;' class='"+B+"' name='"+(this.index||this.name)+"' id='"+
x(this.name)+"'/>");try{if(b.isFunction(d.custom_element)){var P=d.custom_element.call(c,void 0!==d.defaultValue?d.defaultValue:"",d);if(P)P=b(P).addClass("customelement"),Q.find("span[name='"+(this.index||this.name)+"']").append(P);else throw"e2";}else throw"e1";}catch(wa){"e1"===wa&&f.call(c,p,"function 'custom_element' "+r.nodefined,q),"e2"===wa?f.call(c,p,"function 'custom_element' "+r.novalue,q):f.call(c,p,"string"===typeof wa?wa:wa.message,q)}}}A.append(Q);A.find(".ui-search-oper .soptclass,.ui-search-clear .clearsearchclass").hover(function(){b(this).addClass(u)},
function(){b(this).removeClass(u)});aa.append(A);l.searchOperators||I.hide()});b(d.hDiv).find(">div>.ui-jqgrid-htable>thead").append(aa);b.each(J,function(){t.bindEv.call(c,this.elem,this.options)});l.searchOperators&&(b(".soptclass",aa).click(function(a){var c=b(this).offset();H(this,c.left,c.top);a.stopPropagation()}),b("body").on("click",function(a){"soptclass"!==a.target.className&&b("#sopt_menu").hide()}));b(".clearsearchclass",aa).click(function(){var a=b(this).closest(".ui-search-clear"),c=
parseInt(a.siblings(".ui-search-oper").data("colindex"),10),a=a.siblings(".ui-search-input"),d=b.extend({},m[c].searchoptions||{}).defaultValue||"";switch(m[c].stype){case "select":d?a.find("select").val(d):a.find("select")[0].selectedIndex=0;break;case "checkbox":C(a.find("input[type=checkbox]"),-1);break;default:a.find("input").val(d)}!0===l.autosearch&&z()});c.ftoolbar=!0;c.triggerToolbar=z;c.clearToolbar=function(a){var f={},h=0,k;a="boolean"!==typeof a?!0:a;b.each(m,function(){var a,e=b("#"+
...
b(c),e=c.p,g=c.grid;if(g&&null!=e&&!0!==e.frozenColumns){var f=e.colModel,k,l=f.length,m=-1,n=!1,p=[],q=I(e.id),r=O.call(c,"states.hover"),u=O.call(c,"states.disabled");if(!0!==e.subGrid&&!0!==e.treeGrid&&!e.scroll){for(k=0;k<l&&!0===f[k].frozen;k++)n=!0,m=k,p.push("#jqgh_"+q+"_"+I(f[k].name));e.sortable&&(f=b(g.hDiv).find(".ui-jqgrid-htable .ui-jqgrid-labels"),f.sortable("destroy"),d.jqGrid("setGridParam",{sortable:{options:{items:0<p.length?">th:not(:has("+p.join(",")+"),:hidden)":">th:not(:hidden)"}}}),
...
var r,t,u;if(null!=a&&0<a.length){a[0].scrollTop=c.scrollTop;a.css("rtl"===e.direction?{top:q,right:0}:{top:q,left:0});h=a.children("table").children("thead").children("tr");m=b(c).children("div").children("table").children("thead").children("tr");0===m.length&&(h=b(a.children("table")[0].rows),m=b(b(c).children("div").children("table")[0].rows));g=Math.min(h.length,m.length);r=0<g?b(h[0]).position().top:0;t=0<g?b(m[0]).position().top:0;if(0<=d)for(0<=f&&(g=Math.min(f+1,g));d<g;d++)if(l=b(m[d]),"none"!==
l.css("display")&&l.is(":visible")){q=l.position().top;f=b(h[d]);n=f.position().top;p=l.height();if(null!=e.groupHeader&&e.groupHeader.useColSpanStyle)for(u=l[0].cells,k=0;k<u.length;k++)l=u[k],null!=l&&"TH"===l.nodeName.toUpperCase()&&(p=Math.max(p,b(l).height()));q=p+(q-t)+(r-n);w(f,q)}w(a,c.clientHeight)}},n={resizeDiv:!0,resizedRows:{iRowStart:0,iRowEnd:-1}},z={header:n,resizeFooter:!0,body:n};d.on("jqGridAfterGridComplete.setFrozenColumns",function(){b(e.idSel+"_frozen").remove();b(g.fbDiv).height(g.hDiv.clientHeight);
...
this).remove();var a=this.createTableForGroup(e.filter,null);b(this).append(a);m(e.afterRedraw)&&e.afterRedraw.call(p(),e,this)};this.createTableForGroup=function(a,c){var d=this,f,g=b("<table class='"+q("searchDialog.operationGroup","group")+"' style='border:0px none;'><tbody></tbody></table>"),h="left";"rtl"===e.direction&&(h="right",g.attr("dir","rtl"));null===c&&g.append("<tr class='error' style='display:none;'><th colspan='5' class='"+A+"' align='"+h+"'></th></tr>");var k=b("<tr></tr>");g.append(k);
...
a));return g};this.createTableRowForRule=function(a,c){var d=this,f=p(),g=b("<tr></tr>"),h,k,n,w="",v;g.append("<td class='first'></td>");var x=b("<td class='columns'></td>");g.append(x);var A=b("<select class='"+q("searchDialog.label","selectLabel")+"'></select>"),B,G=[];x.append(A);A.on("change",function(){a.field=b(A).val();var c=b(this).parents("tr:first"),e,g;for(g=0;g<d.p.columns.length;g++)if(d.p.columns[g].name===a.field){e=d.p.columns[g];break}if(e){g=b.extend({},e.editoptions||{});delete g.readonly;
...
for(g=0;g<k.length;g++)w=k[g],B=b.inArray(k[g],G),-1!==B&&(r=d.p.ops[B],r=void 0!==r?r.text:d.p.cops[w].text,0===p&&(a.op=w),e+="<option value='"+w+"'>"+r+"</option>",p++);b(".selectopts",c).empty().append(e);b(".selectopts",c)[0].selectedIndex=0;t.msie&&9>t.msiever()&&(g=parseInt(b("select.selectopts",c)[0].offsetWidth,10)+1,b(".selectopts",c).width(g),b(".selectopts",c).css("width","auto"));b(".data",c).empty().append(n);t.bindEv.call(f,n,h);b(".input-elm",c).on("change",function(c){c=c.target;
...
g)return"";if("bw"===d||"bn"===d)h+="%";if("ew"===d||"en"===d)h="%"+h;if("cn"===d||"nc"===d)h="%"+h+"%";if("in"===d||"ni"===d)h=" ("+h+")";e.errorcheck&&v(a.data,g);return-1!==b.inArray(g.searchtype,["int","integer","float","number","currency"])||"nn"===d||"nu"===d?a.field+" "+c+" "+h:a.field+" "+c+' "'+h+'"'};this.resetFilter=function(){e.filter=b.extend(!0,{},e.initFilter);this.reDraw();this.onchange()};this.hideError=function(){b("th."+A,this).html("");b("tr.error",this).hide()};this.showError=
function(){b("th."+A,this).html(e.errmsg);b("tr.error",this).show()};this.toUserFriendlyString=function(){return this.getStringForGroup(e.filter)};this.toString=function(){function b(c){var d="(",e;if(void 0!==c.groups)for(e=0;e<c.groups.length;e++)1<d.length&&(d="OR"===c.groupOp?d+" || ":d+" && "),d+=b(c.groups[e]);if(void 0!==c.rules)for(e=0;e<c.rules.length;e++){1<d.length&&(d="OR"===c.groupOp?d+" || ":d+" && ");var f=void 0,g,k=c.rules[e];if(a.p.errorcheck){for(g=0;g<a.p.columns.length;g++)if(a.p.columns[g].name===
...
void 0===a.search?!0:a.search,d=!0===a.hidden;if(a.searchoptions&&!0===a.searchoptions.searchhidden&&c||c&&!d)C=!0,y=a.index||a.name,h=b}});if(!u&&y||!1===f.multipleSearch)l="eq",0<=h&&E[h].searchoptions&&E[h].searchoptions.sopt?l=E[h].searchoptions.sopt[0]:f.sopt&&f.sopt.length&&(l=f.sopt[0]),u={groupOp:"AND",rules:[{field:y,op:l,data:""}]};C=!1;f.tmplNames&&f.tmplNames.length&&(C=!0,w=f.tmplLabel,w+="<select class='ui-template'>",w+="<option value='default'>Default</option>",r(f.tmplNames,function(b,
a){w+="<option value='"+b+"'>"+a+"</option>"}),w+="</select>");z="<div class='"+O.call(d,"dialog.footer")+"'><table class='EditTable' style='border:0px none;margin-top:5px' id='"+k+"_2'><tbody><tr><td colspan='2'><hr class='"+O.call(d,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='EditButton EditButton-"+g.direction+"'  style='float:"+("rtl"===g.direction?"right":"left")+";'>"+H+w+"</td><td class='EditButton EditButton-"+g.direction+"'>"+x+z+"</td></tr></tbody></table></div>";k=I(k);
f.gbox=p;f.height="auto";k="#"+k;b(k).jqFilter({columns:E,filter:f.loadDefaults?u:null,showQuery:f.showQuery,errorcheck:f.errorcheck,sopt:f.sopt,groupButton:f.multipleGroup,ruleButtons:f.multipleSearch,afterRedraw:f.afterRedraw,ops:f.odata,cops:g.customSortOperations,operands:f.operands,ajaxSelectOptions:g.ajaxSelectOptions,groupOps:f.groupOps,onChange:function(a,c,e){a.showQuery&&b(".query",e).text(c.toUserFriendlyString());Da.call(d,f.afterChange,"jqGridFilterAfterChange",b(k),f,a,c)},direction:g.direction,
id:g.id});v.append(z);if(C&&f.tmplFilters&&f.tmplFilters.length)b(".ui-template",v).on("change",function(){var a=b(this).val();"default"===a?b(k).jqFilter("addFilter",u):b(k).jqFilter("addFilter",f.tmplFilters[parseInt(a,10)]);return!1});!0===f.multipleGroup&&(f.multipleSearch=!0);A("onInitialize",b(k));f.layer?t.createModal.call(d,m,v,f,q,b(p)[0],"#"+I(f.layer),{position:"relative"}):t.createModal.call(d,m,v,f,q,b(p)[0]);(f.searchOnEnter||f.closeOnEscape)&&b(n).keydown(function(a){var c=b(a.target);
...
a&&d.editoptions&&!0===d.editoptions.NullIfEmpty&&F.hasOwnProperty(e)&&""===f&&(F[e]="null")})}function f(){var c=[!0,"",""],d=c,f={},h=r.prmNames,k,l,m,n,w,y,A=D.getInd.call(q,a),E=!1===A?null:p.rows[A];(y=q.triggerHandler("jqGridAddEditBeforeCheckValues",[b(x),M]))&&"object"===typeof y&&(F=y);A=!1===A?-1:A;b.isFunction(v.beforeCheckValues)&&(y=v.beforeCheckValues.call(p,F,b(x),M))&&"object"===typeof y&&(F=y);for(m in F)if(F.hasOwnProperty(m)){y=r.iColByName[m];d=t.checkValues.call(p,F[m],m,void 0,
void 0,{oldValue:"_empty"===a?null:D.getCell.call(q,a,y),newValue:F[m],cmName:m,rowid:a,cm:L[y],iCol:y,iRow:A,tr:E,td:null==E?null:E.cells[y],mode:"_empty"===a?"addForm":"editForm"});if(null==d||!0===d)d=c;if(!1===d[0])break}g();if(d[0]){f=q.triggerHandler("jqGridAddEditClickSubmit",[v,F,M]);void 0===f&&b.isFunction(v.onclickSubmit)&&(f=v.onclickSubmit.call(p,v,F,M)||{});d=q.triggerHandler("jqGridAddEditBeforeSubmit",[F,b(x),M]);if(null==d||!0===d)d=c;d[0]&&b.isFunction(v.beforeSubmit)&&(d=v.beforeSubmit.call(p,
F,b(x),M),null==d||!0===d)&&(d=c)}if(d[0]&&!v.processing){v.processing=!0;b("#sData",z).addClass(N);m=v.url||r.editurl;l=h.oper;k="clientArray"===m&&!1!==r.keyName?r.keyName:h.id;F[l]="_empty"===b.trim(F[u+"_id"])?h.addoper:h.editoper;F[l]!==h.addoper?F[k]=F[u+"_id"]:void 0===F[k]&&(F[k]=F[u+"_id"]);delete F[u+"_id"];F=b.extend(F,v.editData,f);if(!0===r.treeGrid)for(w in F[l]===h.addoper&&(n=r.selrow,F["adjacency"===r.treeGridModel?r.treeReader.parent_id_field:"parent_id"]=n),r.treeReader)r.treeReader.hasOwnProperty(w)&&
(f=r.treeReader[w],!F.hasOwnProperty(f)||F[l]===h.addoper&&"parent_id_field"===w||delete F[f]);F[k]=t.stripPref(r.idPrefix,F[k]);r.autoEncodeOnEdit&&b.each(F,function(a,c){b.isFunction(c)||(F[a]=t.oldEncodePostedData(c))});w=b.extend({url:b.isFunction(m)?m.call(p,F[k],M,F,v):m,type:b.isFunction(v.mtype)?v.mtype.call(p,M,v,F[k],F):v.mtype,data:t.serializeFeedback.call(p,b.isFunction(v.serializeEditData)?v.serializeEditData:r.serializeEditData,"jqGridAddEditSerializeEditData",F),complete:function(a,
f){q.jqGrid("progressBar",{method:"hide",loadtype:v.saveui});b("#sData",z).removeClass(N);F[k]=b("#id_g",C).val();if(300<=a.status&&304!==a.status||0===a.status&&4===a.readyState)d[0]=!1,d[1]=q.triggerHandler("jqGridAddEditErrorTextFormat",[a,M]),b.isFunction(v.errorTextFormat)?d[1]=v.errorTextFormat.call(p,a,M):d[1]=f+" Status: '"+a.statusText+"'. Error code: "+a.status;else{d=q.triggerHandler("jqGridAddEditAfterSubmit",[a,F,M]);if(null==d||!0===d)d=c;d[0]&&b.isFunction(v.afterSubmit)&&(d=v.afterSubmit.call(p,
...
v._savedData[u+"_id"])for(var w in v._savedData)v._savedData.hasOwnProperty(w)&&F[w]&&(v._savedData[w]=F[w])}v.processing=!1;try{b(":input:visible",x)[0].focus()}catch(Jb){}}},t.ajaxOptions,v.ajaxEditOptions);w.url||v.useDataProxy||(b.isFunction(r.dataProxy)?v.useDataProxy=!0:(d[0]=!1,d[1]+=" "+t.errors.nourl));d[0]&&(q.jqGrid("progressBar",{method:"show",loadtype:v.saveui,htmlcontent:v.savetext}),v.useDataProxy?(f=r.dataProxy.call(p,w,"set_"+u),void 0===f&&(f=[!0,""]),!1===f[0]?(d[0]=!1,d[1]=f[1]||
"Error deleting the selected row!"):(w.data.oper===h.addoper&&v.closeAfterAdd&&ia(),w.data.oper===h.editoper&&v.closeAfterEdit&&ia())):"clientArray"===w.url?(v.reloadAfterSubmit=!1,F=w.data,w.complete({status:200,statusText:""},"")):b.ajax(w))}!1===d[0]&&(b("#FormError>td",C).html(d[1]),b("#FormError",C).show())}function k(b,a){var c=!1,d;for(d in b)if(b.hasOwnProperty(d)&&String(b[d])!==String(a[d])){c=!0;break}return c}function l(){var a=!0;b("#FormError",C).hide();v.checkOnUpdate&&(F={},d(),G=
k(F,v._savedData))&&(b(x).data("disabled",!0),b(".confirm",E).show(),a=!1);return a}function m(a,c){var d=c[1].length-1;0===a?b("#pData",z).addClass(oa):void 0!==c[1][a-1]&&Y(b("#"+I(c[1][a-1])),oa)?b("#pData",z).addClass(oa):b("#pData",z).removeClass(oa);a===d?b("#nData",z).addClass(oa):void 0!==c[1][a+1]&&Y(b("#"+I(c[1][a+1])),oa)?b("#nData",z).addClass(oa):b("#nData",z).removeClass(oa)}function n(){var a=D.getDataIDs.call(q),c=b("#id_g",C).val();return[b.inArray(c,a),a]}var p=this,q=b(p),r=p.p;
if(p.grid&&null!=r&&a){var u=r.id,A=D.getGridRes,B=D.setSelection,v=b.extend(!0,{top:0,left:0,width:300,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,url:null,mtype:"POST",clearAfterAdd:!0,closeAfterEdit:!1,reloadAfterSubmit:!0,onInitializeForm:null,beforeInitData:null,beforeShowForm:null,afterShowForm:null,beforeSubmit:null,afterSubmit:null,onclickSubmit:null,afterComplete:null,onclickPgButtons:null,afterclickPgButtons:null,editData:{},closeOnEscape:!1,addedrow:"first",topinfo:"",
bottominfo:"",savekey:[!1,13],navkeys:[!1,38,40],checkOnSubmit:!1,checkOnUpdate:!1,_savedData:{},processing:!1,onClose:null,ajaxEditOptions:{},serializeEditData:null,viewPagerButtons:!0,overlayClass:O.call(this,"overlay"),removemodal:!0,skipPostTypes:["image","file"],saveui:"enable",savetext:A.call(q,"defaults.savetext")||"Saving..."},A.call(q,"edit"),t.edit,r.formEditing||{},c||{}),x="FrmGrid_"+u,w=x,y="TblGrid_"+u,C="#"+I(y),z=C+"_2",h={themodal:"editmod"+u,modalhead:"edithd"+u,modalcontent:"editcnt"+
u,resizeAlso:x},E="#"+I(h.themodal),H=r.gBox,L=r.colModel,J=r.iColByName,aa=1,Q=0,F,G,M,ga=v.commonIconClass,ia=function(){t.hideModal(E,{gb:H,jqm:v.jqModal,onClose:v.onClose,removemodal:v.removemodal})},sa=A.call(q,"errors.errcap"),K=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("AddEdit");a.unshift(v);return bb.apply(p,a)},P=U.call(p,"hover"),oa=U.call(p,"disabled"),R=U.call(p,"select"),N=U.call(p,"active"),X=U.call(p,"error");b(E).remove();x="#"+I(x);"new"===a?(a="_empty",M="add",
v.caption=v.addCaption):(v.caption=v.editCaption,M="edit");var V=!0;!v.checkOnUpdate||!0!==v.jqModal&&void 0!==v.jqModal||v.modal||(V=!1);var T=isNaN(v.dataheight)?v.dataheight:v.dataheight+"px",fa=isNaN(v.datawidth)?v.datawidth:v.datawidth+"px",w=b("<form name='FormPost' id='"+w+"' class='FormGrid' onSubmit='return false;' style='width:"+fa+";overflow:auto;position:relative;height:"+T+";'></form>").data("disabled",!1),ba=b("<table id='"+y+"' class='EditTable'><tbody></tbody></table>");b(L).each(function(){var b=
this.formoptions;aa=Math.max(aa,b?b.colpos||0:0);Q=Math.max(Q,b?b.rowpos||0:0)});b(w).append(ba);X=b("<tr id='FormError' style='display:none'><td class='"+X+"' colspan='"+2*aa+"'>&#160;</td></tr>");X[0].rp=0;b(ba).append(X);X=b("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*aa+"'>"+(v.topinfo||"&#160;")+"</td></tr>");X[0].rp=0;b(ba).append(X);if(K("beforeInitData",w,M)){(function(){var c=t.detectRowEditing.call(p,a);if(null!=c)if("inlineEditing"===c.mode)D.restoreRow.call(q,
...
a?"addForm":"editForm";b.isFunction(m)&&(m=m.call(p,{rowid:a,iCol:k,iRow:g,cmName:l,cm:this,mode:u}));w=(this.editrules&&!0===this.editrules.edithidden?0:!0===this.hidden||"hidden"===m)?"style='display:none'":"";switch(String(m).toLowerCase()){case "hidden":m=!0;break;case "disabled":y=m=!0;break;case "readonly":z=m=!0}if("cb"!==l&&"subgrid"!==l&&!0===m&&"rn"!==l){if(!1===g)q="";else{m=b(p.rows[g].cells[k]);try{q=b.unformat.call(p,m,{rowId:a,colModel:this},k)}catch(Kb){q=this.edittype&&"textarea"===
this.edittype?m.text():m.html()}Ra(q)&&(q="")}m=b.extend({},this.editoptions||{},{id:l,name:l,rowId:a,mode:u,cm:this,iCol:k});var C=b.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),A=parseInt(C.rowpos,10)||e+1,E=parseInt(2*(parseInt(C.colpos,10)||1),10);"_empty"===a&&m.defaultValue&&(q=b.isFunction(m.defaultValue)?m.defaultValue.call(p):m.defaultValue);this.edittype||(this.edittype="text");r.autoEncodeOnEdit&&(q=t.oldDecodePostedData(q));u=t.createEl.call(p,
this.edittype,m,q,!1,b.extend({},t.ajaxOptions,r.ajaxSelectOptions||{}));if(v.checkOnSubmit||v.checkOnUpdate)v._savedData[l]=q;b(u).addClass("FormElement");-1<b.inArray(this.edittype,["text","textarea","checkbox","password","select"])&&b(u).addClass(O.call(p,"dialog.dataField"));n=b(c).find("tr[data-rowpos="+A+"]");if(C.rowabove){var B=b("<tr><td class='contentinfo' colspan='"+2*d+"'>"+C.rowcontent+"</td></tr>");b(c).append(B);B[0].rp=A}0===n.length&&(n=b("<tr "+w+" data-rowpos='"+A+"'></tr>").addClass("FormData").attr("id",
"tr_"+l),b(n).append(h),b(c).append(n),n[0].rp=A);w=b("td:eq("+(E-2)+")",n[0]);n=b("td:eq("+(E-1)+")",n[0]);w.html(void 0===C.label?r.colNames[k]:C.label||"&#160;");n[Ra(n.html())?"html":"append"](C.elmprefix).append(u).append(C.elmsuffix);y?(w.addClass(oa),n.addClass(oa),b(u).prop("readonly",!0),b(u).prop("disabled",!0)):z&&b(u).prop("readonly",!0);"custom"===this.edittype&&b.isFunction(m.custom_value)&&m.custom_value.call(p,b("#"+I(l),x),"set",q);t.bindEv.call(p,u,m);f[e]=k;e++}});0<e&&(k=b("<tr class='FormData' style='display:none'><td class='CaptionTD'>&#160;</td><td colspan='"+
(2*d-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+u+"_id' value='"+a+"'/></td></tr>"),k[0].rp=e+999,b(c).append(k),v.checkOnSubmit||v.checkOnUpdate)&&(v._savedData[u+"_id"]=a);return f})(a,ba,aa);var T=da.call(p,T,"",ta(ga,v.prevIcon),"","left"),fa=da.call(p,fa,"",ta(ga,v.nextIcon),"","right"),W=da.call(p,"sData",v.bSubmit),wa=da.call(p,"cData",v.bCancel),y="<div class='"+O.call(p,"dialog.footer")+"'><table class='EditTable' id='"+y+"_2'><tbody><tr><td colspan='2'><hr class='"+
...
function(a,c){b("tbody",ba).append(c)})}v.gbox=H;var Na=!1;!0===v.closeOnEscape&&(v.closeOnEscape=!1,Na=!0);y=b("<div></div>").append(b("<div class='"+O.call(p,"dialog.body")+"'></div>").append(w)).append(y);t.createModal.call(p,h,y,v,r.gView,b(H)[0]);v.topinfo&&b(".tinfo",C).show();v.bottominfo&&b(".binfo",z).show();y=y=null;b(E).keydown(function(a){var c=(a.target.tagName||"").toUpperCase(),d,e;if(!0===b(x).data("disabled"))return!1;if(13===a.which&&"TEXTAREA"!==c){d=b(z).find(":focus");e=d.attr("id");
if(0<d.length&&0<=b.inArray(e,["pData","nData","cData"]))return d.trigger("click"),!1;if(!0===v.savekey[0]&&13===v.savekey[1])return b("#sData",z).trigger("click"),!1}if(!0===v.savekey[0]&&a.which===v.savekey[1]&&"TEXTAREA"!==c)return b("#sData",z).trigger("click"),!1;if(27===a.which){if(!l())return!1;Na&&ia();return!1}if(!0===v.navkeys[0]){if("_empty"===b("#id_g",C).val())return!0;if(a.which===v.navkeys[1])return b("#pData",z).trigger("click"),!1;if(a.which===v.navkeys[2])return b("#nData",z).trigger("click"),
!1}});v.checkOnUpdate&&(b("a.ui-jqdialog-titlebar-close span",E).removeClass("jqmClose"),b("a.ui-jqdialog-titlebar-close",E).off("click").click(function(){if(!l())return!1;ia();return!1}));Qa(b("#sData",z),v.saveicon,ga);Qa(b("#cData",z),v.closeicon,ga);if(v.checkOnSubmit||v.checkOnUpdate)W=da.call(p,"sNew",v.bYes),fa=da.call(p,"nNew",v.bNo),wa=da.call(p,"cNew",v.bExit),h=v.zIndex||999,h++,b("<div class='"+v.overlayClass+" jqgrid-overlay confirm' style='z-index:"+h+";display:none;'>&#160;</div><div class='"+
...
"_empty"!==a&&v.viewPagerButtons?b("#pData,#nData",z).show():b("#pData,#nData",z).hide();K("beforeShowForm",b(x),M);b(E).data("onClose",v.onClose);t.viewModal.call(p,E,{gbox:H,jqm:v.jqModal,overlay:v.overlay,modal:v.modal,overlayClass:v.overlayClass,toTop:v.toTop,onHide:function(b){b.w.remove();b.o&&b.o.remove()}});V||b("."+I(v.overlayClass)).click(function(){if(!l())return!1;ia();return!1});b(".fm-button",E).hover(function(){b(this).addClass(P)},function(){b(this).removeClass(P)});b("#sData",z).click(function(){F=
{};b("#FormError",C).hide();d();"_empty"===F[u+"_id"]?f():!0===v.checkOnSubmit?(G=k(F,v._savedData))?(b(x).data("disabled",!0),b(".confirm",E).show()):f():f();return!1});b("#cData",z).click(function(){if(!l())return!1;ia();return!1});b("#nData",z).click(function(){if(!l())return!1;b("#FormError",C).hide();var a=n();a[0]=parseInt(a[0],10);if(-1!==a[0]&&a[1][a[0]+1]){if(!K("onclickPgButtons","next",b(x),a[1][a[0]]))return!1;e(a[1][a[0]+1],x);B.call(q,a[1][a[0]+1]);K("afterclickPgButtons","next",b(x),
a[1][a[0]+1]);m(a[0]+1,a)}return!1});b("#pData",z).click(function(){if(!l())return!1;b("#FormError",C).hide();var a=n();if(-1!==a[0]&&a[1][a[0]-1]){if(!K("onclickPgButtons","prev",b(x),a[1][a[0]])||Y(b("#"+I(a[1][a[0]-1])),oa))return!1;e(a[1][a[0]-1],x);B.call(q,a[1][a[0]-1]);K("afterclickPgButtons","prev",b(x),a[1][a[0]-1]);m(a[0]-1,a)}return!1});K("afterShowForm",b(x),M);V=n();m(V[0],V)}}})},viewGridRow:function(a,c){return this.each(function(){function d(){!0!==p.closeOnEscape&&!0!==p.navkeys[0]||
setTimeout(function(){b("#cData").focus()},0)}function e(a){var c,d,e=0,f=D.getInd.call(l,a,!0),g;f&&(b("td",f).each(function(a){g=y[a];c=g.name;d=g.editrules&&!0===g.editrules.edithidden?!1:!0===g.hidden?!0:!1;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&(c=I("v_"+c),b("#"+c+" span",r).html(t.getDataFieldOfCell.call(k,f,a).html()),d&&b("#"+c,r).parents("tr:first").hide(),e++)}),0<e&&b("#id_g",r).val(a))}function g(a,c){var d=c[1].length-1;0===a?b("#pData",u).addClass(L):void 0!==c[1][a-1]&&Y(b("#"+I(c[1][a-
1])),L)?b("#pData",u).addClass(L):b("#pData",u).removeClass(L);a===d?b("#nData",u).addClass(L):void 0!==c[1][a+1]&&Y(b("#"+I(c[1][a+1])),L)?b("#nData",u).addClass(L):b("#nData",u).removeClass(L)}function f(){var a=D.getDataIDs.call(l),c=b("#id_g",r).val();return[b.inArray(c,a),a]}var k=this,l=b(k),m=k.p;if(k.grid&&null!=m&&a){var n=m.id,p=b.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,closeOnEscape:!1,labelswidth:"30%",navkeys:[!1,38,40],onClose:null,
beforeShowForm:null,beforeInitData:null,viewPagerButtons:!0,removemodal:!0},D.getGridRes.call(l,"view"),t.view||{},m.formViewing||{},c||{}),q="#ViewGrid_"+I(n),r="#ViewTbl_"+I(n),u=r+"_2",A="ViewGrid_"+n,B="ViewTbl_"+n,v=p.commonIconClass,n={themodal:"viewmod"+n,modalhead:"viewhd"+n,modalcontent:"viewcnt"+n,resizeAlso:A},x="#"+I(n.themodal),w=m.gBox,y=m.colModel,C=1,z=0,h=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("View");a.unshift(p);return bb.apply(k,a)},E=function(){t.hideModal(x,
{gb:w,jqm:p.jqModal,onClose:p.onClose,removemodal:p.removemodal})},H=U.call(k,"hover"),L=U.call(k,"disabled"),J=isNaN(p.dataheight)?p.dataheight:p.dataheight+"px",aa=isNaN(p.datawidth)?p.datawidth:p.datawidth+"px",A=b("<div class='"+O.call(k,"dialog.body")+"'><form name='FormPost' id='"+A+"' class='FormGrid' style='width:"+aa+";overflow:auto;position:relative;height:"+J+";'></form></div>"),J=A.children("form.FormGrid"),Q=b("<table id='"+B+"' class='EditTable'><tbody></tbody></table>");b(x).remove();
b(y).each(function(){var b=this.formoptions;C=Math.max(C,b?b.colpos||0:0);z=Math.max(z,b?b.rowpos||0:0)});J.append(Q);if(h("beforeInitData",J)){(function(a,c,d){var e,f,g,h=0,n,q,r=[],w=D.getInd.call(l,a),u;u=O.call(k,"dialog.viewData","DataTD form-view-data");var v=O.call(k,"dialog.viewLabel","CaptionTD form-view-label"),x="<td class='"+v+"' width='"+p.labelswidth+"'>&#160;</td><td class='"+u+" ui-helper-reset'>&#160;</td>",z="",v="<td class='"+v+"'></td><td class='"+u+"'></td>",C=["integer","number",
"currency"],A=0,E=0,B,G,H;for(u=1;u<=d;u++)z+=1===u?x:v;b(y).each(function(){(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==b.inArray(this.formatter,C)?A=Math.max(A,parseInt(this.width,10)):E=Math.max(E,parseInt(this.width,10)))});B=0!==A?A:0!==E?E:0;b(y).each(function(a){e=this.name;G=!1;q=(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";H="boolean"!==typeof this.viewable?
...
cloneToTop:!1,hideEmptyPagerParts:!0,alertwidth:200,alertheight:"auto",alerttop:null,removemodal:!0,alertleft:null,alertzIndex:null,iconsOverText:!1},D.getGridRes.call(n,"nav"),t.nav||{},m.navOptions||{},c||{});q.position=q.position||("rtl"===m.direction?"right":"left");var r,u=m.idSel,A=m.gBox,B=q.commonIconClass,v={themodal:"alertmod_"+p,modalhead:"alerthd_"+p,modalcontent:"alertcnt_"+p},x=function(){return function(){var a=document.documentElement,c=window,d=1024,e=768,f=n.closest(".ui-jqgrid").offset();
void 0===b("#"+I(v.themodal))[0]&&(q.alerttop||q.alertleft||(void 0!==c.innerWidth?(d=c.innerWidth,e=c.innerHeight):null!=a&&void 0!==a.clientWidth&&0!==a.clientWidth&&(d=a.clientWidth,e=a.clientHeight),d=d/2-parseInt(q.alertwidth,10)/2-f.left,e=e/2-25-f.top),t.createModal.call(l,v,"<div class='"+O.call(l,"dialog.body")+"'><div>"+q.alerttext+"</div></div>",{gbox:A,jqModal:q.jqModal,drag:!0,resize:!0,caption:q.alertcap,top:null!=q.alerttop?q.alerttop:e,left:null!=q.alertleft?q.alertleft:d,width:q.alertwidth,
height:q.alertheight,closeOnEscape:q.closeOnEscape,zIndex:q.alertzIndex,removemodal:q.removemodal},m.gView,b(A)[0],!1));t.viewModal.call(l,"#"+I(v.themodal),{gbox:A,toTop:q.alertToTop,jqm:q.jqModal});var g=b("#"+I(v.modalhead)).find(".ui-jqdialog-titlebar-close");g.attr({tabindex:"0",href:"#",role:"button"});setTimeout(function(){g.focus()},50)}}(),w,y=function(a){if(13===a.which&&(a=b(this).find(".ui-pg-button").filter(":focus"),0<a.length)){var c=a[0].id,c=c.substr(0,0<b(this).closest(".ui-jqgrid-toppager").length?
c.length-p.length-5:c.length-p.length-1)+"mod"+m.id,d=b(".ui-jqdialog").filter(":visible").map(function(){return this.id});if(0>b.inArray(c,d))return a.trigger("click"),!1}},C=U.call(l,"hover"),z=U.call(l,"disabled"),h=O.call(l,"navButton","ui-pg-button");if(l.grid){l.modalAlert=x;void 0===a&&(m.pager?(a=m.pager,m.toppager&&(q.cloneToTop=!0)):m.toppager&&(a=m.toppager));var E=1,H,L,J,aa,Q,F,G=["left","center","right"],M="<div class='"+O.call(l,"navButton","ui-pg-button "+U.call(l,"disabled"))+"'><span class='ui-separator'></span></div>",
K=function(){Y(this,z)||b(this).addClass(C)},P=function(){b(this).removeClass(C)},R=function(){Y(this,z)||(b.isFunction(q.addfunc)?q.addfunc.call(l):D.editGridRow.call(n,"new",e));return!1},N=function(a,c,d){if(!Y(this,z)){var e=m.selrow;e?b.isFunction(a)?a.call(l,e):D[c].call(n,e,d):x()}return!1},V=function(){return N.call(this,q.editfunc,"editGridRow",d)},oa=function(){return N.call(this,q.viewfunc,"viewGridRow",k)},W=function(){var a;Y(this,z)||(m.multiselect?(a=m.selarrrow,0===a.length&&(a=null)):
a=m.selrow,a?b.isFunction(q.delfunc)?q.delfunc.call(l,a):D.delGridRow.call(n,a,g):x());return!1},Z=function(){Y(this,z)||(b.isFunction(q.searchfunc)?q.searchfunc.call(l,f):D.searchGrid.call(n,f));return!1},X=function(){if(!Y(this,z)){b.isFunction(q.beforeRefresh)&&q.beforeRefresh.call(l);m.search=!1;m.resetsearch=!0;try{if("currentfilter"!==q.refreshstate){m.postData.filters="";try{b("#fbox_"+u).jqFilter("resetFilter")}catch(T){}b.isFunction(l.clearToolbar)&&l.clearToolbar(!1)}}catch(T){}switch(q.refreshstate){case "firstpage":n.trigger("reloadGrid",
...
(q.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+g+"</span>":"")+"</div>");b(w).append(e);e.attr({title:q[a+"title"]||"",id:c||a+"_"+J}).click(d).hover(K,P);return e};q.cloneToTop&&m.toppager&&(E=2);for(H=0;H<E;H++){w=b("<div class='ui-pg-table navtable' role='toolbar' style='float:"+("rtl"===m.direction?"right":"left")+";table-layout:auto;'></div>");0===H?(L=a,J=p,L===m.toppager&&(J+="_top",E=1)):(L=m.toppager,J=p+"_top");q.add&&S("add",e.id,R);q.edit&&S("edit",d.id,V);q.view&&S("view",k.id,
oa);q.del&&S("del",g.id,W);(q.add||q.edit||q.del||q.view)&&b(w).append(M);q.search&&(r=S("search",f.id,Z),f.showOnLoad&&!0===f.showOnLoad&&b(r,w).click());q.refresh&&S("refresh","",X);r=b(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px";b("body").append("<div id='testpg2' class='"+O.call(l,"gBox","ui-jqgrid")+"' style='font-size:"+r+";visibility:hidden;' ></div>");r=b(w).clone().appendTo("#testpg2").width();b("#testpg2").remove();b(L+"_"+q.position,L).append(w);if(q.hideEmptyPagerParts)for(aa=
0;aa<G.length;aa++)G[aa]!==q.position&&(F=b(L+"_"+G[aa],L),0===F.length||0===F[0].childNodes.length?F.hide():1===F[0].childNodes.length&&(Q=F[0].firstChild,!b(Q).is("table.ui-pg-table")||0!==Q.rows&&0!==Q.rows[0].cells.length||F.hide()));m._nvtd&&(r>m._nvtd[0]&&(b(L+"_"+q.position,L).width(r),m._nvtd[0]=r),m._nvtd[1]=r);l.nav=!0;w.on("keydown.jqGrid",y)}n.triggerHandler("jqGridResetFrozenHeights")}}})},navButtonAdd:function(a,c){"object"===typeof a&&(c=a,a=void 0);return this.each(function(){var d=
...
dataIndex:q,value:r,displayValue:u,startRow:c,cnt:1,keys:p,summary:[]};q={cnt:1,pos:e.length,summary:b.extend(!0,[],d.summary)};0===c?(e.push(n),f[m]=r,g[m]=q):"object"===typeof r||(b.isArray(k)&&b.isFunction(k[m])?k[m].call(this,f[m],r,m,d):f[m]===r)?t?(e.push(n),f[m]=r,g[m]=q):(q=g[m],q.cnt+=1,e[q.pos].cnt=q.cnt):(e.push(n),f[m]=r,t=!0,g[m]=q);r=e[q.pos];var v;for(v=0;v<q.summary.length;v++)u=q.summary[v],p=b.isArray(u.st)?u.st[n.idx]:u.st,b.isFunction(p)?u.v=p.call(this,u.v,u.nm,a,n):(u.v=B.call(b(this),
...
[{header:{resizeDiv:!1,resizedRows:{iRowStart:-1,iRowEnd:-1}},resizeFooter:!1,body:{resizeDiv:!0,resizedRows:{iRowStart:m,iRowEnd:k.length?k[0].rowIndex-1:-1}}}]);this.fixScrollOffsetAndhBoxPadding();b(this).triggerHandler("jqGridGroupingClickGroup",[a,p]);b.isFunction(d.onClickGroup)&&d.onClickGroup.call(this,a,p)});return!1},groupingRender:function(a,c){function d(a,c,d,e,k){var h=q[a],l,n="",p,w,v,x=0,y,z,C,A=!0;if(0!==c&&0!==q[a].idx)for(l=a;0<=l;l--)if(q[l].idx===q[a].idx-c){h=q[l];break}a=h.cnt;
for(y=void 0===k?e:0;y<u;y++){c="&#160;";l=r[y];for(p=0;p<h.summary.length;p++)if(w=h.summary[p],z=b.isArray(w.st)?w.st[d.idx]:w.st,C=b.isArray(l.summaryTpl)?l.summaryTpl[d.idx]:l.summaryTpl||"{0}",w.nm===l.name){"string"===typeof z&&"avg"===z.toLowerCase()&&(w.sd&&w.vd?w.v/=w.vd:w.v&&0<a&&(w.v/=a));try{w.groupCount=h.cnt,w.groupIndex=h.dataIndex,w.groupValue=h.value,v=g.formatter("",w.v,y,w)}catch(ia){v=w.v}c=t.format(C,v);l.summaryFormat&&(c=l.summaryFormat.call(g,d,c,v,l,w));break}w=p=!1;void 0!==
k&&A&&!l.hidden&&(c=k,A=!1,1<e&&(p=!0,x=e-1),w=l.align,l.align="rtl"===f.direction?"right":"left",m.iconColumnName=l.name);0<x&&!l.hidden&&"&#160;"===c?(w&&(l.align=w),x--):(n+="<td role='gridcell' "+g.formatCol(y,1,"")+(p?"colspan='"+e+"'":"")+">"+c+"</td>",w&&(l.align=w))}return n}var e="",g=this[0],f=g.p,k=0,l=[],m=f.groupingView,n=b.makeArray(m.groupSummary),p=m.groupField.length,q=m.groups,r=f.colModel,u=r.length,A=f.page,B=D.getGuiStyles.call(g,"gridRow","jqgroup ui-row-"+f.direction),v=D.getGuiStyles.call(g,
"gridRow","jqfoot ui-row-"+f.direction);b.each(r,function(a,b){var c;for(c=0;c<p;c++)if(m.groupField[c]===b.name){l[c]=a;break}});n.reverse();b.each(q,function(x,w){var y,C=f.id+"ghead_"+w.idx,z=C+"_"+x,h=b.isFunction(m.groupCollapse)?m.groupCollapse.call(g,{group:w,rowid:z}):m.groupCollapse,E,H;H=0;var D,J;D=p-1===w.idx;var I=null!=w.parentGroup?w.parentGroup.collapsed:!1;J="<span style='cursor:pointer;margin-"+("rtl"===f.direction?"right:":"left:")+12*w.idx+"px;' class='"+m.commonIconClass+" "+
(h?m.plusicon:m.minusicon)+" tree-wrap' onclick=\"jQuery('#"+t.jqID(f.id).replace("\\","\\\\")+"').jqGrid('groupingToggle','"+z+"', this);return false;\"></span>";if(m._locgr&&!(w.startRow+w.cnt>(A-1)*c&&w.startRow<A*c))return!0;I&&(h=!0);void 0!==h&&(w.collapsed=h);k++;try{b.isArray(m.formatDisplayField)&&b.isFunction(m.formatDisplayField[w.idx])?(w.displayValue=m.formatDisplayField[w.idx].call(g,w.displayValue,w.value,r[l[w.idx]],w.idx,m),y=w.displayValue):y=g.formatter(z,w.displayValue,l[w.idx],
w.value)}catch(Q){y=w.displayValue}e+="<tr id='"+z+"' data-jqgrouplevel='"+w.idx+"' "+(h&&I?"style='display:none;' ":"")+"role='row' class='"+B+" "+C+"'>";C=b.isFunction(m.groupText[w.idx])?m.groupText[w.idx].call(g,y,w.cnt,w.summary):t.template(m.groupText[w.idx],y,w.cnt,w.summary);"string"!==typeof C&&"number"!==typeof C&&(C=y);"header"===m.groupSummaryPos[w.idx]?(y=1,"cb"!==r[0].name&&"cb"!==r[1].name||y++,"subgrid"!==r[0].name&&"subgrid"!==r[1].name||y++,e+=d(x,0,w,y,J+"<span class='cell-wrapper'>"+
C+"</span>")):e+="<td role='gridcell' style='padding-left:"+12*w.idx+"px;' colspan='"+u+"'>"+J+C+"</td>";e+="</tr>";if(D){D=q[x+1];y=w.startRow;J=void 0!==D?D.startRow:q[x].startRow+q[x].cnt;m._locgr&&(H=(A-1)*c,H>w.startRow&&(y=H));for(;y<J&&a[y-H];y++)e+=a[y-H].join("");if("header"!==m.groupSummaryPos[w.idx]){if(void 0!==D){for(E=0;E<m.groupField.length&&D.dataIndex!==m.groupField[E];E++);k=m.groupField.length-E}for(H=0;H<k;H++)n[H]&&(e+="<tr data-jqfootlevel='"+(w.idx-H)+(h&&(0<w.idx-H||!m.showSummaryOnHide)?
"' style='display:none;'":"'")+" role='row' class='"+v+"'>",e+=d(x,H,q[w.idx-H],0),e+="</tr>");k=E}}});this.off("jqGridShowHideCol.groupingRender").on("jqGridShowHideCol.groupingRender",function(){var a=f.iColByName[m.iconColumnName],c,d,e;if(0<=b.inArray("header",m.groupSummaryPos)){for(c=0;c<r.length;c++)if(!r[c].hidden){e=c;break}if(void 0!==e&&a!==e){for(c=0;c<g.rows.length;c++)d=g.rows[c],b(d).hasClass("jqgroup")&&(b(d.cells[e]).html(d.cells[a].innerHTML),b(d.cells[a]).html("&nbsp;"));m.iconColumnName=
...
if(null!=h&&!1===h[0]){F=!0;try{var n=t.getRelativeRect.call(p,c.td);A.call(p,J,h[1],I,{top:n.top,left:n.left+b(p).closest(".ui-jqgrid").offset().left})}catch(Z){v(h[1])}return!1}"date"===e&&!0!==g.sendFormatted&&(m=b.unformat.date.call(p,m,d));K&&!0===f.NullIfEmpty&&""===m&&(m="null");x[d.name]=m}),!F))))if(m=a,D=r.prmNames,z=!1===r.keyName?D.id:r.keyName,x&&(x[D.oper]=D.editoper,void 0===x[z]||""===x[z]?x[z]=a:E.id!==r.idPrefix+x[z]&&(E=t.stripPref(r.idPrefix,a),void 0!==r._index[E]&&(r._index[x[z]]=
r._index[E],delete r._index[E]),a=r.idPrefix+x[z],H.attr("id",a),r.selrow===m&&(r.selrow=a),b.isArray(r.selarrrow)&&(E=b.inArray(m,r.selarrrow),0<=E&&(r.selarrrow[E]=a)),r.multiselect&&(E="jqg_"+r.id+"_"+a,H.find("input.cbox").attr("id",E).attr("name",E))),x=b.extend({},x,r.inlineData||{},n.extraparam)),K)q.jqGrid("progressBar",{method:"show",loadtype:n.saveui,htmlcontent:n.savetext}),y=b.extend({},x,y),y[z]=t.stripPref(r.idPrefix,y[z]),r.autoEncodeOnEdit&&b.each(y,function(a,b){B(b)||(y[a]=t.oldEncodePostedData(b))}),
b.ajax(b.extend({url:B(n.url)?n.url.call(p,y[z],u,y,n):n.url,data:t.serializeFeedback.call(p,B(n.serializeSaveData)?n.serializeSaveData:r.serializeRowData,"jqGridInlineSerializeSaveData",y),type:B(n.mtype)?n.mtype.call(p,u,n,y[z],y):n.mtype,complete:function(c,d){q.jqGrid("progressBar",{method:"hide",loadtype:n.saveui});if((300>c.status||304===c.status)&&(0!==c.status||4!==c.readyState)){var e,f;f=q.triggerHandler("jqGridInlineSuccessSaveRow",[c,a,n]);if(null==f||!0===f)f=[!0,x];f[0]&&B(n.successfunc)&&
...
c.newColOrder));e++})},t=function(c){if(n[c]===n[a])return b(this).after(p[q]),u(),!0},B=function(c){if(n[c]===n[a])return b(this).before(p[q]),u(),!0},v=function(b){if(n[b]===n[a]&&void 0!==n[b])return l[n[b]].startColumnName=d.colModel[b].name,!0};u();if(l&&void 0!==l[n[a]])for(k=l[n[a]],g=0;g<k.numberOfColumns;g++){if(e=d.iColByName[k.startColumnName]+g,!d.colModel[e].hidden&&!d.colModel[e].hidedlg){r(t,q-1,!0);r(B,q+1);r(v);break}}else!l||(p=m.find("li"),g=r(function(b){if(b===a)return!0}),g+
...
a.apply(c,b.makeArray(arguments).slice(2)))}var d=this,e=d[0],g=e.p,f,k,l,m,n,p=g.colModel,q=p.length,r=g.colNames,u=function(a){return na&&na.prototype&&a.data(na.prototype.widgetFullName||na.prototype.widgetName)||a.data("ui-multiselect")||a.data("multiselect")};if(!b("#colchooser_"+I(g.id)).length){f=b('<div id="colchooser_'+g.id+'" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>');k=b("select",f);a=b.extend({width:400,height:240,classname:null,
...
"colModel");try{for(r in f)f.hasOwnProperty(r)&&(l=u[g].name,"cb"!==l&&"rn"!==l&&"subgrid"!==l&&f.hasOwnProperty(r)&&u[g]&&(k[l]=f[r]),g++);f=k}catch(B){}}e.helper.dropped=!0;a.beforedrop&&b.isFunction(a.beforedrop)&&(l=a.beforedrop.call(this,c,e,f,b("#"+I(d.p.id)),b(this)),void 0!==l&&null!==l&&"object"===typeof l&&(f=l));if(e.helper.dropped){var t;a.autoid&&(b.isFunction(a.autoid)?t=a.autoid.call(this,f):(t=Math.ceil(1E3*Math.random()),t=a.autoidprefix+t));b("#"+I(this.id)).jqGrid("addRowData",
...
k={grouping:!0,groupingView:f},l=b.extend({totals:!1,useColSpanStyle:!1,trimByCollect:!0,skipSortByX:!1,skipSortByY:!1,caseSensitive:!1,footerTotals:!1,groupSummary:!0,groupSummaryPos:"header",frozenStaticCols:!1,defaultFormatting:!0,data:a},c||{}),m,n,p,q=a.length,r,u,A,B,v,x,w=l.xDimension,y=l.yDimension,C=l.aggregates,z,q=l.totalText||l.totals||l.rowTotals||l.totalHeader,h,E=e(w)?w.length:0;B=e(y)?y.length:0;var H=e(C)?C.length:0,D=B-(1===H?1:0),J=[],I=[],Q=[],e=[],F=["pivotInfos"],G=Array(H),
...
0>b.inArray(h,l.iRows)&&(l.iRows.push(h),l.rows.push(g)))};if(0===E||0===H)throw"xDimension or aggregates options are not set!";Y=n(w,l.skipSortByX,l.compareVectorsByX);T=n(y,l.skipSortByY,l.compareVectorsByY);c.xIndex=Y;c.yIndex=T;for(n=0;n<E;n++)p=w[n],u={name:"x"+n,label:null!=p.label?b.isFunction(p.label)?p.label.call(d,p,n,l):p.label:p.dataName,frozen:l.frozenStaticCols},n<E-1&&!p.skipGrouping&&!p.additionalProperty&&(f.groupField.push(u.name),f.groupSummary.push(l.groupSummary),f.groupSummaryPos.push(l.groupSummaryPos)),
u=b.extend(u,p),delete u.dataName,delete u.footerText,p.additionalProperty?F.push(u.name):(Q.push(u),k.sortname=u.name);2>E&&(k.grouping=!1);f.hideFirstGroupCol=!0;for(n=0;n<B;n++)r=y[n],I.push(r.totals||r.rowTotals||r.totalText||r.totalHeader?!0:!1);Z=T.getItem(0);v(0,B-1,0);f=T.getIndexLength();for(u=1;u<f;u++){N=T.getItem(u);n=T.getIndexOfDifferences(N,Z);for(p=D-1;p>=n;p--)I[p]&&v(1,p,u-1);Z=N;v(0,B-1,u)}for(n=D-1;0<=n;n--)I[n]&&v(1,n,f-1);q&&v(2);Z=T.getItem(0);for(p=0;p<D;p++)J.push({useColSpanStyle:l.useColSpanStyle,
groupHeaders:[{titleText:Z[p],startColumnName:1===H?"y0":"y0a0",numberOfColumns:H}]});for(u=1;u<f;u++){N=T.getItem(u);n=T.getIndexOfDifferences(N,Z);O(u,n,Z);for(p=D-1;p>=n;p--)J[p].groupHeaders.push({titleText:N[p],startColumnName:"y"+u+(1===H?"":"a0"),numberOfColumns:H});for(p=0;p<n;p++)X=J[p].groupHeaders,X[X.length-1].numberOfColumns+=H;Z=N}O(f,0,Z);if(q)for(n=0;n<D;n++)J[n].groupHeaders.push({titleText:n<D-1?"":l.totalHeader||"",startColumnName:"t"+(1===H?"":"a0"),numberOfColumns:H});O=Y.getIndexLength();
for(B=0;B<O;B++){p=Y.getItem(B);v={iX:B,x:p};U={pivotInfos:v};for(n=0;n<E;n++)U["x"+n]=p[n];R=Y.getIndexesOfSourceData(B);if(q)for(p=0;p<H;p++)G[p]=ba(p);Z=null;ea();for(u=0;u<f;u++){N=T.getItem(u);V=T.getIndexesOfSourceData(u);for(p=0;p<H;p++){null!==Z&&da(u-1,N,Z,p);S=[];for(n=0;n<V.length;n++)A=V[n],0<=b.inArray(A,R)&&S.push(A);if(0<S.length){x=Array(S.length);W=C[p];z=new P(W.aggregator,d,c);for(A=0;A<S.length;A++)n=S[A],m=a[n],x[A]=m,z.calc(m[W.member],W.member,m,n,a),q&&(h=G[p],h.calc(m[W.member],
W.member,m,n,a),h=h.groupInfo,0>b.inArray(n,h.iYs)&&(h.iYs.push(u),h.ys.push(N)),0>b.inArray(n,h.iRows)&&(h.iRows.push(n),h.rows.push(m))),ha(N,Z,W,p,m,n,u);m="y"+u+(1===H?"":"a"+p);z.getResult(U,m);v[m]={colType:0,iY:u,y:N,iA:p,a:W,iRows:S,rows:x}}}Z=N}if(null!==Z)for(p=0;p<H;p++)da(f-1,Z,Z,p);if(q)for(p=0;p<H;p++)m="t"+(1===H?"":"a"+p),h=G[p],h.getResult(U,m),h=h.groupInfo,v[m]={colType:2,iA:p,a:C[p],iRows:h.iRows,rows:h.rows,iYs:h.iYs,ys:h.ys};e.push(U)}if(l.footerTotals||l.colTotals){q=e.length;
for(n=0;n<E;n++)g["x"+n]=w[n].footerText||"";for(n=E;n<Q.length;n++){m=Q[n].name;z=new P(l.footerAggregator||"sum",d,c);for(A=0;A<q;A++)U=e[A],z.calc(U[m],m,U,A,e);z.getResult(g,m)}}c.colHeaders=J;return{colModel:Q,additionalProperties:F,options:c,rows:e,groupOptions:k,groupHeaders:J,summary:g}},jqPivot:function(a,c,d,e){return this.each(function(){function g(){var e=l.pivotSetup.call(k,a,c),g=e.groupHeaders,p=e.summary,q=0,r;for(r in p)p.hasOwnProperty(r)&&q++;p=0<q?!0:!1;q=e.groupOptions.groupingView;
...
"&#160;",e);c.append(f)})},u=function(a,c){var d,f,k,m,n,p=e.jsonReader.subgrid,r=t.getAccessor(a,p.root);if(null!=r)for(f=0;f<r.length;f++){n=r[f];d=b("<tr class='"+l+"'></tr>");if(!0===p.repeatitems)for(p.cell&&(n=n[p.cell]),k=0;k<n.length;k++)q(d,n[k]||"&#160;",k);else if(m=g.mapping||g.name,m.length)for(k=0;k<m.length;k++)q(d,n[m[k]]||"&#160;",k);c.append(d)}},A=function(a,c,h){var l,m;l=f("legacyTable","ui-jqgrid-legacy-subgrid"+(!0===e.altRows&&b(d).jqGrid("isBootstrapGuiStyle")?" table-striped":
...
(f[k][p]=parseInt(f[k][p],10)-g)}}})},addChildNode:function(a,c,d,e){var g=b(this),f=g[0],k=f.p,l=D.getInd;if(d){var m,n,p,q,r;m=0;var u=c,A,B,v=k.treeReader.expanded_field;B=k.treeReader.leaf_field;var x=k.treeReader.level_field,w=k.treeReader.parent_id_field,y=k.treeReader.left_field,C=k.treeReader.right_field,z=k.treeReader.loaded;void 0===e&&(e=!1);if(null==a){r=k.data.length-1;if(0<=r)for(;0<=r;)m=Math.max(m,parseInt(k.data[r][k.localReader.id],10)),r--;a=m+1}var h=l.call(g,c);A=!1;if(void 0===
c||null===c||""===c)u=c=null,m="last",q=k.tree_root_level,r=k.data.length+1;else{m="after";n=k._index[c];p=k.data[n];c=p[k.localReader.id];r=l.call(g,c);q=parseInt(p[x],10)+1;var E=D.getFullTreeNode.call(g,p);if(E.length){var H,I,J;for(H=0;H<E.length;H++)J=E[H][k.localReader.id],I=l.call(g,J),I>r&&(r=I,u=J)}r++;p[B]&&(A=!0,p[v]=!0,b(f.rows[h]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(k.treeIcons.leaf+" tree-leaf").addClass(k.treeIcons.commonIconClass).addClass(k.treeIcons.minus+
" tree-minus"),k.data[n][B]=!1,p[z]=!0)}l=r+1;void 0===d[v]&&(d[v]=!1);void 0===d[z]&&(d[z]=!1);d[x]=q;void 0===d[B]&&(d[B]=!0);"adjacency"===k.treeGridModel&&(d[w]=c);if("nested"===k.treeGridModel){var K;if(null!==c){B=parseInt(p[C],10);k=t.from.call(f,k.data);k=k.greaterOrEquals(C,B,{stype:"integer"});x=k.select();if(x.length)for(K in x)x.hasOwnProperty(K)&&(x[K][y]=x[K][y]>B?parseInt(x[K][y],10)+2:x[K][y],x[K][C]=x[K][C]>=B?parseInt(x[K][C],10)+2:x[K][C]);d[y]=B;d[C]=B+1}else{B=parseInt(D.getCol.call(g,
C,!1,"max"),10);x=t.from.call(f,k.data).greater(y,B,{stype:"integer"}).select();if(x.length)for(K in x)x.hasOwnProperty(K)&&(x[K][y]=parseInt(x[K][y],10)+2);x=t.from.call(f,k.data).greater(C,B,{stype:"integer"}).select();if(x.length)for(K in x)x.hasOwnProperty(K)&&(x[K][C]=parseInt(x[K][C],10)+2);d[y]=B+1;d[C]=B+2}}if(null===c||D.isNodeLoaded.call(g,p)||A)D.addRowData.call(g,a,d,m,u),D.setTreeNode.call(g,r,l);p&&!p[v]&&e&&b(f.rows[h]).find("div.treeclick").click()}}});var db="mousedown",Sa="mousemove",
