...
"currency"===c.formatter?a=parseFloat(a):"integer"===c.formatter&&(a=parseInt(a,10))):(d=String(a).toLowerCase(),c=null!=c.editoptions&&"string"===typeof c.editoptions.value?c.editoptions.value.split(":"):["yes","no"],0<=b.inArray(d,["1","true",c[0].toLowerCase()])?a=!0:0<=b.inArray(d,["0","false",c[1].toLowerCase()])&&(a=!1));return a},parseDataToHtml:function(a,c,d,e,f,g,k){var m=this,l=m.p,n=b(m),p,q,r,t,w,y,x,D=!1,v=[],A=[],E=!0!==l.altRows||n.jqGrid("isBootstrapGuiStyle")?"":l.altclass,F=l.grouping?
!0===l.groupingView.groupCollapse:!1,h=parseInt(l.rowNum,10),C,K=b.fn.jqGrid,H=!0===l.treeGrid&&-1<l.treeANode?m.rows[l.treeANode].rowIndex+1:m.rows.length,M=m.formatCol,I=function(b,a,c,d,e,h){a=m.formatter(b,a,c,e,"add",h);return"<td role='gridcell' "+M(c,d,a,e,b,h)+">"+a+"</td>"},L=function(a,c,d,e,h){var f="&nbsp;",g=!0;b.isFunction(l.hasMultiselectCheckBox)&&(g=l.hasMultiselectCheckBox.call(m,{rowid:a,iRow:d,iCol:c,data:h}));g&&(f="<input type='checkbox' id='jqg_"+l.id+"_"+a+"' class='cbox' name='jqg_"+
l.id+"_"+a+"'"+(e?" checked='checked' aria-checked='true'":" aria-checked='false'")+"/>");return"<td role='gridcell' "+M(c,d,"",null,a,!0)+">"+f+"</td>"},Z=function(b,a,c,d){c=(parseInt(c,10)-1)*parseInt(d,10)+1+a;return"<td role='gridcell' class='"+K.getGuiStyles.call(n,"rowNum","jqgrid-rownum")+"' "+M(b,a,c,null,a,!0)+">"+c+"</td>"};1>=H&&(l.rowIndexes={});if("local"===l.datatype&&!l.deselectAfterSort||l.multiPageSelection)D=!0;g&&(h*=g+1);for(g=0;g<Math.min(a,h);g++){t=c[g];w=d[g];y=null!=e?e[g]:
w;p=1===f?0:f;q=1===(p+g)%2?E:"";D&&(l.multiselect?(r=-1!==b.inArray(t,l.selarrrow))&&null===l.selrow&&(l.selrow=t):r=t===l.selrow);x=v.length;v.push("");for(p=0;p<l.colModel.length;p++)switch(C=l.colModel[p].name,C){case "rn":v.push(Z(p,g,l.page,l.rowNum));break;case "cb":v.push(L(t,p,g,r,w));break;case "subgrid":v.push(K.addSubGridCell.call(n,p,g+f,t,w));break;default:v.push(I(t,w[C],p,g+f,y,w))}v[x]=m.constructTr(t,F,q,w,y,r);v.push("</tr>");l.rowIndexes[t]=H;H++;l.grouping&&K.groupingPrepare&&
(A.push(v),l.groupingView._locgr||K.groupingPrepare.call(n,w,g),v=[]);v.length>l.maxItemsToJoin&&(v=[v.join("")])}l.grouping&&K.groupingRender&&(k&&(l.groupingView._locgr=!0),v=[K.groupingRender.call(n,A,h)],u.clearArray(A));return v},getMethod:function(a){return this.getAccessor(b.fn.jqGrid,a)},extend:function(a){b.extend(b.fn.jqGrid,a);this.no_legacy_api||b.fn.extend(a)}});var da=u.clearArray,G=u.jqID,gb=u.getGridComponentIdSelector,hb=u.getGridComponentId,bb=u.getGridComponent,Na=u.stripPref,Da=
u.randId,pa=u.getAccessor,cb=u.convertOnSaveLocally,lb=u.stripHtml,qb=u.htmlEncode,Oa=u.htmlDecode,ua=u.mergeCssClasses,aa=u.hasOneFromClasses,R=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("");a.unshift(this.p);return u.feedback.apply(this,a)};b.fn.jqGrid=function(a){var c=b.fn.jqGrid,d;if("string"===typeof a){d=c[a];if(!d)throw"jqGrid - No such method: "+a;return d.apply(this,b.makeArray(arguments).slice(1))}return this.each(function(){if(!this.grid){var d=this,f,g,k=b(d),m=b.isFunction,
l=b.isArray,n=b.extend,p=b.inArray,q=b.trim,r=b.each,t=c.setSelection,w=c.getGridRes,y=m(Aa.fatalError)?Aa.fatalError:alert,x=a.locale||Aa.locale||"en-US",D=null!=Ja[x]&&"boolean"===typeof Ja[x].isRTL?Ja[x].isRTL?"rtl":"ltr":"ltr",v=a.iconSet||Aa.iconSet||("bootstrap"===(a.guiStyle||Aa.guiStyle)||"bootstrapPrimary"===(a.guiStyle||Aa.guiStyle)?"glyph":"jQueryUI"),A=a.guiStyle||Aa.guiStyle||"jQueryUI",E=function(b){return c.getIconRes.call(d,b)},F=function(b,a){return k.jqGrid("getGuiStyles",b,a)};
null==a&&(a={datatype:"local"});void 0!==a.datastr&&l(a.datastr)&&(g=a.datastr,a.datastr=[]);void 0!==a.data&&(f=a.data,a.data=[]);null!=u.formatter&&null!=u.formatter.unused||y("CRITICAL ERROR!!!\n\n\nOne uses probably\n\n\t$.extend($.jgrid.defaults, {...});\n\nto set default settings of jqGrid instead of the usage the DEEP version of jQuery.extend (with true as the first parameter):\n\n\t$.extend(true, $.jgrid.defaults, {...});\n\nOne other possible reason:\n\nyou included some OLD version of language file (grid.locale-en.js for example) AFTER jquery.jqGrid.min.js. For example all language files of jqGrid 4.7.0 uses non-deep call of jQuery.extend.\n\n\nSome options of jqGrid could still work, but another one will be broken.");
...
u.search||{}),formViewing:n(!0,{commonIconClass:E("form.common"),prevIcon:E("form.prev"),nextIcon:E("form.next"),closeicon:[!0,"left",E("form.cancel")]},u.view||{}),formDeleting:n(!0,{commonIconClass:E("form.common"),delicon:[!0,"left",E("form.del")],cancelicon:[!0,"left",E("form.cancel")]},u.del||{})},a||{}),C=function(b){var a=u.getRes(h,b);return void 0!==a?a:w.call(k,"defaults."+b)};h.recordpos=h.recordpos||("rtl"===h.direction?"left":"right");h.subGridOptions.openicon="rtl"===h.direction?E("subgrid.openRtl"):
...
if(h.multiselect&&d&&0<d.length)for(b=0;b<d.length;b++)d[b]!==c&&t.call(a,d[b],!1,null);c&&t.call(a,c,!1,null)}e.scrollLeft=f;a.unbind(".selectionPreserver",g)};a.bind("jqGridGridComplete.selectionPreserver",g)}};d.grid=z;R.call(d,"beforeInitGrid");h.iColByName=H(h.colModel);h.iPropByName=M(h.additionalProperties);var B=b("<div class='"+F("gView","ui-jqgrid-view")+"' role='grid' aria-multiselectable='"+!!h.multiselect+"'></div>"),N=u.msie,ca;h.direction=q(h.direction.toLowerCase());-1===p(h.direction,
["ltr","rtl"])&&(h.direction="ltr");ca=h.direction;b(B).insertBefore(d);k.removeClass("scroll").appendTo(B);var Q=b("<div class='"+F("gBox","ui-jqgrid")+"'></div>");b(Q).attr({id:h.gBoxId,dir:ca}).insertBefore(B);b(B).attr("id",h.gViewId).appendTo(Q);b("<div class='"+F("overlay","jqgrid-overlay")+"' id='lui_"+h.id+"'></div>").insertBefore(B);b("<div class='"+F("loading","loading")+"' id='load_"+h.id+"'>"+C("loadtext")+"</div>").insertBefore(B);k.attr({role:"presentation","aria-labelledby":"gbox_"+
...
B[b]=Pa(a):/^\[\w+\]$/.test(a)&&(B[b]=Z(a.substring(1,a.length-1))))},ka=function(b){var a=b.name,c=r?b.xmlmap||a:"local"===n&&!h.dataTypeOrg||"jsonstring"===n||"json"===n||"jsonp"===n?b.jsonmap||a:a;!1!==h.keyName&&!0===b.key&&(h.keyName=a);if("string"===typeof c||m(c))B[a]=c;m(c)||Q(a,c)};for(v=0;v<K;v++)ka(F[v]);K=Ca.length;for(v=0;v<K;v++)x=Ca[v],"object"===typeof x&&null!=x?ka(x):Q(x,x);w=!1===h.keyName?m(q.id)?q.id.call(this,a):q.id:h.keyName;isNaN(w)?m(w)||(N[w]&&(E=N[w].order),r&&("string"===
typeof w&&/^\[\w+\]$/.test(w)?w=Z(w.substring(1,w.length-1)):"string"===typeof w&&/^\w+$/.test(w)&&(w=Pa(w)))):E=Number(w);C=t(a,q.root,!0);if(q.row)if(1===C.length&&"string"===typeof q.row&&/^\w+$/.test(q.row)){K=[];L=C[0].childNodes;ja=L.length;for(x=0;x<ja;x++)H=L[x],1===H.nodeType&&H.nodeName===q.row&&K.push(H);C=K}else C=t(C,q.row,!0);null==C&&l(a)&&(C=a);C||(C=[]);a=C.length;0<a&&0>=h.page&&(h.page=1);ka=parseInt(h.rowNum,10);f&&(ka*=f+1);var F=[],G=[],ha,K=[];for(v=0;v<a;v++){ha=C[v];A=q.repeatitems&&
q.cell?t(ha,q.cell,!0)||ha:ha;M=q.repeatitems&&(r||l(A));D={};ca={};if(r&&!M&&null!=A)for(L=A.childNodes,ja=L.length,x=0;x<ja;x++)H=L[x],1===H.nodeType&&(ca[H.nodeName]=H);for(y in N)N.hasOwnProperty(y)&&(x=N[y],M?(L=A[x.order],r&&null!=L&&(L=L.textContent||L.text)):L=null!=B[y]&&"string"!==typeof B[y]?B[y](A):t(A,"string"===typeof B[y]?B[y]:x.name),1===x.type&&(x=Ca[x.index],null!=x&&m(x.convert)&&(L=x.convert(L,A))),void 0!==L&&(D[y]=L));void 0!==D[w]?ha=void 0!==D[w]?D[w]:Da():(ha=t(ha,l(ha)?E:
...
var d=b(this),e=h.multiSort?[]:"",f={},g=!1,n={},p=[],q=[],t=w.call(k,"formatter.date.srcformat"),v=w.call(k,"formatter.date.newformat");if(!l(h.data))return{};h.multiSort&&sb(e,f);var A=h.grouping?h.groupingView:!1,C,z,E=function(b,a,c){var d=b.index||b.name,f=b.sorttype||"text";n[b.name]={reader:h.dataTypeOrg?b.name:b.jsonmap||b.name,iCol:a,stype:f,srcfmt:"",newfmt:"",sfunc:b.sortfunc||null,isAddProp:!0===c?!0:!1};if("date"===f||"datetime"===f)b.formatter&&"string"===typeof b.formatter&&"date"===
b.formatter?(a=b.formatoptions&&b.formatoptions.srcformat?b.formatoptions.srcformat:t,c=b.formatoptions&&b.formatoptions.newformat?b.formatoptions.newformat:v):a=c=b.datefmt||"Y-m-d",n[b.name].srcfmt=a,n[b.name].newfmt=c;if(h.grouping)for(z=0,C=A.groupField.length;z<C;z++)b.name===A.groupField[z]&&(p[z]=n[d],q[z]=d);h.multiSort||g||b.index!==h.sortname&&b.name!==h.sortname||(e=b.name,g=!0)};r(h.colModel,function(b){E(this,b)});r(h.additionalProperties,function(b){E("string"===typeof this?{name:this}:
...
bn:function(b,a){return"OR"===a?b.orNot().startsWith:b.andNot().startsWith},en:function(b,a){return"OR"===a?b.orNot().endsWith:b.andNot().endsWith},ew:function(b){return b.endsWith},ni:function(b,a){return"OR"===a?b.orNot().equals:b.andNot().equals},"in":function(b){return b.equals},nu:function(b){return b.isNull},nn:function(b,a){return"OR"===a?b.orNot().isNull:b.andNot().isNull}},I=u.from.call(this,h.data);h.ignoreCase&&(I=I.ignoreCase());if(!0===h.search){var M=h.postData.filters;if(M)"string"===
typeof M&&(M=b.parseJSON(M)),a(M);else try{var x=n[h.postData.searchField],I=D[h.postData.searchOper](I)(m(x.reader)?'jQuery.jgrid.getAccessor(this,jQuery("'+h.idSel+'")[0].p.colModel['+x.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+x.reader+"')",h.postData.searchString,n[h.postData.searchField])}catch(F){}}if(h.grouping)for(z=0;z<C;z++)I.orderBy(q[z],A.groupOrder[z],p[z].stype,p[z].srcfmt);h.multiSort?r(e,function(){I.orderBy(this,f[this],n[this].stype,n[this].srcfmt,n[this].sfunc)}):e&&h.sortorder&&
g&&I.orderBy(h.sortname,"DESC"===h.sortorder.toUpperCase()?"d":"a",n[e].stype,n[e].srcfmt,n[e].sfunc);h.lastSelectedData=I.select();var M=parseInt(h.rowNum,10),x=h.lastSelectedData.length,K=parseInt(h.page,10),L=Math.ceil(x/M),ja={};if(h.grouping&&h.groupingView._locgr){h.groupingView.groups=[];var H,N,O;if(h.footerrow&&h.userDataOnFooter){for(N in h.userData)h.userData.hasOwnProperty(N)&&(h.userData[N]=0);O=!0}for(H=0;H<x;H++){if(O)for(N in h.userData)h.userData.hasOwnProperty(N)&&(h.userData[N]+=
parseFloat(h.lastSelectedData[H][N]||0));c.groupingPrepare.call(d,h.lastSelectedData[H],H,M)}}n=I=null;d=h.localReader;ja[d.total]=L;ja[d.page]=K;ja[d.records]=x;ja[d.root]=h.lastSelectedData.slice((K-1)*M,K*M);ja[d.userdata]=h.userData;return ja},$a=function(a){var c=a.outerWidth();0>=c&&(c=b(this).closest(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px",b(document.body).append("<div id='testpg' class='"+F("gBox","ui-jqgrid")+"' style='font-size:"+c+";visibility:hidden;margin:0;padding:0;' ></div>"),
...
"":"px"),width:z.width+"px"}).scroll(z.scrollGrid);h.maxHeight&&b(z.bDiv).css("max-height",h.maxHeight+(isNaN(h.maxHeight)?"":"px"));k.css({width:"1px"});b.support.tbody||2===b(">tbody",d).length&&b(">tbody:gt(0)",d).remove();h.multikey&&b(z.bDiv).bind(u.msie?"selectstart":"mousedown",function(){return!1});Ba&&b(z.bDiv).hide();z.cDiv=document.createElement("div");var Ra=E("gridMinimize.visible"),Xa=E("gridMinimize.hidden"),Ya=C("showhide"),Ua=!0===h.hidegrid?b("<a role='link' class='"+F("titleButton",
...
(h.datatype="jsonstring",h.datastr=h.data,h.data=[]);ka.call(d);h.hiddengrid=!1}}}})};var B=b.fn.jqGrid;u.extend({getGridRes:function(a){var c=this[0];if(!c||!c.grid||!c.p)return null;c=u.getRes(Ja[c.p.locale],a)||u.getRes(Ja["en-US"],a);a=u.getRes(u,a);return"object"!==typeof c||null===c||b.isArray(c)?void 0!==a?a:c:b.extend(!0,{},c,a||{})},getGuiStyles:function(a,c){var d=this instanceof b&&0<this.length?this[0]:this;if(!d||!d.grid||!d.p)return"";var e=d.p.guiStyle||u.defaults.guiStyle||"jQueryUI",
...
b.extend(!0,t,l))}R.call(f,"afterSetRow",{rowid:a,inputData:c,iData:q,iRow:k.rowIndex,tr:k,localData:l,cssProp:d})}catch(u){e=!1}e&&("string"===m?b(k).addClass(d):null!==d&&"object"===m&&b(k).css(d))});return e},addRowData:function(a,c,d,e){0>b.inArray(d,"first last before after afterSelected beforeSelected".split(" "))&&(d="last");var f=!1,g,k,m,l,n,p,q,r,t,w,y;c&&(b.isArray(c)?(p=!0,q=a):(c=[c],p=!1),this.each(function(){var x=this.p,D=c.length,v=b(this),A=this.rows,E=0,F=B.getGridRowById,h=x.colModel,
C,K=x.additionalProperties;p||(void 0!==a?a=String(a):(a=Da(),!1!==x.keyName&&(q=x.keyName,void 0!==c[0][q]&&(a=c[0][q]))));for(r=x.altclass;E<D;){t=c[E];k=[];if(p)try{a=t[q],void 0===a&&(a=Da())}catch(H){a=Da()}y=a;C={};for(l=0;l<h.length;l++)w=h[l],g=w.name,"rn"!==g&&"cb"!==g&&"subgrid"!==g&&(n=cb.call(this,t[g],w,void 0,y,{},l),b.isFunction(w.saveLocally)?w.saveLocally.call(this,{newValue:n,newItem:C,oldItem:{},id:y,cm:w,cmName:g,iCol:l}):void 0!==n&&(C[g]=n));for(l=0;l<K.length;l++)g=K[l],"object"===
...
m=1;break;case "after":if(m=F.call(v,e))b(A[m.rowIndex+1]).hasClass("ui-subgrid")?(b(A[m.rowIndex+1]).after(k),m=m.rowIndex+2):(b(m).after(k),m=m.rowIndex+1);break;case "before":if(m=F.call(v,e))b(m).before(k),m=m.rowIndex-1}}!0===x.subGrid&&B.addSubGrid.call(v,x.iColByName.subgrid,m);x.records++;x.reccount++;0===x.lastpage&&(x.lastpage=1);R.call(this,"afterAddRow",{rowid:a,inputData:c,position:d,srcRowid:e,iRow:m,localData:C,iData:x.data.length-1});E++}!0!==x.altRows||p||v.jqGrid("isBootstrapGuiStyle")||
...
0:m.cellLayout,n;if(g){"string"===typeof a&&(a=[a]);c="none"!==c&&!1!==c?"":"none";d=d||{};var p=""===c?!0:!1,q=m.groupHeader;(q=q&&("object"===typeof q||b.isFunction(q)))&&!d.skipSetGroupHeaders&&B.destroyGroupHeader.call(f,!1);b(m.colModel).each(function(f){if(-1!==b.inArray(this.name,a)&&this.hidden===p){if(!0===m.frozenColumns&&!0===this.frozen&&!d.notSkipFrozen)return!0;var r=b(g.hDiv).find("tr[role=row]");!0===m.frozenColumns&&null!=g.fhDiv&&(r=r.add(b(g.fhDiv).find("tr[role=row]")));r.each(function(){b(this.cells[f]).css("display",
...
{},d.toReport[this.name]=p):R.call(e,"onShowHideCol",p,this.name,f)}});if(!0===k){var r=m.autowidth||void 0!==m.widthOrg&&"auto"!==m.widthOrg&&"100%"!==m.widthOrg?m.width:m.tblwidth+parseInt(m.scrollOffset,10);d.skipSetGridWidth?d.newGridWidth=r:B.setGridWidth.call(f,r)}if(q&&!d.skipSetGroupHeaders)if(null!=m.pivotOptions&&null!=m.pivotOptions.colHeaders&&1<m.pivotOptions.colHeaders.length)for(r=m.pivotOptions.colHeaders,q=0;q<r.length;q++)r[q]&&r[q].groupHeaders.length&&B.setGroupHeaders.call(f,
r[q]);else B.setGroupHeaders.call(f,m.groupHeader)}})},hideCol:function(a,c){return this.each(function(){B.showHideCol.call(b(this),a,"none",c)})},showCol:function(a,c){return this.each(function(){B.showHideCol.call(b(this),a,"",c)})},remapColumns:function(a,c,d){function e(){var b=[],c=[],d,e=a.length;for(d=0;d<e;d++)q&&a[d]<r?b.push(a[d]):c.push(a[d]);return b.concat(c)}function f(a){var c=a.length?p(a):b.extend({},a);b.each(t,function(b){a[b]=c[this]})}function g(a,c){(c?a.children(c):a.children()).each(function(){var a=
...
d,e,f,g){return this.each(function(){var k=this.p,m,l=k.colModel,n,p,q,r,t,w,y,x={},D;if(this.grid&&(m=isNaN(c)?k.iColByName[c]:parseInt(c,10),0<=m&&(r=B.getGridRowById.call(b(this),a)))){t=u.getCell.call(this,r,m);if(""!==d||!0===g){p=l[m];"local"===k.datatype&&(D=Na(k.idPrefix,a),n=k._index[D],void 0!==n&&(q=k.data[n]));if(null==q)for(n=0;n<r.cells.length;n++){if(n!==m&&(w=u.getDataFieldOfCell.call(this,r,n),0<w.length)){try{y=b.unformat.call(this,w,{rowId:a,colModel:l[n]},n)}catch(v){y=Oa(w[0].innerHTML)}x[l[n].name]=
y}}else x=q;x[p.name]=d;l=this.formatter(a,d,m,x,"edit");y=t;!0===k.treeGrid&&p.name===k.ExpandColumn&&(y=y.children("span.cell-wrapperleaf,span.cell-wrapper").first());y.html(l);p.title&&t.attr({title:d});null!=q&&(l=cb.call(this,d,p,q[p.name],D,q,m),b.isFunction(p.saveLocally)?p.saveLocally.call(this,{newValue:l,newItem:q,oldItem:q,id:D,cm:p,cmName:p.name,iCol:m}):q[p.name]=l)}if(e||f){t=u.getCell.call(this,r,m);if(e)t["string"===typeof e?"addClass":"css"](e);"object"===typeof f&&t.attr(f)}}})},
getCell:function(a,c){var d=!1;this.each(function(){var e,f=this.p,g,k;if(this.grid&&(e=isNaN(c)?f.iColByName[c]:parseInt(c,10),0<=e&&(g=B.getGridRowById.call(b(this),a)))){k=u.getDataFieldOfCell.call(this,g,e).first();try{d=b.unformat.call(this,k,{rowId:g.id,colModel:f.colModel[e]},e)}catch(m){d=Oa(k.html())}}});return d},getCol:function(a,c,d){var e=[],f,g=0,k,m,l;c="boolean"!==typeof c?!1:c;void 0===d&&(d=!1);this.each(function(){var n,p=this.p,q;if(this.grid&&(n=isNaN(a)?p.iColByName[a]:parseInt(a,
10),0<=n)){var r=this.rows,t=r.length,w=0,y=0,x;if(t&&0<t){for(;w<t;){x=r[w];if(b(x).hasClass("jqgrow")){q=u.getDataFieldOfCell.call(this,x,n).first();try{f=b.unformat.call(this,q,{rowId:x.id,colModel:p.colModel[n]},n)}catch(D){f=Oa(q.html())}d?(l=parseFloat(f),isNaN(l)||(g+=l,void 0===m&&(m=k=l),k=Math.min(k,l),m=Math.max(m,l),y++)):c?e.push({id:x.id,value:f}):e.push(f)}w++}if(d)switch(d.toLowerCase()){case "sum":e=g;break;case "avg":e=g/y;break;case "count":e=t-1;break;case "min":e=k;break;case "max":e=
m}}}});return e},clearGridData:function(a){return this.each(function(){var c=this.p,d=this.rows,e=this.grid;e&&c&&d&&("boolean"!==typeof a&&(a=!1),b(this).unbind(".jqGridFormatter"),e.emptyRows.call(this,!1,!0),c.footerrow&&a&&b(".ui-jqgrid-ftable td",e.sDiv).html("&#160;"),c.selrow=null,da(c.selarrrow),da(c.savedRow),da(c.data),da(c.lastSelectedData),c._index={},c.rowIndexes={},c.records=0,c.page=1,c.lastpage=0,c.reccount=0,this.updatepager(!0,!1))})},getInd:function(a,c){var d=B.getGridRowById.call(b(this),
...
m.autoResizing.minColWidth?m.autoResizing.minColWidth:k.autoResizing.minColWidth);return Math.min(r,null!=m.autoResizing&&void 0!==m.autoResizing.maxColWidth?m.autoResizing.maxColWidth:k.autoResizing.maxColWidth)},autoResizeColumn:function(a,c){return this.each(function(){var d=b(this),e=this.p,f=e.colModel[a],g,k=b(this.grid.headers[a].el);g=B.getAutoResizableWidth.call(d,a);null==f||0>g||g===f.width||(B.setColWidth.call(d,a,g,e.autoResizing.adjustGridWidth&&!e.autoResizing.fixWidthOnShrink&&!c,
c),e.autoResizing.fixWidthOnShrink&&e.shrinkToFit&&!c&&(f.fixed=!0,g=f.widthOrg,f.widthOrg=f.width,B.setGridWidth.call(d,e.width,!0),f.widthOrg=g,f.fixed=!1),k.data("autoResized","true"))})},autoResizeAllColumns:function(){return this.each(function(){var a=b(this),c=this.p,d=c.colModel,e=d.length,f,g,k=c.shrinkToFit,m=c.autoResizing.adjustGridWidth,l=c.autoResizing.fixWidthOnShrink,n=parseInt(c.widthOrg,10),p=this.grid,q=B.autoResizeColumn;c.shrinkToFit=!1;c.autoResizing.adjustGridWidth=!0;c.autoResizing.fixWidthOnShrink=
!1;for(f=0;f<e;f++)g=d[f],g.autoResizable&&"actions"!==g.formatter&&q.call(a,f,!0);p.hDiv.scrollLeft=p.bDiv.scrollLeft;c.footerrow&&(p.sDiv.scrollLeft=p.bDiv.scrollLeft);this.fixScrollOffsetAndhBoxPadding();isNaN(n)?m&&B.setGridWidth.call(a,p.newWidth+c.scrollOffset,!1):B.setGridWidth.call(a,n,!1);c.autoResizing.fixWidthOnShrink=l;c.autoResizing.adjustGridWidth=m;c.shrinkToFit=k})}});var va=function(a,c){var d=this.grid.fbRows;return b((null!=d&&d[0].cells.length>c?d[a.rowIndex]:a).cells[c])};u.extend({editCell:function(a,
...
c){return this.each(function(){var d=this,e=b(d),f=d.p,g=u.info_dialog,k=u.jqID;if(d.grid&&!0===f.cellEdit){var m=e.jqGrid("getGridRes","errors"),l=m.errcap,n=e.jqGrid("getGridRes","edit").bClose,p=f.savedRow,q=1<=p.length?0:null;if(null!==q){var r=d.rows[a],t=r.id,w=b(r),y=f.colModel[c],x=y.name,D,v=va.call(d,r,c),A={},E=u.getEditedValue.call(d,v,y,A);if(E!==p[q].v){D=e.triggerHandler("jqGridBeforeSaveCell",[t,x,E,a,c]);void 0!==D&&(E=D);b.isFunction(f.beforeSaveCell)&&(D=f.beforeSaveCell.call(d,
t,x,E,a,c),void 0!==D&&(E=D));var F=u.checkValues.call(d,E,c,void 0,void 0,{oldValue:p[q].v,newValue:E,cmName:x,rowid:t,iCol:c,iRow:a,cm:y,tr:r,td:v,mode:"cell"}),r=y.formatoptions||{};if(null==F||!0===F||!0===F[0]){q=e.triggerHandler("jqGridBeforeSubmitCell",[t,x,E,a,c])||{};b.isFunction(f.beforeSubmitCell)&&((q=f.beforeSubmitCell.call(d,t,x,E,a,c))||(q={}));0<b("input.hasDatepicker",v).length&&b("input.hasDatepicker",v).datepicker("hide");"date"===y.formatter&&!0!==r.sendFormatted&&(E=b.unformat.date.call(d,
E,y));if("remote"===f.cellsubmit)if(f.cellurl){var h={};h[x]=E;var m=f.prmNames,r=m.oper,C=d.grid.hDiv;h[m.id]=u.stripPref(f.idPrefix,t);h[r]=m.editoper;h=b.extend(q,h);f.autoEncodeOnEdit&&b.each(h,function(a,c){b.isFunction(c)||(h[a]=u.oldEncodePostedData(c))});e.jqGrid("progressBar",{method:"show",loadtype:f.loadui,htmlcontent:u.defaults.savetext||"Saving..."});C.loading=!0;b.ajax(b.extend({url:b.isFunction(f.cellurl)?f.cellurl.call(d,f.cellurl,a,c,t,E,x):f.cellurl,data:u.serializeFeedback.call(d,
f.serializeCellData,"jqGridSerializeCellData",h),type:"POST",complete:function(k){e.jqGrid("progressBar",{method:"hide",loadtype:f.loadui});C.loading=!1;if((300>k.status||304===k.status)&&(0!==k.status||4!==k.readyState)){var m=e.triggerHandler("jqGridAfterSubmitCell",[d,k,h.id,x,E,a,c])||[!0,""];if(null==m||!0===m||!0===m[0]&&b.isFunction(f.afterSubmitCell))m=f.afterSubmitCell.call(d,k,h.id,x,E,a,c);null==m||!0===m||!0===m[0]?(e.jqGrid("setCell",t,c,E,!1,!1,!0),v.addClass("dirty-cell"),w.addClass("edited"),
R.call(d,"afterSaveCell",t,x,E,a,c),p.splice(0,1)):(g.call(d,l,m[1],n),e.jqGrid("restoreCell",a,c))}},error:function(h,m,p){b("#lui_"+k(f.id)).hide();C.loading=!1;e.triggerHandler("jqGridErrorCell",[h,m,p]);b.isFunction(f.errorCell)?f.errorCell.call(d,h,m,p):g.call(d,l,h.status+" : "+h.statusText+"<br/>"+m,n);e.jqGrid("restoreCell",a,c)}},u.ajaxOptions,f.ajaxCellOptions||{}))}else try{g.call(d,l,m.nourl,n),e.jqGrid("restoreCell",a,c)}catch(K){}"clientArray"===f.cellsubmit&&(e.jqGrid("setCell",t,c,
...
this;b(this.cells).each(function(c){var p=e.colModel[c],q=p.name,r=va.call(d,l,c);if("cb"!==q&&"subgrid"!==q&&"rn"!==q&&("dirty"!==a||r.hasClass("dirty-cell")))try{m[q]=b.unformat.call(d,r[0],{rowId:g[k].id,colModel:p},c)}catch(t){m[q]=f(r.html())}});m.id=this.id;c.push(m)}})});return c}});var P=B.getGuiStyles,na=B.getGridRes;u.jqModal=u.jqModal||{};b.extend(!0,u.jqModal,{toTop:!0});b.extend(u,{showModal:function(b){b.w.show()},closeModal:function(b){b.w.hide().attr("aria-hidden","true");b.o&&b.o.remove()},
...
void 0===c.size&&(c.size=e?3:1);if(void 0!==c.dataUrl){var t=null,w=c.postData||f.postData,y={elem:k,options:c,cm:c.cm,iCol:c.iCol,ovm:a};try{t=c.rowId}catch(D){}l&&l.idPrefix&&(t=u.stripPref(l.idPrefix,t));b.ajax(b.extend({url:b.isFunction(c.dataUrl)?c.dataUrl.call(m,t,d,String(c.name),y):c.dataUrl,type:"GET",dataType:"html",data:b.isFunction(w)?w.call(m,t,d,String(c.name)):w,context:y,success:function(a,c,d){var e=this.ovm,f=this.elem,h=this.cm,k=this.iCol,l=b.extend({},this.options);a=b.isFunction(l.buildSelect)?
l.buildSelect.call(m,a,d,h,k):a;"string"===typeof a&&(a=b(b.trim(a)).html());a&&(b(f).append(a),g(f,l,w?["postData"]:void 0),setTimeout(function(){var a;b("option",f).each(function(c){0===c&&f.multiple&&(this.selected=!1);-1<b.inArray(b.trim(b(this).val()),e)&&(a=this.selected=!0)});a||b("option",f).each(function(){-1<b.inArray(b.trim(b(this).text()),e)&&(this.selected=!0)});b(f).change();u.fullBoolFeedback.call(m,l.selectFilled,"jqGridSelectFilled",{elem:f,options:l,cm:h,cmName:null!=h?h.name:l.name,
iCol:k})},0))}},f||{}))}else if(c.value){"function"===typeof c.value&&(c.value=c.value());f=[];l=void 0===c.separator?":":c.separator;p=void 0===c.delimiter?";":c.delimiter;n=function(b,a){if(0<a)return b};if("string"===typeof c.value)for(p=c.value.split(p),y=0;y<p.length;y++)r=p[y].split(l),2<r.length&&(r[1]=b.map(r,n).join(l)),f.push({value:r[0],innerHtml:r[1],selectValue:b.trim(r[0]),selectText:b.trim(r[1]),selected:!1});else if("object"===typeof c.value)for(y in l=c.value,l)l.hasOwnProperty(y)&&
f.push({value:y,innerHtml:l[y],selectValue:b.trim(y),selectText:b.trim(l[y]),selected:!1});for(y=0;y<f.length;y++)l=f[y],e||l.selectValue!==b.trim(d)||(t=l.selected=!0),e&&-1<b.inArray(l.selectValue,a)&&(t=l.selected=!0);if(!t)for(y=0;y<f.length;y++)l=f[y],e||l.selectText!==b.trim(d)||(l.selected=!0),e&&-1<b.inArray(l.selectText,a)&&(l.selected=!0);for(y=0;y<f.length;y++)l=f[y],d=document.createElement("option"),d.value=l.value,d.innerHTML=l.innerHtml,l.selected&&(d.selected=!0),k.appendChild(d);
g(k,c,["value"]);u.fullBoolFeedback.call(m,c.selectFilled,"jqGridSelectFilled",{elem:k,options:c,cm:c.cm,cmName:null!=c.cm?c.cm.name:c.name,iCol:c.iCol})}break;case "text":case "password":case "button":t="button"===a?"button":"textbox";k=document.createElement("input");k.type=a;g(k,c);k.value=d;"button"!==a&&(e?c.size||b(k).css({width:"100%","box-sizing":"border-box"}):c.size||(c.size=20));b(k).attr("role",t);break;case "image":case "file":k=document.createElement("input");k.type=a;g(k,c);break;case "custom":k=
document.createElement("span");try{if(b.isFunction(c.custom_element)){var x=c.custom_element.call(m,d,c);if(x instanceof jQuery||u.isHTMLElement(x)||"string"===typeof x)x=b(x).addClass("customelement").attr({id:c.id,name:c.name}),b(k).empty().append(x);else throw"editoptions.custom_element returns value of a wrong type";}else throw"editoptions.custom_element is not a function";}catch(D){"e1"===D&&n.call(m,p,"function 'custom_element' "+r.nodefined,q),"e2"===D?n.call(m,p,"function 'custom_element' "+
r.novalue,q):n.call(m,p,"string"===typeof D?D:D.message,q)}}return k},checkDate:function(b,c){var d={},e;b=b.toLowerCase();e=-1!==b.indexOf("/")?"/":-1!==b.indexOf("-")?"-":-1!==b.indexOf(".")?".":"/";b=b.split(e);c=c.split(e);if(3!==c.length)return!1;var f=-1,g,k=e=-1,m;for(m=0;m<b.length;m++)g=isNaN(c[m])?0:parseInt(c[m],10),d[b[m]]=g,g=b[m],-1!==g.indexOf("y")&&(f=m),-1!==g.indexOf("m")&&(k=m),-1!==g.indexOf("d")&&(e=m);g="y"===b[f]||"yyyy"===b[f]?4:"yy"===b[f]?2:-1;var l;m=[0,31,29,31,30,31,30,
31,31,30,31,30,31];if(-1===f)return!1;l=d[b[f]].toString();2===g&&1===l.length&&(g=1);if(l.length!==g||0===d[b[f]]&&"00"!==c[f]||-1===k)return!1;l=d[b[k]].toString();if(1>l.length||1>d[b[k]]||12<d[b[k]]||-1===e)return!1;l=d[b[e]].toString();!(g=1>l.length||1>d[b[e]]||31<d[b[e]])&&(g=2===d[b[k]])&&(f=d[b[f]],g=d[b[e]]>(0!==f%4||0===f%100&&0!==f%400?28:29));return g||d[b[e]]>m[d[b[k]]]?!1:!0},isEmpty:function(b){return b.match(/^\s+$/)||""===b?!0:!1},checkTime:function(b){var c=/^(\d{1,2}):(\d{2})([apAP][Mm])?$/;
if(!u.isEmpty(b))if(b=b.match(c)){if(b[3]){if(1>b[1]||12<b[1])return!1}else if(23<b[1])return!1;if(59<b[2])return!1}else return!1;return!0},checkValues:function(a,c,d,e,f){var g,k,m=this.p;k=m.colModel;var l=u.isEmpty,n=na.call(b(this),"edit.msg"),p=na.call(b(this),"formatter.date.masks");if(void 0===d){"string"===typeof c&&(c=m.iColByName[c]);if(void 0===c||0>c)return[!0,"",""];e=k[c];d=e.editrules;null!=e.formoptions&&(g=e.formoptions.label)}else g=void 0===e?"_":e,e=k[c];if(d){g||(g=null!=m.colNames?
...
role:"row form"});l.loadFilterDefaults&&(D=A()||{});b.each(n,function(a){var d,e;e="";var m,n,A=this.searchoptions||{},C=this.editoptions||{},y=b("<th></th>",{"class":P.call(c,"colHeaders","ui-th-column ui-th-"+f.direction+" "+(l.applyLabelClasses?this.labelClasses||"":"")),role:"gridcell","aria-describedby":f.id+"_"+this.name}),B=b("<div></div>"),Q=b("<table class='ui-search-table'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear' style='width:1px'></td></tr></table>");
...
iCol:a}):(p("search.resetTitle")||"Clear Search Value")+" "+u.stripHtml(f.colNames[a]),b("td",Q).eq(2).append("<a title='"+e+"' aria-label='"+e+"' class='"+P.call(c,"searchToolbar.clearButton","clearsearchclass")+"'><span>"+l.resetIcon+"</span></a>")):b("td",Q).eq(2).hide();switch(this.stype){case "select":if(e=this.surl||d.dataUrl)b(B).append(Q),b.ajax(b.extend({url:e,context:{stbl:Q,options:d,cm:this,iCol:a},dataType:"html",success:function(b,a,e){a=this.cm;var f=this.iCol,h=this.options,k=this.stbl.find(">tbody>tr>td.ui-search-input");
...
options:h,cm:a,cmName:a.name,iCol:f,mode:"filter"});!0===l.autosearch&&b.change(function(){E();return!1})}},u.ajaxOptions,f.ajaxSelectOptions||{}));else{var S,ba,V;this.searchoptions?(S=void 0===A.value?C.value||"":A.value,ba=void 0===A.separator?C.separator||":":A.separator,V=void 0===A.delimiter?C.delimiter||";":A.delimiter):this.editoptions&&(S=void 0===C.value?"":C.value,ba=void 0===C.separator?":":C.separator,V=void 0===C.delimiter?";":C.delimiter);if(S){A=document.createElement("select");A.style.width=
...
J.value="",J.innerHTML=d.noFilterText,J.selected=!0,b(A).prepend(J));void 0!==d.defaultValue&&b(A).val(d.defaultValue);d.attr&&b(A).attr(d.attr);b(A).addClass(x);b(B).append(Q);g.call(c,A,d);b("td",Q).eq(1).append(A);u.fullBoolFeedback.call(c,d.selectFilled,"jqGridSelectFilled",{elem:A,options:this.searchoptions||C,cm:this,cmName:this.name,iCol:a,mode:"filter"});!0===l.autosearch&&b(A).change(function(){E();return!1})}}break;case "text":a=void 0!==d.defaultValue?d.defaultValue:"";b("td",Q).eq(1).append("<input role='search' type='text' class='"+
x+"' name='"+(this.index||this.name)+"' id='"+v(this.name)+"' aria-labelledby='jqgh_"+f.id+"_"+this.name+"' value='"+a+"'/>");b(B).append(Q);d.attr&&b("input",B).attr(d.attr);g.call(c,b("input",B)[0],d);!0===l.autosearch&&(l.searchOnEnter?b("input",B).keypress(function(b){return 13===(b.charCode||b.keyCode||0)?(E(),!1):this}):b("input",B).keydown(function(b){switch(b.which){case 13:return!1;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:K&&clearTimeout(K),K=setTimeout(function(){E()},
l.autosearchDelay)}}));break;case "custom":b("td",Q).eq(1).append("<span style='width:100%;padding:0;box-sizing:border-box;' class='"+x+"' name='"+(this.index||this.name)+"' id='"+v(this.name)+"'/>");b(B).append(Q);try{if(b.isFunction(d.custom_element)){var qa=d.custom_element.call(c,void 0!==d.defaultValue?d.defaultValue:"",d);if(qa)qa=b(qa).addClass("customelement"),b(B).find("span[name='"+(this.index||this.name)+"']").append(qa);else throw"e2";}else throw"e1";}catch(ra){"e1"===ra&&k.call(c,q,"function 'custom_element' "+
t.nodefined,r),"e2"===ra?k.call(c,q,"function 'custom_element' "+t.novalue,r):k.call(c,q,"string"===typeof ra?ra:ra.message,r)}}}b(y).append(B);b(y).find(".ui-search-oper .soptclass,.ui-search-clear .clearsearchclass").hover(function(){b(this).addClass(w)},function(){b(this).removeClass(w)});b(H).append(y);l.searchOperators||b("td",Q).eq(0).hide()});b(d.hDiv).find(">div>.ui-jqgrid-htable>thead").append(H);l.searchOperators&&(b(".soptclass",H).click(function(a){var c=b(this).offset();C(this,c.left,
...
nu:"IS NULL",nn:"IS NOT NULL"}},B.getGridRes.call(e,"search"),u.search||{},f.searching||{},a||{}),k="fbox_"+f.id,m=g.commonIconClass,l={themodal:"searchmod"+k,modalhead:"searchhd"+k,modalcontent:"searchcnt"+k,resizeAlso:k},n="#"+G(l.themodal),p=f.gBox,q=f.gView,r=b.each,t=f.postData[g.sFilter],w=function(){var a=b.makeArray(arguments);a.unshift("Search");a.unshift("Filter");a.unshift(g);return Ra.apply(d,a)},y=function(){u.hideModal(n,{gb:p,jqm:g.jqModal,onClose:g.onClose,removemodal:g.removemodal})};
"string"===typeof t&&(t=""!==b.trim(t)?b.parseJSON(t):void 0);b(n).remove();if(void 0!==b(n)[0])c(b("#fbox_"+f.idSel));else{var x=b("<div><div id='"+k+"' class='"+P.call(d,"dialog.body","searchFilter")+"' style='overflow:auto'></div></div>").insertBefore(q);"rtl"===f.direction&&x.attr("dir","rtl");var D="",v="",A,E=!1,F,h=-1,C=b.extend([],f.colModel);F=ea.call(d,k+"_search",g.Find,ua(m,g.findDialogIcon),"right");var K=ea.call(d,k+"_reset",g.Reset,ua(m,g.resetDialogIcon),"left");g.showQuery&&(D=ea.call(d,
k+"_query","Query",ua(m,g.queryDialogIcon),"left")+"&#160;");g.searchForAdditionalProperties&&r(f.additionalProperties,function(){var b="string"===typeof this?{name:this}:this;b.label||(b.label=b.name);b.isAddProp=!0;C.push(b)});g.columns.length?(C=g.columns,h=0,A=C[0].index||C[0].name):r(C,function(b,a){a.label||(a.label=a.isAddProp?a.name:f.colNames[b]);if(!E){var c=void 0===a.search?!0:a.search,d=!0===a.hidden;if(a.searchoptions&&!0===a.searchoptions.searchhidden&&c||c&&!d)E=!0,A=a.index||a.name,
h=b}});if(!t&&A||!1===g.multipleSearch)m="eq",0<=h&&C[h].searchoptions&&C[h].searchoptions.sopt?m=C[h].searchoptions.sopt[0]:g.sopt&&g.sopt.length&&(m=g.sopt[0]),t={groupOp:"AND",rules:[{field:A,op:m,data:""}]};E=!1;g.tmplNames&&g.tmplNames.length&&(E=!0,v=g.tmplLabel,v+="<select class='ui-template'>",v+="<option value='default'>Default</option>",r(g.tmplNames,function(b,a){v+="<option value='"+b+"'>"+a+"</option>"}),v+="</select>");F="<div class='"+P.call(d,"dialog.footer")+"'><table class='EditTable' style='border:0px none;margin-top:5px' id='"+
...
c){b(c).text()});break;case "date":z[c]=b(this).val();3===String(z[c]).split("-").length&&(a=L[c],void 0!==a&&(a=I[a],a=a.formatoptions||{},a=a.newformat||x.call(t,"formatter.date.newformat"),z[c]=u.parseDate.call(t[0],"Y-m-d",z[c],a)));break;default:void 0!==a&&0>b.inArray(a,v.skipPostTypes)&&(z[c]=b(this).val())}});return!0}function e(a,c,d){var e=0,f=[],g=!1,h="",k;for(k=1;k<=d;k++)h+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==a&&(g=B.getInd.call(t,a));b(I).each(function(k){var l=
this.name,m,n,p,q,t;m=this.editable;var z=!1,C=!1;t="_empty"===a?"addForm":"editForm";b.isFunction(m)&&(m=m.call(r,{rowid:a,iCol:k,iRow:g,cmName:l,cm:this,mode:t}));q=(this.editrules&&!0===this.editrules.edithidden?0:!0===this.hidden||"hidden"===m)?"style='display:none'":"";switch(String(m).toLowerCase()){case "hidden":m=!0;break;case "disabled":z=m=!0;break;case "readonly":C=m=!0}if("cb"!==l&&"subgrid"!==l&&!0===m&&"rn"!==l){if(!1===g)p="";else{m=b(r.rows[g].cells[k]);try{p=b.unformat.call(r,m,{rowId:a,
colModel:this},k)}catch(x){p=this.edittype&&"textarea"===this.edittype?m.text():m.html()}Ka(p)&&(p="")}m=b.extend({},this.editoptions||{},{id:l,name:l,rowId:a,mode:t,cm:this,iCol:k});var y=b.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),E=parseInt(y.rowpos,10)||e+1,F=parseInt(2*(parseInt(y.colpos,10)||1),10);"_empty"===a&&m.defaultValue&&(p=b.isFunction(m.defaultValue)?m.defaultValue.call(r):m.defaultValue);this.edittype||(this.edittype="text");w.autoEncodeOnEdit&&
(p=u.oldDecodePostedData(p));t=u.createEl.call(r,this.edittype,m,p,!1,b.extend({},u.ajaxOptions,w.ajaxSelectOptions||{}));if(v.checkOnSubmit||v.checkOnUpdate)v._savedData[l]=p;b(t).addClass("FormElement");-1<b.inArray(this.edittype,["text","textarea","checkbox","password","select"])&&b(t).addClass(P.call(r,"dialog.dataField"));n=b(c).find("tr[data-rowpos="+E+"]");if(y.rowabove){var D=b("<tr><td class='contentinfo' colspan='"+2*d+"'>"+y.rowcontent+"</td></tr>");b(c).append(D);D[0].rp=E}0===n.length&&
(n=b("<tr "+q+" data-rowpos='"+E+"'></tr>").addClass("FormData").attr("id","tr_"+l),b(n).append(h),b(c).append(n),n[0].rp=E);q=b("td:eq("+(F-2)+")",n[0]);n=b("td:eq("+(F-1)+")",n[0]);q.html(void 0===y.label?w.colNames[k]:y.label||"&#160;");n[Ka(n.html())?"html":"append"](y.elmprefix).append(t).append(y.elmsuffix);z?(q.addClass(V),n.addClass(V),b(t).prop("readonly",!0),b(t).prop("disabled",!0)):C&&b(t).prop("readonly",!0);"custom"===this.edittype&&b.isFunction(m.custom_value)&&m.custom_value.call(r,
...
k=w.prmNames,l,m,n,p,q,x,E=B.getInd.call(t,a),F=!1===E?null:r.rows[E];(x=t.triggerHandler("jqGridAddEditBeforeCheckValues",[b(A),N]))&&"object"===typeof x&&(z=x);E=!1===E?-1:E;b.isFunction(v.beforeCheckValues)&&(x=v.beforeCheckValues.call(r,z,b(A),N))&&"object"===typeof x&&(z=x);for(n in z)if(z.hasOwnProperty(n)){x=w.iColByName[n];d=u.checkValues.call(r,z[n],n,void 0,void 0,{oldValue:"_empty"===a?null:B.getCell.call(t,a,x),newValue:z[n],cmName:n,rowid:a,cm:I[x],iCol:x,iRow:E,tr:F,td:null==F?null:
F.cells[x],mode:"_empty"===a?"addForm":"editForm"});if(null==d||!0===d)d=c;if(!1===d[0])break}g();if(d[0]){e=t.triggerHandler("jqGridAddEditClickSubmit",[v,z,N]);void 0===e&&b.isFunction(v.onclickSubmit)&&(e=v.onclickSubmit.call(r,v,z,N)||{});d=t.triggerHandler("jqGridAddEditBeforeSubmit",[z,b(A),N]);if(null==d||!0===d)d=c;d[0]&&b.isFunction(v.beforeSubmit)&&(d=v.beforeSubmit.call(r,z,b(A),N),null==d||!0===d)&&(d=c)}if(d[0]&&!v.processing){v.processing=!0;b("#sData",C).addClass(W);n=v.url||w.editurl;
...
b.ajax(q))}!1===d[0]&&(b("#FormError>td",h).html(d[1]),b("#FormError",h).show())}function m(b,a){var c=!1,d;for(d in b)if(b.hasOwnProperty(d)&&String(b[d])!==String(a[d])){c=!0;break}return c}function l(){var a=!0;b("#FormError",h).hide();v.checkOnUpdate&&(z={},d(),J=m(z,v._savedData))&&(b(A).data("disabled",!0),b(".confirm",H).show(),a=!1);return a}function n(){var c=u.detectRowEditing.call(r,a);if(null!=c)if("inlineEditing"===c.mode)B.restoreRow.call(t,a);else{var c=c.savedRow,d=r.rows[c.id];B.restoreCell.call(t,
c.id,c.ic);b(d.cells[c.ic]).removeClass("edit-cell "+R);b(d).addClass(R).attr({"aria-selected":"true",tabindex:"0"})}}function p(a,c){var d=c[1].length-1;0===a?b("#pData",C).addClass(V):void 0!==c[1][a-1]&&aa(b("#"+G(c[1][a-1])),V)?b("#pData",C).addClass(V):b("#pData",C).removeClass(V);a===d?b("#nData",C).addClass(V):void 0!==c[1][a+1]&&aa(b("#"+G(c[1][a+1])),V)?b("#nData",C).addClass(V):b("#nData",C).removeClass(V)}function q(){var a=B.getDataIDs.call(t),c=b("#id_g",h).val();return[b.inArray(c,a),
a]}var r=this,t=b(r),w=r.p;if(r.grid&&null!=w&&a){var y=w.id,x=B.getGridRes,D=B.setSelection,v=b.extend(!0,{top:0,left:0,width:300,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,url:null,mtype:"POST",clearAfterAdd:!0,closeAfterEdit:!1,reloadAfterSubmit:!0,onInitializeForm:null,beforeInitData:null,beforeShowForm:null,afterShowForm:null,beforeSubmit:null,afterSubmit:null,onclickSubmit:null,afterComplete:null,onclickPgButtons:null,afterclickPgButtons:null,editData:{},closeOnEscape:!1,
addedrow:"first",topinfo:"",bottominfo:"",savekey:[!1,13],navkeys:[!1,38,40],checkOnSubmit:!1,checkOnUpdate:!1,_savedData:{},processing:!1,onClose:null,ajaxEditOptions:{},serializeEditData:null,viewPagerButtons:!0,overlayClass:P.call(this,"overlay"),removemodal:!0,skipPostTypes:["image","file"]},x.call(t,"edit"),u.edit,w.formEditing||{},c||{}),A="FrmGrid_"+y,E=A,F="TblGrid_"+y,h="#"+G(F),C=h+"_2",K={themodal:"editmod"+y,modalhead:"edithd"+y,modalcontent:"editcnt"+y,resizeAlso:A},H="#"+G(K.themodal),
...
b(A).data("disabled",!1);setTimeout(function(){b(":input:visible",A)[0].focus()},0);return!1}),b("#cNew",H).click(function(){b(".confirm",H).hide();b(A).data("disabled",!1);Q();return!1});S("onInitializeForm",b(A),N);"_empty"!==a&&v.viewPagerButtons?b("#pData,#nData",C).show():b("#pData,#nData",C).hide();S("beforeShowForm",b(A),N);b(H).data("onClose",v.onClose);u.viewModal.call(r,H,{gbox:M,jqm:v.jqModal,overlay:v.overlay,modal:v.modal,overlayClass:v.overlayClass,toTop:v.toTop,onHide:function(b){b.w.remove();
b.o&&b.o.remove()}});qa||b("."+G(v.overlayClass)).click(function(){if(!l())return!1;Q();return!1});b(".fm-button",H).hover(function(){b(this).addClass(ba)},function(){b(this).removeClass(ba)});b("#sData",C).click(function(){z={};b("#FormError",h).hide();d();"_empty"===z[y+"_id"]?k():!0===v.checkOnSubmit?(J=m(z,v._savedData))?(b(A).data("disabled",!0),b(".confirm",H).show()):k():k();return!1});b("#cData",C).click(function(){if(!l())return!1;Q();return!1});b("#nData",C).click(function(){if(!l())return!1;
b("#FormError",h).hide();var a=q();a[0]=parseInt(a[0],10);if(-1!==a[0]&&a[1][a[0]+1]){if(!S("onclickPgButtons","next",b(A),a[1][a[0]]))return!1;f(a[1][a[0]+1],A);D.call(t,a[1][a[0]+1]);S("afterclickPgButtons","next",b(A),a[1][a[0]+1]);p(a[0]+1,a)}return!1});b("#pData",C).click(function(){if(!l())return!1;b("#FormError",h).hide();var a=q();if(-1!==a[0]&&a[1][a[0]-1]){if(!S("onclickPgButtons","prev",b(A),a[1][a[0]])||aa(b("#"+G(a[1][a[0]-1])),V))return!1;f(a[1][a[0]-1],A);D.call(t,a[1][a[0]-1]);S("afterclickPgButtons",
"prev",b(A),a[1][a[0]-1]);p(a[0]-1,a)}return!1});S("afterShowForm",b(A),N);qa=q();p(qa[0],qa)}}})},viewGridRow:function(a,c){return this.each(function(){function d(){!0!==q.closeOnEscape&&!0!==q.navkeys[0]||setTimeout(function(){b("#cData").focus()},0)}function e(a,c,d){var e,f,g,h=0,k,p,r=[],t=B.getInd.call(l,a),v;v=P.call(m,"dialog.viewData","DataTD form-view-data");var w=P.call(m,"dialog.viewLabel","CaptionTD form-view-label"),z="<td class='"+w+"' width='"+q.labelswidth+"'>&#160;</td><td class='"+
v+" ui-helper-reset'>&#160;</td>",x="",w="<td class='"+w+"'></td><td class='"+v+"'></td>",C=["integer","number","currency"],A=0,y=0,F,D,K;for(v=1;v<=d;v++)x+=1===v?z:w;b(E).each(function(){(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==b.inArray(this.formatter,C)?A=Math.max(A,parseInt(this.width,10)):y=Math.max(y,parseInt(this.width,10)))});F=0!==A?A:0!==y?y:0;b(E).each(function(a){e=this.name;D=!1;p=(f=this.editrules&&!0===
...
b(c).append(w);w[0].rp=q}g=b(c).find("tr[data-rowpos="+q+"]");0===g.length&&(g=b("<tr "+p+" data-rowpos='"+q+"'></tr>").addClass("FormData").attr("id","trv_"+e),b(g).append(x),b(c).append(g),g[0].rp=q);l=void 0===l.label?n.colNames[a]:l.label;q=b("td:eq("+(v-1)+")",g[0]);b("td:eq("+(v-2)+")",g[0]).html("<b>"+(l||"&nbsp;")+"</b>");q[Ka(q.html())?"html":"append"]("<span>"+(k||"&nbsp;")+"</span>").attr("id","v_"+e);D&&b("td:eq("+(v-1)+") span",g[0]).css({"text-align":"right",width:F+"px"});r[h]=a;h++}});
0<h&&(a=b("<tr class='FormData' style='display:none'><td class='CaptionTD'>&#160;</td><td colspan='"+(2*d-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+a+"'/></td></tr>"),a[0].rp=h+99,b(c).append(a));return r}function f(a){var c,d,e=0,f=B.getInd.call(l,a,!0),g;f&&(b("td",f).each(function(a){g=E[a];c=g.name;d=g.editrules&&!0===g.editrules.edithidden?!1:!0===g.hidden?!0:!1;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&(c=G("v_"+c),b("#"+c+" span",t).html(u.getDataFieldOfCell.call(m,
f,a).html()),d&&b("#"+c,t).parents("tr:first").hide(),e++)}),0<e&&b("#id_g",t).val(a))}function g(a,c){var d=c[1].length-1;0===a?b("#pData",w).addClass(M):void 0!==c[1][a-1]&&aa(b("#"+G(c[1][a-1])),M)?b("#pData",w).addClass(M):b("#pData",w).removeClass(M);a===d?b("#nData",w).addClass(M):void 0!==c[1][a+1]&&aa(b("#"+G(c[1][a+1])),M)?b("#nData",w).addClass(M):b("#nData",w).removeClass(M)}function k(){var a=B.getDataIDs.call(l),c=b("#id_g",t).val();return[b.inArray(c,a),a]}var m=this,l=b(m),n=m.p;if(m.grid&&
null!=n&&a){var p=n.id,q=b.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,closeOnEscape:!1,labelswidth:"30%",navkeys:[!1,38,40],onClose:null,beforeShowForm:null,beforeInitData:null,viewPagerButtons:!0,removemodal:!0},B.getGridRes.call(l,"view"),u.view||{},n.formViewing||{},c||{}),r="#ViewGrid_"+G(p),t="#ViewTbl_"+G(p),w=t+"_2",y="ViewGrid_"+p,x="ViewTbl_"+p,D=q.commonIconClass,p={themodal:"viewmod"+p,modalhead:"viewhd"+p,modalcontent:"viewcnt"+p,
resizeAlso:y},v="#"+G(p.themodal),A=n.gBox,E=n.colModel,F=1,h=0,C=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("View");a.unshift(q);return Ra.apply(m,a)},K=function(){u.hideModal(v,{gb:A,jqm:q.jqModal,onClose:q.onClose,removemodal:q.removemodal})},H=Y.call(m,"hover"),M=Y.call(m,"disabled"),I=isNaN(q.dataheight)?q.dataheight:q.dataheight+"px",L=isNaN(q.datawidth)?q.datawidth:q.datawidth+"px",y=b("<div class='"+P.call(m,"dialog.body")+"'><form name='FormPost' id='"+y+"' class='FormGrid' style='width:"+
L+";overflow:auto;position:relative;height:"+I+";'></form></div>"),I=y.children("form.FormGrid"),Z=b("<table id='"+x+"' class='EditTable'><tbody></tbody></table>");b(v).remove();b(E).each(function(){var b=this.formoptions;F=Math.max(F,b?b.colpos||0:0);h=Math.max(h,b?b.rowpos||0:0)});I.append(Z);if(C("beforeInitData",I)){e(a,Z,F);var O=(I="rtl"===n.direction?!0:!1)?"pData":"nData",L=ea.call(m,I?"nData":"pData","",ua(D,q.prevIcon),"","left"),O=ea.call(m,O,"",ua(D,q.nextIcon),"","right"),z=ea.call(m,
...
q.navkeys[2])return b("#nData",w).trigger("click"),!1}});Ha(b("#cData",w),q.closeicon,D);C("beforeShowForm",b(r));u.viewModal.call(m,v,{gbox:A,jqm:q.jqModal,overlay:q.overlay,toTop:q.toTop,modal:q.modal,onHide:function(b){b.w.remove();b.o&&b.o.remove()}});b(".fm-button:not(."+M.split(" ").join(".")+")",w).hover(function(){b(this).addClass(H)},function(){b(this).removeClass(H)});d();b("#cData",w).click(function(){K();return!1});b("#nData",w).click(function(){b("#FormError",t).hide();var a=k();a[0]=
parseInt(a[0],10);if(-1!==a[0]&&a[1][a[0]+1]){if(!C("onclickPgButtons","next",b(r),a[1][a[0]]))return!1;f(a[1][a[0]+1]);B.setSelection.call(l,a[1][a[0]+1]);C("afterclickPgButtons","next",b(r),a[1][a[0]+1]);g(a[0]+1,a)}d();return!1});b("#pData",w).click(function(){b("#FormError",t).hide();var a=k();if(-1!==a[0]&&a[1][a[0]-1]){if(!C("onclickPgButtons","prev",b(r),a[1][a[0]]))return!1;f(a[1][a[0]-1]);B.setSelection.call(l,a[1][a[0]-1]);C("afterclickPgButtons","prev",b(r),a[1][a[0]-1]);g(a[0]-1,a)}d();
...
g){var h;b("#dData",l+"_2").removeClass(A);300<=c.status&&304!==c.status||0===c.status&&4===c.readyState?(a[0]=!1,b.isFunction(k.errorTextFormat)?a[1]=k.errorTextFormat.call(d,c):a[1]=g+" Status: '"+c.statusText+"'. Error code: "+c.status):b.isFunction(k.afterSubmit)&&(a=k.afterSubmit.call(d,c,n)||[!0]);if(!1===a[0])b("#DelError>td",l).html(a[1]),b("#DelError",l).show();else{if(k.reloadAfterSubmit&&"local"!==e.datatype)f.trigger("reloadGrid",[b.extend({},k.reloadGridOptions||{})]);else if(!0===e.treeGrid)try{B.delTreeNode.call(f,
t[0])}catch(p){}else for(t=t.slice(),h=0;h<t.length;h++)B.delRowData.call(f,t[h]);setTimeout(function(){D("afterComplete",c,m,b(l))},50)}k.processing=!1;a[0]&&u.hideModal(w,{gb:y,jqm:k.jqModal,onClose:k.onClose,removemodal:k.removemodal})}},u.ajaxOptions,k.ajaxDelOptions);c.url||k.useDataProxy||(b.isFunction(e.dataProxy)?k.useDataProxy=!0:(a[0]=!1,a[1]+=" "+u.errors.nourl));a[0]&&(k.useDataProxy?(c=e.dataProxy.call(d,c,"del_"+g),void 0===c&&(c=[!0,""]),!1===c[0]?(a[0]=!1,a[1]=c[1]||"Error deleting the selected row!"):
...
afterRefresh:null,cloneToTop:!1,hideEmptyPagerParts:!0,alertwidth:200,alertheight:"auto",alerttop:null,removemodal:!0,alertleft:null,alertzIndex:null,iconsOverText:!1},B.getGridRes.call(n,"nav"),u.nav||{},l.navOptions||{},c||{});q.position=q.position||("rtl"===l.direction?"right":"left");var r,t=l.idSel,w=l.gBox,y=q.commonIconClass,x={themodal:"alertmod_"+p,modalhead:"alerthd_"+p,modalcontent:"alertcnt_"+p},D=function(){return function(){var a=document.documentElement,c=window,d=1024,e=768,f=n.closest(".ui-jqgrid").offset();
...
c.length-p.length-5:c.length-p.length-1)+"mod"+l.id,d=b(".ui-jqdialog").filter(":visible").map(function(){return this.id});if(0>b.inArray(c,d))return a.trigger("click"),!1}},E=Y.call(m,"hover"),F=Y.call(m,"disabled"),h=P.call(m,"navButton","ui-pg-button");if(m.grid){m.modalAlert=D;void 0===a&&(l.pager?(a=l.pager,l.toppager&&(q.cloneToTop=!0)):l.toppager&&(a=l.toppager));var C=1,K,H,M,I,L,Z,O=["left","center","right"],z="<div class='"+P.call(m,"navButton","ui-pg-button "+Y.call(m,"disabled"))+"'><span class='ui-separator'></span></div>",
J=function(){aa(this,F)||b(this).addClass(E)},N=function(){b(this).removeClass(E)},ca=function(){aa(this,F)||(b.isFunction(q.addfunc)?q.addfunc.call(m):B.editGridRow.call(n,"new",e));return!1},Q=function(a,c,d){if(!aa(this,F)){var e=l.selrow;e?b.isFunction(a)?a.call(m,e):B[c].call(n,e,d):D()}return!1},R=function(){return Q.call(this,q.editfunc,"editGridRow",d)},S=function(){return Q.call(this,q.viewfunc,"viewGridRow",k)},U=function(){var a;aa(this,F)||(l.multiselect?(a=l.selarrrow,0===a.length&&(a=
null)):a=l.selrow,a?b.isFunction(q.delfunc)?q.delfunc.call(m,a):B.delGridRow.call(n,a,f):D());return!1},V=function(){aa(this,F)||(b.isFunction(q.searchfunc)?q.searchfunc.call(m,g):B.searchGrid.call(n,g));return!1},da=function(){if(!aa(this,F)){b.isFunction(q.beforeRefresh)&&q.beforeRefresh.call(m);l.search=!1;l.resetsearch=!0;try{if("currentfilter"!==q.refreshstate){l.postData.filters="";try{b("#fbox_"+t).jqFilter("resetFilter")}catch(a){}b.isFunction(m.clearToolbar)&&m.clearToolbar(!1)}}catch(a){}switch(q.refreshstate){case "firstpage":n.trigger("reloadGrid",
...
(q.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+g+"</span>":"")+"</div>");b(v).append(e);e.attr({title:q[a+"title"]||"",id:c||a+"_"+M}).click(d).hover(J,N);return e};q.cloneToTop&&l.toppager&&(C=2);for(K=0;K<C;K++){v=b("<div class='ui-pg-table navtable' role='toolbar' style='float:"+("rtl"===l.direction?"right":"left")+";table-layout:auto;'></div>");0===K?(H=a,M=p,H===l.toppager&&(M+="_top",C=1)):(H=l.toppager,M=p+"_top");q.add&&W("add",e.id,ca);q.edit&&W("edit",d.id,R);q.view&&W("view",
...
this,e=d.p;if(d.grid){var f=b.extend({caption:"newButton",title:"",onClickButton:null,position:"last",cursor:"pointer",iconsOverText:!1},B.getGridRes.call(b(d),"nav"),u.nav||{},e.navOptions||{},c||{}),g=Y.call(d,"hover"),k=Y.call(d,"disabled"),m=P.call(d,"navButton","ui-pg-button");if(void 0===a)if(e.pager)if(B.navButtonAdd.call(b(d),e.pager,f),e.toppager)a=e.toppager;else return;else e.toppager&&(a=e.toppager);"string"===typeof a&&0!==a.indexOf("#")&&(a="#"+G(a));var e=b(".navtable",a),l=f.commonIconClass;
...
"<span class='ui-pg-button-text"+(f.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+f.caption+"</span>":"")+"</div>");f.id&&b(n).attr("id",f.id);"first"===f.position&&0<e.children("div.ui-pg-button").length?e.children("div.ui-pg-button").first().before(n):e.append(n);b(n,e).attr("title",f.title||"").click(function(a){aa(this,k)||b.isFunction(f.onClickButton)&&f.onClickButton.call(d,f,a);return!1}).hover(function(){aa(this,k)||b(this).addClass(g)},function(){b(this).removeClass(g)});b(d).triggerHandler("jqGridResetFrozenHeights")}}})},
navSeparatorAdd:function(a,c){c=b.extend({sepclass:"ui-separator",sepcontent:"",position:"last"},c||{});return this.each(function(){if(this.grid){var d=this.p,e=P.call(this,"navButton","ui-pg-button "+Y.call(this,"disabled"));if(void 0===a)if(d.pager)if(B.navSeparatorAdd.call(b(this),d.pager,c),d.toppager)a=d.toppager;else return;else d.toppager&&(a=d.toppager);"string"===typeof a&&0!==a.indexOf("#")&&(a="#"+G(a));d=b(".navtable",a);0<d.length&&(e="<div class='"+e+"'><span class='"+c.sepclass+"'></span>"+
c.sepcontent+"</div>","first"===c.position?0===d.children("div.ui-pg-button").length?d.append(e):d.children("div.ui-pg-button").first().before(e):d.append(e))}})},GridToForm:function(a,c){return this.each(function(){var d,e,f,g;if(this.grid){var k=B.getRowData.call(b(this),a);if(k)for(d in k)if(k.hasOwnProperty(d))if(e=b("[name="+G(d)+"]",c),e.is("input:radio")||e.is("input:checkbox"))for(f=0;f<e.length;f++)g=b(e[f]),g.prop("checked",g.val()===String(k[d]));else e.val(Ka(k[d])?"":k[d])}})},FormToGrid:function(a,
c,d,e){return this.each(function(){if(this.grid){d||(d="set");e||(e="first");var f=b(c).serializeArray(),g={};b.each(f,function(b,a){g[a.name]=a.value});"add"===d?B.addRowData.call(b(this),a,g,e):"set"===d&&B.setRowData.call(b(this),a,g)}})}});u.extend({groupingSetup:function(){return this.each(function(){var a,c;c=this.p;var d=c.colModel,e=c.groupingView,f,g,k=function(){return""};if(null===e||"object"!==typeof e&&!b.isFunction(e))c.grouping=!1;else if(e.groupField.length){void 0===e.visibiltyOnNextGrouping&&
...
e,k){var l=x[a],m,n="",p,q,t,w=0,A,y,E,F=!0;if(0!==c&&0!==x[a].idx)for(m=a;0<=m;m--)if(x[m].idx===x[a].idx-c){l=x[m];break}a=l.cnt;for(A=void 0===k?e:0;A<v;A++){c="&#160;";m=D[A];for(p=0;p<l.summary.length;p++)if(q=l.summary[p],y=b.isArray(q.st)?q.st[d.idx]:q.st,E=b.isArray(m.summaryTpl)?m.summaryTpl[d.idx]:m.summaryTpl||"{0}",q.nm===m.name){"string"===typeof y&&"avg"===y.toLowerCase()&&(q.sd&&q.vd?q.v/=q.vd:q.v&&0<a&&(q.v/=a));try{q.groupCount=l.cnt,q.groupIndex=l.dataIndex,q.groupValue=l.value,
t=f.formatter("",q.v,A,q)}catch(B){t=q.v}c=u.format(E,t);m.summaryFormat&&(c=m.summaryFormat.call(f,d,c,t,m,q));break}q=p=!1;void 0!==k&&F&&!m.hidden&&(c=k,F=!1,1<e&&(p=!0,w=e-1),q=m.align,m.align="rtl"===g.direction?"right":"left",r.iconColumnName=m.name);0<w&&!m.hidden&&"&#160;"===c?(q&&(m.align=q),w--):(n+="<td role='gridcell' "+f.formatCol(A,1,"")+(p?"colspan='"+e+"'":"")+">"+c+"</td>",q&&(m.align=q))}return n}var e="",f=this[0],g=f.p,k=0,m,l=[],n="",p,q,r=g.groupingView,t=b.makeArray(r.groupSummary),
w=(r.groupCollapse?r.plusicon:r.minusicon)+" tree-wrap",y=r.groupField.length,x=r.groups,D=g.colModel,v=D.length,A=g.page,E=B.getGuiStyles.call(f,"gridRow","jqgroup ui-row-"+g.direction),F=B.getGuiStyles.call(f,"gridRow","jqfoot ui-row-"+g.direction);b.each(D,function(b,a){var c;for(c=0;c<y;c++)if(r.groupField[c]===a.name){l[c]=b;break}});t.reverse();b.each(x,function(h,C){if(r._locgr&&!(C.startRow+C.cnt>(A-1)*c&&C.startRow<A*c))return!0;k++;q=g.id+"ghead_"+C.idx;p=q+"_"+h;n="<span style='cursor:pointer;margin-"+
("rtl"===g.direction?"right:":"left:")+12*C.idx+"px;' class='"+r.commonIconClass+" "+w+"' onclick=\"jQuery('#"+u.jqID(g.id).replace("\\","\\\\")+"').jqGrid('groupingToggle','"+p+"', this);return false;\"></span>";try{b.isArray(r.formatDisplayField)&&b.isFunction(r.formatDisplayField[C.idx])?(C.displayValue=r.formatDisplayField[C.idx].call(f,C.displayValue,C.value,D[l[C.idx]],C.idx,r),m=C.displayValue):m=f.formatter(p,C.displayValue,l[C.idx],C.value)}catch(B){m=C.displayValue}e+="<tr id='"+p+"' data-jqgrouplevel='"+
C.idx+"' "+(r.groupCollapse&&0<C.idx?"style='display:none;' ":"")+"role='row' class='"+E+" "+q+"'>";var K=b.isFunction(r.groupText[C.idx])?r.groupText[C.idx].call(f,m,C.cnt,C.summary):u.template(r.groupText[C.idx],m,C.cnt,C.summary),H,M,I,L;L=0;I=y-1===C.idx;"string"!==typeof K&&"number"!==typeof K&&(K=m);"header"===r.groupSummaryPos[C.idx]?(H=1,"cb"!==D[0].name&&"cb"!==D[1].name||H++,"subgrid"!==D[0].name&&"subgrid"!==D[1].name||H++,e+=d(h,0,C,H,n+"<span class='cell-wrapper'>"+K+"</span>")):e+="<td role='gridcell' style='padding-left:"+
12*C.idx+"px;' colspan='"+v+"'>"+n+K+"</td>";e+="</tr>";if(I){K=x[h+1];I=C.startRow;H=void 0!==K?K.startRow:x[h].startRow+x[h].cnt;r._locgr&&(L=(A-1)*c,L>C.startRow&&(I=L));for(;I<H&&a[I-L];I++)e+=a[I-L].join("");if("header"!==r.groupSummaryPos[C.idx]){if(void 0!==K){for(M=0;M<r.groupField.length&&K.dataIndex!==r.groupField[M];M++);k=r.groupField.length-M}for(L=0;L<k;L++)t[L]&&(e+="<tr data-jqfootlevel='"+(C.idx-L)+(r.groupCollapse&&(0<C.idx-L||!r.showSummaryOnHide)?"' style='display:none;'":"'")+
" role='row' class='"+F+"'>",e+=d(h,L,x[C.idx-L],0),e+="</tr>");k=M}}});this.unbind("jqGridShowHideCol.groupingRender").bind("jqGridShowHideCol.groupingRender",function(){var a=g.iColByName[r.iconColumnName],c,d,e;if(0<=b.inArray("header",r.groupSummaryPos)){for(c=0;c<D.length;c++)if(!D[c].hidden){e=c;break}if(void 0!==e&&a!==e){for(c=0;c<f.rows.length;c++)d=f.rows[c],b(d).hasClass("jqgroup")&&(b(d.cells[e]).html(d.cells[a].innerHTML),b(d.cells[a]).html("&nbsp;"));r.iconColumnName=D[e].name}}});return e},
...
b,d,e,f,g){var k={sum:function(){return parseFloat(b||0)+parseFloat(g[d]||0)},min:function(){return""===b?parseFloat(g[d]||0):Math.min(parseFloat(b),parseFloat(g[d]||0))},max:function(){return""===b?parseFloat(g[d]||0):Math.max(parseFloat(b),parseFloat(g[d]||0))},count:function(){""===b&&(b=0);return g.hasOwnProperty(d)?b+1:0},avg:function(){return k.sum()}};if(!k[a])throw"jqGrid Grouping No such method: "+a;a=k[a]();null!=e&&("fixed"===f?a=a.toFixed(e):(e=Math.pow(10,e),a=Math.round(a*e)/e));return a}}});
...
"remote"===a.exptype&&(c=b.extend({},this.p.postData,a.exportOptions),c[a.oper]=a.tag,c=jQuery.param(c),c=-1!==a.url.indexOf("?")?a.url+"&"+c:a.url+"?"+c,window.location=c)})}});var Xa=function(a){var c=b.makeArray(arguments).slice(1);c.unshift("");c.unshift("Inline");c.unshift(a);return u.feedback.apply(this,c)};u.inlineEdit=u.inlineEdit||{};u.extend({editRow:function(a,c,d,e,f,g,k,m,l,n){var p={},q=b.makeArray(arguments).slice(1);"object"===b.type(q[0])?p=q[0]:(void 0!==c&&(p.keys=c),b.isFunction(d)&&
...
beforeEditRow:null,mtype:"POST",focusField:!0},u.inlineEdit,e.inlineEditing||{},p),q=d.jqGrid("getInd",a,!0),h=n.focusField,C="object"===typeof h&&null!=h?b(h.target||h).closest("tr.jqgrow>td")[0]:null;if(!1!==q&&(n.extraparam[m.oper]===m.addoper||Xa.call(c,n,"beforeEditRow",n,a))&&"0"===(b(q).attr("editable")||"0")&&!b(q).hasClass("not-editable-row")){m=u.detectRowEditing.call(c,a);if(null!=m&&"cellEditing"===m.mode){var m=m.savedRow,B=c.rows[m.id],H=Y.call(c,"select");d.jqGrid("restoreCell",m.id,
...
url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,beforeSaveRow:null,ajaxSaveOptions:{},serializeSaveData:null,mtype:"POST",saveui:"enable",savetext:l("defaults.savetext")||"Saving..."},u.inlineEdit,r.inlineEditing||{},n),x={},D={},v={},A,E,F,h;F=q.jqGrid("getInd",a,!0);var C=b(F);A=r.prmNames;var B=l("errors.errcap"),H=l("edit.bClose"),M;if(!1!==F&&(l=n.extraparam[A.oper]===A.addoper?"add":"edit",Xa.call(p,n,"beforeSaveRow",n,a,l)&&(A=C.attr("editable"),
n.url=n.url||r.editurl,M="clientArray"!==n.url,"1"===A)))if(u.enumEditableCells.call(p,F,C.hasClass("jqgrid-new-row")?"add":"edit",function(c){var d=c.cm,e=d.formatter,f=d.editoptions||{},g=d.formatoptions||{},k={},l=(b.jgrid.detectRowEditing.call(p,a)||{}).savedRow,m=u.getEditedValue.call(p,b(c.dataElement),d,k,c.editable);"select"===d.edittype&&"select"!==d.formatter&&(D[d.name]=k.text);h=u.checkValues.call(p,m,c.iCol,void 0,void 0,b.extend(c,{oldValue:null!=l?l[d.name]:null,newValue:m,oldRowData:l}));
if(null!=h&&!1===h[0])return!1;"date"===e&&!0!==g.sendFormatted&&(m=b.unformat.date.call(p,m,d));M&&!0===f.NullIfEmpty&&""===m&&(m="null");x[d.name]=m}),null!=h&&!1===h[0])try{var I=q.jqGrid("getGridRowById",a),G=u.findPos(I);t.call(p,B,h[1],H,{left:G[0],top:G[1]+b(I).outerHeight()})}catch(J){y(h[1])}else if(I=a,A=r.prmNames,G=!1===r.keyName?A.id:r.keyName,x&&(x[A.oper]=A.editoper,void 0===x[G]||""===x[G]?x[G]=a:F.id!==r.idPrefix+x[G]&&(F=u.stripPref(r.idPrefix,a),void 0!==r._index[F]&&(r._index[x[G]]=
r._index[F],delete r._index[F]),a=r.idPrefix+x[G],C.attr("id",a),r.selrow===I&&(r.selrow=a),b.isArray(r.selarrrow)&&(F=b.inArray(I,r.selarrrow),0<=F&&(r.selarrrow[F]=a)),r.multiselect&&(F="jqg_"+r.id+"_"+a,C.find("input.cbox").attr("id",F).attr("name",F))),x=b.extend({},x,r.inlineData||{},n.extraparam)),M)q.jqGrid("progressBar",{method:"show",loadtype:n.saveui,htmlcontent:n.savetext}),v=b.extend({},x,v),v[G]=u.stripPref(r.idPrefix,v[G]),r.autoEncodeOnEdit&&b.each(v,function(a,b){w(b)||(v[a]=u.oldEncodePostedData(b))}),
b.ajax(b.extend({url:w(n.url)?n.url.call(p,v[G],l,v,n):n.url,data:u.serializeFeedback.call(p,w(n.serializeSaveData)?n.serializeSaveData:r.serializeRowData,"jqGridInlineSerializeSaveData",v),type:w(n.mtype)?n.mtype.call(p,l,n,v[G],v):n.mtype,complete:function(c,d){q.jqGrid("progressBar",{method:"hide",loadtype:n.saveui,htmlcontent:n.savetext});if((300>c.status||304===c.status)&&(0!==c.status||4!==c.readyState)){var e,f;f=q.triggerHandler("jqGridInlineSuccessSaveRow",[c,a,n]);if(null==f||!0===f)f=[!0,
x];f[0]&&w(n.successfunc)&&(f=n.successfunc.call(p,c));b.isArray(f)?(e=f[0],x=f[1]||x):e=f;if(!0===e){r.autoEncodeOnEdit&&b.each(x,function(a,b){x[a]=u.oldDecodePostedData(b)});x=b.extend({},x,D);q.jqGrid("setRowData",a,x);C.attr("editable","0");for(e=0;e<r.savedRow.length;e++)if(String(r.savedRow[e].id)===String(a)){E=e;break}0<=E&&r.savedRow.splice(E,1);la.call(p,n.aftersavefunc,"jqGridInlineAfterSaveRow",a,c,x,n);C.removeClass("jqgrid-new-row").unbind("keydown")}else la.call(p,n.errorfunc,"jqGridInlineErrorSaveRow",
a,c,d,null,n),!0===n.restoreAfterError&&q.jqGrid("restoreRow",a,n.afterrestorefunc)}},error:function(c,d,e){b("#lui_"+u.jqID(r.id)).hide();q.triggerHandler("jqGridInlineErrorSaveRow",[a,c,d,e,n]);if(w(n.errorfunc))n.errorfunc.call(p,a,c,d,e);else{c=c.responseText||c.statusText;try{t.call(p,B,'<div class="'+Y.call(p,"error")+'">'+c+"</div>",H,{buttonalign:"right"})}catch(f){y(c)}}!0===n.restoreAfterError&&q.jqGrid("restoreRow",a,n.afterrestorefunc)}},u.ajaxOptions,r.ajaxRowOptions,n.ajaxSaveOptions||
{}));else{x=b.extend({},x,D);F=q.jqGrid("setRowData",a,x);C.attr("editable","0");for(l=0;l<r.savedRow.length;l++)if(String(r.savedRow[l].id)===String(I)){E=l;break}0<=E&&r.savedRow.splice(E,1);la.call(p,n.aftersavefunc,"jqGridInlineAfterSaveRow",a,F,x,n);C.removeClass("jqgrid-new-row").unbind("keydown")}}},restoreRow:function(a,c){var d=b.makeArray(arguments).slice(1),e={};"object"===b.type(d[0])?e=d[0]:b.isFunction(c)&&(e.afterrestorefunc=c);return this.each(function(){var c=this,d=b(c),k=c.p,m=
-1,l={},n;if(c.grid){var p=b.extend(!0,{},u.inlineEdit,k.inlineEditing||{},e),q=d.jqGrid("getInd",a,!0);if(!1!==q&&Xa.call(c,p,"beforeCancelRow",p,a)){for(n=0;n<k.savedRow.length;n++)if(String(k.savedRow[n].id)===String(a)){m=n;break}if(0<=m){if(b.isFunction(b.fn.datepicker))try{b("input.hasDatepicker","#"+u.jqID(q.id)).datepicker("hide")}catch(r){}b.each(k.colModel,function(){var a=this.name;k.savedRow[m].hasOwnProperty(a)&&(l[a]=k.savedRow[m][a],!this.formatter||"date"!==this.formatter||null!=this.formatoptions&&
!0===this.formatoptions.sendFormatted||(l[a]=b.unformat.date.call(c,l[a],this)))});d.jqGrid("setRowData",a,l);b(q).attr("editable","0").unbind("keydown");k.savedRow.splice(m,1);b("#"+u.jqID(a),c).hasClass("jqgrid-new-row")&&setTimeout(function(){d.jqGrid("delRowData",a);d.jqGrid("showAddEditButtons",!1)},0)}la.call(c,p.afterrestorefunc,"jqGridInlineAfterRestoreRow",a)}}})},addRow:function(a){return this.each(function(){if(this.grid){var c=this,d=b(c),e=c.p,f=b.extend(!0,{rowID:null,initdata:{},position:"first",
...
f.position),b("#"+u.jqID(f.rowID),c).addClass("jqgrid-new-row"),f.useFormatter?b("#"+u.jqID(f.rowID)+" .ui-inline-edit",c).click():(e=e.prmNames,f.addRowParams.extraparam[e.oper]=e.addoper,d.jqGrid("editRow",f.rowID,f.addRowParams),d.jqGrid("setSelection",f.rowID)))}})},inlineNav:function(a,c){"object"===typeof a&&(c=a,a=void 0);return this.each(function(){var d=this,e=b(d),f=d.p;if(this.grid&&null!=f){var g,k=a===f.toppager?f.idSel+"_top":f.idSel,m=a===f.toppager?f.id+"_top":f.id,l=Y.call(d,"disabled"),
...
0===a.offsetHeight||"none"===a.style.display});u._multiselect=!1;if(fa){if(fa.prototype._setSelected){var Gb=fa.prototype._setSelected;fa.prototype._setSelected=function(a,c){var d=this,e=Gb.call(d,a,c);if(c&&d.selectedList){var f=d.element;d.selectedList.find("li").each(function(){b(d).data("optionLink")&&b(d).data("optionLink").remove().appendTo(f)})}return e}}fa.prototype.destroy&&(fa.prototype.destroy=function(){this.element.show();this.container.remove();void 0===b.Widget?b.widget.prototype.destroy.apply(this,
...
c){a&&("string"===typeof a?b.fn[a]&&b.fn[a].apply(c,b.makeArray(arguments).slice(2)):b.isFunction(a)&&a.apply(c,b.makeArray(arguments).slice(2)))}var d=this,e=d[0].p,f,g,k={},m=[],l,n,p=e.colModel;l=p.length;n=e.colNames;var q=function(a){return fa&&fa.prototype&&a.data(fa.prototype.widgetFullName||fa.prototype.widgetName)||a.data("ui-multiselect")||a.data("multiselect")};if(!b("#colchooser_"+G(e.id)).length){f=b('<div id="colchooser_'+e.id+'" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>');
...
groupSummaryPos:"header",frozenStaticCols:!1,defaultFormatting:!0,data:a},c||{}),l,n,p,q=a.length,r,t,w,y,x,D,v=m.xDimension,A=m.yDimension,E=m.aggregates,F,q=m.totalText||m.totals||m.rowTotals||m.totalHeader,h,C=e(v)?v.length:0;y=e(A)?A.length:0;var B=e(E)?E.length:0,H=y-(1===B?1:0),G=[],I=[],L=[],e=[],J=Array(B),O=Array(y),z,P,N,R,Q,U,S,ba,V,Y,W;n=function(c,d,e){c=new za(m.trimByCollect,m.caseSensitive,d,c);b.isFunction(e)&&(c.compareVectorsEx=e);c.createDataIndex(a);return c};var da=function(a,
c,e,f,g){var h,k;switch(a){case 1:h=A[f].totalText||"{0} {1} {2}";k="y"+g+"t"+f;break;case 2:h=m.totalText||"{0}";k="t";break;default:h=1<B?c.label||"{0}":W.getItem(g)[f],k="y"+g}a=b.extend({},c,{name:k+(1<B?"a"+e:""),label:b.isFunction(h)?h.call(d,2===a?{aggregate:c,iAggregate:e,pivotOptions:m}:{yIndex:W.getItem(g),aggregate:c,iAggregate:e,yLevel:f,pivotOptions:m}):u.template.apply(d,2===a?[h,c.aggregator,c.member,e]:[h,c.aggregator,c.member,W.getItem(g)[f],f])});delete a.member;delete a.aggregator;
return a};x=function(a,b,c){var d,e;for(d=0;d<B;d++)e=E[d],void 0===e.template&&void 0===e.formatter&&m.defaultFormatting&&(e.template="count"===e.aggregator?"integer":"number"),L.push(da(a,e,d,b,c))};z=function(a,c,e){var f,g,h,k;for(f=H-1;f>=c;f--)if(I[f]){for(g=0;g<=f;g++)V=G[g].groupHeaders,V[V.length-1].numberOfColumns+=B;r=A[f];h=r.totalHeader;k=r.headerOnTop;for(g=f+1;g<=H-1;g++)G[g].groupHeaders.push({titleText:k&&g===f+1||!k&&g===H-1?b.isFunction(h)?h.call(d,e,f):u.template.call(d,h||"",
e[f],f):"",startColumnName:"y"+(a-1)+"t"+f+(1===B?"":"a0"),numberOfColumns:B})}};var aa=function(a){a=new xa("count"===E[a].aggregator?"sum":E[a].aggregator,d,c);a.groupInfo={iRows:[],rows:[],ys:[],iYs:[]};return a},ea=function(){var a,b;for(a=H-1;0<=a;a--)if(I[a])for(null==O[a]&&(O[a]=Array(B)),b=0;b<B;b++)O[a][b]=aa(b)},fa=function(a,b,c,d){var e,f=W.getIndexOfDifferences(b,c),g,h;if(null!==c)for(f=Math.max(f,0),e=H-1;e>=f;e--)g="y"+a+"t"+e+(1<B?"a"+d:""),I[e]&&void 0===S[g]&&(h=O[e][d],h.getResult(S,
g),S.pivotInfos[g]={colType:1,iA:d,a:E[d],level:e,iRows:h.groupInfo.iRows,rows:h.groupInfo.rows,ys:h.groupInfo.ys,iYs:h.groupInfo.iYs},b!==c&&(O[e][d]=aa(d)))},ga=function(c,d,e,f,g,h,k){var l;if(c!==d)for(d=H-1;0<=d;d--)I[d]&&(l=O[d][f],l.calc(g[e.member],e.member,g,h,a),l=l.groupInfo,0>b.inArray(k,l.iYs)&&(l.iYs.push(k),l.ys.push(c)),0>b.inArray(h,l.iRows)&&(l.iRows.push(h),l.rows.push(g)))};if(0===C||0===B)throw"xDimension or aggregates options are not set!";Y=n(v,m.skipSortByX,m.compareVectorsByX);
W=n(A,m.skipSortByY,m.compareVectorsByY);c.xIndex=Y;c.yIndex=W;for(n=0;n<C;n++)p=v[n],t={name:"x"+n,label:null!=p.label?b.isFunction(p.label)?p.label.call(d,p,n,m):p.label:p.dataName,frozen:m.frozenStaticCols},n<C-1&&(g.groupField.push(t.name),g.groupSummary.push(m.groupSummary),g.groupSummaryPos.push(m.groupSummaryPos)),t=b.extend(t,p),delete t.dataName,delete t.footerText,L.push(t);2>C&&(k.grouping=!1);k.sortname=L[C-1].name;g.hideFirstGroupCol=!0;for(n=0;n<y;n++)r=A[n],I.push(r.totals||r.rowTotals||
r.totalText||r.totalHeader?!0:!1);ba=W.getItem(0);x(0,y-1,0);g=W.getIndexLength();for(t=1;t<g;t++){N=W.getItem(t);n=W.getIndexOfDifferences(N,ba);for(p=H-1;p>=n;p--)I[p]&&x(1,p,t-1);ba=N;x(0,y-1,t)}for(n=H-1;0<=n;n--)I[n]&&x(1,n,g-1);q&&x(2);ba=W.getItem(0);for(p=0;p<H;p++)G.push({useColSpanStyle:m.useColSpanStyle,groupHeaders:[{titleText:ba[p],startColumnName:1===B?"y0":"y0a0",numberOfColumns:B}]});for(t=1;t<g;t++){N=W.getItem(t);n=W.getIndexOfDifferences(N,ba);z(t,n,ba);for(p=H-1;p>=n;p--)G[p].groupHeaders.push({titleText:N[p],
startColumnName:"y"+t+(1===B?"":"a0"),numberOfColumns:B});for(p=0;p<n;p++)V=G[p].groupHeaders,V[V.length-1].numberOfColumns+=B;ba=N}z(g,0,ba);if(q)for(n=0;n<H;n++)G[n].groupHeaders.push({titleText:n<H-1?"":m.totalHeader||"",startColumnName:"t"+(1===B?"":"a0"),numberOfColumns:B});z=Y.getIndexLength();for(y=0;y<z;y++){p=Y.getItem(y);x={iX:y,x:p};S={pivotInfos:x};for(n=0;n<C;n++)S["x"+n]=p[n];P=Y.getIndexesOfSourceData(y);if(q)for(p=0;p<B;p++)J[p]=aa(p);ba=null;ea();for(t=0;t<g;t++){N=W.getItem(t);R=
W.getIndexesOfSourceData(t);for(p=0;p<B;p++){null!==ba&&fa(t-1,N,ba,p);Q=[];for(n=0;n<R.length;n++)w=R[n],0<=b.inArray(w,P)&&Q.push(w);if(0<Q.length){D=Array(Q.length);U=E[p];F=new xa(U.aggregator,d,c);for(w=0;w<Q.length;w++)n=Q[w],l=a[n],D[w]=l,F.calc(l[U.member],U.member,l,n,a),q&&(h=J[p],h.calc(l[U.member],U.member,l,n,a),h=h.groupInfo,0>b.inArray(n,h.iYs)&&(h.iYs.push(t),h.ys.push(N)),0>b.inArray(n,h.iRows)&&(h.iRows.push(n),h.rows.push(l))),ga(N,ba,U,p,l,n,t);l="y"+t+(1===B?"":"a"+p);F.getResult(S,
l);x[l]={colType:0,iY:t,y:N,iA:p,a:U,iRows:Q,rows:D}}}ba=N}if(null!==ba)for(p=0;p<B;p++)fa(g-1,ba,ba,p);if(q)for(p=0;p<B;p++)l="t"+(1===B?"":"a"+p),h=J[p],h.getResult(S,l),h=h.groupInfo,x[l]={colType:2,iA:p,a:E[p],iRows:h.iRows,rows:h.rows,iYs:h.iYs,ys:h.ys};e.push(S)}if(m.footerTotals||m.colTotals){q=e.length;for(n=0;n<C;n++)f["x"+n]=v[n].footerText||"";for(n=C;n<L.length;n++){l=L[n].name;F=new xa(m.footerAggregator||"sum",d,c);for(w=0;w<q;w++)S=e[w],F.calc(S[l],l,S,w,e);F.getResult(f,l)}}c.colHeaders=
G;return{colModel:L,options:c,rows:e,groupOptions:k,groupHeaders:G,summary:f}},jqPivot:function(a,c,d,e){return this.each(function(){function f(){var e=m.pivotSetup.call(k,a,c),f=e.groupHeaders,p=e.summary,q=0,r;for(r in p)p.hasOwnProperty(r)&&q++;p=0<q?!0:!1;q=e.groupOptions.groupingView;r=u.from.call(g,e.rows);var t;if(c.skipSortByX)for(t=0;t<q.groupField.length;t++)r.orderBy(q.groupField[t],null!=d&&d.groupingView&&null!=d.groupingView.groupOrder&&"desc"===d.groupingView.groupOrder[t]?"d":"a",
...
String(this);d&&-1===b.inArray(d,f)&&(0<=b.inArray(c,g)?a.additionalProperties.push({name:d,search:!1,convert:function(a){return!0===a||"true"===String(a).toLowerCase()||"1"===String(a)?!0:a}}):a.additionalProperties.push(d))})}})},expandRow:function(a){this.each(function(){var c=b(this),d=this.p;if(this.grid&&d.treeGrid){var e=d.treeReader.expanded_field,f=a[d.localReader.id];if(ya.call(this,"beforeExpandRow",{rowid:f,item:a})){var g=B.getNodeChildren.call(c,a);b(g).each(function(){var a=d.idPrefix+
pa(this,d.localReader.id);b(B.getGridRowById.call(c,a)).css("display","");this[e]&&B.expandRow.call(c,this)});ya.call(this,"afterExpandRow",{rowid:f,item:a})}}})},collapseRow:function(a){this.each(function(){var c=b(this),d=this.p;if(this.grid&&d.treeGrid){var e=d.treeReader.expanded_field,f=a[d.localReader.id];if(ya.call(this,"beforeCollapseRow",{rowid:f,item:a})){var g=B.getNodeChildren.call(c,a);b(g).each(function(){var a=d.idPrefix+pa(this,d.localReader.id);b(B.getGridRowById.call(c,a)).css("display",
"none");this[e]&&B.collapseRow.call(c,this)});ya.call(this,"afterCollapseRow",{rowid:f,item:a})}}})},getRootNodes:function(){var a=[];this.each(function(){var c=this.p;if(this.grid&&c.treeGrid)switch(c.treeGridModel){case "nested":var d=c.treeReader.level_field;b(c.data).each(function(){parseInt(this[d],10)===parseInt(c.tree_root_level,10)&&a.push(this)});break;case "adjacency":var e=c.treeReader.parent_id_field;b(c.data).each(function(){null!==this[e]&&"null"!==String(this[e]).toLowerCase()||a.push(this)})}});
return a},getNodeDepth:function(a){var c=null;this.each(function(){var d=this.p;if(this.grid&&d.treeGrid)switch(d.treeGridModel){case "nested":c=parseInt(a[d.treeReader.level_field],10)-parseInt(d.tree_root_level,10);break;case "adjacency":c=B.getNodeAncestors.call(b(this),a).length}});return c},getNodeParent:function(a){var c=this[0];if(!c||!c.grid||null==c.p||!c.p.treeGrid||null==a)return null;var c=c.p,d=c.treeReader,e=a[d.parent_id_field];if("nested"===c.treeGridModel){var f=null,g=d.left_field,
...
[];this.each(function(){var d=b(this),e=B.getNodeParent;if(this.grid&&this.p.treeGrid)for(var f=e.call(d,a);f;)c.push(f),f=e.call(d,f)});return c},isVisibleNode:function(a){var c=!0;this.each(function(){var d=this.p;if(this.grid&&d.treeGrid){var e=B.getNodeAncestors.call(b(this),a),f=d.treeReader.expanded_field;b(e).each(function(){c=c&&this[f];if(!c)return!1})}});return c},isNodeLoaded:function(a){var c;this.each(function(){var d=this.p;if(this.grid&&d.treeGrid){var e=d.treeReader.leaf_field,d=d.treeReader.loaded;
c=void 0!==a?void 0!==a[d]?a[d]:a[e]||0<B.getNodeChildren.call(b(this),a).length?!0:!1:!1}});return c},expandNode:function(a){return this.each(function(){var c=this.p;if(this.grid&&c.treeGrid){var d=c.treeReader.expanded_field,e=c.treeReader.parent_id_field,f=c.treeReader.loaded,g=c.treeReader.level_field,k=c.treeReader.left_field,m=c.treeReader.right_field;if(!a[d]){var l=pa(a,c.localReader.id);if(ya.call(this,"beforeExpandNode",{rowid:l,item:a})){var n=b("#"+c.idPrefix+G(l),this.grid.bDiv)[0],p=
c._index[l];"local"===c.treedatatype||B.isNodeLoaded.call(b(this),c.data[p])?(a[d]=!0,b("div.treeclick",n).removeClass(c.treeIcons.plus+" tree-plus").addClass(c.treeIcons.commonIconClass).addClass(c.treeIcons.minus+" tree-minus")):this.grid.hDiv.loading||(a[d]=!0,b("div.treeclick",n).removeClass(c.treeIcons.plus+" tree-plus").addClass(c.treeIcons.commonIconClass).addClass(c.treeIcons.minus+" tree-minus"),c.treeANode=n.rowIndex,c.datatype=c.treedatatype,B.setGridParam.call(b(this),{postData:"nested"===
...
ya.call(this,"beforeCollapseNode",{rowid:e,item:a})&&(a[d]=!1,d=b("#"+c.idPrefix+G(e),this.grid.bDiv)[0],b("div.treeclick",d).removeClass(c.treeIcons.minus+" tree-minus").addClass(c.treeIcons.commonIconClass).addClass(c.treeIcons.plus+" tree-plus"),ya.call(this,"afterCollapseNode",{rowid:e,item:a}))}}})},SortTree:function(a,c,d,e){return this.each(function(){var f=this,g=f.p,k=b(f);if(f.grid&&g.treeGrid){var m,l,n,p=[];m=B.getRootNodes.call(k);m=u.from.call(f,m);m.orderBy(a,c,d,e);var q=m.select();
m=0;for(l=q.length;m<l;m++)n=q[m],p.push(n),B.collectChildrenSortTree.call(k,p,n,a,c,d,e);b.each(p,function(a){var c=pa(this,g.localReader.id);b(f.rows[a]).after(k.find(">tbody>tr#"+G(c)))})}})},collectChildrenSortTree:function(a,c,d,e,f,g){return this.each(function(){var k=b(this);if(this.grid&&this.p.treeGrid){var m,l,n;m=B.getNodeChildren.call(k,c);m=u.from.call(this,m);m.orderBy(d,e,f,g);var p=m.select();m=0;for(l=p.length;m<l;m++)n=p[m],a.push(n),B.collectChildrenSortTree.call(k,a,n,d,e,f,g)}})},
setTreeRow:function(a,c){var d=!1;this.each(function(){this.grid&&this.p.treeGrid&&(d=B.setRowData.call(b(this),a,c))});return d},delTreeNode:function(a){return this.each(function(){var c=this.p,d,e,f,g;f=c.localReader.id;var k,m=b(this),l=c.treeReader.left_field,n=c.treeReader.right_field;if(this.grid&&c.treeGrid&&(k=c._index[a],void 0!==k)){d=parseInt(c.data[k][n],10);e=d-parseInt(c.data[k][l],10)+1;var p=B.getFullTreeNode.call(m,c.data[k]);if(0<p.length)for(k=0;k<p.length;k++)B.delRowData.call(m,
p[k][f]);if("nested"===c.treeGridModel){f=u.from.call(this,c.data).greater(l,d,{stype:"integer"}).select();if(f.length)for(g in f)f.hasOwnProperty(g)&&(f[g][l]=parseInt(f[g][l],10)-e);f=u.from.call(this,c.data).greater(n,d,{stype:"integer"}).select();if(f.length)for(g in f)f.hasOwnProperty(g)&&(f[g][n]=parseInt(f[g][n],10)-e)}}})},addChildNode:function(a,c,d,e){var f=b(this),g=f[0],k=g.p,m=B.getInd;if(d){var l,n,p,q,r;l=0;var t=c,w,y,x=k.treeReader.expanded_field;y=k.treeReader.leaf_field;var D=k.treeReader.level_field,
v=k.treeReader.parent_id_field,A=k.treeReader.left_field,E=k.treeReader.right_field,F=k.treeReader.loaded;void 0===e&&(e=!1);if(null==a){r=k.data.length-1;if(0<=r)for(;0<=r;)l=Math.max(l,parseInt(k.data[r][k.localReader.id],10)),r--;a=l+1}var h=m.call(f,c);w=!1;if(void 0===c||null===c||""===c)t=c=null,l="last",q=k.tree_root_level,r=k.data.length+1;else{l="after";n=k._index[c];p=k.data[n];c=p[k.localReader.id];r=m.call(f,c);q=parseInt(p[D],10)+1;var C=B.getFullTreeNode.call(f,p);if(C.length){var G,
H,J;for(G=0;G<C.length;G++)J=C[G][k.localReader.id],H=m.call(f,J),H>r&&(r=H,t=J)}r++;p[y]&&(w=!0,p[x]=!0,b(g.rows[h]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(k.treeIcons.leaf+" tree-leaf").addClass(k.treeIcons.commonIconClass).addClass(k.treeIcons.minus+" tree-minus"),k.data[n][y]=!1,p[F]=!0)}m=r+1;void 0===d[x]&&(d[x]=!1);void 0===d[F]&&(d[F]=!1);d[D]=q;void 0===d[y]&&(d[y]=!0);"adjacency"===k.treeGridModel&&(d[v]=
c);if("nested"===k.treeGridModel){var I;if(null!==c){y=parseInt(p[E],10);k=u.from.call(g,k.data);k=k.greaterOrEquals(E,y,{stype:"integer"});D=k.select();if(D.length)for(I in D)D.hasOwnProperty(I)&&(D[I][A]=D[I][A]>y?parseInt(D[I][A],10)+2:D[I][A],D[I][E]=D[I][E]>=y?parseInt(D[I][E],10)+2:D[I][E]);d[A]=y;d[E]=y+1}else{y=parseInt(B.getCol.call(f,E,!1,"max"),10);D=u.from.call(g,k.data).greater(A,y,{stype:"integer"}).select();if(D.length)for(I in D)D.hasOwnProperty(I)&&(D[I][A]=parseInt(D[I][A],10)+2);
D=u.from.call(g,k.data).greater(E,y,{stype:"integer"}).select();if(D.length)for(I in D)D.hasOwnProperty(I)&&(D[I][E]=parseInt(D[I][E],10)+2);d[A]=y+1;d[E]=y+2}}if(null===c||B.isNodeLoaded.call(f,p)||w)B.addRowData.call(f,a,d,l,t),B.setTreeNode.call(f,r,m);p&&!p[x]&&e&&b(g.rows[h]).find("div.treeclick").click()}}});var Ya="mousedown",Sa="mousemove",Ia="mouseup",wb=function(a){var b=a.originalEvent.targetTouches;return b?(b=b[0],{x:b.pageX,y:b.pageY}):{x:a.pageX,y:a.pageY}},La={drag:function(a){var b=
