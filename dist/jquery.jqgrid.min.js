...
a,c,e,"add",h);return"<td role='gridcell' "+M(c,d,a,e,b,h)+">"+a+"</td>"},L=function(a,c,d,e,h){var f="&nbsp;",g=!0;b.isFunction(l.hasMultiselectCheckBox)&&(g=l.hasMultiselectCheckBox.call(m,{rowid:a,iRow:d,iCol:c,data:h}));g&&(f="<input type='checkbox' id='jqg_"+l.id+"_"+a+"' class='cbox' name='jqg_"+l.id+"_"+a+"'"+(e?" checked='checked' aria-checked='true'":" aria-checked='false'")+"/>");return"<td role='gridcell' "+M(c,d,"",null,a,!0)+">"+f+"</td>"},Z=function(b,a,c,d){c=(parseInt(c,10)-1)*parseInt(d,
10)+1+a;return"<td role='gridcell' class='"+K.getGuiStyles.call(n,"rowNum","jqgrid-rownum")+"' "+M(b,a,c,null,a,!0)+">"+c+"</td>"};1>=H&&(l.rowIndexes={});if("local"===l.datatype&&!l.deselectAfterSort||l.multiPageSelection)D=!0;g&&(h*=g+1);for(g=0;g<Math.min(a,h);g++){t=c[g];w=d[g];y=null!=e?e[g]:w;p=1===f?0:f;q=1===(p+g)%2?E:"";D&&(l.multiselect?(r=-1!==b.inArray(t,l.selarrrow))&&null===l.selrow&&(l.selrow=t):r=t===l.selrow);x=v.length;v.push("");for(p=0;p<l.colModel.length;p++)switch(C=l.colModel[p].name,
C){case "rn":v.push(Z(p,g,l.page,l.rowNum));break;case "cb":v.push(L(t,p,g,r,w));break;case "subgrid":v.push(K.addSubGridCell.call(n,p,g+f,t,w));break;default:v.push(I(t,w[C],p,g+f,y,w))}v[x]=m.constructTr(t,F,q,w,y,r);v.push("</tr>");l.rowIndexes[t]=H;H++;l.grouping&&K.groupingPrepare&&(A.push(v),l.groupingView._locgr||K.groupingPrepare.call(n,w,g),v=[]);v.length>l.maxItemsToJoin&&(v=[v.join("")])}l.grouping&&K.groupingRender&&(k&&(l.groupingView._locgr=!0),v=[K.groupingRender.call(n,A,h)],u.clearArray(A));
...
return u.feedback.apply(this,a)};b.fn.jqGrid=function(a){var c=b.fn.jqGrid,d;if("string"===typeof a){d=c[a];if(!d)throw"jqGrid - No such method: "+a;return d.apply(this,b.makeArray(arguments).slice(1))}return this.each(function(){if(!this.grid){var d=this,f,g,k=b(d),m=b.isFunction,l=b.isArray,n=b.extend,p=b.inArray,q=b.trim,r=b.each,t=c.setSelection,w=c.getGridRes,y=m(Aa.fatalError)?Aa.fatalError:alert,x=a.locale||Aa.locale||"en-US",D=null!=Ja[x]&&"boolean"===typeof Ja[x].isRTL?Ja[x].isRTL?"rtl":
"ltr":"ltr",v=a.iconSet||Aa.iconSet||("bootstrap"===(a.guiStyle||Aa.guiStyle)||"bootstrapPrimary"===(a.guiStyle||Aa.guiStyle)?"glyph":"jQueryUI"),A=a.guiStyle||Aa.guiStyle||"jQueryUI",E=function(b){return c.getIconRes.call(d,b)},F=function(b,a){return k.jqGrid("getGuiStyles",b,a)};null==a&&(a={datatype:"local"});void 0!==a.datastr&&l(a.datastr)&&(g=a.datastr,a.datastr=[]);void 0!==a.data&&(f=a.data,a.data=[]);null!=u.formatter&&null!=u.formatter.unused||y("CRITICAL ERROR!!!\n\n\nOne uses probably\n\n\t$.extend($.jgrid.defaults, {...});\n\nto set default settings of jqGrid instead of the usage the DEEP version of jQuery.extend (with true as the first parameter):\n\n\t$.extend(true, $.jgrid.defaults, {...});\n\nOne other possible reason:\n\nyou included some OLD version of language file (grid.locale-en.js for example) AFTER jquery.jqGrid.min.js. For example all language files of jqGrid 4.7.0 uses non-deep call of jQuery.extend.\n\n\nSome options of jqGrid could still work, but another one will be broken.");
...
B[b]=Pa(a):/^\[\w+\]$/.test(a)&&(B[b]=Z(a.substring(1,a.length-1))))},ka=function(b){var a=b.name,c=r?b.xmlmap||a:"local"===n&&!h.dataTypeOrg||"jsonstring"===n||"json"===n||"jsonp"===n?b.jsonmap||a:a;!1!==h.keyName&&!0===b.key&&(h.keyName=a);if("string"===typeof c||m(c))B[a]=c;m(c)||Q(a,c)};for(v=0;v<K;v++)ka(F[v]);K=Ca.length;for(v=0;v<K;v++)y=Ca[v],"object"===typeof y&&null!=y?ka(y):Q(y,y);w=!1===h.keyName?m(q.id)?q.id.call(this,a):q.id:h.keyName;isNaN(w)?m(w)||(N[w]&&(E=N[w].order),r&&("string"===
typeof w&&/^\[\w+\]$/.test(w)?w=Z(w.substring(1,w.length-1)):"string"===typeof w&&/^\w+$/.test(w)&&(w=Pa(w)))):E=Number(w);C=t(a,q.root,!0);if(q.row)if(1===C.length&&"string"===typeof q.row&&/^\w+$/.test(q.row)){K=[];L=C[0].childNodes;ja=L.length;for(y=0;y<ja;y++)H=L[y],1===H.nodeType&&H.nodeName===q.row&&K.push(H);C=K}else C=t(C,q.row,!0);null==C&&l(a)&&(C=a);C||(C=[]);a=C.length;0<a&&0>=h.page&&(h.page=1);ka=parseInt(h.rowNum,10);f&&(ka*=f+1);var F=[],G=[],ha,K=[];for(v=0;v<a;v++){ha=C[v];A=q.repeatitems&&
q.cell?t(ha,q.cell,!0)||ha:ha;M=q.repeatitems&&(r||l(A));D={};ca={};if(r&&!M&&null!=A)for(L=A.childNodes,ja=L.length,y=0;y<ja;y++)H=L[y],1===H.nodeType&&(ca[H.nodeName]=H);for(x in N)N.hasOwnProperty(x)&&(y=N[x],M?(L=A[y.order],r&&null!=L&&(L=L.textContent||L.text)):L=null!=B[x]&&"string"!==typeof B[x]?B[x](A):t(A,"string"===typeof B[x]?B[x]:y.name),1===y.type&&(y=Ca[y.index],null!=y&&m(y.convert)&&(L=y.convert(L,A))),void 0!==L&&(D[x]=L));void 0!==D[w]?ha=void 0!==D[w]?D[w]:Da():(ha=t(ha,l(ha)?E:
...
var D=function(b,a){var c=b.height();1<=Math.abs(c-a)&&0<a&&(b.height(a),c=b.height(),1<=Math.abs(a-c)&&b.height(a+Math.round(a-c)))},v=function(b,a){var c=b.width();1<=Math.abs(c-a)&&(b.width(a),c=b.width(),1<=Math.abs(a-c)&&b.width(a+Math.round(a-c)))},A=function(a,c,e,f){var k,l,m,n,p,r,q;q=b(c).position().top;var t,u,v;if(null!=a&&0<a.length){a[0].scrollTop=c.scrollTop;a.css("rtl"===d.direction?{top:q,right:0}:{top:q,left:0});l=a.children("table").children("thead").children("tr");m=b(c).children("div").children("table").children("thead").children("tr");
0===m.length&&(l=b(a.children("table")[0].rows),m=b(b(c).children("div").children("table")[0].rows));k=Math.min(l.length,m.length);t=0<k?b(l[0]).position().top:0;u=0<k?b(m[0]).position().top:0;if(0<=e)for(0<=f&&(k=Math.min(f+1,k));e<k;e++)if(n=b(m[e]),"none"!==n.css("display")&&n.is(":visible")){q=n.position().top;f=b(l[e]);p=f.position().top;r=n.height();if(null!=d.groupHeader&&d.groupHeader.useColSpanStyle)for(v=n[0].cells,g=0;g<v.length;g++)n=v[g],null!=n&&"TH"===n.nodeName.toUpperCase()&&(r=Math.max(r,
b(n).height()));q=r+(q-u)+(t-p);D(f,q)}D(a,c.clientHeight)}},l={resizeDiv:!0,resizedRows:{iRowStart:0,iRowEnd:-1}},E={header:l,resizeFooter:!0,body:l};c.bind("jqGridAfterGridComplete.setFrozenColumns",function(){b(d.idSel+"_frozen").remove();b(e.fbDiv).height(e.hDiv.clientHeight);var a=b(this).clone(!0),f=a[0].rows,g=c[0].rows;b(f).filter("tr[role=row]").each(function(){b(this.cells).filter("td[role=gridcell]:gt("+m+")").remove()});e.fbRows=f;a.width(1).attr("id",d.id+"_frozen");a.appendTo(e.fbDiv);
...
v+" ui-helper-reset'>&#160;</td>",x="",w="<td class='"+w+"'></td><td class='"+v+"'></td>",C=["integer","number","currency"],y=0,A=0,F,D,K;for(v=1;v<=d;v++)x+=1===v?z:w;b(E).each(function(){(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==b.inArray(this.formatter,C)?y=Math.max(y,parseInt(this.width,10)):A=Math.max(A,parseInt(this.width,10)))});F=0!==y?y:0!==A?A:0;b(E).each(function(a){e=this.name;D=!1;p=(f=this.editrules&&!0===
...
this,e=d.p;if(d.grid){var f=b.extend({caption:"newButton",title:"",onClickButton:null,position:"last",cursor:"pointer",iconsOverText:!1},B.getGridRes.call(b(d),"nav"),u.nav||{},e.navOptions||{},c||{}),g=f.id,k=Y.call(d,"hover"),m=Y.call(d,"disabled"),l=P.call(d,"navButton","ui-pg-button");if(void 0===a)if(e.pager)if(B.navButtonAdd.call(b(d),e.pager,f),e.toppager)a=e.toppager,g&&(g+="_top");else return;else e.toppager&&(a=e.toppager);"string"===typeof a&&0!==a.indexOf("#")&&(a="#"+G(a));var e=b(".navtable",
...
var e="",f=this[0],g=f.p,k=0,m,l=[],n="",p,q,r=g.groupingView,t=b.makeArray(r.groupSummary),w=(r.groupCollapse?r.plusicon:r.minusicon)+" tree-wrap",y=r.groupField.length,x=r.groups,D=g.colModel,v=D.length,A=g.page,E=B.getGuiStyles.call(f,"gridRow","jqgroup ui-row-"+g.direction),F=B.getGuiStyles.call(f,"gridRow","jqfoot ui-row-"+g.direction);b.each(D,function(b,a){var c;for(c=0;c<y;c++)if(r.groupField[c]===a.name){l[c]=b;break}});t.reverse();b.each(x,function(h,C){if(r._locgr&&!(C.startRow+C.cnt>(A-
1)*c&&C.startRow<A*c))return!0;k++;q=g.id+"ghead_"+C.idx;p=q+"_"+h;n="<span style='cursor:pointer;margin-"+("rtl"===g.direction?"right:":"left:")+12*C.idx+"px;' class='"+r.commonIconClass+" "+w+"' onclick=\"jQuery('#"+u.jqID(g.id).replace("\\","\\\\")+"').jqGrid('groupingToggle','"+p+"', this);return false;\"></span>";try{b.isArray(r.formatDisplayField)&&b.isFunction(r.formatDisplayField[C.idx])?(C.displayValue=r.formatDisplayField[C.idx].call(f,C.displayValue,C.value,D[l[C.idx]],C.idx,r),m=C.displayValue):
m=f.formatter(p,C.displayValue,l[C.idx],C.value)}catch(B){m=C.displayValue}e+="<tr id='"+p+"' data-jqgrouplevel='"+C.idx+"' "+(r.groupCollapse&&0<C.idx?"style='display:none;' ":"")+"role='row' class='"+E+" "+q+"'>";var K=b.isFunction(r.groupText[C.idx])?r.groupText[C.idx].call(f,m,C.cnt,C.summary):u.template(r.groupText[C.idx],m,C.cnt,C.summary),H,M,I,L;L=0;I=y-1===C.idx;"string"!==typeof K&&"number"!==typeof K&&(K=m);"header"===r.groupSummaryPos[C.idx]?(H=1,"cb"!==D[0].name&&"cb"!==D[1].name||H++,
"subgrid"!==D[0].name&&"subgrid"!==D[1].name||H++,e+=d(h,0,C,H,n+"<span class='cell-wrapper'>"+K+"</span>")):e+="<td role='gridcell' style='padding-left:"+12*C.idx+"px;' colspan='"+v+"'>"+n+K+"</td>";e+="</tr>";if(I){K=x[h+1];I=C.startRow;H=void 0!==K?K.startRow:x[h].startRow+x[h].cnt;r._locgr&&(L=(A-1)*c,L>C.startRow&&(I=L));for(;I<H&&a[I-L];I++)e+=a[I-L].join("");if("header"!==r.groupSummaryPos[C.idx]){if(void 0!==K){for(M=0;M<r.groupField.length&&K.dataIndex!==r.groupField[M];M++);k=r.groupField.length-
M}for(L=0;L<k;L++)t[L]&&(e+="<tr data-jqfootlevel='"+(C.idx-L)+(r.groupCollapse&&(0<C.idx-L||!r.showSummaryOnHide)?"' style='display:none;'":"'")+" role='row' class='"+F+"'>",e+=d(h,L,x[C.idx-L],0),e+="</tr>");k=M}}});this.unbind("jqGridShowHideCol.groupingRender").bind("jqGridShowHideCol.groupingRender",function(){var a=g.iColByName[r.iconColumnName],c,d,e;if(0<=b.inArray("header",r.groupSummaryPos)){for(c=0;c<D.length;c++)if(!D[c].hidden){e=c;break}if(void 0!==e&&a!==e){for(c=0;c<f.rows.length;c++)d=
...
m=e.prmNames;if(c.grid){var n=b.extend(!0,{keys:!1,oneditfunc:null,successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,beforeEditRow:null,mtype:"POST",focusField:!0},u.inlineEdit,e.inlineEditing||{},p),q=d.jqGrid("getInd",a,!0),h=n.focusField,C="object"===typeof h&&null!=h?b(h.target||h).closest("tr.jqgrow>td")[0]:null;if(!1!==q&&(n.extraparam[m.oper]===m.addoper||Xa.call(c,n,"beforeEditRow",n,a))&&"0"===(b(q).attr("editable")||"0")&&
!b(q).hasClass("not-editable-row")){m=u.detectRowEditing.call(c,a);if(null!=m&&"cellEditing"===m.mode){var m=m.savedRow,B=c.rows[m.id],H=Y.call(c,"select");d.jqGrid("restoreCell",m.id,m.ic);b(B.cells[m.ic]).removeClass("edit-cell "+H);b(B).addClass(H).attr({"aria-selected":"true",tabindex:"0"})}u.enumEditableCells.call(c,q,b(q).hasClass("jqgrid-new-row")?"add":"edit",function(d){var h=d.cm,l=b(d.dataElement),m=d.dataWidth,n,p=h.name,q=h.edittype,t=d.iCol,v=h.editoptions||{};if("hidden"!==d.editable){try{n=
...
f),w(g)&&(n.errorfunc=g),w(k)&&(n.afterrestorefunc=k),w(m)&&(n.beforeSaveRow=m));var l=function(a){return q.jqGrid("getGridRes",a)},n=b.extend(!0,{successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,beforeSaveRow:null,ajaxSaveOptions:{},serializeSaveData:null,mtype:"POST",saveui:"enable",savetext:l("defaults.savetext")||"Saving..."},u.inlineEdit,r.inlineEditing||{},n),x={},D={},v={},A,E,F,h;F=q.jqGrid("getInd",a,!0);var C=b(F);A=r.prmNames;
var B=l("errors.errcap"),H=l("edit.bClose"),M;if(!1!==F&&(l=n.extraparam[A.oper]===A.addoper?"add":"edit",Xa.call(p,n,"beforeSaveRow",n,a,l)&&(A=C.attr("editable"),n.url=n.url||r.editurl,M="clientArray"!==n.url,"1"===A)))if(u.enumEditableCells.call(p,F,C.hasClass("jqgrid-new-row")?"add":"edit",function(c){var d=c.cm,e=d.formatter,f=d.editoptions||{},g=d.formatoptions||{},k={},l=(b.jgrid.detectRowEditing.call(p,a)||{}).savedRow,m=u.getEditedValue.call(p,b(c.dataElement),d,k,c.editable);"select"===
d.edittype&&"select"!==d.formatter&&(D[d.name]=k.text);h=u.checkValues.call(p,m,c.iCol,void 0,void 0,b.extend(c,{oldValue:null!=l?l[d.name]:null,newValue:m,oldRowData:l}));if(null!=h&&!1===h[0])return!1;"date"===e&&!0!==g.sendFormatted&&(m=b.unformat.date.call(p,m,d));M&&!0===f.NullIfEmpty&&""===m&&(m="null");x[d.name]=m}),null!=h&&!1===h[0])try{var I=q.jqGrid("getGridRowById",a),G=u.findPos(I);t.call(p,B,h[1],H,{left:G[0],top:G[1]+b(I).outerHeight()})}catch(J){y(h[1])}else if(I=a,A=r.prmNames,G=
!1===r.keyName?A.id:r.keyName,x&&(x[A.oper]=A.editoper,void 0===x[G]||""===x[G]?x[G]=a:F.id!==r.idPrefix+x[G]&&(F=u.stripPref(r.idPrefix,a),void 0!==r._index[F]&&(r._index[x[G]]=r._index[F],delete r._index[F]),a=r.idPrefix+x[G],C.attr("id",a),r.selrow===I&&(r.selrow=a),b.isArray(r.selarrrow)&&(F=b.inArray(I,r.selarrrow),0<=F&&(r.selarrrow[F]=a)),r.multiselect&&(F="jqg_"+r.id+"_"+a,C.find("input.cbox").attr("id",F).attr("name",F))),x=b.extend({},x,r.inlineData||{},n.extraparam)),M)q.jqGrid("progressBar",
...
htmlcontent:n.savetext});if((300>c.status||304===c.status)&&(0!==c.status||4!==c.readyState)){var e,f;f=q.triggerHandler("jqGridInlineSuccessSaveRow",[c,a,n]);if(null==f||!0===f)f=[!0,x];f[0]&&w(n.successfunc)&&(f=n.successfunc.call(p,c));b.isArray(f)?(e=f[0],x=f[1]||x):e=f;if(!0===e){r.autoEncodeOnEdit&&b.each(x,function(a,b){x[a]=u.oldDecodePostedData(b)});x=b.extend({},x,D);q.jqGrid("setRowData",a,x);C.attr("editable","0");for(e=0;e<r.savedRow.length;e++)if(String(r.savedRow[e].id)===String(a)){E=
e;break}0<=E&&r.savedRow.splice(E,1);la.call(p,n.aftersavefunc,"jqGridInlineAfterSaveRow",a,c,x,n);C.removeClass("jqgrid-new-row").unbind("keydown")}else la.call(p,n.errorfunc,"jqGridInlineErrorSaveRow",a,c,d,null,n),!0===n.restoreAfterError&&q.jqGrid("restoreRow",a,n.afterrestorefunc)}},error:function(c,d,e){b("#lui_"+u.jqID(r.id)).hide();q.triggerHandler("jqGridInlineErrorSaveRow",[a,c,d,e,n]);if(w(n.errorfunc))n.errorfunc.call(p,a,c,d,e);else{c=c.responseText||c.statusText;try{t.call(p,B,'<div class="'+
Y.call(p,"error")+'">'+c+"</div>",H,{buttonalign:"right"})}catch(f){y(c)}}!0===n.restoreAfterError&&q.jqGrid("restoreRow",a,n.afterrestorefunc)}},u.ajaxOptions,r.ajaxRowOptions,n.ajaxSaveOptions||{}));else{x=b.extend({},x,D);F=q.jqGrid("setRowData",a,x);C.attr("editable","0");for(l=0;l<r.savedRow.length;l++)if(String(r.savedRow[l].id)===String(I)){E=l;break}0<=E&&r.savedRow.splice(E,1);la.call(p,n.aftersavefunc,"jqGridInlineAfterSaveRow",a,F,x,n);C.removeClass("jqgrid-new-row").unbind("keydown")}}},
...
expandRow:function(a){this.each(function(){var c=b(this),d=this.p;if(this.grid&&d.treeGrid){var e=d.treeReader.expanded_field,f=a[d.localReader.id];if(ya.call(this,"beforeExpandRow",{rowid:f,item:a})){var g=B.getNodeChildren.call(c,a);b(g).each(function(){var a=d.idPrefix+pa(this,d.localReader.id);b(B.getGridRowById.call(c,a)).css("display","");this[e]&&B.expandRow.call(c,this)});ya.call(this,"afterExpandRow",{rowid:f,item:a})}}})},collapseRow:function(a){this.each(function(){var c=b(this),d=this.p;
if(this.grid&&d.treeGrid){var e=d.treeReader.expanded_field,f=a[d.localReader.id];if(ya.call(this,"beforeCollapseRow",{rowid:f,item:a})){var g=B.getNodeChildren.call(c,a);b(g).each(function(){var a=d.idPrefix+pa(this,d.localReader.id);b(B.getGridRowById.call(c,a)).css("display","none");this[e]&&B.collapseRow.call(c,this)});ya.call(this,"afterCollapseRow",{rowid:f,item:a})}}})},getRootNodes:function(){var a=[];this.each(function(){var c=this.p;if(this.grid&&c.treeGrid)switch(c.treeGridModel){case "nested":var d=
...
this.grid.hDiv.loading||(a[d]=!0,b("div.treeclick",n).removeClass(c.treeIcons.plus+" tree-plus").addClass(c.treeIcons.commonIconClass).addClass(c.treeIcons.minus+" tree-minus"),c.treeANode=n.rowIndex,c.datatype=c.treedatatype,B.setGridParam.call(b(this),{postData:"nested"===c.treeGridModel?{nodeid:l,n_level:a[g],n_left:a[k],n_right:a[m]}:{nodeid:l,n_level:a[g],parentid:a[e]}}),b(this).trigger("reloadGrid"),a[f]=!0,B.setGridParam.call(b(this),{postData:"nested"===c.treeGridModel?{nodeid:"",n_level:"",
...
" tree-plus"),ya.call(this,"afterCollapseNode",{rowid:e,item:a}))}}})},SortTree:function(a,c,d,e){return this.each(function(){var f=this,g=f.p,k=b(f);if(f.grid&&g.treeGrid){var m,l,n,p=[];m=B.getRootNodes.call(k);m=u.from.call(f,m);m.orderBy(a,c,d,e);var q=m.select();m=0;for(l=q.length;m<l;m++)n=q[m],p.push(n),B.collectChildrenSortTree.call(k,p,n,a,c,d,e);b.each(p,function(a){var c=pa(this,g.localReader.id);b(f.rows[a]).after(k.find(">tbody>tr#"+G(c)))})}})},collectChildrenSortTree:function(a,c,d,
e,f,g){return this.each(function(){var k=b(this);if(this.grid&&this.p.treeGrid){var m,l,n;m=B.getNodeChildren.call(k,c);m=u.from.call(this,m);m.orderBy(d,e,f,g);var p=m.select();m=0;for(l=p.length;m<l;m++)n=p[m],a.push(n),B.collectChildrenSortTree.call(k,a,n,d,e,f,g)}})},setTreeRow:function(a,c){var d=!1;this.each(function(){this.grid&&this.p.treeGrid&&(d=B.setRowData.call(b(this),a,c))});return d},delTreeNode:function(a){return this.each(function(){var c=this.p,d,e,f,g;f=c.localReader.id;var k,m=
b(this),l=c.treeReader.left_field,n=c.treeReader.right_field;if(this.grid&&c.treeGrid&&(k=c._index[a],void 0!==k)){d=parseInt(c.data[k][n],10);e=d-parseInt(c.data[k][l],10)+1;var p=B.getFullTreeNode.call(m,c.data[k]);if(0<p.length)for(k=0;k<p.length;k++)B.delRowData.call(m,p[k][f]);if("nested"===c.treeGridModel){f=u.from.call(this,c.data).greater(l,d,{stype:"integer"}).select();if(f.length)for(g in f)f.hasOwnProperty(g)&&(f[g][l]=parseInt(f[g][l],10)-e);f=u.from.call(this,c.data).greater(n,d,{stype:"integer"}).select();
if(f.length)for(g in f)f.hasOwnProperty(g)&&(f[g][n]=parseInt(f[g][n],10)-e)}}})},addChildNode:function(a,c,d,e){var f=b(this),g=f[0],k=g.p,m=B.getInd;if(d){var l,n,p,q,r;l=0;var t=c,w,y,x=k.treeReader.expanded_field;y=k.treeReader.leaf_field;var D=k.treeReader.level_field,v=k.treeReader.parent_id_field,A=k.treeReader.left_field,E=k.treeReader.right_field,F=k.treeReader.loaded;void 0===e&&(e=!1);if(null==a){r=k.data.length-1;if(0<=r)for(;0<=r;)l=Math.max(l,parseInt(k.data[r][k.localReader.id],10)),
r--;a=l+1}var h=m.call(f,c);w=!1;if(void 0===c||null===c||""===c)t=c=null,l="last",q=k.tree_root_level,r=k.data.length+1;else{l="after";n=k._index[c];p=k.data[n];c=p[k.localReader.id];r=m.call(f,c);q=parseInt(p[D],10)+1;var C=B.getFullTreeNode.call(f,p);if(C.length){var G,H,J;for(G=0;G<C.length;G++)J=C[G][k.localReader.id],H=m.call(f,J),H>r&&(r=H,t=J)}r++;p[y]&&(w=!0,p[x]=!0,b(g.rows[h]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(k.treeIcons.leaf+
...
y?parseInt(D[I][E],10)+2:D[I][E]);d[A]=y;d[E]=y+1}else{y=parseInt(B.getCol.call(f,E,!1,"max"),10);D=u.from.call(g,k.data).greater(A,y,{stype:"integer"}).select();if(D.length)for(I in D)D.hasOwnProperty(I)&&(D[I][A]=parseInt(D[I][A],10)+2);D=u.from.call(g,k.data).greater(E,y,{stype:"integer"}).select();if(D.length)for(I in D)D.hasOwnProperty(I)&&(D[I][E]=parseInt(D[I][E],10)+2);d[A]=y+1;d[E]=y+2}}if(null===c||B.isNodeLoaded.call(f,p)||w)B.addRowData.call(f,a,d,l,t),B.setTreeNode.call(f,r,m);p&&!p[x]&&
