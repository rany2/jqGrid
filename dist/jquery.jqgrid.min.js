...
k=m.getMilliseconds();var q=m.getDay(),r=m.getFullYear(),t=(q+6)%7+1,w=(new Date(r,p-1,c)-new Date(r,0,1))/864E5,y=5>t?Math.floor((w+t-1)/7)+1:Math.floor((w+t-1)/7)||(4>((new Date(r-1,0,1)).getDay()+6)%7?53:52),x={d:n(c),D:e.dayNames[q],j:c,l:e.dayNames[q+7],N:t,S:e.S(c),w:q,z:w,W:y,F:e.monthNames[p-1+12],m:n(p),M:e.monthNames[p-1],n:p,t:"?",L:"?",o:"?",Y:r,y:String(r).substring(2),a:12>l?e.AmPm[0]:e.AmPm[1],A:12>l?e.AmPm[2]:e.AmPm[3],B:"?",g:l%12||12,G:l,h:n(l%12||12),H:n(l),i:n(a),s:n(g),u:k,e:"?",
...
e&&(e="Y-m-d");null==h&&(h=!1);if("desc"===c||"descending"===c)c="d";if("asc"===c||"ascending"===c)c="a";y.push({by:a,dir:c,type:d,datefmt:e,sfunc:h});return f};this.inSet=function(b,a,c){var d,e=void 0===c.stype?"text":c.stype;d=f._getStr('"'+f._toStr(void 0===a?null:a)+'"');if("text"!==e)return f._compareValues(f.equals,b,a,"==",c);f._append("jQuery.inArray("+f._getStr(b)+","+d+".split(',')) >= 0");f._setCommand(f.inSet,b);f._resetNegate();return f};this.custom=function(b,a,c){f._append("self.p.customSortOperations."+
...
10)+1+a;return"<td role='gridcell' class='"+L.getGuiStyles.call(n,"rowNum","jqgrid-rownum")+"' "+I(b,a,c,null,a,!0)+">"+c+"</td>"};1>=H&&(l.rowIndexes={});if("local"===l.datatype&&!l.deselectAfterSort||l.multiPageSelection)F=!0;g&&(h*=g+1);for(g=0;g<Math.min(a,h);g++){t=c[g];w=d[g];y=null!=e?e[g]:w;p=1===f?0:f;q=1===(p+g)%2?A:"";F&&(l.multiselect?(r=-1!==b.inArray(t,l.selarrrow))&&null===l.selrow&&(l.selrow=t):r=t===l.selrow);x=v.length;v.push("");for(p=0;p<l.colModel.length;p++)switch(B=l.colModel[p].name,
B){case "rn":v.push(Z(p,g,l.page,l.rowNum));break;case "cb":v.push(K(t,p,g,r,w));break;case "subgrid":v.push(L.addSubGridCell.call(n,p,g+f,t,w));break;default:v.push(Q(t,w[B],p,g+f,y,w))}v[x]=m.constructTr(t,E,q,w,y,r);v.push("</tr>");l.rowIndexes[t]=H;H++;l.grouping&&L.groupingPrepare&&(D.push(v),l.groupingView._locgr||L.groupingPrepare.call(n,w,g),v=[]);v.length>l.maxItemsToJoin&&(v=[v.join("")])}l.grouping&&L.groupingRender&&(k&&(l.groupingView._locgr=!0),v=[L.groupingRender.call(n,D,h)],u.clearArray(D));
...
return u.feedback.apply(this,a)};b.fn.jqGrid=function(a){var c=b.fn.jqGrid,d;if("string"===typeof a){d=c[a];if(!d)throw"jqGrid - No such method: "+a;return d.apply(this,b.makeArray(arguments).slice(1))}return this.each(function(){if(!this.grid){var d=this,f,g,k=b(d),m=b.isFunction,l=b.isArray,n=b.extend,p=b.inArray,q=b.trim,r=b.each,t=c.setSelection,w=c.getGridRes,y=m(Aa.fatalError)?Aa.fatalError:alert,x=a.locale||Aa.locale||"en-US",F=null!=Ja[x]&&"boolean"===typeof Ja[x].isRTL?Ja[x].isRTL?"rtl":
"ltr":"ltr",v=a.iconSet||Aa.iconSet||("bootstrap"===(a.guiStyle||Aa.guiStyle)||"bootstrapPrimary"===(a.guiStyle||Aa.guiStyle)?"glyph":"jQueryUI"),D=a.guiStyle||Aa.guiStyle||"jQueryUI",A=function(b){return c.getIconRes.call(d,b)},E=function(b,a){return k.jqGrid("getGuiStyles",b,a)};null==a&&(a={datatype:"local"});void 0!==a.datastr&&l(a.datastr)&&(g=a.datastr,a.datastr=[]);void 0!==a.data&&(f=a.data,a.data=[]);null!=u.formatter&&null!=u.formatter.unused||y("CRITICAL ERROR!!!\n\n\nOne uses probably\n\n\t$.extend($.jgrid.defaults, {...});\n\nto set default settings of jqGrid instead of the usage the DEEP version of jQuery.extend (with true as the first parameter):\n\n\t$.extend(true, $.jgrid.defaults, {...});\n\nOne other possible reason:\n\nyou included some OLD version of language file (grid.locale-en.js for example) AFTER jquery.jqGrid.min.js. For example all language files of jqGrid 4.7.0 uses non-deep call of jQuery.extend.\n\n\nSome options of jqGrid could still work, but another one will be broken.");
...
iColByName:{},iPropByName:{},reservedColumnNames:["rn","cb","subgrid"],grouping:!1,groupingView:{groupField:[],groupOrder:[],groupText:[],groupColumnShow:[],groupSummary:[],showSummaryOnHide:!1,sortitems:[],sortnames:[],summary:[],summaryval:[],displayField:[],groupSummaryPos:[],formatDisplayField:[],_locgr:!1,commonIconClass:A("grouping.common"),plusicon:A("grouping.plus"),minusicon:A("grouping.minus")},ignoreCase:!0,cmTemplate:{},idPrefix:"",iconSet:v,guiStyle:D,locale:x,multiSort:!1,treeIcons:{commonIconClass:A("treeGrid.common"),
...
if(h.multiselect&&d&&0<d.length)for(b=0;b<d.length;b++)d[b]!==c&&t.call(a,d[b],!1,null);c&&t.call(a,c,!1,null)}e.scrollLeft=f;a.unbind(".selectionPreserver",g)};a.bind("jqGridGridComplete.selectionPreserver",g)}};d.grid=z;R.call(d,"beforeInitGrid");h.iColByName=H(h.colModel);h.iPropByName=I(h.additionalProperties);var C=b("<div class='"+E("gView","ui-jqgrid-view")+"' role='grid' aria-multiselectable='"+!!h.multiselect+"'></div>"),M=u.msie,ca;h.direction=q(h.direction.toLowerCase());-1===p(h.direction,
["ltr","rtl"])&&(h.direction="ltr");ca=h.direction;b(C).insertBefore(d);k.removeClass("scroll").appendTo(C);var P=b("<div class='"+E("gBox","ui-jqgrid")+"'></div>");b(P).attr({id:h.gBoxId,dir:ca}).insertBefore(C);b(C).attr("id",h.gViewId).appendTo(P);b("<div class='"+E("overlay","jqgrid-overlay")+"' id='lui_"+h.id+"'></div>").insertBefore(C);b("<div class='"+E("loading","loading")+"' id='load_"+h.id+"'>"+B("loadtext")+"</div>").insertBefore(C);k.attr({role:"presentation","aria-labelledby":"gbox_"+
...
C[b]=Pa(a):/^\[\w+\]$/.test(a)&&(C[b]=Z(a.substring(1,a.length-1))))},ka=function(b){var a=b.name,c=r?b.xmlmap||a:"local"===n&&!h.dataTypeOrg||"jsonstring"===n||"json"===n||"jsonp"===n?b.jsonmap||a:a;!1!==h.keyName&&!0===b.key&&(h.keyName=a);if("string"===typeof c||m(c))C[a]=c;m(c)||P(a,c)};for(v=0;v<x;v++)ka(E[v]);x=Ca.length;for(v=0;v<x;v++)y=Ca[v],"object"===typeof y&&null!=y?ka(y):P(y,y);w=!1===h.keyName?m(q.id)?q.id.call(this,a):q.id:h.keyName;isNaN(w)?m(w)||(M[w]&&(D=M[w].order),r&&("string"===
typeof w&&/^\[\w+\]$/.test(w)?w=Z(w.substring(1,w.length-1)):"string"===typeof w&&/^\w+$/.test(w)&&(w=Pa(w)))):D=Number(w);B=t(a,q.root,!0);if(q.row)if(1===B.length&&"string"===typeof q.row&&/^\w+$/.test(q.row)){x=[];K=B[0].childNodes;ja=K.length;for(y=0;y<ja;y++)H=K[y],1===H.nodeType&&H.nodeName===q.row&&x.push(H);B=x}else B=t(B,q.row,!0);null==B&&l(a)&&(B=a);B||(B=[]);a=B.length;0<a&&0>=h.page&&(h.page=1);ka=parseInt(h.rowNum,10);f&&(ka*=f+1);var E=[],G=[],ha,x=[];for(v=0;v<a;v++){ha=B[v];A=q.repeatitems&&
q.cell?t(ha,q.cell,!0)||ha:ha;F=q.repeatitems&&(r||l(A));I={};ca={};if(r&&!F&&null!=A)for(K=A.childNodes,ja=K.length,y=0;y<ja;y++)H=K[y],1===H.nodeType&&(ca[H.nodeName]=H);for(L in M)M.hasOwnProperty(L)&&(y=M[L],F?(K=A[y.order],r&&null!=K&&(K=K.textContent||K.text)):K=null!=C[L]&&"string"!==typeof C[L]?C[L](A):t(A,"string"===typeof C[L]?C[L]:y.name),1===y.type&&(y=Ca[y.index],null!=y&&m(y.convert)&&(K=y.convert(K,A))),void 0!==K&&(I[L]=K));void 0!==I[w]?ha=void 0!==I[w]?I[w]:Da():(ha=t(ha,l(ha)?D:
w),void 0===ha&&(ha=t(A,l(A)?D:w)),void 0===ha&&(ha=Da()));void 0===I[w]&&(I[w]=ha);ha=String(ha);F=h.idPrefix+ha;h.treeGrid&&V(I);if(v<ka)G.push(F),E.push(A),x.push(I);else if(!p)break;if(p||!0===h.treeGrid)I._id_=ha,h.data.push(I),h._index[I._id_]=h.data.length-1}if(!p||!h.forceClientSorting||!0===h.treeGrid){d=u.parseDataToHtml.call(this,a,G,x,E,d,f,p);J(!0);f=-1<h.treeANode?h.treeANode:0;q=b(this.tBodies[0]);!0===h.treeGrid&&0<f?b(this.rows[f]).after(d.join("")):h.scroll?q.append(d.join("")):
(null==this.firstElementChild||void 0!==document.documentMode&&9>=document.documentMode?q.html(q.html()+d.join("")):this.firstElementChild.innerHTML+=d.join(""),this.grid.cols=this.rows[0].cells);h.grouping&&Q.call(this);if(!0===h.subGrid)try{c.addSubGrid.call(g,h.iColByName.subgrid)}catch(S){}if(!1===h.gridview||m(h.afterInsertRow))for(v=0;v<Math.min(a,ka);v++)R.call(this,"afterInsertRow",G[v],x[v],E[v]);h.totaltime=new Date-k;0<v&&0===h.records&&(h.records=a);da(d);if(!0===h.treeGrid)try{c.setTreeNode.call(g,
...
I.orBegin();for(d=0;d<b.rules.length;d++)k=b.rules[d],g=b.groupOp.toString().toUpperCase(),Q[k.op]&&k.field?(0<c&&g&&"OR"===g&&(I=I.or()),p=n[k.field],null!=p&&(l=p.reader,I=Q[k.op](I,g)(m(l)?'jQuery.jgrid.getAccessor(this,jQuery("'+h.idSel+'")[0].p.colModel['+p.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+l+"')",k.data,n[k.field]))):null!=h.customSortOperations&&null!=h.customSortOperations[k.op]&&m(h.customSortOperations[k.op].filter)&&(I=I.custom(k.op,k.field,k.data)),c++;f&&I.orEnd()}catch(r){y(r)}}
var d=b(this),e=h.multiSort?[]:"",f={},g=!1,n={},p=[],q=[],t=w.call(k,"formatter.date.srcformat"),v=w.call(k,"formatter.date.newformat");if(!l(h.data))return{};h.multiSort&&sb(e,f);var A=h.grouping?h.groupingView:!1,B,z,D=function(b,a,c){var d=b.index||b.name,f=b.sorttype||"text";n[b.name]={reader:h.dataTypeOrg?b.name:b.jsonmap||b.name,iCol:a,stype:f,srcfmt:"",newfmt:"",sfunc:b.sortfunc||null,isAddProp:!0===c?!0:!1};if("date"===f||"datetime"===f)b.formatter&&"string"===typeof b.formatter&&"date"===
b.formatter?(a=b.formatoptions&&b.formatoptions.srcformat?b.formatoptions.srcformat:t,c=b.formatoptions&&b.formatoptions.newformat?b.formatoptions.newformat:v):a=c=b.datefmt||"Y-m-d",n[b.name].srcfmt=a,n[b.name].newfmt=c;if(h.grouping)for(z=0,B=A.groupField.length;z<B;z++)b.name===A.groupField[z]&&(p[z]=n[d],q[z]=d);h.multiSort||g||b.index!==h.sortname&&b.name!==h.sortname||(e=b.name,g=!0)};r(h.colModel,function(b){D(this,b)});r(h.additionalProperties,function(b){D("string"===typeof this?{name:this}:
...
typeof F&&(F=b.parseJSON(F)),a(F);else try{var x=n[h.postData.searchField],I=Q[h.postData.searchOper](I)(m(x.reader)?'jQuery.jgrid.getAccessor(this,jQuery("'+h.idSel+'")[0].p.colModel['+x.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+x.reader+"')",h.postData.searchString,n[h.postData.searchField])}catch(E){}}if(h.grouping)for(z=0;z<B;z++)I.orderBy(q[z],A.groupOrder[z],p[z].stype,p[z].srcfmt);h.multiSort?r(e,function(){I.orderBy(this,f[this],n[this].stype,n[this].srcfmt,n[this].sfunc)}):e&&h.sortorder&&
g&&I.orderBy(h.sortname,"DESC"===h.sortorder.toUpperCase()?"d":"a",n[e].stype,n[e].srcfmt,n[e].sfunc);h.lastSelectedData=I.select();var F=parseInt(h.rowNum,10),x=h.lastSelectedData.length,L=parseInt(h.page,10),K=Math.ceil(x/F),ja={};if(h.grouping&&h.groupingView._locgr){h.groupingView.groups=[];var H,M,N;if(h.footerrow&&h.userDataOnFooter){for(M in h.userData)h.userData.hasOwnProperty(M)&&(h.userData[M]=0);N=!0}for(H=0;H<x;H++){if(N)for(M in h.userData)h.userData.hasOwnProperty(M)&&(h.userData[M]+=
parseFloat(h.lastSelectedData[H][M]||0));c.groupingPrepare.call(d,h.lastSelectedData[H],H,F)}}n=I=null;d=h.localReader;ja[d.total]=K;ja[d.page]=L;ja[d.records]=x;ja[d.root]=h.lastSelectedData.slice((L-1)*F,L*F);ja[d.userdata]=h.userData;return ja},$a=function(a){var c=a.outerWidth();0>=c&&(c=b(this).closest(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px",b(document.body).append("<div id='testpg' class='"+E("gBox","ui-jqgrid")+"' style='font-size:"+c+";visibility:hidden;margin:0;padding:0;' ></div>"),
b(a).clone().appendTo("#testpg"),c=b("#testpg>.ui-pg-table").width(),b("#testpg").remove());0<c&&a.parent().width(c);return c},ib=function(a,c){var d=this,e=b(d),f=d.grid,g,l,m,n,p,r,q=h.pager||"",t=h.pager?"_"+h.pager.substr(1):"";g=f.bDiv;var v=b.fmatter?b.fmatter.NumberFormat:null,A=h.toppager?"_"+h.toppager.substr(1):"",z=E("states.hover"),I=E("states.disabled");l=parseInt(h.page,10)-1;0>l&&(l=0);l*=parseInt(h.rowNum,10);n=l+h.reccount;if(h.scroll){r=b(bb(21,g)[0].rows).slice(1);l=n-r.length;
...
q);var D=String(h.page).length;m.val(h.page);m.each(function(){var a=parseInt(b(this).attr("size"),10);0<a&&a<D&&b(this).attr("size",D)});m=h.toppager?"#sp_1"+t+",#sp_1"+A:"#sp_1"+t;b(m).html(b.fmatter?v(h.lastpage,r):h.lastpage).closest(".ui-pg-table").each(function(){$a.call(d,b(this))})}h.viewrecords&&(0===h.reccount?b(".ui-paging-info",q).html(B("emptyrecords")):(m=l+1,p=h.records,b.fmatter&&(m=v(m,r),n=v(n,r),p=v(p,r)),b(".ui-paging-info",q).html(u.format(B("recordtext"),m,n,p))));!0===h.pgbuttons&&
...
null,A=0;a=a||1;1<a?null!==q.npage?(p[q.npage]=a,A=a-1,a=1):v=function(b){h.page++;k.hDiv.loading=!1;t&&h.loadComplete.call(f,b);ka.call(f,a-1)}:null!==q.npage&&delete h.postData[q.npage];if(h.grouping&&c.groupingSetup){c.groupingSetup.call(g);var B=h.groupingView,w,I="",D,Q,F;for(w=0;w<B.groupField.length;w++){D=B.groupField[w];for(Q=0;Q<h.colModel.length;Q++)F=h.colModel[Q],F.name===D&&F.index&&(D=F.index);I+=D+" "+B.groupOrder[w]+", "}p[q.sort]=I+p[q.sort]}n(h.postData,p);var y=h.scroll?f.rows.length-
1:1,x=function(){L.call(f);var b=g.width(),a=g.closest(".ui-jqgrid-view").width(),d=g.css("height");a<b&&0===h.reccount?g.css("height","1px"):"0"!==d&&"0px"!==d&&g.css("height","");h.autowidth||void 0!==h.widthOrg&&"auto"!==h.widthOrg&&"100%"!==h.widthOrg||c.setGridWidth.call(g,h.tblwidth+h.scrollOffset,!1)},E=function(){var b;if(h.autoresizeOnLoad)c.autoResizeAllColumns.call(g);else for(b=0;b<h.columnsToReResizing.length;b++)c.autoResizeColumn.call(g,h.columnsToReResizing[b]);da(h.columnsToReResizing)},
q=function(){R.call(f,"loadComplete",r);E();g.triggerHandler("jqGridAfterLoadComplete",[r]);Pa.call(f);h.datatype="local";h.datastr=null;x()},K=function(b){g.triggerHandler("jqGridLoadComplete",[b]);v&&v.call(f,b);E();g.triggerHandler("jqGridAfterLoadComplete",[b]);l&&k.populateVisible.call(f);1===a&&Pa.call(f);x()},H=function(){var b=db.call(f);Fa.call(f,b,y,1<a,A);K(b)};if(R.call(f,"beforeRequest"))if(m(h.datatype))h.datatype.call(f,h.postData,"load_"+h.id,y,a,A);else switch(p=h.datatype.toLowerCase(),
b(z.eDiv).hide(),p){case "json":case "jsonp":case "xml":case "script":b.ajax(n({url:h.url,type:h.mtype,dataType:p,data:u.serializeFeedback.call(d,h.serializeGridData,"jqGridSerializeGridData",h.postData),success:function(c,d,e){h.jqXhr=null;b(z.eDiv).hide();if(m(h.beforeProcessing)&&!1===h.beforeProcessing.call(f,c,d,e))Pa.call(f);else if(Fa.call(f,c,y,1<a,A),K(c),h.loadonce||h.treeGrid)h.dataTypeOrg=h.datatype,h.datatype="local",h.forceClientSorting&&H()},error:function(b,c,d){h.jqXhr=null;m(h.loadError)&&
...
H();break;case "local":case "clientside":ja.call(f),h.datatype="local",H()}}},jb=function(a){var c=this.grid;b(h.cb,c.hDiv).prop("checked",a);h.frozenColumns&&b(h.cb,c.fhDiv).prop("checked",a)},tb=function(a,c){var f=E("states.hover"),g=E("states.disabled"),k="<td class='ui-pg-button "+g+"'><span class='ui-separator'></span></td>",l="",m="<table style='table-layout:auto;white-space: pre;"+("left"===h.pagerpos?"margin-right:auto;":"right"===h.pagerpos?"margin-left:auto;":"margin-left:auto;margin-right:auto;")+
...
"true")):h.viewsortcols[0]||k.hide();sb(v,u,g);r(v,function(){0<f.length&&(f+=", ");f+=this+" "+u[this];h.sortorder=u[this]});h.sortname=f.substring(0,f.length-h.sortorder.length-1)},Y=function(a,d,e,f,g){var k=this.grid,l=h.colModel[d],m=E("states.disabled");if(null!=l&&l.sortable&&!(0<h.savedRow.length)){e||(h.lastsort===d&&""!==h.sortname?(h.sortorder="asc"===h.sortorder?"desc":"desc"===h.sortorder?"asc":l.firstsortorder||"asc",l.lso?"asc"===l.lso?l.lso+="-desc":"desc"===l.lso?l.lso+="-asc":"asc-desc"!==
...
h.datatype&&(h.localReader={id:"_id_"});h.iPropByName=I(h.additionalProperties)}Ca();K();h.data.length&&(ia.call(d),qa());if(!0===h.shrinkToFit&&!0===h.forceFit)for(X=h.colModel.length-1;0<=X;X--)if(!0!==h.colModel[X].hidden){h.colModel[X].resizable=!1;break}var U,ea,fb,fa,na,ga,ma,oa=[],za=[],la=[],Ga="<thead><tr class='ui-jqgrid-labels' role='row'>",ya,xa="<tbody><tr style='display:none;'>",ta=E("states.hover"),Va=E("states.disabled");if(h.multiSort){var oa=h.sortname.split(","),va;for(va=0;va<
oa.length;va++)la=q(oa[va]).split(" "),oa[va]=q(la[0]),za[va]=la[1]?q(la[1]):h.sortorder||"asc"}for(X=0;X<h.colNames.length;X++){T=h.colModel[X];na=h.headertitles||T.headerTitle?" title='"+lb("string"===typeof T.headerTitle?T.headerTitle:h.colNames[X])+"'":"";Ga+="<th id='"+h.id+"_"+T.name+"' class='"+E("colHeaders","ui-th-column ui-th-"+ca+" "+(T.labelClasses||""))+"'"+na+">";U=T.index||T.name;switch(T.labelAlign){case "left":ga="text-align:left;";break;case "right":ga="text-align:right;"+(!1===
...
h.iRow=-1;h.iCol=-1;h.scroll&&z.emptyRows.call(this,!0,!1);if(d.page){var g=parseInt(d.page,10);g>h.lastpage&&(g=h.lastpage);1>g&&(g=1);h.page=g;f.bDiv.scrollTop=f.prevRowHeight?(g-1)*f.prevRowHeight*h.rowNum:0}f.prevRowHeight&&h.scroll&&void 0===d.page?(delete h.lastpage,f.populateVisible.call(this)):f.populate.call(this);!0===h._inlinenav&&e.jqGrid("showAddEditButtons",!1);return!1}).dblclick(function(b){var a=Ma.call(this,b.target),c=a.parent();if(0<a.length&&!R.call(d,"ondblClickRow",c.attr("id"),
c[0].rowIndex,a[0].cellIndex,b))return!1}).bind("contextmenu",function(b){var a=Ma.call(this,b.target),c=a.parent(),f=c.attr("id");if(0!==a.length&&(h.multiselect||t.call(k,f,!0,b),!R.call(d,"onRightClickRow",f,c[0].rowIndex,a[0].cellIndex,b)))return!1});z.bDiv=document.createElement("div");M&&"auto"===String(h.height).toLowerCase()&&(h.height="100%");b(z.bDiv).append(b("<div style='position:relative;'></div>").append("<div></div>").append(d)).addClass("ui-jqgrid-bdiv").css({height:h.height+(isNaN(h.height)?
"":"px"),width:z.width+"px"}).scroll(z.scrollGrid);h.maxHeight&&b(z.bDiv).css("max-height",h.maxHeight+(isNaN(h.maxHeight)?"":"px"));k.css({width:"1px"});b.support.tbody||2===b(">tbody",d).length&&b(">tbody:gt(0)",d).remove();h.multikey&&b(z.bDiv).bind(u.msie?"selectstart":"mousedown",function(){return!1});Ba&&b(z.bDiv).hide();z.cDiv=document.createElement("div");var Ra=A("gridMinimize.visible"),Xa=A("gridMinimize.hidden"),Ya=B("showhide"),Ua=!0===h.hidegrid?b("<a role='link' class='"+E("titleButton",
"ui-jqgrid-titlebar-close")+"'"+(Ya?" title='"+Ya+"'":"")+"/>").hover(function(){Ua.addClass(ta)},function(){Ua.removeClass(ta)}).append("<span class='"+Ra+"'></span>"):"";b(z.cDiv).append("<span class='ui-jqgrid-title'>"+h.caption+"</span>").append(Ua).addClass(E("gridTitle","ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===ca?"-rtl ":" ")+Sa));b(z.cDiv).insertBefore(z.hDiv);if(h.toolbar[0]){z.uDiv=document.createElement("div");"top"===h.toolbar[1]?b(z.uDiv).insertBefore(z.hDiv):"bottom"===h.toolbar[1]&&
b(z.uDiv).insertAfter(z.hDiv);var Za=E("toolbarUpper","ui-userdata");"both"===h.toolbar[1]?(z.ubDiv=document.createElement("div"),b(z.uDiv).addClass(Za).attr("id","t_"+h.id).insertBefore(z.hDiv),b(z.ubDiv).addClass(E("toolbarBottom","ui-userdata")).attr("id","tb_"+h.id).insertAfter(z.hDiv),Ba&&b(z.ubDiv).hide()):b(z.uDiv).width(z.width).addClass(Za).attr("id","t_"+h.id);Ba&&b(z.uDiv).hide()}"string"===typeof h.datatype&&(h.datatype=h.datatype.toLowerCase());h.toppager?(h.toppager=h.id+"_toppager",
z.topDiv=b("<div id='"+h.toppager+"'></div>")[0],b(z.topDiv).addClass(E("pager.pager","ui-jqgrid-toppager"+(h.caption?"":" "+Sa))).css({width:z.width+"px"}).insertBefore(z.hDiv),tb.call(d,h.toppager,"_t"),h.toppager="#"+G(h.toppager)):""!==h.pager||h.scroll||(h.rowNum=h.maxRowNum);h.footerrow&&(z.sDiv=b("<div class='ui-jqgrid-sdiv'></div>")[0],ab=b("<div class='ui-jqgrid-hbox"+("rtl"===ca?"-rtl":"")+"'></div>"),b(z.sDiv).append(ab).width(z.width).insertAfter(z.hDiv),b(ab).append(Ha),z.footers=b(".ui-jqgrid-ftable",
z.sDiv)[0].rows[0].cells,h.rownumbers&&(z.footers[0].className=E("rowNum","jqgrid-rownum")),Ba&&b(z.sDiv).hide());ab=null;if(h.caption){var cb=h.datatype;!0===h.hidegrid&&(b(".ui-jqgrid-titlebar-close",z.cDiv).click(function(a){var c=".ui-jqgrid-bdiv,.ui-jqgrid-hdiv,.ui-jqgrid-pager,.ui-jqgrid-sdiv",f=this;!0===h.toolbar[0]&&("both"===h.toolbar[1]&&(c+=",#"+G(b(z.ubDiv).attr("id"))),c+=",#"+G(b(z.uDiv).attr("id")));var g=b(c,h.gView).length;h.toppager&&(c+=","+h.toppager);"visible"===h.gridstate?
...
h.gBox).show(),Ba||R.call(d,"onHeaderClick",h.gridstate,a))}));return!1}),Ba&&(h.datatype="local",b(".ui-jqgrid-titlebar-close",z.cDiv).trigger("click")))}else b(z.cDiv).hide(),b(z.cDiv).nextAll("div:visible").first().addClass("ui-corner-top");b(z.hDiv).after(z.bDiv);z.eDiv=b("<div class='"+E("gridError","ui-jqgrid-errorbar ui-jqgrid-errorbar-"+ca)+"' style='display:none;'><span class='"+E("gridErrorText","ui-jqgrid-error")+"'></span></div>")[0];b(z.hDiv).after(z.eDiv);b(P).click(Z).dblclick(function(a){var f=
...
this.p,e,f=this.grid,g=0,k,m=0,l=!1,n,p=0,q=u.isCellClassHidden,r=a;if(f&&null!=d){this.fixScrollOffsetAndhBoxPadding();var t=d.colModel,w=d.scrollOffset,y=u.cell_width?0:d.cellLayout,x=f.headers,F=f.footers,v=f.bDiv,D=f.hDiv,A=f.sDiv,E=f.cols,h,B,L=b(D).find(">div>.ui-jqgrid-htable>thead>tr").first()[0].cells,H=function(a){f.width=d.width=a;b(d.gBox).css("width",a+"px");b(d.gView).css("width",a+"px");b(v).css("width",a+"px");b(D).css("width",a+"px");d.pager&&b(d.pager).css("width",a+"px");d.toppager&&
...
setCell:function(a,c,d,e,f,g){return this.each(function(){var k=this.p,m,l=k.colModel,n,p,q,r,t,w,y,x={},F;if(this.grid&&(m=isNaN(c)?k.iColByName[c]:parseInt(c,10),0<=m&&(r=C.getGridRowById.call(b(this),a)))){t=u.getCell.call(this,r,m);if(""!==d||!0===g){p=l[m];"local"===k.datatype&&(F=Na(k.idPrefix,a),n=k._index[F],void 0!==n&&(q=k.data[n]));if(null==q)for(n=0;n<r.cells.length;n++){if(n!==m&&(w=u.getDataFieldOfCell.call(this,r,n),0<w.length)){try{y=b.unformat.call(this,w,{rowId:a,colModel:l[n]},
n)}catch(v){y=Oa(w[0].innerHTML)}x[l[n].name]=y}}else x=q;x[p.name]=d;l=this.formatter(a,d,m,x,"edit");y=t;!0===k.treeGrid&&p.name===k.ExpandColumn&&(y=y.children("span.cell-wrapperleaf,span.cell-wrapper").first());y.html(l);p.title&&t.attr({title:d});null!=q&&(l=cb.call(this,d,p,q[p.name],F,q,m),b.isFunction(p.saveLocally)?p.saveLocally.call(this,{newValue:l,newItem:q,oldItem:q,id:F,cm:p,cmName:p.name,iCol:m}):q[p.name]=l)}if(e||f){t=u.getCell.call(this,r,m);if(e)t["string"===typeof e?"addClass":
...
(n=isNaN(a)?p.iColByName[a]:parseInt(a,10),0<=n)){var r=this.rows,t=r.length,w=0,y=0,x;if(t&&0<t){for(;w<t;){x=r[w];if(b(x).hasClass("jqgrow")){q=u.getDataFieldOfCell.call(this,x,n).first();try{f=b.unformat.call(this,q,{rowId:x.id,colModel:p.colModel[n]},n)}catch(F){f=Oa(q.html())}d?(l=parseFloat(f),isNaN(l)||(g+=l,void 0===m&&(m=k=l),k=Math.min(k,l),m=Math.max(m,l),y++)):c?e.push({id:x.id,value:f}):e.push(f)}w++}if(d)switch(d.toLowerCase()){case "sum":e=g;break;case "avg":e=g/y;break;case "count":e=
...
u.jqID(g.knv)).attr("tabindex","-1").focus()},1);n=g.colModel[c];k=n.name;if("subgrid"!==k&&"cb"!==k&&"rn"!==k){l=va.call(e,p,c);p=n.editable;b.isFunction(p)&&(p=p.call(e,{rowid:q,iCol:c,iRow:a,name:k,cm:n,mode:"cell"}));var F=f.jqGrid("getGuiStyles","states.select","edit-cell"),v=f.jqGrid("getGuiStyles","states.hover","selected-row");if(!0!==p||!0!==d||l.hasClass("not-editable-cell"))0<=t&&0<=w&&(va.call(e,y[0],t).removeClass(F),y.removeClass(v)),l.addClass(F),r.addClass(v),m=l.html().replace(/&#160;/ig,
...
(m=t));R.call(e,"beforeEditCell",q,k,m,a,c);n=b.extend({},n.editoptions||{},{id:a+"_"+k,name:k,rowId:q,mode:"cell",cm:n,iCol:c});var D=u.createEl.call(e,r,n,m,!0,b.extend({},u.ajaxOptions,g.ajaxSelectOptions||{})),r=l;(t=!0===g.treeGrid&&k===g.ExpandColumn)&&(r=l.children("span.cell-wrapperleaf,span.cell-wrapper"));r.html("").append(D).attr("tabindex","0");t&&b(D).width(l.width()-l.children("div.tree-wrap").outerWidth());u.bindEv.call(e,D,n);setTimeout(function(){b(D).focus()},1);b("input, select, textarea",
...
a,c])}g.iCol=c;g.iRow=a}}}})},saveCell:function(a,c){return this.each(function(){var d=this,e=b(d),f=d.p,g=u.info_dialog,k=u.jqID;if(d.grid&&!0===f.cellEdit){var m=e.jqGrid("getGridRes","errors"),l=m.errcap,n=e.jqGrid("getGridRes","edit").bClose,p=f.savedRow,q=1<=p.length?0:null;if(null!==q){var r=d.rows[a],t=r.id,w=b(r),y=f.colModel[c],x=y.name,F,v=va.call(d,r,c),D={},A=u.getEditedValue.call(d,v,y,D);if(A!==p[q].v){F=e.triggerHandler("jqGridBeforeSaveCell",[t,x,A,a,c]);void 0!==F&&(A=F);b.isFunction(f.beforeSaveCell)&&
(F=f.beforeSaveCell.call(d,t,x,A,a,c),void 0!==F&&(A=F));var E=u.checkValues.call(d,A,c,void 0,void 0,{oldValue:p[q].v,newValue:A,cmName:x,rowid:t,iCol:c,iRow:a,cm:y,tr:r,td:v,mode:"cell"}),r=y.formatoptions||{};if(null==E||!0===E||!0===E[0]){q=e.triggerHandler("jqGridBeforeSubmitCell",[t,x,A,a,c])||{};b.isFunction(f.beforeSubmitCell)&&((q=f.beforeSubmitCell.call(d,t,x,A,a,c))||(q={}));0<b("input.hasDatepicker",v).length&&b("input.hasDatepicker",v).datepicker("hide");"date"===y.formatter&&!0!==r.sendFormatted&&
(A=b.unformat.date.call(d,A,y));if("remote"===f.cellsubmit)if(f.cellurl){var h={};h[x]=A;var m=f.prmNames,r=m.oper,B=d.grid.hDiv;h[m.id]=u.stripPref(f.idPrefix,t);h[r]=m.editoper;h=b.extend(q,h);f.autoEncodeOnEdit&&b.each(h,function(a,c){b.isFunction(c)||(h[a]=u.oldEncodePostedData(c))});e.jqGrid("progressBar",{method:"show",loadtype:f.loadui,htmlcontent:u.defaults.savetext||"Saving..."});B.loading=!0;b.ajax(b.extend({url:b.isFunction(f.cellurl)?f.cellurl.call(d,f.cellurl,a,c,t,A,x):f.cellurl,data:u.serializeFeedback.call(d,
...
"jqGridSelectFilled",{elem:e,options:l,cm:h,rowid:n,mode:p,cmName:null!=h?h.name:l.name,iCol:k})},0))}},f||{}))}else if(c.value){"function"===typeof c.value&&(c.value=c.value());var y,x;f=[];l=void 0===c.separator?":":c.separator;r=void 0===c.delimiter?";":c.delimiter;p=function(b,a){if(0<a)return b};if("string"===typeof c.value)for(r=c.value.split(r),y=0;y<r.length;y++)x=r[y].split(l),2<x.length&&(x[1]=b.map(x,p).join(l)),f.push({value:x[0],innerHtml:x[1],selectValue:b.trim(x[0]),selectText:b.trim(x[1]),
...
p=function(b){return na.call(e,b)},q=p("errors.errcap"),r=p("edit.bClose"),t=p("edit.msg"),w=O.call(c,"states.hover"),y=O.call(c,"states.select"),x=O.call(c,"filterToolbar.dataField"),F={},v=function(b){var a="gs_";switch(l.idMode){case "compatibility":a+=f.idPrefix;break;case "new":a+=f.id+"_"}return a+b},D=function(a){var c;c=f.postData.filters;var d={},e,g,h,k;if(a)for(a=0;a<n.length;a++)h=n[a],!1!==h.search&&(k=h.searchoptions||{},d[h.name]={op:k.sopt?k.sopt[0]:"select"===h.stype?"eq":l.defaultSearch,
...
b.each(E,function(){q.push(this.oper)});null!=h&&b.each(h,function(b){q.push(b)});for(p=0;p<g.sopt.length;p++)t=g.sopt[p],k=b.inArray(t,q),-1!==k&&(k=E[k],void 0!==k?(u=l.operands[t],v=k.text):null!=h&&(v=h[t],u=v.operand,v=v.text),k=r===t?y:"",d+='<li class="ui-menu-item '+k+'" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="'+m(t)+'" data-oper="'+m(u)+'"><table><tr><td style="width:25px">'+m(u)+"</td><td>"+m(v)+"</td></tr></table></a></li>");d+="</ul>";
...
options:h,cm:a,cmName:a.name,iCol:f,mode:"filter"});!0===l.autosearch&&b.change(function(){A();return!1})}},u.ajaxOptions,f.ajaxSelectOptions||{}));else{var S,ba,V;this.searchoptions?(S=void 0===B.value?D.value||"":B.value,ba=void 0===B.separator?D.separator||":":B.separator,V=void 0===B.delimiter?D.delimiter||";":B.delimiter):this.editoptions&&(S=void 0===D.value?"":D.value,ba=void 0===D.separator?":":D.separator,V=void 0===D.delimiter?";":D.delimiter);if(S){B=document.createElement("select");B.style.width=
...
b(k).prepend(m);!0===a&&b(this).jqGrid("setGridParam",{groupHeader:null})}})},setGroupHeaders:function(a){a=b.extend({useColSpanStyle:!1,applyLabelClasses:!0,groupHeaders:[]},a||{});return this.each(function(){this.p.groupHeader=a;var c,d,e=0,f,g,k,m,l,n,p,q=this.p,r=q.colModel,t=r.length,w=this.grid.headers,y=b("table.ui-jqgrid-htable",this.grid.hDiv),x=u.isCellClassHidden,F=y.children("thead").children("tr.ui-jqgrid-labels"),v=F.last().addClass("jqg-second-row-header");f=y.children("thead");var D=
y.find(".jqg-first-row-header");void 0===D[0]?D=b("<tr>",{role:"row","aria-hidden":"true"}).addClass("jqg-first-row-header").css("height","auto"):D.empty();var A=function(b,a){var c=a.length,d;for(d=0;d<c;d++)if(a[d].startColumnName===b)return d;return-1};b(this).prepend(f);f=b("<tr>",{role:"row"}).addClass("ui-jqgrid-labels jqg-third-row-header");for(c=0;c<t;c++)if(k=w[c].el,m=b(k),d=r[c],g={height:"0",width:w[c].width+"px",display:d.hidden?"none":""},b("<th>",{role:"gridcell"}).css(g).addClass("ui-first-th-"+
q.direction+(a.applyLabelClasses?" "+(d.labelClasses||""):"")).appendTo(D),k.style.width="",g=O.call(this,"colHeaders","ui-th-column-header ui-th-"+q.direction+" "+(a.applyLabelClasses?d.labelClasses||"":"")),l=A(d.name,a.groupHeaders),0<=l){l=a.groupHeaders[l];e=l.numberOfColumns;n=l.titleText;for(p=l=d=0;l<e&&c+l<t;l++)p++,r[c+l].hidden||x(r[c+l].classes)||d++;g=b("<th>").addClass(g).css({height:"22px","border-top":"0 none"}).html(n);1<p&&g.attr("colspan",String(p));q.headertitles&&g.attr("title",
g.text());0===d&&g.hide();m.before(g);f.append(k);--e}else 0===e?a.useColSpanStyle?m.attr("rowspan",F.length+1):(b("<th>").addClass(g).css({display:d.hidden?"none":"","border-top":"0 none"}).insertBefore(m),f.append(k)):(f.append(k),e--);q=b(this).children("thead");q.prepend(D);f.insertAfter(v);y.prepend(q);a.useColSpanStyle&&(y.find("span.ui-jqgrid-resize").each(function(){var a=b(this).parent();a.is(":visible")&&(this.style.cssText="height:"+a.height()+"px !important;cursor:col-resize;")}),y.find(".ui-th-column>div").each(function(){var a=
...
if(!0===d.hoverrows){var k=function(a,c,d){b(a)[c](q);b(d[a.rowIndex])[c](q)};b(f).filter(".jqgrow").hover(function(){k(this,"addClass",g)},function(){k(this,"removeClass",g)});b(g).filter(".jqgrow").hover(function(){k(this,"addClass",f)},function(){k(this,"removeClass",f)})}D(e.fhDiv,e.hDiv,0,-1);D(e.fbDiv,e.bDiv,0,-1);e.sDiv&&D(e.fsDiv,e.sDiv,0,-1)});var E=function(a){b(e.fbDiv).scrollTop(b(e.bDiv).scrollTop());a.header.resizeDiv&&D(e.fhDiv,e.hDiv,a.header.iRowStart,a.header.iRowEnd);a.body.resizeDiv&&
D(e.fbDiv,e.bDiv,a.body.iRowStart,a.body.iRowEnd);a.resizeFooter&&e.sDiv&&a.resizeFooter&&D(e.fsDiv,e.sDiv,0,-1);var c=e.fhDiv[0].clientWidth;a.header.resizeDiv&&null!=e.fhDiv&&1<=e.fhDiv.length&&F(b(e.fhDiv),e.hDiv.clientHeight);a.body.resizeDiv&&null!=e.fbDiv&&0<e.fbDiv.length&&v(b(e.fbDiv),c);a.resizeFooter&&null!=e.fsDiv&&0<=e.fsDiv.length&&v(b(e.fsDiv),c)};b(d.gBox).bind("resizestop.setFrozenColumns",function(){setTimeout(function(){E(A)},50)});c.bind("jqGridInlineEditRow.setFrozenColumns jqGridInlineAfterRestoreRow.setFrozenColumns jqGridInlineAfterSaveRow.setFrozenColumns jqGridAfterEditCell.setFrozenColumns jqGridAfterRestoreCell.setFrozenColumns jqGridAfterSaveCell.setFrozenColumns jqGridResizeStop.setFrozenColumns",
function(b,a){var d=c.jqGrid("getInd",a);E({header:{resizeDiv:!1,resizedRows:{iRowStart:-1,iRowEnd:-1}},resizeFooter:!0,body:{resizeDiv:!0,resizedRows:{iRowStart:d,iRowEnd:d}}})});c.bind("jqGridResizeStop.setFrozenColumns",function(){E(A)});c.bind("jqGridResetFrozenHeights.setFrozenColumns",function(b,a){E(a||A)});e.hDiv.loading||c.triggerHandler("jqGridAfterGridComplete");d.frozenColumns=!0}}}})},destroyFrozenColumns:function(){return this.each(function(){var a=b(this),c=this.grid,d=this.p,e=G(d.id);
...
h&&l(h.custom_value)?h.custom_value.call(f,b(c).children(".customelement:first"),"get"):c.value;d.onchange()});setTimeout(function(){a.data=b(n).val();d.onchange()},0)}});var x=0,z,G;for(h=0;h<d.p.columns.length;h++)if(y=void 0===d.p.columns[h].search?!0:d.p.columns[h].search,z=!0===d.p.columns[h].hidden,(G=!0===d.p.columns[h].searchoptions.searchhidden)&&y||y&&!z)y="",a.field===d.p.columns[h].name&&(y=" selected='selected'",x=h),w+="<option value='"+d.p.columns[h].name+"'"+y+">"+d.p.columns[h].label+
...
c){b(c).text()});break;case "date":z[c]=b(this).val();3===String(z[c]).split("-").length&&(a=K[c],void 0!==a&&(a=Q[a],a=a.formatoptions||{},a=a.newformat||x.call(t,"formatter.date.newformat"),z[c]=u.parseDate.call(t[0],"Y-m-d",z[c],a)));break;default:void 0!==a&&0>b.inArray(a,v.skipPostTypes)&&(z[c]=b(this).val())}});return!0}function e(a,c,d){var e=0,f=[],g=!1,h="",k;for(k=1;k<=d;k++)h+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==a&&(g=C.getInd.call(t,a));b(Q).each(function(k){var l=
this.name,m,n,p,q,t;m=this.editable;var z=!1,A=!1;t="_empty"===a?"addForm":"editForm";b.isFunction(m)&&(m=m.call(r,{rowid:a,iCol:k,iRow:g,cmName:l,cm:this,mode:t}));q=(this.editrules&&!0===this.editrules.edithidden?0:!0===this.hidden||"hidden"===m)?"style='display:none'":"";switch(String(m).toLowerCase()){case "hidden":m=!0;break;case "disabled":z=m=!0;break;case "readonly":A=m=!0}if("cb"!==l&&"subgrid"!==l&&!0===m&&"rn"!==l){if(!1===g)p="";else{m=b(r.rows[g].cells[k]);try{p=b.unformat.call(r,m,{rowId:a,
colModel:this},k)}catch(B){p=this.edittype&&"textarea"===this.edittype?m.text():m.html()}Ka(p)&&(p="")}m=b.extend({},this.editoptions||{},{id:l,name:l,rowId:a,mode:t,cm:this,iCol:k});var y=b.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),x=parseInt(y.rowpos,10)||e+1,E=parseInt(2*(parseInt(y.colpos,10)||1),10);"_empty"===a&&m.defaultValue&&(p=b.isFunction(m.defaultValue)?m.defaultValue.call(r):m.defaultValue);this.edittype||(this.edittype="text");w.autoEncodeOnEdit&&
(p=u.oldDecodePostedData(p));t=u.createEl.call(r,this.edittype,m,p,!1,b.extend({},u.ajaxOptions,w.ajaxSelectOptions||{}));if(v.checkOnSubmit||v.checkOnUpdate)v._savedData[l]=p;b(t).addClass("FormElement");-1<b.inArray(this.edittype,["text","textarea","checkbox","password","select"])&&b(t).addClass(O.call(r,"dialog.dataField"));n=b(c).find("tr[data-rowpos="+x+"]");if(y.rowabove){var L=b("<tr><td class='contentinfo' colspan='"+2*d+"'>"+y.rowcontent+"</td></tr>");b(c).append(L);L[0].rp=x}0===n.length&&
(n=b("<tr "+q+" data-rowpos='"+x+"'></tr>").addClass("FormData").attr("id","tr_"+l),b(n).append(h),b(c).append(n),n[0].rp=x);q=b("td:eq("+(E-2)+")",n[0]);n=b("td:eq("+(E-1)+")",n[0]);q.html(void 0===y.label?w.colNames[k]:y.label||"&#160;");n[Ka(n.html())?"html":"append"](y.elmprefix).append(t).append(y.elmsuffix);z?(q.addClass(V),n.addClass(V),b(t).prop("readonly",!0),b(t).prop("disabled",!0)):A&&b(t).prop("readonly",!0);"custom"===this.edittype&&b.isFunction(m.custom_value)&&m.custom_value.call(r,
b("#"+G(l),D),"set",p);u.bindEv.call(r,t,m);f[e]=k;e++}});0<e&&(k=b("<tr class='FormData' style='display:none'><td class='CaptionTD'>&#160;</td><td colspan='"+(2*d-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+y+"_id' value='"+a+"'/></td></tr>"),k[0].rp=e+999,b(c).append(k),v.checkOnSubmit||v.checkOnUpdate)&&(v._savedData[y+"_id"]=a);return f}function f(a,c){var d,e=0,f,g,k,l;if(v.checkOnSubmit||v.checkOnUpdate)v._savedData={},v._savedData[y+"_id"]=a;var m=w.colModel;
...
h?u.info_dialog.call(r,Ca,"function 'custom_value' "+v.msg.nodefined,v.bClose):u.info_dialog.call(r,Ca,h.message,v.bClose)}}e++}}),0<e&&b("#id_g",h).val(a))}}function g(){var a=v.url||w.editurl;b.each(Q,function(c,d){var f=d.name,e=z[f];"date"!==d.formatter||null!=d.formatoptions&&!0===d.formatoptions.sendFormatted||(z[f]=b.unformat.date.call(r,e,d));"clientArray"!==a&&d.editoptions&&!0===d.editoptions.NullIfEmpty&&z.hasOwnProperty(f)&&""===e&&(z[f]="null")})}function k(){var c=[!0,"",""],d=c,e={},
k=w.prmNames,l,m,n,p,q,A,x=C.getInd.call(t,a),E=!1===x?null:r.rows[x];(A=t.triggerHandler("jqGridAddEditBeforeCheckValues",[b(D),M]))&&"object"===typeof A&&(z=A);x=!1===x?-1:x;b.isFunction(v.beforeCheckValues)&&(A=v.beforeCheckValues.call(r,z,b(D),M))&&"object"===typeof A&&(z=A);for(n in z)if(z.hasOwnProperty(n)){A=w.iColByName[n];d=u.checkValues.call(r,z[n],n,void 0,void 0,{oldValue:"_empty"===a?null:C.getCell.call(t,a,A),newValue:z[n],cmName:n,rowid:a,cm:Q[A],iCol:A,iRow:x,tr:E,td:null==E?null:
E.cells[A],mode:"_empty"===a?"addForm":"editForm"});if(null==d||!0===d)d=c;if(!1===d[0])break}g();if(d[0]){e=t.triggerHandler("jqGridAddEditClickSubmit",[v,z,M]);void 0===e&&b.isFunction(v.onclickSubmit)&&(e=v.onclickSubmit.call(r,v,z,M)||{});d=t.triggerHandler("jqGridAddEditBeforeSubmit",[z,b(D),M]);if(null==d||!0===d)d=c;d[0]&&b.isFunction(v.beforeSubmit)&&(d=v.beforeSubmit.call(r,z,b(D),M),null==d||!0===d)&&(d=c)}if(d[0]&&!v.processing){v.processing=!0;b("#sData",B).addClass(W);n=v.url||w.editurl;
...
z[l]=u.stripPref(w.idPrefix,z[l]);w.autoEncodeOnEdit&&b.each(z,function(a,c){b.isFunction(c)||(z[a]=u.oldEncodePostedData(c))});q=b.extend({url:b.isFunction(n)?n.call(r,z[l],M,z,v):n,type:b.isFunction(v.mtype)?v.mtype.call(r,M,v,z[l],z):v.mtype,data:u.serializeFeedback.call(r,b.isFunction(v.serializeEditData)?v.serializeEditData:w.serializeEditData,"jqGridAddEditSerializeEditData",z),complete:function(a,e){b("#sData",B).removeClass(W);z[l]=b("#id_g",h).val();if(300<=a.status&&304!==a.status||0===
a.status&&4===a.readyState)d[0]=!1,d[1]=t.triggerHandler("jqGridAddEditErrorTextFormat",[a,M]),b.isFunction(v.errorTextFormat)?d[1]=v.errorTextFormat.call(r,a,M):d[1]=e+" Status: '"+a.statusText+"'. Error code: "+a.status;else{d=t.triggerHandler("jqGridAddEditAfterSubmit",[a,z,M]);if(null==d||!0===d)d=c;d[0]&&b.isFunction(v.afterSubmit)&&(d=v.afterSubmit.call(r,a,z,M),null==d||!0===d)&&(d=c)}if(!1===d[0])b("#FormError>td",h).html(d[1]),b("#FormError",h).show();else{w.autoEncodeOnEdit&&b.each(z,function(b,
a){z[b]=u.oldDecodePostedData(a)});var g=[b.extend({},v.reloadGridOptions||{})];z[m]===k.addoper?(d[2]||(d[2]=u.randId()),null==z[l]||"_empty"===z[l]||z[m]===k.addoper?z[l]=d[2]:d[2]=z[l],v.reloadAfterSubmit?t.trigger("reloadGrid",g):!0===w.treeGrid?C.addChildNode.call(t,d[2],p,z):C.addRowData.call(t,d[2],z,v.addedrow),v.closeAfterAdd?(!0!==w.treeGrid&&F.call(t,d[2]),P()):v.clearAfterAdd&&f("_empty",D)):(v.reloadAfterSubmit?(t.trigger("reloadGrid",g),v.closeAfterEdit||setTimeout(function(){F.call(t,
z[l])},1E3)):!0===w.treeGrid?C.setTreeRow.call(t,z[l],z):C.setRowData.call(t,z[l],z),v.closeAfterEdit&&P());if(b.isFunction(v.afterComplete)){var n=a;setTimeout(function(){t.triggerHandler("jqGridAddEditAfterComplete",[n,z,b(D),M]);v.afterComplete.call(r,n,z,b(D),M);n=null},50)}if(v.checkOnSubmit||v.checkOnUpdate)if(b(D).data("disabled",!1),"_empty"!==v._savedData[y+"_id"])for(var q in v._savedData)v._savedData.hasOwnProperty(q)&&z[q]&&(v._savedData[q]=z[q])}v.processing=!1;try{b(":input:visible",
D)[0].focus()}catch(A){}}},u.ajaxOptions,v.ajaxEditOptions);q.url||v.useDataProxy||(b.isFunction(w.dataProxy)?v.useDataProxy=!0:(d[0]=!1,d[1]+=" "+u.errors.nourl));d[0]&&(v.useDataProxy?(e=w.dataProxy.call(r,q,"set_"+y),void 0===e&&(e=[!0,""]),!1===e[0]?(d[0]=!1,d[1]=e[1]||"Error deleting the selected row!"):(q.data.oper===k.addoper&&v.closeAfterAdd&&P(),q.data.oper===k.editoper&&v.closeAfterEdit&&P())):"clientArray"===q.url?(v.reloadAfterSubmit=!1,z=q.data,q.complete({status:200,statusText:""},"")):
b.ajax(q))}!1===d[0]&&(b("#FormError>td",h).html(d[1]),b("#FormError",h).show())}function m(b,a){var c=!1,d;for(d in b)if(b.hasOwnProperty(d)&&String(b[d])!==String(a[d])){c=!0;break}return c}function l(){var a=!0;b("#FormError",h).hide();v.checkOnUpdate&&(z={},d(),J=m(z,v._savedData))&&(b(D).data("disabled",!0),b(".confirm",H).show(),a=!1);return a}function n(){var c=u.detectRowEditing.call(r,a);if(null!=c)if("inlineEditing"===c.mode)C.restoreRow.call(t,a);else{var c=c.savedRow,d=r.rows[c.id];C.restoreCell.call(t,
...
"","left"),Ea=ea.call(r,Ea,"",ua(ca,v.nextIcon),"","right"),Fa=ea.call(r,"sData",v.bSubmit),db=ea.call(r,"cData",v.bCancel),E="<div class='"+O.call(r,"dialog.footer")+"'><table class='EditTable' id='"+E+"_2'><tbody><tr><td colspan='2'><hr class='"+O.call(r,"dialog.hr")+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton navButton-"+w.direction+"'>"+(ia?Ea+ra:ra+Ea)+"</td><td class='EditButton EditButton-"+w.direction+"'>"+Fa+"&#160;"+db+"</td></tr>",E=E+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+
(v.bottominfo||"&#160;")+"</td></tr>"),E=E+"</tbody></table></div>";if(0<N){var $a=[];b.each(b(U)[0].rows,function(b,a){$a[b]=a});$a.sort(function(b,a){return b.rp>a.rp?1:b.rp<a.rp?-1:0});b.each($a,function(a,c){b("tbody",U).append(c)})}v.gbox=I;var ib=!1;!0===v.closeOnEscape&&(v.closeOnEscape=!1,ib=!0);E=b("<div></div>").append(b("<div class='"+O.call(r,"dialog.body")+"'></div>").append(A)).append(E);u.createModal.call(r,L,E,v,w.gView,b(I)[0]);v.topinfo&&b(".tinfo",h).show();v.bottominfo&&b(".binfo",
B).show();E=E=null;b(H).keydown(function(a){var c=(a.target.tagName||"").toUpperCase(),d,e;if(!0===b(D).data("disabled"))return!1;if(13===a.which&&"TEXTAREA"!==c){d=b(B).find(":focus");e=d.attr("id");if(0<d.length&&0<=b.inArray(e,["pData","nData","cData"]))return d.trigger("click"),!1;if(!0===v.savekey[0]&&13===v.savekey[1])return b("#sData",B).trigger("click"),!1}if(!0===v.savekey[0]&&a.which===v.savekey[1]&&"TEXTAREA"!==c)return b("#sData",B).trigger("click"),!1;if(27===a.which){if(!l())return!1;
...
ea.call(r,"sNew",v.bYes),Ea=ea.call(r,"nNew",v.bNo),db=ea.call(r,"cNew",v.bExit),L=v.zIndex||999,L++,b("<div class='"+v.overlayClass+" jqgrid-overlay confirm' style='z-index:"+L+";display:none;'>&#160;</div><div class='"+O.call(r,"dialog.content","confirm ui-jqconfirm")+"' style='z-index:"+(L+1)+"'>"+v.saveData+"<br/><br/>"+Fa+Ea+db+"</div>").insertAfter(D),b("#sNew",H).click(function(){k();b(D).data("disabled",!1);b(".confirm",H).hide();return!1}),b("#nNew",H).click(function(){b(".confirm",H).hide();
b(D).data("disabled",!1);setTimeout(function(){b(":input:visible",D)[0].focus()},0);return!1}),b("#cNew",H).click(function(){b(".confirm",H).hide();b(D).data("disabled",!1);P();return!1});S("onInitializeForm",b(D),M);"_empty"!==a&&v.viewPagerButtons?b("#pData,#nData",B).show():b("#pData,#nData",B).hide();S("beforeShowForm",b(D),M);b(H).data("onClose",v.onClose);u.viewModal.call(r,H,{gbox:I,jqm:v.jqModal,overlay:v.overlay,modal:v.modal,overlayClass:v.overlayClass,toTop:v.toTop,onHide:function(b){b.w.remove();
b.o&&b.o.remove()}});qa||b("."+G(v.overlayClass)).click(function(){if(!l())return!1;P();return!1});b(".fm-button",H).hover(function(){b(this).addClass(ba)},function(){b(this).removeClass(ba)});b("#sData",B).click(function(){z={};b("#FormError",h).hide();d();"_empty"===z[y+"_id"]?k():!0===v.checkOnSubmit?(J=m(z,v._savedData))?(b(D).data("disabled",!0),b(".confirm",H).show()):k():k();return!1});b("#cData",B).click(function(){if(!l())return!1;P();return!1});b("#nData",B).click(function(){if(!l())return!1;
b("#FormError",h).hide();var a=q();a[0]=parseInt(a[0],10);if(-1!==a[0]&&a[1][a[0]+1]){if(!S("onclickPgButtons","next",b(D),a[1][a[0]]))return!1;f(a[1][a[0]+1],D);F.call(t,a[1][a[0]+1]);S("afterclickPgButtons","next",b(D),a[1][a[0]+1]);p(a[0]+1,a)}return!1});b("#pData",B).click(function(){if(!l())return!1;b("#FormError",h).hide();var a=q();if(-1!==a[0]&&a[1][a[0]-1]){if(!S("onclickPgButtons","prev",b(D),a[1][a[0]])||aa(b("#"+G(a[1][a[0]-1])),V))return!1;f(a[1][a[0]-1],D);F.call(t,a[1][a[0]-1]);S("afterclickPgButtons",
"prev",b(D),a[1][a[0]-1]);p(a[0]-1,a)}return!1});S("afterShowForm",b(D),M);qa=q();p(qa[0],qa)}}})},viewGridRow:function(a,c){return this.each(function(){function d(){!0!==q.closeOnEscape&&!0!==q.navkeys[0]||setTimeout(function(){b("#cData").focus()},0)}function e(a,c,d){var e,f,g,h=0,k,p,r=[],t=C.getInd.call(l,a),v;v=O.call(m,"dialog.viewData","DataTD form-view-data");var w=O.call(m,"dialog.viewLabel","CaptionTD form-view-label"),z="<td class='"+w+"' width='"+q.labelswidth+"'>&#160;</td><td class='"+
v+" ui-helper-reset'>&#160;</td>",B="",w="<td class='"+w+"'></td><td class='"+v+"'></td>",y=["integer","number","currency"],x=0,E=0,L,D,F;for(v=1;v<=d;v++)B+=1===v?z:w;b(A).each(function(){(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==b.inArray(this.formatter,y)?x=Math.max(x,parseInt(this.width,10)):E=Math.max(E,parseInt(this.width,10)))});L=0!==x?x:0!==E?E:0;b(A).each(function(a){e=this.name;D=!1;p=(f=this.editrules&&!0===
this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";F="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==e&&"subgrid"!==e&&"rn"!==e&&F){k=!1===t?"":u.getDataFieldOfCell.call(m,m.rows[t],a).html();D="right"===this.align&&0!==L?!0:!1;var l=b.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),q=parseInt(l.rowpos,10)||h+1,v=parseInt(2*(parseInt(l.colpos,10)||1),10);if(l.rowabove){var w=b("<tr><td class='contentinfo' colspan='"+2*d+"'>"+l.rowcontent+"</td></tr>");
...
null!=n&&a){var p=n.id,q=b.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,closeOnEscape:!1,labelswidth:"30%",navkeys:[!1,38,40],onClose:null,beforeShowForm:null,beforeInitData:null,viewPagerButtons:!0,removemodal:!0},C.getGridRes.call(l,"view"),u.view||{},n.formViewing||{},c||{}),r="#ViewGrid_"+G(p),t="#ViewTbl_"+G(p),w=t+"_2",y="ViewGrid_"+p,x="ViewTbl_"+p,F=q.commonIconClass,p={themodal:"viewmod"+p,modalhead:"viewhd"+p,modalcontent:"viewcnt"+p,
resizeAlso:y},v="#"+G(p.themodal),D=n.gBox,A=n.colModel,E=1,h=0,B=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("View");a.unshift(q);return Ra.apply(m,a)},L=function(){u.hideModal(v,{gb:D,jqm:q.jqModal,onClose:q.onClose,removemodal:q.removemodal})},H=Y.call(m,"hover"),I=Y.call(m,"disabled"),Q=isNaN(q.dataheight)?q.dataheight:q.dataheight+"px",K=isNaN(q.datawidth)?q.datawidth:q.datawidth+"px",y=b("<div class='"+O.call(m,"dialog.body")+"'><form name='FormPost' id='"+y+"' class='FormGrid' style='width:"+
K+";overflow:auto;position:relative;height:"+Q+";'></form></div>"),Q=y.children("form.FormGrid"),Z=b("<table id='"+x+"' class='EditTable'><tbody></tbody></table>");b(v).remove();b(A).each(function(){var b=this.formoptions;E=Math.max(E,b?b.colpos||0:0);h=Math.max(h,b?b.rowpos||0:0)});Q.append(Z);if(B("beforeInitData",Q)){e(a,Z,E);var N=(Q="rtl"===n.direction?!0:!1)?"pData":"nData",K=ea.call(m,Q?"nData":"pData","",ua(F,q.prevIcon),"","left"),N=ea.call(m,N,"",ua(F,q.nextIcon),"","right"),z=ea.call(m,
"cData",q.bClose);if(0<h){var J=[];b.each(b(Z)[0].rows,function(b,a){J[b]=a});J.sort(function(b,a){return b.rp>a.rp?1:b.rp<a.rp?-1:0});b.each(J,function(a,c){b("tbody",Z).append(c)})}q.gbox=D;x=b("<div></div>").append(y).append("<div class='"+O.call(m,"dialog.footer")+"'><table border='0' class='EditTable' id='"+x+"_2'><tbody><tr id='Act_Buttons'><td class='navButton navButton-"+n.direction+"' width='"+(q.labelswidth||"auto")+"'>"+(Q?N+K:K+N)+"</td><td class='EditButton EditButton-"+n.direction+"'>"+
...
useDataProxy:!1},C.getGridRes.call(f,"del"),u.del||{},e.formDeleting||{},c||{}),m="DelTbl_"+g,l="#DelTbl_"+G(g),n,p,q,r,t={themodal:"delmod"+g,modalhead:"delhd"+g,modalcontent:"delcnt"+g,resizeAlso:m},w="#"+G(t.themodal),y=e.gBox,x=k.commonIconClass,F=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("Delete");a.unshift(k);return Ra.apply(d,a)},v=Y.call(d,"hover"),D=Y.call(d,"active"),A=Y.call(d,"error");b.isArray(a)||(a=[String(a)]);if(void 0!==b(w)[0]){if(!F("beforeInitData",b(l)))return;
b("#DelData>td",l).text(a.join()).data("rowids",a);b("#DelError",l).hide();!0===k.processing&&(k.processing=!1,b("#dData",l).removeClass(D));F("beforeShowForm",b(l));u.viewModal.call(d,w,{gbox:y,jqm:k.jqModal,jqM:!1,overlay:k.overlay,toTop:k.toTop,modal:k.modal})}else{var E=isNaN(k.dataheight)?k.dataheight:k.dataheight+"px",h=isNaN(k.datawidth)?k.datawidth:k.datawidth+"px",E="<div class='"+O.call(d,"dialog.body")+"'><div id='"+m+"' class='formdata' style='width:"+h+";overflow:auto;position:relative;height:"+
E+";'>",E=E+"<table class='DelTable'><tbody>"+("<tr id='DelError' style='display:none'><td class='"+A+"'></td></tr>")+("<tr id='DelData' style='display:none'><td >"+a.join()+"</td></tr>"),E=E+("<tr><td class='delmsg' style='white-space:pre;'>"+k.msg+"</td></tr>"),E=E+"</tbody></table></div></div>",A=ea.call(d,"dData",k.bSubmit),h=ea.call(d,"eData",k.bCancel),E=E+("<div class='"+O.call(d,"dialog.footer")+"'><table class='EditTable' id='"+m+"_2'><tbody><tr><td><hr class='"+O.call(d,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton EditButton-"+
e.direction+"'>"+A+"&#160;"+h+"</td></tr></tbody></table></div>");k.gbox=y;u.createModal.call(d,t,E,k,e.gView,b(e.gView)[0]);b("#DelData>td",l).data("rowids",a);if(!F("beforeInitData",b(E)))return;b(".fm-button",l+"_2").hover(function(){b(this).addClass(v)},function(){b(this).removeClass(v)});Ha(b("#dData",l+"_2"),k.delicon,x);Ha(b("#eData",l+"_2"),k.cancelicon,x);b("#dData",l+"_2").click(function(){var a=[!0,""],c,h=b("#DelData>td",l),m=h.text(),t=h.data("rowids"),h={};b.isFunction(k.onclickSubmit)&&
(h=k.onclickSubmit.call(d,k,m)||{});b.isFunction(k.beforeSubmit)&&(a=k.beforeSubmit.call(d,m)||a);if(a[0]&&!k.processing){k.processing=!0;q=e.prmNames;n=b.extend({},k.delData,h);r=q.oper;n[r]=q.deloper;p=q.id;m=t.slice();if(!m.length)return!1;for(c in m)m.hasOwnProperty(c)&&(m[c]=u.stripPref(e.idPrefix,m[c]));n[p]=m.join();b(this).addClass(D);c=k.url||e.editurl;c=b.extend({url:b.isFunction(c)?c.call(d,n[p],n,k):c,type:k.mtype,data:b.isFunction(k.serializeDelData)?k.serializeDelData.call(d,n):n,complete:function(c,
g){var h;b("#dData",l+"_2").removeClass(D);300<=c.status&&304!==c.status||0===c.status&&4===c.readyState?(a[0]=!1,b.isFunction(k.errorTextFormat)?a[1]=k.errorTextFormat.call(d,c):a[1]=g+" Status: '"+c.statusText+"'. Error code: "+c.status):b.isFunction(k.afterSubmit)&&(a=k.afterSubmit.call(d,c,n)||[!0]);if(!1===a[0])b("#DelError>td",l).html(a[1]),b("#DelError",l).show();else{if(k.reloadAfterSubmit&&"local"!==e.datatype)f.trigger("reloadGrid",[b.extend({},k.reloadGridOptions||{})]);else if(!0===e.treeGrid)try{C.delTreeNode.call(f,
t[0])}catch(p){}else for(t=t.slice(),h=0;h<t.length;h++)C.delRowData.call(f,t[h]);setTimeout(function(){F("afterComplete",c,m,b(l))},50)}k.processing=!1;a[0]&&u.hideModal(w,{gb:y,jqm:k.jqModal,onClose:k.onClose,removemodal:k.removemodal})}},u.ajaxOptions,k.ajaxDelOptions);c.url||k.useDataProxy||(b.isFunction(e.dataProxy)?k.useDataProxy=!0:(a[0]=!1,a[1]+=" "+u.errors.nourl));a[0]&&(k.useDataProxy?(c=e.dataProxy.call(d,c,"del_"+g),void 0===c&&(c=[!0,""]),!1===c[0]?(a[0]=!1,a[1]=c[1]||"Error deleting the selected row!"):
u.hideModal(w,{gb:y,jqm:k.jqModal,onClose:k.onClose,removemodal:k.removemodal})):"clientArray"===c.url?(n=c.data,c.complete({status:200,statusText:""},"")):b.ajax(c))}!1===a[0]&&(b("#DelError>td",l).html(a[1]),b("#DelError",l).show());return!1});b("#eData",l+"_2").click(function(){u.hideModal(w,{gb:y,jqm:k.jqModal,onClose:k.onClose,removemodal:k.removemodal});return!1});F("beforeShowForm",b(l));u.viewModal.call(d,w,{gbox:y,jqm:k.jqModal,overlay:k.overlay,toTop:k.toTop,modal:k.modal})}F("afterShowForm",
...
height:q.alertheight,closeOnEscape:q.closeOnEscape,zIndex:q.alertzIndex,removemodal:q.removemodal},l.gView,b(w)[0],!1));u.viewModal.call(m,"#"+G(x.themodal),{gbox:w,toTop:q.alertToTop,jqm:q.jqModal});var g=b("#"+G(x.modalhead)).find(".ui-jqdialog-titlebar-close");g.attr({tabindex:"0",href:"#",role:"button"});setTimeout(function(){g.focus()},50)}}(),v,D=function(a){if(13===a.which&&(a=b(this).find(".ui-pg-button").filter(":focus"),0<a.length)){var c=a[0].id,c=c.substr(0,0<b(this).closest(".ui-jqgrid-toppager").length?
c.length-p.length-5:c.length-p.length-1)+"mod"+l.id,d=b(".ui-jqdialog").filter(":visible").map(function(){return this.id});if(0>b.inArray(c,d))return a.trigger("click"),!1}},A=Y.call(m,"hover"),E=Y.call(m,"disabled"),h=O.call(m,"navButton","ui-pg-button");if(m.grid){m.modalAlert=F;void 0===a&&(l.pager?(a=l.pager,l.toppager&&(q.cloneToTop=!0)):l.toppager&&(a=l.toppager));var B=1,L,H,I,Q,K,Z,N=["left","center","right"],z="<div class='"+O.call(m,"navButton","ui-pg-button "+Y.call(m,"disabled"))+"'><span class='ui-separator'></span></div>",
J=function(){aa(this,E)||b(this).addClass(A)},M=function(){b(this).removeClass(A)},ca=function(){aa(this,E)||(b.isFunction(q.addfunc)?q.addfunc.call(m):C.editGridRow.call(n,"new",e));return!1},P=function(a,c,d){if(!aa(this,E)){var e=l.selrow;e?b.isFunction(a)?a.call(m,e):C[c].call(n,e,d):F()}return!1},R=function(){return P.call(this,q.editfunc,"editGridRow",d)},S=function(){return P.call(this,q.viewfunc,"viewGridRow",k)},U=function(){var a;aa(this,E)||(l.multiselect?(a=l.selarrrow,0===a.length&&(a=
null)):a=l.selrow,a?b.isFunction(q.delfunc)?q.delfunc.call(m,a):C.delGridRow.call(n,a,f):F());return!1},V=function(){aa(this,E)||(b.isFunction(q.searchfunc)?q.searchfunc.call(m,g):C.searchGrid.call(n,g));return!1},da=function(){if(!aa(this,E)){b.isFunction(q.beforeRefresh)&&q.beforeRefresh.call(m);l.search=!1;l.resetsearch=!0;try{if("currentfilter"!==q.refreshstate){l.postData.filters="";try{b("#fbox_"+t).jqFilter("resetFilter")}catch(a){}b.isFunction(m.clearToolbar)&&m.clearToolbar(!1)}}catch(a){}switch(q.refreshstate){case "firstpage":n.trigger("reloadGrid",
...
0;Q<N.length;Q++)N[Q]!==q.position&&(Z=b(H+"_"+N[Q],H),0===Z.length||0===Z[0].childNodes.length?Z.hide():1===Z[0].childNodes.length&&(K=Z[0].firstChild,!b(K).is("table.ui-pg-table")||0!==K.rows&&0!==K.rows[0].cells.length||Z.hide()));l._nvtd&&(r>l._nvtd[0]&&(b(H+"_"+q.position,H).width(r),l._nvtd[0]=r),l._nvtd[1]=r);m.nav=!0;v.bind("keydown.jqGrid",D)}n.triggerHandler("jqGridResetFrozenHeights")}}})},navButtonAdd:function(a,c){"object"===typeof a&&(c=a,a=void 0);return this.each(function(){var d=
...
d.onClickGroup.call(this,a,p)});return!1},groupingRender:function(a,c){function d(a,c,d,e,k){var l=x[a],m,n="",p,q,t,w=0,A,y,E,D=!0;if(0!==c&&0!==x[a].idx)for(m=a;0<=m;m--)if(x[m].idx===x[a].idx-c){l=x[m];break}a=l.cnt;for(A=void 0===k?e:0;A<v;A++){c="&#160;";m=F[A];for(p=0;p<l.summary.length;p++)if(q=l.summary[p],y=b.isArray(q.st)?q.st[d.idx]:q.st,E=b.isArray(m.summaryTpl)?m.summaryTpl[d.idx]:m.summaryTpl||"{0}",q.nm===m.name){"string"===typeof y&&"avg"===y.toLowerCase()&&(q.sd&&q.vd?q.v/=q.vd:q.v&&
0<a&&(q.v/=a));try{q.groupCount=l.cnt,q.groupIndex=l.dataIndex,q.groupValue=l.value,t=f.formatter("",q.v,A,q)}catch(C){t=q.v}c=u.format(E,t);m.summaryFormat&&(c=m.summaryFormat.call(f,d,c,t,m,q));break}q=p=!1;void 0!==k&&D&&!m.hidden&&(c=k,D=!1,1<e&&(p=!0,w=e-1),q=m.align,m.align="rtl"===g.direction?"right":"left",r.iconColumnName=m.name);0<w&&!m.hidden&&"&#160;"===c?(q&&(m.align=q),w--):(n+="<td role='gridcell' "+f.formatCol(A,1,"")+(p?"colspan='"+e+"'":"")+">"+c+"</td>",q&&(m.align=q))}return n}
var e="",f=this[0],g=f.p,k=0,m,l=[],n="",p,q,r=g.groupingView,t=b.makeArray(r.groupSummary),w=(r.groupCollapse?r.plusicon:r.minusicon)+" tree-wrap",y=r.groupField.length,x=r.groups,F=g.colModel,v=F.length,D=g.page,A=C.getGuiStyles.call(f,"gridRow","jqgroup ui-row-"+g.direction),E=C.getGuiStyles.call(f,"gridRow","jqfoot ui-row-"+g.direction);b.each(F,function(b,a){var c;for(c=0;c<y;c++)if(r.groupField[c]===a.name){l[c]=b;break}});t.reverse();b.each(x,function(h,B){if(r._locgr&&!(B.startRow+B.cnt>(D-
...
f),w(g)&&(n.errorfunc=g),w(k)&&(n.afterrestorefunc=k),w(m)&&(n.beforeSaveRow=m));var l=function(a){return q.jqGrid("getGridRes",a)},n=b.extend(!0,{successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,beforeSaveRow:null,ajaxSaveOptions:{},serializeSaveData:null,mtype:"POST",saveui:"enable",savetext:l("defaults.savetext")||"Saving..."},u.inlineEdit,r.inlineEditing||{},n),x={},F={},v={},D,A,E,h;E=q.jqGrid("getInd",a,!0);var B=b(E);D=r.prmNames;
var C=l("errors.errcap"),H=l("edit.bClose"),I;if(!1!==E&&(l=n.extraparam[D.oper]===D.addoper?"add":"edit",Xa.call(p,n,"beforeSaveRow",n,a,l)&&(D=B.attr("editable"),n.url=n.url||r.editurl,I="clientArray"!==n.url,"1"===D)))if(u.enumEditableCells.call(p,E,B.hasClass("jqgrid-new-row")?"add":"edit",function(c){var d=c.cm,e=d.formatter,f=d.editoptions||{},g=d.formatoptions||{},k={},l=(b.jgrid.detectRowEditing.call(p,a)||{}).savedRow,m=u.getEditedValue.call(p,b(c.dataElement),d,k,c.editable);"select"===
d.edittype&&"select"!==d.formatter&&(F[d.name]=k.text);h=u.checkValues.call(p,m,c.iCol,void 0,void 0,b.extend(c,{oldValue:null!=l?l[d.name]:null,newValue:m,oldRowData:l}));if(null!=h&&!1===h[0])return!1;"date"===e&&!0!==g.sendFormatted&&(m=b.unformat.date.call(p,m,d));I&&!0===f.NullIfEmpty&&""===m&&(m="null");x[d.name]=m}),null!=h&&!1===h[0])try{var G=q.jqGrid("getGridRowById",a),K=u.findPos(G);t.call(p,C,h[1],H,{left:K[0],top:K[1]+b(G).outerHeight()})}catch(J){y(h[1])}else if(G=a,D=r.prmNames,K=
!1===r.keyName?D.id:r.keyName,x&&(x[D.oper]=D.editoper,void 0===x[K]||""===x[K]?x[K]=a:E.id!==r.idPrefix+x[K]&&(E=u.stripPref(r.idPrefix,a),void 0!==r._index[E]&&(r._index[x[K]]=r._index[E],delete r._index[E]),a=r.idPrefix+x[K],B.attr("id",a),r.selrow===G&&(r.selrow=a),b.isArray(r.selarrrow)&&(E=b.inArray(G,r.selarrrow),0<=E&&(r.selarrrow[E]=a)),r.multiselect&&(E="jqg_"+r.id+"_"+a,B.find("input.cbox").attr("id",E).attr("name",E))),x=b.extend({},x,r.inlineData||{},n.extraparam)),I)q.jqGrid("progressBar",
...
Y.call(p,"error")+'">'+c+"</div>",H,{buttonalign:"right"})}catch(f){y(c)}}!0===n.restoreAfterError&&q.jqGrid("restoreRow",a,n.afterrestorefunc)}},u.ajaxOptions,r.ajaxRowOptions,n.ajaxSaveOptions||{}));else{x=b.extend({},x,F);E=q.jqGrid("setRowData",a,x);B.attr("editable","0");for(l=0;l<r.savedRow.length;l++)if(String(r.savedRow[l].id)===String(G)){A=l;break}0<=A&&r.savedRow.splice(A,1);la.call(p,n.aftersavefunc,"jqGridInlineAfterSaveRow",a,E,x,n);B.removeClass("jqgrid-new-row").unbind("keydown")}}},
...
return}a.msel_opts=b.extend(fa.defaults,a.msel_opts)}a.caption&&g.attr("title",a.caption);a.classname&&(g.addClass(a.classname),k.addClass(a.classname));a.width&&(b(">div",g).css({width:a.width,margin:"0 auto"}),k.css("width",a.width));a.height&&(b(">div",g).css("height",a.height),k.css("height",a.height-10));k.empty();var t=f.groupHeader,w={},y,x,F,v,D;if(null!=t&&null!=t.groupHeaders)for(y=0,F=t.groupHeaders.length;y<F;y++)for(D=t.groupHeaders[y],x=0;x<D.numberOfColumns;x++)v=f.iColByName[D.startColumnName]+
x,w[v]=b.isFunction(a.buildItemText)?a.buildItemText.call(d[0],{iCol:v,cm:q[v],cmName:q[v].name,colName:p[v],groupTitleText:D.titleText}):b.jgrid.stripHtml(D.titleText)+": "+b.jgrid.stripHtml(""===p[v]?q[v].name:p[v]);for(v=0;v<n;v++)void 0===w[v]&&(w[v]=b.isFunction(a.buildItemText)?a.buildItemText.call(d[0],{iCol:v,cm:q[v],cmName:q[v].name,colName:p[v],groupTitleText:null}):b.jgrid.stripHtml(p[v]));b.each(q,function(a){m[this.name]=a;this.hidedlg?this.hidden||l.push(a):k.append("<option value='"+
...
W=n(D,m.skipSortByY,m.compareVectorsByY);c.xIndex=Y;c.yIndex=W;for(n=0;n<B;n++)p=v[n],t={name:"x"+n,label:null!=p.label?b.isFunction(p.label)?p.label.call(d,p,n,m):p.label:p.dataName,frozen:m.frozenStaticCols},n<B-1&&(g.groupField.push(t.name),g.groupSummary.push(m.groupSummary),g.groupSummaryPos.push(m.groupSummaryPos)),t=b.extend(t,p),delete t.dataName,delete t.footerText,K.push(t);2>B&&(k.grouping=!1);k.sortname=K[B-1].name;g.hideFirstGroupCol=!0;for(n=0;n<y;n++)r=D[n],G.push(r.totals||r.rowTotals||
r.totalText||r.totalHeader?!0:!1);ba=W.getItem(0);x(0,y-1,0);g=W.getIndexLength();for(t=1;t<g;t++){M=W.getItem(t);n=W.getIndexOfDifferences(M,ba);for(p=H-1;p>=n;p--)G[p]&&x(1,p,t-1);ba=M;x(0,y-1,t)}for(n=H-1;0<=n;n--)G[n]&&x(1,n,g-1);q&&x(2);ba=W.getItem(0);for(p=0;p<H;p++)I.push({useColSpanStyle:m.useColSpanStyle,groupHeaders:[{titleText:ba[p],startColumnName:1===C?"y0":"y0a0",numberOfColumns:C}]});for(t=1;t<g;t++){M=W.getItem(t);n=W.getIndexOfDifferences(M,ba);z(t,n,ba);for(p=H-1;p>=n;p--)I[p].groupHeaders.push({titleText:M[p],
startColumnName:"y"+t+(1===C?"":"a0"),numberOfColumns:C});for(p=0;p<n;p++)V=I[p].groupHeaders,V[V.length-1].numberOfColumns+=C;ba=M}z(g,0,ba);if(q)for(n=0;n<H;n++)I[n].groupHeaders.push({titleText:n<H-1?"":m.totalHeader||"",startColumnName:"t"+(1===C?"":"a0"),numberOfColumns:C});z=Y.getIndexLength();for(y=0;y<z;y++){p=Y.getItem(y);x={iX:y,x:p};S={pivotInfos:x};for(n=0;n<B;n++)S["x"+n]=p[n];O=Y.getIndexesOfSourceData(y);if(q)for(p=0;p<C;p++)J[p]=aa(p);ba=null;ea();for(t=0;t<g;t++){M=W.getItem(t);R=
W.getIndexesOfSourceData(t);for(p=0;p<C;p++){null!==ba&&fa(t-1,M,ba,p);P=[];for(n=0;n<R.length;n++)w=R[n],0<=b.inArray(w,O)&&P.push(w);if(0<P.length){F=Array(P.length);U=A[p];E=new xa(U.aggregator,d,c);for(w=0;w<P.length;w++)n=P[w],l=a[n],F[w]=l,E.calc(l[U.member],U.member,l,n,a),q&&(h=J[p],h.calc(l[U.member],U.member,l,n,a),h=h.groupInfo,0>b.inArray(n,h.iYs)&&(h.iYs.push(t),h.ys.push(M)),0>b.inArray(n,h.iRows)&&(h.iRows.push(n),h.rows.push(l))),ga(M,ba,U,p,l,n,t);l="y"+t+(1===C?"":"a"+p);E.getResult(S,
l);x[l]={colType:0,iY:t,y:M,iA:p,a:U,iRows:P,rows:F}}}ba=M}if(null!==ba)for(p=0;p<C;p++)fa(g-1,ba,ba,p);if(q)for(p=0;p<C;p++)l="t"+(1===C?"":"a"+p),h=J[p],h.getResult(S,l),h=h.groupInfo,x[l]={colType:2,iA:p,a:A[p],iRows:h.iRows,rows:h.rows,iYs:h.iYs,ys:h.ys};e.push(S)}if(m.footerTotals||m.colTotals){q=e.length;for(n=0;n<B;n++)f["x"+n]=v[n].footerText||"";for(n=B;n<K.length;n++){l=K[n].name;E=new xa(m.footerAggregator||"sum",d,c);for(w=0;w<q;w++)S=e[w],E.calc(S[l],l,S,w,e);E.getResult(f,l)}}c.colHeaders=
...
(n=n[p.cell]),k=0;k<n.length;k++)q(d,n[k]||"&#160;",k);else if(l=f.mapping||f.name,l.length)for(k=0;k<l.length;k++)q(d,n[l[k]]||"&#160;",k);c.append(d)}},w=function(a,c,h){var l,m;l=g("legacyTable","ui-jqgrid-legacy-subgrid"+(!0===e.altRows&&b(d).jqGrid("isBootstrapGuiStyle")?" table-striped":""));var n=b("<table"+(l?" style='width:1px' role='presentation' class='"+l+"'":"")+"><thead></thead><tbody></tbody></table>"),q=b("<tr></tr>");for(m=0;m<f.name.length;m++)l=b("<th class='"+k+"'></th>").html(f.name[m]).width(f.width[m]),
q.append(l);q.appendTo(n[0].tHead);h(a,b(n[0].tBodies[0]));b("#"+G(e.id+"_"+c)).append(n);d.grid.hDiv.loading=!1;b("#load_"+G(e.id)).hide();return!1},y=function(a){var c=b(a).attr("id"),g={nd_:(new Date).getTime()},k,l;g[e.prmNames.subgridid]=c;if(!f)return!1;if(f.params)for(l=0;l<f.params.length;l++)k=e.iColByName[f.params[l]],void 0!==k&&(g[e.colModel[k].name]=b(a.cells[k]).text().replace(/\&#160\;/ig,""));if(!d.grid.hDiv.loading)switch(d.grid.hDiv.loading=!0,b("#load_"+G(e.id)).show(),e.subgridtype||
...
p[k][f]);if("nested"===c.treeGridModel){f=u.from.call(this,c.data).greater(l,d,{stype:"integer"}).select();if(f.length)for(g in f)f.hasOwnProperty(g)&&(f[g][l]=parseInt(f[g][l],10)-e);f=u.from.call(this,c.data).greater(n,d,{stype:"integer"}).select();if(f.length)for(g in f)f.hasOwnProperty(g)&&(f[g][n]=parseInt(f[g][n],10)-e)}}})},addChildNode:function(a,c,d,e){var f=b(this),g=f[0],k=g.p,m=C.getInd;if(d){var l,n,p,q,r;l=0;var t=c,w,y,x=k.treeReader.expanded_field;y=k.treeReader.leaf_field;var F=k.treeReader.level_field,
v=k.treeReader.parent_id_field,D=k.treeReader.left_field,A=k.treeReader.right_field,E=k.treeReader.loaded;void 0===e&&(e=!1);if(null==a){r=k.data.length-1;if(0<=r)for(;0<=r;)l=Math.max(l,parseInt(k.data[r][k.localReader.id],10)),r--;a=l+1}var h=m.call(f,c);w=!1;if(void 0===c||null===c||""===c)t=c=null,l="last",q=k.tree_root_level,r=k.data.length+1;else{l="after";n=k._index[c];p=k.data[n];c=p[k.localReader.id];r=m.call(f,c);q=parseInt(p[F],10)+1;var B=C.getFullTreeNode.call(f,p);if(B.length){var G,
H,I;for(G=0;G<B.length;G++)I=B[G][k.localReader.id],H=m.call(f,I),H>r&&(r=H,t=I)}r++;p[y]&&(w=!0,p[x]=!0,b(g.rows[h]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(k.treeIcons.leaf+" tree-leaf").addClass(k.treeIcons.commonIconClass).addClass(k.treeIcons.minus+" tree-minus"),k.data[n][y]=!1,p[E]=!0)}m=r+1;void 0===d[x]&&(d[x]=!1);void 0===d[E]&&(d[E]=!1);d[F]=q;void 0===d[y]&&(d[y]=!0);"adjacency"===k.treeGridModel&&(d[v]=
c);if("nested"===k.treeGridModel){var J;if(null!==c){y=parseInt(p[A],10);k=u.from.call(g,k.data);k=k.greaterOrEquals(A,y,{stype:"integer"});F=k.select();if(F.length)for(J in F)F.hasOwnProperty(J)&&(F[J][D]=F[J][D]>y?parseInt(F[J][D],10)+2:F[J][D],F[J][A]=F[J][A]>=y?parseInt(F[J][A],10)+2:F[J][A]);d[D]=y;d[A]=y+1}else{y=parseInt(C.getCol.call(f,A,!1,"max"),10);F=u.from.call(g,k.data).greater(D,y,{stype:"integer"}).select();if(F.length)for(J in F)F.hasOwnProperty(J)&&(F[J][D]=parseInt(F[J][D],10)+2);
F=u.from.call(g,k.data).greater(A,y,{stype:"integer"}).select();if(F.length)for(J in F)F.hasOwnProperty(J)&&(F[J][A]=parseInt(F[J][A],10)+2);d[D]=y+1;d[A]=y+2}}if(null===c||C.isNodeLoaded.call(f,p)||w)C.addRowData.call(f,a,d,l,t),C.setTreeNode.call(f,r,m);p&&!p[x]&&e&&b(g.rows[h]).find("div.treeclick").click()}}});var Ya="mousedown",Sa="mousemove",Ia="mouseup",wb=function(a){var b=a.originalEvent.targetTouches;return b?(b=b[0],{x:b.pageX,y:b.pageY}):{x:a.pageX,y:a.pageY}},La={drag:function(a){var b=
