...
e;if("string"===typeof b){e=c[b];if(!e)throw"jqGrid - No such method: "+b;return e.apply(this,a.makeArray(arguments).slice(1))}return this.each(function(){if(!this.grid){var d=this,e,g,h=a(d),m=a.isFunction,l=a.isArray,n=a.extend,p=a.inArray,q=a.trim,r=a.each,t=c.setSelection,w=c.getGridRes,x=m(Ta.fatalError)?Ta.fatalError:alert,y=b.locale||Ta.locale||"en-US",B=null!=Ga[y]&&"boolean"===typeof Ga[y].isRTL?Ga[y].isRTL?"rtl":"ltr":"ltr",u=b.iconSet||Ta.iconSet||"jQueryUI",E=b.guiStyle||Ta.guiStyle||
"jQueryUI",z=function(a){return v.getIconRes(u,a)},F=function(a,b){return pa(v.getRes(v.guiStyles[E],a),b||"")};null==b&&(b={datatype:"local"});void 0!==b.datastr&&l(b.datastr)&&(g=b.datastr,b.datastr=[]);void 0!==b.data&&(e=b.data,b.data=[]);null!=v.formatter&&null!=v.formatter.unused||x("CRITICAL ERROR!!!\n\n\nOne uses probably\n\n\t$.extend($.jgrid.defaults, {...});\n\nto set default settings of jqGrid instead of the usage the DEEP version of jQuery.extend (with true as the first parameter):\n\n\t$.extend(true, $.jgrid.defaults, {...});\n\nOne other possible reason:\n\nyou included some OLD version of language file (grid.locale-en.js for example) AFTER jquery.jqGrid.min.js. For example all language files of jqGrid 4.7.0 uses non-deep call of jQuery.extend.\n\n\nSome options of jqGrid could still work, but another one will be broken.");
...
ajaxGridOptions:{},direction:B,toppager:!1,headertitles:!1,scrollTimeout:40,maxItemsToJoin:32768,data:[],lastSelectedData:[],quickEmpty:"quickest",_index:{},iColByName:{},iPropByName:{},reservedColumnNames:["rn","cb","subgrid"],grouping:!1,groupingView:{groupField:[],groupOrder:[],groupText:[],groupColumnShow:[],groupSummary:[],showSummaryOnHide:!1,sortitems:[],sortnames:[],summary:[],summaryval:[],displayField:[],groupSummaryPos:[],formatDisplayField:[],_locgr:!1,commonIconClass:z("grouping.common"),
plusicon:z("grouping.plus"),minusicon:z("grouping.minus")},ignoreCase:!0,cmTemplate:{},idPrefix:"",iconSet:u,guiStyle:E,locale:y,multiSort:!1,treeIcons:{commonIconClass:z("treeGrid.common"),plusLtr:z("treeGrid.plusLtr"),plusRtl:z("treeGrid.plusRtl"),minus:z("treeGrid.minus"),leaf:z("treeGrid.leaf")},subGridOptions:{commonIconClass:z("subgrid.common"),plusicon:z("subgrid.plus"),minusicon:z("subgrid.minus")}},Ta,{navOptions:n(!0,{commonIconClass:z("nav.common"),editicon:z("nav.edit"),addicon:z("nav.add"),
delicon:z("nav.del"),searchicon:z("nav.search"),refreshicon:z("nav.refresh"),viewicon:z("nav.view"),saveicon:z("nav.save"),cancelicon:z("nav.cancel"),buttonicon:z("nav.newbutton")},v.nav||{}),actionsNavOptions:n(!0,{commonIconClass:z("actions.common"),editicon:z("actions.edit"),delicon:z("actions.del"),saveicon:z("actions.save"),cancelicon:z("actions.cancel")},v.actionsNav||{}),formEditing:n(!0,{commonIconClass:z("form.common"),prevIcon:z("form.prev"),nextIcon:z("form.next"),saveicon:[!0,"left",z("form.save")],
closeicon:[!0,"left",z("form.undo")]},v.edit||{}),searching:n(!0,{commonIconClass:z("search.common"),findDialogIcon:z("search.search"),resetDialogIcon:z("search.reset"),queryDialogIcon:z("search.query")},v.search||{}),formViewing:n(!0,{commonIconClass:z("form.common"),prevIcon:z("form.prev"),nextIcon:z("form.next"),closeicon:[!0,"left",z("form.cancel")]},v.view||{}),formDeleting:n(!0,{commonIconClass:z("form.common"),delicon:[!0,"left",z("form.del")],cancelicon:[!0,"left",z("form.cancel")]},v.del||
{})},b||{}),D=function(a){var b=v.getRes(k,a);return void 0!==b?b:w.call(h,"defaults."+a)};k.recordpos=k.recordpos||("rtl"===k.direction?"left":"right");k.subGridOptions.openicon="rtl"===k.direction?z("subgrid.openRtl"):z("subgrid.openLtr");k.autoResizing.widthOfVisiblePartOfSortIcon=void 0!==k.autoResizing.widthOfVisiblePartOfSortIcon?k.autoResizing.widthOfVisiblePartOfSortIcon:"fontAwesome"===k.iconSet?13:12;k.datatype=void 0!==k.datatype?k.datatype:void 0!==e||null==k.url?"local":null!=k.jsonReader&&
...
typeof e?e:e.name]=c;return b},Y=function(){var b={},c,d;this.p.rowIndexes=b;for(d=0;d<this.rows.length;d++)c=this.rows[d],a(c).hasClass("jqgrow")&&(b[c.id]=c.rowIndex)},C=function(){var b,c=k.colModel;b=k.cmNamesInputOrder;var d=k.additionalProperties,e=b.length,f,g,h,l;k.arrayReaderInfos={};f=k.arrayReaderInfos;for(l=0;l<e;l++)g=b[l],0>p(g,k.reservedColumnNames)&&!f.hasOwnProperty(g)&&(h=k.iColByName[g],void 0!==h?f[g]={name:c[h].name,index:h,order:l,type:0}:(h=k.iPropByName[g],void 0!==h?f[g]=
...
d&&0<d.length)for(a=0;a<d.length;a++)d[a]!==c&&t.call(b,d[a],!1,null);c&&t.call(b,c,!1,null)}e.scrollLeft=f;b.unbind(".selectionPreserver",g)};b.bind("jqGridGridComplete.selectionPreserver",g)}};d.grid=A;Q.call(d,"beforeInitGrid");k.iColByName=K(k.colModel);k.iPropByName=J(k.additionalProperties);var O=a("<div class='ui-jqgrid-view' role='grid' aria-multiselectable='"+!!k.multiselect+"'></div>"),T=v.msie,Ba=T&&8>v.msiever();k.direction=q(k.direction.toLowerCase());-1===p(k.direction,["ltr","rtl"])&&
(k.direction="ltr");ma=k.direction;a(O).insertBefore(d);h.removeClass("scroll").appendTo(O);var W=a("<div class='"+F("gBox","ui-jqgrid")+"'></div>");a(W).attr({id:k.gBoxId,dir:ma}).insertBefore(O);a(O).attr("id",k.gViewId).appendTo(W);a("<div class='"+F("overlay","jqgrid-overlay")+"' id='lui_"+k.id+"'></div>").insertBefore(O);a("<div class='"+F("loading","loading")+"' id='load_"+k.id+"'>"+D("loadtext")+"</div>").insertBefore(O);Ba&&h.attr({cellspacing:"0"});h.attr({role:"presentation","aria-labelledby":"gbox_"+
d.id});var L=function(){var a=k.remapColumns,b=k.colModel,c=b.length,d=[],e,f;for(e=0;e<c;e++)f=b[e].name,0>p(f,k.reservedColumnNames)&&d.push(f);if(null!=a)for(b=d.slice(),e=0;e<a.length;e++)d[e]=b[a[e]];k.cmNamesInputOrder=d},X=function(a,b,c,e,f,g){var h=k.colModel[a],l=c,n=h.classes,p=h.align?"text-align:"+h.align+";":"",r,q=function(a){return"string"===typeof a?a.replace(/\'/g,"&#39;"):a},t=" aria-describedby='"+k.id+"_"+h.name+"'";!0===h.hidden&&(p+="display:none;");if(0===b)p+="width: "+A.headers[a].width+
...
18*(b+1)+"px;'><div class='"+pa(k.treeIcons.commonIconClass,e?(null!=h&&""!==h?h:k.treeIcons.leaf)+" tree-leaf":g?k.treeIcons.minus+" tree-minus":k.treeIcons.plus+" tree-plus","treeclick")+"' style='"+(!0===k.ExpandColClick?"cursor:pointer;":"")+("rtl"===k.direction?"margin-right:":"margin-left:")+18*b+"px;'></div></div><span class='cell-wrapper"+(e?"leaf":"")+"'"+(k.ExpandColClick?" style='cursor:pointer;'":"")+">"+c+"</span>");return c},M=function(b,c){var d=A.bDiv,e=null!=A.fbDiv?A.fbDiv.children(".ui-jqgrid-btable")[0]:
...
!0===c&&k.treeGrid&&(V(k.data),V(k.lastSelectedData),k._index={});k.rowIndexes={};k.iRow=-1;k.iCol=-1},ya=function(){var a=k.data,b=a.length,c,e,f,g,h,p,r,q=k.localReader,t=k.additionalProperties,u=q.cell,w,v,x,A=k.arrayReaderInfos;if("local"!==k.datatype||!0!==q.repeatitems){if(k.treeGrid)for(c=0;c<b;c++)$a(a[c])}else for(g=!1===k.keyName?m(q.id)?q.id.call(d,a):q.id:k.keyName,isNaN(g)?m(g)||null==k.arrayReaderInfos[g]||(h=k.arrayReaderInfos[g].order):h=Number(g),c=0;c<b;c++){e=a[c];f=u?oa(e,u)||
e:e;v=l(f);r={};for(w in A)A.hasOwnProperty(w)&&(x=A[w],p=oa(f,v?x.order:x.name),1===x.type&&(x=t[x.index],null!=x&&m(x.convert)&&(p=x.convert(p,f))),void 0!==p&&(r[w]=p));void 0!==r[g]?e=void 0!==r[g]?r[g]:Ia():(e=oa(e,l(e)?h:g),void 0===e&&(e=oa(f,l(f)?h:g)),void 0===e&&(e=Ia()));e=String(e);r[q.id]=e;k.treeGrid&&$a(r);n(a[c],r)}},mb=function(){var a=k.data.length,b,c,d;b=!1===k.keyName||k.loadonce?k.localReader.id:k.keyName;k._index={};for(c=0;c<a;c++)d=oa(k.data[c],b),void 0===d&&(d=String(c+
...
f.cellBuilder=k.autoencode?n:p:"string"===typeof f.formatter&&null!=a.fn.fmatter&&m(a.fn.fmatter.getCellBuilder)?f.cellBuilder=a.fn.fmatter.getCellBuilder.call(d,f.formatter,l,c||"add"):m(f.getCellBuilder)&&(f.cellBuilder=f.getCellBuilder.call(d,l,c||"add")))},Fa=function(b,d,e,f){var g=a(this),h=new Date,n=k.datatype,p="local"!==n&&k.loadonce||"xmlstring"===n||"jsonstring"===n,r=("xmlstring"===n||"xml"===n)&&a.isXMLDoc(b),q=k.localReader,t=oa;if(b&&("xml"!==n||r)){-1!==k.treeANode||k.scroll?d=1<
d?d:1:(A.emptyRows.call(this,!1,!0),d=1);p&&(V(k.data),V(k.lastSelectedData),k._index={},k.grouping&&null!=k.groupingView&&(k.groupingView.groups=[],k.groupingView._locgr=!1),k.localReader.id="_id_");k.reccount=0;switch(n){case "xml":case "xmlstring":q=k.xmlReader;t=v.getXmlData;break;case "json":case "jsonp":case "jsonstring":q=k.jsonReader}var u,w,x,D,y,E={},I,G=k.colModel,z=G.length,B,F,da,K,J,O=k.arrayReaderInfos,ia={},C=function(a){return function(b){b=b.getAttribute(a);return null!==b?b:void 0}},
...
(T[a]=C(b.substring(1,b.length-1))))},ha=function(a){var b=a.name,c=r?a.xmlmap||b:"local"===n&&!k.dataTypeOrg||"json"===n||"jsonp"===n?a.jsonmap||b:b;!1!==k.keyName&&!0===a.key&&(k.keyName=b);if("string"===typeof c||m(c))T[b]=c;m(c)||H(b,c)};for(u=0;u<z;u++)ha(G[u]);z=Ja.length;for(u=0;u<z;u++)F=Ja[u],"object"===typeof F&&null!=F?ha(F):H(F,F);D=!1===k.keyName?m(q.id)?q.id.call(this,b):q.id:k.keyName;isNaN(D)?m(D)||(O[D]&&(y=O[D].order),r&&("string"===typeof D&&/^\[\w+\]$/.test(D)?D=C(D.substring(1,
D.length-1)):"string"===typeof D&&/^\w+$/.test(D)&&(D=Pa(D)))):y=Number(D);x=t(b,q.root,!0);if(q.row)if(1===x.length&&"string"===typeof q.row&&/^\w+$/.test(q.row)){z=[];da=x[0].childNodes;K=da.length;for(F=0;F<K;F++)J=da[F],1===J.nodeType&&J.nodeName===q.row&&z.push(J);x=z}else x=t(x,q.row,!0);null==x&&l(b)&&(x=b);x||(x=[]);b=x.length;0<b&&0>=k.page&&(k.page=1);ha=parseInt(k.rowNum,10);f&&(ha*=f+1);var G=[],Za=[],L,z=[];for(u=0;u<b;u++){L=x[u];w=q.repeatitems&&q.cell?t(L,q.cell,!0)||L:L;I=q.repeatitems&&
(r||l(w));E={};ia={};if(r&&!I&&null!=w)for(da=w.childNodes,K=da.length,F=0;F<K;F++)J=da[F],1===J.nodeType&&(ia[J.nodeName]=J);for(B in O)O.hasOwnProperty(B)&&(F=O[B],I?(da=w[F.order],r&&null!=da&&(da=da.textContent||da.text)):da=null!=T[B]&&"string"!==typeof T[B]?T[B](w):t(w,"string"===typeof T[B]?T[B]:F.name),1===F.type&&(F=Ja[F.index],null!=F&&m(F.convert)&&(da=F.convert(da,w))),void 0!==da&&(E[B]=da));void 0!==E[D]?L=void 0!==E[D]?E[D]:Ia():(L=t(L,l(L)?y:D),void 0===L&&(L=t(w,l(w)?y:D)),void 0===
L&&(L=Ia()));L=String(L);I=k.idPrefix+L;k.treeGrid&&$a(E);if(u<ha)Za.push(I),G.push(w),z.push(E);else if(!p)break;if(p||!0===k.treeGrid)E._id_=L,k.data.push(E),k._index[E._id_]=k.data.length-1}if(!p||!k.forceClientSorting||!0===k.treeGrid){d=v.parseDataToHtml.call(this,b,Za,z,G,d,f,p);ab(!0);f=-1<k.treeANode?k.treeANode:0;q=a(this.tBodies[0]);!0===k.treeGrid&&0<f?a(this.rows[f]).after(d.join("")):k.scroll?q.append(d.join("")):(null==this.firstElementChild||void 0!==document.documentMode&&9>=document.documentMode?
q.html(q.html()+d.join("")):this.firstElementChild.innerHTML+=d.join(""),this.grid.cols=this.rows[0].cells);k.grouping&&Y.call(this);if(!0===k.subGrid)try{c.addSubGrid.call(g,k.iColByName.subgrid)}catch(S){}if(!1===k.gridview||m(k.afterInsertRow))for(u=0;u<Math.min(b,ha);u++)Q.call(this,"afterInsertRow",Za[u],z[u],G[u]);k.totaltime=new Date-h;0<u&&0===k.records&&(k.records=b);V(d);if(!0===k.treeGrid)try{c.setTreeNode.call(g,f+1,u+f+1)}catch(S){}k.reccount=Math.min(b,ha);k.treeANode=-1;k.userDataOnFooter&&
c.footerData.call(g,"set",k.userData,!0);p&&(k.records=b,k.lastpage=Math.ceil(b/ha));e||this.updatepager(!1,!0);ba.call(this)}}},db=function(){function b(a){var c=0,d,e,f,g,h,l,p;if(null!=a.groups){(e=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase())&&z.orBegin();for(d=0;d<a.groups.length;d++){0<c&&e&&z.or();try{b(a.groups[d])}catch(q){x(q)}c++}e&&z.orEnd()}if(null!=a.rules)try{(f=a.rules.length&&"OR"===a.groupOp.toString().toUpperCase())&&z.orBegin();for(d=0;d<a.rules.length;d++)h=a.rules[d],
g=a.groupOp.toString().toUpperCase(),I[h.op]&&h.field?(0<c&&g&&"OR"===g&&(z=z.or()),p=n[h.field],l=p.reader,z=I[h.op](z,g)(m(l)?'jQuery.jgrid.getAccessor(this,jQuery("'+k.idSel+'")[0].p.colModel['+p.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+l+"')",h.data,n[h.field])):null!=k.customSortOperations&&null!=k.customSortOperations[h.op]&&m(k.customSortOperations[h.op].filter)&&(z=z.custom(h.op,h.field,h.data)),c++;f&&z.orEnd()}catch(q){x(q)}}var d=a(this),e=k.multiSort?[]:"",f={},g=!1,n={},p=
[],q=[],t=w.call(h,"formatter.date.srcformat"),u=w.call(h,"formatter.date.newformat");if(!l(k.data))return{};k.multiSort&&ub(e,f);var A=k.grouping?k.groupingView:!1,D,y,E=function(a,b,c){var d=a.index||a.name,f=a.sorttype||"text";n[a.name]={reader:k.dataTypeOrg?a.name:a.jsonmap||a.name,iCol:b,stype:f,srcfmt:"",newfmt:"",sfunc:a.sortfunc||null,isAddProp:!0===c?!0:!1};if("date"===f||"datetime"===f)a.formatter&&"string"===typeof a.formatter&&"date"===a.formatter?(b=a.formatoptions&&a.formatoptions.srcformat?
a.formatoptions.srcformat:t,c=a.formatoptions&&a.formatoptions.newformat?a.formatoptions.newformat:u):b=c=a.datefmt||"Y-m-d",n[a.name].srcfmt=b,n[a.name].newfmt=c;if(k.grouping)for(y=0,D=A.groupField.length;y<D;y++)a.name===A.groupField[y]&&(p[y]=n[d],q[y]=d);k.multiSort||g||a.index!==k.sortname&&a.name!==k.sortname||(e=a.name,g=!0)};r(k.colModel,function(a){E(this,a)});r(k.additionalProperties,function(a){E("string"===typeof this?{name:this}:this,a,!0)});if(k.treeGrid)return c.SortTree.call(d,e,
...
a.andNot().startsWith},en:function(a,b){return"OR"===b?a.orNot().endsWith:a.andNot().endsWith},ew:function(a){return a.endsWith},ni:function(a,b){return"OR"===b?a.orNot().equals:a.andNot().equals},"in":function(a){return a.equals},nu:function(a){return a.isNull},nn:function(a,b){return"OR"===b?a.orNot().isNull:a.andNot().isNull}},z=v.from.call(this,k.data);k.ignoreCase&&(z=z.ignoreCase());if(!0===k.search){var G=k.postData.filters;if(G)"string"===typeof G&&(G=v.parse(G)),b(G);else try{P=n[k.postData.searchField],
z=I[k.postData.searchOper](z)(m(P.reader)?'jQuery.jgrid.getAccessor(this,jQuery("'+k.idSel+'")[0].p.colModel['+P.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+P.reader+"')",k.postData.searchString,n[k.postData.searchField])}catch(F){}}if(k.grouping)for(y=0;y<D;y++)z.orderBy(q[y],A.groupOrder[y],p[y].stype,p[y].srcfmt);k.multiSort?r(e,function(){z.orderBy(this,f[this],n[this].stype,n[this].srcfmt,n[this].sfunc)}):e&&k.sortorder&&g&&z.orderBy(k.sortname,"DESC"===k.sortorder.toUpperCase()?"d":
"a",n[e].stype,n[e].srcfmt,n[e].sfunc);k.lastSelectedData=z.select();var G=parseInt(k.rowNum,10),B=k.lastSelectedData.length,da=parseInt(k.page,10),K=Math.ceil(B/G),J={};if(k.grouping&&k.groupingView._locgr){k.groupingView.groups=[];var Y,O,N;if(k.footerrow&&k.userDataOnFooter){for(O in k.userData)k.userData.hasOwnProperty(O)&&(k.userData[O]=0);N=!0}for(Y=0;Y<B;Y++){if(N)for(O in k.userData)k.userData.hasOwnProperty(O)&&(k.userData[O]+=parseFloat(k.lastSelectedData[Y][O]||0));c.groupingPrepare.call(d,
k.lastSelectedData[Y],Y,G)}}n=z=null;d=k.localReader;J[d.total]=K;J[d.page]=da;J[d.records]=B;J[d.root]=k.lastSelectedData.slice((da-1)*G,da*G);J[d.userdata]=k.userData;return J},eb=function(b){var c=b.outerWidth();0>=c&&(c=a(this).closest(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px",a(document.body).append("<div id='testpg' class='"+F("gBox","ui-jqgrid")+"' style='font-size:"+c+";visibility:hidden;margin:0;padding:0;' ></div>"),a(b).clone().appendTo("#testpg"),c=a("#testpg>.ui-pg-table").width(),
a("#testpg").remove());0<c&&b.parent().width(c);return c},da=function(b,c){var d=this,e=a(d),f=d.grid,g,l,m,n,p,q,r=k.pager||"",t=k.pager?"_"+k.pager.substr(1):"";g=f.bDiv;var u=a.fmatter?a.fmatter.NumberFormat:null,x=k.toppager?"_"+k.toppager.substr(1):"",A=F("states.hover"),y=F("states.disabled");l=parseInt(k.page,10)-1;0>l&&(l=0);l*=parseInt(k.rowNum,10);n=l+k.reccount;if(k.scroll){q=a(Ha(21,g)[0].rows).slice(1);l=n-q.length;k.reccount=q.length;if(q=q.outerHeight()||f.prevRowHeight)m=l*q,p=v.fixMaxHeightOfDiv.call(d,
...
r+"' style='text-align:right;'></td></tr></tbody></table></div>").attr("dir","ltr");n="#"+H(n);if(0<k.rowList.length){m="<td dir='"+ma+"'>";p=D("pgrecs");m+="<select class='"+F("pagerSelect","ui-pg-selbox")+"' "+(p?"title='"+p+"'":"")+">";for(p=0;p<k.rowList.length;p++)q=k.rowList[p].toString().split(":"),1===q.length&&(q[1]=q[0]),m+="<option value='"+q[0]+"'"+(N(k.rowNum,0)===N(q[0],0)?" selected='selected'":"")+">"+q[1]+"</option>";m+="</select></td>"}"rtl"===ma&&(l+=m);!0===k.pginput&&(h="<td dir='"+
ma+"'>"+v.format(D("pgtext")||"","<input class='"+F("pagerInput","ui-pg-input")+"' type='text' size='2' maxlength='7' value='0'/>","<span id='sp_1_"+b+"'>0</span>")+"</td>");b="#"+H(b);if(!0===k.pgbuttons){q=["first","prev","next","last"];var u=F("pagerButton","ui-pg-button");r=function(a){var b=D("pg"+a);return"<td role='button' tabindex='0' id='"+a+c+"' class='"+u+"' "+(b?"title='"+b+"'":"")+"><span class='"+z("pager."+a)+"'></span></td>"};"rtl"===ma&&q.reverse();for(p=0;p<q.length;p++)l+=r(q[p]),
1===p&&(l+=""!==h?g+h+g:"")}else""!==h&&(l+=h);"ltr"===ma&&(l+=m);l+="</tr></tbody></table>";!0===k.viewrecords&&a("td"+b+"_"+k.recordpos,n).append("<span dir='"+ma+"' style='text-align:"+k.recordpos+"' class='ui-paging-info'></span>");var w=a("td"+b+"_"+k.pagerpos,n);w.append(l);g=eb.call(this,w.children(".ui-pg-table"));k._nvtd=[];k._nvtd[0]=g?Math.floor((k.width-g)/2):Math.floor(k.width/3);k._nvtd[1]=0;l=null;a(".ui-pg-selbox",n).bind("change",function(){var b=N(this.value,10),c=Math.round(k.rowNum*
...
var a=N(k.page,1),b=a,e=this.id,g=N(k.lastpage,1),h=!1,l=!0,m=!0,n=!0,p=!0;0===g||1===g?(1>=a&&(m=l=!1),p=n=!1):1<g&&1<=a?1===a?m=l=!1:a===g&&(p=n=!1):1<g&&0===a&&(p=n=!1,a=g-1);this.id==="first"+c&&l&&(e="first",b=1,h=!0);this.id==="prev"+c&&m&&(e="prev",b=a-1,h=!0);this.id==="next"+c&&n&&(e="next",b=a+1,h=!0);this.id==="last"+c&&p&&(e="last",b=g,h=!0);if(!t(e,b,N(k.rowNum,10)))return!1;k.page=b;h&&ha.call(d);return!1}));!0===k.pginput&&a("input.ui-pg-input",n).bind("keypress.jqGrid",function(b){b=
...
l.autoResizing.compact||k.autoResizing.compact)&&k.columnsToReResizing.push(d);b=b.substring(5+k.id.length+1);k.sortname=l.index||b}Q.call(this,"onSortCol",k.sortname,d,k.sortorder)?("local"===k.datatype?k.deselectAfterSort&&!k.multiPageSelection&&c.resetSelection.call(a(this)):k.multiPageSelection||(k.selrow=null,k.multiselect&&(jb.call(this,!1),V(k.selarrrow))),V(k.savedRow),k.scroll&&(m=h.bDiv.scrollLeft,A.emptyRows.call(this,!0,!1),h.hDiv.scrollLeft=m),k.subGrid&&"local"===k.datatype&&a("td.sgexpanded",
"#"+H(k.id)).each(function(){a(this).trigger("click")}),ha.call(this),k.lastsort=d,k.sortname!==b&&d&&(k.lastsort=d)):k.lastsort=d}},Fb=function(){var a=0,b=v.cell_width?0:N(k.cellLayout,0),c=0,d,e=N(k.scrollOffset,0),f,g=!1,h,l=0,m,n=v.isCellClassHidden;r(k.colModel,function(){void 0===this.hidden&&(this.hidden=!1);if(k.grouping&&k.autowidth){var d=p(this.name,k.groupingView.groupField);0<=d&&k.groupingView.groupColumnShow.length>d&&(this.hidden=!k.groupingView.groupColumnShow[d])}this.widthOrg=
f=N(this.width,0);!1!==this.hidden||n(this.classes)||(a+=f+b,this.fixed?l+=f+b:c++)});isNaN(k.width)&&(k.width=a+(!1!==k.shrinkToFit||isNaN(k.height)?0:e));A.width=k.width;k.tblwidth=a;!1===k.shrinkToFit&&!0===k.forceFit&&(k.forceFit=!1);!0===k.shrinkToFit&&0<c&&(h=A.width-b*c-l,isNaN(k.height)||(h-=e,g=!0),a=0,r(k.colModel,function(e){!1!==this.hidden||n(this.classes)||this.fixed||(this.width=f=Math.round(h*this.width/(k.tblwidth-b*c-l)),a+=f,d=e)}),m=0,g?A.width-l-(a+b*c)!==e&&(m=A.width-l-(a+b*
c)-e):g||1===Math.abs(A.width-l-(a+b*c))||(m=A.width-l-(a+b*c)),k.colModel[d].width+=m,k.tblwidth=a+m+b*c+l,k.tblwidth>k.width&&(k.colModel[d].width-=k.tblwidth-parseInt(k.width,10),k.tblwidth=k.width))},Gb=function(a){var b=a,c;for(c=a+1;c<k.colModel.length;c++)if(!0!==k.colModel[c].hidden){b=c;break}return b-a},fb;-1===p(k.multikey,["shiftKey","altKey","ctrlKey"])&&(k.multikey=!1);k.keyName=!1;k.sortorder=k.sortorder.toLowerCase();v.cell_width=v.cellWidth();var kb=v.cmTemplate,Z,ma;for(Z=0;Z<k.colModel.length;Z++)P=
...
cell:"cell"}},k.localReader);k.scroll&&(k.pgbuttons=!1,k.pginput=!1,k.rowList=[]);if(!0===k.treeGrid){try{c.setTreeGrid.call(h)}catch(tb){}"local"!==k.datatype&&(k.localReader={id:"_id_"});k.iPropByName=J(k.additionalProperties)}L();C();k.data.length&&(ya.call(d),mb());if(!0===k.shrinkToFit&&!0===k.forceFit)for(Z=k.colModel.length-1;0<=Z;Z--)if(!0!==k.colModel[Z].hidden){k.colModel[Z].resizable=!1;break}var fa,ea,aa,ga,P,ua,ka,na,ra=[],Da=[],la=[],ja="<thead><tr class='ui-jqgrid-labels' role='row'>",
Aa,va="<tbody><tr>",sa=F("states.hover"),ta=F("states.disabled");if(k.multiSort){var ra=k.sortname.split(","),wa;for(wa=0;wa<ra.length;wa++)la=q(ra[wa]).split(" "),ra[wa]=q(la[0]),Da[wa]=la[1]?q(la[1]):k.sortorder||"asc"}for(Z=0;Z<k.colNames.length;Z++){P=k.colModel[Z];ua=k.headertitles||P.headerTitle?" title='"+ib("string"===typeof P.headerTitle?P.headerTitle:k.colNames[Z])+"'":"";ja+="<th id='"+k.id+"_"+P.name+"' class='"+F("colHeaders","ui-th-column ui-th-"+ma+" "+(P.labelClasses||""))+"'"+ua+
...
"asc");k.multiSort&&(la=p(fa,ra),-1!==la&&(P.lso=Da[la]))}var ja=ja+"</tr></thead>",va=va+"</tr></tbody>",xa=a("<table class='"+F("hTable","ui-jqgrid-htable")+"' style='width:1px' role='presentation' aria-labelledby='gbox_"+k.id+"'"+(Ba?" cellspacing='0'":"")+">"+ja+va+"</table>");a(xa[0].tHead).children("tr").children("th").hover(function(){a(this).addClass(sa)},function(){a(this).removeClass(sa)});k.multiselect&&a(k.cb,xa).bind("click",function(){var b=F("states.select"),c,e=[],f=k.iColByName.cb,
g=function(c,d){a(c)[d?"addClass":"removeClass"](b).attr(d?{"aria-selected":"true",tabindex:"0"}:{"aria-selected":"false",tabindex:"-1"});if(void 0!==f)a(c.cells[f]).children("input.cbox")[k.propOrAttr]("checked",d)},h=A.fbRows,l=ta+" ui-subgrid jqgroup jqfoot jqgfirstrow",m,n=k._index;V(k.selarrrow);if(this.checked){if(c=!0,k.selrow=1<d.rows.length?d.rows[d.rows.length-1].id:null,k.multiPageSelection&&("local"===k.datatype||k.treeGrid)&&null!=k.data&&0<k.data.length&&null!=n)for(m in n)n.hasOwnProperty(m)&&
k.selarrrow.push(k.idPrefix+m)}else c=!1,k.selrow=null;a(d.rows).each(function(a){ca(this,l)||(g(this,c),(c?k.selarrrow:e).push(this.id),h&&g(h[a],c))});Q.call(d,"onSelectAll",c?k.selarrrow:e,c)});if(!0===k.autowidth){var Ka=Math.floor(a(W).innerWidth());k.width=0<Ka?Ka:"nw"}isNaN(k.width)?isNaN(parseFloat(k.width))||(k.width=parseFloat(k.width)):k.width=Number(k.width);k.widthOrg=k.width;Fb();a(W).css("width",A.width+"px").append("<div class='"+F("resizer","ui-jqgrid-resize-mark")+"' id='"+k.rsId+
...
A.width+"px");var Ua="";k.footerrow&&(Ua+="<table role='presentation' style='width:"+k.tblwidth+"px' class='ui-jqgrid-ftable'"+(Ba?" cellspacing='0'":"")+"><tbody><tr role='row' class='"+F("rowFooter","footrow footrow-"+ma)+"'>");var za="<tr class='jqgfirstrow' role='row' style='height:auto'>";k.disableClick=!1;a("th",xa[0].tHead.rows[0]).each(function(b){var c=k.colModel[b],d=c.name,e=a(this),f=e.children("div"),g=f.children("span.s-ico"),h=k.showOneSortIcon;ea=c.width;void 0===c.resizable&&(c.resizable=
!0);c.resizable?(aa=document.createElement("span"),a(aa).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+ma).bind("selectstart",function(){return!1}),e.addClass(k.resizeclass)):aa="";e.css("width",ea+"px").prepend(aa);aa=null;var l="";!0===c.hidden&&(e.css("display","none"),l="display:none;");za+="<td role='gridcell' "+(c.classes?"class='"+c.classes+"' ":"")+"style='height:0;width:"+ea+"px;"+l+"'></td>";A.headers[b]={width:ea,el:this};ga=c.sortable;"boolean"!==typeof ga&&(ga=c.sortable=
...
("rtl"===ma?"-rtl":"")+"'></div>"),Ea=F("bottom");A.hDiv=document.createElement("div");a(A.hDiv).css({width:A.width+"px"}).addClass(F("hDiv","ui-jqgrid-hdiv")).append(bb).scroll(function(){var b=a(this).next(".ui-jqgrid-bdiv")[0];b&&(b.scrollLeft=this.scrollLeft)});a(bb).append(xa);xa=null;Ca&&a(A.hDiv).hide();k.rowNum=parseInt(k.rowNum,10);if(isNaN(k.rowNum)||0>=k.rowNum)k.rowNum=k.maxRowNum;if(k.pager){var Qa,Va;"string"===typeof k.pager&&"#"!==k.pager.substr(0,1)?(Va=k.pager,Qa=a("#"+H(k.pager))):
!0===k.pager?(Va=Ia(),Qa=a("<div id='"+Va+"'></div>"),Qa.appendTo("body"),k.pager="#"+H(Va)):(Qa=a(k.pager),Va=Qa.attr("id"));0<Qa.length?(Qa.css({width:A.width+"px"}).addClass(F("pager","ui-jqgrid-pager "+Ea)).appendTo(W),Ca&&Qa.hide(),vb.call(d,Va,""),k.pager="#"+H(Va)):k.pager=""}!1===k.cellEdit&&!0===k.hoverrows&&h.bind("mouseover",function(b){na=a(b.target).closest("tr.jqgrow");"ui-subgrid"!==a(na).attr("class")&&a(na).addClass(sa)}).bind("mouseout",function(b){na=a(b.target).closest("tr.jqgrow");
a(na).removeClass(sa)});var qa,La,Sa,Ma=function(b){var c,d;do if(c=a(b).closest("td"),0<c.length){b=c.parent();d=b.parent().parent();if(b.is(".jqgrow")&&(d[0]===this||d.is("table.ui-jqgrid-btable")&&(d[0].id||"").replace("_frozen","")===this.id))break;b=c.parent()}while(0<c.length);return c};h.before(A.hDiv).click(function(b){var e=F("states.select"),f=b.target,g=Ma.call(this,f),l=g.parent();if(0!==l.length&&!ca(l,ta)){qa=l[0].id;var m=a(f).hasClass("cbox"),n=Q.call(d,"beforeSelectRow",qa,b),p=v.detectRowEditing.call(d,
qa),p=null!=p&&"cellEditing"!==p.mode;if("A"!==f.tagName&&(!p||m))if(La=g[0].cellIndex,Sa=g.html(),Q.call(d,"onCellSelect",qa,La,Sa,b),!0===k.cellEdit)if(k.multiselect&&m&&n)t.call(h,qa,!0,b);else{qa=l[0].rowIndex;try{c.editCell.call(h,qa,La,!0)}catch(q){}}else if(n)if(k.multikey)b[k.multikey]?t.call(h,qa,!0,b):k.multiselect&&m&&(m=a("#jqg_"+H(k.id)+"_"+qa).is(":checked"),a("#jqg_"+H(k.id)+"_"+qa)[I]("checked",!m));else if(k.multiselect&&k.multiboxonly){if(!m){var r=k.frozenColumns?k.id+"_frozen":
"";a(k.selarrrow).each(function(b,d){var f=c.getGridRowById.call(h,d);f&&a(f).removeClass(e);a("#jqg_"+H(k.id)+"_"+H(d))[k.propOrAttr]("checked",!1);r&&(a("#"+H(d),"#"+H(r)).removeClass(e),a("#jqg_"+H(k.id)+"_"+H(d),"#"+H(r))[k.propOrAttr]("checked",!1))});V(k.selarrrow)}t.call(h,qa,!0,b)}else f=k.selrow,t.call(h,qa,!0,b),"toggle"!==k.singleSelectClickMode||k.multiselect||f!==qa||(this.grid.fbRows&&(l=l.add(this.grid.fbRows[qa])),l.removeClass(e).attr({"aria-selected":"false",tabindex:"-1"}),k.selrow=
...
(k.selrow=null,k.multiselect&&(V(k.selarrrow),jb.call(this,!1)),V(k.savedRow));k.iRow=-1;k.iCol=-1;k.scroll&&A.emptyRows.call(this,!0,!1);if(d.page){var g=parseInt(d.page,10);g>k.lastpage&&(g=k.lastpage);1>g&&(g=1);k.page=g;e.bDiv.scrollTop=e.prevRowHeight?(g-1)*e.prevRowHeight*k.rowNum:0}e.prevRowHeight&&k.scroll&&void 0===d.page?(delete k.lastpage,e.populateVisible.call(this)):e.populate.call(this);!0===k._inlinenav&&f.jqGrid("showAddEditButtons",!1);return!1}).dblclick(function(a){var b=Ma.call(this,
a.target),c=b.parent();if(0<b.length&&!Q.call(d,"ondblClickRow",c.attr("id"),c[0].rowIndex,b[0].cellIndex,a))return!1}).bind("contextmenu",function(a){var b=Ma.call(this,a.target),c=b.parent(),e=c.attr("id");if(0!==b.length&&(k.multiselect||t.call(h,e,!0,a),!Q.call(d,"onRightClickRow",e,c[0].rowIndex,b[0].cellIndex,a)))return!1});A.bDiv=document.createElement("div");T&&"auto"===String(k.height).toLowerCase()&&(k.height="100%");a(A.bDiv).append(a("<div style='position:relative;"+(Ba?"height:0.01%;":
"")+"'></div>").append("<div></div>").append(d)).addClass("ui-jqgrid-bdiv").css({height:k.height+(isNaN(k.height)?"":"px"),width:A.width+"px"}).scroll(A.scrollGrid);k.maxHeight&&a(A.bDiv).css("max-height",k.maxHeight+(isNaN(k.maxHeight)?"":"px"));h.css({width:"1px"});a.support.tbody||2===a(">tbody",d).length&&a(">tbody:gt(0)",d).remove();k.multikey&&a(A.bDiv).bind(v.msie?"selectstart":"mousedown",function(){return!1});Ca&&a(A.bDiv).hide();A.cDiv=document.createElement("div");var Na=z("gridMinimize.visible"),
Wa=z("gridMinimize.hidden"),Xa=D("showhide"),Ra=!0===k.hidegrid?a("<a role='link' class='"+F("titleButton","ui-jqgrid-titlebar-close")+"'"+(Xa?" title='"+Xa+"'":"")+"/>").hover(function(){Ra.addClass(sa)},function(){Ra.removeClass(sa)}).append("<span class='"+Na+"'></span>"):"";a(A.cDiv).append("<span class='ui-jqgrid-title'>"+k.caption+"</span>").append(Ra).addClass(F("gridTitle","ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===ma?"-rtl":"")));a(A.cDiv).insertBefore(A.hDiv);if(k.toolbar[0]){A.uDiv=
document.createElement("div");"top"===k.toolbar[1]?a(A.uDiv).insertBefore(A.hDiv):"bottom"===k.toolbar[1]&&a(A.uDiv).insertAfter(A.hDiv);var Ya=F("toolbarUpper","ui-userdata");"both"===k.toolbar[1]?(A.ubDiv=document.createElement("div"),a(A.uDiv).addClass(Ya).attr("id","t_"+k.id).insertBefore(A.hDiv),a(A.ubDiv).addClass(F("toolbarBottom","ui-userdata")).attr("id","tb_"+k.id).insertAfter(A.hDiv),Ca&&a(A.ubDiv).hide()):a(A.uDiv).width(A.width).addClass(Ya).attr("id","t_"+k.id);Ca&&a(A.uDiv).hide()}"string"===
typeof k.datatype&&(k.datatype=k.datatype.toLowerCase());k.toppager?(k.toppager=k.id+"_toppager",A.topDiv=a("<div id='"+k.toppager+"'></div>")[0],a(A.topDiv).addClass(F("pager","ui-jqgrid-toppager")).css({width:A.width+"px"}).insertBefore(A.hDiv),vb.call(d,k.toppager,"_t"),k.toppager="#"+H(k.toppager)):""!==k.pager||k.scroll||(k.rowNum=k.maxRowNum);k.footerrow&&(A.sDiv=a("<div class='ui-jqgrid-sdiv'></div>")[0],bb=a("<div class='ui-jqgrid-hbox"+("rtl"===ma?"-rtl":"")+"'></div>"),a(A.sDiv).append(bb).width(A.width).insertAfter(A.hDiv),
a(bb).append(Ua),A.footers=a(".ui-jqgrid-ftable",A.sDiv)[0].rows[0].cells,k.rownumbers&&(A.footers[0].className=F("rowNum","jqgrid-rownum")),Ca&&a(A.sDiv).hide());bb=null;if(k.caption){var cb=k.datatype;!0===k.hidegrid&&(a(".ui-jqgrid-titlebar-close",A.cDiv).click(function(b){var c=".ui-jqgrid-bdiv,.ui-jqgrid-hdiv,.ui-jqgrid-pager,.ui-jqgrid-sdiv",e=this;!0===k.toolbar[0]&&("both"===k.toolbar[1]&&(c+=",#"+H(a(A.ubDiv).attr("id"))),c+=",#"+H(a(A.uDiv).attr("id")));var f=a(c,k.gView).length;k.toppager&&
(c+=","+k.toppager);"visible"===k.gridstate?a(c,k.gBox).slideUp("fast",function(){f--;0===f&&(a("span",e).removeClass(Na).addClass(Wa),k.gridstate="hidden",a(k.gBox).hasClass("ui-resizable")&&a(".ui-resizable-handle",k.gBox).hide(),a(A.cDiv).addClass(Ea),Ca||Q.call(d,"onHeaderClick",k.gridstate,b))}):"hidden"===k.gridstate&&(a(A.cDiv).removeClass(Ea),a(c,k.gBox).slideDown("fast",function(){f--;0===f&&(a("span",e).removeClass(Wa).addClass(Na),Ca&&(k.datatype=cb,ha.call(d),Ca=!1),k.gridstate="visible",
a(k.gBox).hasClass("ui-resizable")&&a(".ui-resizable-handle",k.gBox).show(),Ca||Q.call(d,"onHeaderClick",k.gridstate,b))}));return!1}),Ca&&(k.datatype="local",a(".ui-jqgrid-titlebar-close",A.cDiv).trigger("click")))}else a(A.cDiv).hide(),a(A.cDiv).nextAll("div:visible").first().addClass("ui-corner-top");a(A.hDiv).after(A.bDiv);A.eDiv=a("<div class='"+F("gridError","ui-jqgrid-errorbar ui-jqgrid-errorbar-"+ma)+"' style='display:none;'><span class='ui-jqgrid-error'></span></div>")[0];a(A.hDiv).after(A.eDiv);
...
c.clientHeight,e=c.scrollTop,f=a(b).position().top,g=b.clientHeight;f+g>=d+e?c.scrollTop=f-(d+e)+g+e:f<d+e&&f<e&&(c.scrollTop=f)}var f=a(this),g=this.p,h,m,l,n=C.getGuiStyles;l=C.getGridRowById;var p=n.call(f,"states.select"),q=n.call(f,"states.disabled"),r=this.grid.fbRows,n=function(b,c){var d=c?"addClass":"removeClass",e=g.iColByName.cb,f=c?{"aria-selected":"true",tabindex:"0"}:{"aria-selected":"false",tabindex:"-1"},h=function(b){a(b)[d](p).attr(f);if(void 0!==e)a(b.cells[e]).children("input.cbox")[g.propOrAttr]("checked",
...
g.selarrrow.splice(l,1),l=g.selarrrow[0],g.selrow=void 0===l?null:l),"ui-subgrid"!==h.className&&n(h,f),c&&Q.call(this,"onSelectRow",h.id,f,e)):"ui-subgrid"!==h.className&&(g.selrow!==h.id?(null!==g.selrow&&(f=l.call(f,g.selrow))&&n(f,!1),n(h,!0),f=!0):f=!1,g.selrow=h.id,c&&Q.call(this,"onSelectRow",h.id,f,e))))})},resetSelection:function(b){return this.each(function(){var c=a(this),e=this.p,d=C.getGuiStyles,f=C.getGridRowById,g=d.call(c,"states.select"),h="edit-cell "+g,d="selected-row "+d.call(c,
...
typeof b&&(c=b,b=void 0);c=c||{};this.each(function(){var f=this.p,g=!1,h,m=2,l=0,n=this.rows,p,q,r,t,w;if(void 0===b)g=!0,d=[],m=n.length;else if(h=C.getGridRowById.call(a(this),b),!h)return e;for(;l<m;){g&&(h=n[l]);if(a(h).hasClass("jqgrow")){q=a("td[role=gridcell]",h);for(p=0;p<q.length;p++)if(r=f.colModel[p],t=r.name,!("cb"===t||"subgrid"===t||"rn"===t||"actions"===r.formatter||c.skipHidden&&r.hidden))if(w=q[p],!0===f.treeGrid&&t===f.ExpandColumn)e[t]=Ea(a("span",w).first().html());else try{e[t]=
a.unformat.call(this,w,{rowId:h.id,colModel:r},p)}catch(x){e[t]=Ea(a(w).html())}!c.includeId||!1!==f.keyName&&null!=e[f.keyName]||(e[f.prmNames.id]=Oa(f.idPrefix,h.id));g&&(d.push(e),e={})}l++}});return d||e},delRowData:function(b){var c=!1,e,d,f;this.each(function(){var g=this.p;e=C.getGridRowById.call(a(this),b);if(!e)return!1;g.subGrid&&(f=a(e).next(),f.hasClass("ui-subgrid")&&f.remove());a(e).remove();g.records--;g.reccount--;this.updatepager(!0,!1);c=!0;g.multiselect&&(d=a.inArray(b,g.selarrrow),
...
h.groupHeader;(p=p&&("object"===typeof p||a.isFunction(p)))&&C.destroyGroupHeader.call(d,!1);a(h.colModel).each(function(d){if(-1!==a.inArray(this.name,b)&&this.hidden===n){if(!0===h.frozenColumns&&!0===this.frozen)return!0;a("tr[role=row]",f.hDiv).each(function(){a(this.cells[d]).css("display",c)});a(e.rows).each(function(){var b=this.cells[d];(!a(this).hasClass("jqgroup")||null!=b&&1===b.colSpan)&&a(b).css("display",c)});h.footerrow&&a("tr.footrow td:eq("+d+")",f.sDiv).css("display",c);l=parseInt(this.width,
10);h.tblwidth="none"===c?h.tblwidth-(l+m):h.tblwidth+(l+m);this.hidden=!n;g=!0;Q.call(e,"onShowHideCol",n,this.name,d)}});!0===g&&C.setGridWidth.call(d,h.autowidth||void 0!==h.widthOrg&&"auto"!==h.widthOrg&&"100%"!==h.widthOrg?h.width:h.tblwidth+parseInt(h.scrollOffset,10));if(p)if(null!=h.pivotOptions&&null!=h.pivotOptions.colHeaders&&1<h.pivotOptions.colHeaders.length)for(var q=h.pivotOptions.colHeaders,p=0;p<q.length;p++)q[p]&&q[p].groupHeaders.length&&C.setGroupHeaders.call(d,q[p]);else C.setGroupHeaders.call(d,
h.groupHeader)}})},hideCol:function(b){return this.each(function(){C.showHideCol.call(a(this),b,"none")})},showCol:function(b){return this.each(function(){C.showHideCol.call(a(this),b,"")})},remapColumns:function(b,c,e){function d(c){var d=c.length?n(c):a.extend({},c);a.each(b,function(a){c[a]=d[this]})}function f(c,d){(d?c.children(d):c.children()).each(function(){var c=this,d=n(c.cells);a.each(b,function(a){var b=d[this],e=c.cells[a];b.cellIndex!==a&&b.parentNode.insertBefore(b,e)})})}var g=this[0],
...
a(this).triggerHandler("jqGridResetFrozenHeights")}})},setCaption:function(b){return this.each(function(){var c=this.grid.cDiv;this.p.caption=b;a("span.ui-jqgrid-title, span.ui-jqgrid-title-rtl",c).html(b);a(c).show();a(c).nextAll("div").removeClass(C.getGuiStyles.call(this,"top"));a(this).triggerHandler("jqGridResetFrozenHeights")})},setLabel:function(b,c,e,d){return this.each(function(){var f,g=this.p;if(this.grid){if(isNaN(b)){if(f=g.iColByName[b],void 0===f)return}else f=parseInt(b,10);if(0<=
f){var h=a("tr.ui-jqgrid-labels th:eq("+f+")",this.grid.hDiv);if(c){var m=a(".s-ico",h);a("[id^=jqgh_]",h).empty().html(c).append(m);g.colNames[f]=c}e&&("string"===typeof e?a(h).addClass(e):a(h).css(e));"object"===typeof d&&a(h).attr(d)}}})},setCell:function(b,c,e,d,f,g){return this.each(function(){var h=this.p,m=-1,l=h.colModel,n,p,q,r,t,w,x,y={},B;if(this.grid&&(m=isNaN(c)?h.iColByName[c]:parseInt(c,10),0<=m&&(r=C.getGridRowById.call(a(this),b)))){t=v.getCell.call(this,r,m);if(""!==e||!0===g){p=
l[m];"local"===h.datatype&&(B=Oa(h.idPrefix,b),n=h._index[B],void 0!==n&&(q=h.data[n]));if(null==q)for(n=0;n<r.cells.length;n++){if(n!==m&&(w=v.getDataFieldOfCell.call(this,r,n),0<w.length)){try{x=a.unformat.call(this,w,{rowId:b,colModel:l[n]},n)}catch(u){x=Ea(w[0].innerHTML)}y[l[n].name]=x}}else y=q;y[p.name]=e;l=this.formatter(b,e,m,y,"edit");h=h.colModel[m].title?{title:ib(l)}:{};t.html(l).attr(h);null!=q&&(l=lb.call(this,e,p,q[p.name],B,q,m),a.isFunction(p.saveLocally)?p.saveLocally.call(this,
{newValue:l,newItem:q,oldItem:q,id:B,cm:p,cmName:p.name,iCol:m}):q[p.name]=l)}if(d||f){t=v.getCell.call(this,r,m);if(d)t["string"===typeof d?"addClass":"css"](d);"object"===typeof f&&t.attr(f)}}})},getCell:function(b,c){var e=!1;this.each(function(){var d,f=this.p,g,h;if(this.grid&&(d=isNaN(c)?f.iColByName[c]:parseInt(c,10),0<=d&&(g=C.getGridRowById.call(a(this),b)))){h=v.getDataFieldOfCell.call(this,g,d).first();try{e=a.unformat.call(this,h,{rowId:g.id,colModel:f.colModel[d]},d)}catch(m){e=Ea(h.html())}}});
return e},getCol:function(b,c,e){var d=[],f,g=0,h,m,l;c="boolean"!==typeof c?!1:c;void 0===e&&(e=!1);this.each(function(){var n,p=this.p,q;if(this.grid&&(n=isNaN(b)?p.iColByName[b]:parseInt(b,10),0<=n)){var r=this.rows,t=r.length,w=0,x=0,y;if(t&&0<t){for(;w<t;){y=r[w];if(a(y).hasClass("jqgrow")){q=v.getDataFieldOfCell.call(this,y,n).first();try{f=a.unformat.call(this,q,{rowId:y.id,colModel:p.colModel[n]},n)}catch(B){f=Ea(q.html())}e?(l=parseFloat(f),isNaN(l)||(g+=l,void 0===m&&(m=h=l),h=Math.min(h,
...
g,h=a(this.grid.headers[b].el);g=C.getAutoResizableWidth.call(e,b);null==f||0>g||g===f.width||(C.setColWidth.call(e,b,g,d.autoResizing.adjustGridWidth&&!d.autoResizing.fixWidthOnShrink&&!c,c),d.autoResizing.fixWidthOnShrink&&d.shrinkToFit&&!c&&(f.fixed=!0,g=f.widthOrg,f.widthOrg=f.width,C.setGridWidth.call(e,d.width,!0),f.widthOrg=g,f.fixed=!1),h.data("autoResized","true"))})},autoResizeAllColumns:function(){return this.each(function(){var b=a(this),c=this.p,e=c.colModel,d=e.length,f,g,h=c.shrinkToFit,
m=c.autoResizing.adjustGridWidth,l=c.autoResizing.fixWidthOnShrink,n=parseInt(c.widthOrg,10),p=this.grid,q=C.autoResizeColumn;c.shrinkToFit=!1;c.autoResizing.adjustGridWidth=!0;c.autoResizing.fixWidthOnShrink=!1;for(f=0;f<d;f++)g=e[f],g.autoResizable&&"actions"!==g.formatter&&q.call(b,f,!0);p.hDiv.scrollLeft=p.bDiv.scrollLeft;c.footerrow&&(p.sDiv.scrollLeft=p.bDiv.scrollLeft);this.fixScrollOffsetAndhBoxPadding();isNaN(n)?m&&C.setGridWidth.call(b,p.newWidth+c.scrollOffset,!1):C.setGridWidth.call(b,
...
var B=R.call(d,"select","edit-cell"),u=R.call(d,"hover","selected-row");if(!0!==p||!0!==e||l.hasClass("not-editable-cell"))0<=t&&0<=w&&(wa.call(d,x[0],t).removeClass(B),x.removeClass(u)),l.addClass(B),r.addClass(u),m=l.html().replace(/\&#160\;/ig,""),Q.call(d,"onSelectCell",q,h,m,b,c);else{0<=t&&0<=w&&(wa.call(d,x[0],t).removeClass(B),x.removeClass(u));l.addClass(B);r.addClass(u);n.edittype||(n.edittype="text");r=n.edittype;try{m=a.unformat.call(d,l,{rowId:q,colModel:n},c)}catch(z){m="textarea"===
...
y=x.name,B,u=wa.call(e,r,c),E={},z=v.getEditedValue.call(e,u,x,E);if(z!==p[q].v){B=d.triggerHandler("jqGridBeforeSaveCell",[t,y,z,b,c]);void 0!==B&&(z=B);a.isFunction(f.beforeSaveCell)&&(B=f.beforeSaveCell.call(e,t,y,z,b,c),void 0!==B&&(z=B));var F=v.checkValues.call(e,z,c,void 0,void 0,{oldValue:p[q].v,newValue:z,cmName:y,rowid:t,iCol:c,iRow:b,cm:x,tr:r,td:u,mode:"cell"}),r=x.formatoptions||{};if(!0===F[0]){q=d.triggerHandler("jqGridBeforeSubmitCell",[t,y,z,b,c])||{};a.isFunction(f.beforeSubmitCell)&&
((q=f.beforeSubmitCell.call(e,t,y,z,b,c))||(q={}));0<a("input.hasDatepicker",u).length&&a("input.hasDatepicker",u).datepicker("hide");"date"===x.formatter&&!0!==r.sendFormatted&&(z=a.unformat.date.call(e,z,x));if("remote"===f.cellsubmit)if(f.cellurl){var k={};k[y]=z;var m=f.prmNames,r=m.oper,D=e.grid.hDiv;k[m.id]=v.stripPref(f.idPrefix,t);k[r]=m.editoper;k=a.extend(q,k);f.autoEncodeOnEdit&&a.each(k,function(b,c){a.isFunction(c)||(k[b]=v.oldEncodePostedData(c))});d.jqGrid("progressBar",{method:"show",
loadtype:f.loadui,htmlcontent:v.defaults.savetext||"Saving..."});D.loading=!0;a.ajax(a.extend({url:a.isFunction(f.cellurl)?f.cellurl.call(e,f.cellurl,b,c,t,z,y):f.cellurl,data:v.serializeFeedback.call(e,f.serializeCellData,"jqGridSerializeCellData",k),type:"POST",complete:function(h){d.jqGrid("progressBar",{method:"hide",loadtype:f.loadui});D.loading=!1;if((300>h.status||304===h.status)&&(0!==h.status||4!==h.readyState)){var m=d.triggerHandler("jqGridAfterSubmitCell",[e,h,k.id,y,z,b,c])||[!0,""];
!0===m[0]&&a.isFunction(f.afterSubmitCell)&&(m=f.afterSubmitCell.call(e,h,k.id,y,z,b,c));!0===m[0]?(d.jqGrid("setCell",t,c,z,!1,!1,!0),u.addClass("dirty-cell"),w.addClass("edited"),Q.call(e,"afterSaveCell",t,y,z,b,c),p.splice(0,1)):(g.call(e,l,m[1],n),d.jqGrid("restoreCell",b,c))}},error:function(k,m,p){a("#lui_"+h(f.id)).hide();D.loading=!1;d.triggerHandler("jqGridErrorCell",[k,m,p]);a.isFunction(f.errorCell)?f.errorCell.call(e,k,m,p):g.call(e,l,k.status+" : "+k.statusText+"<br/>"+m,n);d.jqGrid("restoreCell",
b,c)}},v.ajaxOptions,f.ajaxCellOptions||{}))}else try{g.call(e,l,m.nourl,n),d.jqGrid("restoreCell",b,c)}catch(I){}"clientArray"===f.cellsubmit&&(d.jqGrid("setCell",t,c,"select"===x.edittype&&"select"!==x.formatter?E.text:z,!1,!1,!0),u.addClass("dirty-cell"),w.addClass("edited"),Q.call(e,"afterSaveCell",t,y,z,b,c),p.splice(0,1))}else try{setTimeout(function(){g.call(e,l,z+" "+F[1],n)},100),d.jqGrid("restoreCell",b,c)}catch(I){}}else d.jqGrid("restoreCell",b,c)}setTimeout(function(){a("#"+h(f.knv)).attr("tabindex",
...
[];b||(b="all");this.each(function(){var e=this,d=e.p,f=v.htmlDecode,g=e.rows;e.grid&&!0===d.cellEdit&&a(g).each(function(h){var m={};if(a(this).hasClass("edited")){var l=this;a(this.cells).each(function(c){var p=d.colModel[c],q=p.name,r=wa.call(e,l,c);if("cb"!==q&&"subgrid"!==q&&"rn"!==q&&("dirty"!==b||r.hasClass("dirty-cell")))try{m[q]=a.unformat.call(e,r[0],{rowId:g[h].id,colModel:p},c)}catch(t){m[q]=f(r.html())}});m.id=this.id;c.push(m)}})});return c}});var ga=v.getMethod("getGridRes"),ba=function(a,
...
document.createElement("select");b=[];d=l.iColByName[c.name];n=l.colModel[d];!0===c.multiple?(p=!0,h.multiple="multiple",a(h).attr("aria-multiselectable","true"),b=e.split(","),b=a.map(b,function(b){return a.trim(b)})):(p=!1,b[0]=a.trim(e));void 0===c.size&&(c.size=p?3:1);if(void 0!==c.dataUrl){var t=null,w=c.postData||f.postData,x={elem:h,options:c,cm:n,iCol:d,ovm:b};try{t=c.rowId}catch(u){}l&&l.idPrefix&&(t=v.stripPref(l.idPrefix,t));a.ajax(a.extend({url:a.isFunction(c.dataUrl)?c.dataUrl.call(m,
...
y=0;y<B.length;y++)q=B[y].split(l),2<q.length&&(q[1]=a.map(q,r).join(l)),f.push({value:q[0],innerHtml:q[1],selectValue:a.trim(q[0]),selectText:a.trim(q[1])});else if("object"===typeof c.value)for(y in l=c.value,l)l.hasOwnProperty(y)&&f.push({value:y,innerHtml:l[y],selectValue:a.trim(y),selectText:a.trim(l[y])});for(y=0;y<f.length;y++)l=f[y],x=document.createElement("option"),x.value=l.value,x.innerHTML=l.innerHtml,h.appendChild(x),p||l.selectValue!==a.trim(e)||(x.selected="selected",t=!0),p&&-1<a.inArray(l.selectValue,
b)&&(x.selected="selected",t=!0);if(!t)for(y=0;y<f.length;y++)l=f[y],p||l.selectText!==a.trim(e)||(x.selected="selected"),p&&-1<a.inArray(l.selectText,b)&&(x.selected="selected");g(h,c,["value"]);v.fullBoolFeedback.call(m,c.selectFilled,"jqGridSelectFilled",{elem:h,options:c,cm:n,cmName:n.name,iCol:d})}break;case "text":case "password":case "button":t="button"===b?"button":"textbox";h=document.createElement("input");h.type=b;g(h,c);h.value=e;"button"!==b&&(d?c.size||a(h).css({width:"100%","box-sizing":"border-box"}):
c.size||(c.size=20));a(h).attr("role",t);break;case "image":case "file":h=document.createElement("input");h.type=b;g(h,c);break;case "custom":h=document.createElement("span");try{if(a.isFunction(c.custom_element))if(B=c.custom_element.call(m,e,c),B instanceof jQuery||v.isHTMLElement(B)||"string"===typeof B)B=a(B).addClass("customelement").attr({id:c.id,name:c.name}),a(h).empty().append(B);else throw"editoptions.custom_element returns value of a wrong type";else throw"editoptions.custom_element is not a function";
}catch(u){"e1"===u&&n.call(m,p,"function 'custom_element' "+r.nodefined,q),"e2"===u?n.call(m,p,"function 'custom_element' "+r.novalue,q):n.call(m,p,"string"===typeof u?u:u.message,q)}}return h},checkDate:function(a,c){var e={},d;a=a.toLowerCase();d=-1!==a.indexOf("/")?"/":-1!==a.indexOf("-")?"-":-1!==a.indexOf(".")?".":"/";a=a.split(d);c=c.split(d);if(3!==c.length)return!1;var f=-1,g,h=d=-1,m;for(m=0;m<a.length;m++)g=isNaN(c[m])?0:parseInt(c[m],10),e[a[m]]=g,g=a[m],-1!==g.indexOf("y")&&(f=m),-1!==
...
e=a(this).data("oper");d.triggerHandler("jqGridToolbarSelectOper",[c,e,b]);a("#sopt_menu").hide();a(b).text(e).data("soper",c);!0===l.autosearch&&(e=a(b).parent().next().children()[0],(a(e).val()||"nu"===c||"nn"===c)&&B())})}},F,k=a("<tr></tr>",{"class":"ui-search-toolbar",role:"row"});a.each(n,function(b){var d,e;e="";var m,n,w=this.searchoptions,x=this.editoptions,z=a("<th></th>",{"class":ba.call(c,"colHeaders","ui-th-column ui-th-"+f.direction+" "+(l.applyLabelClasses?this.labelClasses||"":""))}),
N=a("<div style='position:relative;height:auto;'></div>"),A=a("<table class='ui-search-table'"+(v.msie&&8>v.msiever()?" cellspacing='0'":"")+"><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear' style='width:1px'></td></tr></table>");!0===this.hidden&&a(z).css("display","none");this.search=!1===this.search?!1:!0;void 0===this.stype&&(this.stype="text");d=a.extend({mode:"filter"},w||{});if(this.search){if(l.searchOperators){e=d.sopt?d.sopt[0]:"select"===
...
void 0===d.clearSearch&&(d.clearSearch="text"===this.stype?!0:!1);d.clearSearch?(e=p("search.resetTitle")||"Clear Search Value",a("td",A).eq(2).append("<a title='"+e+"' style='padding-right:0.2em;padding-left:0.3em;' class='clearsearchclass'>"+l.resetIcon+"</a>")):a("td",A).eq(2).hide();switch(this.stype){case "select":if(e=this.surl||d.dataUrl)a(N).append(A),a.ajax(a.extend({url:e,context:{stbl:A,options:d,cm:this,iCol:b},dataType:"html",success:function(a,b,d){b=this.cm;var e=this.iCol,f=this.options,
k=this.stbl.find(">tbody>tr>td.ui-search-input");void 0!==f.buildSelect?(a=f.buildSelect.call(c,a,d,b,e))&&k.append(a):k.append(a);a=k.children("select");void 0!==f.defaultValue&&a.val(f.defaultValue);a.attr({name:b.index||b.name,id:"gs_"+b.name});f.attr&&a.attr(f.attr);a.addClass(y);a.css({width:"100%"});g.call(c,a[0],f);v.fullBoolFeedback.call(c,f.selectFilled,"jqGridSelectFilled",{elem:a[0],options:f,cm:b,cmName:b.name,iCol:e,mode:"filter"});!0===l.autosearch&&a.change(function(){B();return!1})}},
v.ajaxOptions,f.ajaxSelectOptions||{}));else{var C,H,W;w?(C=void 0===w.value?"":w.value,H=void 0===w.separator?":":w.separator,W=void 0===w.delimiter?";":w.delimiter):x&&(C=void 0===x.value?"":x.value,H=void 0===x.separator?":":x.separator,W=void 0===x.delimiter?";":x.delimiter);if(C){var L=document.createElement("select");L.style.width="100%";a(L).attr({name:this.index||this.name,id:"gs_"+this.name});var X;if("string"===typeof C)for(e=C.split(W),X=0;X<e.length;X++)C=e[X].split(H),W=document.createElement("option"),
W.value=C[0],W.innerHTML=C[1],L.appendChild(W);else if("object"===typeof C)for(X in C)C.hasOwnProperty(X)&&(W=document.createElement("option"),W.value=X,W.innerHTML=C[X],L.appendChild(W));void 0!==d.defaultValue&&a(L).val(d.defaultValue);d.attr&&a(L).attr(d.attr);a(L).addClass(y);a(N).append(A);g.call(c,L,d);a("td",A).eq(1).append(L);v.fullBoolFeedback.call(c,d.selectFilled,"jqGridSelectFilled",{elem:L,options:w||x||{},cm:this,cmName:this.name,iCol:b,mode:"filter"});!0===l.autosearch&&a(L).change(function(){B();
return!1})}}break;case "text":b=void 0!==d.defaultValue?d.defaultValue:"";a("td",A).eq(1).append("<input type='text' class='"+y+"' style='width:100%;padding:0;' name='"+(this.index||this.name)+"' id='gs_"+this.name+"' value='"+b+"'/>");a(N).append(A);d.attr&&a("input",N).attr(d.attr);g.call(c,a("input",N)[0],d);!0===l.autosearch&&(l.searchOnEnter?a("input",N).keypress(function(a){return 13===(a.charCode||a.keyCode||0)?(B(),!1):this}):a("input",N).keydown(function(a){switch(a.which){case 13:return!1;
case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:F&&clearTimeout(F),F=setTimeout(function(){B()},l.autosearchDelay)}}));break;case "custom":a("td",A).eq(1).append("<span style='width:95%;padding:0;' class='"+y+"' name='"+(this.index||this.name)+"' id='gs_"+this.name+"'/>");a(N).append(A);try{if(a.isFunction(d.custom_element))if(L=d.custom_element.call(c,void 0!==d.defaultValue?d.defaultValue:"",d))L=a(L).addClass("customelement"),a(N).find("span[name='"+(this.index||this.name)+
"']").append(L);else throw"e2";else throw"e1";}catch(S){"e1"===S&&h.call(c,q,"function 'custom_element' "+t.nodefined,r),"e2"===S?h.call(c,q,"function 'custom_element' "+t.novalue,r):h.call(c,q,"string"===typeof S?S:S.message,r)}}}a(z).append(N);a(k).append(z);l.searchOperators||a("td",A).eq(0).hide()});a(e.hDiv).find(">div>.ui-jqgrid-htable>thead").append(k);l.searchOperators&&(a(".soptclass",k).click(function(b){var c=a(this).offset();z(this,c.left,c.top);b.stopPropagation()}),a("body").on("click",
function(b){"soptclass"!==b.target.className&&a("#sopt_menu").hide()}));a(".clearsearchclass",k).click(function(){var b=a(this).parents("tr").first(),c=parseInt(a("td.ui-search-oper",b).data("colindex"),10),d=a.extend({},n[c].searchoptions||{}).defaultValue||"";"select"===n[c].stype?d?a("td.ui-search-input select",b).val(d):a("td.ui-search-input select",b)[0].selectedIndex=0:a("td.ui-search-input input",b).val(d);!0===l.autosearch&&B()});c.ftoolbar=!0;c.triggerToolbar=B;c.clearToolbar=function(b){var g=
...
b).addClass(r);a(b).attr("aria-selected","false");a("span.ui-icon-"+e.sortorder,c).removeClass(r);a(c).attr("aria-selected","true");e.viewsortcols[0]||e.lastsort===f||(a("span.s-ico",b).hide(),a("span.s-ico",c).show())});a(e.gView).append(d.fbDiv);a(d.bDiv).scroll(function(){a(d.fbDiv).scrollTop(a(this).scrollTop())});!0===e.hoverrows&&a(e.idSel).unbind("mouseover").unbind("mouseout");var B=function(a,b){var c=a.height();1<=Math.abs(c-b)&&0<b&&(a.height(b),c=a.height(),1<=Math.abs(b-c)&&a.height(b+
...
d.fhDiv[0].clientWidth;b.header.resizeDiv&&null!=d.fhDiv&&1<=d.fhDiv.length&&B(a(d.fhDiv),d.hDiv.clientHeight);b.body.resizeDiv&&null!=d.fbDiv&&0<d.fbDiv.length&&u(a(d.fbDiv),c);b.resizeFooter&&null!=d.fsDiv&&0<=d.fsDiv.length&&u(a(d.fsDiv),c)};a(e.gBox).bind("resizestop.setFrozenColumns",function(){setTimeout(function(){F(z)},50)});c.bind("jqGridInlineEditRow.setFrozenColumns jqGridInlineAfterRestoreRow.setFrozenColumns jqGridInlineAfterSaveRow.setFrozenColumns jqGridAfterEditCell.setFrozenColumns jqGridAfterRestoreCell.setFrozenColumns jqGridAfterSaveCell.setFrozenColumns jqGridResizeStop.setFrozenColumns",
function(a,b){var d=c.jqGrid("getInd",b);F({header:{resizeDiv:!1,resizedRows:{iRowStart:-1,iRowEnd:-1}},resizeFooter:!0,body:{resizeDiv:!0,resizedRows:{iRowStart:d,iRowEnd:d}}})});c.bind("jqGridResizeStop.setFrozenColumns",function(){F(z)});c.bind("jqGridResetFrozenHeights.setFrozenColumns",function(a,b){F(b||z)});d.hDiv.loading||c.triggerHandler("jqGridAfterGridComplete");e.frozenColumns=!0}}}})},destroyFrozenColumns:function(){return this.each(function(){var b=a(this),c=this.grid,e=this.p,d=H(e.id);
...
b));return g};this.createTableRowForRule=function(b,c){var e=this,f=l(),g=a("<tr></tr>"),h,p,q,r="",k;g.append("<td class='first'></td>");var D=a("<td class='columns'></td>");g.append(D);var I=a("<select></select>"),G,K=[];D.append(I);I.bind("change",function(){b.field=a(I).val();var c=a(this).parents("tr:first"),d,g;for(g=0;g<e.p.columns.length;g++)if(e.p.columns[g].name===b.field){d=e.p.columns[g];break}if(d){var h=a.extend({},d.searchoptions||{},{id:v.randId(),name:d.name,mode:"search"});m&&"text"===
...
setTimeout(function(){b.data=a(k).val();e.onchange()},0)}});var D=0,J,Y;for(h=0;h<e.p.columns.length;h++)if(k=void 0===e.p.columns[h].search?!0:e.p.columns[h].search,J=!0===e.p.columns[h].hidden,(Y=!0===e.p.columns[h].searchoptions.searchhidden)&&k||k&&!J)k="",b.field===e.p.columns[h].name&&(k=" selected='selected'",D=h),r+="<option value='"+e.p.columns[h].name+"'"+k+">"+e.p.columns[h].label+"</option>";I.append(r);r=a("<td class='operators'></td>");g.append(r);q=d.columns[D];m&&"text"===q.inputtype&&
!q.searchoptions.size&&(q.searchoptions.size=10);D=v.createEl.call(f,q.inputtype,a.extend({},q.searchoptions||{},{id:v.randId(),name:q.name}),b.data,!0,e.p.ajaxSelectOptions||{},!0);if("nu"===b.op||"nn"===b.op)a(D).attr("readonly","true"),a(D).attr("disabled","true");var C=a("<select class='selectopts'></select>");r.append(C);C.bind("change",function(){b.op=a(C).val();var c=a(this).parents("tr:first"),c=a(".input-elm",c)[0];"nu"===b.op||"nn"===b.op?(b.data="","SELECT"!==c.tagName.toUpperCase()&&(c.value=
...
k=b.op===Y?" selected='selected'":"",r+="<option value='"+Y+"'"+k+">"+(void 0!==J?J.text:e.p.cops[Y].text)+"</option>");C.append(r);r=a("<td class='data'></td>");g.append(r);r.append(D);v.bindEv.call(f,D,q.searchoptions);a(D).addClass("input-elm").bind("change",function(){b.data="custom"===q.inputtype?q.searchoptions.custom_value.call(f,a(this).children(".customelement:first"),"get"):a(this).val();e.onchange()});r=a("<td></td>");g.append(r);!0===d.ruleButtons&&(D=a("<input type='button' value='-' title='"+
n("deleteRuleTitle")+"' class='delete-rule ui-del'/>"),r.append(D),D.bind("click",function(){for(h=0;h<c.rules.length;h++)if(c.rules[h]===b){c.rules.splice(h,1);break}e.reDraw();e.onchange();return!1}));return g};this.getStringForGroup=function(a){var b="(",c;if(void 0!==a.groups)for(c=0;c<a.groups.length;c++){1<b.length&&(b+=" "+a.groupOp+" ");try{b+=this.getStringForGroup(a.groups[c])}catch(d){alert(d)}}if(void 0!==a.rules)try{for(c=0;c<a.rules.length;c++)1<b.length&&(b+=" "+a.groupOp+" "),b+=this.getStringForRule(a.rules[c])}catch(d){alert(d)}b+=
...
ne:"<>",lt:"<",le:"<=",gt:">",ge:">=",bw:"LIKE",bn:"NOT LIKE","in":"IN",ni:"NOT IN",ew:"LIKE",en:"NOT LIKE",cn:"LIKE",nc:"NOT LIKE",nu:"IS NULL",nn:"IS NOT NULL"}},C.getGridRes.call(d,"search"),v.search||{},f.searching||{},b||{}),h="fbox_"+f.id,m=g.commonIconClass,l={themodal:"searchmod"+h,modalhead:"searchhd"+h,modalcontent:"searchcnt"+h,resizeAlso:h},n="#"+H(l.themodal),p=f.gBox,q=f.gView,r=a.each,t=f.postData[g.sFilter],w=function(){var b=a.makeArray(arguments);b.unshift("Search");b.unshift("Filter");
b.unshift(g);return Wa.apply(e,b)};"string"===typeof t&&(t=""!==a.trim(t)?v.parse(t):void 0);!0===g.recreateFilter?a(n).remove():d.data("searchProp")&&a.extend(g,d.data("searchProp"));if(void 0!==a(n)[0])c(a("#fbox_"+f.idSel));else{var x=a("<div><div id='"+h+"' class='searchFilter' style='overflow:auto'></div></div>").insertBefore(q);"rtl"===f.direction&&x.attr("dir","rtl");var y="",B="",u,E=!1,z,F=-1,k=a.extend([],f.colModel);z=ea.call(e,h+"_search",g.Find,pa(m,g.findDialogIcon),"right");var D=ea.call(e,
h+"_reset",g.Reset,pa(m,g.resetDialogIcon),"left");g.showQuery&&(y=ea.call(e,h+"_query","Query",pa(m,g.queryDialogIcon),"left")+"&#160;");g.searchForAdditionalProperties&&r(f.additionalProperties,function(){var a="string"===typeof this?{name:this}:this;a.label||(a.label=a.name);a.isAddProp=!0;k.push(a)});g.columns.length?(k=g.columns,F=0,u=k[0].index||k[0].name):r(k,function(a,b){b.label||(b.label=b.isAddProp?b.name:f.colNames[a]);if(!E){var c=void 0===b.search?!0:b.search,d=!0===b.hidden;if(b.searchoptions&&
!0===b.searchoptions.searchhidden&&c||c&&!d)E=!0,u=b.index||b.name,F=a}});if(!t&&u||!1===g.multipleSearch)m="eq",0<=F&&k[F].searchoptions&&k[F].searchoptions.sopt?m=k[F].searchoptions.sopt[0]:g.sopt&&g.sopt.length&&(m=g.sopt[0]),t={groupOp:"AND",rules:[{field:u,op:m,data:""}]};E=!1;g.tmplNames&&g.tmplNames.length&&(E=!0,B=g.tmplLabel,B+="<select class='ui-template'>",B+="<option value='default'>Default</option>",r(g.tmplNames,function(a,b){B+="<option value='"+a+"'>"+b+"</option>"}),B+="</select>");
z="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+h+"_2'><tbody><tr><td colspan='2'><hr class='"+ba.call(e,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='EditButton EditButton-"+f.direction+"'  style='float:"+("rtl"===f.direction?"right":"left")+";'>"+D+B+"</td><td class='EditButton EditButton-"+f.direction+"'>"+y+z+"</td></tr></tbody></table>";h=H(h);g.gbox="#gbox_"+h;g.height="auto";h="#"+h;a(h).jqFilter({columns:k,filter:g.loadDefaults?t:null,showQuery:g.showQuery,
errorcheck:g.errorcheck,sopt:g.sopt,groupButton:g.multipleGroup,ruleButtons:g.multipleSearch,afterRedraw:g.afterRedraw,ops:g.odata,cops:f.customSortOperations,operands:g.operands,ajaxSelectOptions:f.ajaxSelectOptions,groupOps:g.groupOps,onChange:function(){this.p.showQuery&&a(".query",this).html(this.toUserFriendlyString());ra.call(e,g.afterChange,"jqGridFilterAfterChange",a(h),g)},direction:f.direction,id:f.id});x.append(z);E&&g.tmplFilters&&g.tmplFilters.length&&a(".ui-template",x).bind("change",
...
a(".customelement",this),c=this.name;if(b.length){if(c=b.attr("name"),b=Za[c],void 0!==b&&(b=Y[b],b=b.editoptions||{},a.isFunction(b.custom_value))){try{if(A[c]=b.custom_value.call(r,a("#"+H(c),k),"get"),void 0===A[c])throw"e1";}catch(d){"e1"===d?Xa.call(r,W,"function 'custom_value' "+u.msg.novalue,u.bClose):Xa.call(r,W,d.message,u.bClose)}return!0}}else switch(b=a(this)[0].type,b){case "checkbox":A[c]=a(this).is(":checked")?a(this).val():a(this).data("offval");break;case "select-one":A[c]=a("option:selected",
this).val();break;case "select-multiple":A[c]=a(this).val();A[c]=A[c]?A[c].join(","):"";a("option:selected",this).each(function(b,c){a(c).text()});break;case "date":A[c]=a(this).val();3===String(A[c]).split("-").length&&(b=Za[c],void 0!==b&&(b=Y[b],b=b.formatoptions||{},b=b.newformat||y.call(t,"formatter.date.newformat"),A[c]=v.parseDate.call(t[0],"Y-m-d",A[c],b)));break;default:void 0!==b&&0>a.inArray(b,u.skipPostTypes)&&(A[c]=a(this).val())}});return!0}function d(b,c,d){var e=0,f=[],g=!1,h="",k;
for(k=1;k<=d;k++)h+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==b&&(g=C.getInd.call(t,b));a(Y).each(function(k){var l=this.name,m,n,p,q,t;m=this.editable;var A=!1,x=!1;t="_empty"===b?"addForm":"editForm";a.isFunction(m)&&(m=m.call(r,{rowid:b,iCol:k,iRow:g,cmName:l,cm:this,mode:t}));q=(this.editrules&&!0===this.editrules.edithidden?0:!0===this.hidden||"hidden"===m)?"style='display:none'":"";switch(String(m).toLowerCase()){case "hidden":m=!0;break;case "disabled":A=
m=!0;break;case "readonly":x=m=!0}if("cb"!==l&&"subgrid"!==l&&!0===m&&"rn"!==l){if(!1===g)p="";else{m=a(r.rows[g].cells[k]);try{p=a.unformat.call(r,m,{rowId:b,colModel:this},k)}catch(D){p=this.edittype&&"textarea"===this.edittype?m.text():m.html()}Sa(p)&&(p="")}m=a.extend({},this.editoptions||{},{id:l,name:l,rowId:b,mode:t});var z=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),y=parseInt(z.rowpos,10)||e+1,F=parseInt(2*(parseInt(z.colpos,10)||1),10);"_empty"===
...
if(z.rowabove){var B=a("<tr><td class='contentinfo' colspan='"+2*d+"'>"+z.rowcontent+"</td></tr>");a(c).append(B);B[0].rp=y}0===n.length&&(n=a("<tr "+q+" data-rowpos='"+y+"'></tr>").addClass("FormData").attr("id","tr_"+l),a(n).append(h),a(c).append(n),n[0].rp=y);q=a("td:eq("+(F-2)+")",n[0]);n=a("td:eq("+(F-1)+")",n[0]);q.html(void 0===z.label?w.colNames[k]:z.label||"&#160;");n[Sa(n.html())?"html":"append"](z.elmprefix).append(t).append(z.elmsuffix);A?(q.addClass(S),n.addClass(S),a(t).prop("readonly",
...
f=A[e];"date"!==d.formatter||null!=d.formatoptions&&!0===d.formatoptions.sendFormatted||(A[e]=a.unformat.date.call(r,f,d));"clientArray"!==b&&d.editoptions&&!0===d.editoptions.NullIfEmpty&&A.hasOwnProperty(e)&&""===f&&(A[e]="null")})}function h(){var c=[!0,"",""],d={},e=w.prmNames,h,l,m,n,p,q,z=C.getInd.call(t,b),y=!1===z?null:r.rows[z];(q=t.triggerHandler("jqGridAddEditBeforeCheckValues",[a(E),T]))&&"object"===typeof q&&(A=q);z=!1===z?-1:z;a.isFunction(u.beforeCheckValues)&&(q=u.beforeCheckValues.call(r,
A,a(E),T))&&"object"===typeof q&&(A=q);for(m in A)if(A.hasOwnProperty(m)&&(q=w.iColByName[m],c=v.checkValues.call(r,A[m],m,void 0,void 0,{oldValue:"_empty"===b?null:C.getCell.call(t,b,q),newValue:A[m],cmName:m,rowid:b,cm:Y[q],iCol:q,iRow:z,tr:y,td:null==y?null:y.cells[q],mode:"_empty"===b?"addForm":"editForm"}),!1===c[0]))break;g();c[0]&&(d=t.triggerHandler("jqGridAddEditClickSubmit",[u,A,T]),void 0===d&&a.isFunction(u.onclickSubmit)&&(d=u.onclickSubmit.call(r,u,A,T)||{}),c=t.triggerHandler("jqGridAddEditBeforeSubmit",
[A,a(E),T]),void 0===c&&(c=[!0,"",""]),c[0]&&a.isFunction(u.beforeSubmit)&&(c=u.beforeSubmit.call(r,A,a(E),T)));if(c[0]&&!u.processing){u.processing=!0;a("#sData",D).addClass(Q);m=u.url||w.editurl;l=e.oper;h="clientArray"===m&&!1!==w.keyName?w.keyName:e.id;A[l]="_empty"===a.trim(A[x+"_id"])?e.addoper:e.editoper;A[l]!==e.addoper?A[h]=A[x+"_id"]:void 0===A[h]&&(A[h]=A[x+"_id"]);delete A[x+"_id"];A=a.extend(A,u.editData,d);if(!0===w.treeGrid)for(p in A[l]===e.addoper&&(n=w.selrow,A["adjacency"===w.treeGridModel?
w.treeReader.parent_id_field:"parent_id"]=n),w.treeReader)w.treeReader.hasOwnProperty(p)&&(d=w.treeReader[p],!A.hasOwnProperty(d)||A[l]===e.addoper&&"parent_id_field"===p||delete A[d]);A[h]=v.stripPref(w.idPrefix,A[h]);w.autoEncodeOnEdit&&a.each(A,function(b,c){a.isFunction(c)||(A[b]=v.oldEncodePostedData(c))});p=a.extend({url:a.isFunction(m)?m.call(r,A[h],T,A,u):m,type:a.isFunction(u.mtype)?u.mtype.call(r,T,u,A[h],A):u.mtype,data:v.serializeFeedback.call(r,a.isFunction(u.serializeEditData)?u.serializeEditData:
w.serializeEditData,"jqGridAddEditSerializeEditData",A),complete:function(b,d){a("#sData",D).removeClass(Q);A[h]=w.idPrefix+a("#id_g",k).val();300<=b.status&&304!==b.status||0===b.status&&4===b.readyState?(c[0]=!1,c[1]=t.triggerHandler("jqGridAddEditErrorTextFormat",[b,T]),a.isFunction(u.errorTextFormat)?c[1]=u.errorTextFormat.call(r,b,T):c[1]=d+" Status: '"+b.statusText+"'. Error code: "+b.status):(c=t.triggerHandler("jqGridAddEditAfterSubmit",[b,A,T]),void 0===c&&(c=[!0,"",""]),c[0]&&a.isFunction(u.afterSubmit)&&
(c=u.afterSubmit.call(r,b,A,T)));if(!1===c[0])a("#FormError>td",k).html(c[1]),a("#FormError",k).show();else{w.autoEncodeOnEdit&&a.each(A,function(a,b){A[a]=v.oldDecodePostedData(b)});var g=[a.extend({},u.reloadGridOptions||{})];A[l]===e.addoper?(c[2]||(c[2]=v.randId()),null==A[h]||"_empty"===A[h]||A[l]===e.addoper?A[h]=c[2]:c[2]=A[h],u.reloadAfterSubmit?t.trigger("reloadGrid",g):!0===w.treeGrid?C.addChildNode.call(t,c[2],n,A):C.addRowData.call(t,c[2],A,u.addedrow),u.closeAfterAdd?(!0!==w.treeGrid&&
B.call(t,c[2]),fa(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form})):u.clearAfterAdd&&f("_empty",E)):(u.reloadAfterSubmit?(t.trigger("reloadGrid",g),u.closeAfterEdit||setTimeout(function(){B.call(t,A[h])},1E3)):!0===w.treeGrid?C.setTreeRow.call(t,A[h],A):C.setRowData.call(t,A[h],A),u.closeAfterEdit&&fa(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form}));if(a.isFunction(u.afterComplete)){var m=
b;setTimeout(function(){t.triggerHandler("jqGridAddEditAfterComplete",[m,A,a(E),T]);u.afterComplete.call(r,m,A,a(E),T);m=null},50)}if(u.checkOnSubmit||u.checkOnUpdate)if(a(E).data("disabled",!1),"_empty"!==u._savedData[x+"_id"])for(var p in u._savedData)u._savedData.hasOwnProperty(p)&&A[p]&&(u._savedData[p]=A[p])}u.processing=!1;try{a(":input:visible",E)[0].focus()}catch(q){}}},v.ajaxOptions,u.ajaxEditOptions);p.url||u.useDataProxy||(a.isFunction(w.dataProxy)?u.useDataProxy=!0:(c[0]=!1,c[1]+=" "+
v.errors.nourl));c[0]&&(u.useDataProxy?(d=w.dataProxy.call(r,p,"set_"+x),void 0===d&&(d=[!0,""]),!1===d[0]?(c[0]=!1,c[1]=d[1]||"Error deleting the selected row!"):(p.data.oper===e.addoper&&u.closeAfterAdd&&fa(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form}),p.data.oper===e.editoper&&u.closeAfterEdit&&fa(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form}))):"clientArray"===p.url?(u.reloadAfterSubmit=
!1,A=p.data,p.complete({status:200,statusText:""},"")):a.ajax(p))}!1===c[0]&&(a("#FormError>td",k).html(c[1]),a("#FormError",k).show())}function m(a,b){var c=!1,d;for(d in a)if(a.hasOwnProperty(d)&&String(a[d])!==String(b[d])){c=!0;break}return c}function l(){var b=!0;a("#FormError",k).hide();u.checkOnUpdate&&(A={},e(),O=m(A,u._savedData))&&(a(E).data("disabled",!0),a(".confirm",G).show(),b=!1);return b}function n(){var c=v.detectRowEditing.call(r,b);if(null!=c)if("inlineEditing"===c.mode)C.restoreRow.call(t,
b);else{var c=c.savedRow,d=r.rows[c.id];C.restoreCell.call(t,c.id,c.ic);a(d.cells[c.ic]).removeClass("edit-cell "+$a);a(d).addClass($a).attr({"aria-selected":"true",tabindex:"0"})}}function p(b,c){var d=c[1].length-1;0===b?a("#pData",D).addClass(S):void 0!==c[1][b-1]&&ca(a("#"+H(c[1][b-1])),S)?a("#pData",D).addClass(S):a("#pData",D).removeClass(S);b===d?a("#nData",D).addClass(S):void 0!==c[1][b+1]&&ca(a("#"+H(c[1][b+1])),S)?a("#nData",D).addClass(S):a("#nData",D).removeClass(S)}function q(){var b=
C.getDataIDs.call(t),c=a("#id_g",k).val();return[a.inArray(c,b),b]}var r=this,t=a(r),w=r.p;if(r.grid&&null!=w&&b){var x=w.id,y=C.getGridRes,B=C.setSelection,u=a.extend(!0,{top:0,left:0,width:300,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,url:null,mtype:"POST",clearAfterAdd:!0,closeAfterEdit:!1,reloadAfterSubmit:!0,onInitializeForm:null,beforeInitData:null,beforeShowForm:null,afterShowForm:null,beforeSubmit:null,afterSubmit:null,onclickSubmit:null,afterComplete:null,onclickPgButtons:null,
afterclickPgButtons:null,editData:{},recreateForm:!1,closeOnEscape:!1,addedrow:"first",topinfo:"",bottominfo:"",savekey:[!1,13],navkeys:[!1,38,40],checkOnSubmit:!1,checkOnUpdate:!1,_savedData:{},processing:!1,onClose:null,ajaxEditOptions:{},serializeEditData:null,viewPagerButtons:!0,overlayClass:"ui-widget-overlay",removemodal:!0,skipPostTypes:["image","file"],form:"edit"},y.call(t,"edit"),v.edit,w.formEditing||{},c||{}),E="FrmGrid_"+x,z=E,F="TblGrid_"+x,k="#"+H(F),D=k+"_2",I={themodal:"editmod"+
x,modalhead:"edithd"+x,modalcontent:"editcnt"+x,resizeAlso:E},G="#"+H(I.themodal),K=w.gBox,J=w.propOrAttr,Y=w.colModel,Za=w.iColByName,ia=1,N=0,A,O,T,Ba=u.commonIconClass,W=y.call(t,"errors.errcap"),L=function(){var b=a.makeArray(arguments);b.unshift("");b.unshift("AddEdit");b.unshift(u);return Wa.apply(r,b)},X=R.call(r,"hover"),S=R.call(r,"disabled"),$a=R.call(r,"select"),Q=R.call(r,"active"),M=R.call(r,"error"),E="#"+H(E);"new"===b?(b="_empty",T="add",u.caption=u.addCaption):(u.caption=u.editCaption,
T="edit");if(!u.recreateForm){var ya=t.data("formProp");ya&&(ya.top=Math.max(ya.top,0),ya.left=Math.max(ya.left,0),a.extend(u,ya))}ya=!0;!u.checkOnUpdate||!0!==u.jqModal&&void 0!==u.jqModal||u.modal||(ya=!1);var U=isNaN(u.dataheight)?u.dataheight:u.dataheight+"px",V=isNaN(u.datawidth)?u.datawidth:u.datawidth+"px",z=a("<form name='FormPost' id='"+z+"' class='FormGrid' onSubmit='return false;' style='width:"+V+";overflow:auto;position:relative;height:"+U+";'></form>").data("disabled",!1),aa=a("<table id='"+
F+"' class='EditTable'"+(v.msie&&8>v.msiever()?" cellspacing='0'":"")+"><tbody></tbody></table>");a(Y).each(function(){var a=this.formoptions;ia=Math.max(ia,a?a.colpos||0:0);N=Math.max(N,a?a.rowpos||0:0)});a(z).append(aa);M=a("<tr id='FormError' style='display:none'><td class='"+M+"' colspan='"+2*ia+"'>&#160;</td></tr>");M[0].rp=0;a(aa).append(M);M=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*ia+"'>"+(u.topinfo||"&#160;")+"</td></tr>");M[0].rp=0;a(aa).append(M);if(L("beforeInitData",
z,T)){n();U=(M="rtl"===w.direction?!0:!1)?"nData":"pData";V=M?"pData":"nData";d(b,aa,ia);var U=ea.call(r,U,"",pa(Ba,u.prevIcon),"","left"),V=ea.call(r,V,"",pa(Ba,u.nextIcon),"","right"),ab=ea.call(r,"sData",u.bSubmit),Fa=ea.call(r,"cData",u.bCancel),F="<table"+(v.msie&&8>v.msiever()?" cellspacing='0'":"")+" class='EditTable' id='"+F+"_2'><tbody><tr><td colspan='2'><hr class='"+ba.call(r,"dialog.hr")+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton navButton-"+w.direction+
"'>"+(M?V+U:U+V)+"</td><td class='EditButton EditButton-"+w.direction+"'>"+ab+"&#160;"+Fa+"</td></tr>",F=F+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+(u.bottominfo||"&#160;")+"</td></tr>"),F=F+"</tbody></table>";if(0<N){var db=[];a.each(a(aa)[0].rows,function(a,b){db[a]=b});db.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(db,function(b,c){a("tbody",aa).append(c)})}u.gbox=K;var eb=!1;!0===u.closeOnEscape&&(u.closeOnEscape=!1,eb=!0);F=a("<div></div>").append(z).append(F);
za.call(r,I,F,u,w.gView,a(K)[0]);u.topinfo&&a(".tinfo",k).show();u.bottominfo&&a(".binfo",D).show();F=F=null;a(G).keydown(function(b){var c=(b.target.tagName||"").toUpperCase(),d,e;if(!0===a(E).data("disabled"))return!1;if(13===b.which&&"TEXTAREA"!==c){d=a(D).find(":focus");e=d.attr("id");if(0<d.length&&0<=a.inArray(e,["pData","nData","cData"]))return d.trigger("click"),!1;if(!0===u.savekey[0]&&13===u.savekey[1])return a("#sData",D).trigger("click"),!1}if(!0===u.savekey[0]&&b.which===u.savekey[1]&&
"TEXTAREA"!==c)return a("#sData",D).trigger("click"),!1;if(27===b.which){if(!l())return!1;eb&&fa(G,{gb:u.gbox,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form});return!1}if(!0===u.navkeys[0]){if("_empty"===a("#id_g",k).val())return!0;if(b.which===u.navkeys[1])return a("#pData",D).trigger("click"),!1;if(b.which===u.navkeys[2])return a("#nData",D).trigger("click"),!1}});u.checkOnUpdate&&(a("a.ui-jqdialog-titlebar-close span",G).removeClass("jqmClose"),a("a.ui-jqdialog-titlebar-close",
G).unbind("click").click(function(){if(!l())return!1;fa(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form});return!1}));La(a("#sData",D),u.saveicon,Ba);La(a("#cData",D),u.closeicon,Ba);if(u.checkOnSubmit||u.checkOnUpdate)ab=ea.call(r,"sNew",u.bYes),V=ea.call(r,"nNew",u.bNo),Fa=ea.call(r,"cNew",u.bExit),I=u.zIndex||999,I++,a("<div class='"+u.overlayClass+" jqgrid-overlay confirm' style='z-index:"+I+";display:none;'>&#160;</div><div class='"+ba.call(r,
...
formprop:!u.recreateForm,form:u.form});return!1});L("onInitializeForm",a(E),T);"_empty"!==b&&u.viewPagerButtons?a("#pData,#nData",D).show():a("#pData,#nData",D).hide();L("beforeShowForm",a(E),T);a(G).data("onClose",u.onClose);Ka(G,{gbox:K,jqm:u.jqModal,overlay:u.overlay,modal:u.modal,overlayClass:u.overlayClass,toTop:u.toTop,onHide:function(a){nb.call(t,"formProp",E,a)}});ya||a("."+H(u.overlayClass)).click(function(){if(!l())return!1;fa(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,
formprop:!u.recreateForm,form:u.form});return!1});a(".fm-button",G).hover(function(){a(this).addClass(X)},function(){a(this).removeClass(X)});a("#sData",D).click(function(){A={};a("#FormError",k).hide();e();"_empty"===A[x+"_id"]?h():!0===u.checkOnSubmit?(O=m(A,u._savedData))?(a(E).data("disabled",!0),a(".confirm",G).show()):h():h();return!1});a("#cData",D).click(function(){if(!l())return!1;fa(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form});
return!1});a("#nData",D).click(function(){if(!l())return!1;a("#FormError",k).hide();var b=q();b[0]=parseInt(b[0],10);if(-1!==b[0]&&b[1][b[0]+1]){if(!L("onclickPgButtons","next",a(E),b[1][b[0]]))return!1;f(b[1][b[0]+1],E);B.call(t,b[1][b[0]+1]);L("afterclickPgButtons","next",a(E),b[1][b[0]+1]);p(b[0]+1,b)}return!1});a("#pData",D).click(function(){if(!l())return!1;a("#FormError",k).hide();var b=q();if(-1!==b[0]&&b[1][b[0]-1]){if(!L("onclickPgButtons","prev",a(E),b[1][b[0]])||ca(a("#"+H(b[1][b[0]-1])),
S))return!1;f(b[1][b[0]-1],E);B.call(t,b[1][b[0]-1]);L("afterclickPgButtons","prev",a(E),b[1][b[0]-1]);p(b[0]-1,b)}return!1});L("afterShowForm",a(E),T);I=q();p(I[0],I)}}})},viewGridRow:function(b,c){return this.each(function(){function e(){!0!==q.closeOnEscape&&!0!==q.navkeys[0]||setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+H(u.modalhead)).attr("tabindex","-1").focus()},0)}function d(b,c,d){var e,f,g,h=0,k,p,r=[],t=C.getInd.call(l,b),u;u=ba.call(m,"dialog.viewData","DataTD form-view-data");
var w=ba.call(m,"dialog.viewLabel","CaptionTD form-view-label"),x="<td class='"+w+"' width='"+q.labelswidth+"'>&#160;</td><td class='"+u+" ui-helper-reset'>&#160;</td>",z="",w="<td class='"+w+"'></td><td class='"+u+"'></td>",D=["integer","number","currency"],E=0,y=0,B,I,G;for(u=1;u<=d;u++)z+=1===u?x:w;a(F).each(function(){(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==a.inArray(this.formatter,D)?E=Math.max(E,parseInt(this.width,
10)):y=Math.max(y,parseInt(this.width,10)))});B=0!==E?E:0!==y?y:0;a(F).each(function(b){e=this.name;I=!1;p=(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";G="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==e&&"subgrid"!==e&&"rn"!==e&&G){k=!1===t?"":v.getDataFieldOfCell.call(m,m.rows[t],b).html();I="right"===this.align&&0!==B?!0:!1;var l=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),q=parseInt(l.rowpos,10)||h+1,u=parseInt(2*
(parseInt(l.colpos,10)||1),10);if(l.rowabove){var w=a("<tr><td class='contentinfo' colspan='"+2*d+"'>"+l.rowcontent+"</td></tr>");a(c).append(w);w[0].rp=q}g=a(c).find("tr[data-rowpos="+q+"]");0===g.length&&(g=a("<tr "+p+" data-rowpos='"+q+"'></tr>").addClass("FormData").attr("id","trv_"+e),a(g).append(z),a(c).append(g),g[0].rp=q);l=void 0===l.label?n.colNames[b]:l.label;q=a("td:eq("+(u-1)+")",g[0]);a("td:eq("+(u-2)+")",g[0]).html("<b>"+(l||"&nbsp;")+"</b>");q[Sa(q.html())?"html":"append"]("<span>"+
(k||"&nbsp;")+"</span>").attr("id","v_"+e);I&&a("td:eq("+(u-1)+") span",g[0]).css({"text-align":"right",width:B+"px"});r[h]=b;h++}});0<h&&(b=a("<tr class='FormData' style='display:none'><td class='CaptionTD'>&#160;</td><td colspan='"+(2*d-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+b+"'/></td></tr>"),b[0].rp=h+99,a(c).append(b));return r}function f(b){var c,d,e=0,f=C.getInd.call(l,b,!0),g;f&&(a("td",f).each(function(b){g=F[b];c=g.name;d=g.editrules&&!0===
...
a("#nData",w).removeClass(K)}function h(){var b=C.getDataIDs.call(l),c=a("#id_g",t).val();return[a.inArray(c,b),b]}var m=this,l=a(m),n=m.p;if(m.grid&&null!=n&&b){var p=n.id,q=a.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,closeOnEscape:!1,labelswidth:"30%",navkeys:[!1,38,40],onClose:null,beforeShowForm:null,beforeInitData:null,viewPagerButtons:!0,recreateForm:!1,removemodal:!0,form:"view"},C.getGridRes.call(l,"view"),v.view||{},n.formViewing||
{},c||{}),r="#ViewGrid_"+H(p),t="#ViewTbl_"+H(p),w=t+"_2",x="ViewGrid_"+p,y="ViewTbl_"+p,B=q.commonIconClass,u={themodal:"viewmod"+p,modalhead:"viewhd"+p,modalcontent:"viewcnt"+p,resizeAlso:x},E="#"+H(u.themodal),z=n.gBox,F=n.colModel,k=1,D=0,I=function(){var b=a.makeArray(arguments);b.unshift("");b.unshift("View");b.unshift(q);return Wa.apply(m,b)},G=R.call(m,"hover"),K=R.call(m,"disabled");q.recreateForm||l.data("viewProp")&&a.extend(q,l.data("viewProp"));var p=isNaN(q.dataheight)?q.dataheight:
q.dataheight+"px",J=isNaN(q.datawidth)?q.datawidth:q.datawidth+"px",x=a("<form name='FormPost' id='"+x+"' class='FormGrid' style='width:"+J+";overflow:auto;position:relative;height:"+p+";'></form>"),Y=a("<table id='"+y+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");a(F).each(function(){var a=this.formoptions;k=Math.max(k,a?a.colpos||0:0);D=Math.max(D,a?a.rowpos||0:0)});x.append(Y);if(I("beforeInitData",x)){d(b,Y,k);var M=(p="rtl"===
n.direction?!0:!1)?"pData":"nData",J=ea.call(m,p?"nData":"pData","",pa(B,q.prevIcon),"","left"),M=ea.call(m,M,"",pa(B,q.nextIcon),"","right"),ia=ea.call(m,"cData",q.bClose);if(0<D){var N=[];a.each(a(Y)[0].rows,function(a,b){N[a]=b});N.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(N,function(b,c){a("tbody",Y).append(c)})}q.gbox=z;y=a("<div></div>").append(x).append("<table border='0' class='EditTable' id='"+y+"_2'><tbody><tr id='Act_Buttons'><td class='navButton navButton-"+n.direction+
"' width='"+(q.labelswidth||"auto")+"'>"+(p?M+J:J+M)+"</td><td class='EditButton EditButton-"+n.direction+"'>"+ia+"</td></tr></tbody></table>");za.call(m,u,y,q,n.gView,a(n.gView)[0]);q.viewPagerButtons||a("#pData, #nData",w).hide();y=null;a(E).keydown(function(b){var c,d;if(!0===a(r).data("disabled"))return!1;if(13===b.which&&(c=a(w).find(":focus"),d=c.attr("id"),0<c.length&&0<=a.inArray(d,["pData","nData","cData"])))return c.trigger("click"),!1;if(27===b.which)return q.closeOnEscape&&fa(E,{gb:z,
jqm:q.jqModal,onClose:q.onClose,removemodal:q.removemodal,formprop:!q.recreateForm,form:q.form}),!1;if(!0===q.navkeys[0]){if(b.which===q.navkeys[1])return a("#pData",w).trigger("click"),!1;if(b.which===q.navkeys[2])return a("#nData",w).trigger("click"),!1}});La(a("#cData",w),q.closeicon,B);I("beforeShowForm",a(r));Ka(E,{gbox:z,jqm:q.jqModal,overlay:q.overlay,toTop:q.toTop,modal:q.modal,onHide:function(a){nb.call(l,"viewProp",r,a)}});a(".fm-button:not(."+K.split(" ").join(".")+")",w).hover(function(){a(this).addClass(G)},
function(){a(this).removeClass(G)});e();a("#cData",w).click(function(){fa(E,{gb:z,jqm:q.jqModal,onClose:q.onClose,removemodal:q.removemodal,formprop:!q.recreateForm,form:q.form});return!1});a("#nData",w).click(function(){a("#FormError",t).hide();var b=h();b[0]=parseInt(b[0],10);if(-1!==b[0]&&b[1][b[0]+1]){if(!I("onclickPgButtons","next",a(r),b[1][b[0]]))return!1;f(b[1][b[0]+1]);C.setSelection.call(l,b[1][b[0]+1]);I("afterclickPgButtons","next",a(r),b[1][b[0]+1]);g(b[0]+1,b)}e();return!1});a("#pData",
w).click(function(){a("#FormError",t).hide();var b=h();if(-1!==b[0]&&b[1][b[0]-1]){if(!I("onclickPgButtons","prev",a(r),b[1][b[0]]))return!1;f(b[1][b[0]-1]);C.setSelection.call(l,b[1][b[0]-1]);I("afterclickPgButtons","prev",a(r),b[1][b[0]-1]);g(b[0]-1,b)}e();return!1});B=h();g(B[0],B)}}})},delGridRow:function(b,c){return this.each(function(){var e=this,d=e.p,f=a(e);if(e.grid&&null!=d&&b){var g=d.id,h=a.extend(!0,{top:0,left:0,width:240,removemodal:!0,height:"auto",dataheight:"auto",drag:!0,resize:!0,
url:"",mtype:"POST",reloadAfterSubmit:!0,beforeShowForm:null,beforeInitData:null,afterShowForm:null,beforeSubmit:null,onclickSubmit:null,afterSubmit:null,closeOnEscape:!1,delData:{},onClose:null,ajaxDelOptions:{},processing:!1,serializeDelData:null,useDataProxy:!1},C.getGridRes.call(f,"del"),v.del||{},d.formDeleting||{},c||{}),m="DelTbl_"+g,l="#DelTbl_"+H(g),n,p,q,r,t={themodal:"delmod"+g,modalhead:"delhd"+g,modalcontent:"delcnt"+g,resizeAlso:m},w="#"+H(t.themodal),x=d.gBox,y=h.commonIconClass,B=
function(){var b=a.makeArray(arguments);b.unshift("");b.unshift("Delete");b.unshift(h);return Wa.apply(e,b)},u=R.call(e,"hover"),E=R.call(e,"active"),z=R.call(e,"error");a.isArray(b)||(b=[String(b)]);if(void 0!==a(w)[0]){if(!B("beforeInitData",a(l)))return;a("#DelData>td",l).text(b.join()).data("rowids",b);a("#DelError",l).hide();!0===h.processing&&(h.processing=!1,a("#dData",l).removeClass(E));B("beforeShowForm",a(l));Ka(w,{gbox:x,jqm:h.jqModal,jqM:!1,overlay:h.overlay,toTop:h.toTop,modal:h.modal})}else{var F=
isNaN(h.dataheight)?h.dataheight:h.dataheight+"px",k=isNaN(h.datawidth)?h.datawidth:h.datawidth+"px",F="<div id='"+m+"' class='formdata' style='width:"+k+";overflow:auto;position:relative;height:"+F+";'><table class='DelTable'><tbody>",F=F+("<tr id='DelError' style='display:none'><td class='"+z+"'></td></tr>"),F=F+("<tr id='DelData' style='display:none'><td >"+b.join()+"</td></tr>"),F=F+("<tr><td class='delmsg' style='white-space:pre;'>"+h.msg+"</td></tr><tr><td >&#160;</td></tr>"),F=F+"</tbody></table></div>",
z=ea.call(e,"dData",h.bSubmit),k=ea.call(e,"eData",h.bCancel),F=F+("<table"+(v.msie&&8>v.msiever()?" cellspacing='0'":"")+" class='EditTable' id='"+m+"_2'><tbody><tr><td><hr class='"+ba.call(e,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton EditButton-"+d.direction+"'>"+z+"&#160;"+k+"</td></tr></tbody></table>");h.gbox=x;za.call(e,t,F,h,d.gView,a(d.gView)[0]);a("#DelData>td",l).data("rowids",b);if(!B("beforeInitData",a(F)))return;a(".fm-button",l+"_2").hover(function(){a(this).addClass(u)},
...
(b=h.afterSubmit.call(e,c,n));if(!1===b[0])a("#DelError>td",l).html(b[1]),a("#DelError",l).show();else{if(h.reloadAfterSubmit&&"local"!==d.datatype)f.trigger("reloadGrid",[a.extend({},h.reloadGridOptions||{})]);else if(!0===d.treeGrid)try{C.delTreeNode.call(f,t[0])}catch(p){}else for(t=t.slice(),k=0;k<t.length;k++)C.delRowData.call(f,t[k]);setTimeout(function(){B("afterComplete",c,m,a(l))},50)}h.processing=!1;b[0]&&fa(w,{gb:x,jqm:h.jqModal,onClose:h.onClose,removemodal:h.removemodal})}},v.ajaxOptions,
...
g.attr({tabindex:"0",href:"#",role:"button"});setTimeout(function(){g.focus()},50)}}(),u,E=function(b){if(13===b.which&&(b=a(this).find(".ui-pg-button").filter(":focus"),0<b.length))return b.trigger("click"),!1},z=R.call(m,"hover"),F=R.call(m,"disabled");if(m.grid){m.modalAlert=B;void 0===b&&(l.pager?(b=l.pager,l.toppager&&(q.cloneToTop=!0)):l.toppager&&(b=l.toppager));var k=1,D,I,G,K,J,Y=["left","center","right"],M="<div class='ui-pg-button "+F+"'><span class='ui-separator'></span></div>",ia=function(){ca(this,
F)||a(this).addClass(z)},N=function(){a(this).removeClass(z)},A=function(){ca(this,F)||(a.isFunction(q.addfunc)?q.addfunc.call(m):C.editGridRow.call(n,"new",d));return!1},O=function(b,c,d){if(!ca(this,F)){var e=l.selrow;e?a.isFunction(b)?b.call(m,e):C[c].call(n,e,d):B()}return!1},T=function(){return O.call(this,q.editfunc,"editGridRow",e)},Q=function(){return O.call(this,q.viewfunc,"viewGridRow",h)},W=function(){var b;ca(this,F)||(l.multiselect?(b=l.selarrrow,0===b.length&&(b=null)):b=l.selrow,b?
a.isFunction(q.delfunc)?q.delfunc.call(m,b):C.delGridRow.call(n,b,f):B());return!1},L=function(){ca(this,F)||(a.isFunction(q.searchfunc)?q.searchfunc.call(m,g):C.searchGrid.call(n,g));return!1},X=function(){if(!ca(this,F)){a.isFunction(q.beforeRefresh)&&q.beforeRefresh.call(m);l.search=!1;l.resetsearch=!0;try{if("currentfilter"!==q.refreshstate){l.postData.filters="";try{a("#fbox_"+t).jqFilter("resetFilter")}catch(b){}a.isFunction(m.clearToolbar)&&m.clearToolbar(!1)}}catch(b){}switch(q.refreshstate){case "firstpage":n.trigger("reloadGrid",
...
(q.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+k+"</span>":"")+"</div>");a(e).append(g);g.attr({title:q[b+"title"]||"",id:c||b+"_"+f}).click(d).hover(ia,N);return g};q.cloneToTop&&l.toppager&&(k=2);for(D=0;D<k;D++){u=a("<div class='ui-pg-table navtable' role='toolbar' style='float:"+("rtl"===l.direction?"right":"left")+";table-layout:auto;'></div>");0===D?(I=b,G=p,I===l.toppager&&(G+="_top",k=1)):(I=l.toppager,G=p+"_top");q.add&&S("add",d.id,A,u,G);q.edit&&S("edit",e.id,T,u,G);q.view&&S("view",
...
this,d=e.p;if(e.grid){var f=a.extend({caption:"newButton",title:"",onClickButton:null,position:"last",cursor:"pointer",iconsOverText:!1},C.getGridRes.call(a(e),"nav"),v.nav||{},d.navOptions||{},c||{}),g=R.call(e,"hover"),h=R.call(e,"disabled");if(void 0===b)if(d.pager)if(C.navButtonAdd.call(a(e),d.pager,f),d.toppager)b=d.toppager;else return;else d.toppager&&(b=d.toppager);"string"===typeof b&&0!==b.indexOf("#")&&(b="#"+H(b));var d=a(".navtable",b),m=f.commonIconClass;if(0<d.length&&!(f.id&&0<d.find("#"+
H(f.id)).length)){var l=a("<div tabindex='0' role='button'></div>");"NONE"===f.buttonicon.toString().toUpperCase()?a(l).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'>"+(f.caption?"<span class='ui-pg-button-text"+(f.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+f.caption+"</span>":"")+"</div>"):a(l).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'><span class='"+(f.iconsOverText?pa("ui-pg-button-icon-over-text",m,f.buttonicon):pa(m,f.buttonicon))+
...
b,p)});return!1},groupingRender:function(b,c){function e(b,c,d,e,h){var l=y[b],m,n="",p,q,t,w=0,z,x,E,F=!0;if(0!==c&&0!==y[b].idx)for(m=b;0<=m;m--)if(y[m].idx===y[b].idx-c){l=y[m];break}b=l.cnt;for(z=void 0===h?e:0;z<u;z++){c="&#160;";m=B[z];for(p=0;p<l.summary.length;p++)if(q=l.summary[p],x=a.isArray(q.st)?q.st[d.idx]:q.st,E=a.isArray(m.summaryTpl)?m.summaryTpl[d.idx]:m.summaryTpl||"{0}",q.nm===m.name){"string"===typeof x&&"avg"===x.toLowerCase()&&(q.sd&&q.vd?q.v/=q.vd:q.v&&0<b&&(q.v/=b));try{q.groupCount=
l.cnt,q.groupIndex=l.dataIndex,q.groupValue=l.value,t=f.formatter("",q.v,z,q)}catch(C){t=q.v}c=v.format(E,t);break}q=p=!1;void 0!==h&&F&&!m.hidden&&(c=h,F=!1,1<e&&(p=!0,w=e-1),q=m.align,m.align="rtl"===g.direction?"right":"left",r.iconColumnName=m.name);0<w&&!m.hidden&&"&#160;"===c?(q&&(m.align=q),w--):(n+="<td role='gridcell' "+f.formatCol(z,1,"")+(p?"colspan='"+e+"'":"")+">"+c+"</td>",q&&(m.align=q))}return n}var d="",f=this[0],g=f.p,h=0,m,l=[],n="",p,q,r=g.groupingView,t=a.makeArray(r.groupSummary),
w=(r.groupCollapse?r.plusicon:r.minusicon)+" tree-wrap",x=r.groupField.length,y=r.groups,B=g.colModel,u=B.length,E=g.page,z=C.getGuiStyles.call(f,"gridRow","jqgroup ui-row-"+g.direction),F=C.getGuiStyles.call(f,"gridRow","jqfoot ui-row-"+g.direction);a.each(B,function(a,b){var c;for(c=0;c<x;c++)if(r.groupField[c]===b.name){l[c]=a;break}});t.reverse();a.each(y,function(k,D){if(r._locgr&&!(D.startRow+D.cnt>(E-1)*c&&D.startRow<E*c))return!0;h++;q=g.id+"ghead_"+D.idx;p=q+"_"+k;n="<span style='cursor:pointer;margin-"+
("rtl"===g.direction?"right:":"left:")+12*D.idx+"px;' class='"+r.commonIconClass+" "+w+"' onclick=\"jQuery('#"+v.jqID(g.id).replace("\\","\\\\")+"').jqGrid('groupingToggle','"+p+"', this);return false;\"></span>";try{a.isArray(r.formatDisplayField)&&a.isFunction(r.formatDisplayField[D.idx])?(D.displayValue=r.formatDisplayField[D.idx].call(f,D.displayValue,D.value,B[l[D.idx]],D.idx,r),m=D.displayValue):m=f.formatter(p,D.displayValue,l[D.idx],D.value)}catch(C){m=D.displayValue}d+="<tr id='"+p+"' data-jqgrouplevel='"+
D.idx+"' "+(r.groupCollapse&&0<D.idx?"style='display:none;' ":"")+"role='row' class='"+z+" "+q+"'>";var I=a.isFunction(r.groupText[D.idx])?r.groupText[D.idx].call(f,m,D.cnt,D.summary):v.template(r.groupText[D.idx],m,D.cnt,D.summary),G=1,K,J,H;H=0;J=x-1===D.idx;"string"!==typeof I&&"number"!==typeof I&&(I=m);"header"===r.groupSummaryPos[D.idx]?(G=1,"cb"!==B[0].name&&"cb"!==B[1].name||G++,"subgrid"!==B[0].name&&"subgrid"!==B[1].name||G++,d+=e(k,0,D,G,n+"<span class='cell-wrapper'>"+I+"</span>")):d+=
"<td role='gridcell' style='padding-left:"+12*D.idx+"px;' colspan='"+u+"'>"+n+I+"</td>";d+="</tr>";if(J){I=y[k+1];J=D.startRow;G=void 0!==I?I.startRow:y[k].startRow+y[k].cnt;r._locgr&&(H=(E-1)*c,H>D.startRow&&(J=H));for(;J<G&&b[J-H];J++)d+=b[J-H].join("");if("header"!==r.groupSummaryPos[D.idx]){if(void 0!==I){for(K=0;K<r.groupField.length&&I.dataIndex!==r.groupField[K];K++);h=r.groupField.length-K}for(H=0;H<h;H++)t[H]&&(d+="<tr data-jqfootlevel='"+(D.idx-H)+(r.groupCollapse&&(0<D.idx-H||!r.showSummaryOnHide)?
"' style='display:none;'":"'")+" role='row' class='"+F+"'>",d+=e(k,H,y[D.idx-H],0),d+="</tr>");h=K}}});this.unbind("jqGridShowHideCol.groupingRender").bind("jqGridShowHideCol.groupingRender",function(){var b=g.iColByName[r.iconColumnName],c,d,e;if(0<=a.inArray("header",r.groupSummaryPos)){for(c=0;c<B.length;c++)if(!B[c].hidden){e=c;break}if(void 0!==e&&b!==e){for(c=0;c<f.rows.length;c++)d=f.rows[c],a(d).hasClass("jqgroup")&&(a(d.cells[e]).html(d.cells[b].innerHTML),a(d.cells[b]).html("&nbsp;"));r.iconColumnName=
B[e].name}}});return d},groupingGroupBy:function(b,c){return this.each(function(){var e=this.p,d=e.groupingView,f,g;"string"===typeof b&&(b=[b]);e.grouping=!0;d._locgr=!1;void 0===d.visibiltyOnNextGrouping&&(d.visibiltyOnNextGrouping=[]);for(f=0;f<d.groupField.length;f++)g=e.colModel[e.iColByName[d.groupField[f]]],!d.groupColumnShow[f]&&d.visibiltyOnNextGrouping[f]&&null!=g&&!0===g.hidden&&C.showCol.call(a(this),d.groupField[f]);for(f=0;f<b.length;f++)d.visibiltyOnNextGrouping[f]=a(e.idSel+"_"+v.jqID(b[f])).is(":visible");
e.groupingView=a.extend(e.groupingView,c||{});d.groupField=b;a(this).trigger("reloadGrid")})},groupingRemove:function(b){return this.each(function(){var c=this.p,e=this.tBodies[0],d=c.groupingView;void 0===b&&(b=!0);c.grouping=!1;if(!0===b){for(c=0;c<d.groupField.length;c++)!d.groupColumnShow[c]&&d.visibiltyOnNextGrouping[c]&&C.showCol.call(a(this),d.groupField);a("tr.jqgroup, tr.jqfoot",e).remove();a("tr.jqgrow",e).filter(":hidden").show()}else a(this).trigger("reloadGrid")})},groupingCalculations:{handler:function(a,
...
focusField:!0},v.inlineEdit,e.inlineEditing||{},p),q=d.jqGrid("getInd",b,!0),k=n.focusField,D="object"===typeof k&&null!=k?a(k.target||k).closest("tr.jqgrow>td")[0]:null;if(!1!==q&&(n.extraparam[m.oper]===m.addoper||Ya.call(c,n,"beforeEditRow",n,b))&&"0"===(a(q).attr("editable")||"0")&&!a(q).hasClass("not-editable-row")){m=v.detectRowEditing.call(c,b);if(null!=m&&"cellEditing"===m.mode){var m=m.savedRow,I=c.rows[m.id],G=R.call(c,"select");d.jqGrid("restoreCell",m.id,m.ic);a(I.cells[m.ic]).removeClass("edit-cell "+
G);a(I).addClass(G).attr({"aria-selected":"true",tabindex:"0"})}v.enumEditableCells.call(c,q,a(q).hasClass("jqgrid-new-row")?"add":"edit",function(d){var k=d.cm,l=a(d.dataElement),m=d.dataWidth,n,p=k.name,q=k.edittype,t=d.iCol,u=k.editoptions||{};if("hidden"!==d.editable){try{n=a.unformat.call(this,d.td,{rowId:b,colModel:k},t)}catch(z){n="textarea"===q?l.text():l.html()}h[p]=n;l.html("");k=a.extend({},u,{id:b+"_"+p,name:p,rowId:b,mode:d.mode});if("&nbsp;"===n||"&#160;"===n||1===n.length&&160===n.charCodeAt(0))n=
...
ajaxSaveOptions:{},serializeSaveData:null,mtype:"POST",saveui:"enable",savetext:l("defaults.savetext")||"Saving..."},v.inlineEdit,r.inlineEditing||{},n),w={},x={},y={},B,u,E,z;E=q.jqGrid("getInd",b,!0);var F=a(E);B=r.prmNames;var k=l("errors.errcap"),D=l("edit.bClose"),I;if(!1!==E&&(l=n.extraparam[B.oper]===B.addoper?"add":"edit",Ya.call(p,n,"beforeSaveRow",n,b,l)&&(B=F.attr("editable"),n.url=n.url||r.editurl,I="clientArray"!==n.url,"1"===B)))if(v.enumEditableCells.call(p,E,F.hasClass("jqgrid-new-row")?
"add":"edit",function(c){var d=c.cm,e=d.formatter,f=d.editoptions||{},g=d.formatoptions||{},h={},k=(a.jgrid.detectRowEditing.call(p,b)||{}).savedRow,l=v.getEditedValue.call(p,a(c.dataElement),d,h,c.editable);"select"===d.edittype&&"select"!==d.formatter&&(x[d.name]=h.text);z=v.checkValues.call(p,l,c.iCol,void 0,void 0,a.extend(c,{oldValue:null!=k?k[d.name]:null,newValue:l,oldRowData:k}));if(!1===z[0])return!1;"date"===e&&!0!==g.sendFormatted&&(l=a.unformat.date.call(p,l,d));I&&!0===f.NullIfEmpty&&
""===l&&(l="null");w[d.name]=l}),!1===z[0])try{var G=q.jqGrid("getGridRowById",b),C=v.findPos(G);t.call(p,k,z[1],D,{left:C[0],top:C[1]+a(G).outerHeight()})}catch(J){alert(z[1])}else if(G=b,B=r.prmNames,C=!1===r.keyName?B.id:r.keyName,w&&(w[B.oper]=B.editoper,void 0===w[C]||""===w[C]?w[C]=b:E.id!==r.idPrefix+w[C]&&(E=v.stripPref(r.idPrefix,b),void 0!==r._index[E]&&(r._index[w[C]]=r._index[E],delete r._index[E]),b=r.idPrefix+w[C],F.attr("id",b),r.selrow===G&&(r.selrow=b),a.isArray(r.selarrrow)&&(E=
a.inArray(G,r.selarrrow),0<=E&&(r.selarrrow[E]=b)),r.multiselect&&(E="jqg_"+r.id+"_"+b,F.find("input.cbox").attr("id",E).attr("name",E))),w=a.extend({},w,r.inlineData||{},n.extraparam)),I)q.jqGrid("progressBar",{method:"show",loadtype:n.saveui,htmlcontent:n.savetext}),y=a.extend({},w,y),y[C]=v.stripPref(r.idPrefix,y[C]),r.autoEncodeOnEdit&&a.each(y,function(b,c){a.isFunction(c)||(y[b]=v.oldEncodePostedData(c))}),a.ajax(a.extend({url:a.isFunction(n.url)?n.url.call(p,y[C],l,y,n):n.url,data:v.serializeFeedback.call(p,
a.isFunction(n.serializeSaveData)?n.serializeSaveData:r.serializeRowData,"jqGridInlineSerializeSaveData",y),type:a.isFunction(n.mtype)?n.mtype.call(p,l,n,y[C],y):n.mtype,complete:function(c,d){q.jqGrid("progressBar",{method:"hide",loadtype:n.saveui,htmlcontent:n.savetext});if((300>c.status||304===c.status)&&(0!==c.status||4!==c.readyState)){var e,f;f=q.triggerHandler("jqGridInlineSuccessSaveRow",[c,b,n]);a.isArray(f)||(f=[!0,w]);f[0]&&a.isFunction(n.successfunc)&&(f=n.successfunc.call(p,c));a.isArray(f)?
...
d.groupHeader,t={},w,x,y,B,u;if(null!=r&&null!=r.groupHeaders)for(w=0,y=r.groupHeaders.length;w<y;w++)for(u=r.groupHeaders[w],x=0;x<u.numberOfColumns;x++)B=d.iColByName[u.startColumnName]+x,t[B]=a.isFunction(b.buildItemText)?b.buildItemText.call(e[0],{iCol:B,cm:p[B],cmName:p[B].name,colName:n[B],groupTitleText:u.titleText}):a.jgrid.stripHtml(u.titleText)+": "+a.jgrid.stripHtml(""===n[B]?p[B].name:n[B]);for(B=0;B<l;B++)void 0===t[B]&&(t[B]=a.isFunction(b.buildItemText)?b.buildItemText.call(e[0],{iCol:B,
cm:p[B],cmName:p[B].name,colName:n[B],groupTitleText:null}):a.jgrid.stripHtml(n[B]));a.each(p,function(a){h[this.name]=a;this.hidedlg?this.hidden||m.push(a):g.append("<option value='"+a+"'"+(d.headertitles||this.headerTitle?" title='"+v.stripHtml("string"===typeof this.headerTitle?this.headerTitle:t[a])+"'":"")+(this.hidden?"":" selected='selected'")+">"+t[a]+"</option>")});l=a.isFunction(b.dlog_opts)?b.dlog_opts.call(e,b):b.dlog_opts;c(b.dlog,f,l);l=a.isFunction(b.msel_opts)?b.msel_opts.call(e,b):
...
data:b},c||{}),l,n,p,q=b.length,r,t,w,x,y,B,u=m.xDimension,E=m.yDimension,z=m.aggregates,F,q=m.totalText||m.totals||m.rowTotals||m.totalHeader,k,D=d(u)?u.length:0;x=d(E)?E.length:0;var C=d(z)?z.length:0,G=x-(1===C?1:0),H=[],J=[],M=[],d=[],Q=Array(C),V=Array(x),N,A,O,T,U,W,L,X,S,aa,R;n=function(c,d,e){c=new na(m.trimByCollect,m.caseSensitive,d,c);a.isFunction(e)&&(c.compareVectorsEx=e);c.createDataIndex(b);return c};var ba=function(b,c,d,f,g){var h,k;switch(b){case 1:h=E[f].totalText||"{0} {1} {2}";
k="y"+g+"t"+f;break;case 2:h=m.totalText||"{0}";k="t";break;default:h=1<C?c.label||"{0}":R.getItem(g)[f],k="y"+g}b=a.extend({},c,{name:k+(1<C?"a"+d:""),label:a.isFunction(h)?h.call(e,2===b?{aggregate:c,iAggregate:d,pivotOptions:m}:{yIndex:R.getItem(g),aggregate:c,iAggregate:d,yLevel:f,pivotOptions:m}):v.template.apply(e,2===b?[h,c.aggregator,c.member,d]:[h,c.aggregator,c.member,R.getItem(g)[f],f])});delete b.member;delete b.aggregator;return b};y=function(a,b,c){var d,e;for(d=0;d<C;d++)e=z[d],void 0===
e.template&&void 0===e.formatter&&m.defaultFormatting&&(e.template="count"===e.aggregator?"integer":"number"),M.push(ba(a,e,d,b,c))};N=function(b,c,d){var f,g,h,k;for(f=G-1;f>=c;f--)if(J[f]){for(g=0;g<=f;g++)S=H[g].groupHeaders,S[S.length-1].numberOfColumns+=C;r=E[f];h=r.totalHeader;k=r.headerOnTop;for(g=f+1;g<=G-1;g++)H[g].groupHeaders.push({titleText:k&&g===f+1||!k&&g===G-1?a.isFunction(h)?h.call(e,d,f):v.template.call(e,h||"",d[f],f):"",startColumnName:"y"+(b-1)+"t"+f+(1===C?"":"a0"),numberOfColumns:C})}};
var ca=function(a){a=new va("count"===z[a].aggregator?"sum":z[a].aggregator,e,c);a.groupInfo={iRows:[],rows:[],ys:[],iYs:[]};return a},fa=function(){var a,b;for(a=G-1;0<=a;a--)if(J[a])for(null==V[a]&&(V[a]=Array(C)),b=0;b<C;b++)V[a][b]=ca(b)},ea=function(a,b,c,d){var e,f=R.getIndexOfDifferences(b,c),g,h;if(null!==c)for(f=Math.max(f,0),e=G-1;e>=f;e--)g="y"+a+"t"+e+(1<C?"a"+d:""),J[e]&&void 0===L[g]&&(h=V[e][d],h.getResult(L,g),L.pivotInfos[g]={colType:1,iA:d,a:z[d],level:e,iRows:h.groupInfo.iRows,
rows:h.groupInfo.rows,ys:h.groupInfo.ys,iYs:h.groupInfo.iYs},b!==c&&(V[e][d]=ca(d)))},ga=function(c,d,e,f,g,h,k){var l;if(c!==d)for(d=G-1;0<=d;d--)J[d]&&(l=V[d][f],l.calc(g[e.member],e.member,g,h,b),l=l.groupInfo,0>a.inArray(k,l.iYs)&&(l.iYs.push(k),l.ys.push(c)),0>a.inArray(h,l.iRows)&&(l.iRows.push(h),l.rows.push(g)))};if(0===D||0===C)throw"xDimension or aggregates options are not set!";aa=n(u,m.skipSortByX,m.compareVectorsByX);R=n(E,m.skipSortByY,m.compareVectorsByY);c.xIndex=aa;c.yIndex=R;for(n=
0;n<D;n++)p=u[n],t={name:"x"+n,label:null!=p.label?a.isFunction(p.label)?p.label.call(e,p,n,m):p.label:p.dataName,frozen:m.frozenStaticCols},n<D-1&&(g.groupField.push(t.name),g.groupSummary.push(m.groupSummary),g.groupSummaryPos.push(m.groupSummaryPos)),t=a.extend(t,p),delete t.dataName,delete t.footerText,M.push(t);2>D&&(h.grouping=!1);h.sortname=M[D-1].name;g.hideFirstGroupCol=!0;for(n=0;n<x;n++)r=E[n],J.push(r.totals||r.rowTotals||r.totalText||r.totalHeader?!0:!1);X=R.getItem(0);y(0,x-1,0);g=R.getIndexLength();
for(t=1;t<g;t++){O=R.getItem(t);n=R.getIndexOfDifferences(O,X);for(p=G-1;p>=n;p--)J[p]&&y(1,p,t-1);X=O;y(0,x-1,t)}for(n=G-1;0<=n;n--)J[n]&&y(1,n,g-1);q&&y(2);X=R.getItem(0);for(p=0;p<G;p++)H.push({useColSpanStyle:m.useColSpanStyle,groupHeaders:[{titleText:X[p],startColumnName:1===C?"y0":"y0a0",numberOfColumns:C}]});for(t=1;t<g;t++){O=R.getItem(t);n=R.getIndexOfDifferences(O,X);N(t,n,X);for(p=G-1;p>=n;p--)H[p].groupHeaders.push({titleText:O[p],startColumnName:"y"+t+(1===C?"":"a0"),numberOfColumns:C});
for(p=0;p<n;p++)S=H[p].groupHeaders,S[S.length-1].numberOfColumns+=C;X=O}N(g,0,X);if(q)for(n=0;n<G;n++)H[n].groupHeaders.push({titleText:n<G-1?"":m.totalHeader||"",startColumnName:"t"+(1===C?"":"a0"),numberOfColumns:C});N=aa.getIndexLength();for(x=0;x<N;x++){p=aa.getItem(x);y={iX:x,x:p};L={pivotInfos:y};for(n=0;n<D;n++)L["x"+n]=p[n];A=aa.getIndexesOfSourceData(x);if(q)for(p=0;p<C;p++)Q[p]=ca(p);X=null;fa();for(t=0;t<g;t++){O=R.getItem(t);T=R.getIndexesOfSourceData(t);for(p=0;p<C;p++){null!==X&&ea(t-
1,O,X,p);U=[];for(n=0;n<T.length;n++)w=T[n],0<=a.inArray(w,A)&&U.push(w);if(0<U.length){B=Array(U.length);W=z[p];F=new va(W.aggregator,e,c);for(w=0;w<U.length;w++)n=U[w],l=b[n],B[w]=l,F.calc(l[W.member],W.member,l,n,b),q&&(k=Q[p],k.calc(l[W.member],W.member,l,n,b),k=k.groupInfo,0>a.inArray(n,k.iYs)&&(k.iYs.push(t),k.ys.push(O)),0>a.inArray(n,k.iRows)&&(k.iRows.push(n),k.rows.push(l))),ga(O,X,W,p,l,n,t);l="y"+t+(1===C?"":"a"+p);F.getResult(L,l);y[l]={colType:0,iY:t,y:O,iA:p,a:W,iRows:U,rows:B}}}X=
O}if(null!==X)for(p=0;p<C;p++)ea(g-1,X,X,p);if(q)for(p=0;p<C;p++)l="t"+(1===C?"":"a"+p),k=Q[p],k.getResult(L,l),k=k.groupInfo,y[l]={colType:2,iA:p,a:z[p],iRows:k.iRows,rows:k.rows,iYs:k.iYs,ys:k.ys};d.push(L)}if(m.footerTotals||m.colTotals){q=d.length;for(n=0;n<D;n++)f["x"+n]=u[n].footerText||"";for(n=D;n<M.length;n++){l=M[n].name;F=new va(m.footerAggregator||"sum",e,c);for(w=0;w<q;w++)L=d[w],F.calc(L[l],l,L,w,d);F.getResult(f,l)}}c.colHeaders=H;return{colModel:M,options:c,rows:d,groupOptions:h,groupHeaders:H,
...
e=a.isFunction(g.hasSubgrid)?g.hasSubgrid.call(f,{rowid:e,iRow:c,iCol:b,data:d}):!0;return null==f||null==f.p||null==g?"":"<td role='gridcell' class='"+C.getGuiStyles.call(this,"subgrid.tdStart",e?"ui-sgcollapsed sgcollapsed":"")+"' "+f.formatCol(b,c)+">"+(e?"<a style='cursor:pointer;'><span class='"+v.mergeCssClasses(g.commonIconClass,g.plusicon)+"'></span></a>":"&nbsp;")+"</td>"},addSubGrid:function(b,c){return this.each(function(){var e=this,d=e.p,f=d.subGridModel[0],g=function(a,b){return C.getGuiStyles.call(e,
...
d.subGridOptions.selectOnCollapse&&a(e).jqGrid("setSelection",g)}return!1},y,B,u=1;if(e.grid){y=e.rows.length;void 0!==c&&0<c&&(u=c,y=c+1);for(;u<y;)B=e.rows[u],a(B).hasClass("jqgrow")&&(B=a(B.cells[b]),B.hasClass("ui-sgcollapsed")&&(d.scroll&&B.unbind("click"),B.bind("click",g))),u++;!0===d.subGridOptions.expandOnLoad&&a(e.rows).filter(".jqgrow").each(function(b,c){a(c.cells[0]).click()});e.subGridXml=function(a,b){w(a,b,r)};e.subGridJson=function(a,b){w(a,b,t)}}})},expandSubGridRow:function(a){return ob.call(this,
...
if(Da.call(this,"beforeExpandRow",{rowid:f,item:b})){var g=C.getNodeChildren.call(c,b);a(g).each(function(){var b=e.idPrefix+oa(this,e.localReader.id);a(C.getGridRowById.call(c,b)).css("display","");this[d]&&C.expandRow.call(c,this)});Da.call(this,"afterExpandRow",{rowid:f,item:b})}}})},collapseRow:function(b){this.each(function(){var c=a(this),e=this.p;if(this.grid&&e.treeGrid){var d=e.treeReader.expanded_field,f=b[e.localReader.id];if(Da.call(this,"beforeCollapseRow",{rowid:f,item:b})){var g=C.getNodeChildren.call(c,
b);a(g).each(function(){var b=e.idPrefix+oa(this,e.localReader.id);a(C.getGridRowById.call(c,b)).css("display","none");this[d]&&C.collapseRow.call(c,this)});Da.call(this,"afterCollapseRow",{rowid:f,item:b})}}})},getRootNodes:function(){var b=[];this.each(function(){var c=this.p;if(this.grid&&c.treeGrid)switch(c.treeGridModel){case "nested":var e=c.treeReader.level_field;a(c.data).each(function(){parseInt(this[e],10)===parseInt(c.tree_root_level,10)&&b.push(this)});break;case "adjacency":var d=c.treeReader.parent_id_field;
a(c.data).each(function(){null!==this[d]&&"null"!==String(this[d]).toLowerCase()||b.push(this)})}});return b},getNodeDepth:function(b){var c=null;this.each(function(){var e=this.p;if(this.grid&&e.treeGrid)switch(e.treeGridModel){case "nested":c=parseInt(b[e.treeReader.level_field],10)-parseInt(e.tree_root_level,10);break;case "adjacency":c=C.getNodeAncestors.call(a(this),b).length}});return c},getNodeParent:function(b){var c=this[0];if(!c||!c.grid||null==c.p||!c.p.treeGrid||null==b)return null;var c=
...
return c},getNodeAncestors:function(b){var c=[];this.each(function(){var e=a(this),d=C.getNodeParent;if(this.grid&&this.p.treeGrid)for(var f=d.call(e,b);f;)c.push(f),f=d.call(e,f)});return c},isVisibleNode:function(b){var c=!0;this.each(function(){var e=this.p;if(this.grid&&e.treeGrid){var d=C.getNodeAncestors.call(a(this),b),f=e.treeReader.expanded_field;a(d).each(function(){c=c&&this[f];if(!c)return!1})}});return c},isNodeLoaded:function(b){var c;this.each(function(){var e=this.p;if(this.grid&&
e.treeGrid){var d=e.treeReader.leaf_field,e=e.treeReader.loaded;c=void 0!==b?void 0!==b[e]?b[e]:b[d]||0<C.getNodeChildren.call(a(this),b).length?!0:!1:!1}});return c},expandNode:function(b){return this.each(function(){var c=this.p;if(this.grid&&c.treeGrid){var e=c.treeReader.expanded_field,d=c.treeReader.parent_id_field,f=c.treeReader.loaded,g=c.treeReader.level_field,h=c.treeReader.left_field,m=c.treeReader.right_field;if(!b[e]){var l=oa(b,c.localReader.id);if(Da.call(this,"beforeExpandNode",{rowid:l,
item:b})){var n=a("#"+c.idPrefix+H(l),this.grid.bDiv)[0],p=c._index[l];"local"===c.treedatatype||C.isNodeLoaded.call(a(this),c.data[p])?(b[e]=!0,a("div.treeclick",n).removeClass(c.treeIcons.plus+" tree-plus").addClass(c.treeIcons.commonIconClass).addClass(c.treeIcons.minus+" tree-minus")):this.grid.hDiv.loading||(b[e]=!0,a("div.treeclick",n).removeClass(c.treeIcons.plus+" tree-plus").addClass(c.treeIcons.commonIconClass).addClass(c.treeIcons.minus+" tree-minus"),c.treeANode=n.rowIndex,c.datatype=
c.treedatatype,C.setGridParam.call(a(this),{postData:"nested"===c.treeGridModel?{nodeid:l,n_level:b[g],n_left:b[h],n_right:b[m]}:{nodeid:l,n_level:b[g],parentid:b[d]}}),a(this).trigger("reloadGrid"),b[f]=!0,C.setGridParam.call(a(this),{postData:"nested"===c.treeGridModel?{nodeid:"",n_level:"",n_left:"",n_right:""}:{nodeid:"",n_level:"",parentid:""}}));Da.call(this,"afterExpandNode",{rowid:l,item:b})}}}})},collapseNode:function(b){return this.each(function(){var c=this.p;if(this.grid&&c.treeGrid){var e=
c.treeReader.expanded_field;if(b[e]){var d=oa(b,c.localReader.id);Da.call(this,"beforeCollapseNode",{rowid:d,item:b})&&(b[e]=!1,e=a("#"+c.idPrefix+H(d),this.grid.bDiv)[0],a("div.treeclick",e).removeClass(c.treeIcons.minus+" tree-minus").addClass(c.treeIcons.commonIconClass).addClass(c.treeIcons.plus+" tree-plus"),Da.call(this,"afterCollapseNode",{rowid:d,item:b}))}}})},SortTree:function(b,c,e,d){return this.each(function(){var f=this,g=f.p,h=a(f);if(f.grid&&g.treeGrid){var m,l,n,p=[];m=C.getRootNodes.call(h);
m=v.from.call(f,m);m.orderBy(b,c,e,d);var q=m.select();m=0;for(l=q.length;m<l;m++)n=q[m],p.push(n),C.collectChildrenSortTree.call(h,p,n,b,c,e,d);a.each(p,function(b){var c=oa(this,g.localReader.id);a(f.rows[b]).after(h.find(">tbody>tr#"+H(c)))})}})},collectChildrenSortTree:function(b,c,e,d,f,g){return this.each(function(){var h=a(this);if(this.grid&&this.p.treeGrid){var m,l,n;m=C.getNodeChildren.call(h,c);m=v.from.call(this,m);m.orderBy(e,d,f,g);var p=m.select();m=0;for(l=p.length;m<l;m++)n=p[m],
b.push(n),C.collectChildrenSortTree.call(h,b,n,e,d,f,g)}})},setTreeRow:function(b,c){var e=!1;this.each(function(){this.grid&&this.p.treeGrid&&(e=C.setRowData.call(a(this),b,c))});return e},delTreeNode:function(b){return this.each(function(){var c=this.p,e,d,f,g;f=c.localReader.id;var h,m=a(this),l=c.treeReader.left_field,n=c.treeReader.right_field;if(this.grid&&c.treeGrid&&(h=c._index[b],void 0!==h)){e=parseInt(c.data[h][n],10);d=e-parseInt(c.data[h][l],10)+1;var p=C.getFullTreeNode.call(m,c.data[h]);
if(0<p.length)for(h=0;h<p.length;h++)C.delRowData.call(m,p[h][f]);if("nested"===c.treeGridModel){f=v.from.call(this,c.data).greater(l,e,{stype:"integer"}).select();if(f.length)for(g in f)f.hasOwnProperty(g)&&(f[g][l]=parseInt(f[g][l],10)-d);f=v.from.call(this,c.data).greater(n,e,{stype:"integer"}).select();if(f.length)for(g in f)f.hasOwnProperty(g)&&(f[g][n]=parseInt(f[g][n],10)-d)}}})},addChildNode:function(b,c,e,d){var f=a(this),g=f[0],h=g.p,m=C.getInd;if(e){var l,n,p,q,r;l=0;var t=c,w,x,y=h.treeReader.expanded_field;
x=h.treeReader.leaf_field;var B=h.treeReader.level_field,u=h.treeReader.parent_id_field,E=h.treeReader.left_field,z=h.treeReader.right_field,F=h.treeReader.loaded;void 0===d&&(d=!1);if(null==b){r=h.data.length-1;if(0<=r)for(;0<=r;)l=Math.max(l,parseInt(h.data[r][h.localReader.id],10)),r--;b=l+1}var k=m.call(f,c);w=!1;if(void 0===c||null===c||""===c)t=c=null,l="last",q=h.tree_root_level,r=h.data.length+1;else{l="after";n=h._index[c];p=h.data[n];c=p[h.localReader.id];r=m.call(f,c);q=parseInt(p[B],10)+
1;var D=C.getFullTreeNode.call(f,p);if(D.length){var H,G,K;for(H=0;H<D.length;H++)K=D[H][h.localReader.id],G=m.call(f,K),G>r&&(r=G,t=K)}r++;p[x]&&(w=!0,p[y]=!0,a(g.rows[k]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(h.treeIcons.leaf+" tree-leaf").addClass(h.treeIcons.commonIconClass).addClass(h.treeIcons.minus+" tree-minus"),h.data[n][x]=!1,p[F]=!0)}m=r+1;void 0===e[y]&&(e[y]=!1);void 0===e[F]&&(e[F]=!1);e[B]=q;void 0===
e[x]&&(e[x]=!0);"adjacency"===h.treeGridModel&&(e[u]=c);if("nested"===h.treeGridModel){var J;if(null!==c){x=parseInt(p[z],10);h=v.from.call(g,h.data);h=h.greaterOrEquals(z,x,{stype:"integer"});B=h.select();if(B.length)for(J in B)B.hasOwnProperty(J)&&(B[J][E]=B[J][E]>x?parseInt(B[J][E],10)+2:B[J][E],B[J][z]=B[J][z]>=x?parseInt(B[J][z],10)+2:B[J][z]);e[E]=x;e[z]=x+1}else{x=parseInt(C.getCol.call(f,z,!1,"max"),10);B=v.from.call(g,h.data).greater(E,x,{stype:"integer"}).select();if(B.length)for(J in B)B.hasOwnProperty(J)&&
(B[J][E]=parseInt(B[J][E],10)+2);B=v.from.call(g,h.data).greater(z,x,{stype:"integer"}).select();if(B.length)for(J in B)B.hasOwnProperty(J)&&(B[J][z]=parseInt(B[J][z],10)+2);e[E]=x+1;e[z]=x+2}}if(null===c||C.isNodeLoaded.call(f,p)||w)C.addRowData.call(f,b,e,l,t),C.setTreeNode.call(f,r,m);p&&!p[y]&&d&&a(g.rows[k]).find("div.treeclick").click()}}});var sa="mousedown",la="mousemove",Aa="mouseup",yb=function(a){var c=a.originalEvent.targetTouches;return c?(c=c[0],{x:c.pageX,y:c.pageY}):{x:a.pageX,y:a.pageY}},
Ma={drag:function(a){var c=a.data,e=c.e,d=c.dnr,f=c.ar,c=c.dnrAr;a=yb(a);"move"===d.k?e.css({left:d.X+a.x-d.pX,top:d.Y+a.y-d.pY}):(e.css({width:Math.max(a.x-d.pX+d.W,0),height:Math.max(a.y-d.pY+d.H,0)}),c&&f.css({width:Math.max(a.x-c.pX+c.W,0),height:Math.max(a.y-c.pY+c.H,0)}));return!1},stop:function(){a(document).unbind(la,Ma.drag).unbind(Aa,Ma.stop)}},zb=function(b,c,e,d){return b.each(function(){c=c?a(c,b):b;c.bind(sa,{e:b,k:e},function(b){var c=b.data,e={},m,l,n=function(a,b){return parseInt(a.css(b),
...
n(l,"height")||0,pX:p.x,pY:p.y,k:c.k}:!1;c=b.find("input.hasDatepicker");if(0<c.length)try{c.datepicker("hide")}catch(q){}b={e:b,dnr:m,ar:l,dnrAr:e};a(document).bind(la,b,Ma.drag);a(document).bind(Aa,b,Ma.stop);return!1}})})};window.PointerEvent?(sa+=".jqGrid pointerdown.jqGrid",la+=".jqGrid pointermove.jqGrid",Aa+=".jqGrid pointerup.jqGrid"):window.MSPointerEvent?(sa+=".jqGrid mspointerdown.jqGrid",la+=".jqGrid mspointermove.jqGrid",Aa+=".jqGrid mspointerup"):(sa+=".jqGrid touchstart.jqGrid",la+=
...
{}));g.target&&(h="target="+n(g.target));f=n(g.baseLinkUrl)+n(g.showAction);m=g.idName?encodeURIComponent(n(g.idName))+"="+encodeURIComponent(n(g.rowId)||c.rowId):"";l=n(g.addParam);"object"===typeof l&&null!==l&&(l=(""!==m?"&":"")+a.param(l));f+=m||l?"?"+m+l:"";""===f&&(f=n(g.hrefDefaultValue));return"string"===typeof b||U.isNumber(b)||a.isFunction(g.cellValue)?"<a "+h+' href="'+f+'">'+(a.isFunction(g.cellValue)?n(g.cellValue):b)+"</a>":ua(b,g)};M.showlink.getCellBuilder=function(b){var c={baseLinkUrl:b.baseLinkUrl,
...
null!==n&&(n=(""!==d?"&":"")+a.param(n));l+=d||n?"?"+d+n:"";""===l&&(l=p(c.hrefDefaultValue));return"string"===typeof b||U.isNumber(b)||a.isFunction(c.cellValue)?"<a "+m+' href="'+l+'">'+(a.isFunction(c.cellValue)?p(c.cellValue):b)+"</a>":ua(b,c)}};M.showlink.pageFinalization=function(b){var c=a(this),e=this.p,d=e.colModel[b],f,g=this.rows,h=g.length,m,l=function(e){var f=a(this).closest(".jqgrow");if(0<f.length)return d.formatoptions.onClick.call(c[0],{iCol:b,iRow:f[0].rowIndex,rowid:f.attr("id"),
