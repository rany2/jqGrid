...
(b="");return b.replace(/\{(\d+)\}/g,function(a,b){return c[b]})},template:function(b){var c=a.makeArray(arguments).slice(1),e,d=c.length;null==b&&(b="");return b.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((\.*?)?\))?)?\}/g,function(b,g){var h,m;if(!isNaN(parseInt(g,10)))return c[parseInt(g,10)];for(e=0;e<d;e++)if(a.isArray(c[e]))for(h=c[e],m=h.length;m--;)if(g===h[m].nm)return h[m].v})},msie:"Microsoft Internet Explorer"===navigator.appName,msiever:function(){var a=-1,c=/(MSIE) ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent);
...
{},e=(v.formatter||{}).date||{},k=null==a||null==a.locale?{}:((Ga[a.locale]||{}).formatter||{}).date,f,g=c.length,h={},l;for(f=0;f<g;f++)l=c[f],void 0!==d[l]?h[l]=d[l]:void 0!==e[l]?h[l]=e[l]:void 0!==k[l]&&(h[l]=k[l]);return h}(this.p,d);void 0===d.parseRe&&(d.parseRe=/[#%\\\/:_;.,\t\s\-]/);d.masks.hasOwnProperty(b)&&(b=d.masks[b]);if(c&&null!=c)if(isNaN(c)||"u"!==String(b).toLowerCase())if(isNaN(c)||"u1000"!==String(b).toLowerCase())if(c.constructor===Date)m=c;else if(null!==f)m=new Date(parseInt(f[1],
...
c&&"abort"!==d){var e=a(this.grid.eDiv),f=b.getResponseHeader("Content-Type"),g=e.children(".ui-jqgrid-error"),h=b.responseText||"",l=function(b){var c=document.createElement("div"),d;d=/<body[^>]*>([\s\S]*)<\/body\s*>/gim.exec(b);c.innerHTML=null!=d&&2===d.length?d[1]:b;b=c.getElementsByTagName("script");for(d=b.length;d--;)b[d].parentNode.removeChild(b[d]);b=c.innerHTML;try{a.trim(a(b).text())}catch(e){}},m=function(b){try{var c=a.parseJSON(b),d=[],e;for(e in c)"StackTrace"!==e&&d.push(e+": "+c[e]);
...
d&&0<d.length)for(a=0;a<d.length;a++)d[a]!==c&&t.call(b,d[a],!1,null);c&&t.call(b,c,!1,null)}e.scrollLeft=f;b.unbind(".selectionPreserver",g)};b.bind("jqGridGridComplete.selectionPreserver",g)}};d.grid=z;Q.call(d,"beforeInitGrid");k.iColByName=K(k.colModel);k.iPropByName=J(k.additionalProperties);var P=a("<div class='ui-jqgrid-view' role='grid' aria-multiselectable='"+!!k.multiselect+"'></div>"),U=v.msie,Ba=U&&8>v.msiever();k.direction=q(k.direction.toLowerCase());-1===p(k.direction,["ltr","rtl"])&&
(k.direction="ltr");la=k.direction;a(P).insertBefore(d);h.removeClass("scroll").appendTo(P);var X=a("<div class='"+F("gBox","ui-jqgrid")+"'></div>");a(X).attr({id:k.gBoxId,dir:la}).insertBefore(P);a(P).attr("id",k.gViewId).appendTo(X);a("<div class='"+F("overlay","jqgrid-overlay")+"' id='lui_"+k.id+"'></div>").insertBefore(P);a("<div class='"+F("loading","loading")+"' id='load_"+k.id+"'>"+C("loadtext")+"</div>").insertBefore(P);Ba&&h.attr({cellspacing:"0"});h.attr({role:"presentation","aria-labelledby":"gbox_"+
...
" style='"+q(p)+"'"+(n?" class='"+q(n)+"'":"")+(r?" title='"+q(r)+"'":"");f=c[3];e=c[4];switch(c[1].toLowerCase()){case "class":n=n?n+(" "+f):f;break;case "title":r=f;break;case "style":p+=f;break;default:t+=" "+c[1]+"="+c[2]+f+c[2]}}h=(""!==p?"style='"+p+"'":"")+((void 0!==n?" class='"+n+"'":"")+(h.title&&l?" title='"+ib(c).replace(/\'/g,"&apos;")+"'":""));return h+=t},T=function(a){return null==a||""===a?"&#160;":k.autoencode?sb(a):String(a)},$a=function(a){var b=k.treeReader,c=b.loaded,d=b.leaf_field,
...
d?d:1:(z.emptyRows.call(this,!1,!0),d=1);p&&(V(k.data),V(k.lastSelectedData),k._index={},k.grouping&&null!=k.groupingView&&(k.groupingView.groups=[],k.groupingView._locgr=!1),k.localReader.id="_id_");k.reccount=0;switch(n){case "xml":case "xmlstring":q=k.xmlReader;t=v.getXmlData;break;case "json":case "jsonp":case "jsonstring":q=k.jsonReader}var u,w,x,C,E,y={},H,B=k.colModel,G=B.length,A,F,K,va,J,P=k.arrayReaderInfos,ha={},D=function(a){return function(b){b=b.getAttribute(a);return null!==b?b:void 0}},
Pa=function(a){return function(){var b=ha[a];if(null!=b)return b=b.childNodes,0<b.length?b[0].nodeValue:void 0}};k.page=N(t(b,q.page),k.page);k.lastpage=N(t(b,q.total),1);k.records=N(t(b,q.records));m(q.userdata)?k.userData=q.userdata.call(this,b)||{}:r?t(b,q.userdata,!0).each(function(){k.userData[this.getAttribute("name")]=a(this).text()}):k.userData=t(b,q.userdata)||{};ab();var U={},Ja=k.additionalProperties,I=function(a,b){r&&"string"===typeof b&&(/^\w+$/.test(b)?U[a]=Pa(b):/^\[\w+\]$/.test(b)&&
(U[a]=D(b.substring(1,b.length-1))))},fa=function(a){var b=a.name,c=r?a.xmlmap||b:"local"===n&&!k.dataTypeOrg||"json"===n||"jsonp"===n?a.jsonmap||b:b;!1!==k.keyName&&!0===a.key&&(k.keyName=b);if("string"===typeof c||m(c))U[b]=c;m(c)||I(b,c)};for(u=0;u<G;u++)fa(B[u]);G=Ja.length;for(u=0;u<G;u++)F=Ja[u],"object"===typeof F&&null!=F?fa(F):I(F,F);C=!1===k.keyName?m(q.id)?q.id.call(this,b):q.id:k.keyName;isNaN(C)?m(C)||(P[C]&&(E=P[C].order),r&&("string"===typeof C&&/^\[\w+\]$/.test(C)?C=D(C.substring(1,
C.length-1)):"string"===typeof C&&/^\w+$/.test(C)&&(C=Pa(C)))):E=Number(C);x=t(b,q.root,!0);if(q.row)if(1===x.length&&"string"===typeof q.row&&/^\w+$/.test(q.row)){G=[];K=x[0].childNodes;va=K.length;for(F=0;F<va;F++)J=K[F],1===J.nodeType&&J.nodeName===q.row&&G.push(J);x=G}else x=t(x,q.row,!0);null==x&&l(b)&&(x=b);x||(x=[]);b=x.length;0<b&&0>=k.page&&(k.page=1);fa=parseInt(k.rowNum,10);f&&(fa*=f+1);var B=[],Za=[],L,G=[];for(u=0;u<b;u++){L=x[u];w=q.repeatitems&&q.cell?t(L,q.cell,!0)||L:L;H=q.repeatitems&&
(r||l(w));y={};ha={};if(r&&!H&&null!=w)for(K=w.childNodes,va=K.length,F=0;F<va;F++)J=K[F],1===J.nodeType&&(ha[J.nodeName]=J);for(A in P)P.hasOwnProperty(A)&&(F=P[A],H?(K=w[F.order],r&&null!=K&&(K=K.textContent||K.text)):K=null!=U[A]&&"string"!==typeof U[A]?U[A](w):t(w,"string"===typeof U[A]?U[A]:F.name),1===F.type&&(F=Ja[F.index],null!=F&&m(F.convert)&&(K=F.convert(K,w))),void 0!==K&&(y[A]=K));void 0!==y[C]?L=void 0!==y[C]?y[C]:Ia():(L=t(L,l(L)?E:C),void 0===L&&(L=t(w,l(w)?E:C)),void 0===L&&(L=Ia()));
L=String(L);H=k.idPrefix+L;k.treeGrid&&$a(y);if(u<fa)Za.push(H),B.push(w),G.push(y);else if(!p)break;if(p||!0===k.treeGrid)y._id_=L,k.data.push(y),k._index[y._id_]=k.data.length-1}if(!p||!k.forceClientSorting||!0===k.treeGrid){d=v.parseDataToHtml.call(this,b,Za,G,B,d,f,p);ab(!0);f=-1<k.treeANode?k.treeANode:0;q=a(this.tBodies[0]);!0===k.treeGrid&&0<f?a(this.rows[f]).after(d.join("")):k.scroll?q.append(d.join("")):(null==this.firstElementChild||void 0!==document.documentMode&&9>=document.documentMode?
q.html(q.html()+d.join("")):this.firstElementChild.innerHTML+=d.join(""),this.grid.cols=this.rows[0].cells);k.grouping&&O.call(this);if(!0===k.subGrid)try{c.addSubGrid.call(g,k.iColByName.subgrid)}catch(T){}if(!1===k.gridview||m(k.afterInsertRow))for(u=0;u<Math.min(b,fa);u++)Q.call(this,"afterInsertRow",Za[u],G[u],B[u]);k.totaltime=new Date-h;0<u&&0===k.records&&(k.records=b);V(d);if(!0===k.treeGrid)try{c.setTreeNode.call(g,f+1,u+f+1)}catch(T){}k.reccount=Math.min(b,fa);k.treeANode=-1;k.userDataOnFooter&&
c.footerData.call(g,"set",k.userData,!0);p&&(k.records=b,k.lastpage=Math.ceil(b/fa));e||this.updatepager(!1,!0);aa.call(this)}}},db=function(){function b(a){var c=0,d,e,f,g,h,l,p;if(null!=a.groups){(e=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase())&&G.orBegin();for(d=0;d<a.groups.length;d++){0<c&&e&&G.or();try{b(a.groups[d])}catch(q){x(q)}c++}e&&G.orEnd()}if(null!=a.rules)try{(f=a.rules.length&&"OR"===a.groupOp.toString().toUpperCase())&&G.orBegin();for(d=0;d<a.rules.length;d++)h=a.rules[d],
g=a.groupOp.toString().toUpperCase(),H[h.op]&&h.field?(0<c&&g&&"OR"===g&&(G=G.or()),p=n[h.field],l=p.reader,G=H[h.op](G,g)(m(l)?'jQuery.jgrid.getAccessor(this,jQuery("'+k.idSel+'")[0].p.colModel['+p.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+l+"')",h.data,n[h.field])):null!=k.customSortOperations&&null!=k.customSortOperations[h.op]&&m(k.customSortOperations[h.op].filter)&&(G=G.custom(h.op,h.field,h.data)),c++;f&&G.orEnd()}catch(q){x(q)}}var d=a(this),e=k.multiSort?[]:"",f={},g=!1,n={},p=
...
k.sortorder,null!=n[e]&&n[e].stype?n[e].stype:"text",null!=n[e]&&n[e].srcfmt?n[e].srcfmt:""),!1;var H={eq:function(a){return a.equals},ne:function(a){return a.notEquals},lt:function(a){return a.less},le:function(a){return a.lessOrEquals},gt:function(a){return a.greater},ge:function(a){return a.greaterOrEquals},cn:function(a){return a.contains},nc:function(a,b){return"OR"===b?a.orNot().contains:a.andNot().contains},bw:function(a){return a.startsWith},bn:function(a,b){return"OR"===b?a.orNot().startsWith:
a.andNot().startsWith},en:function(a,b){return"OR"===b?a.orNot().endsWith:a.andNot().endsWith},ew:function(a){return a.endsWith},ni:function(a,b){return"OR"===b?a.orNot().equals:a.andNot().equals},"in":function(a){return a.equals},nu:function(a){return a.isNull},nn:function(a,b){return"OR"===b?a.orNot().isNull:a.andNot().isNull}},G=v.from.call(this,k.data);k.ignoreCase&&(G=G.ignoreCase());if(!0===k.search){var B=k.postData.filters;if(B)"string"===typeof B&&(B=v.parse(B)),b(B);else try{G=H[k.postData.searchOper](G)(k.postData.searchField,
k.postData.searchString,n[k.postData.searchField])}catch(F){}}if(k.grouping)for(y=0;y<z;y++)G.orderBy(q[y],C.groupOrder[y],p[y].stype,p[y].srcfmt);k.multiSort?r(e,function(){G.orderBy(this,f[this],n[this].stype,n[this].srcfmt,n[this].sfunc)}):e&&k.sortorder&&g&&G.orderBy(k.sortname,"DESC"===k.sortorder.toUpperCase()?"d":"a",n[e].stype,n[e].srcfmt,n[e].sfunc);k.lastSelectedData=G.select();var B=parseInt(k.rowNum,10),A=k.lastSelectedData.length,K=parseInt(k.page,10),va=Math.ceil(A/B),J={};if(k.grouping&&
k.groupingView._locgr){k.groupingView.groups=[];var O,P,N;if(k.footerrow&&k.userDataOnFooter){for(P in k.userData)k.userData.hasOwnProperty(P)&&(k.userData[P]=0);N=!0}for(O=0;O<A;O++){if(N)for(P in k.userData)k.userData.hasOwnProperty(P)&&(k.userData[P]+=parseFloat(k.lastSelectedData[O][P]||0));c.groupingPrepare.call(d,k.lastSelectedData[O],O,B)}}n=G=null;d=k.localReader;J[d.total]=va;J[d.page]=K;J[d.records]=A;J[d.root]=k.lastSelectedData.slice((K-1)*B,K*B);J[d.userdata]=k.userData;return J},eb=
function(b){var c=b.outerWidth();0>=c&&(c=a(this).closest(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px",a(document.body).append("<div id='testpg' class='"+F("gBox","ui-jqgrid")+"' style='font-size:"+c+";visibility:hidden;margin:0;padding:0;' ></div>"),a(b).clone().appendTo("#testpg"),c=a("#testpg>.ui-pg-table").width(),a("#testpg").remove());0<c&&b.parent().width(c);return c},va=function(b,c){var d=this,e=a(d),f=d.grid,g,l,m,n,p,q,r=k.pager||"",t=k.pager?"_"+k.pager.substr(1):"";g=f.bDiv;
var u=a.fmatter?a.fmatter.NumberFormat:null,x=k.toppager?"_"+k.toppager.substr(1):"",z=F("states.hover"),y=F("states.disabled");l=parseInt(k.page,10)-1;0>l&&(l=0);l*=parseInt(k.rowNum,10);n=l+k.reccount;if(k.scroll){q=a(Ha(21,g)[0].rows).slice(1);l=n-q.length;k.reccount=q.length;if(q=q.outerHeight()||f.prevRowHeight)m=l*q,p=v.fixMaxHeightOfDiv.call(d,parseInt(k.records,10)*q),a(g).children("div").first().css({height:p+"px"}).children("div").first().css({height:m+"px",display:m+"px"?"":"none"}),0===
g.scrollTop&&1<k.page&&(g.scrollTop=k.rowNum*(k.page-1)*q);g.scrollLeft=f.hDiv.scrollLeft}if(r+=k.toppager?(r?",":"")+k.toppager:"")q=w.call(h,"formatter.integer")||{},f=N(k.page),g=N(k.lastpage),a(".selbox",r)[H]("disabled",!1),!0===k.pginput&&(a(".ui-pg-input",r).val(k.page),m=k.toppager?"#sp_1"+t+",#sp_1"+x:"#sp_1"+t,a(m).html(a.fmatter?u(k.lastpage,q):k.lastpage).closest(".ui-pg-table").each(function(){eb.call(d,a(this))})),k.viewrecords&&(0===k.reccount?a(".ui-paging-info",r).html(C("emptyrecords")):
(m=l+1,p=k.records,a.fmatter&&(m=u(m,q),n=u(n,q),p=u(p,q)),a(".ui-paging-info",r).html(v.format(C("recordtext"),m,n,p)))),!0===k.pgbuttons&&(0>=g&&(f=0),0>=f&&(f=g=0),1===f||0===f?(a("#first"+t+", #prev"+t).addClass(y).removeClass(z),k.toppager&&a("#first_t"+x+", #prev_t"+x).addClass(y).removeClass(z)):(a("#first"+t+", #prev"+t).removeClass(y),k.toppager&&a("#first_t"+x+", #prev_t"+x).removeClass(y)),f===g||0===f?(a("#next"+t+", #last"+t).addClass(y).removeClass(z),k.toppager&&a("#next_t"+x+", #last_t"+
x).addClass(y).removeClass(z)):(a("#next"+t+", #last"+t).removeClass(y),k.toppager&&a("#next_t"+x+", #last_t"+x).removeClass(y)));!0===b&&!0===k.rownumbers&&a(">td.jqgrid-rownum",d.rows).each(function(b){a(this).html(l+1+b)});c&&k.jqgdnd&&e.jqGrid("gridDnD","updateDnD");Q.call(d,"gridComplete");e.triggerHandler("jqGridAfterGridComplete")},Pa=function(){this.grid.hDiv.loading=!0;k.hiddengrid||c.progressBar.call(a(this),{method:"show",loadtype:k.loadui,htmlcontent:C("loadtext")})},Ja=function(){this.grid.hDiv.loading=
!1;c.progressBar.call(a(this),{method:"hide",loadtype:k.loadui})},fa=function(b){var e=this,f=a(e),g=e.grid;if(!g.hDiv.loading){var h=k.scroll&&!1===b,l={},p,q=k.prmNames;0>=k.page&&(k.page=Math.min(1,k.lastpage));null!==q.search&&(l[q.search]=k.search);null!==q.nd&&(l[q.nd]=(new Date).getTime());if(isNaN(parseInt(k.rowNum,10))||0>=parseInt(k.rowNum,10))k.rowNum=k.maxRowNum;null!==q.rows&&(l[q.rows]=k.rowNum);null!==q.page&&(l[q.page]=k.page);null!==q.sort&&(l[q.sort]=k.sortname);null!==q.order&&
(l[q.order]=k.sortorder);null!==k.rowTotal&&null!==q.totalrows&&(l[q.totalrows]=k.rowTotal);var r=m(k.loadComplete),t=r?k.loadComplete:null,u=0;b=b||1;1<b?null!==q.npage?(l[q.npage]=b,u=b-1,b=1):t=function(a){k.page++;g.hDiv.loading=!1;r&&k.loadComplete.call(e,a);fa.call(e,b-1)}:null!==q.npage&&delete k.postData[q.npage];if(k.grouping&&c.groupingSetup){c.groupingSetup.call(f);var x=k.groupingView,w,C="",y,E,H;for(w=0;w<x.groupField.length;w++){y=x.groupField[w];for(E=0;E<k.colModel.length;E++)H=k.colModel[E],
H.name===y&&H.index&&(y=H.index);C+=y+" "+x.groupOrder[w]+", "}l[q.sort]=C+l[q.sort]}n(k.postData,l);var B=k.scroll?e.rows.length-1:1,A=function(){G.call(e);var a=f.width(),b=f.closest(".ui-jqgrid-view").width(),d=f.css("height");b<a&&0===k.reccount?f.css("height","1px"):"0"!==d&&"0px"!==d&&f.css("height","");k.autowidth||void 0!==k.widthOrg&&"auto"!==k.widthOrg&&"100%"!==k.widthOrg||c.setGridWidth.call(f,k.tblwidth+k.scrollOffset,!1)},F=function(){var a;if(k.autoresizeOnLoad)c.autoResizeAllColumns.call(f);
else for(a=0;a<k.columnsToReResizing.length;a++)c.autoResizeColumn.call(f,k.columnsToReResizing[a]);V(k.columnsToReResizing)},q=function(){Q.call(e,"loadComplete",p);F();f.triggerHandler("jqGridAfterLoadComplete",[p]);Ja.call(e);k.datatype="local";k.datastr=null;A()},K=function(a){f.triggerHandler("jqGridLoadComplete",[a]);t&&t.call(e,a);F();f.triggerHandler("jqGridAfterLoadComplete",[a]);h&&g.populateVisible.call(e);1===b&&Ja.call(e);A()},va=function(){var a=db.call(e);Fa.call(e,a,B,1<b,u);K(a)};
if(Q.call(e,"beforeRequest"))if(m(k.datatype))k.datatype.call(e,k.postData,"load_"+k.id,B,b,u);else switch(l=k.datatype.toLowerCase(),l){case "json":case "jsonp":case "xml":case "script":a.ajax(n({url:k.url,type:k.mtype,dataType:l,data:v.serializeFeedback.call(d,k.serializeGridData,"jqGridSerializeGridData",k.postData),success:function(c,d,f){k.jqXhr=null;a(z.eDiv).hide();if(m(k.beforeProcessing)&&!1===k.beforeProcessing.call(e,c,d,f))Ja.call(e);else if(Fa.call(e,c,B,1<b,u),K(c),k.loadonce||k.treeGrid)k.dataTypeOrg=
k.datatype,k.datatype="local",k.forceClientSorting&&va()},error:function(a,c,d){k.jqXhr=null;m(k.loadError)&&k.loadError.call(e,a,c,d);1===b&&Ja.call(e)},beforeSend:function(a,b){var c=!0;m(k.loadBeforeSend)&&(c=k.loadBeforeSend.call(e,a,b));void 0===c&&(c=!0);if(!1===c)return!1;k.jqXhr=a;Pa.call(e)}},v.ajaxOptions,k.ajaxGridOptions));break;case "xmlstring":Pa.call(e);p="string"===typeof k.datastr?a.parseXML(k.datastr):k.datastr;Fa.call(e,p);q();k.forceClientSorting&&va();break;case "jsonstring":Pa.call(e);
p="string"===typeof k.datastr?v.parse(k.datastr):k.datastr;Fa.call(e,p);q();k.forceClientSorting&&va();break;case "local":case "clientside":Pa.call(e),k.datatype="local",va()}}},jb=function(b){var c=this.grid;a(k.cb,c.hDiv)[k.propOrAttr]("checked",b);if(k.frozenColumns)a(k.cb,c.fhDiv)[k.propOrAttr]("checked",b)},vb=function(b,c){var e=F("states.hover"),f=F("states.disabled"),g="<td class='ui-pg-button "+f+"'><span class='ui-separator'></span></td>",h="",l="<table "+(Ba?"cellspacing='0' ":"")+"style='table-layout:auto;white-space: pre;"+
("left"===k.pagerpos?"margin-right:auto;":"right"===k.pagerpos?"margin-left:auto;":"margin-left:auto;margin-right:auto;")+"' class='ui-pg-table'><tbody><tr>",m="",n,p,q,r,t=function(a,b,c){if(!Q.call(d,"onPaging",a,{newPage:b,currentPage:N(k.page,1),lastPage:N(k.lastpage,1),currentRowNum:N(k.rowNum,10),newRowNum:c}))return!1;k.selrow=null;k.multiselect&&(k.multiPageSelection||V(k.selarrrow),jb.call(d,!1));V(k.savedRow);return!0};c+="_"+b;n="pg_"+b;p=b+"_left";q=b+"_center";r=b+"_right";a("#"+I(b)).append("<div id='"+
n+"' class='ui-pager-control' role='group'><table "+(Ba?"cellspacing='0' ":"")+"class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;'><tbody><tr><td id='"+p+"' style='text-align:left;'></td><td id='"+q+"' style='text-align:center;white-space:pre;'></td><td id='"+r+"' style='text-align:right;'></td></tr></tbody></table></div>").attr("dir","ltr");n="#"+I(n);if(0<k.rowList.length){m="<td dir='"+la+"'>";p=C("pgrecs");m+="<select class='"+F("pagerSelect","ui-pg-selbox")+"' "+(p?"title='"+
p+"'":"")+">";for(p=0;p<k.rowList.length;p++)q=k.rowList[p].toString().split(":"),1===q.length&&(q[1]=q[0]),m+="<option value='"+q[0]+"'"+(N(k.rowNum,0)===N(q[0],0)?" selected='selected'":"")+">"+q[1]+"</option>";m+="</select></td>"}"rtl"===la&&(l+=m);!0===k.pginput&&(h="<td dir='"+la+"'>"+v.format(C("pgtext")||"","<input class='"+F("pagerInput","ui-pg-input")+"' type='text' size='2' maxlength='7' value='0'/>","<span id='sp_1_"+b+"'>0</span>")+"</td>");b="#"+I(b);if(!0===k.pgbuttons){q=["first","prev",
"next","last"];var u=F("pagerButton","ui-pg-button");r=function(a){var b=C("pg"+a);return"<td role='button' tabindex='0' id='"+a+c+"' class='"+u+"' "+(b?"title='"+b+"'":"")+"><span class='"+B("pager."+a)+"'></span></td>"};"rtl"===la&&q.reverse();for(p=0;p<q.length;p++)l+=r(q[p]),1===p&&(l+=""!==h?g+h+g:"")}else""!==h&&(l+=h);"ltr"===la&&(l+=m);l+="</tr></tbody></table>";!0===k.viewrecords&&a("td"+b+"_"+k.recordpos,n).append("<span dir='"+la+"' style='text-align:"+k.recordpos+"' class='ui-paging-info'></span>");
var w=a("td"+b+"_"+k.pagerpos,n);w.append(l);g=eb.call(this,w.children(".ui-pg-table"));k._nvtd=[];k._nvtd[0]=g?Math.floor((k.width-g)/2):Math.floor(k.width/3);k._nvtd[1]=0;l=null;a(".ui-pg-selbox",n).bind("change",function(){var b=N(this.value,10),c=Math.round(k.rowNum*(k.page-1)/b-.5)+1;if(!t("records",c,b))return!1;k.page=c;k.rowNum=b;k.pager&&a(".ui-pg-selbox",k.pager).val(b);k.toppager&&a(".ui-pg-selbox",k.toppager).val(b);fa.call(d);return!1});!0===k.pgbuttons&&(a(".ui-pg-button",n).hover(function(){ca(this,
f)?this.style.cursor="default":(a(this).addClass(e),this.style.cursor="pointer")},function(){ca(this,f)||(a(this).removeClass(e),this.style.cursor="default")}),a("#first"+I(c)+", #prev"+I(c)+", #next"+I(c)+", #last"+I(c)).click(function(){if(ca(this,f))return!1;var a=N(k.page,1),b=a,e=this.id,g=N(k.lastpage,1),h=!1,l=!0,m=!0,n=!0,p=!0;0===g||1===g?(1>=a&&(m=l=!1),p=n=!1):1<g&&1<=a?1===a?m=l=!1:a===g&&(p=n=!1):1<g&&0===a&&(p=n=!1,a=g-1);this.id==="first"+c&&l&&(e="first",b=1,h=!0);this.id==="prev"+
c&&m&&(e="prev",b=a-1,h=!0);this.id==="next"+c&&n&&(e="next",b=a+1,h=!0);this.id==="last"+c&&p&&(e="last",b=g,h=!0);if(!t(e,b,N(k.rowNum,10)))return!1;k.page=b;h&&fa.call(d);return!1}));!0===k.pginput&&a("input.ui-pg-input",n).bind("keypress.jqGrid",function(b){b=b.charCode||b.keyCode||0;var c=N(a(this).val(),1);if(13===b){if(!t("user",c,N(k.rowNum,10)))return!1;a(this).val(c);k.page=0<a(this).val()?a(this).val():k.page;fa.call(d);return!1}return this});w.children(".ui-pg-table").bind("keydown.jqGrid",
function(a){13===a.which&&(a=w.find(":focus"),0<a.length&&a.trigger("click"))})},ub=function(b,c,d){r((k.sortname+" "+k.sortorder).split(","),function(){var c=a.trim(this).split(" ");2===c.length&&b.push(c[0])});if(null!=d){var e=a.inArray(d.index||d.name,b);""!==d.lso&&0>e?b.push(d.index||d.name):""===d.lso&&0<=e&&b.splice(e,1)}r(k.colModel,function(){var d=this.index||this.name,e;this.lso&&(e=this.lso.split("-"),0>a.inArray(d,b)&&b.push(d),c[d]=e[e.length-1])})},Eb=function(b,c){var e="",f=k.colModel[b],
g="",h=F("states.disabled"),l=k.frozenColumns?a(c):a(d.grid.headers[b].el),g=l.find("span.s-ico"),m=g.children("span.ui-icon-asc"),n=g.children("span.ui-icon-desc"),p=m,q=n,t=[],u={};l.find("span.ui-grid-ico-sort").addClass(h);l.attr("aria-selected","false");f.lso?(g.show(),g=f.lso.split("-"),g=g[g.length-1],"desc"===g&&(p=n,q=m),p.removeClass(h).css("display",""),k.showOneSortIcon&&q.hide(),l.attr("aria-selected","true")):k.viewsortcols[0]||g.hide();ub(t,u,f);r(t,function(){0<e.length&&(e+=", ");
e+=this+" "+u[this];k.sortorder=u[this]});k.sortname=e.substring(0,e.length-k.sortorder.length-1)},wb=function(b,d,e,f,g){var h=this.grid,l=k.colModel[d],m=F("states.disabled");if(null!=l&&l.sortable&&!(0<k.savedRow.length)){e||(k.lastsort===d&&""!==k.sortname?(k.sortorder="asc"===k.sortorder?"desc":"desc"===k.sortorder?"asc":l.firstsortorder||"asc",l.lso?"asc"===l.lso?l.lso+="-desc":"desc"===l.lso?l.lso+="-asc":"asc-desc"!==l.lso&&"desc-asc"!==l.lso||!k.threeStateSort&&!k.multiSort||(l.lso=""):l.lso=
l.firstsortorder||"asc"):l.lso=k.sortorder=l.firstsortorder||"asc",k.page=1);if(k.multiSort)Eb(d,g);else{if(f){if(k.lastsort===d&&k.sortorder===f&&!e)return;k.sortorder=f}l=h.headers;e=h.fhDiv;f=l[k.lastsort]?a(l[k.lastsort].el):a();g=k.frozenColumns?a(g):a(l[d].el);var n=g.find("span.s-ico"),p=n.children("span.ui-icon-"+k.sortorder),q=n.children("span.ui-icon-"+("asc"===k.sortorder?"desc":"asc")),l=k.colModel[k.lastsort];f.find("span.ui-grid-ico-sort").addClass(m);f.attr("aria-selected","false");
...
k.multiPageSelection||(k.selrow=null,k.multiselect&&(jb.call(this,!1),V(k.selarrrow))),V(k.savedRow),k.scroll&&(m=h.bDiv.scrollLeft,z.emptyRows.call(this,!0,!1),h.hDiv.scrollLeft=m),k.subGrid&&"local"===k.datatype&&a("td.sgexpanded","#"+I(k.id)).each(function(){a(this).trigger("click")}),fa.call(this),k.lastsort=d,k.sortname!==b&&d&&(k.lastsort=d)):k.lastsort=d}},Fb=function(){var a=0,b=v.cell_width?0:N(k.cellLayout,0),c=0,d,e=N(k.scrollOffset,0),f,g=!1,h,l=0,m,n=v.isCellClassHidden;r(k.colModel,
function(){void 0===this.hidden&&(this.hidden=!1);if(k.grouping&&k.autowidth){var d=p(this.name,k.groupingView.groupField);0<=d&&k.groupingView.groupColumnShow.length>d&&(this.hidden=!k.groupingView.groupColumnShow[d])}this.widthOrg=f=N(this.width,0);!1!==this.hidden||n(this.classes)||(a+=f+b,this.fixed?l+=f+b:c++)});isNaN(k.width)&&(k.width=a+(!1!==k.shrinkToFit||isNaN(k.height)?0:e));z.width=k.width;k.tblwidth=a;!1===k.shrinkToFit&&!0===k.forceFit&&(k.forceFit=!1);!0===k.shrinkToFit&&0<c&&(h=z.width-
b*c-l,isNaN(k.height)||(h-=e,g=!0),a=0,r(k.colModel,function(e){!1!==this.hidden||n(this.classes)||this.fixed||(this.width=f=Math.round(h*this.width/(k.tblwidth-b*c-l)),a+=f,d=e)}),m=0,g?z.width-l-(a+b*c)!==e&&(m=z.width-l-(a+b*c)-e):g||1===Math.abs(z.width-l-(a+b*c))||(m=z.width-l-(a+b*c)),k.colModel[d].width+=m,k.tblwidth=a+m+b*c+l,k.tblwidth>k.width&&(k.colModel[d].width-=k.tblwidth-parseInt(k.width,10),k.tblwidth=k.width))},Gb=function(a){var b=a,c;for(c=a+1;c<k.colModel.length;c++)if(!0!==k.colModel[c].hidden){b=
c;break}return b-a},fb;-1===p(k.multikey,["shiftKey","altKey","ctrlKey"])&&(k.multikey=!1);k.keyName=!1;k.sortorder=k.sortorder.toLowerCase();v.cell_width=v.cellWidth();var kb=v.cmTemplate,Z,la;for(Z=0;Z<k.colModel.length;Z++)S=k.colModel[Z],fb="string"===typeof S.template?null==kb||"object"!==typeof kb[S.template]&&!a.isFunction(kb[S.template])?{}:kb[S.template]:S.template,m(fb)&&(fb=fb.call(d,{cm:S,iCol:Z})),S=n(!0,{},k.cmTemplate,fb||{},S),!1===k.keyName&&!0===S.key&&(k.keyName=S.name),k.colModel[Z]=
S;for(Z=0;Z<k.additionalProperties.length;Z++)S=k.additionalProperties[Z],!1===k.keyName&&!0===S.key&&(k.keyName=S.name);if(0===k.colNames.length)for(Z=0;Z<k.colModel.length;Z++)k.colNames[Z]=void 0!==k.colModel[Z].label?k.colModel[Z].label:k.colModel[Z].name;if(k.colNames.length!==k.colModel.length)x(w.call(h,"errors.model"));else{!0===k.grouping&&(k.scroll=!1,k.rownumbers=!1,k.treeGrid=!1,k.gridview=!0);if(k.subGrid)try{c.setSubGrid.call(h)}catch(tb){}if(k.multiselect&&("left"===k.multiselectPosition||
...
k.cellLayout:k.rownumWidth,labelClasses:"jqgh_rn",sortable:!1,resizable:!1,hidedlg:!0,search:!1,align:"center",fixed:!0,frozen:!0}));k.iColByName=K(k.colModel);k.xmlReader=n(!0,{root:"rows",row:"row",page:"rows>page",total:"rows>total",records:"rows>records",repeatitems:!0,cell:"cell",id:"[id]",userdata:"userdata",subgrid:{root:"rows",row:"row",repeatitems:!0,cell:"cell"}},k.xmlReader);k.jsonReader=n(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!0,cell:"cell",id:"id",userdata:"userdata",
subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},k.jsonReader);k.localReader=n(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},k.localReader);k.scroll&&(k.pgbuttons=!1,k.pginput=!1,k.rowList=[]);if(!0===k.treeGrid){try{c.setTreeGrid.call(h)}catch(tb){}"local"!==k.datatype&&(k.localReader={id:"_id_"});k.iPropByName=J(k.additionalProperties)}L();D();k.data.length&&(ya.call(d),mb());
if(!0===k.shrinkToFit&&!0===k.forceFit)for(Z=k.colModel.length-1;0<=Z;Z--)if(!0!==k.colModel[Z].hidden){k.colModel[Z].resizable=!1;break}var da,ea,R,ga,S,ta,ja,ma,qa=[],Da=[],ka=[],ia="<thead><tr class='ui-jqgrid-labels' role='row'>",Aa,ua="<tbody><tr>",ra=F("states.hover"),sa=F("states.disabled");if(k.multiSort){var qa=k.sortname.split(","),wa;for(wa=0;wa<qa.length;wa++)ka=q(qa[wa]).split(" "),qa[wa]=q(ka[0]),Da[wa]=ka[1]?q(ka[1]):k.sortorder||"asc"}for(Z=0;Z<k.colNames.length;Z++){S=k.colModel[Z];
ta=k.headertitles||S.headerTitle?" title='"+ib("string"===typeof S.headerTitle?S.headerTitle:k.colNames[Z])+"'":"";ia+="<th id='"+k.id+"_"+S.name+"' class='"+F("colHeaders","ui-th-column ui-th-"+la+" "+(S.labelClasses||""))+"'"+ta+">";da=S.index||S.name;switch(S.labelAlign){case "left":ja="text-align:left;";break;case "right":ja="text-align:right;"+(!1===S.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;");break;case "likeData":ja=void 0===S.align||"left"===S.align?"text-align:left;":
"right"===S.align?"text-align:right;"+(!1===S.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;"):"";break;default:ja=""}ia+="<div id='jqgh_"+k.id+"_"+S.name+"'"+(U?" class='ui-th-div-ie'":"")+(""===ja?"":" style='"+ja+"'")+">";Aa=S.autoResizable&&"actions"!==S.formatter?"<span class='"+k.autoResizing.wrapperClassName+"'>"+k.colNames[Z]+"</span>":k.colNames[Z];k.sortIconsBeforeText?(ia+=(k.builderSortIcons||v.builderSortIcons).call(d,Z),ia+=Aa):(ia+=Aa,ia+=(k.builderSortIcons||
v.builderSortIcons).call(d,Z));ia+="</div></th>";ua+="<td></td>";S.width=S.width?parseInt(S.width,10):150;"boolean"!==typeof S.title&&(S.title=!0);S.lso="";da===k.sortname&&(k.lastsort=Z,S.lso=k.sortorder||S.firstsortorder||"asc");k.multiSort&&(ka=p(da,qa),-1!==ka&&(S.lso=Da[ka]))}var ia=ia+"</tr></thead>",ua=ua+"</tr></tbody>",xa=a("<table class='"+F("hTable","ui-jqgrid-htable")+"' style='width:1px' role='presentation' aria-labelledby='gbox_"+k.id+"'"+(Ba?" cellspacing='0'":"")+">"+ia+ua+"</table>");
a(xa[0].tHead).children("tr").children("th").hover(function(){a(this).addClass(ra)},function(){a(this).removeClass(ra)});k.multiselect&&a(k.cb,xa).bind("click",function(){var b=F("states.select"),c,e=[],f=k.iColByName.cb,g=function(c,d){a(c)[d?"addClass":"removeClass"](b).attr(d?{"aria-selected":"true",tabindex:"0"}:{"aria-selected":"false",tabindex:"-1"});if(void 0!==f)a(c.cells[f]).children("input.cbox")[k.propOrAttr]("checked",d)},h=z.fbRows,l=sa+" ui-subgrid jqgroup jqfoot jqgfirstrow",m,n=k._index;
V(k.selarrrow);if(this.checked){if(c=!0,k.selrow=1<d.rows.length?d.rows[d.rows.length-1].id:null,k.multiPageSelection&&("local"===k.datatype||k.treeGrid)&&null!=k.data&&0<k.data.length&&null!=n)for(m in n)n.hasOwnProperty(m)&&k.selarrrow.push(k.idPrefix+m)}else c=!1,k.selrow=null;a(d.rows).each(function(a){ca(this,l)||(g(this,c),(c?k.selarrrow:e).push(this.id),h&&g(h[a],c))});Q.call(d,"onSelectAll",c?k.selarrrow:e,c)});if(!0===k.autowidth){var Ka=Math.floor(a(X).innerWidth());k.width=0<Ka?Ka:"nw"}isNaN(k.width)?
isNaN(parseFloat(k.width))||(k.width=parseFloat(k.width)):k.width=Number(k.width);k.widthOrg=k.width;Fb();a(X).css("width",z.width+"px").append("<div class='"+F("resizer","ui-jqgrid-resize-mark")+"' id='"+k.rsId+"'>&#160;</div>");a(k.rs).bind("selectstart",function(){return!1}).click(ha).dblclick(function(b){var e=a(this).data("idx"),f=a(this).data("pageX"),g=k.colModel[e];if(null==f||null==g)return!1;var f=String(f).split(";"),l=parseFloat(f[0]),m=parseFloat(f[1]);if(2===f.length&&(5<Math.abs(l-
m)||5<Math.abs(b.pageX-l)||5<Math.abs(b.pageX-m)))return!1;Q.call(d,"resizeDblClick",e,g,b)&&g.autoResizable&&c.autoResizeColumn.call(h,e);Q.call(d,"afterResizeDblClick",{iCol:e,cm:g,cmName:g.name});return!1});a(P).css("width",z.width+"px");var Ua="";k.footerrow&&(Ua+="<table role='presentation' style='width:"+k.tblwidth+"px' class='ui-jqgrid-ftable'"+(Ba?" cellspacing='0'":"")+"><tbody><tr role='row' class='"+F("rowFooter","footrow footrow-"+la)+"'>");var za="<tr class='jqgfirstrow' role='row' style='height:auto'>";
k.disableClick=!1;a("th",xa[0].tHead.rows[0]).each(function(b){var c=k.colModel[b],d=c.name,e=a(this),f=e.children("div"),g=f.children("span.s-ico"),h=k.showOneSortIcon;ea=c.width;void 0===c.resizable&&(c.resizable=!0);c.resizable?(R=document.createElement("span"),a(R).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+la).bind("selectstart",function(){return!1}),e.addClass(k.resizeclass)):R="";e.css("width",ea+"px").prepend(R);R=null;var l="";!0===c.hidden&&(e.css("display","none"),l="display:none;");
za+="<td role='gridcell' "+(c.classes?"class='"+c.classes+"' ":"")+"style='height:0;width:"+ea+"px;"+l+"'></td>";z.headers[b]={width:ea,el:this};ga=c.sortable;"boolean"!==typeof ga&&(ga=c.sortable=!0);"cb"!==d&&"subgrid"!==d&&"rn"!==d&&ga&&k.viewsortcols[2]&&f.addClass("ui-jqgrid-sortable");ga&&(k.multiSort?(d="desc"===c.lso?"asc":"desc",k.viewsortcols[0]?(g.css("display",""),c.lso&&(g.children("span.ui-icon-"+c.lso).removeClass(sa),h&&g.children("span.ui-icon-"+d).hide())):c.lso&&(g.css("display",
""),g.children("span.ui-icon-"+c.lso).removeClass(sa),h&&g.children("span.ui-icon-"+d).hide())):(d="desc"===k.sortorder?"asc":"desc",k.viewsortcols[0]?(g.css("display",""),b===k.lastsort&&(g.children("span.ui-icon-"+k.sortorder).removeClass(sa),h&&g.children("span.ui-icon-"+d).hide())):b===k.lastsort&&""!==c.lso&&(g.css("display",""),g.children("span.ui-icon-"+k.sortorder).removeClass(sa),h&&g.children("span.ui-icon-"+d).hide())));k.footerrow&&(Ua+="<td role='gridcell' "+Y(b,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(b){var c=
a(this),d=c.closest(".ui-jqgrid-hdiv").hasClass("frozen-div"),e=function(){var b=[c.position().left+c.outerWidth()];"rtl"===k.direction&&(b[0]=k.width-b[0]);b[0]-=d?0:z.bDiv.scrollLeft;b.push(a(z.hDiv).position().top);b.push(a(z.bDiv).offset().top-a(z.hDiv).offset().top+a(z.bDiv).height()+(z.sDiv?a(z.sDiv).height():0));return b},f;if(1===a(b.target).closest("th>span.ui-jqgrid-resize").length)return f=k.iColByName[(this.id||"").substring(k.id.length+1)],null!=f&&(!0===k.forceFit&&(k.nv=Gb(f)),z.dragStart(f,
b,e(),c)),!1}).click(function(b){if(k.disableClick)return k.disableClick=!1;var c="th.ui-th-column>div",e,f,c=k.viewsortcols[2]?c+".ui-jqgrid-sortable":c+">span.s-ico>span.ui-grid-ico-sort";b=a(b.target).closest(c);if(1===b.length)return k.viewsortcols[2]||(e=!0,f=b.hasClass("ui-icon-desc")?"desc":"asc"),b=k.iColByName[(this.id||"").substring(k.id.length+1)],null!=b&&wb.call(d,a("div",this)[0].id,b,e,f,this),!1});if(k.sortable&&a.fn.sortable)try{c.sortableColumns.call(h,a(xa[0].tHead.rows[0]))}catch(tb){}k.footerrow&&
(Ua+="</tr></tbody></table>");za+="</tr>";a(d).html("<tbody>"+za+"</tbody>");h.addClass(F("grid","ui-jqgrid-btable"));var Ca=k.caption&&!0===k.hiddengrid?!0:!1,bb=a("<div class='ui-jqgrid-hbox"+("rtl"===la?"-rtl":"")+"'></div>"),Ea=F("bottom");z.hDiv=document.createElement("div");a(z.hDiv).css({width:z.width+"px"}).addClass(F("hDiv","ui-jqgrid-hdiv")).append(bb).scroll(function(){var b=a(this).next(".ui-jqgrid-bdiv")[0];b&&(b.scrollLeft=this.scrollLeft)});a(bb).append(xa);xa=null;Ca&&a(z.hDiv).hide();
k.rowNum=parseInt(k.rowNum,10);if(isNaN(k.rowNum)||0>=k.rowNum)k.rowNum=k.maxRowNum;if(k.pager){var Qa,Va;"string"===typeof k.pager&&"#"!==k.pager.substr(0,1)?(Va=k.pager,Qa=a("#"+I(k.pager))):!0===k.pager?(Va=Ia(),Qa=a("<div id='"+Va+"'></div>"),Qa.appendTo("body"),k.pager="#"+I(Va)):(Qa=a(k.pager),Va=Qa.attr("id"));0<Qa.length?(Qa.css({width:z.width+"px"}).addClass(F("pager","ui-jqgrid-pager "+Ea)).appendTo(X),Ca&&Qa.hide(),vb.call(d,Va,""),k.pager="#"+I(Va)):k.pager=""}!1===k.cellEdit&&!0===k.hoverrows&&
h.bind("mouseover",function(b){ma=a(b.target).closest("tr.jqgrow");"ui-subgrid"!==a(ma).attr("class")&&a(ma).addClass(ra)}).bind("mouseout",function(b){ma=a(b.target).closest("tr.jqgrow");a(ma).removeClass(ra)});var pa,La,Sa,Ma=function(b){var c,d;do if(c=a(b).closest("td"),0<c.length){b=c.parent();d=b.parent().parent();if(b.is(".jqgrow")&&(d[0]===this||d.is("table.ui-jqgrid-btable")&&(d[0].id||"").replace("_frozen","")===this.id))break;b=c.parent()}while(0<c.length);return c};h.before(z.hDiv).click(function(b){var e=
F("states.select"),f=b.target,g=Ma.call(this,f),l=g.parent();if(0!==l.length&&!ca(l,sa)){pa=l[0].id;var m=a(f).hasClass("cbox"),n=Q.call(d,"beforeSelectRow",pa,b),p=v.detectRowEditing.call(d,pa),p=null!=p&&"cellEditing"!==p.mode;if("A"!==f.tagName&&(!p||m))if(La=g[0].cellIndex,Sa=g.html(),Q.call(d,"onCellSelect",pa,La,Sa,b),!0===k.cellEdit)if(k.multiselect&&m&&n)t.call(h,pa,!0,b);else{pa=l[0].rowIndex;try{c.editCell.call(h,pa,La,!0)}catch(q){}}else if(n)if(k.multikey)b[k.multikey]?t.call(h,pa,!0,
b):k.multiselect&&m&&(m=a("#jqg_"+I(k.id)+"_"+pa).is(":checked"),a("#jqg_"+I(k.id)+"_"+pa)[H]("checked",!m));else if(k.multiselect&&k.multiboxonly){if(!m){var r=k.frozenColumns?k.id+"_frozen":"";a(k.selarrrow).each(function(b,d){var f=c.getGridRowById.call(h,d);f&&a(f).removeClass(e);a("#jqg_"+I(k.id)+"_"+I(d))[k.propOrAttr]("checked",!1);r&&(a("#"+I(d),"#"+I(r)).removeClass(e),a("#jqg_"+I(k.id)+"_"+I(d),"#"+I(r))[k.propOrAttr]("checked",!1))});V(k.selarrrow)}t.call(h,pa,!0,b)}else f=k.selrow,t.call(h,
pa,!0,b),"toggle"!==k.singleSelectClickMode||k.multiselect||f!==pa||(this.grid.fbRows&&(l=l.add(this.grid.fbRows[pa])),l.removeClass(e).attr({"aria-selected":"false",tabindex:"-1"}),k.selrow=null);else m&&a(f).prop("checked",!1)}}).bind("reloadGrid",function(b,d){var e=this.grid,f=a(this);!0===k.treeGrid&&(k.datatype=k.treedatatype);d=n({},Ta.reloadGridOptions||{},k.reloadGridOptions||{},d||{});"local"===k.datatype&&k.dataTypeOrg&&k.loadonce&&d.fromServer&&(k.datatype=k.dataTypeOrg,delete k.dataTypeOrg);
d.current&&e.selectionPreserver.call(this);"local"===k.datatype?(k.multiPageSelection||c.resetSelection.call(f),k.data.length&&(ya.call(this),mb())):k.treeGrid||k.multiPageSelection||(k.selrow=null,k.multiselect&&(V(k.selarrrow),jb.call(this,!1)),V(k.savedRow));k.iRow=-1;k.iCol=-1;k.scroll&&z.emptyRows.call(this,!0,!1);if(d.page){var g=parseInt(d.page,10);g>k.lastpage&&(g=k.lastpage);1>g&&(g=1);k.page=g;e.bDiv.scrollTop=e.prevRowHeight?(g-1)*e.prevRowHeight*k.rowNum:0}e.prevRowHeight&&k.scroll&&void 0===
d.page?(delete k.lastpage,e.populateVisible.call(this)):e.populate.call(this);!0===k._inlinenav&&f.jqGrid("showAddEditButtons",!1);return!1}).dblclick(function(a){var b=Ma.call(this,a.target),c=b.parent();if(0<b.length&&!Q.call(d,"ondblClickRow",c.attr("id"),c[0].rowIndex,b[0].cellIndex,a))return!1}).bind("contextmenu",function(a){var b=Ma.call(this,a.target),c=b.parent(),e=c.attr("id");if(0!==b.length&&(k.multiselect||t.call(h,e,!0,a),!Q.call(d,"onRightClickRow",e,c[0].rowIndex,b[0].cellIndex,a)))return!1});
z.bDiv=document.createElement("div");U&&"auto"===String(k.height).toLowerCase()&&(k.height="100%");a(z.bDiv).append(a("<div style='position:relative;"+(Ba?"height:0.01%;":"")+"'></div>").append("<div></div>").append(d)).addClass("ui-jqgrid-bdiv").css({height:k.height+(isNaN(k.height)?"":"px"),width:z.width+"px"}).scroll(z.scrollGrid);k.maxHeight&&a(z.bDiv).css("max-height",k.maxHeight+(isNaN(k.maxHeight)?"":"px"));h.css({width:"1px"});a.support.tbody||2===a(">tbody",d).length&&a(">tbody:gt(0)",d).remove();
k.multikey&&a(z.bDiv).bind(v.msie?"selectstart":"mousedown",function(){return!1});Ca&&a(z.bDiv).hide();z.cDiv=document.createElement("div");var Na=B("gridMinimize.visible"),Wa=B("gridMinimize.hidden"),Xa=C("showhide"),Ra=!0===k.hidegrid?a("<a role='link' class='"+F("titleButton","ui-jqgrid-titlebar-close")+"'"+(Xa?" title='"+Xa+"'":"")+"/>").hover(function(){Ra.addClass(ra)},function(){Ra.removeClass(ra)}).append("<span class='"+Na+"'></span>"):"";a(z.cDiv).append("<span class='ui-jqgrid-title'>"+
k.caption+"</span>").append(Ra).addClass(F("gridTitle","ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===la?"-rtl":"")));a(z.cDiv).insertBefore(z.hDiv);if(k.toolbar[0]){z.uDiv=document.createElement("div");"top"===k.toolbar[1]?a(z.uDiv).insertBefore(z.hDiv):"bottom"===k.toolbar[1]&&a(z.uDiv).insertAfter(z.hDiv);var Ya=F("toolbarUpper","ui-userdata");"both"===k.toolbar[1]?(z.ubDiv=document.createElement("div"),a(z.uDiv).addClass(Ya).attr("id","t_"+k.id).insertBefore(z.hDiv),a(z.ubDiv).addClass(F("toolbarBottom",
"ui-userdata")).attr("id","tb_"+k.id).insertAfter(z.hDiv),Ca&&a(z.ubDiv).hide()):a(z.uDiv).width(z.width).addClass(Ya).attr("id","t_"+k.id);Ca&&a(z.uDiv).hide()}"string"===typeof k.datatype&&(k.datatype=k.datatype.toLowerCase());k.toppager?(k.toppager=k.id+"_toppager",z.topDiv=a("<div id='"+k.toppager+"'></div>")[0],a(z.topDiv).addClass(F("pager","ui-jqgrid-toppager")).css({width:z.width+"px"}).insertBefore(z.hDiv),vb.call(d,k.toppager,"_t"),k.toppager="#"+I(k.toppager)):""!==k.pager||k.scroll||(k.rowNum=
k.maxRowNum);k.footerrow&&(z.sDiv=a("<div class='ui-jqgrid-sdiv'></div>")[0],bb=a("<div class='ui-jqgrid-hbox"+("rtl"===la?"-rtl":"")+"'></div>"),a(z.sDiv).append(bb).width(z.width).insertAfter(z.hDiv),a(bb).append(Ua),z.footers=a(".ui-jqgrid-ftable",z.sDiv)[0].rows[0].cells,k.rownumbers&&(z.footers[0].className=F("rowNum","jqgrid-rownum")),Ca&&a(z.sDiv).hide());bb=null;if(k.caption){var cb=k.datatype;!0===k.hidegrid&&(a(".ui-jqgrid-titlebar-close",z.cDiv).click(function(b){var c=".ui-jqgrid-bdiv,.ui-jqgrid-hdiv,.ui-jqgrid-pager,.ui-jqgrid-sdiv",
e=this;!0===k.toolbar[0]&&("both"===k.toolbar[1]&&(c+=",#"+I(a(z.ubDiv).attr("id"))),c+=",#"+I(a(z.uDiv).attr("id")));var f=a(c,k.gView).length;k.toppager&&(c+=","+k.toppager);"visible"===k.gridstate?a(c,k.gBox).slideUp("fast",function(){f--;0===f&&(a("span",e).removeClass(Na).addClass(Wa),k.gridstate="hidden",a(k.gBox).hasClass("ui-resizable")&&a(".ui-resizable-handle",k.gBox).hide(),a(z.cDiv).addClass(Ea),Ca||Q.call(d,"onHeaderClick",k.gridstate,b))}):"hidden"===k.gridstate&&(a(z.cDiv).removeClass(Ea),
a(c,k.gBox).slideDown("fast",function(){f--;0===f&&(a("span",e).removeClass(Wa).addClass(Na),Ca&&(k.datatype=cb,fa.call(d),Ca=!1),k.gridstate="visible",a(k.gBox).hasClass("ui-resizable")&&a(".ui-resizable-handle",k.gBox).show(),Ca||Q.call(d,"onHeaderClick",k.gridstate,b))}));return!1}),Ca&&(k.datatype="local",a(".ui-jqgrid-titlebar-close",z.cDiv).trigger("click")))}else a(z.cDiv).hide(),a(z.cDiv).nextAll("div:visible").first().addClass("ui-corner-top");a(z.hDiv).after(z.bDiv);z.eDiv=a("<div class='"+
F("gridError","ui-jqgrid-errorbar ui-jqgrid-errorbar-"+la)+"' style='display:none;'><span class='ui-jqgrid-error'></span></div>")[0];a(z.hDiv).after(z.eDiv);a(X).click(ha).dblclick(function(b){var e=a(k.rs),f=e.offset(),g=e.data("idx"),l=e.data("delta"),m=k.colModel[g],n=a(this).data("pageX")||e.data("pageX");if(null==n||null==m)return!1;var n=String(n).split(";"),p=parseFloat(n[0]),q=parseFloat(n[1]);if(2===n.length&&(5<Math.abs(p-q)||5<Math.abs(b.pageX-p)||5<Math.abs(b.pageX-q)))return!1;Q.call(d,
"resizeDblClick",g,m)&&f.left-1<=b.pageX+l&&b.pageX+l<=f.left+e.outerWidth()+1&&m.autoResizable&&c.autoResizeColumn.call(h,g);Q.call(d,"afterResizeDblClick",{iCol:g,cm:m,cmName:m.name});return!1});k.pager||a(z.cDiv).nextAll("div:visible").filter(":last").addClass(Ea);a(".ui-jqgrid-labels",z.hDiv).bind("selectstart",function(){return!1});d.formatCol=Y;d.sortData=wb;d.updatepager=va;d.refreshIndex=mb;d.setHeadCheckBox=jb;d.fixScrollOffsetAndhBoxPadding=G;d.constructTr=ba;d.formatter=Db;n(z,{populate:fa,
emptyRows:M,beginReq:Pa,endReq:Ja});d.addXmlData=Fa;d.addJSONData=Fa;d.rebuildRowIndexes=O;d.grid.cols=d.rows[0].cells;Q.call(d,"onInitGrid");k.treeGrid&&"local"===k.datatype&&null!=k.data&&0<k.data.length&&(k.datatype="jsonstring",k.datastr=k.data,k.data=[]);fa.call(d);k.hiddengrid=!1}}}})};var D=a.fn.jqGrid;v.extend({getGridRes:function(b){var c=this[0];if(!c||!c.grid||!c.p)return null;c=v.getRes(Ga[c.p.locale],b)||v.getRes(Ga["en-US"],b);b=v.getRes(v,b);return"object"!==typeof c||null===c||a.isArray(c)?
...
abortAjaxRequest:function(){return this.each(function(){null!=this.p.jqXhr&&this.p.jqXhr.abort();this.grid.endReq.call(this)})},getGridRowById:function(b){if(null==b)return null;var c,e=b.toString();this.each(function(){var d,f=this.rows,g;null!=this.p.rowIndexes&&(g=this.p.rowIndexes[e],(g=f[g])&&g.id===e&&(c=g));if(!c)try{for(d=f.length;d--;)if(g=f[d],e===g.id){c=g;break}}catch(h){c=a(this.grid.bDiv).find("#"+I(b)),c=0<c.length?c[0]:null}});return c},getDataIDs:function(){var b=[];this.each(function(){var c=
this.rows,e=c.length,d,f;if(e&&0<e)for(d=0;d<e;d++)f=c[d],a(f).hasClass("jqgrow")&&b.push(f.id)});return b},setSelection:function(b,c,e){return this.each(function(){function d(b,c){var d=c.clientHeight,e=c.scrollTop,f=a(b).position().top,g=b.clientHeight;f+g>=d+e?c.scrollTop=f-(d+e)+g+e:f<d+e&&f<e&&(c.scrollTop=f)}var f=a(this),g=this.p,h,m,l,n=D.getGuiStyles;l=D.getGridRowById;var p=n.call(f,"states.select"),q=n.call(f,"states.disabled"),r=this.grid.fbRows,n=function(b,c){var d=c?"addClass":"removeClass",
e=g.iColByName.cb,f=c?{"aria-selected":"true",tabindex:"0"}:{"aria-selected":"false",tabindex:"-1"},h=function(b){a(b)[d](p).attr(f);if(void 0!==e)a(b.cells[e]).children("input.cbox")[g.propOrAttr]("checked",c)};h(b);r&&h(r[b.rowIndex])};void 0!==b&&(c=!1===c?!1:!0,null!=e&&(m=a(e.target).closest("tr.jqgrow"),0<m.length&&(h=m[0],r&&(h=this.rows[h.rowIndex]))),null==h&&(h=l.call(f,b)),!h||!h.className||-1<h.className.indexOf(q)||(!0===g.scrollrows&&(m=l.call(f,b),null!=m&&(m=m.rowIndex,0<=m&&d(this.rows[m],
this.grid.bDiv))),g.multiselect?(this.setHeadCheckBox(!1),g.selrow=h.id,l=a.inArray(g.selrow,g.selarrrow),-1===l?(f=!0,g.selarrrow.push(g.selrow)):null!==v.detectRowEditing.call(this,h.id)?f=!0:(f=!1,g.selarrrow.splice(l,1),l=g.selarrrow[0],g.selrow=void 0===l?null:l),"ui-subgrid"!==h.className&&n(h,f),c&&Q.call(this,"onSelectRow",h.id,f,e)):"ui-subgrid"!==h.className&&(g.selrow!==h.id?(null!==g.selrow&&(f=l.call(f,g.selrow))&&n(f,!1),n(h,!0),f=!0):f=!1,g.selrow=h.id,c&&Q.call(this,"onSelectRow",
h.id,f,e))))})},resetSelection:function(b){return this.each(function(){var c=a(this),e=this.p,d=D.getGuiStyles,f=D.getGridRowById,g=d.call(c,"states.select"),h="edit-cell "+g,d="selected-row "+d.call(c,"states.hover"),m=e.iColByName.cb,l=void 0!==m,n=this.grid.fbRows,p=function(b){var c={"aria-selected":"false",tabindex:"-1"};a(b).removeClass(g).attr(c);if(l)a(b.cells[m]).children("input.cbox")[e.propOrAttr]("checked",!1);if(n&&(b=n[b.rowIndex],a(b).removeClass(g).attr(c),l))a(b.cells[m]).children("input.cbox")[e.propOrAttr]("checked",
!1)};void 0!==b?(c=f.call(c,b),p(c),l&&(this.setHeadCheckBox(!1),c=a.inArray(b,e.selarrrow),-1!==c&&e.selarrrow.splice(c,1))):e.multiselect?(a(this.rows).each(function(){var b=a.inArray(this.id,e.selarrrow);-1!==b&&(p(this),e.selarrrow.splice(b,1))}),this.setHeadCheckBox(!1),e.multiPageSelection||V(e.selarrrow),e.selrow=null):e.selrow&&(c=f.call(c,e.selrow),p(c),e.selrow=null);!0===e.cellEdit&&0<=parseInt(e.iCol,10)&&0<=parseInt(e.iRow,10)&&(c=this.rows[e.iRow],null!=c&&(a(c.cells[e.iCol]).removeClass(h),
a(c).removeClass(d)),n&&(c=n[e.iRow],null!=c&&(a(c.cells[e.iCol]).removeClass(h),a(c).removeClass(d))));V(e.savedRow)})},getRowData:function(b,c){var e={},d;"object"===typeof b&&(c=b,b=void 0);c=c||{};this.each(function(){var f=this.p,g=!1,h,m=2,l=0,n=this.rows,p,q,r,t,w;if(void 0===b)g=!0,d=[],m=n.length;else if(h=D.getGridRowById.call(a(this),b),!h)return e;for(;l<m;){g&&(h=n[l]);if(a(h).hasClass("jqgrow")){q=a("td[role=gridcell]",h);for(p=0;p<q.length;p++)if(r=f.colModel[p],t=r.name,!("cb"===t||
"subgrid"===t||"rn"===t||"actions"===r.formatter||c.skipHidden&&r.hidden))if(w=q[p],!0===f.treeGrid&&t===f.ExpandColumn)e[t]=Ea(a("span",w).first().html());else try{e[t]=a.unformat.call(this,w,{rowId:h.id,colModel:r},p)}catch(x){e[t]=Ea(a(w).html())}!c.includeId||!1!==f.keyName&&null!=e[f.keyName]||(e[f.prmNames.id]=Oa(f.idPrefix,h.id));g&&(d.push(e),e={})}l++}});return d||e},delRowData:function(b){var c=!1,e,d,f;this.each(function(){var g=this.p;e=D.getGridRowById.call(a(this),b);if(!e)return!1;
g.subGrid&&(f=a(e).next(),f.hasClass("ui-subgrid")&&f.remove());a(e).remove();g.records--;g.reccount--;this.updatepager(!0,!1);c=!0;g.multiselect&&(d=a.inArray(b,g.selarrrow),-1!==d&&g.selarrrow.splice(d,1));g.multiselect&&0<g.selarrrow.length?g.selrow=g.selarrrow[g.selarrrow.length-1]:g.selrow===b&&(g.selrow=null);if("local"===g.datatype){var h=Oa(g.idPrefix,b),h=g._index[h];void 0!==h&&(g.data.splice(h,1),this.refreshIndex())}this.rebuildRowIndexes();if(!0===g.altRows&&c){var m=g.altclass,l=this.grid.fbRows;
a(this.rows).each(function(b){var c=a(this);l&&(c=c.add(l[this.rowIndex]));c[0===b%2?"addClass":"removeClass"](m)})}Q.call(this,"afterDelRow",b)});return c},setRowData:function(b,c,e){var d=!0;this.each(function(){var f=this,g=f.p,h,m=typeof e,l={};if(!f.grid)return!1;h=D.getGridRowById.call(a(f),b);if(!h)return!1;if(c)try{var n=Oa(g.idPrefix,b),p,q=g._index[n],r={},t=null!=q?g.data[q]:void 0;a(g.colModel).each(function(b){var d=this.name,e=na(c,d);void 0!==e&&("local"===g.datatype&&null!=t&&(e=lb.call(f,
e,this,t[d],n,t,b),a.isFunction(this.saveLocally)?this.saveLocally.call(f,{newValue:e,newItem:l,oldItem:t,id:n,cm:this,cmName:d,iCol:b}):l[d]=e),r[d]=e)});a(g.colModel).each(function(d){var e=this.name,m,n=na(c,e);if(void 0!==n){"local"===g.datatype&&null!=t&&(n=l[e]);m=this.title?{title:n}:{};var n=f.formatter(b,n,d,c,"edit",r),p=a(h.cells[d]);!0===g.treeGrid&&e===g.ExpandColumn&&(p=p.children("span.cell-wrapperleaf,span.cell-wrapper").first());p.html(n).attr(m);g.frozenColumns&&(p=a(f.grid.fbRows[h.rowIndex].cells[d]),
!0===g.treeGrid&&e===g.ExpandColumn&&(p=p.children("span.cell-wrapperleaf,span.cell-wrapper").first()),p.html(n).attr(m))}});if("local"===g.datatype){if(g.treeGrid)for(p in g.treeReader)g.treeReader.hasOwnProperty(p)&&delete l[g.treeReader[p]];void 0!==t&&(g.data[q]=a.extend(!0,t,l));l=null}Q.call(f,"afterSetRow",{rowid:b,inputData:c,iData:q,iRow:h.rowIndex,tr:h,localData:l,cssProp:e})}catch(w){d=!1}d&&("string"===m?a(h).addClass(e):null!==e&&"object"===m&&a(h).css(e))});return d},addRowData:function(b,
c,e,d){0>a.inArray(e,"first last before after afterSelected beforeSelected".split(" "))&&(e="last");var f=!1,g,h,m,l,n,p,q,r,t,w,x;c&&(a.isArray(c)?(p=!0,q=b):(c=[c],p=!1),this.each(function(){var y=this.p,A=c.length,u=a(this),E=this.rows,B=0,F=D.getGridRowById,k=y.colModel,C={},H=y.additionalProperties;p||(void 0!==b?b=String(b):(b=Ia(),!1!==y.keyName&&(q=y.keyName,void 0!==c[0][q]&&(b=c[0][q]))));for(r=y.altclass;B<A;){t=c[B];h=[];if(p)try{b=t[q],void 0===b&&(b=Ia())}catch(G){b=Ia()}x=b;for(l=0;l<
k.length;l++)w=k[l],g=w.name,"rn"!==g&&"cb"!==g&&"subgrid"!==g&&(n=lb.call(this,t[g],w,void 0,x,{},l),a.isFunction(w.saveLocally)?w.saveLocally.call(this,{newValue:n,newItem:C,oldItem:{},id:x,cm:w,cmName:g,iCol:l}):void 0!==n&&(C[g]=n));for(l=0;l<H.length;l++)g=H[l],"object"===typeof g&&g.hasOwnProperty("name")&&(g=g.name),n=na(t,g),void 0!==n&&(C[g]=n);"local"===y.datatype&&(C[y.localReader.id]=x,y._index[x]=y.data.length,y.data.push(C));h=v.parseDataToHtml.call(this,1,[b],[t]);h=h.join("");if(0===
E.length)a(this.tBodies[0]).append(h);else{if("afterSelected"===e||"beforeSelected"===e)void 0===d&&null!==y.selrow?(d=y.selrow,e="afterSelected"===e?"after":"before"):e="afterSelected"===e?"last":"first";switch(e){case "last":a(E[E.length-1]).after(h);m=E.length-1;break;case "first":a(E[0]).after(h);m=1;break;case "after":if(m=F.call(u,d))a(E[m.rowIndex+1]).hasClass("ui-subgrid")?(a(E[m.rowIndex+1]).after(h),m=m.rowIndex+2):(a(m).after(h),m=m.rowIndex+1);break;case "before":if(m=F.call(u,d))a(m).before(h),
m=m.rowIndex-1}}!0===y.subGrid&&D.addSubGrid.call(u,y.iColByName.subgrid,m);y.records++;y.reccount++;0===y.lastpage&&(y.lastpage=1);Q.call(this,"afterAddRow",{rowid:b,inputData:c,position:e,srcRowid:d,iRow:m,localData:C,iData:y.data.length-1});B++}!0!==y.altRows||p||("last"===e?0===(E.length-1)%2&&a(E[E.length-1]).addClass(r):a(E).each(function(b){1===b%2?a(this).addClass(r):a(this).removeClass(r)}));this.rebuildRowIndexes();this.updatepager(!0,!0);f=!0}));return f},footerData:function(b,c,e){function d(a){for(var b in a)if(a.hasOwnProperty(b))return!1;
return!0}var f,g=!1,h={},m;null==b&&(b="get");"boolean"!==typeof e&&(e=!0);b=b.toLowerCase();this.each(function(){var l=this,n=l.p,p;if(!l.grid||!n.footerrow||"set"===b&&d(c))return!1;g=!0;a(n.colModel).each(function(d){f=this.name;"set"===b?void 0!==c[f]&&(p=e?l.formatter("",c[f],d,c,"edit"):c[f],m=this.title?{title:ib(p)}:{},a("tr.footrow td:eq("+d+")",l.grid.sDiv).html(p).attr(m),g=!0):"get"===b&&(h[f]=a("tr.footrow td:eq("+d+")",l.grid.sDiv).html())})});return"get"===b?h:g},showHideCol:function(b,
c){return this.each(function(){var e=this,d=a(e),f=e.grid,g=!1,h=e.p,m=v.cell_width?0:h.cellLayout,l;if(f){"string"===typeof b&&(b=[b]);c="none"!==c?"":"none";var n=""===c?!0:!1,p=h.groupHeader;(p=p&&("object"===typeof p||a.isFunction(p)))&&D.destroyGroupHeader.call(d,!1);a(h.colModel).each(function(d){if(-1!==a.inArray(this.name,b)&&this.hidden===n){if(!0===h.frozenColumns&&!0===this.frozen)return!0;a("tr[role=row]",f.hDiv).each(function(){a(this.cells[d]).css("display",c)});a(e.rows).each(function(){var b=
this.cells[d];(!a(this).hasClass("jqgroup")||null!=b&&1===b.colSpan)&&a(b).css("display",c)});h.footerrow&&a("tr.footrow td:eq("+d+")",f.sDiv).css("display",c);l=parseInt(this.width,10);h.tblwidth="none"===c?h.tblwidth-(l+m):h.tblwidth+(l+m);this.hidden=!n;g=!0;Q.call(e,"onShowHideCol",n,this.name,d)}});!0===g&&D.setGridWidth.call(d,h.autowidth||void 0!==h.widthOrg&&"auto"!==h.widthOrg&&"100%"!==h.widthOrg?h.width:h.tblwidth+parseInt(h.scrollOffset,10));if(p)if(null!=h.pivotOptions&&null!=h.pivotOptions.colHeaders&&
1<h.pivotOptions.colHeaders.length)for(var q=h.pivotOptions.colHeaders,p=0;p<q.length;p++)q[p]&&q[p].groupHeaders.length&&D.setGroupHeaders.call(d,q[p]);else D.setGroupHeaders.call(d,h.groupHeader)}})},hideCol:function(b){return this.each(function(){D.showHideCol.call(a(this),b,"none")})},showCol:function(b){return this.each(function(){D.showHideCol.call(a(this),b,"")})},remapColumns:function(b,c,e){function d(c){var d=c.length?n(c):a.extend({},c);a.each(b,function(a){c[a]=d[this]})}function f(c,
d){(d?c.children(d):c.children()).each(function(){var c=this,d=n(c.cells);a.each(b,function(a){var b=d[this],e=c.cells[a];b.cellIndex!==a&&b.parentNode.insertBefore(b,e)})})}var g=this[0],h=g.p,m=g.grid,l,n=a.makeArray;if(null!=m&&null!=h){d(h.colModel);d(h.colNames);d(m.headers);f(a(m.hDiv).find(">div>.ui-jqgrid-htable>thead"),e&&":not(.ui-jqgrid-labels)");c&&f(a(g.tBodies[0]),"tr.jqgfirstrow,tr.jqgrow,tr.jqfoot");h.footerrow&&f(a(m.sDiv).find(">div>.ui-jqgrid-ftable>tbody").first());h.remapColumns&&
(h.remapColumns.length?d(h.remapColumns):h.remapColumns=n(b));h.lastsort=a.inArray(h.lastsort,b);h.iColByName={};m=0;for(l=h.colModel.length;m<l;m++)h.iColByName[h.colModel[m].name]=m;Q.call(g,"onRemapColumns",b,c,e)}},remapColumnsByName:function(b,c,e){var d=this[0].p,f=[],g,h;b=b.slice();g=a.inArray;d.subGrid&&0>g("subgrid",b)&&b.unshift("subgrid");d.multiselect&&0>g("cb",b)&&b.unshift("cb");d.rownumbers&&0>g("rn",b)&&b.unshift("rn");g=0;for(h=b.length;g<h;g++)f.push(d.iColByName[b[g]]);D.remapColumns.call(this,
f,c,e);return this},setGridWidth:function(b,c){return this.each(function(){var e=this.p,d,f=this.grid,g=0,h,m=0,l=!1,n,p=0,q=v.isCellClassHidden,r=b;if(f&&null!=e){this.fixScrollOffsetAndhBoxPadding();var t=e.colModel,w=e.scrollOffset,x=v.cell_width?0:e.cellLayout,y=f.headers,A=f.footers,u=f.bDiv,E=f.hDiv,B=f.sDiv,F=f.cols,k,C,H=a(E).find(">div>.ui-jqgrid-htable>thead>tr").first()[0].cells,G=function(b){f.width=e.width=b;a(e.gBox).css("width",b+"px");a(e.gView).css("width",b+"px");a(u).css("width",
b+"px");a(E).css("width",b+"px");e.pager&&a(e.pager).css("width",b+"px");e.toppager&&a(e.toppager).css("width",b+"px");!0===e.toolbar[0]&&(a(f.uDiv).css("width",b+"px"),"both"===e.toolbar[1]&&a(f.ubDiv).css("width",b+"px"));e.footerrow&&a(B).css("width",b+"px")};"boolean"!==typeof c&&(c=e.shrinkToFit);if(!isNaN(r)){r=parseInt(r,10);G(r);!1===c&&!0===e.forceFit&&(e.forceFit=!1);if(!0===c){a.each(t,function(){!1!==this.hidden||q(this.classes)||(d=this.widthOrg,g+=d+x,this.fixed?p+=this.width+x:m++)});
if(0===m)return;e.tblwidth=parseInt(g,10);n=r-x*m-p;!isNaN(e.height)&&(u.clientHeight<u.scrollHeight||1===this.rows.length)&&(l=!0,n-=w);C=n/(e.tblwidth-x*m-p);if(0>C)return;g=0;k=0<F.length;a.each(t,function(a){!1!==this.hidden||q(this.classes)||this.fixed||(this.width=d=Math.round(this.widthOrg*C),g+=d,y[a].width=d,H[a].style.width=d+"px",e.footerrow&&(A[a].style.width=d+"px"),k&&(F[a].style.width=d+"px"),h=a)});if(!h)return;n=0;l?r-p-(g+x*m)!==w&&(n=r-p-(g+x*m)-w):1!==Math.abs(r-p-(g+x*m))&&(n=
r-p-(g+x*m));t=t[h];t.width+=n;e.tblwidth=parseInt(g+n+x*m+p,10);e.tblwidth>r&&(n=e.tblwidth-parseInt(r,10),e.tblwidth=r,t.width-=n);d=t.width;r=y[h];r.width=d;H[h].style.width=d+"px";k&&(F[h].style.width=d+"px");e.footerrow&&(A[h].style.width=d+"px");e.tblwidth+(l?w:0)<e.width&&G(e.tblwidth+(l?w:0));u.offsetWidth>u.clientWidth&&(e.autowidth||void 0!==e.widthOrg&&"auto"!==e.widthOrg&&"100%"!==e.widthOrg||G(u.offsetWidth))}e.tblwidth&&(e.tblwidth=parseInt(e.tblwidth,10),r=e.tblwidth,E.scrollLeft=u.scrollLeft,
e.footerrow&&Ha(27,B).css("width",r+"px"),n=Math.abs(r-e.width),e.shrinkToFit&&!c&&3>n&&0<n&&(r<e.width&&G(r),u.offsetWidth>u.clientWidth&&(e.autowidth||void 0!==e.widthOrg&&"auto"!==e.widthOrg&&"100%"!==e.widthOrg||G(u.offsetWidth))));this.fixScrollOffsetAndhBoxPadding();l={resizeDiv:!0,resizedRows:{iRowStart:c?0:-1,iRowEnd:-1}};a(this).triggerHandler("jqGridResetFrozenHeights",[{header:l,resizeFooter:!0,body:l}])}}})},setGridHeight:function(b){return this.each(function(){var c=this.grid,e=this.p;
if(c){var d=a(c.bDiv);d.css({height:b+(isNaN(b)?"":"px")});!0===e.frozenColumns&&a(e.idSel+"_frozen").parent().height(d.height()-16);e.height=b;e.scroll&&c.populateVisible.call(this);this.fixScrollOffsetAndhBoxPadding();a(this).triggerHandler("jqGridResetFrozenHeights")}})},setCaption:function(b){return this.each(function(){var c=this.grid.cDiv;this.p.caption=b;a("span.ui-jqgrid-title, span.ui-jqgrid-title-rtl",c).html(b);a(c).show();a(c).nextAll("div").removeClass(D.getGuiStyles.call(this,"top"));
a(this).triggerHandler("jqGridResetFrozenHeights")})},setLabel:function(b,c,e,d){return this.each(function(){var f,g=this.p;if(this.grid){if(isNaN(b)){if(f=g.iColByName[b],void 0===f)return}else f=parseInt(b,10);if(0<=f){var h=a("tr.ui-jqgrid-labels th:eq("+f+")",this.grid.hDiv);if(c){var m=a(".s-ico",h);a("[id^=jqgh_]",h).empty().html(c).append(m);g.colNames[f]=c}e&&("string"===typeof e?a(h).addClass(e):a(h).css(e));"object"===typeof d&&a(h).attr(d)}}})},setCell:function(b,c,e,d,f,g){return this.each(function(){var h=
this.p,m=-1,l=h.colModel,n,p,q,r,t,w,x,y={},A;if(this.grid&&(m=isNaN(c)?h.iColByName[c]:parseInt(c,10),0<=m&&(r=D.getGridRowById.call(a(this),b)))){t=v.getCell.call(this,r,m);if(""!==e||!0===g){p=l[m];"local"===h.datatype&&(A=Oa(h.idPrefix,b),n=h._index[A],void 0!==n&&(q=h.data[n]));if(null==q)for(n=0;n<r.cells.length;n++){if(n!==m&&(w=v.getDataFieldOfCell.call(this,r,n),0<w.length)){try{x=a.unformat.call(this,w,{rowId:b,colModel:l[n]},n)}catch(u){x=Ea(w[0].innerHTML)}y[l[n].name]=x}}else y=q;y[p.name]=
e;l=this.formatter(b,e,m,y,"edit");h=h.colModel[m].title?{title:ib(l)}:{};t.html(l).attr(h);null!=q&&(l=lb.call(this,e,p,q[p.name],A,q,m),a.isFunction(p.saveLocally)?p.saveLocally.call(this,{newValue:l,newItem:q,oldItem:q,id:A,cm:p,cmName:p.name,iCol:m}):q[p.name]=l)}if(d||f){t=v.getCell.call(this,r,m);if(d)t["string"===typeof d?"addClass":"css"](d);"object"===typeof f&&t.attr(f)}}})},getCell:function(b,c){var e=!1;this.each(function(){var d,f=this.p,g,h;if(this.grid&&(d=isNaN(c)?f.iColByName[c]:
parseInt(c,10),0<=d&&(g=D.getGridRowById.call(a(this),b)))){h=v.getDataFieldOfCell.call(this,g,d).first();try{e=a.unformat.call(this,h,{rowId:g.id,colModel:f.colModel[d]},d)}catch(m){e=Ea(h.html())}}});return e},getCol:function(b,c,e){var d=[],f,g=0,h,m,l;c="boolean"!==typeof c?!1:c;void 0===e&&(e=!1);this.each(function(){var n,p=this.p,q;if(this.grid&&(n=isNaN(b)?p.iColByName[b]:parseInt(b,10),0<=n)){var r=this.rows,t=r.length,w=0,x=0,y;if(t&&0<t){for(;w<t;){y=r[w];if(a(y).hasClass("jqgrow")){q=
v.getDataFieldOfCell.call(this,y,n).first();try{f=a.unformat.call(this,q,{rowId:y.id,colModel:p.colModel[n]},n)}catch(A){f=Ea(q.html())}e?(l=parseFloat(f),isNaN(l)||(g+=l,void 0===m&&(m=h=l),h=Math.min(h,l),m=Math.max(m,l),x++)):c?d.push({id:y.id,value:f}):d.push(f)}w++}if(e)switch(e.toLowerCase()){case "sum":d=g;break;case "avg":d=g/x;break;case "count":d=t-1;break;case "min":d=h;break;case "max":d=m}}}});return d},clearGridData:function(b){return this.each(function(){var c=this.p,e=this.rows,d=
this.grid;d&&c&&e&&("boolean"!==typeof b&&(b=!1),a(this).unbind(".jqGridFormatter"),d.emptyRows.call(this,!1,!0),c.footerrow&&b&&a(".ui-jqgrid-ftable td",d.sDiv).html("&#160;"),c.selrow=null,V(c.selarrrow),V(c.savedRow),V(c.data),V(c.lastSelectedData),c._index={},c.rowIndexes={},c.records=0,c.page=1,c.lastpage=0,c.reccount=0,this.updatepager(!0,!1))})},getInd:function(b,c){var e=D.getGridRowById.call(a(this),b);return e?!0===c?e:e.rowIndex:!1},bindKeys:function(b){var c=a.extend({onEnter:null,onSpace:null,
onLeftKey:null,onRightKey:null,scrollingRows:!0},b||{});return this.each(function(){var b=this,d=b.p,f=a(b);d.scrollrows=c.scrollingRows;f.bind("keydown.jqGrid",function(g){var h=a(this).find("tr[tabindex=0]")[0],m=v.detectRowEditing.call(b,a(g.target).closest("tr.jqgrow").attr("id")),l=function(b){do if(h=h[b],null===h)return;while(a(h).is(":hidden")||!a(h).hasClass("jqgrow"));D.setSelection.call(f,h.id,!0);g.preventDefault()},n=function(g,h){var l=c["on"+g+(h||"")];f.triggerHandler("jqGridKey"+
g,[d.selrow]);a.isFunction(l)&&l.call(b,d.selrow)},p=function(b){if(d.treeGrid){var c=d.data[d._index[Oa(d.idPrefix,h.id)]][d.treeReader.expanded_field];"Right"===b&&(c=!c);c&&a(h).find("div.treeclick").trigger("click")}n(b,"Key")};if(h&&null===m)switch(g.keyCode){case 38:l("previousSibling");break;case 40:l("nextSibling");break;case 37:p("Left");break;case 39:p("Right");break;case 13:n("Enter");break;case 32:n("Space")}})})},unbindKeys:function(){return this.each(function(){a(this).unbind("keydown.jqGrid")})},
...
l):h.treeGrid&&h.ExpandColumn===m.name&&(d=c.children(".cell-wrapper,.cell-wrapperleaf"),r=Math.max(r,d.outerWidth()+l+c.children(".tree-wrap").outerWidth()))):a(d).hasClass("jqgfirstrow")&&(l=(v.cell_width?parseFloat(c.css("padding-left")||0)+parseFloat(c.css("padding-right")||0):0)+parseFloat(c.css("border-right")||0)+parseFloat(c.css("border-left")||0));r=Math.max(r,null!=m.autoResizing&&void 0!==m.autoResizing.minColWidth?m.autoResizing.minColWidth:h.autoResizing.minColWidth);return Math.min(r,
null!=m.autoResizing&&void 0!==m.autoResizing.maxColWidth?m.autoResizing.maxColWidth:h.autoResizing.maxColWidth)},autoResizeColumn:function(b,c){return this.each(function(){var e=a(this),d=this.p,f=d.colModel[b],g,h=a(this.grid.headers[b].el);g=D.getAutoResizableWidth.call(e,b);null==f||0>g||g===f.width||(D.setColWidth.call(e,b,g,d.autoResizing.adjustGridWidth&&!d.autoResizing.fixWidthOnShrink&&!c,c),d.autoResizing.fixWidthOnShrink&&d.shrinkToFit&&!c&&(f.fixed=!0,g=f.widthOrg,f.widthOrg=f.width,D.setGridWidth.call(e,
d.width,!0),f.widthOrg=g,f.fixed=!1),h.data("autoResized","true"))})},autoResizeAllColumns:function(){return this.each(function(){var b=a(this),c=this.p,e=c.colModel,d=e.length,f,g,h=c.shrinkToFit,m=c.autoResizing.adjustGridWidth,l=c.autoResizing.fixWidthOnShrink,n=parseInt(c.widthOrg,10),p=this.grid,q=D.autoResizeColumn;c.shrinkToFit=!1;c.autoResizing.adjustGridWidth=!0;c.autoResizing.fixWidthOnShrink=!1;for(f=0;f<d;f++)g=e[f],g.autoResizable&&"actions"!==g.formatter&&q.call(b,f,!0);p.hDiv.scrollLeft=
p.bDiv.scrollLeft;c.footerrow&&(p.sDiv.scrollLeft=p.bDiv.scrollLeft);this.fixScrollOffsetAndhBoxPadding();isNaN(n)?m&&D.setGridWidth.call(b,p.newWidth+c.scrollOffset,!1):D.setGridWidth.call(b,n,!1);c.autoResizing.fixWidthOnShrink=l;c.autoResizing.adjustGridWidth=m;c.shrinkToFit=h})}});var ba=function(a,c){return v.mergeCssClasses(v.getRes(v.guiStyles[this.p.guiStyle],"states."+a),c||"")},wa=function(b,c){var e=this.grid.fbRows;return a((null!=e&&e[0].cells.length>c?e[b.rowIndex]:b).cells[c])};v.extend({editCell:function(b,
...
n=g.colModel[c];h=n.name;if("subgrid"!==h&&"cb"!==h&&"rn"!==h){l=wa.call(d,p,c);p=n.editable;a.isFunction(p)&&(p=p.call(d,{rowid:q,iCol:c,iRow:b,name:h,cm:n,mode:"cell"}));var A=ba.call(d,"select","edit-cell"),u=ba.call(d,"hover","selected-row");if(!0!==p||!0!==e||l.hasClass("not-editable-cell"))0<=t&&0<=w&&(wa.call(d,x[0],t).removeClass(A),x.removeClass(u)),l.addClass(A),r.addClass(u),m=l.html().replace(/\&#160\;/ig,""),Q.call(d,"onSelectCell",q,h,m,b,c);else{0<=t&&0<=w&&(wa.call(d,x[0],t).removeClass(A),
x.removeClass(u));l.addClass(A);r.addClass(u);n.edittype||(n.edittype="text");r=n.edittype;try{m=a.unformat.call(d,l,{rowId:q,colModel:n},c)}catch(B){m="textarea"===r?l.text():l.html()}g.autoEncodeOnEdit&&(m=v.oldDecodePostedData(m));y.push({id:b,ic:c,name:h,v:m});if("&nbsp;"===m||"&#160;"===m||1===m.length&&160===m.charCodeAt(0))m="";a.isFunction(g.formatCell)&&(t=g.formatCell.call(d,q,h,m,b,c),void 0!==t&&(m=t));Q.call(d,"beforeEditCell",q,h,m,b,c);n=a.extend({},n.editoptions||{},{id:b+"_"+h,name:h,
rowId:q,mode:"cell"});var E=v.createEl.call(d,r,n,m,!0,a.extend({},v.ajaxOptions,g.ajaxSelectOptions||{})),r=l;(t=!0===g.treeGrid&&h===g.ExpandColumn)&&(r=l.children("span.cell-wrapperleaf,span.cell-wrapper"));r.html("").append(E).attr("tabindex","0");t&&a(E).width(l.width()-l.children("div.tree-wrap").outerWidth());v.bindEv.call(d,E,n);setTimeout(function(){a(E).focus()},1);a("input, select, textarea",l).bind("keydown",function(e){27===e.keyCode&&(0<a("input.hasDatepicker",l).length?a(".ui-datepicker").is(":hidden")?
f.jqGrid("restoreCell",b,c):a("input.hasDatepicker",l).datepicker("hide"):f.jqGrid("restoreCell",b,c));if(13===e.keyCode&&!e.shiftKey)return f.jqGrid("saveCell",b,c),!1;if(9===e.keyCode){if(d.grid.hDiv.loading)return!1;e.shiftKey?f.jqGrid("prevCell",b,c):f.jqGrid("nextCell",b,c)}e.stopPropagation()});Q.call(d,"afterEditCell",q,h,m,b,c);f.triggerHandler("jqGridAfterEditCell",[q,h,m,b,c])}g.iCol=c;g.iRow=b}}}})},saveCell:function(b,c){return this.each(function(){var e=this,d=a(e),f=e.p,g=v.info_dialog,
h=v.jqID;if(e.grid&&!0===f.cellEdit){var m=d.jqGrid("getGridRes","errors"),l=m.errcap,n=d.jqGrid("getGridRes","edit").bClose,p=f.savedRow,q=1<=p.length?0:null;if(null!==q){var r=e.rows[b],t=r.id,w=a(r),x=f.colModel[c],y=x.name,A,u=wa.call(e,r,c),E={},B=v.getEditedValue.call(e,u,x,E);if(B!==p[q].v){A=d.triggerHandler("jqGridBeforeSaveCell",[t,y,B,b,c]);void 0!==A&&(B=A);a.isFunction(f.beforeSaveCell)&&(A=f.beforeSaveCell.call(e,t,y,B,b,c),void 0!==A&&(B=A));var F=v.checkValues.call(e,B,c,void 0,void 0,
{oldValue:p[q].v,newValue:B,cmName:y,rowid:t,iCol:c,iRow:b,cm:x,tr:r,td:u,mode:"cell"}),r=x.formatoptions||{};if(!0===F[0]){q=d.triggerHandler("jqGridBeforeSubmitCell",[t,y,B,b,c])||{};a.isFunction(f.beforeSubmitCell)&&((q=f.beforeSubmitCell.call(e,t,y,B,b,c))||(q={}));0<a("input.hasDatepicker",u).length&&a("input.hasDatepicker",u).datepicker("hide");"date"===x.formatter&&!0!==r.sendFormatted&&(B=a.unformat.date.call(e,B,x));if("remote"===f.cellsubmit)if(f.cellurl){var k={};k[y]=B;var m=f.prmNames,
...
{method:"hide",loadtype:f.loadui});C.loading=!1;if((300>h.status||304===h.status)&&(0!==h.status||4!==h.readyState)){var m=d.triggerHandler("jqGridAfterSubmitCell",[e,h,k.id,y,B,b,c])||[!0,""];!0===m[0]&&a.isFunction(f.afterSubmitCell)&&(m=f.afterSubmitCell.call(e,h,k.id,y,B,b,c));!0===m[0]?(d.jqGrid("setCell",t,c,B,!1,!1,!0),u.addClass("dirty-cell"),w.addClass("edited"),Q.call(e,"afterSaveCell",t,y,B,b,c),p.splice(0,1)):(g.call(e,l,m[1],n),d.jqGrid("restoreCell",b,c))}},error:function(k,m,p){a("#lui_"+
h(f.id)).hide();C.loading=!1;d.triggerHandler("jqGridErrorCell",[k,m,p]);a.isFunction(f.errorCell)?f.errorCell.call(e,k,m,p):g.call(e,l,k.status+" : "+k.statusText+"<br/>"+m,n);d.jqGrid("restoreCell",b,c)}},v.ajaxOptions,f.ajaxCellOptions||{}))}else try{g.call(e,l,m.nourl,n),d.jqGrid("restoreCell",b,c)}catch(H){}"clientArray"===f.cellsubmit&&(d.jqGrid("setCell",t,c,"select"===x.edittype&&"select"!==x.formatter?E.text:B,!1,!1,!0),u.addClass("dirty-cell"),w.addClass("edited"),Q.call(e,"afterSaveCell",
t,y,B,b,c),p.splice(0,1))}else try{setTimeout(function(){g.call(e,l,B+" "+F[1],n)},100),d.jqGrid("restoreCell",b,c)}catch(H){}}else d.jqGrid("restoreCell",b,c)}setTimeout(function(){a("#"+h(f.knv)).attr("tabindex","-1").focus()},0)}})},restoreCell:function(b,c){return this.each(function(){var e=this.p,d=this.rows[b],f=d.id,g,h;if(this.grid&&!0===e.cellEdit){var m=e.savedRow;g=wa.call(this,d,c);if(1<=m.length){if(a.isFunction(a.fn.datepicker))try{a("input.hasDatepicker",g).datepicker("hide")}catch(l){}d=
...
f=!1,g,h,m,l=this.rows;if(this.grid&&!0===d.cellEdit&&null!=l&&null!=l[b]){for(g=c+1;g<d.colModel.length;g++)if(m=d.colModel[g],h=m.editable,a.isFunction(h)&&(h=h.call(this,{rowid:l[b].id,iCol:g,iRow:b,name:m.name,cm:m,mode:"cell"})),!0===h){f=g;break}!1!==f?e.jqGrid("editCell",b,f,!0):0<d.savedRow.length&&e.jqGrid("saveCell",b,c)}})},prevCell:function(b,c){return this.each(function(){var e=a(this),d=this.p,f=!1,g,h,m,l=this.rows;if(this.grid&&!0===d.cellEdit&&null!=l&&null!=l[b]){for(g=c-1;0<=g;g--)if(m=
d.colModel[g],h=m.editable,a.isFunction(h)&&(h=h.call(this,{rowid:l[b].id,iCol:g,iRow:b,name:m.name,cm:m,mode:"cell"})),!0===h){f=g;break}!1!==f?e.jqGrid("editCell",b,f,!0):0<d.savedRow.length&&e.jqGrid("saveCell",b,c)}})},GridNav:function(){return this.each(function(){function b(a,b,c){a=e.rows[a];if("v"===c.substr(0,1)){var d=l.clientHeight,f=l.scrollTop,g=a.offsetTop+a.clientHeight,h=a.offsetTop;"vd"===c&&g>=d&&(l.scrollTop+=a.clientHeight);"vu"===c&&h<f&&(l.scrollTop-=a.clientHeight)}"h"===c&&
(c=l.scrollLeft,b=a.cells[b],a=b.offsetLeft,b.offsetLeft+b.clientWidth>=l.clientWidth+parseInt(c,10)?l.scrollLeft+=b.clientWidth:a<c&&(l.scrollLeft-=b.clientWidth))}function c(a,b){var c=0,d,e=f.colModel;if("lft"===b)for(c=a+1,d=a;0<=d;d--)if(!0!==e[d].hidden){c=d;break}if("rgt"===b)for(c=a-1,d=a;d<e.length;d++)if(!0!==e[d].hidden){c=d;break}return c}var e=this,d=a(e),f=e.p,g=e.grid,h,m;if(g&&!0===f.cellEdit){var l=g.bDiv;f.knv=f.id+"_kn";var n=a("<div style='position:fixed;top:0px;width:1px;height:1px;' tabindex='0'><div tabindex='-1' style='width:1px;height:1px;' id='"+
f.knv+"'></div></div>");a(n).insertBefore(g.cDiv);a("#"+f.knv).focus().keydown(function(a){var g=parseInt(f.iRow,10),l=parseInt(f.iCol,10);m=a.keyCode;"rtl"===f.direction&&(37===m?m=39:39===m&&(m=37));switch(m){case 38:0<g-1&&(b(g-1,l,"vu"),d.jqGrid("editCell",g-1,l,!1));break;case 40:g+1<=e.rows.length-1&&(b(g+1,l,"vd"),d.jqGrid("editCell",g+1,l,!1));break;case 37:0<=l-1&&(h=c(l-1,"lft"),b(g,h,"h"),d.jqGrid("editCell",g,h,!1));break;case 39:l+1<=f.colModel.length-1&&(h=c(l+1,"rgt"),b(g,h,"h"),d.jqGrid("editCell",
g,h,!1));break;case 13:0<=l&&0<=g&&d.jqGrid("editCell",g,l,!0);break;default:return!0}return!1})}})},getChangedCells:function(b){var c=[];b||(b="all");this.each(function(){var e=this,d=e.p,f=v.htmlDecode,g=e.rows;e.grid&&!0===d.cellEdit&&a(g).each(function(h){var m={};if(a(this).hasClass("edited")){var l=this;a(this.cells).each(function(c){var p=d.colModel[c],q=p.name,r=wa.call(e,l,c);if("cb"!==q&&"subgrid"!==q&&"rn"!==q&&("dirty"!==b||r.hasClass("dirty-cell")))try{m[q]=a.unformat.call(e,r[0],{rowId:g[h].id,
colModel:p},c)}catch(t){m[q]=f(r.html())}});m.id=this.id;c.push(m)}})});return c}});var ga=v.getMethod("getGridRes"),aa=function(a,c){return v.mergeCssClasses(v.getRes(v.guiStyles[this.p.guiStyle||v.defaults.guiStyle||"jQueryUI"],a),c||"")};v.jqModal=v.jqModal||{};a.extend(!0,v.jqModal,{toTop:!0});a.extend(v,{showModal:function(a){a.w.show()},closeModal:function(a){a.w.hide().attr("aria-hidden","true");a.o&&a.o.remove()},hideModal:function(b,c){c=a.extend({jqm:!0,gb:"",removemodal:!1,formprop:!1,
...
width:d.width(),height:f,dataheight:a(g).height(),datawidth:a(g).width()})}if(a.fn.jqm&&!0===c.jqm)d.attr("aria-hidden","true").jqmHide();else{if(""!==c.gb)try{a(">.jqgrid-overlay",c.gb).first().hide()}catch(m){}d.hide().attr("aria-hidden","true")}c.removemodal&&d.remove()},findPos:function(a){var c=0,e=0;if(a.offsetParent){do c+=a.offsetLeft,e+=a.offsetTop,a=a.offsetParent;while(a)}return[c,e]},createModal:function(b,c,e,d,f,g,h){var m=v.jqID,l=this.p;e=a.extend(!0,{resizingRightBottomIcon:"ui-icon ui-icon-gripsmall-diagonal-se"},
v.jqModal||{},null!=l?l.jqModal||{}:{},e);var n=document.createElement("div"),p="#"+m(b.themodal),q="rtl"===a(e.gbox).attr("dir")?!0:!1,r=b.resizeAlso?"#"+m(b.resizeAlso):!1;h=a.extend({},h||{});n.className=aa.call(this,"dialog.window","ui-jqdialog");n.id=b.themodal;n.dir=q?"rtl":"ltr";var t=document.createElement("div");t.className=aa.call(this,"dialog.header","ui-jqdialog-titlebar "+(q?"ui-jqdialog-titlebar-rtl":"ui-jqdialog-titlebar-ltr"));t.id=b.modalhead;a(t).append("<span class='ui-jqdialog-title'>"+
e.caption+"</span>");var w=aa.call(this,"states.hover"),x=a("<a class='ui-jqdialog-titlebar-close ui-corner-all'></a>").hover(function(){x.addClass(w)},function(){x.removeClass(w)}).append("<span class='"+v.getIconRes(l.iconSet,"form.close")+"'></span>");a(t).append(x);l=document.createElement("div");a(l).addClass(aa.call(this,"dialog.content","ui-jqdialog-content")).attr("id",b.modalcontent);a(l).append(c);n.appendChild(l);a(n).prepend(t);!0===g?a("body").append(n):"string"===typeof g?a(g).append(n):
...
"false");try{a(":input:visible",b)[0].focus()}catch(e){}}},info_dialog:function(b,c,e,d){var f=this,g=f.p,h=a.extend(!0,{width:290,height:"auto",dataheight:"auto",drag:!0,resize:!1,left:250,top:170,zIndex:1E3,jqModal:!0,modal:!1,closeOnEscape:!0,align:"center",buttonalign:"center",buttons:[]},v.jqModal||{},null!=g?g.jqModal||{}:{},{caption:"<b>"+b+"</b>"},d||{}),m=h.jqModal;a.fn.jqm&&!m&&(m=!1);b="";var l=aa.call(f,"states.hover");if(0<h.buttons.length)for(d=0;d<h.buttons.length;d++)void 0===h.buttons[d].id&&
(h.buttons[d].id="info_button_"+d),b+=v.builderFmButon.call(f,h.buttons[d].id,h.buttons[d].text);d=isNaN(h.dataheight)?h.dataheight:h.dataheight+"px";c="<div id='info_id'>"+("<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:"+d+";"+("text-align:"+h.align+";")+"'>"+c+"</div>");if(e||""!==b)c+="<hr class='"+aa.call(f,"dialog.hr")+"' style='margin:1px'/><div style='text-align:"+h.buttonalign+";padding:.8em 0 .5em 0;background-image:none;border-width: 1px 0 0 0;'>"+
...
var h="",m=this,l=m.p,n=v.info_dialog,p=ga.call(a(m),"errors.errcap"),q=ga.call(a(m),"edit"),r=q.msg,q=q.bClose;switch(b){case "textarea":h=document.createElement("textarea");d?c.cols||a(h).css({width:"100%","box-sizing":"border-box"}):c.cols||(c.cols=20);c.rows||(c.rows=2);if("&nbsp;"===e||"&#160;"===e||1===e.length&&160===e.charCodeAt(0))e="";h.value=e;g(h,c);a(h).attr({role:"textbox"});break;case "checkbox":h=document.createElement("input");h.type="checkbox";if(c.value){var t=c.value.split(":");
e===t[0]&&(h.checked=!0,h.defaultChecked=!0);h.value=t[0];a(h).data("offval",t[1])}else t=String(e).toLowerCase(),0>t.search(/(false|f|0|no|n|off|undefined)/i)&&""!==t?(h.checked=!0,h.defaultChecked=!0,h.value=e):h.value="on",a(h).data("offval","off");g(h,c,["value"]);a(h).attr({role:"checkbox","aria-checked":h.checked?"true":"false"});break;case "select":h=document.createElement("select");b=[];d=l.iColByName[c.name];n=l.colModel[d];!0===c.multiple?(p=!0,h.multiple="multiple",a(h).attr("aria-multiselectable",
"true"),b=e.split(","),b=a.map(b,function(b){return a.trim(b)})):(p=!1,b[0]=a.trim(e));void 0===c.size&&(c.size=p?3:1);if(void 0!==c.dataUrl){var t=null,w=c.postData||f.postData,x={elem:h,options:c,cm:n,iCol:d,ovm:b};try{t=c.rowId}catch(E){}l&&l.idPrefix&&(t=v.stripPref(l.idPrefix,t));a.ajax(a.extend({url:a.isFunction(c.dataUrl)?c.dataUrl.call(m,t,e,String(c.name),x):c.dataUrl,type:"GET",dataType:"html",data:a.isFunction(w)?w.call(m,t,e,String(c.name)):w,context:x,success:function(b,c,d){var e=this.ovm,
f=this.elem,h=this.cm,l=this.iCol,n=a.extend({},this.options);b=a.isFunction(n.buildSelect)?n.buildSelect.call(m,b,d,h,l):b;"string"===typeof b&&(b=a(a.trim(b)).html());b&&(a(f).append(b),g(f,n,w?["postData"]:void 0),setTimeout(function(){var b;a("option",f).each(function(c){0===c&&f.multiple&&(this.selected=!1);-1<a.inArray(a.trim(a(this).val()),e)&&(this.selected="selected",b=!0)});b||a("option",f).each(function(){-1<a.inArray(a.trim(a(this).text()),e)&&(this.selected="selected")});v.fullBoolFeedback.call(m,
n.selectFilled,"jqGridSelectFilled",{elem:f,options:n,cm:h,cmName:h.name,iCol:l})},0))}},f||{}))}else if(c.value){"function"===typeof c.value&&(c.value=c.value());var y,A;f=[];var u,l=void 0===c.separator?":":c.separator;A=void 0===c.delimiter?";":c.delimiter;r=function(a,b){if(0<b)return a};if("string"===typeof c.value)for(A=c.value.split(A),y=0;y<A.length;y++)q=A[y].split(l),2<q.length&&(q[1]=a.map(q,r).join(l)),f.push({value:q[0],innerHtml:q[1],selectValue:a.trim(q[0]),selectText:a.trim(q[1])});
else if("object"===typeof c.value)for(y in l=c.value,l)l.hasOwnProperty(y)&&f.push({value:y,innerHtml:l[y],selectValue:a.trim(y),selectText:a.trim(l[y])});for(y=0;y<f.length;y++)u=f[y],x=document.createElement("option"),x.value=u.value,x.innerHTML=u.innerHtml,h.appendChild(x),p||u.selectValue!==a.trim(e)||(x.selected="selected",t=!0),p&&-1<a.inArray(u.selectValue,b)&&(x.selected="selected",t=!0);if(!t)for(y=0;y<u.length;y++)p||u.selectText!==a.trim(e)||(x.selected="selected"),p&&-1<a.inArray(u.selectText,
...
document.createElement("span");try{if(a.isFunction(c.custom_element))if(A=c.custom_element.call(m,e,c),A instanceof jQuery||v.isHTMLElement(A)||"string"===typeof A)A=a(A).addClass("customelement").attr({id:c.id,name:c.name}),a(h).empty().append(A);else throw"editoptions.custom_element returns value of a wrong type";else throw"editoptions.custom_element is not a function";}catch(E){"e1"===E&&n.call(m,p,"function 'custom_element' "+r.nodefined,q),"e2"===E?n.call(m,p,"function 'custom_element' "+r.novalue,
q):n.call(m,p,"string"===typeof E?E:E.message,q)}}return h},checkDate:function(a,c){var e={},d;a=a.toLowerCase();d=-1!==a.indexOf("/")?"/":-1!==a.indexOf("-")?"-":-1!==a.indexOf(".")?".":"/";a=a.split(d);c=c.split(d);if(3!==c.length)return!1;var f=-1,g,h=d=-1,m;for(m=0;m<a.length;m++)g=isNaN(c[m])?0:parseInt(c[m],10),e[a[m]]=g,g=a[m],-1!==g.indexOf("y")&&(f=m),-1!==g.indexOf("m")&&(h=m),-1!==g.indexOf("d")&&(d=m);g="y"===a[f]||"yyyy"===a[f]?4:"yy"===a[f]?2:-1;var l;m=[0,31,29,31,30,31,30,31,31,30,
31,30,31];if(-1===f)return!1;l=e[a[f]].toString();2===g&&1===l.length&&(g=1);if(l.length!==g||0===e[a[f]]&&"00"!==c[f]||-1===h)return!1;l=e[a[h]].toString();if(1>l.length||1>e[a[h]]||12<e[a[h]]||-1===d)return!1;l=e[a[d]].toString();!(g=1>l.length||1>e[a[d]]||31<e[a[d]])&&(g=2===e[a[h]])&&(f=e[a[f]],g=e[a[d]]>(0!==f%4||0===f%100&&0!==f%400?28:29));return g||e[a[d]]>m[e[a[h]]]?!1:!0},isEmpty:function(a){return a.match(/^\s+$/)||""===a?!0:!1},checkTime:function(a){var c=/^(\d{1,2}):(\d{2})([apAP][Mm])?$/;
if(!v.isEmpty(a))if(a=a.match(c)){if(a[3]){if(1>a[1]||12<a[1])return!1}else if(23<a[1])return!1;if(59<a[2])return!1}else return!1;return!0},checkValues:function(b,c,e,d,f){var g,h,m=this.p;h=m.colModel;var l=v.isEmpty,n=ga.call(a(this),"edit.msg"),p=ga.call(a(this),"formatter.date.masks");if(void 0===e){"string"===typeof c&&(c=m.iColByName[c]);if(void 0===c||0>c)return[!0,"",""];d=h[c];e=d.editrules;null!=d.formoptions&&(g=d.formoptions.label)}else g=void 0===d?"_":d,d=h[c];if(e){g||(g=null!=m.colNames?
m.colNames[c]:d.label);if(!0===e.required&&l(b))return[!1,g+": "+n.required,""];m=!1===e.required?!1:!0;if(!0===e.number&&(!1!==m||!l(b))&&isNaN(b))return[!1,g+": "+n.number,""];if(void 0!==e.minValue&&!isNaN(e.minValue)&&parseFloat(b)<parseFloat(e.minValue))return[!1,g+": "+n.minValue+" "+e.minValue,""];if(void 0!==e.maxValue&&!isNaN(e.maxValue)&&parseFloat(b)>parseFloat(e.maxValue))return[!1,g+": "+n.maxValue+" "+e.maxValue,""];var q;if(!(!0!==e.email||!1===m&&l(b)||(q=/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i,
...
v.ajaxOptions,f.ajaxSelectOptions||{}));else{var D,I,X;w?(D=void 0===w.value?"":w.value,I=void 0===w.separator?":":w.separator,X=void 0===w.delimiter?";":w.delimiter):x&&(D=void 0===x.value?"":x.value,I=void 0===x.separator?":":x.separator,X=void 0===x.delimiter?";":x.delimiter);if(D){var L=document.createElement("select");L.style.width="100%";a(L).attr({name:this.index||this.name,id:"gs_"+this.name});var Y;if("string"===typeof D)for(e=D.split(X),Y=0;Y<e.length;Y++)D=e[Y].split(I),X=document.createElement("option"),
X.value=D[0],X.innerHTML=D[1],L.appendChild(X);else if("object"===typeof D)for(Y in D)D.hasOwnProperty(Y)&&(X=document.createElement("option"),X.value=Y,X.innerHTML=D[Y],L.appendChild(X));void 0!==d.defaultValue&&a(L).val(d.defaultValue);d.attr&&a(L).attr(d.attr);a(L).addClass(y);a(N).append(z);g.call(c,L,d);a("td",z).eq(1).append(L);v.fullBoolFeedback.call(c,d.selectFilled,"jqGridSelectFilled",{elem:L,options:w||x||{},cm:this,cmName:this.name,iCol:b,mode:"filter"});!0===l.autosearch&&a(L).change(function(){A();
...
"']").append(L);else throw"e2";else throw"e1";}catch(T){"e1"===T&&h.call(c,q,"function 'custom_element' "+t.nodefined,r),"e2"===T?h.call(c,q,"function 'custom_element' "+t.novalue,r):h.call(c,q,"string"===typeof T?T:T.message,r)}}}a(B).append(N);a(k).append(B);l.searchOperators||a("td",z).eq(0).hide()});a(e.hDiv).find(">div>.ui-jqgrid-htable>thead").append(k);l.searchOperators&&(a(".soptclass",k).click(function(b){var c=a(this).offset();B(this,c.left,c.top);b.stopPropagation()}),a("body").on("click",
...
b));return g};this.createTableRowForRule=function(b,c){var e=this,f=l(),g=a("<tr></tr>"),h,p,q,r="",k;g.append("<td class='first'></td>");var C=a("<td class='columns'></td>");g.append(C);var H=a("<select></select>"),G,K=[];C.append(H);H.bind("change",function(){b.field=a(H).val();var c=a(this).parents("tr:first"),d,g;for(g=0;g<e.p.columns.length;g++)if(e.p.columns[g].name===b.field){d=e.p.columns[g];break}if(d){var h=a.extend({},d.searchoptions||{},{id:v.randId(),name:d.name,mode:"search"});m&&"text"===
...
setTimeout(function(){b.data=a(k).val();e.onchange()},0)}});var C=0,J,O;for(h=0;h<e.p.columns.length;h++)if(k=void 0===e.p.columns[h].search?!0:e.p.columns[h].search,J=!0===e.p.columns[h].hidden,(O=!0===e.p.columns[h].searchoptions.searchhidden)&&k||k&&!J)k="",b.field===e.p.columns[h].name&&(k=" selected='selected'",C=h),r+="<option value='"+e.p.columns[h].name+"'"+k+">"+e.p.columns[h].label+"</option>";H.append(r);r=a("<td class='operators'></td>");g.append(r);q=d.columns[C];m&&"text"===q.inputtype&&
...
function(){var b=a(this).val();"default"===b?a(h).jqFilter("addFilter",t):a(h).jqFilter("addFilter",g.tmplFilters[parseInt(b,10)]);return!1});!0===g.multipleGroup&&(g.multipleSearch=!0);w("onInitialize",a(h));g.layer?za.call(e,l,x,g,q,a(p)[0],"#"+I(g.layer),{position:"relative"}):za.call(e,l,x,g,q,a(p)[0]);(g.searchOnEnter||g.closeOnEscape)&&a(n).keydown(function(b){var c=a(b.target);if(!(!g.searchOnEnter||13!==b.which||c.hasClass("add-group")||c.hasClass("add-rule")||c.hasClass("delete-group")||
...
b);qa.call(e,g.onReset,"jqGridFilterReset")&&d.trigger("reloadGrid",[a.extend({page:1},g.reloadGridResetOptions||{})]);g.closeAfterReset&&da(n,{gb:p,jqm:g.jqModal,onClose:g.onClose,removemodal:g.removemodal});return!1});c(a(h));var H=ba.call(e,"hover");a(".fm-button:not(."+ba.call(e,"disabled").split(" ").join(".")+")",x).hover(function(){a(this).addClass(H)},function(){a(this).removeClass(H)})}}})},editGridRow:function(b,c){return this.each(function(){function e(){a(k+" > tbody > tr > td .FormElement").each(function(){var b=
a(".customelement",this),c=this.name;if(b.length){if(c=b.attr("name"),b=Za[c],void 0!==b&&(b=O[b],b=b.editoptions||{},a.isFunction(b.custom_value))){try{if(z[c]=b.custom_value.call(r,a("#"+I(c),k),"get"),void 0===z[c])throw"e1";}catch(d){"e1"===d?Xa.call(r,X,"function 'custom_value' "+u.msg.novalue,u.bClose):Xa.call(r,X,d.message,u.bClose)}return!0}}else switch(b=a(this)[0].type,b){case "checkbox":z[c]=a(this).is(":checked")?a(this).val():a(this).data("offval");break;case "select-one":z[c]=a("option:selected",
this).val();break;case "select-multiple":z[c]=a(this).val();z[c]=z[c]?z[c].join(","):"";a("option:selected",this).each(function(b,c){a(c).text()});break;case "date":z[c]=a(this).val();3===String(z[c]).split("-").length&&(b=Za[c],void 0!==b&&(b=O[b],b=b.formatoptions||{},b=b.newformat||y.call(t,"formatter.date.newformat"),z[c]=v.parseDate.call(t[0],"Y-m-d",z[c],b)));break;default:void 0!==b&&0>a.inArray(b,u.skipPostTypes)&&(z[c]=a(this).val())}});return!0}function d(b,c,d){var e=0,f=[],g=!1,h="",k;
for(k=1;k<=d;k++)h+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==b&&(g=D.getInd.call(t,b));a(O).each(function(k){var l=this.name,m,n,p,q,t;m=this.editable;var z=!1,x=!1;t="_empty"===b?"addForm":"editForm";a.isFunction(m)&&(m=m.call(r,{rowid:b,iCol:k,iRow:g,cmName:l,cm:this,mode:t}));q=(this.editrules&&!0===this.editrules.edithidden?0:!0===this.hidden||"hidden"===m)?"style='display:none'":"";switch(String(m).toLowerCase()){case "hidden":m=!0;break;case "disabled":z=
...
""!==f?(a(d,c)[J]("checked",!0),a(d,c)[J]("defaultChecked",!0)):(a(d,c)[J]("checked",!1),a(d,c)[J]("defaultChecked",!1));break;case "custom":try{if(n[g].editoptions&&a.isFunction(n[g].editoptions.custom_value))n[g].editoptions.custom_value.call(r,a(d,c),"set",f);else throw"e1";}catch(h){"e1"===h?Xa.call(r,X,"function 'custom_value' "+u.msg.nodefined,u.bClose):Xa.call(r,X,h.message,u.bClose)}}e++}}),0<e&&a("#id_g",k).val(b))}}function g(){var b=u.url||w.editurl;a.each(O,function(c,d){var e=d.name,
f=z[e];"date"!==d.formatter||null!=d.formatoptions&&!0===d.formatoptions.sendFormatted||(z[e]=a.unformat.date.call(r,f,d));"clientArray"!==b&&d.editoptions&&!0===d.editoptions.NullIfEmpty&&z.hasOwnProperty(e)&&""===f&&(z[e]="null")})}function h(){var c=[!0,"",""],d={},e=w.prmNames,h,l,m,n,p,q,B=D.getInd.call(t,b),y=!1===B?null:r.rows[B];(q=t.triggerHandler("jqGridAddEditBeforeCheckValues",[a(E),U]))&&"object"===typeof q&&(z=q);B=!1===B?-1:B;a.isFunction(u.beforeCheckValues)&&(q=u.beforeCheckValues.call(r,
z,a(E),U))&&"object"===typeof q&&(z=q);for(m in z)if(z.hasOwnProperty(m)&&(q=w.iColByName[m],c=v.checkValues.call(r,z[m],m,void 0,void 0,{oldValue:"_empty"===b?null:D.getCell.call(t,b,q),newValue:z[m],cmName:m,rowid:b,cm:O[q],iCol:q,iRow:B,tr:y,td:null==y?null:y.cells[q],mode:"_empty"===b?"addForm":"editForm"}),!1===c[0]))break;g();c[0]&&(d=t.triggerHandler("jqGridAddEditClickSubmit",[u,z,U]),void 0===d&&a.isFunction(u.onclickSubmit)&&(d=u.onclickSubmit.call(r,u,z,U)||{}),c=t.triggerHandler("jqGridAddEditBeforeSubmit",
[z,a(E),U]),void 0===c&&(c=[!0,"",""]),c[0]&&a.isFunction(u.beforeSubmit)&&(c=u.beforeSubmit.call(r,z,a(E),U)));if(c[0]&&!u.processing){u.processing=!0;a("#sData",C).addClass(Q);m=u.url||w.editurl;l=e.oper;h="clientArray"===m&&!1!==w.keyName?w.keyName:e.id;z[l]="_empty"===a.trim(z[x+"_id"])?e.addoper:e.editoper;z[l]!==e.addoper?z[h]=z[x+"_id"]:void 0===z[h]&&(z[h]=z[x+"_id"]);delete z[x+"_id"];z=a.extend(z,u.editData,d);if(!0===w.treeGrid)for(p in z[l]===e.addoper&&(n=w.selrow,z["adjacency"===w.treeGridModel?
w.treeReader.parent_id_field:"parent_id"]=n),w.treeReader)w.treeReader.hasOwnProperty(p)&&(d=w.treeReader[p],!z.hasOwnProperty(d)||z[l]===e.addoper&&"parent_id_field"===p||delete z[d]);z[h]=v.stripPref(w.idPrefix,z[h]);w.autoEncodeOnEdit&&a.each(z,function(b,c){a.isFunction(c)||(z[b]=v.oldEncodePostedData(c))});p=a.extend({url:a.isFunction(m)?m.call(r,z[h],U,z,u):m,type:a.isFunction(u.mtype)?u.mtype.call(r,U,u,z[h],z):u.mtype,data:v.serializeFeedback.call(r,a.isFunction(u.serializeEditData)?u.serializeEditData:
w.serializeEditData,"jqGridAddEditSerializeEditData",z),complete:function(b,d){a("#sData",C).removeClass(Q);z[h]=w.idPrefix+a("#id_g",k).val();300<=b.status&&304!==b.status||0===b.status&&4===b.readyState?(c[0]=!1,c[1]=t.triggerHandler("jqGridAddEditErrorTextFormat",[b,U]),a.isFunction(u.errorTextFormat)?c[1]=u.errorTextFormat.call(r,b,U):c[1]=d+" Status: '"+b.statusText+"'. Error code: "+b.status):(c=t.triggerHandler("jqGridAddEditAfterSubmit",[b,z,U]),void 0===c&&(c=[!0,"",""]),c[0]&&a.isFunction(u.afterSubmit)&&
(c=u.afterSubmit.call(r,b,z,U)));if(!1===c[0])a("#FormError>td",k).html(c[1]),a("#FormError",k).show();else{w.autoEncodeOnEdit&&a.each(z,function(a,b){z[a]=v.oldDecodePostedData(b)});var g=[a.extend({},u.reloadGridOptions||{})];z[l]===e.addoper?(c[2]||(c[2]=v.randId()),null==z[h]||"_empty"===z[h]||z[l]===e.addoper?z[h]=c[2]:c[2]=z[h],u.reloadAfterSubmit?t.trigger("reloadGrid",g):!0===w.treeGrid?D.addChildNode.call(t,c[2],n,z):D.addRowData.call(t,c[2],z,u.addedrow),u.closeAfterAdd?(!0!==w.treeGrid&&
A.call(t,c[2]),da(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form})):u.clearAfterAdd&&f("_empty",E)):(u.reloadAfterSubmit?(t.trigger("reloadGrid",g),u.closeAfterEdit||setTimeout(function(){A.call(t,z[h])},1E3)):!0===w.treeGrid?D.setTreeRow.call(t,z[h],z):D.setRowData.call(t,z[h],z),u.closeAfterEdit&&da(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form}));if(a.isFunction(u.afterComplete)){var m=
b;setTimeout(function(){t.triggerHandler("jqGridAddEditAfterComplete",[m,z,a(E),U]);u.afterComplete.call(r,m,z,a(E),U);m=null},50)}if(u.checkOnSubmit||u.checkOnUpdate)if(a(E).data("disabled",!1),"_empty"!==u._savedData[x+"_id"])for(var p in u._savedData)u._savedData.hasOwnProperty(p)&&z[p]&&(u._savedData[p]=z[p])}u.processing=!1;try{a(":input:visible",E)[0].focus()}catch(q){}}},v.ajaxOptions,u.ajaxEditOptions);p.url||u.useDataProxy||(a.isFunction(w.dataProxy)?u.useDataProxy=!0:(c[0]=!1,c[1]+=" "+
v.errors.nourl));c[0]&&(u.useDataProxy?(d=w.dataProxy.call(r,p,"set_"+x),void 0===d&&(d=[!0,""]),!1===d[0]?(c[0]=!1,c[1]=d[1]||"Error deleting the selected row!"):(p.data.oper===e.addoper&&u.closeAfterAdd&&da(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form}),p.data.oper===e.editoper&&u.closeAfterEdit&&da(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form}))):"clientArray"===p.url?(u.reloadAfterSubmit=
!1,z=p.data,p.complete({status:200,statusText:""},"")):a.ajax(p))}!1===c[0]&&(a("#FormError>td",k).html(c[1]),a("#FormError",k).show())}function m(a,b){var c=!1,d;for(d in a)if(a.hasOwnProperty(d)&&String(a[d])!==String(b[d])){c=!0;break}return c}function l(){var b=!0;a("#FormError",k).hide();u.checkOnUpdate&&(z={},e(),P=m(z,u._savedData))&&(a(E).data("disabled",!0),a(".confirm",G).show(),b=!1);return b}function n(){var c=v.detectRowEditing.call(r,b);if(null!=c)if("inlineEditing"===c.mode)D.restoreRow.call(t,
b);else{var c=c.savedRow,d=r.rows[c.id];D.restoreCell.call(t,c.id,c.ic);a(d.cells[c.ic]).removeClass("edit-cell "+$a);a(d).addClass($a).attr({"aria-selected":"true",tabindex:"0"})}}function p(b,c){var d=c[1].length-1;0===b?a("#pData",C).addClass(T):void 0!==c[1][b-1]&&ca(a("#"+I(c[1][b-1])),T)?a("#pData",C).addClass(T):a("#pData",C).removeClass(T);b===d?a("#nData",C).addClass(T):void 0!==c[1][b+1]&&ca(a("#"+I(c[1][b+1])),T)?a("#nData",C).addClass(T):a("#nData",C).removeClass(T)}function q(){var b=
...
afterclickPgButtons:null,editData:{},recreateForm:!1,closeOnEscape:!1,addedrow:"first",topinfo:"",bottominfo:"",savekey:[!1,13],navkeys:[!1,38,40],checkOnSubmit:!1,checkOnUpdate:!1,_savedData:{},processing:!1,onClose:null,ajaxEditOptions:{},serializeEditData:null,viewPagerButtons:!0,overlayClass:"ui-widget-overlay",removemodal:!0,skipPostTypes:["image","file"],form:"edit"},y.call(t,"edit"),v.edit,w.formEditing||{},c||{}),E="FrmGrid_"+x,B=E,F="TblGrid_"+x,k="#"+I(F),C=k+"_2",H={themodal:"editmod"+
x,modalhead:"edithd"+x,modalcontent:"editcnt"+x,resizeAlso:E},G="#"+I(H.themodal),K=w.gBox,J=w.propOrAttr,O=w.colModel,Za=w.iColByName,ha=1,N=0,z,P,U,Ba=u.commonIconClass,X=y.call(t,"errors.errcap"),L=function(){var b=a.makeArray(arguments);b.unshift("");b.unshift("AddEdit");b.unshift(u);return Wa.apply(r,b)},Y=ba.call(r,"hover"),T=ba.call(r,"disabled"),$a=ba.call(r,"select"),Q=ba.call(r,"active"),M=ba.call(r,"error"),E="#"+I(E);"new"===b?(b="_empty",U="add",u.caption=u.addCaption):(u.caption=u.editCaption,
U="edit");if(!u.recreateForm){var ya=t.data("formProp");ya&&(ya.top=Math.max(ya.top,0),ya.left=Math.max(ya.left,0),a.extend(u,ya))}ya=!0;!u.checkOnUpdate||!0!==u.jqModal&&void 0!==u.jqModal||u.modal||(ya=!1);var W=isNaN(u.dataheight)?u.dataheight:u.dataheight+"px",V=isNaN(u.datawidth)?u.datawidth:u.datawidth+"px",B=a("<form name='FormPost' id='"+B+"' class='FormGrid' onSubmit='return false;' style='width:"+V+";overflow:auto;position:relative;height:"+W+";'></form>").data("disabled",!1),R=a("<table id='"+
F+"' class='EditTable'"+(v.msie&&8>v.msiever()?" cellspacing='0'":"")+"><tbody></tbody></table>");a(O).each(function(){var a=this.formoptions;ha=Math.max(ha,a?a.colpos||0:0);N=Math.max(N,a?a.rowpos||0:0)});a(B).append(R);M=a("<tr id='FormError' style='display:none'><td class='"+M+"' colspan='"+2*ha+"'>&#160;</td></tr>");M[0].rp=0;a(R).append(M);M=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*ha+"'>"+(u.topinfo||"&#160;")+"</td></tr>");M[0].rp=0;a(R).append(M);if(L("beforeInitData",
B,U)){n();W=(M="rtl"===w.direction?!0:!1)?"nData":"pData";V=M?"pData":"nData";d(b,R,ha);var W=ea.call(r,W,"",oa(Ba,u.prevIcon),"","left"),V=ea.call(r,V,"",oa(Ba,u.nextIcon),"","right"),ab=ea.call(r,"sData",u.bSubmit),Fa=ea.call(r,"cData",u.bCancel),F="<table"+(v.msie&&8>v.msiever()?" cellspacing='0'":"")+" class='EditTable' id='"+F+"_2'><tbody><tr><td colspan='2'><hr class='"+aa.call(r,"dialog.hr")+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton navButton-"+w.direction+
"'>"+(M?V+W:W+V)+"</td><td class='EditButton EditButton-"+w.direction+"'>"+ab+"&#160;"+Fa+"</td></tr>",F=F+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+(u.bottominfo||"&#160;")+"</td></tr>"),F=F+"</tbody></table>";if(0<N){var db=[];a.each(a(R)[0].rows,function(a,b){db[a]=b});db.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(db,function(b,c){a("tbody",R).append(c)})}u.gbox=K;var eb=!1;!0===u.closeOnEscape&&(u.closeOnEscape=!1,eb=!0);F=a("<div></div>").append(B).append(F);
za.call(r,H,F,u,w.gView,a(K)[0]);u.topinfo&&a(".tinfo",k).show();u.bottominfo&&a(".binfo",C).show();F=F=null;a(G).keydown(function(b){var c=(b.target.tagName||"").toUpperCase(),d,e;if(!0===a(E).data("disabled"))return!1;if(13===b.which&&"TEXTAREA"!==c){d=a(C).find(":focus");e=d.attr("id");if(0<d.length&&0<=a.inArray(e,["pData","nData","cData"]))return d.trigger("click"),!1;if(!0===u.savekey[0]&&13===u.savekey[1])return a("#sData",C).trigger("click"),!1}if(!0===u.savekey[0]&&b.which===u.savekey[1]&&
"TEXTAREA"!==c)return a("#sData",C).trigger("click"),!1;if(27===b.which){if(!l())return!1;eb&&da(G,{gb:u.gbox,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form});return!1}if(!0===u.navkeys[0]){if("_empty"===a("#id_g",k).val())return!0;if(b.which===u.navkeys[1])return a("#pData",C).trigger("click"),!1;if(b.which===u.navkeys[2])return a("#nData",C).trigger("click"),!1}});u.checkOnUpdate&&(a("a.ui-jqdialog-titlebar-close span",G).removeClass("jqmClose"),a("a.ui-jqdialog-titlebar-close",
G).unbind("click").click(function(){if(!l())return!1;da(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form});return!1}));La(a("#sData",C),u.saveicon,Ba);La(a("#cData",C),u.closeicon,Ba);if(u.checkOnSubmit||u.checkOnUpdate)ab=ea.call(r,"sNew",u.bYes),V=ea.call(r,"nNew",u.bNo),Fa=ea.call(r,"cNew",u.bExit),H=u.zIndex||999,H++,a("<div class='"+u.overlayClass+" jqgrid-overlay confirm' style='z-index:"+H+";display:none;'>&#160;</div><div class='"+aa.call(r,
"dialog.content","confirm ui-jqconfirm")+"' style='z-index:"+(H+1)+"'>"+u.saveData+"<br/><br/>"+ab+V+Fa+"</div>").insertAfter(E),a("#sNew",G).click(function(){h();a(E).data("disabled",!1);a(".confirm",G).hide();return!1}),a("#nNew",G).click(function(){a(".confirm",G).hide();a(E).data("disabled",!1);setTimeout(function(){a(":input:visible",E)[0].focus()},0);return!1}),a("#cNew",G).click(function(){a(".confirm",G).hide();a(E).data("disabled",!1);da(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,
formprop:!u.recreateForm,form:u.form});return!1});L("onInitializeForm",a(E),U);"_empty"!==b&&u.viewPagerButtons?a("#pData,#nData",C).show():a("#pData,#nData",C).hide();L("beforeShowForm",a(E),U);a(G).data("onClose",u.onClose);Ka(G,{gbox:K,jqm:u.jqModal,overlay:u.overlay,modal:u.modal,overlayClass:u.overlayClass,toTop:u.toTop,onHide:function(a){nb.call(t,"formProp",E,a)}});ya||a("."+I(u.overlayClass)).click(function(){if(!l())return!1;da(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,
formprop:!u.recreateForm,form:u.form});return!1});a(".fm-button",G).hover(function(){a(this).addClass(Y)},function(){a(this).removeClass(Y)});a("#sData",C).click(function(){z={};a("#FormError",k).hide();e();"_empty"===z[x+"_id"]?h():!0===u.checkOnSubmit?(P=m(z,u._savedData))?(a(E).data("disabled",!0),a(".confirm",G).show()):h():h();return!1});a("#cData",C).click(function(){if(!l())return!1;da(G,{gb:K,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form});
...
T))return!1;f(b[1][b[0]-1],E);A.call(t,b[1][b[0]-1]);L("afterclickPgButtons","prev",a(E),b[1][b[0]-1]);p(b[0]-1,b)}return!1});L("afterShowForm",a(E),U);H=q();p(H[0],H)}}})},viewGridRow:function(b,c){return this.each(function(){function e(){!0!==q.closeOnEscape&&!0!==q.navkeys[0]||setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+I(u.modalhead)).attr("tabindex","-1").focus()},0)}function d(b,c,d){var e,f,g,h=0,k,p,r=[],t=D.getInd.call(l,b),u;u=aa.call(m,"dialog.viewData","DataTD form-view-data");
var w=aa.call(m,"dialog.viewLabel","CaptionTD form-view-label"),x="<td class='"+w+"' width='"+q.labelswidth+"'>&#160;</td><td class='"+u+" ui-helper-reset'>&#160;</td>",C="",w="<td class='"+w+"'></td><td class='"+u+"'></td>",B=["integer","number","currency"],E=0,y=0,A,H,G;for(u=1;u<=d;u++)C+=1===u?x:w;a(F).each(function(){(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==a.inArray(this.formatter,B)?E=Math.max(E,parseInt(this.width,
10)):y=Math.max(y,parseInt(this.width,10)))});A=0!==E?E:0!==y?y:0;a(F).each(function(b){e=this.name;H=!1;p=(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";G="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==e&&"subgrid"!==e&&"rn"!==e&&G){k=!1===t?"":v.getDataFieldOfCell.call(m,m.rows[t],b).html();H="right"===this.align&&0!==A?!0:!1;var l=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),q=parseInt(l.rowpos,10)||h+1,u=parseInt(2*
...
g.editrules.edithidden?!1:!0===g.hidden?!0:!1;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&(c=I("v_"+c),a("#"+c+" span",t).html(v.getDataFieldOfCell.call(m,f,b).html()),d&&a("#"+c,t).parents("tr:first").hide(),e++)}),0<e&&a("#id_g",t).val(b))}function g(b,c){var d=c[1].length-1;0===b?a("#pData",w).addClass(K):void 0!==c[1][b-1]&&ca(a("#"+I(c[1][b-1])),K)?a("#pData",w).addClass(K):a("#pData",w).removeClass(K);b===d?a("#nData",w).addClass(K):void 0!==c[1][b+1]&&ca(a("#"+I(c[1][b+1])),K)?a("#nData",w).addClass(K):
...
B=ea.call(e,"dData",h.bSubmit),k=ea.call(e,"eData",h.bCancel),F=F+("<table"+(v.msie&&8>v.msiever()?" cellspacing='0'":"")+" class='EditTable' id='"+m+"_2'><tbody><tr><td><hr class='"+aa.call(e,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton EditButton-"+d.direction+"'>"+B+"&#160;"+k+"</td></tr></tbody></table>");h.gbox=x;za.call(e,t,F,h,d.gView,a(d.gView)[0]);a("#DelData>td",l).data("rowids",b);if(!A("beforeInitData",a(F)))return;a(".fm-button",l+"_2").hover(function(){a(this).addClass(u)},
...
(b=h.afterSubmit.call(e,c,n));if(!1===b[0])a("#DelError>td",l).html(b[1]),a("#DelError",l).show();else{if(h.reloadAfterSubmit&&"local"!==d.datatype)f.trigger("reloadGrid",[a.extend({},h.reloadGridOptions||{})]);else if(!0===d.treeGrid)try{D.delTreeNode.call(f,t[0])}catch(p){}else for(t=t.slice(),k=0;k<t.length;k++)D.delRowData.call(f,t[k]);setTimeout(function(){A("afterComplete",c,m,a(l))},50)}h.processing=!1;b[0]&&da(w,{gb:x,jqm:h.jqModal,onClose:h.onClose,removemodal:h.removemodal})}},v.ajaxOptions,
...
10)/2-f.left,e=e/2-25-f.top),za.call(m,y,"<div>"+q.alerttext+"</div><span tabindex='0'><span tabindex='-1' id='"+p+"_jqg_alrt'></span></span>",{gbox:w,jqModal:q.jqModal,drag:!0,resize:!0,caption:q.alertcap,top:null!=q.alerttop?q.alerttop:e,left:null!=q.alertleft?q.alertleft:d,width:q.alertwidth,height:q.alertheight,closeOnEscape:q.closeOnEscape,zIndex:q.alertzIndex,removemodal:q.removemodal},l.gView,a(w)[0],!1));Ka("#"+I(y.themodal),{gbox:w,toTop:q.alertToTop,jqm:q.jqModal});var g=a("#"+I(y.modalhead)).find(".ui-jqdialog-titlebar-close");
g.attr({tabindex:"0",href:"#",role:"button"});setTimeout(function(){g.focus()},50)}}(),u,E=function(b){if(13===b.which&&(b=a(this).find(".ui-pg-button").filter(":focus"),0<b.length))return b.trigger("click"),!1},B=ba.call(m,"hover"),F=ba.call(m,"disabled");if(m.grid){m.modalAlert=A;void 0===b&&(l.pager?(b=l.pager,l.toppager&&(q.cloneToTop=!0)):l.toppager&&(b=l.toppager));var k=1,C,H,G,K,J,O=["left","center","right"],M="<div class='ui-pg-button "+F+"'><span class='ui-separator'></span></div>",ha=function(){ca(this,
F)||a(this).addClass(B)},N=function(){a(this).removeClass(B)},z=function(){ca(this,F)||(a.isFunction(q.addfunc)?q.addfunc.call(m):D.editGridRow.call(n,"new",d));return!1},P=function(b,c,d){if(!ca(this,F)){var e=l.selrow;e?a.isFunction(b)?b.call(m,e):D[c].call(n,e,d):A()}return!1},U=function(){return P.call(this,q.editfunc,"editGridRow",e)},Q=function(){return P.call(this,q.viewfunc,"viewGridRow",h)},X=function(){var b;ca(this,F)||(l.multiselect?(b=l.selarrrow,0===b.length&&(b=null)):b=l.selrow,b?
a.isFunction(q.delfunc)?q.delfunc.call(m,b):D.delGridRow.call(n,b,f):A());return!1},L=function(){ca(this,F)||(a.isFunction(q.searchfunc)?q.searchfunc.call(m,g):D.searchGrid.call(n,g));return!1},Y=function(){if(!ca(this,F)){a.isFunction(q.beforeRefresh)&&q.beforeRefresh.call(m);l.search=!1;l.resetsearch=!0;try{if("currentfilter"!==q.refreshstate){l.postData.filters="";try{a("#fbox_"+t).jqFilter("resetFilter")}catch(b){}a.isFunction(m.clearToolbar)&&m.clearToolbar(!1)}}catch(b){}switch(q.refreshstate){case "firstpage":n.trigger("reloadGrid",
[a.extend({},q.reloadGridOptions||{},{page:1})]);break;case "current":case "currentfilter":n.trigger("reloadGrid",[a.extend({},q.reloadGridOptions||{},{current:!0})])}a.isFunction(q.afterRefresh)&&q.afterRefresh.call(m)}return!1},T=function(b,c,d,e,f){var g=a("<div class='ui-pg-button ui-corner-all' tabindex='0' role='button'></div>"),h=q[b+"icon"],k=a.trim(q[b+"text"]);g.append("<div class='ui-pg-div'><span class='"+(q.iconsOverText?oa("ui-pg-button-icon-over-text",x,h):oa(x,h))+"'></span>"+(k?"<span class='ui-pg-button-text"+
(q.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+k+"</span>":"")+"</div>");a(e).append(g);g.attr({title:q[b+"title"]||"",id:c||b+"_"+f}).click(d).hover(ha,N);return g};q.cloneToTop&&l.toppager&&(k=2);for(C=0;C<k;C++){u=a("<div class='ui-pg-table navtable' role='toolbar' style='float:"+("rtl"===l.direction?"right":"left")+";table-layout:auto;'></div>");0===C?(H=b,G=p,H===l.toppager&&(G+="_top",k=1)):(H=l.toppager,G=p+"_top");q.add&&T("add",d.id,z,u,G);q.edit&&T("edit",e.id,U,u,G);q.view&&T("view",
h.id,Q,u,G);q.del&&T("del",f.id,X,u,G);(q.add||q.edit||q.del||q.view)&&a(u).append(M);q.search&&(r=T("search",g.id,L,u,G),g.showOnLoad&&!0===g.showOnLoad&&a(r,u).click());q.refresh&&T("refresh","",Y,u,G);r=a(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px";a("body").append("<div id='testpg2' class='"+aa.call(m,"gBox","ui-jqgrid")+"' style='font-size:"+r+";visibility:hidden;' ></div>");r=a(u).clone().appendTo("#testpg2").width();a("#testpg2").remove();a(H+"_"+q.position,H).append(u);if(q.hideEmptyPagerParts)for(G=
0;G<O.length;G++)O[G]!==q.position&&(J=a(H+"_"+O[G],H),0===J.length||0===J[0].childNodes.length?J.hide():1===J[0].childNodes.length&&(K=J[0].firstChild,!a(K).is("table.ui-pg-table")||0!==K.rows&&0!==K.rows[0].cells.length||J.hide()));l._nvtd&&(r>l._nvtd[0]&&(a(H+"_"+q.position,H).width(r),l._nvtd[0]=r),l._nvtd[1]=r);m.nav=!0;u.bind("keydown.jqGrid",E)}n.triggerHandler("jqGridResetFrozenHeights")}}})},navButtonAdd:function(b,c){"object"===typeof b&&(c=b,b=void 0);return this.each(function(){var e=
this,d=e.p;if(e.grid){var f=a.extend({caption:"newButton",title:"",onClickButton:null,position:"last",cursor:"pointer",iconsOverText:!1},D.getGridRes.call(a(e),"nav"),v.nav||{},d.navOptions||{},c||{}),g=ba.call(e,"hover"),h=ba.call(e,"disabled");if(void 0===b)if(d.pager)if(D.navButtonAdd.call(a(e),d.pager,f),d.toppager)b=d.toppager;else return;else d.toppager&&(b=d.toppager);"string"===typeof b&&0!==b.indexOf("#")&&(b="#"+I(b));var d=a(".navtable",b),m=f.commonIconClass;if(0<d.length&&!(f.id&&0<d.find("#"+
I(f.id)).length)){var l=a("<div tabindex='0' role='button'></div>");"NONE"===f.buttonicon.toString().toUpperCase()?a(l).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'>"+(f.caption?"<span class='ui-pg-button-text"+(f.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+f.caption+"</span>":"")+"</div>"):a(l).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'><span class='"+(f.iconsOverText?oa("ui-pg-button-icon-over-text",m,f.buttonicon):oa(m,f.buttonicon))+
...
focusField:!0},v.inlineEdit,e.inlineEditing||{},p),q=d.jqGrid("getInd",b,!0),k=n.focusField,C="object"===typeof k&&null!=k?a(k.target||k).closest("tr.jqgrow>td")[0]:null;if(!1!==q&&(n.extraparam[m.oper]===m.addoper||Ya.call(c,n,"beforeEditRow",n,b))&&"0"===(a(q).attr("editable")||"0")&&!a(q).hasClass("not-editable-row")){m=v.detectRowEditing.call(c,b);if(null!=m&&"cellEditing"===m.mode){var m=m.savedRow,H=c.rows[m.id],G=ba.call(c,"select");d.jqGrid("restoreCell",m.id,m.ic);a(H.cells[m.ic]).removeClass("edit-cell "+
...
ajaxSaveOptions:{},serializeSaveData:null,mtype:"POST",saveui:"enable",savetext:l("defaults.savetext")||"Saving..."},v.inlineEdit,r.inlineEditing||{},n),w={},x={},y={},A,u,E,B;E=q.jqGrid("getInd",b,!0);var F=a(E);A=r.prmNames;var k=l("errors.errcap"),C=l("edit.bClose"),H;if(!1!==E&&(l=n.extraparam[A.oper]===A.addoper?"add":"edit",Ya.call(p,n,"beforeSaveRow",n,b,l)&&(A=F.attr("editable"),n.url=n.url||r.editurl,H="clientArray"!==n.url,"1"===A)))if(v.enumEditableCells.call(p,E,F.hasClass("jqgrid-new-row")?
...
c).addClass("jqgrid-new-row"),f.useFormatter?a("#"+v.jqID(f.rowID)+" .ui-inline-edit",c).click():(d=d.prmNames,f.addRowParams.extraparam[d.oper]=d.addoper,e.jqGrid("editRow",f.rowID,f.addRowParams),e.jqGrid("setSelection",f.rowID)))}})},inlineNav:function(b,c){"object"===typeof b&&(c=b,b=void 0);return this.each(function(){var e=this,d=a(e),f=e.p;if(this.grid&&null!=f){var g,h=b===f.toppager?f.idSel+"_top":f.idSel,m=b===f.toppager?f.id+"_top":f.id,l=ba.call(e,"disabled"),n=a.extend(!0,{edit:!0,editicon:"ui-icon-pencil",
...
a.fn[b].apply(c,a.makeArray(arguments).slice(2)):a.isFunction(b)&&b.apply(c,a.makeArray(arguments).slice(2)))}var e=this,d=e[0].p,f,g,h={},m=[],l,n,p=d.colModel;l=p.length;n=d.colNames;var q=function(a){return R&&R.prototype&&a.data(R.prototype.widgetFullName||R.prototype.widgetName)||a.data("ui-multiselect")||a.data("multiselect")};if(!a("#colchooser_"+I(d.id)).length){f=a('<div id="colchooser_'+d.id+'" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>');
...
e.jqGrid("getGridRes","col"),v.col,b||{});if(a.ui&&R&&R.defaults){if(!v._multiselect){alert("Multiselect plugin loaded after jqGrid. Please load the plugin before the jqGrid!");return}b.msel_opts=a.extend(R.defaults,b.msel_opts)}b.caption&&f.attr("title",b.caption);b.classname&&(f.addClass(b.classname),g.addClass(b.classname));b.width&&(a(">div",f).css({width:b.width,margin:"0 auto"}),g.css("width",b.width));b.height&&(a(">div",f).css("height",b.height),g.css("height",b.height-10));g.empty();var r=
...
e.template&&void 0===e.formatter&&m.defaultFormatting&&(e.template="count"===e.aggregator?"integer":"number"),I.push(ba(a,e,d,b,c))};N=function(b,c,d){var f,g,h,k;for(f=G-1;f>=c;f--)if(J[f]){for(g=0;g<=f;g++)T=K[g].groupHeaders,T[T.length-1].numberOfColumns+=D;r=E[f];h=r.totalHeader;k=r.headerOnTop;for(g=f+1;g<=G-1;g++)K[g].groupHeaders.push({titleText:k&&g===f+1||!k&&g===G-1?a.isFunction(h)?h.call(e,d,f):v.template.call(e,h||"",d[f],f):"",startColumnName:"y"+(b-1)+"t"+f+(1===D?"":"a0"),numberOfColumns:D})}};
var aa=function(a){a=new ua("count"===B[a].aggregator?"sum":B[a].aggregator,e,c);a.groupInfo={iRows:[],rows:[],ys:[],iYs:[]};return a},ca=function(){var a,b;for(a=G-1;0<=a;a--)if(J[a])for(null==Q[a]&&(Q[a]=Array(D)),b=0;b<D;b++)Q[a][b]=aa(b)},da=function(a,b,c,d){var e,f=R.getIndexOfDifferences(b,c),g,h;if(null!==c)for(f=Math.max(f,0),e=G-1;e>=f;e--)g="y"+a+"t"+e+(1<D?"a"+d:""),J[e]&&void 0===L[g]&&(h=Q[e][d],h.getResult(L,g),L.pivotInfos[g]={colType:1,iA:d,a:B[d],level:e,iRows:h.groupInfo.iRows,
rows:h.groupInfo.rows,ys:h.groupInfo.ys,iYs:h.groupInfo.iYs},b!==c&&(Q[e][d]=aa(d)))},ea=function(c,d,e,f,g,h,k){var l;if(c!==d)for(d=G-1;0<=d;d--)J[d]&&(l=Q[d][f],l.calc(g[e.member],e.member,g,h,b),l=l.groupInfo,0>a.inArray(k,l.iYs)&&(l.iYs.push(k),l.ys.push(c)),0>a.inArray(h,l.iRows)&&(l.iRows.push(h),l.rows.push(g)))};if(0===C||0===D)throw"xDimension or aggregates options are not set!";W=n(u,m.skipSortByX,m.compareVectorsByX);R=n(E,m.skipSortByY,m.compareVectorsByY);c.xIndex=W;c.yIndex=R;for(n=
0;n<C;n++)p=u[n],t={name:"x"+n,label:null!=p.label?a.isFunction(p.label)?p.label.call(e,p,n,m):p.label:p.dataName,frozen:m.frozenStaticCols},n<C-1&&(g.groupField.push(t.name),g.groupSummary.push(m.groupSummary),g.groupSummaryPos.push(m.groupSummaryPos)),t=a.extend(t,p),delete t.dataName,delete t.footerText,I.push(t);2>C&&(h.grouping=!1);h.sortname=I[C-1].name;g.hideFirstGroupCol=!0;for(n=0;n<x;n++)r=E[n],J.push(r.totals||r.rowTotals||r.totalText||r.totalHeader?!0:!1);Y=R.getItem(0);y(0,x-1,0);g=R.getIndexLength();
for(t=1;t<g;t++){P=R.getItem(t);n=R.getIndexOfDifferences(P,Y);for(p=G-1;p>=n;p--)J[p]&&y(1,p,t-1);Y=P;y(0,x-1,t)}for(n=G-1;0<=n;n--)J[n]&&y(1,n,g-1);q&&y(2);Y=R.getItem(0);for(p=0;p<G;p++)K.push({useColSpanStyle:m.useColSpanStyle,groupHeaders:[{titleText:Y[p],startColumnName:1===D?"y0":"y0a0",numberOfColumns:D}]});for(t=1;t<g;t++){P=R.getItem(t);n=R.getIndexOfDifferences(P,Y);N(t,n,Y);for(p=G-1;p>=n;p--)K[p].groupHeaders.push({titleText:P[p],startColumnName:"y"+t+(1===D?"":"a0"),numberOfColumns:D});
for(p=0;p<n;p++)T=K[p].groupHeaders,T[T.length-1].numberOfColumns+=D;Y=P}N(g,0,Y);if(q)for(n=0;n<G;n++)K[n].groupHeaders.push({titleText:n<G-1?"":m.totalHeader||"",startColumnName:"t"+(1===D?"":"a0"),numberOfColumns:D});N=W.getIndexLength();for(x=0;x<N;x++){p=W.getItem(x);y={iX:x,x:p};L={pivotInfos:y};for(n=0;n<C;n++)L["x"+n]=p[n];z=W.getIndexesOfSourceData(x);if(q)for(p=0;p<D;p++)M[p]=aa(p);Y=null;ca();for(t=0;t<g;t++){P=R.getItem(t);U=R.getIndexesOfSourceData(t);for(p=0;p<D;p++){null!==Y&&da(t-
1,P,Y,p);V=[];for(n=0;n<U.length;n++)w=U[n],0<=a.inArray(w,z)&&V.push(w);if(0<V.length){A=Array(V.length);X=B[p];F=new ua(X.aggregator,e,c);for(w=0;w<V.length;w++)n=V[w],l=b[n],A[w]=l,F.calc(l[X.member],X.member,l,n,b),q&&(k=M[p],k.calc(l[X.member],X.member,l,n,b),k=k.groupInfo,0>a.inArray(n,k.iYs)&&(k.iYs.push(t),k.ys.push(P)),0>a.inArray(n,k.iRows)&&(k.iRows.push(n),k.rows.push(l))),ea(P,Y,X,p,l,n,t);l="y"+t+(1===D?"":"a"+p);F.getResult(L,l);y[l]={colType:0,iY:t,y:P,iA:p,a:X,iRows:V,rows:A}}}Y=
P}if(null!==Y)for(p=0;p<D;p++)da(g-1,Y,Y,p);if(q)for(p=0;p<D;p++)l="t"+(1===D?"":"a"+p),k=M[p],k.getResult(L,l),k=k.groupInfo,y[l]={colType:2,iA:p,a:B[p],iRows:k.iRows,rows:k.rows,iYs:k.iYs,ys:k.ys};d.push(L)}if(m.footerTotals||m.colTotals){q=d.length;for(n=0;n<C;n++)f["x"+n]=u[n].footerText||"";for(n=C;n<I.length;n++){l=I[n].name;F=new ua(m.footerAggregator||"sum",e,c);for(w=0;w<q;w++)L=d[w],F.calc(L[l],l,L,w,d);F.getResult(f,l)}}c.colHeaders=K;return{colModel:I,options:c,rows:d,groupOptions:h,groupHeaders:K,
...
item:b})){var n=a("#"+c.idPrefix+I(l),this.grid.bDiv)[0],p=c._index[l];"local"===c.treedatatype||D.isNodeLoaded.call(a(this),c.data[p])?(b[e]=!0,a("div.treeclick",n).removeClass(c.treeIcons.plus+" tree-plus").addClass(c.treeIcons.commonIconClass).addClass(c.treeIcons.minus+" tree-minus")):this.grid.hDiv.loading||(b[e]=!0,a("div.treeclick",n).removeClass(c.treeIcons.plus+" tree-plus").addClass(c.treeIcons.commonIconClass).addClass(c.treeIcons.minus+" tree-minus"),c.treeANode=n.rowIndex,c.datatype=
...
1;var C=D.getFullTreeNode.call(f,p);if(C.length){var H,G,I;for(H=0;H<C.length;H++)I=C[H][h.localReader.id],G=m.call(f,I),G>r&&(r=G,t=I)}r++;p[x]&&(w=!0,p[y]=!0,a(g.rows[k]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(h.treeIcons.leaf+" tree-leaf").addClass(h.treeIcons.commonIconClass).addClass(h.treeIcons.minus+" tree-minus"),h.data[n][x]=!1,p[F]=!0)}m=r+1;void 0===e[y]&&(e[y]=!1);void 0===e[F]&&(e[F]=!1);e[A]=q;void 0===
...
null};M.defaultFormat=function(a,c){return W.isValue(a)&&""!==a?a:c.defaultValue||"&#160;"};var ta=M.defaultFormat;M.email=function(a,c){return W.isEmpty(a)?ta(a,c):'<a href="mailto:'+a+'">'+a+"</a>"};M.checkbox=function(b,c){var e=c.colModel,d=a.extend({},c.checkbox);null!=e&&(d=a.extend({},d,e.formatoptions||{}));e=!0===d.disabled?'disabled="disabled"':"";if(W.isEmpty(b)||void 0===b)b=ta(b,d);b=String(b);b=String(b).toLowerCase();return'<input type="checkbox" '+(0>b.search(/(false|f|0|no|n|off|undefined)/i)?
" checked='checked' ":"")+' value="'+b+'" data-offval="no" '+e+"/>"};M.checkbox.getCellBuilder=function(b){var c=b.colModel,e=a.extend({},b.checkbox),d;null!=c&&(e=a.extend({},e,c.formatoptions||{}));d='" data-offval="no" '+(!0===e.disabled?'disabled="disabled"':"")+"/>";return function(a){if(W.isEmpty(a)||void 0===a)a=ta(a,e);a=String(a).toLowerCase();return'<input type="checkbox" '+(0>a.search(/(false|f|0|no|n|off|undefined)/i)?" checked='checked' ":"")+' value="'+a+d}};M.checkboxFontAwesome4=function(a,
...
null!==n&&(n=(""!==d?"&":"")+a.param(n));l+=d||n?"?"+d+n:"";""===l&&(l=p(c.hrefDefaultValue));return"string"===typeof b||W.isNumber(b)||a.isFunction(c.cellValue)?"<a "+m+' href="'+l+'">'+(a.isFunction(c.cellValue)?p(c.cellValue):b)+"</a>":ta(b,c)}};M.showlink.pageFinalization=function(b){var c=a(this),e=this.p,d=e.colModel[b],f,g=this.rows,h=g.length,m,l=function(e){var f=a(this).closest(".jqgrow");if(0<f.length)return d.formatoptions.onClick.call(c[0],{iCol:b,iRow:f[0].rowIndex,rowid:f.attr("id"),
...
return W.isEmpty(b)?cb(c.defaultValue,c):cb(W.NumberFormat(b,c),c)};M.integer=function(a,c){return qb(a,c,"integer")};M.number=function(a,c){return qb(a,c,"number")};M.currency=function(a,c){return qb(a,c,"currency")};var rb=function(b,c){var e=b.colModel,d=a.extend({},b[c]);null!=e&&(d=a.extend({},d,e.formatoptions||{}));var f=W.NumberFormat,g=d.defaultValue?cb(d.defaultValue,d):"";return function(a){return W.isEmpty(a)?g:cb(f(a,d),d)}};M.integer.getCellBuilder=function(a){return rb(a,"integer")};
M.number.getCellBuilder=function(a){return rb(a,"number")};M.currency.getCellBuilder=function(a){return rb(a,"currency")};M.date=function(b,c,e,d){e=c.colModel;c=a.extend({},c.date);null!=e&&(c=a.extend({},c,e.formatoptions||{}));return c.reformatAfterEdit||"edit"!==d?W.isEmpty(b)?ta(b,c):v.parseDate.call(this,c.srcformat,b,c.newformat,c):ta(b,c)};M.date.getCellBuilder=function(b,c){var e=a.extend({},b.date);null!=b.colModel&&(e=a.extend({},e,b.colModel.formatoptions||{}));var d=v.parseDate,f=e.srcformat,
g=e.newformat;return e.reformatAfterEdit||"edit"!==c?function(a){return W.isEmpty(a)?ta(a,e):d.call(this,f,a,g,e)}:function(a){return ta(a,e)}};M.select=function(b,c){var e=[],d=c.colModel,f,d=a.extend({},d.editoptions||{},d.formatoptions||{}),g=d.value,h=d.separator||":",m=d.delimiter||";";if(g){var l=!0===d.multiple?!0:!1,n=[],p=function(a,b){if(0<b)return a};l&&(n=a.map(String(b).split(","),function(b){return a.trim(b)}));if("string"===typeof g){var q=g.split(m),r,t;for(r=0;r<q.length;r++)if(m=
