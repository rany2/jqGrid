...
a;for(d=0;d<this.rows.length;d++)c=this.rows[d],b(c).hasClass("jqgrow")&&(a[c.id]=c.rowIndex)},Q=function(){var a,c=k.colModel;a=k.cmNamesInputOrder;var d=k.additionalProperties,e=a.length,f,g,h,l;k.arrayReaderInfos={};f=k.arrayReaderInfos;for(l=0;l<e;l++)g=a[l],0>p(g,k.reservedColumnNames)&&!f.hasOwnProperty(g)&&(h=k.iColByName[g],void 0!==h?f[g]={name:c[h].name,index:h,order:l,type:0}:(h=k.iPropByName[g],void 0!==h?f[g]={name:c[h].name,index:h,order:l,type:1}:g===(k.prmNames.rowidName||"rowid")&&
(f[g]={index:h,type:2})));e=c.length;for(a=0;a<e;a++)g=c[a].name,0>p(g,k.reservedColumnNames)&&!f.hasOwnProperty(g)&&(f[g]={name:g,index:a,order:l,type:0},l++);e=d.length;for(a=0;a<e;a++)g=d[a],null==g||f.hasOwnProperty(g)||("object"===typeof g&&"string"===b.type(g.name)&&(g=g.name),f[g]={name:g,index:a,order:l,type:1},l++)},ba=function(a){var c=b(this).data("pageX");c?(c=String(c).split(";"),c=c[c.length-1],b(this).data("pageX",c+";"+a.pageX)):b(this).data("pageX",a.pageX)},R=function(b,a){b=parseInt(b,
10);return isNaN(b)?a||0:b},z={headers:[],cols:[],footers:[],dragStart:function(a,c,d,e){var f=b(this.bDiv),g=f.closest(k.gBox).offset();e=e.offset().left+("rtl"===k.direction?0:this.headers[a].width+(u.cell_width?0:R(k.cellLayout,0))-2);this.resizing={idx:a,startX:e,sOL:e,moved:!1,delta:e-c.pageX};this.curGbox=b(k.rs);this.curGbox.prependTo("body");this.curGbox.css({display:"block",left:e,top:d[1]+g.top+1,height:d[2]});this.curGbox.css("height",d[2]-(this.curGbox.outerHeight()-this.curGbox.height())+
"px");this.curGbox.data("idx",a);this.curGbox.data("delta",e-c.pageX);ba.call(this.curGbox,c);O.call(bb(21,f)[0],"resizeStart",c,a);document.onselectstart=function(){return!1};b(document).bind("mousemove.jqGrid",function(b){if(z.resizing)return z.dragMove(b),!1}).bind("mouseup.jqGrid"+k.id,function(){if(z.resizing)return z.dragEnd(),!1})},dragMove:function(a){var c=this.resizing;if(c){var d=a.pageX+c.delta-c.startX,e=this.headers;a=e[c.idx];var f="ltr"===k.direction?a.width+d:a.width-d,g=((k.colModel[c.idx]||
...
b.makeArray(k.selarrrow):null,e=this.grid.bDiv,f=e.scrollLeft,g=function(){var b;k.selrow=null;if(!k.multiPageSelection){aa(k.selarrrow);if(k.multiselect&&d&&0<d.length)for(b=0;b<d.length;b++)d[b]!==c&&t.call(a,d[b],!1,null);c&&t.call(a,c,!1,null)}e.scrollLeft=f;a.unbind(".selectionPreserver",g)};a.bind("jqGridGridComplete.selectionPreserver",g)}};d.grid=z;O.call(d,"beforeInitGrid");k.iColByName=H(k.colModel);k.iPropByName=L(k.additionalProperties);var C=b("<div class='"+D("gView","ui-jqgrid-view")+
"' role='grid' aria-multiselectable='"+!!k.multiselect+"'></div>"),M=u.msie,W;k.direction=q(k.direction.toLowerCase());-1===p(k.direction,["ltr","rtl"])&&(k.direction="ltr");W=k.direction;b(C).insertBefore(d);h.removeClass("scroll").appendTo(C);var ea=b("<div class='"+D("gBox","ui-jqgrid")+"'></div>");b(ea).attr({id:k.gBoxId,dir:W}).insertBefore(C);b(C).attr("id",k.gViewId).appendTo(ea);b("<div class='"+D("overlay","jqgrid-overlay")+"' id='lui_"+k.id+"'></div>").insertBefore(C);b("<div class='"+D("loading",
"loading")+"' id='load_"+k.id+"'>"+F("loadtext")+"</div>").insertBefore(C);h.attr({role:"presentation","aria-labelledby":"gbox_"+d.id});var wa=function(){var b=k.remapColumns,a=k.colModel,c=a.length,d=[],e,f;for(e=0;e<c;e++)f=a[e].name,0>p(f,k.reservedColumnNames)&&d.push(f);if(null!=b)for(a=d.slice(),e=0;e<b.length;e++)d[e]=a[b[e]];k.cmNamesInputOrder=d},T=function(b,a,c,e,f,g){var h=k.colModel[b],l=c,n=h.classes,p=h.align?"text-align:"+h.align+";":"",r,q=function(b){return"string"===typeof b?b.replace(/\'/g,
...
"")+">"+c+"</span>");return c},X=function(a,c){var d=z.bDiv,e=null!=z.fbDiv?z.fbDiv.children(".ui-jqgrid-btable")[0]:null,f=function(a){if(a){var c=a.rows,d=c[0];if(k.deepempty)c&&b(c).slice(1).remove();else if(k.quickEmpty)if("quickest"===k.quickEmpty)a.replaceChild(document.createElement("tbody"),a.tBodies[0]),a.firstChild.appendChild(d);else for(;1<c.length;)a.deleteRow(c.length-1);else b(a.firstChild).empty().append(d)}};b(this).unbind(".jqGridFormatter");f(this);f(e);a&&k.scroll&&(b(d.firstChild).css({height:"auto"}),
b(d.firstChild.firstChild).css({height:0,display:"none"}),0!==d.scrollTop&&(d.scrollTop=0));!0===c&&k.treeGrid&&(aa(k.data),aa(k.lastSelectedData),k._index={});k.rowIndexes={};k.iRow=-1;k.iCol=-1},ia=function(){var b=k.data,a=b.length,c,e,f,g,h,p,r,q=k.localReader,v=k.additionalProperties,t=q.cell,u,x,w,z=k.arrayReaderInfos;if("local"!==k.datatype||!0!==q.repeatitems){if(k.treeGrid)for(c=0;c<a;c++)U(b[c])}else for(g=!1===k.keyName?m(q.id)?q.id.call(d,b):q.id:k.keyName,isNaN(g)?m(g)||null==k.arrayReaderInfos[g]||
(h=k.arrayReaderInfos[g].order):h=Number(g),c=0;c<a;c++){e=b[c];f=t?pa(e,t)||e:e;x=l(f);r={};for(u in z)z.hasOwnProperty(u)&&(w=z[u],p=pa(f,x?w.order:w.name),1===w.type&&(w=v[w.index],null!=w&&m(w.convert)&&(p=w.convert(p,f))),void 0!==p&&(r[u]=p));void 0!==r[g]?e=void 0!==r[g]?r[g]:Ea():(e=pa(e,l(e)?h:g),void 0===e&&(e=pa(f,l(f)?h:g)),void 0===e&&(e=Ea()));e=String(e);r[q.id]=e;k.treeGrid&&U(r);n(b[c],r)}},qa=function(){var b=k.data.length,a,c,d,e;a=!1===k.keyName||k.loadonce?k.localReader.id:k.keyName;
...
n||"xml"===n)&&b.isXMLDoc(a),q=k.localReader,v=pa;if(a&&("xml"!==n||r)){-1!==k.treeANode||k.scroll?d=1<d?d:1:(z.emptyRows.call(this,!1,!0),d=1);p&&(aa(k.data),aa(k.lastSelectedData),k._index={},k.grouping&&null!=k.groupingView&&(k.groupingView.groups=[],k.groupingView._locgr=!1),k.localReader.id="_id_");k.reccount=0;switch(n){case "xml":case "xmlstring":q=k.xmlReader;v=u.getXmlData;break;case "json":case "jsonp":case "jsonstring":q=k.jsonReader}var t,w,x,A,F,B={},y,L=k.colModel,D=L.length,E,I,H,ja,
Q,M=k.arrayReaderInfos,W={},Pa=function(b){return function(a){a=a.getAttribute(b);return null!==a?a:void 0}},C=function(b){return function(){var a=W[b];if(null!=a)return a=a.childNodes,0<a.length?a[0].nodeValue:void 0}};k.page=R(v(a,q.page),k.page);k.lastpage=R(v(a,q.total),1);k.records=R(v(a,q.records));m(q.userdata)?k.userData=q.userdata.call(this,a)||{}:r?v(a,q.userdata,!0).each(function(){k.userData[this.getAttribute("name")]=b(this).text()}):k.userData=v(a,q.userdata)||{};J();var ba={},ea=k.additionalProperties,
...
q.id:k.keyName;isNaN(A)?m(A)||(M[A]&&(F=M[A].order),r&&("string"===typeof A&&/^\[\w+\]$/.test(A)?A=Pa(A.substring(1,A.length-1)):"string"===typeof A&&/^\w+$/.test(A)&&(A=C(A)))):F=Number(A);x=v(a,q.root,!0);if(q.row)if(1===x.length&&"string"===typeof q.row&&/^\w+$/.test(q.row)){D=[];H=x[0].childNodes;ja=H.length;for(I=0;I<ja;I++)Q=H[I],1===Q.nodeType&&Q.nodeName===q.row&&D.push(Q);x=D}else x=v(x,q.row,!0);null==x&&l(a)&&(x=a);x||(x=[]);a=x.length;0<a&&0>=k.page&&(k.page=1);Ka=parseInt(k.rowNum,10);
f&&(Ka*=f+1);var L=[],za=[],G,D=[];for(t=0;t<a;t++){G=x[t];w=q.repeatitems&&q.cell?v(G,q.cell,!0)||G:G;y=q.repeatitems&&(r||l(w));B={};W={};if(r&&!y&&null!=w)for(H=w.childNodes,ja=H.length,I=0;I<ja;I++)Q=H[I],1===Q.nodeType&&(W[Q.nodeName]=Q);for(E in M)M.hasOwnProperty(E)&&(I=M[E],y?(H=w[I.order],r&&null!=H&&(H=H.textContent||H.text)):H=null!=ba[E]&&"string"!==typeof ba[E]?ba[E](w):v(w,"string"===typeof ba[E]?ba[E]:I.name),1===I.type&&(I=ea[I.index],null!=I&&m(I.convert)&&(H=I.convert(H,w))),void 0!==
H&&(B[E]=H));void 0!==B[A]?G=void 0!==B[A]?B[A]:Ea():(G=v(G,l(G)?F:A),void 0===G&&(G=v(w,l(w)?F:A)),void 0===G&&(G=Ea()));void 0===B[A]&&(B[A]=G);G=String(G);y=k.idPrefix+G;k.treeGrid&&U(B);if(t<Ka)za.push(y),L.push(w),D.push(B);else if(!p)break;if(p||!0===k.treeGrid)B._id_=G,k.data.push(B),k._index[B._id_]=k.data.length-1}if(!p||!k.forceClientSorting||!0===k.treeGrid){d=u.parseDataToHtml.call(this,a,za,D,L,d,f,p);J(!0);f=-1<k.treeANode?k.treeANode:0;q=b(this.tBodies[0]);!0===k.treeGrid&&0<f?b(this.rows[f]).after(d.join("")):
k.scroll?q.append(d.join("")):(null==this.firstElementChild||void 0!==document.documentMode&&9>=document.documentMode?q.html(q.html()+d.join("")):this.firstElementChild.innerHTML+=d.join(""),this.grid.cols=this.rows[0].cells);k.grouping&&K.call(this);if(!0===k.subGrid)try{c.addSubGrid.call(g,k.iColByName.subgrid)}catch(Z){}if(!1===k.gridview||m(k.afterInsertRow))for(t=0;t<Math.min(a,Ka);t++)O.call(this,"afterInsertRow",za[t],D[t],L[t]);k.totaltime=new Date-h;0<t&&0===k.records&&(k.records=a);aa(d);
if(!0===k.treeGrid)try{c.setTreeNode.call(g,f+1,t+f+1)}catch(Z){}k.reccount=Math.min(a,Ka);k.treeANode=-1;k.userDataOnFooter&&c.footerData.call(g,"set",k.userData,!0);p&&(k.records=a,k.lastpage=Math.ceil(a/Ka));e||this.updatepager(!1,!0);Fa.call(this)}}},cb=function(){function a(b){var c=0,d,e,f,g,h,l,p;if(null!=b.groups){(e=b.groups.length&&"OR"===b.groupOp.toString().toUpperCase())&&y.orBegin();for(d=0;d<b.groups.length;d++){0<c&&e&&y.or();try{a(b.groups[d])}catch(r){x(r)}c++}e&&y.orEnd()}if(null!=
b.rules)try{(f=b.rules.length&&"OR"===b.groupOp.toString().toUpperCase())&&y.orBegin();for(d=0;d<b.rules.length;d++)h=b.rules[d],g=b.groupOp.toString().toUpperCase(),K[h.op]&&h.field?(0<c&&g&&"OR"===g&&(y=y.or()),p=n[h.field],null!=p&&(l=p.reader,y=K[h.op](y,g)(m(l)?'jQuery.jgrid.getAccessor(this,jQuery("'+k.idSel+'")[0].p.colModel['+p.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+l+"')",h.data,n[h.field]))):null!=k.customSortOperations&&null!=k.customSortOperations[h.op]&&m(k.customSortOperations[h.op].filter)&&
(y=y.custom(h.op,h.field,h.data)),c++;f&&y.orEnd()}catch(r){x(r)}}var d=b(this),e=k.multiSort?[]:"",f={},g=!1,n={},p=[],q=[],v=w.call(h,"formatter.date.srcformat"),t=w.call(h,"formatter.date.newformat");if(!l(k.data))return{};k.multiSort&&rb(e,f);var A=k.grouping?k.groupingView:!1,z,B,F=function(b,a,c){var d=b.index||b.name,f=b.sorttype||"text";n[b.name]={reader:k.dataTypeOrg?b.name:b.jsonmap||b.name,iCol:a,stype:f,srcfmt:"",newfmt:"",sfunc:b.sortfunc||null,isAddProp:!0===c?!0:!1};if("date"===f||
"datetime"===f)b.formatter&&"string"===typeof b.formatter&&"date"===b.formatter?(a=b.formatoptions&&b.formatoptions.srcformat?b.formatoptions.srcformat:v,c=b.formatoptions&&b.formatoptions.newformat?b.formatoptions.newformat:t):a=c=b.datefmt||"Y-m-d",n[b.name].srcfmt=a,n[b.name].newfmt=c;if(k.grouping)for(B=0,z=A.groupField.length;B<z;B++)b.name===A.groupField[B]&&(p[B]=n[d],q[B]=d);k.multiSort||g||b.index!==k.sortname&&b.name!==k.sortname||(e=b.name,g=!0)};r(k.colModel,function(b){F(this,b)});r(k.additionalProperties,
function(b){F("string"===typeof this?{name:this}:this,b,!0)});if(k.treeGrid)return c.SortTree.call(d,e,k.sortorder,null!=n[e]&&n[e].stype?n[e].stype:"text",null!=n[e]&&n[e].srcfmt?n[e].srcfmt:""),!1;var K={eq:function(b){return b.equals},ne:function(b){return b.notEquals},lt:function(b){return b.less},le:function(b){return b.lessOrEquals},gt:function(b){return b.greater},ge:function(b){return b.greaterOrEquals},cn:function(b){return b.contains},nc:function(b,a){return"OR"===a?b.orNot().contains:b.andNot().contains},
bw:function(b){return b.startsWith},bn:function(b,a){return"OR"===a?b.orNot().startsWith:b.andNot().startsWith},en:function(b,a){return"OR"===a?b.orNot().endsWith:b.andNot().endsWith},ew:function(b){return b.endsWith},ni:function(b,a){return"OR"===a?b.orNot().equals:b.andNot().equals},"in":function(b){return b.equals},nu:function(b){return b.isNull},nn:function(b,a){return"OR"===a?b.orNot().isNull:b.andNot().isNull}},y=u.from.call(this,k.data);k.ignoreCase&&(y=y.ignoreCase());if(!0===k.search){var L=
k.postData.filters;if(L)"string"===typeof L&&(L=b.parseJSON(L)),a(L);else try{var D=n[k.postData.searchField],y=K[k.postData.searchOper](y)(m(D.reader)?'jQuery.jgrid.getAccessor(this,jQuery("'+k.idSel+'")[0].p.colModel['+D.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+D.reader+"')",k.postData.searchString,n[k.postData.searchField])}catch(I){}}if(k.grouping)for(B=0;B<z;B++)y.orderBy(q[B],A.groupOrder[B],p[B].stype,p[B].srcfmt);k.multiSort?r(e,function(){y.orderBy(this,f[this],n[this].stype,n[this].srcfmt,
n[this].sfunc)}):e&&k.sortorder&&g&&y.orderBy(k.sortname,"DESC"===k.sortorder.toUpperCase()?"d":"a",n[e].stype,n[e].srcfmt,n[e].sfunc);k.lastSelectedData=y.select();var L=parseInt(k.rowNum,10),D=k.lastSelectedData.length,E=parseInt(k.page,10),H=Math.ceil(D/L),Q={};if(k.grouping&&k.groupingView._locgr){k.groupingView.groups=[];var ja,M,W;if(k.footerrow&&k.userDataOnFooter){for(M in k.userData)k.userData.hasOwnProperty(M)&&(k.userData[M]=0);W=!0}for(ja=0;ja<D;ja++){if(W)for(M in k.userData)k.userData.hasOwnProperty(M)&&
(k.userData[M]+=parseFloat(k.lastSelectedData[ja][M]||0));c.groupingPrepare.call(d,k.lastSelectedData[ja],ja,L)}}n=y=null;d=k.localReader;Q[d.total]=H;Q[d.page]=E;Q[d.records]=D;Q[d.root]=k.lastSelectedData.slice((E-1)*L,E*L);Q[d.userdata]=k.userData;return Q},$a=function(a){var c=a.outerWidth();0>=c&&(c=b(this).closest(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px",b(document.body).append("<div id='testpg' class='"+D("gBox","ui-jqgrid")+"' style='font-size:"+c+";visibility:hidden;margin:0;padding:0;' ></div>"),
b(a).clone().appendTo("#testpg"),c=b("#testpg>.ui-pg-table").width(),b("#testpg").remove());0<c&&a.parent().width(c);return c},ib=function(a,c){var d=this,e=b(d),f=d.grid,g,l,m,n,p,r,q=k.pager||"",v=k.pager?"_"+k.pager.substr(1):"";g=f.bDiv;var t=b.fmatter?b.fmatter.NumberFormat:null,A=k.toppager?"_"+k.toppager.substr(1):"",x=D("states.hover"),z=D("states.disabled");l=parseInt(k.page,10)-1;0>l&&(l=0);l*=parseInt(k.rowNum,10);n=l+k.reccount;if(k.scroll){r=b(bb(21,g)[0].rows).slice(1);l=n-r.length;
k.reccount=r.length;if(r=r.outerHeight()||f.prevRowHeight)m=l*r,p=u.fixMaxHeightOfDiv.call(d,parseInt(k.records,10)*r),b(g).children("div").first().css({height:p+"px"}).children("div").first().css({height:m+"px",display:m+"px"?"":"none"}),0===g.scrollTop&&1<k.page&&(g.scrollTop=k.rowNum*(k.page-1)*r);g.scrollLeft=f.hDiv.scrollLeft}if(q+=k.toppager?(q?",":"")+k.toppager:"")r=w.call(h,"formatter.integer")||{},f=R(k.page),g=R(k.lastpage),b(".selbox",q).prop("disabled",!1),!0===k.pginput&&(b(".ui-pg-input",
q).val(k.page),m=k.toppager?"#sp_1"+v+",#sp_1"+A:"#sp_1"+v,b(m).html(b.fmatter?t(k.lastpage,r):k.lastpage).closest(".ui-pg-table").each(function(){$a.call(d,b(this))})),k.viewrecords&&(0===k.reccount?b(".ui-paging-info",q).html(F("emptyrecords")):(m=l+1,p=k.records,b.fmatter&&(m=t(m,r),n=t(n,r),p=t(p,r)),b(".ui-paging-info",q).html(u.format(F("recordtext"),m,n,p)))),!0===k.pgbuttons&&(0>=g&&(f=0),0>=f&&(f=g=0),1===f||0===f?(b("#first"+v+", #prev"+v).addClass(z).removeClass(x),k.toppager&&b("#first_t"+
A+", #prev_t"+A).addClass(z).removeClass(x)):(b("#first"+v+", #prev"+v).removeClass(z),k.toppager&&b("#first_t"+A+", #prev_t"+A).removeClass(z)),f===g||0===f?(b("#next"+v+", #last"+v).addClass(z).removeClass(x),k.toppager&&b("#next_t"+A+", #last_t"+A).addClass(z).removeClass(x)):(b("#next"+v+", #last"+v).removeClass(z),k.toppager&&b("#next_t"+A+", #last_t"+A).removeClass(z)));!0===a&&!0===k.rownumbers&&b(">td.jqgrid-rownum",d.rows).each(function(a){b(this).html(l+1+a)});c&&k.jqgdnd&&e.jqGrid("gridDnD",
"updateDnD");O.call(d,"gridComplete");e.triggerHandler("jqGridAfterGridComplete")},ja=function(){this.grid.hDiv.loading=!0;k.hiddengrid||c.progressBar.call(b(this),{method:"show",loadtype:k.loadui,htmlcontent:F("loadtext")})},Pa=function(){this.grid.hDiv.loading=!1;c.progressBar.call(b(this),{method:"hide",loadtype:k.loadui})},za=function(a){var e=this,f=b(e),g=e.grid;if(!g.hDiv.loading){var h=k.scroll&&!1===a,l={},p,r=k.prmNames;0>=k.page&&(k.page=Math.min(1,k.lastpage));null!==r.search&&(l[r.search]=
...
b);za.call(e,a-1)}:null!==r.npage&&delete k.postData[r.npage];if(k.grouping&&c.groupingSetup){c.groupingSetup.call(f);var A=k.groupingView,x,w="",B,y,F;for(x=0;x<A.groupField.length;x++){B=A.groupField[x];for(y=0;y<k.colModel.length;y++)F=k.colModel[y],F.name===B&&F.index&&(B=F.index);w+=B+" "+A.groupOrder[x]+", "}l[r.sort]=w+l[r.sort]}n(k.postData,l);var K=k.scroll?e.rows.length-1:1,L=function(){I.call(e);var b=f.width(),a=f.closest(".ui-jqgrid-view").width(),d=f.css("height");a<b&&0===k.reccount?
f.css("height","1px"):"0"!==d&&"0px"!==d&&f.css("height","");k.autowidth||void 0!==k.widthOrg&&"auto"!==k.widthOrg&&"100%"!==k.widthOrg||c.setGridWidth.call(f,k.tblwidth+k.scrollOffset,!1)},D=function(){var b;if(k.autoresizeOnLoad)c.autoResizeAllColumns.call(f);else for(b=0;b<k.columnsToReResizing.length;b++)c.autoResizeColumn.call(f,k.columnsToReResizing[b]);aa(k.columnsToReResizing)},r=function(){O.call(e,"loadComplete",p);D();f.triggerHandler("jqGridAfterLoadComplete",[p]);Pa.call(e);k.datatype=
"local";k.datastr=null;L()},E=function(b){f.triggerHandler("jqGridLoadComplete",[b]);v&&v.call(e,b);D();f.triggerHandler("jqGridAfterLoadComplete",[b]);h&&g.populateVisible.call(e);1===a&&Pa.call(e);L()},H=function(){var b=cb.call(e);Ga.call(e,b,K,1<a,t);E(b)};if(O.call(e,"beforeRequest"))if(m(k.datatype))k.datatype.call(e,k.postData,"load_"+k.id,K,a,t);else switch(l=k.datatype.toLowerCase(),l){case "json":case "jsonp":case "xml":case "script":b.ajax(n({url:k.url,type:k.mtype,dataType:l,data:u.serializeFeedback.call(d,
k.serializeGridData,"jqGridSerializeGridData",k.postData),success:function(c,d,f){k.jqXhr=null;b(z.eDiv).hide();if(m(k.beforeProcessing)&&!1===k.beforeProcessing.call(e,c,d,f))Pa.call(e);else if(Ga.call(e,c,K,1<a,t),E(c),k.loadonce||k.treeGrid)k.dataTypeOrg=k.datatype,k.datatype="local",k.forceClientSorting&&H()},error:function(b,c,d){k.jqXhr=null;m(k.loadError)&&k.loadError.call(e,b,c,d);1===a&&Pa.call(e)},beforeSend:function(b,a){var c=!0;m(k.loadBeforeSend)&&(c=k.loadBeforeSend.call(e,b,a));void 0===
c&&(c=!0);if(!1===c)return!1;k.jqXhr=b;ja.call(e)}},u.ajaxOptions,k.ajaxGridOptions));break;case "xmlstring":ja.call(e);p="string"===typeof k.datastr?b.parseXML(k.datastr):k.datastr;Ga.call(e,p);r();k.forceClientSorting&&H();break;case "jsonstring":ja.call(e);p=k.datastr&&"string"===typeof k.datastr?b.parseJSON(k.datastr):k.datastr;Ga.call(e,p);r();k.forceClientSorting&&H();break;case "local":case "clientside":ja.call(e),k.datatype="local",H()}}},jb=function(a){var c=this.grid;b(k.cb,c.hDiv).prop("checked",
a);k.frozenColumns&&b(k.cb,c.fhDiv).prop("checked",a)},sb=function(a,c){var e=D("states.hover"),f=D("states.disabled"),g="<td class='ui-pg-button "+f+"'><span class='ui-separator'></span></td>",h="",l="<table style='table-layout:auto;white-space: pre;"+("left"===k.pagerpos?"margin-right:auto;":"right"===k.pagerpos?"margin-left:auto;":"margin-left:auto;margin-right:auto;")+"' class='ui-pg-table'><tbody><tr>",m="",n,p,r,q,v=function(b,a,c){if(!O.call(d,"onPaging",b,{newPage:a,currentPage:R(k.page,1),
lastPage:R(k.lastpage,1),currentRowNum:R(k.rowNum,10),newRowNum:c}))return!1;k.selrow=null;k.multiselect&&(k.multiPageSelection||aa(k.selarrrow),jb.call(d,!1));aa(k.savedRow);return!0};c+="_"+a;n="pg_"+a;p=a+"_left";r=a+"_center";q=a+"_right";b("#"+G(a)).append("<div id='"+n+"' class='ui-pager-control' role='group'><table class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;'><tbody><tr><td id='"+p+"' style='text-align:left;"+(void 0!==k.pagerLeftWidth?"width:"+k.pagerLeftWidth+"px;":
"")+"'></td><td id='"+r+"' style='text-align:center;white-space:pre;"+(void 0!==k.pagerCenterWidth?"width:"+k.pagerCenterWidth+"px;":"")+"'></td><td id='"+q+"' style='text-align:right;"+(void 0!==k.pagerRightWidth?"width:"+k.pagerRightWidth+"px;":"")+"'></td></tr></tbody></table></div>").attr("dir","ltr");n="#"+G(n);if(0<k.rowList.length){m="<td dir='"+W+"'>";p=F("pgrecs");m+="<select class='"+D("pager.pagerSelect","ui-pg-selbox")+"' "+(p?"title='"+p+"'":"")+">";for(p=0;p<k.rowList.length;p++)r=k.rowList[p].toString().split(":"),
1===r.length&&(r[1]=r[0]),m+="<option value='"+r[0]+"'"+(R(k.rowNum,0)===R(r[0],0)?" selected='selected'":"")+">"+r[1]+"</option>";m+="</select></td>"}"rtl"===W&&(l+=m);!0===k.pginput&&(h="<td dir='"+W+"'>"+u.format(F("pgtext")||"","<input class='"+D("pager.pagerInput","ui-pg-input")+"' type='text' size='2' maxlength='7' value='0'/>","<span id='sp_1_"+a+"'>0</span>")+"</td>");a="#"+G(a);if(!0===k.pgbuttons){r=["first","prev","next","last"];var t=D("pager.pagerButton","ui-pg-button");q=function(b){var a=
F("pg"+b);return"<td role='button' tabindex='0' id='"+b+c+"' class='"+t+"' "+(a?"title='"+a+"'":"")+"><span class='"+B("pager."+b)+"'></span></td>"};"rtl"===W&&r.reverse();for(p=0;p<r.length;p++)l+=q(r[p]),1===p&&(l+=""!==h?g+h+g:"")}else""!==h&&(l+=h);"ltr"===W&&(l+=m);l+="</tr></tbody></table>";!0===k.viewrecords&&b("td"+a+"_"+k.recordpos,n).append("<span dir='"+W+"' style='text-align:"+k.recordpos+"' class='ui-paging-info'></span>");var A=b("td"+a+"_"+k.pagerpos,n);A.append(l);g=$a.call(this,A.children(".ui-pg-table"));
k._nvtd=[];k._nvtd[0]=g?Math.floor((k.width-g)/2):Math.floor(k.width/3);k._nvtd[1]=0;l=null;b(".ui-pg-selbox",n).bind("change",function(){var a=R(this.value,10),c=Math.round(k.rowNum*(k.page-1)/a-.5)+1;if(!v("records",c,a))return!1;k.page=c;k.rowNum=a;k.pager&&b(".ui-pg-selbox",k.pager).val(a);k.toppager&&b(".ui-pg-selbox",k.toppager).val(a);za.call(d);return!1});!0===k.pgbuttons&&(b(".ui-pg-button",n).hover(function(){ca(this,f)?this.style.cursor="default":(b(this).addClass(e),this.style.cursor=
"pointer")},function(){ca(this,f)||(b(this).removeClass(e),this.style.cursor="default")}),b("#first"+G(c)+", #prev"+G(c)+", #next"+G(c)+", #last"+G(c)).click(function(){if(ca(this,f))return!1;var b=R(k.page,1),a=b,e=this.id,g=R(k.lastpage,1),h=!1,l=!0,m=!0,n=!0,p=!0;0===g||1===g?(1>=b&&(m=l=!1),p=n=!1):1<g&&1<=b?1===b?m=l=!1:b===g&&(p=n=!1):1<g&&0===b&&(p=n=!1,b=g-1);this.id==="first"+c&&l&&(e="first",a=1,h=!0);this.id==="prev"+c&&m&&(e="prev",a=b-1,h=!0);this.id==="next"+c&&n&&(e="next",a=b+1,h=
!0);this.id==="last"+c&&p&&(e="last",a=g,h=!0);if(!v(e,a,R(k.rowNum,10)))return!1;k.page=a;h&&za.call(d);return!1}));!0===k.pginput&&b("input.ui-pg-input",n).bind("keypress.jqGrid",function(a){a=a.charCode||a.keyCode||0;var c=R(b(this).val(),1);if(13===a){if(!v("user",c,R(k.rowNum,10)))return!1;b(this).val(c);k.page=0<b(this).val()?b(this).val():k.page;za.call(d);return!1}return this});A.children(".ui-pg-table").bind("keydown.jqGrid",function(b){13===b.which&&(b=A.find(":focus"),0<b.length&&b.trigger("click"))})},
rb=function(a,c,d){r((k.sortname+" "+k.sortorder).split(","),function(){var c=b.trim(this).split(" ");2===c.length&&a.push(c[0])});if(null!=d){var e=b.inArray(d.index||d.name,a);""!==d.lso&&0>e?a.push(d.index||d.name):""===d.lso&&0<=e&&a.splice(e,1)}r(k.colModel,function(){var d=this.index||this.name,e;this.lso&&(e=this.lso.split("-"),0>b.inArray(d,a)&&a.push(d),c[d]=e[e.length-1])})},Cb=function(a,c){var e="",f=k.colModel[a],g,h=D("states.disabled"),l=k.frozenColumns?b(c):b(d.grid.headers[a].el);
g=l.find("span.s-ico");var m=g.children("span.ui-icon-asc"),n=g.children("span.ui-icon-desc"),p=m,q=n,v=[],t={};l.find("span.ui-grid-ico-sort").addClass(h);l.attr("aria-selected","false");f.lso?(g.show(),g=f.lso.split("-"),g=g[g.length-1],"desc"===g&&(p=n,q=m),p.removeClass(h).css("display",""),k.showOneSortIcon&&q.hide(),l.attr("aria-selected","true")):k.viewsortcols[0]||g.hide();rb(v,t,f);r(v,function(){0<e.length&&(e+=", ");e+=this+" "+t[this];k.sortorder=t[this]});k.sortname=e.substring(0,e.length-
k.sortorder.length-1)},V=function(a,d,e,f,g){var h=this.grid,l=k.colModel[d],m=D("states.disabled");if(null!=l&&l.sortable&&!(0<k.savedRow.length)){e||(k.lastsort===d&&""!==k.sortname?(k.sortorder="asc"===k.sortorder?"desc":"desc"===k.sortorder?"asc":l.firstsortorder||"asc",l.lso?"asc"===l.lso?l.lso+="-desc":"desc"===l.lso?l.lso+="-asc":"asc-desc"!==l.lso&&"desc-asc"!==l.lso||!k.threeStateSort&&!k.multiSort||(l.lso=""):l.lso=l.firstsortorder||"asc"):l.lso=k.sortorder=l.firstsortorder||"asc",k.page=
1);if(k.multiSort)Cb(d,g);else{if(f){if(k.lastsort===d&&k.sortorder===f&&!e)return;k.sortorder=f}l=h.headers;e=h.fhDiv;f=l[k.lastsort]?b(l[k.lastsort].el):b();g=k.frozenColumns?b(g):b(l[d].el);var n=g.find("span.s-ico"),p=n.children("span.ui-icon-"+k.sortorder),r=n.children("span.ui-icon-"+("asc"===k.sortorder?"desc":"asc")),l=k.colModel[k.lastsort];f.find("span.ui-grid-ico-sort").addClass(m);f.attr("aria-selected","false");k.frozenColumns&&(e.find("span.ui-grid-ico-sort").addClass(m),e.find("th").attr("aria-selected",
"false"));k.viewsortcols[0]||(k.lastsort!==d?(k.frozenColumns&&e.find("span.s-ico").hide(),f.find("span.s-ico").hide(),n.show()):""===k.sortname&&n.show());k.lastsort!==d&&"true"===f.data("autoResized")&&(null!=l&&null!=l.autoResizing&&l.autoResizing.compact||k.autoResizing.compact)&&k.columnsToReResizing.push(k.lastsort);l=k.colModel[d];n.css("display","");""!==l.lso?(p.removeClass(m).css("display",""),k.showOneSortIcon&&r.removeClass(m).hide(),g.attr("aria-selected","true")):(g.attr("aria-selected",
"false"),k.threeStateSort&&(k.sortorder="",k.viewsortcols[0]||n.hide()));k.lastsort!==d&&"true"===g.data("autoResized")&&(null!=l&&null!=l.autoResizing&&l.autoResizing.compact||k.autoResizing.compact)&&k.columnsToReResizing.push(d);a=a.substring(5+k.id.length+1);k.sortname=l.index||a}O.call(this,"onSortCol",k.sortname,d,k.sortorder)?("local"===k.datatype?k.deselectAfterSort&&!k.multiPageSelection&&c.resetSelection.call(b(this)):k.multiPageSelection||(k.selrow=null,k.multiselect&&(jb.call(this,!1),
aa(k.selarrrow))),aa(k.savedRow),k.scroll&&(m=h.bDiv.scrollLeft,z.emptyRows.call(this,!0,!1),h.hDiv.scrollLeft=m),k.subGrid&&"local"===k.datatype&&b("td.sgexpanded","#"+G(k.id)).each(function(){b(this).trigger("click")}),za.call(this),k.lastsort=d,k.sortname!==a&&d&&(k.lastsort=d)):k.lastsort=d}},Db=function(){var b=0,a=u.cell_width?0:R(k.cellLayout,0),c=0,d,e=R(k.scrollOffset,0),f,g=!1,h,l=0,m,n=u.isCellClassHidden;r(k.colModel,function(){void 0===this.hidden&&(this.hidden=!1);if(k.grouping&&k.autowidth){var d=
p(this.name,k.groupingView.groupField);0<=d&&k.groupingView.groupColumnShow.length>d&&(this.hidden=!k.groupingView.groupColumnShow[d])}this.widthOrg=f=R(this.width,0);!1!==this.hidden||n(this.classes)||(b+=f+a,this.fixed?l+=f+a:c++)});isNaN(k.width)&&(k.width=b+(!1!==k.shrinkToFit||isNaN(k.height)?0:e));z.width=k.width;k.tblwidth=b;!1===k.shrinkToFit&&!0===k.forceFit&&(k.forceFit=!1);!0===k.shrinkToFit&&0<c&&(h=z.width-a*c-l,isNaN(k.height)||(h-=e,g=!0),b=0,r(k.colModel,function(e){!1!==this.hidden||
n(this.classes)||this.fixed||(this.width=f=Math.round(h*this.width/(k.tblwidth-a*c-l)),b+=f,d=e)}),m=0,g?z.width-l-(b+a*c)!==e&&(m=z.width-l-(b+a*c)-e):g||1===Math.abs(z.width-l-(b+a*c))||(m=z.width-l-(b+a*c)),k.colModel[d].width+=m,k.tblwidth=b+m+a*c+l,k.tblwidth>k.width&&(k.colModel[d].width-=k.tblwidth-parseInt(k.width,10),k.tblwidth=k.width))},Eb=function(b){var a=b,c;for(c=b+1;c<k.colModel.length;c++)if(!0!==k.colModel[c].hidden){a=c;break}return a-b},db;-1===p(k.multikey,["shiftKey","altKey",
"ctrlKey"])&&(k.multikey=!1);k.keyName=!1;k.sortorder=k.sortorder.toLowerCase();u.cell_width=u.cellWidth();var kb=u.cmTemplate,Y,P;for(Y=0;Y<k.colModel.length;Y++)P=k.colModel[Y],db="string"===typeof P.template?null==kb||"object"!==typeof kb[P.template]&&!b.isFunction(kb[P.template])?{}:kb[P.template]:P.template,m(db)&&(db=db.call(d,{cm:P,iCol:Y})),P=n(!0,{},k.cmTemplate,db||{},P),!1===k.keyName&&!0===P.key&&(k.keyName=P.name),k.colModel[Y]=P;for(Y=0;Y<k.additionalProperties.length;Y++)P=k.additionalProperties[Y],
!1===k.keyName&&!0===P.key&&(k.keyName=P.name);if(0===k.colNames.length)for(Y=0;Y<k.colModel.length;Y++)k.colNames[Y]=void 0!==k.colModel[Y].label?k.colModel[Y].label:k.colModel[Y].name;if(k.colNames.length!==k.colModel.length)x(w.call(h,"errors.model"));else{!0===k.grouping&&(k.scroll=!1,k.rownumbers=!1,k.treeGrid=!1,k.gridview=!0);if(k.subGrid)try{c.setSubGrid.call(h)}catch(qb){}if(k.multiselect&&("left"===k.multiselectPosition||"right"===k.multiselectPosition)){var tb="left"===k.multiselectPosition?
...
hidedlg:!0,search:!1,align:"center",fixed:!0,frozen:!0}));k.iColByName=H(k.colModel);k.xmlReader=n(!0,{root:"rows",row:"row",page:"rows>page",total:"rows>total",records:"rows>records",repeatitems:!0,cell:"cell",id:"[id]",userdata:"userdata",subgrid:{root:"rows",row:"row",repeatitems:!0,cell:"cell"}},k.xmlReader);k.jsonReader=n(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!0,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},k.jsonReader);
k.localReader=n(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},k.localReader);k.scroll&&(k.pgbuttons=!1,k.pginput=!1,k.rowList=[]);if(!0===k.treeGrid){try{c.setTreeGrid.call(h)}catch(qb){}"local"!==k.datatype&&(k.localReader={id:"_id_"});k.iPropByName=L(k.additionalProperties)}wa();Q();k.data.length&&(ia.call(d),qa());if(!0===k.shrinkToFit&&!0===k.forceFit)for(Y=k.colModel.length-
1;0<=Y;Y--)if(!0!==k.colModel[Y].hidden){k.colModel[Y].resizable=!1;break}var S,da,eb,fa,la,ga,ma,oa=[],Da=[],ha=[],ka="<thead><tr class='ui-jqgrid-labels' role='row'>",Aa,ua="<tbody><tr style='display:none;'>",na=D("states.hover"),ta=D("states.disabled");if(k.multiSort){var oa=k.sortname.split(","),va;for(va=0;va<oa.length;va++)ha=q(oa[va]).split(" "),oa[va]=q(ha[0]),Da[va]=ha[1]?q(ha[1]):k.sortorder||"asc"}for(Y=0;Y<k.colNames.length;Y++){P=k.colModel[Y];la=k.headertitles||P.headerTitle?" title='"+
lb("string"===typeof P.headerTitle?P.headerTitle:k.colNames[Y])+"'":"";ka+="<th id='"+k.id+"_"+P.name+"' class='"+D("colHeaders","ui-th-column ui-th-"+W+" "+(P.labelClasses||""))+"'"+la+">";S=P.index||P.name;switch(P.labelAlign){case "left":ga="text-align:left;";break;case "right":ga="text-align:right;"+(!1===P.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;");break;case "likeData":ga=void 0===P.align||"left"===P.align?"text-align:left;":"right"===P.align?"text-align:right;"+
(!1===P.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;"):"";break;default:ga=""}ka+="<div id='jqgh_"+k.id+"_"+P.name+"'"+(M?" class='ui-th-div-ie'":"")+(""===ga?"":" style='"+ga+"'")+">";Aa=P.autoResizable&&"actions"!==P.formatter?"<span class='"+k.autoResizing.wrapperClassName+"'>"+k.colNames[Y]+"</span>":k.colNames[Y];k.sortIconsBeforeText?(ka+=(k.builderSortIcons||u.builderSortIcons).call(d,Y),ka+=Aa):(ka+=Aa,ka+=(k.builderSortIcons||u.builderSortIcons).call(d,Y));
ka+="</div></th>";ua+="<td></td>";P.width=P.width?parseInt(P.width,10):150;"boolean"!==typeof P.title&&(P.title=!0);P.lso="";S===k.sortname&&(k.lastsort=Y,P.lso=k.sortorder||P.firstsortorder||"asc");k.multiSort&&(ha=p(S,oa),-1!==ha&&(P.lso=Da[ha]))}var ka=ka+"</tr></thead>",ua=ua+"</tr></tbody>",ya=b("<table class='"+D("hTable","ui-jqgrid-htable")+"' style='width:1px' role='presentation' aria-labelledby='gbox_"+k.id+"'>"+ka+ua+"</table>");b(ya[0].tHead).children("tr").children("th").hover(function(){b(this).addClass(na)},
function(){b(this).removeClass(na)});k.multiselect&&b(k.cb,ya).bind("click",function(){var a=D("states.select"),c,e=[],f=k.iColByName.cb,g=function(c,d){b(c)[d?"addClass":"removeClass"](a).attr(d?{"aria-selected":"true",tabindex:"0"}:{"aria-selected":"false",tabindex:"-1"});void 0!==f&&b(c.cells[f]).children("input.cbox").prop("checked",d)},h=z.fbRows,l=ta+" ui-subgrid jqgroup jqfoot jqgfirstrow jqgskipselect",m,n=k._index;aa(k.selarrrow);if(this.checked){if(c=!0,k.selrow=1<d.rows.length?d.rows[d.rows.length-
1].id:null,k.multiPageSelection&&("local"===k.datatype||k.treeGrid)&&null!=k.data&&0<k.data.length&&null!=n)for(m in n)n.hasOwnProperty(m)&&k.selarrrow.push(k.idPrefix+m)}else c=!1,k.selrow=null;var p=c?k.selarrrow:e;b(d.rows).each(function(a){ca(this,l)||(g(this,c),0>b.inArray(this.id,p)&&p.push(this.id),h&&g(h[a],c))});O.call(d,"onSelectAll",c?k.selarrrow:e,c)});if(!0===k.autowidth){var La=Math.floor(b(ea).innerWidth());k.width=0<La?La:"nw"}isNaN(k.width)?isNaN(parseFloat(k.width))||(k.width=parseFloat(k.width)):
k.width=Number(k.width);k.widthOrg=k.width;Db();b(ea).css("width",z.width+"px").append("<div class='"+D("resizer","ui-jqgrid-resize-mark")+"' id='"+k.rsId+"'>&#160;</div>");b(k.rs).bind("selectstart",function(){return!1}).click(ba).dblclick(function(a){var e=b(this).data("idx"),f=b(this).data("pageX"),g=k.colModel[e];if(null==f||null==g)return!1;var f=String(f).split(";"),l=parseFloat(f[0]),m=parseFloat(f[1]);if(2===f.length&&(5<Math.abs(l-m)||5<Math.abs(a.pageX-l)||5<Math.abs(a.pageX-m)))return!1;
O.call(d,"resizeDblClick",e,g,a)&&g.autoResizable&&c.autoResizeColumn.call(h,e);O.call(d,"afterResizeDblClick",{iCol:e,cm:g,cmName:g.name});return!1});b(C).css("width",z.width+"px");var Va="";k.footerrow&&(Va+="<table role='presentation' style='width:1px' class='"+D("gridFooter","ui-jqgrid-ftable")+"'><tbody><tr role='row' class='"+D("rowFooter","footrow footrow-"+W)+"'>");var Ba="<tr class='jqgfirstrow' role='row' style='height:auto'>";k.disableClick=!1;b("th",ya[0].tHead.rows[0]).each(function(a){var c=
k.colModel[a],d=c.name,e=b(this),f=e.children("div"),g=f.children("span.s-ico"),h=k.showOneSortIcon;da=c.width;void 0===c.resizable&&(c.resizable=!0);c.resizable?(eb=document.createElement("span"),b(eb).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+W).bind("selectstart",function(){return!1}),e.addClass(k.resizeclass)):eb="";e.css("width",da+"px").prepend(eb);eb=null;var l="";!0===c.hidden&&(e.css("display","none"),l="display:none;");Ba+="<td role='gridcell' "+(c.classes?"class='"+c.classes+
"' ":"")+"style='height:0;width:"+da+"px;"+l+"'></td>";z.headers[a]={width:da,el:this};fa=c.sortable;"boolean"!==typeof fa&&(fa=c.sortable=!0);"cb"!==d&&"subgrid"!==d&&"rn"!==d&&fa&&k.viewsortcols[2]&&f.addClass("ui-jqgrid-sortable");fa&&(k.multiSort?(d="desc"===c.lso?"asc":"desc",k.viewsortcols[0]?(g.css("display",""),c.lso&&(g.children("span.ui-icon-"+c.lso).removeClass(ta),h&&g.children("span.ui-icon-"+d).hide())):c.lso&&(g.css("display",""),g.children("span.ui-icon-"+c.lso).removeClass(ta),h&&
g.children("span.ui-icon-"+d).hide())):(d="desc"===k.sortorder?"asc":"desc",k.viewsortcols[0]?(g.css("display",""),a===k.lastsort&&(g.children("span.ui-icon-"+k.sortorder).removeClass(ta),h&&g.children("span.ui-icon-"+d).hide())):a===k.lastsort&&""!==c.lso&&(g.css("display",""),g.children("span.ui-icon-"+k.sortorder).removeClass(ta),h&&g.children("span.ui-icon-"+d).hide())));k.footerrow&&(Va+="<td role='gridcell' "+T(a,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(a){var c=b(this),d=c.closest(".ui-jqgrid-hdiv").hasClass("frozen-div"),
...
!1;var c="th.ui-th-column>div",e,f,c=k.viewsortcols[2]?c+".ui-jqgrid-sortable":c+">span.s-ico>span.ui-grid-ico-sort";a=b(a.target).closest(c);if(1===a.length)return k.viewsortcols[2]||(e=!0,f=a.hasClass("ui-icon-desc")?"desc":"asc"),a=k.iColByName[(this.id||"").substring(k.id.length+1)],null!=a&&V.call(d,b("div",this)[0].id,a,e,f,this),!1});if(k.sortable&&b.fn.sortable)try{c.sortableColumns.call(h,b(ya[0].tHead.rows[0]))}catch(qb){}k.footerrow&&(Va+="</tr></tbody></table>");Ba+="</tr>";h.html("<tbody>"+
Ba+"</tbody>");h.addClass(D("grid","ui-jqgrid-btable"+(!0===k.altRows&&h.jqGrid("isBootstrapGuiStyle")?" table-striped":"")));var Ca=k.caption&&!0===k.hiddengrid?!0:!1,ab=b("<div class='ui-jqgrid-hbox"+("rtl"===W?"-rtl":"")+"'></div>"),Sa=D("top"),Ha=D("bottom");z.hDiv=document.createElement("div");b(z.hDiv).css({width:z.width+"px"}).addClass(D("hDiv","ui-jqgrid-hdiv")).append(ab).scroll(function(){var a=b(this).next(".ui-jqgrid-bdiv")[0];a&&(a.scrollLeft=this.scrollLeft);return!1});b(ab).append(ya);
ya=null;Ca&&b(z.hDiv).hide();k.rowNum=parseInt(k.rowNum,10);if(isNaN(k.rowNum)||0>=k.rowNum)k.rowNum=k.maxRowNum;if(k.pager){var Qa,Wa;"string"===typeof k.pager&&"#"!==k.pager.substr(0,1)?(Wa=k.pager,Qa=b("#"+G(k.pager))):!0===k.pager?(Wa=Ea(),Qa=b("<div id='"+Wa+"'></div>"),Qa.appendTo("body"),k.pager="#"+G(Wa)):(Qa=b(k.pager),Wa=Qa.attr("id"));0<Qa.length?(Qa.css({width:z.width+"px"}).addClass(D("pager.pager","ui-jqgrid-pager "+Ha)).appendTo(ea),Ca&&Qa.hide(),sb.call(d,Wa,""),k.pager="#"+G(Wa)):
...
c.length);return c};h.before(z.hDiv).click(function(a){var e=D("states.select"),f=a.target,g=Na.call(this,f),l=g.parent();if(0!==l.length&&!ca(l,ta)){sa=l[0].id;var m=b(f).hasClass("cbox"),n=O.call(d,"beforeSelectRow",sa,a),p=u.detectRowEditing.call(d,sa),p=null!=p&&"cellEditing"!==p.mode;if("A"!==f.tagName&&(!p||m))if(Ma=g[0].cellIndex,Ta=g.html(),O.call(d,"onCellSelect",sa,Ma,Ta,a),!0===k.cellEdit)if(k.multiselect&&m&&n)t.call(h,sa,!0,a);else{sa=l[0].rowIndex;try{c.editCell.call(h,sa,Ma,!0)}catch(r){}}else if(n)if(k.multikey)a[k.multikey]?
t.call(h,sa,!0,a):k.multiselect&&m&&(m=b("#jqg_"+G(k.id)+"_"+sa).is(":checked"),b("#jqg_"+G(k.id)+"_"+sa).prop("checked",!m));else if(k.multiselect&&k.multiboxonly){if(!m){var q=k.frozenColumns?k.id+"_frozen":"";b(k.selarrrow).each(function(a,d){var f=c.getGridRowById.call(h,d);f&&b(f).removeClass(e);b("#jqg_"+G(k.id)+"_"+G(d)).prop("checked",!1);q&&(b("#"+G(d),"#"+G(q)).removeClass(e),b("#jqg_"+G(k.id)+"_"+G(d),"#"+G(q)).prop("checked",!1))});aa(k.selarrrow)}t.call(h,sa,!0,a)}else f=k.selrow,t.call(h,
sa,!0,a),"toggle"!==k.singleSelectClickMode||k.multiselect||f!==sa||(this.grid.fbRows&&(l=l.add(this.grid.fbRows[sa])),l.removeClass(e).attr({"aria-selected":"false",tabindex:"-1"}),k.selrow=null);else m&&b(f).prop("checked",!1)}}).bind("reloadGrid",function(a,d){var e=this.grid,f=b(this);!0===k.treeGrid&&(k.datatype=k.treedatatype);d=n({},Ja.reloadGridOptions||{},k.reloadGridOptions||{},d||{});"local"===k.datatype&&k.dataTypeOrg&&k.loadonce&&d.fromServer&&(k.datatype=k.dataTypeOrg,delete k.dataTypeOrg);
d.current&&e.selectionPreserver.call(this);"local"===k.datatype?(k.multiPageSelection||c.resetSelection.call(f),k.data.length&&(ia.call(this),qa())):k.treeGrid||k.multiPageSelection||(k.selrow=null,k.multiselect&&(aa(k.selarrrow),jb.call(this,!1)),aa(k.savedRow));k.iRow=-1;k.iCol=-1;k.scroll&&z.emptyRows.call(this,!0,!1);if(d.page){var g=parseInt(d.page,10);g>k.lastpage&&(g=k.lastpage);1>g&&(g=1);k.page=g;e.bDiv.scrollTop=e.prevRowHeight?(g-1)*e.prevRowHeight*k.rowNum:0}e.prevRowHeight&&k.scroll&&
void 0===d.page?(delete k.lastpage,e.populateVisible.call(this)):e.populate.call(this);!0===k._inlinenav&&f.jqGrid("showAddEditButtons",!1);return!1}).dblclick(function(b){var a=Na.call(this,b.target),c=a.parent();if(0<a.length&&!O.call(d,"ondblClickRow",c.attr("id"),c[0].rowIndex,a[0].cellIndex,b))return!1}).bind("contextmenu",function(b){var a=Na.call(this,b.target),c=a.parent(),e=c.attr("id");if(0!==a.length&&(k.multiselect||t.call(h,e,!0,b),!O.call(d,"onRightClickRow",e,c[0].rowIndex,a[0].cellIndex,
...
b(z.bDiv).bind(u.msie?"selectstart":"mousedown",function(){return!1});Ca&&b(z.bDiv).hide();z.cDiv=document.createElement("div");var Ra=B("gridMinimize.visible"),Xa=B("gridMinimize.hidden"),Ya=F("showhide"),Ua=!0===k.hidegrid?b("<a role='link' class='"+D("titleButton","ui-jqgrid-titlebar-close")+"'"+(Ya?" title='"+Ya+"'":"")+"/>").hover(function(){Ua.addClass(na)},function(){Ua.removeClass(na)}).append("<span class='"+Ra+"'></span>"):"";b(z.cDiv).append("<span class='ui-jqgrid-title'>"+k.caption+"</span>").append(Ua).addClass(D("gridTitle",
"ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===W?"-rtl ":" ")+Sa));b(z.cDiv).insertBefore(z.hDiv);if(k.toolbar[0]){z.uDiv=document.createElement("div");"top"===k.toolbar[1]?b(z.uDiv).insertBefore(z.hDiv):"bottom"===k.toolbar[1]&&b(z.uDiv).insertAfter(z.hDiv);var Za=D("toolbarUpper","ui-userdata");"both"===k.toolbar[1]?(z.ubDiv=document.createElement("div"),b(z.uDiv).addClass(Za).attr("id","t_"+k.id).insertBefore(z.hDiv),b(z.ubDiv).addClass(D("toolbarBottom","ui-userdata")).attr("id","tb_"+k.id).insertAfter(z.hDiv),
Ca&&b(z.ubDiv).hide()):b(z.uDiv).width(z.width).addClass(Za).attr("id","t_"+k.id);Ca&&b(z.uDiv).hide()}"string"===typeof k.datatype&&(k.datatype=k.datatype.toLowerCase());k.toppager?(k.toppager=k.id+"_toppager",z.topDiv=b("<div id='"+k.toppager+"'></div>")[0],b(z.topDiv).addClass(D("pager.pager","ui-jqgrid-toppager"+(k.caption?"":" "+Sa))).css({width:z.width+"px"}).insertBefore(z.hDiv),sb.call(d,k.toppager,"_t"),k.toppager="#"+G(k.toppager)):""!==k.pager||k.scroll||(k.rowNum=k.maxRowNum);k.footerrow&&
(z.sDiv=b("<div class='ui-jqgrid-sdiv'></div>")[0],ab=b("<div class='ui-jqgrid-hbox"+("rtl"===W?"-rtl":"")+"'></div>"),b(z.sDiv).append(ab).width(z.width).insertAfter(z.hDiv),b(ab).append(Va),z.footers=b(".ui-jqgrid-ftable",z.sDiv)[0].rows[0].cells,k.rownumbers&&(z.footers[0].className=D("rowNum","jqgrid-rownum")),Ca&&b(z.sDiv).hide());ab=null;if(k.caption){var fb=k.datatype;!0===k.hidegrid&&(b(".ui-jqgrid-titlebar-close",z.cDiv).click(function(a){var c=".ui-jqgrid-bdiv,.ui-jqgrid-hdiv,.ui-jqgrid-pager,.ui-jqgrid-sdiv",
e=this;!0===k.toolbar[0]&&("both"===k.toolbar[1]&&(c+=",#"+G(b(z.ubDiv).attr("id"))),c+=",#"+G(b(z.uDiv).attr("id")));var f=b(c,k.gView).length;k.toppager&&(c+=","+k.toppager);"visible"===k.gridstate?b(c,k.gBox).slideUp("fast",function(){f--;0===f&&(b("span",e).removeClass(Ra).addClass(Xa),k.gridstate="hidden",b(k.gBox).hasClass("ui-resizable")&&b(".ui-resizable-handle",k.gBox).hide(),b(z.cDiv).addClass(Ha),Ca||O.call(d,"onHeaderClick",k.gridstate,a))}):"hidden"===k.gridstate&&(b(z.cDiv).removeClass(Ha),
b(c,k.gBox).slideDown("fast",function(){f--;0===f&&(b("span",e).removeClass(Xa).addClass(Ra),Ca&&(k.datatype=fb,za.call(d),Ca=!1),k.gridstate="visible",b(k.gBox).hasClass("ui-resizable")&&b(".ui-resizable-handle",k.gBox).show(),Ca||O.call(d,"onHeaderClick",k.gridstate,a))}));return!1}),Ca&&(k.datatype="local",b(".ui-jqgrid-titlebar-close",z.cDiv).trigger("click")))}else b(z.cDiv).hide(),b(z.cDiv).nextAll("div:visible").first().addClass("ui-corner-top");b(z.hDiv).after(z.bDiv);z.eDiv=b("<div class='"+
D("gridError","ui-jqgrid-errorbar ui-jqgrid-errorbar-"+W)+"' style='display:none;'><span class='ui-jqgrid-error'></span></div>")[0];b(z.hDiv).after(z.eDiv);b(ea).click(ba).dblclick(function(a){var e=b(k.rs),f=e.offset(),g=e.data("idx"),l=e.data("delta"),m=k.colModel[g],n=b(this).data("pageX")||e.data("pageX");if(null==n||null==m)return!1;var n=String(n).split(";"),p=parseFloat(n[0]),r=parseFloat(n[1]);if(2===n.length&&(5<Math.abs(p-r)||5<Math.abs(a.pageX-p)||5<Math.abs(a.pageX-r)))return!1;O.call(d,
"resizeDblClick",g,m)&&f.left-1<=a.pageX+l&&a.pageX+l<=f.left+e.outerWidth()+1&&m.autoResizable&&c.autoResizeColumn.call(h,g);O.call(d,"afterResizeDblClick",{iCol:g,cm:m,cmName:m.name});return!1});k.pager||b(z.cDiv).nextAll("div:visible").filter(":last").addClass(Ha);b(".ui-jqgrid-labels",z.hDiv).bind("selectstart",function(){return!1});d.formatCol=T;d.sortData=V;d.updatepager=ib;d.refreshIndex=qa;d.setHeadCheckBox=jb;d.fixScrollOffsetAndhBoxPadding=I;d.constructTr=ra;d.formatter=N;n(z,{populate:za,
emptyRows:X,beginReq:ja,endReq:Pa});d.addXmlData=Ga;d.addJSONData=Ga;d.rebuildRowIndexes=K;d.grid.cols=d.rows[0].cells;O.call(d,"onInitGrid");k.treeGrid&&"local"===k.datatype&&null!=k.data&&0<k.data.length&&(k.datatype="jsonstring",k.datastr=k.data,k.data=[]);za.call(d);k.hiddengrid=!1}}}})};var C=b.fn.jqGrid;u.extend({getGridRes:function(a){var c=this[0];if(!c||!c.grid||!c.p)return null;c=u.getRes(Ia[c.p.locale],a)||u.getRes(Ia["en-US"],a);a=u.getRes(u,a);return"object"!==typeof c||null===c||b.isArray(c)?
...
t,l))}O.call(f,"afterSetRow",{rowid:a,inputData:c,iData:q,iRow:h.rowIndex,tr:h,localData:l,cssProp:e})}catch(u){d=!1}d&&("string"===m?b(h).addClass(e):null!==e&&"object"===m&&b(h).css(e))});return d},addRowData:function(a,c,e,d){0>b.inArray(e,"first last before after afterSelected beforeSelected".split(" "))&&(e="last");var f=!1,g,h,m,l,n,p,q,r,t,w,x;c&&(b.isArray(c)?(p=!0,q=a):(c=[c],p=!1),this.each(function(){var y=this.p,A=c.length,v=b(this),E=this.rows,B=0,D=C.getGridRowById,k=y.colModel,F,I=
y.additionalProperties;p||(void 0!==a?a=String(a):(a=Ea(),!1!==y.keyName&&(q=y.keyName,void 0!==c[0][q]&&(a=c[0][q]))));for(r=y.altclass;B<A;){t=c[B];h=[];if(p)try{a=t[q],void 0===a&&(a=Ea())}catch(H){a=Ea()}x=a;F={};for(l=0;l<k.length;l++)w=k[l],g=w.name,"rn"!==g&&"cb"!==g&&"subgrid"!==g&&(n=Za.call(this,t[g],w,void 0,x,{},l),b.isFunction(w.saveLocally)?w.saveLocally.call(this,{newValue:n,newItem:F,oldItem:{},id:x,cm:w,cmName:g,iCol:l}):void 0!==n&&(F[g]=n));for(l=0;l<I.length;l++)g=I[l],"object"===
typeof g&&g.hasOwnProperty("name")&&(g=g.name),n=pa(t,g),void 0!==n&&(F[g]=n);"local"===y.datatype&&(F[y.localReader.id]=x,y._index[x]=y.data.length,y.data.push(F));h=u.parseDataToHtml.call(this,1,[a],[t]);h=h.join("");if(0===E.length)b(this.tBodies[0]).append(h);else{if("afterSelected"===e||"beforeSelected"===e)void 0===d&&null!==y.selrow?(d=y.selrow,e="afterSelected"===e?"after":"before"):e="afterSelected"===e?"last":"first";switch(e){case "last":b(E[E.length-1]).after(h);m=E.length-1;break;case "first":b(E[0]).after(h);
m=1;break;case "after":if(m=D.call(v,d))b(E[m.rowIndex+1]).hasClass("ui-subgrid")?(b(E[m.rowIndex+1]).after(h),m=m.rowIndex+2):(b(m).after(h),m=m.rowIndex+1);break;case "before":if(m=D.call(v,d))b(m).before(h),m=m.rowIndex-1}}!0===y.subGrid&&C.addSubGrid.call(v,y.iColByName.subgrid,m);y.records++;y.reccount++;0===y.lastpage&&(y.lastpage=1);O.call(this,"afterAddRow",{rowid:a,inputData:c,position:e,srcRowid:d,iRow:m,localData:F,iData:y.data.length-1});B++}!0!==y.altRows||p||v.jqGrid("isBootstrapGuiStyle")||
...
a.empty().html(c)[g.sortIconsBeforeText?"prepend":"append"](d))}),g.colNames[f]=c),e&&("string"===typeof e?h.addClass(e):h.css(e)),"object"===typeof d&&h.attr(d))}})},setCell:function(a,c,e,d,f,g){return this.each(function(){var h=this.p,m=-1,l=h.colModel,n,p,q,r,t,w,x,y={},A;if(this.grid&&(m=isNaN(c)?h.iColByName[c]:parseInt(c,10),0<=m&&(r=C.getGridRowById.call(b(this),a)))){t=u.getCell.call(this,r,m);if(""!==e||!0===g){p=l[m];"local"===h.datatype&&(A=Oa(h.idPrefix,a),n=h._index[A],void 0!==n&&(q=
h.data[n]));if(null==q)for(n=0;n<r.cells.length;n++){if(n!==m&&(w=u.getDataFieldOfCell.call(this,r,n),0<w.length)){try{x=b.unformat.call(this,w,{rowId:a,colModel:l[n]},n)}catch(v){x=Ba(w[0].innerHTML)}y[l[n].name]=x}}else y=q;y[p.name]=e;l=this.formatter(a,e,m,y,"edit");x=t;!0===h.treeGrid&&p.name===h.ExpandColumn&&(x=x.children("span.cell-wrapperleaf,span.cell-wrapper").first());x.html(l);p.title&&t.attr({title:e});null!=q&&(l=Za.call(this,e,p,q[p.name],A,q,m),b.isFunction(p.saveLocally)?p.saveLocally.call(this,
{newValue:l,newItem:q,oldItem:q,id:A,cm:p,cmName:p.name,iCol:m}):q[p.name]=l)}if(d||f){t=u.getCell.call(this,r,m);if(d)t["string"===typeof d?"addClass":"css"](d);"object"===typeof f&&t.attr(f)}}})},getCell:function(a,c){var e=!1;this.each(function(){var d,f=this.p,g,h;if(this.grid&&(d=isNaN(c)?f.iColByName[c]:parseInt(c,10),0<=d&&(g=C.getGridRowById.call(b(this),a)))){h=u.getDataFieldOfCell.call(this,g,d).first();try{e=b.unformat.call(this,h,{rowId:g.id,colModel:f.colModel[d]},d)}catch(m){e=Ba(h.html())}}});
return e},getCol:function(a,c,e){var d=[],f,g=0,h,m,l;c="boolean"!==typeof c?!1:c;void 0===e&&(e=!1);this.each(function(){var n,p=this.p,q;if(this.grid&&(n=isNaN(a)?p.iColByName[a]:parseInt(a,10),0<=n)){var r=this.rows,t=r.length,w=0,x=0,y;if(t&&0<t){for(;w<t;){y=r[w];if(b(y).hasClass("jqgrow")){q=u.getDataFieldOfCell.call(this,y,n).first();try{f=b.unformat.call(this,q,{rowId:y.id,colModel:p.colModel[n]},n)}catch(A){f=Ba(q.html())}e?(l=parseFloat(f),isNaN(l)||(g+=l,void 0===m&&(m=h=l),h=Math.min(h,
l),m=Math.max(m,l),x++)):c?d.push({id:y.id,value:f}):d.push(f)}w++}if(e)switch(e.toLowerCase()){case "sum":d=g;break;case "avg":d=g/x;break;case "count":d=t-1;break;case "min":d=h;break;case "max":d=m}}}});return d},clearGridData:function(a){return this.each(function(){var c=this.p,e=this.rows,d=this.grid;d&&c&&e&&("boolean"!==typeof a&&(a=!1),b(this).unbind(".jqGridFormatter"),d.emptyRows.call(this,!1,!0),c.footerrow&&a&&b(".ui-jqgrid-ftable td",d.sDiv).html("&#160;"),c.selrow=null,aa(c.selarrrow),
...
n,!1);c.autoResizing.fixWidthOnShrink=l;c.autoResizing.adjustGridWidth=m;c.shrinkToFit=h})}});var ya=function(a,c){var e=this.grid.fbRows;return b((null!=e&&e[0].cells.length>c?e[a.rowIndex]:a).cells[c])};u.extend({editCell:function(a,c,e){return this.each(function(){var d=this,f=b(d),g=d.p,h,m,l,n;h=d.rows;if(d.grid&&!0===g.cellEdit&&null!=h&&null!=h[a]&&(a=parseInt(a,10),c=parseInt(c,10),!isNaN(a)&&!isNaN(c))){var p=h[a],q=null!=p?p.id:null,r=b(p),t=parseInt(g.iCol,10),w=parseInt(g.iRow,10),x=b(h[w]),
y=g.savedRow;if(null!=q){g.selrow=q;g.knv||f.jqGrid("GridNav");if(0<y.length){if(!0===e&&a===w&&c===t)return;f.jqGrid("saveCell",y[0].id,y[0].ic)}else setTimeout(function(){b("#"+u.jqID(g.knv)).attr("tabindex","-1").focus()},1);n=g.colModel[c];h=n.name;if("subgrid"!==h&&"cb"!==h&&"rn"!==h){l=ya.call(d,p,c);p=n.editable;b.isFunction(p)&&(p=p.call(d,{rowid:q,iCol:c,iRow:a,name:h,cm:n,mode:"cell"}));var A=f.jqGrid("getGuiStyles","select","edit-cell"),v=f.jqGrid("getGuiStyles","hover","selected-row");
if(!0!==p||!0!==e||l.hasClass("not-editable-cell"))0<=t&&0<=w&&(ya.call(d,x[0],t).removeClass(A),x.removeClass(v)),l.addClass(A),r.addClass(v),m=l.html().replace(/&#160;/ig,""),O.call(d,"onSelectCell",q,h,m,a,c);else{0<=t&&0<=w&&(ya.call(d,x[0],t).removeClass(A),x.removeClass(v));l.addClass(A);r.addClass(v);n.edittype||(n.edittype="text");r=n.edittype;try{m=b.unformat.call(d,l,{rowId:q,colModel:n},c)}catch(B){m="textarea"===r?l.text():l.html()}g.autoEncodeOnEdit&&(m=u.oldDecodePostedData(m));y.push({id:a,
ic:c,name:h,v:m});if("&nbsp;"===m||"&#160;"===m||1===m.length&&160===m.charCodeAt(0))m="";b.isFunction(g.formatCell)&&(t=g.formatCell.call(d,q,h,m,a,c),void 0!==t&&(m=t));O.call(d,"beforeEditCell",q,h,m,a,c);n=b.extend({},n.editoptions||{},{id:a+"_"+h,name:h,rowId:q,mode:"cell",cm:n,iCol:c});var E=u.createEl.call(d,r,n,m,!0,b.extend({},u.ajaxOptions,g.ajaxSelectOptions||{})),r=l;(t=!0===g.treeGrid&&h===g.ExpandColumn)&&(r=l.children("span.cell-wrapperleaf,span.cell-wrapper"));r.html("").append(E).attr("tabindex",
"0");t&&b(E).width(l.width()-l.children("div.tree-wrap").outerWidth());u.bindEv.call(d,E,n);setTimeout(function(){b(E).focus()},1);b("input, select, textarea",l).bind("keydown",function(e){27===e.keyCode&&(0<b("input.hasDatepicker",l).length?b(".ui-datepicker").is(":hidden")?f.jqGrid("restoreCell",a,c):b("input.hasDatepicker",l).datepicker("hide"):f.jqGrid("restoreCell",a,c));if(13===e.keyCode&&!e.shiftKey)return f.jqGrid("saveCell",a,c),!1;if(9===e.keyCode){if(d.grid.hDiv.loading)return!1;e.shiftKey?
f.jqGrid("prevCell",a,c):f.jqGrid("nextCell",a,c)}e.stopPropagation()});O.call(d,"afterEditCell",q,h,m,a,c);f.triggerHandler("jqGridAfterEditCell",[q,h,m,a,c])}g.iCol=c;g.iRow=a}}}})},saveCell:function(a,c){return this.each(function(){var e=this,d=b(e),f=e.p,g=u.info_dialog,h=u.jqID;if(e.grid&&!0===f.cellEdit){var m=d.jqGrid("getGridRes","errors"),l=m.errcap,n=d.jqGrid("getGridRes","edit").bClose,p=f.savedRow,q=1<=p.length?0:null;if(null!==q){var r=e.rows[a],t=r.id,w=b(r),x=f.colModel[c],y=x.name,
A,v=ya.call(e,r,c),E={},B=u.getEditedValue.call(e,v,x,E);if(B!==p[q].v){A=d.triggerHandler("jqGridBeforeSaveCell",[t,y,B,a,c]);void 0!==A&&(B=A);b.isFunction(f.beforeSaveCell)&&(A=f.beforeSaveCell.call(e,t,y,B,a,c),void 0!==A&&(B=A));var D=u.checkValues.call(e,B,c,void 0,void 0,{oldValue:p[q].v,newValue:B,cmName:y,rowid:t,iCol:c,iRow:a,cm:x,tr:r,td:v,mode:"cell"}),r=x.formatoptions||{};if(null==D||!0===D||!0===D[0]){q=d.triggerHandler("jqGridBeforeSubmitCell",[t,y,B,a,c])||{};b.isFunction(f.beforeSubmitCell)&&
((q=f.beforeSubmitCell.call(e,t,y,B,a,c))||(q={}));0<b("input.hasDatepicker",v).length&&b("input.hasDatepicker",v).datepicker("hide");"date"===x.formatter&&!0!==r.sendFormatted&&(B=b.unformat.date.call(e,B,x));if("remote"===f.cellsubmit)if(f.cellurl){var k={};k[y]=B;var m=f.prmNames,r=m.oper,F=e.grid.hDiv;k[m.id]=u.stripPref(f.idPrefix,t);k[r]=m.editoper;k=b.extend(q,k);f.autoEncodeOnEdit&&b.each(k,function(a,c){b.isFunction(c)||(k[a]=u.oldEncodePostedData(c))});d.jqGrid("progressBar",{method:"show",
loadtype:f.loadui,htmlcontent:u.defaults.savetext||"Saving..."});F.loading=!0;b.ajax(b.extend({url:b.isFunction(f.cellurl)?f.cellurl.call(e,f.cellurl,a,c,t,B,y):f.cellurl,data:u.serializeFeedback.call(e,f.serializeCellData,"jqGridSerializeCellData",k),type:"POST",complete:function(h){d.jqGrid("progressBar",{method:"hide",loadtype:f.loadui});F.loading=!1;if((300>h.status||304===h.status)&&(0!==h.status||4!==h.readyState)){var m=d.triggerHandler("jqGridAfterSubmitCell",[e,h,k.id,y,B,a,c])||[!0,""];
if(null==m||!0===m||!0===m[0]&&b.isFunction(f.afterSubmitCell))m=f.afterSubmitCell.call(e,h,k.id,y,B,a,c);null==m||!0===m||!0===m[0]?(d.jqGrid("setCell",t,c,B,!1,!1,!0),v.addClass("dirty-cell"),w.addClass("edited"),O.call(e,"afterSaveCell",t,y,B,a,c),p.splice(0,1)):(g.call(e,l,m[1],n),d.jqGrid("restoreCell",a,c))}},error:function(k,m,p){b("#lui_"+h(f.id)).hide();F.loading=!1;d.triggerHandler("jqGridErrorCell",[k,m,p]);b.isFunction(f.errorCell)?f.errorCell.call(e,k,m,p):g.call(e,l,k.status+" : "+k.statusText+
"<br/>"+m,n);d.jqGrid("restoreCell",a,c)}},u.ajaxOptions,f.ajaxCellOptions||{}))}else try{g.call(e,l,m.nourl,n),d.jqGrid("restoreCell",a,c)}catch(I){}"clientArray"===f.cellsubmit&&(d.jqGrid("setCell",t,c,"select"===x.edittype&&"select"!==x.formatter?E.text:B,!1,!1,!0),v.addClass("dirty-cell"),w.addClass("edited"),O.call(e,"afterSaveCell",t,y,B,a,c),p.splice(0,1))}else try{setTimeout(function(){g.call(e,l,B+" "+D[1],n)},100),d.jqGrid("restoreCell",a,c)}catch(I){}}else d.jqGrid("restoreCell",a,c)}setTimeout(function(){b("#"+
...
"aria-labelledby":a.modalhead,"aria-hidden":"true"});void 0===e.drag&&(e.drag=!0);void 0===e.resize&&(e.resize=!0);if(e.drag)if(b.fn.jqDrag)b(r).css("cursor","move"),b(l).jqDrag(r);else try{b(l).draggable({handle:b("#"+m(r.id))})}catch(y){}if(e.resize)if(b.fn.jqResize)b(p).append("<div class='jqResize ui-resizable-handle ui-resizable-se "+e.resizingRightBottomIcon+"'></div>"),b(n).jqResize(".jqResize",q);else try{b(l).resizable({handles:"se, sw",alsoResize:q})}catch(y){}!0===e.closeOnEscape&&b(l).keydown(function(a){27===
...
d){-1===b.inArray(c,e)&&b(a).attr(c,d)});c.hasOwnProperty("id")||b(a).attr("id",u.randId())}var h="",m=this,l=m.p,n=u.info_dialog,p=la.call(b(m),"errors.errcap"),q=la.call(b(m),"edit"),r=q.msg,q=q.bClose;if(null==c)return"";switch(a){case "textarea":h=document.createElement("textarea");d?c.cols||b(h).css({width:"100%","box-sizing":"border-box"}):c.cols||(c.cols=19);c.rows||(c.rows=2);if("&nbsp;"===e||"&#160;"===e||1===e.length&&160===e.charCodeAt(0))e="";h.value=e;g(h,c);b(h).attr({role:"textbox"});
...
b.inArray(b.trim(b(this).text()),e)&&(this.selected="selected")});u.fullBoolFeedback.call(m,n.selectFilled,"jqGridSelectFilled",{elem:f,options:n,cm:h,cmName:null!=h?h.name:n.name,iCol:l})},0))}},f||{}))}else if(c.value){"function"===typeof c.value&&(c.value=c.value());var y;f=[];l=void 0===c.separator?":":c.separator;p=void 0===c.delimiter?";":c.delimiter;n=function(b,a){if(0<a)return b};if("string"===typeof c.value)for(p=c.value.split(p),y=0;y<p.length;y++)r=p[y].split(l),2<r.length&&(r[1]=b.map(r,
n).join(l)),f.push({value:r[0],innerHtml:r[1],selectValue:b.trim(r[0]),selectText:b.trim(r[1])});else if("object"===typeof c.value)for(y in l=c.value,l)l.hasOwnProperty(y)&&f.push({value:y,innerHtml:l[y],selectValue:b.trim(y),selectText:b.trim(l[y])});for(y=0;y<f.length;y++)l=f[y],x=document.createElement("option"),x.value=l.value,x.innerHTML=l.innerHtml,h.appendChild(x),d||l.selectValue!==b.trim(e)||(x.selected="selected",t=!0),d&&-1<b.inArray(l.selectValue,a)&&(x.selected="selected",t=!0);if(!t)for(y=
0;y<f.length;y++)l=f[y],d||l.selectText!==b.trim(e)||(x.selected="selected"),d&&-1<b.inArray(l.selectText,a)&&(x.selected="selected");g(h,c,["value"]);u.fullBoolFeedback.call(m,c.selectFilled,"jqGridSelectFilled",{elem:h,options:c,cm:c.cm,cmName:null!=c.cm?c.cm.name:c.name,iCol:c.iCol})}break;case "text":case "password":case "button":t="button"===a?"button":"textbox";h=document.createElement("input");h.type=a;g(h,c);h.value=e;"button"!==a&&(d?c.size||b(h).css({width:"100%","box-sizing":"border-box"}):
...
p=function(b){return la.call(d,b)},q=p("errors.errcap"),r=p("edit.bClose"),t=p("edit.msg"),w=N.call(c,"states.hover"),x=N.call(c,"states.select"),y=N.call(c,"filterToolbar.dataField"),A,v=function(b){var a="gs_";switch(l.idMode){case "compatibility":a+=f.idPrefix;break;case "new":a+=f.id+"_"}return a+b},E=function(a){var c=f.postData.filters,d={},e,g=f.iColByName,k,h;if(a)for(a=0;a<n.length;a++)k=n[a],!1!==k.search&&(h=k.searchoptions||{},d[k.name]={op:h.sopt?h.sopt[0]:"select"===k.stype?"eq":l.defaultSearch,
...
e=b(this).data("oper");d.triggerHandler("jqGridToolbarSelectOper",[c,e,a]);b("#sopt_menu").hide();b(a).text(e).data("soper",c);!0===l.autosearch&&(e=b(a).parent().next().children()[0],(b(e).val()||"nu"===c||"nn"===c)&&B())})}},I,H=b("<tr></tr>",{"class":"ui-search-toolbar",role:"row"});l.loadFilterDefaults&&(A=E()||{});b.each(n,function(a){var d,e;e="";var m,n,x=this.searchoptions||{},F=this.editoptions||{},E=b("<th></th>",{"class":N.call(c,"colHeaders","ui-th-column ui-th-"+f.direction+" "+(l.applyLabelClasses?
this.labelClasses||"":""))}),C=b("<div></div>"),G=b("<table class='ui-search-table'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear' style='width:1px'></td></tr></table>");!0===this.hidden&&b(E).css("display","none");this.search=!1===this.search?!1:!0;void 0===this.stype&&(this.stype="text");d=b.extend({mode:"filter"},x);if(this.search){if(l.searchOperators){e=f.search&&null!=A[this.name]?A[this.name].op:d.sopt?d.sopt[0]:"select"===this.stype?"eq":l.defaultSearch;
...
success:function(b,a,e){a=this.cm;var f=this.iCol,k=this.options,h=this.stbl.find(">tbody>tr>td.ui-search-input");void 0!==k.buildSelect?(b=k.buildSelect.call(c,b,e,a,f))&&h.append(b):h.append(b);b=h.children("select");0===b.find("option[value='']").length&&"string"===typeof d.noFilterText&&(J=document.createElement("option"),J.value="",J.innerHTML=d.noFilterText,b.prepend(J));void 0!==k.defaultValue&&b.val(k.defaultValue);b.attr({name:a.index||a.name,id:v(a.name)});k.attr&&b.attr(k.attr);b.addClass(y);
b.css({width:"100%"});g.call(c,b[0],k);u.fullBoolFeedback.call(c,k.selectFilled,"jqGridSelectFilled",{elem:b[0],options:k,cm:a,cmName:a.name,iCol:f,mode:"filter"});!0===l.autosearch&&b.change(function(){B();return!1})}},u.ajaxOptions,f.ajaxSelectOptions||{}));else{var T,Z,U;this.searchoptions?(T=void 0===x.value?F.value||"":x.value,Z=void 0===x.separator?F.separator||":":x.separator,U=void 0===x.delimiter?F.delimiter||";":x.delimiter):this.editoptions&&(T=void 0===F.value?"":F.value,Z=void 0===F.separator?
":":F.separator,U=void 0===F.delimiter?";":F.delimiter);if(T){x=document.createElement("select");x.style.width="100%";b(x).attr({name:this.index||this.name,id:v(this.name)});var J,X,ia;if("string"===typeof T)for(e=T.split(U),U=0;U<e.length;U++)T=e[U].split(Z),J=document.createElement("option"),J.value=T[0],""===T[0]&&(ia=!0),J.innerHTML=T[1],x.appendChild(J);else if("object"===typeof T)for(X in T)T.hasOwnProperty(X)&&(J=document.createElement("option"),J.value=X,""===X&&(ia=!0),J.innerHTML=T[X],x.appendChild(J));
ia||"string"!==typeof d.noFilterText||(J=document.createElement("option"),J.value="",J.innerHTML=d.noFilterText,b(x).prepend(J));void 0!==d.defaultValue&&b(x).val(d.defaultValue);d.attr&&b(x).attr(d.attr);b(x).addClass(y);b(C).append(G);g.call(c,x,d);b("td",G).eq(1).append(x);u.fullBoolFeedback.call(c,d.selectFilled,"jqGridSelectFilled",{elem:x,options:this.searchoptions||F,cm:this,cmName:this.name,iCol:a,mode:"filter"});!0===l.autosearch&&b(x).change(function(){B();return!1})}}break;case "text":a=
void 0!==d.defaultValue?d.defaultValue:"";b("td",G).eq(1).append("<input type='text' class='"+y+"' name='"+(this.index||this.name)+"' id='"+v(this.name)+"' value='"+a+"'/>");b(C).append(G);d.attr&&b("input",C).attr(d.attr);g.call(c,b("input",C)[0],d);!0===l.autosearch&&(l.searchOnEnter?b("input",C).keypress(function(b){return 13===(b.charCode||b.keyCode||0)?(B(),!1):this}):b("input",C).keydown(function(b){switch(b.which){case 13:return!1;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;
default:I&&clearTimeout(I),I=setTimeout(function(){B()},l.autosearchDelay)}}));break;case "custom":b("td",G).eq(1).append("<span style='width:100%;padding:0;box-sizing:border-box;' class='"+y+"' name='"+(this.index||this.name)+"' id='"+v(this.name)+"'/>");b(C).append(G);try{if(b.isFunction(d.custom_element)){var qa=d.custom_element.call(c,void 0!==d.defaultValue?d.defaultValue:"",d);if(qa)qa=b(qa).addClass("customelement"),b(C).find("span[name='"+(this.index||this.name)+"']").append(qa);else throw"e2";
}else throw"e1";}catch(ra){"e1"===ra&&h.call(c,q,"function 'custom_element' "+t.nodefined,r),"e2"===ra?h.call(c,q,"function 'custom_element' "+t.novalue,r):h.call(c,q,"string"===typeof ra?ra:ra.message,r)}}}b(E).append(C);b(E).find(".ui-search-oper .soptclass,.ui-search-clear .clearsearchclass").hover(function(){b(this).addClass(w)},function(){b(this).removeClass(w)});b(H).append(E);l.searchOperators||b("td",G).eq(0).hide()});b(e.hDiv).find(">div>.ui-jqgrid-htable>thead").append(H);l.searchOperators&&
...
m&&b(this).remove())})});var t=-1,u=-1,x,y;b(h).filter(".jqg-second-row-header").children("th").each(function(){x=parseInt(b(this).attr("colspan")||1,10);y=parseInt(b(this).attr("rowspan")||1,10);1<y?(t++,u++):x&&(t+=x,u++);if(t===m)return!1});t!==m&&(u=m);b(h).filter(".jqg-second-row-header,.ui-search-toolbar").each(function(){b(this).children(":gt("+u+")").remove()})}else b(h).each(function(){b(this).children(":gt("+m+")").remove()});b(f).width(1);b(d.fhDiv).append(f).mousemove(function(b){if(d.resizing)return d.dragMove(b),
...
if(!0===e.hoverrows){var h=function(a,c,d){b(a)[c](q);b(d[a.rowIndex])[c](q)};b(f).filter(".jqgrow").hover(function(){h(this,"addClass",g)},function(){h(this,"removeClass",g)});b(g).filter(".jqgrow").hover(function(){h(this,"addClass",f)},function(){h(this,"removeClass",f)})}E(d.fhDiv,d.hDiv,0,-1);E(d.fbDiv,d.bDiv,0,-1);d.sDiv&&E(d.fsDiv,d.sDiv,0,-1)});var D=function(a){b(d.fbDiv).scrollTop(b(d.bDiv).scrollTop());a.header.resizeDiv&&E(d.fhDiv,d.hDiv,a.header.iRowStart,a.header.iRowEnd);a.body.resizeDiv&&
...
b("<tr></tr>"),h,r,k,t="",w;g.append("<td class='first'></td>");var H=b("<td class='columns'></td>");g.append(H);var L=b("<select class='"+n("searchDialog.label","selectLabel")+"'></select>"),K,Q=[];H.append(L);L.bind("change",function(){a.field=b(L).val();var c=b(this).parents("tr:first"),d,g;for(g=0;g<e.p.columns.length;g++)if(e.p.columns[g].name===a.field){d=e.p.columns[g];break}if(d){var h=b.extend({},d.editoptions||{},d.searchoptions||{},q(d.cmName),{id:u.randId(),name:d.name,mode:"search"});
m&&"text"===d.inputtype&&!h.size&&(h.size=10);var k=u.createEl.call(f,d.inputtype,h,"",!0,e.p.ajaxSelectOptions||{},!0);b(k).addClass(n("searchDialog.elem","input-elm"));r=h.sopt?h.sopt:e.p.sopt?e.p.sopt:-1!==b.inArray(d.searchtype,e.p.strarr)?e.p.stropts:e.p.numopts;d="";var l=0,p,t;Q=[];b.each(e.p.ops,function(){Q.push(this.oper)});e.p.cops&&b.each(e.p.cops,function(b){Q.push(b)});for(g=0;g<r.length;g++)t=r[g],K=b.inArray(r[g],Q),-1!==K&&(p=e.p.ops[K],p=void 0!==p?p.text:e.p.cops[t].text,0===l&&
...
(e="OR"===c.groupOp?e+" || ":e+" && ");var f=c.rules[d];if(a.p.errorcheck){for(var g=void 0,h=void 0,g=0;g<a.p.columns.length;g++)if(a.p.columns[g].name===f.field){h=a.p.columns[g];break}h&&w(f.data,h)}e+=f.op+"(item."+f.field+",'"+f.data+"')"}e+=")";return"()"===e?"":e}var a=this;return b(d.filter)};this.reDraw();if(d.showQuery)this.onchange();this.filter=!0}}})};b.extend(b.fn.jqFilter,{toSQLString:function(){var b="";this.each(function(){b=this.toUserFriendlyString()});return b},filterData:function(){var b;
...
n="#"+G(l.themodal),p=f.gBox,q=f.gView,r=b.each,t=f.postData[g.sFilter],w=function(){var a=b.makeArray(arguments);a.unshift("Search");a.unshift("Filter");a.unshift(g);return Ra.apply(e,a)},x=function(){u.hideModal(n,{gb:p,jqm:g.jqModal,onClose:g.onClose,removemodal:g.removemodal})};"string"===typeof t&&(t=""!==b.trim(t)?b.parseJSON(t):void 0);b(n).remove();if(void 0!==b(n)[0])c(b("#fbox_"+f.idSel));else{var y=b("<div><div id='"+h+"' class='"+N.call(e,"dialog.body","searchFilter")+"' style='overflow:auto'></div></div>").insertBefore(q);
"rtl"===f.direction&&y.attr("dir","rtl");var A="",v="",E,B=!1,D,k=-1,F=b.extend([],f.colModel);D=da.call(e,h+"_search",g.Find,xa(m,g.findDialogIcon),"right");var I=da.call(e,h+"_reset",g.Reset,xa(m,g.resetDialogIcon),"left");g.showQuery&&(A=da.call(e,h+"_query","Query",xa(m,g.queryDialogIcon),"left")+"&#160;");g.searchForAdditionalProperties&&r(f.additionalProperties,function(){var b="string"===typeof this?{name:this}:this;b.label||(b.label=b.name);b.isAddProp=!0;F.push(b)});g.columns.length?(F=g.columns,
k=0,E=F[0].index||F[0].name):r(F,function(b,a){a.label||(a.label=a.isAddProp?a.name:f.colNames[b]);if(!B){var c=void 0===a.search?!0:a.search,d=!0===a.hidden;if(a.searchoptions&&!0===a.searchoptions.searchhidden&&c||c&&!d)B=!0,E=a.index||a.name,k=b}});if(!t&&E||!1===g.multipleSearch)m="eq",0<=k&&F[k].searchoptions&&F[k].searchoptions.sopt?m=F[k].searchoptions.sopt[0]:g.sopt&&g.sopt.length&&(m=g.sopt[0]),t={groupOp:"AND",rules:[{field:E,op:m,data:""}]};B=!1;g.tmplNames&&g.tmplNames.length&&(B=!0,v=
...
this).html(this.toUserFriendlyString());Da.call(e,g.afterChange,"jqGridFilterAfterChange",b(h),g)},direction:f.direction,id:f.id});y.append(D);B&&g.tmplFilters&&g.tmplFilters.length&&b(".ui-template",y).bind("change",function(){var a=b(this).val();"default"===a?b(h).jqFilter("addFilter",t):b(h).jqFilter("addFilter",g.tmplFilters[parseInt(a,10)]);return!1});!0===g.multipleGroup&&(g.multipleSearch=!0);w("onInitialize",b(h));g.layer?u.createModal.call(e,l,y,g,q,b(p)[0],"#"+G(g.layer),{position:"relative"}):
u.createModal.call(e,l,y,g,q,b(p)[0]);(g.searchOnEnter||g.closeOnEscape)&&b(n).keydown(function(a){var c=b(a.target);if(!(!g.searchOnEnter||13!==a.which||c.hasClass("add-group")||c.hasClass("add-rule")||c.hasClass("delete-group")||c.hasClass("delete-rule")||c.hasClass("fm-button")&&c.is("[id$=_query]")))return b(h+"_search").click(),!1;if(g.closeOnEscape&&27===a.which)return b("#"+G(l.modalhead)).find(".ui-jqdialog-titlebar-close").click(),!1});A&&b(h+"_query").bind("click",function(){b(".queryresult",
y).toggle();return!1});void 0===g.stringResult&&(g.stringResult=g.multipleSearch);b(h+"_search").bind("click",function(){var a={},c="",k,l=b(h);k=l.find(".input-elm");k.filter(":focus")&&(k=k.filter(":focus"));k.change();k=l.jqFilter("filterData");if(g.errorcheck&&(l[0].hideError(),g.showQuery||l.jqFilter("toSQLString"),l[0].p.error))return l[0].showError(),!1;if(g.stringResult||"local"===f.datatype){try{c=window.JSON&&window.JSON.stringify?JSON.stringify(k):La.toJson(k,"","",!1)}catch(m){}"string"===
...
{},c=b(h);f.search=!1;f.resetsearch=!0;!1===g.multipleSearch?a[g.sField]=a[g.sValue]=a[g.sOper]="":a[g.sFilter]="";c[0].resetFilter();B&&b(".ui-template",y).val("default");b.extend(f.postData,a);Da.call(e,g.onReset,"jqGridFilterReset")&&d.trigger("reloadGrid",[b.extend({page:1},g.reloadGridResetOptions||{})]);g.closeAfterReset&&x();return!1});c(b(h));var H=V.call(e,"hover");b(".fm-button:not(."+V.call(e,"disabled").split(" ").join(".")+")",y).hover(function(){b(this).addClass(H)},function(){b(this).removeClass(H)})}}})},
editGridRow:function(a,c){return this.each(function(){function e(){b(k+" > tbody > tr > td .FormElement").each(function(){var a=b(".customelement",this),c=this.name;if(a.length){if(c=a.attr("name"),a=Q[c],void 0!==a&&(a=K[a],a=a.editoptions||{},b.isFunction(a.custom_value))){try{if(z[c]=a.custom_value.call(r,b("#"+G(c),k),"get"),void 0===z[c])throw"e1";}catch(d){"e1"===d?u.info_dialog.call(r,wa,"function 'custom_value' "+v.msg.novalue,v.bClose):u.info_dialog.call(r,wa,d.message,v.bClose)}return!0}}else switch(a=
b(this)[0].type,a){case "checkbox":z[c]=b(this).is(":checked")?b(this).val():b(this).data("offval");break;case "select-one":z[c]=b("option:selected",this).val();break;case "select-multiple":z[c]=b(this).val();z[c]=z[c]?z[c].join(","):"";b("option:selected",this).each(function(a,c){b(c).text()});break;case "date":z[c]=b(this).val();3===String(z[c]).split("-").length&&(a=Q[c],void 0!==a&&(a=K[a],a=a.formatoptions||{},a=a.newformat||y.call(t,"formatter.date.newformat"),z[c]=u.parseDate.call(t[0],"Y-m-d",
z[c],a)));break;default:void 0!==a&&0>b.inArray(a,v.skipPostTypes)&&(z[c]=b(this).val())}});return!0}function d(a,c,d){var e=0,f=[],g=!1,h="",k;for(k=1;k<=d;k++)h+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==a&&(g=C.getInd.call(t,a));b(K).each(function(k){var l=this.name,m,n,p,q,t;m=this.editable;var z=!1,x=!1;t="_empty"===a?"addForm":"editForm";b.isFunction(m)&&(m=m.call(r,{rowid:a,iCol:k,iRow:g,cmName:l,cm:this,mode:t}));q=(this.editrules&&!0===this.editrules.edithidden?
0:!0===this.hidden||"hidden"===m)?"style='display:none'":"";switch(String(m).toLowerCase()){case "hidden":m=!0;break;case "disabled":z=m=!0;break;case "readonly":x=m=!0}if("cb"!==l&&"subgrid"!==l&&!0===m&&"rn"!==l){if(!1===g)p="";else{m=b(r.rows[g].cells[k]);try{p=b.unformat.call(r,m,{rowId:a,colModel:this},k)}catch(F){p=this.edittype&&"textarea"===this.edittype?m.text():m.html()}Ha(p)&&(p="")}m=b.extend({},this.editoptions||{},{id:l,name:l,rowId:a,mode:t,cm:this,iCol:k});var B=b.extend({},{elmprefix:"",
elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),y=parseInt(B.rowpos,10)||e+1,A=parseInt(2*(parseInt(B.colpos,10)||1),10);"_empty"===a&&m.defaultValue&&(p=b.isFunction(m.defaultValue)?m.defaultValue.call(r):m.defaultValue);this.edittype||(this.edittype="text");w.autoEncodeOnEdit&&(p=u.oldDecodePostedData(p));t=u.createEl.call(r,this.edittype,m,p,!1,b.extend({},u.ajaxOptions,w.ajaxSelectOptions||{}));if(v.checkOnSubmit||v.checkOnUpdate)v._savedData[l]=p;b(t).addClass("FormElement");-1<
b.inArray(this.edittype,["text","textarea","checkbox","password","select"])&&b(t).addClass(N.call(r,"dialog.dataField"));n=b(c).find("tr[data-rowpos="+y+"]");if(B.rowabove){var D=b("<tr><td class='contentinfo' colspan='"+2*d+"'>"+B.rowcontent+"</td></tr>");b(c).append(D);D[0].rp=y}0===n.length&&(n=b("<tr "+q+" data-rowpos='"+y+"'></tr>").addClass("FormData").attr("id","tr_"+l),b(n).append(h),b(c).append(n),n[0].rp=y);q=b("td:eq("+(A-2)+")",n[0]);n=b("td:eq("+(A-1)+")",n[0]);q.html(void 0===B.label?
w.colNames[k]:B.label||"&#160;");n[Ha(n.html())?"html":"append"](B.elmprefix).append(t).append(B.elmsuffix);z?(q.addClass(U),n.addClass(U),b(t).prop("readonly",!0),b(t).prop("disabled",!0)):x&&b(t).prop("readonly",!0);"custom"===this.edittype&&b.isFunction(m.custom_value)&&m.custom_value.call(r,b("#"+G(l),E),"set",p);u.bindEv.call(r,t,m);f[e]=k;e++}});0<e&&(k=b("<tr class='FormData' style='display:none'><td class='CaptionTD'>&#160;</td><td colspan='"+(2*d-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+
...
f=z[e];"date"!==d.formatter||null!=d.formatoptions&&!0===d.formatoptions.sendFormatted||(z[e]=b.unformat.date.call(r,f,d));"clientArray"!==a&&d.editoptions&&!0===d.editoptions.NullIfEmpty&&z.hasOwnProperty(e)&&""===f&&(z[e]="null")})}function h(){var c=[!0,"",""],d=c,e={},h=w.prmNames,l,m,n,p,q,B,y=C.getInd.call(t,a),D=!1===y?null:r.rows[y];(B=t.triggerHandler("jqGridAddEditBeforeCheckValues",[b(E),M]))&&"object"===typeof B&&(z=B);y=!1===y?-1:y;b.isFunction(v.beforeCheckValues)&&(B=v.beforeCheckValues.call(r,
z,b(E),M))&&"object"===typeof B&&(z=B);for(n in z)if(z.hasOwnProperty(n)){B=w.iColByName[n];d=u.checkValues.call(r,z[n],n,void 0,void 0,{oldValue:"_empty"===a?null:C.getCell.call(t,a,B),newValue:z[n],cmName:n,rowid:a,cm:K[B],iCol:B,iRow:y,tr:D,td:null==D?null:D.cells[B],mode:"_empty"===a?"addForm":"editForm"});if(null==d||!0===d)d=c;if(!1===d[0])break}g();if(d[0]){e=t.triggerHandler("jqGridAddEditClickSubmit",[v,z,M]);void 0===e&&b.isFunction(v.onclickSubmit)&&(e=v.onclickSubmit.call(r,v,z,M)||{});
d=t.triggerHandler("jqGridAddEditBeforeSubmit",[z,b(E),M]);if(null==d||!0===d)d=c;d[0]&&b.isFunction(v.beforeSubmit)&&(d=v.beforeSubmit.call(r,z,b(E),M),null==d||!0===d)&&(d=c)}if(d[0]&&!v.processing){v.processing=!0;b("#sData",F).addClass(X);n=v.url||w.editurl;m=h.oper;l="clientArray"===n&&!1!==w.keyName?w.keyName:h.id;z[m]="_empty"===b.trim(z[x+"_id"])?h.addoper:h.editoper;z[m]!==h.addoper?z[l]=z[x+"_id"]:void 0===z[l]&&(z[l]=z[x+"_id"]);delete z[x+"_id"];z=b.extend(z,v.editData,e);if(!0===w.treeGrid)for(q in z[m]===
...
b.isFunction(v.serializeEditData)?v.serializeEditData:w.serializeEditData,"jqGridAddEditSerializeEditData",z),complete:function(a,e){b("#sData",F).removeClass(X);z[l]=b("#id_g",k).val();if(300<=a.status&&304!==a.status||0===a.status&&4===a.readyState)d[0]=!1,d[1]=t.triggerHandler("jqGridAddEditErrorTextFormat",[a,M]),b.isFunction(v.errorTextFormat)?d[1]=v.errorTextFormat.call(r,a,M):d[1]=e+" Status: '"+a.statusText+"'. Error code: "+a.status;else{d=t.triggerHandler("jqGridAddEditAfterSubmit",[a,z,
...
d[2],p,z):C.addRowData.call(t,d[2],z,v.addedrow),v.closeAfterAdd?(!0!==w.treeGrid&&A.call(t,d[2]),ea()):v.clearAfterAdd&&f("_empty",E)):(v.reloadAfterSubmit?(t.trigger("reloadGrid",g),v.closeAfterEdit||setTimeout(function(){A.call(t,z[l])},1E3)):!0===w.treeGrid?C.setTreeRow.call(t,z[l],z):C.setRowData.call(t,z[l],z),v.closeAfterEdit&&ea());if(b.isFunction(v.afterComplete)){var n=a;setTimeout(function(){t.triggerHandler("jqGridAddEditAfterComplete",[n,z,b(E),M]);v.afterComplete.call(r,n,z,b(E),M);
n=null},50)}if(v.checkOnSubmit||v.checkOnUpdate)if(b(E).data("disabled",!1),"_empty"!==v._savedData[x+"_id"])for(var q in v._savedData)v._savedData.hasOwnProperty(q)&&z[q]&&(v._savedData[q]=z[q])}v.processing=!1;try{b(":input:visible",E)[0].focus()}catch(B){}}},u.ajaxOptions,v.ajaxEditOptions);q.url||v.useDataProxy||(b.isFunction(w.dataProxy)?v.useDataProxy=!0:(d[0]=!1,d[1]+=" "+u.errors.nourl));d[0]&&(v.useDataProxy?(e=w.dataProxy.call(r,q,"set_"+x),void 0===e&&(e=[!0,""]),!1===e[0]?(d[0]=!1,d[1]=
e[1]||"Error deleting the selected row!"):(q.data.oper===h.addoper&&v.closeAfterAdd&&ea(),q.data.oper===h.editoper&&v.closeAfterEdit&&ea())):"clientArray"===q.url?(v.reloadAfterSubmit=!1,z=q.data,q.complete({status:200,statusText:""},"")):b.ajax(q))}!1===d[0]&&(b("#FormError>td",k).html(d[1]),b("#FormError",k).show())}function m(b,a){var c=!1,d;for(d in b)if(b.hasOwnProperty(d)&&String(b[d])!==String(a[d])){c=!0;break}return c}function l(){var a=!0;b("#FormError",k).hide();v.checkOnUpdate&&(z={},
e(),J=m(z,v._savedData))&&(b(E).data("disabled",!0),b(".confirm",H).show(),a=!1);return a}function n(){var c=u.detectRowEditing.call(r,a);if(null!=c)if("inlineEditing"===c.mode)C.restoreRow.call(t,a);else{var c=c.savedRow,d=r.rows[c.id];C.restoreCell.call(t,c.id,c.ic);b(d.cells[c.ic]).removeClass("edit-cell "+O);b(d).addClass(O).attr({"aria-selected":"true",tabindex:"0"})}}function p(a,c){var d=c[1].length-1;0===a?b("#pData",F).addClass(U):void 0!==c[1][a-1]&&ca(b("#"+G(c[1][a-1])),U)?b("#pData",
F).addClass(U):b("#pData",F).removeClass(U);a===d?b("#nData",F).addClass(U):void 0!==c[1][a+1]&&ca(b("#"+G(c[1][a+1])),U)?b("#nData",F).addClass(U):b("#nData",F).removeClass(U)}function q(){var a=C.getDataIDs.call(t),c=b("#id_g",k).val();return[b.inArray(c,a),a]}var r=this,t=b(r),w=r.p;if(r.grid&&null!=w&&a){var x=w.id,y=C.getGridRes,A=C.setSelection,v=b.extend(!0,{top:0,left:0,width:300,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,url:null,mtype:"POST",clearAfterAdd:!0,closeAfterEdit:!1,
...
removemodal:!0,skipPostTypes:["image","file"]},y.call(t,"edit"),u.edit,w.formEditing||{},c||{}),E="FrmGrid_"+x,B=E,D="TblGrid_"+x,k="#"+G(D),F=k+"_2",I={themodal:"editmod"+x,modalhead:"edithd"+x,modalcontent:"editcnt"+x,resizeAlso:E},H="#"+G(I.themodal),L=w.gBox,K=w.colModel,Q=w.iColByName,ba=1,R=0,z,J,M,W=v.commonIconClass,ea=function(){u.hideModal(H,{gb:L,jqm:v.jqModal,onClose:v.onClose,removemodal:v.removemodal})},wa=y.call(t,"errors.errcap"),T=function(){var a=b.makeArray(arguments);a.unshift("");
a.unshift("AddEdit");a.unshift(v);return Ra.apply(r,a)},Z=V.call(r,"hover"),U=V.call(r,"disabled"),O=V.call(r,"select"),X=V.call(r,"active"),ia=V.call(r,"error");b(H).remove();E="#"+G(E);"new"===a?(a="_empty",M="add",v.caption=v.addCaption):(v.caption=v.editCaption,M="edit");var qa=!0;!v.checkOnUpdate||!0!==v.jqModal&&void 0!==v.jqModal||v.modal||(qa=!1);var ra=isNaN(v.dataheight)?v.dataheight:v.dataheight+"px",Fa=isNaN(v.datawidth)?v.datawidth:v.datawidth+"px",B=b("<form name='FormPost' id='"+B+
"' class='FormGrid' onSubmit='return false;' style='width:"+Fa+";overflow:auto;position:relative;height:"+ra+";'></form>").data("disabled",!1),S=b("<table id='"+D+"' class='EditTable'><tbody></tbody></table>");b(K).each(function(){var b=this.formoptions;ba=Math.max(ba,b?b.colpos||0:0);R=Math.max(R,b?b.rowpos||0:0)});b(B).append(S);ia=b("<tr id='FormError' style='display:none'><td class='"+ia+"' colspan='"+2*ba+"'>&#160;</td></tr>");ia[0].rp=0;b(S).append(ia);ia=b("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+
2*ba+"'>"+(v.topinfo||"&#160;")+"</td></tr>");ia[0].rp=0;b(S).append(ia);if(T("beforeInitData",B,M)){n();ra=(ia="rtl"===w.direction?!0:!1)?"nData":"pData";Fa=ia?"pData":"nData";d(a,S,ba);var ra=da.call(r,ra,"",xa(W,v.prevIcon),"","left"),Fa=da.call(r,Fa,"",xa(W,v.nextIcon),"","right"),Ga=da.call(r,"sData",v.bSubmit),cb=da.call(r,"cData",v.bCancel),D="<div class='"+N.call(r,"dialog.footer")+"'><table class='EditTable' id='"+D+"_2'><tbody><tr><td colspan='2'><hr class='"+N.call(r,"dialog.hr")+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton navButton-"+
w.direction+"'>"+(ia?Fa+ra:ra+Fa)+"</td><td class='EditButton EditButton-"+w.direction+"'>"+Ga+"&#160;"+cb+"</td></tr>",D=D+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+(v.bottominfo||"&#160;")+"</td></tr>"),D=D+"</tbody></table></div>";if(0<R){var $a=[];b.each(b(S)[0].rows,function(b,a){$a[b]=a});$a.sort(function(b,a){return b.rp>a.rp?1:b.rp<a.rp?-1:0});b.each($a,function(a,c){b("tbody",S).append(c)})}v.gbox=L;var ib=!1;!0===v.closeOnEscape&&(v.closeOnEscape=!1,ib=
!0);D=b("<div></div>").append(b("<div class='"+N.call(r,"dialog.body")+"'></div>").append(B)).append(D);u.createModal.call(r,I,D,v,w.gView,b(L)[0]);v.topinfo&&b(".tinfo",k).show();v.bottominfo&&b(".binfo",F).show();D=D=null;b(H).keydown(function(a){var c=(a.target.tagName||"").toUpperCase(),d,e;if(!0===b(E).data("disabled"))return!1;if(13===a.which&&"TEXTAREA"!==c){d=b(F).find(":focus");e=d.attr("id");if(0<d.length&&0<=b.inArray(e,["pData","nData","cData"]))return d.trigger("click"),!1;if(!0===v.savekey[0]&&
13===v.savekey[1])return b("#sData",F).trigger("click"),!1}if(!0===v.savekey[0]&&a.which===v.savekey[1]&&"TEXTAREA"!==c)return b("#sData",F).trigger("click"),!1;if(27===a.which){if(!l())return!1;ib&&ea();return!1}if(!0===v.navkeys[0]){if("_empty"===b("#id_g",k).val())return!0;if(a.which===v.navkeys[1])return b("#pData",F).trigger("click"),!1;if(a.which===v.navkeys[2])return b("#nData",F).trigger("click"),!1}});v.checkOnUpdate&&(b("a.ui-jqdialog-titlebar-close span",H).removeClass("jqmClose"),b("a.ui-jqdialog-titlebar-close",
H).unbind("click").click(function(){if(!l())return!1;ea();return!1}));Sa(b("#sData",F),v.saveicon,W);Sa(b("#cData",F),v.closeicon,W);if(v.checkOnSubmit||v.checkOnUpdate)Ga=da.call(r,"sNew",v.bYes),Fa=da.call(r,"nNew",v.bNo),cb=da.call(r,"cNew",v.bExit),I=v.zIndex||999,I++,b("<div class='"+v.overlayClass+" jqgrid-overlay confirm' style='z-index:"+I+";display:none;'>&#160;</div><div class='"+N.call(r,"dialog.content","confirm ui-jqconfirm")+"' style='z-index:"+(I+1)+"'>"+v.saveData+"<br/><br/>"+Ga+
Fa+cb+"</div>").insertAfter(E),b("#sNew",H).click(function(){h();b(E).data("disabled",!1);b(".confirm",H).hide();return!1}),b("#nNew",H).click(function(){b(".confirm",H).hide();b(E).data("disabled",!1);setTimeout(function(){b(":input:visible",E)[0].focus()},0);return!1}),b("#cNew",H).click(function(){b(".confirm",H).hide();b(E).data("disabled",!1);ea();return!1});T("onInitializeForm",b(E),M);"_empty"!==a&&v.viewPagerButtons?b("#pData,#nData",F).show():b("#pData,#nData",F).hide();T("beforeShowForm",
b(E),M);b(H).data("onClose",v.onClose);u.viewModal.call(r,H,{gbox:L,jqm:v.jqModal,overlay:v.overlay,modal:v.modal,overlayClass:v.overlayClass,toTop:v.toTop,onHide:function(b){b.w.remove();b.o&&b.o.remove()}});qa||b("."+G(v.overlayClass)).click(function(){if(!l())return!1;ea();return!1});b(".fm-button",H).hover(function(){b(this).addClass(Z)},function(){b(this).removeClass(Z)});b("#sData",F).click(function(){z={};b("#FormError",k).hide();e();"_empty"===z[x+"_id"]?h():!0===v.checkOnSubmit?(J=m(z,v._savedData))?
(b(E).data("disabled",!0),b(".confirm",H).show()):h():h();return!1});b("#cData",F).click(function(){if(!l())return!1;ea();return!1});b("#nData",F).click(function(){if(!l())return!1;b("#FormError",k).hide();var a=q();a[0]=parseInt(a[0],10);if(-1!==a[0]&&a[1][a[0]+1]){if(!T("onclickPgButtons","next",b(E),a[1][a[0]]))return!1;f(a[1][a[0]+1],E);A.call(t,a[1][a[0]+1]);T("afterclickPgButtons","next",b(E),a[1][a[0]+1]);p(a[0]+1,a)}return!1});b("#pData",F).click(function(){if(!l())return!1;b("#FormError",
k).hide();var a=q();if(-1!==a[0]&&a[1][a[0]-1]){if(!T("onclickPgButtons","prev",b(E),a[1][a[0]])||ca(b("#"+G(a[1][a[0]-1])),U))return!1;f(a[1][a[0]-1],E);A.call(t,a[1][a[0]-1]);T("afterclickPgButtons","prev",b(E),a[1][a[0]-1]);p(a[0]-1,a)}return!1});T("afterShowForm",b(E),M);qa=q();p(qa[0],qa)}}})},viewGridRow:function(a,c){return this.each(function(){function e(){!0!==q.closeOnEscape&&!0!==q.navkeys[0]||setTimeout(function(){b("#cData").focus()},0)}function d(a,c,d){var e,f,g,h=0,k,p,r=[],t=C.getInd.call(l,
a),v;v=N.call(m,"dialog.viewData","DataTD form-view-data");var w=N.call(m,"dialog.viewLabel","CaptionTD form-view-label"),z="<td class='"+w+"' width='"+q.labelswidth+"'>&#160;</td><td class='"+v+" ui-helper-reset'>&#160;</td>",x="",w="<td class='"+w+"'></td><td class='"+v+"'></td>",y=["integer","number","currency"],F=0,D=0,A,E,I;for(v=1;v<=d;v++)x+=1===v?z:w;b(B).each(function(){(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==
b.inArray(this.formatter,y)?F=Math.max(F,parseInt(this.width,10)):D=Math.max(D,parseInt(this.width,10)))});A=0!==F?F:0!==D?D:0;b(B).each(function(a){e=this.name;E=!1;p=(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";I="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==e&&"subgrid"!==e&&"rn"!==e&&I){k=!1===t?"":u.getDataFieldOfCell.call(m,m.rows[t],a).html();E="right"===this.align&&0!==A?!0:!1;var l=b.extend({},{rowabove:!1,rowcontent:""},
...
"view"),u.view||{},n.formViewing||{},c||{}),r="#ViewGrid_"+G(p),t="#ViewTbl_"+G(p),w=t+"_2",x="ViewGrid_"+p,y="ViewTbl_"+p,A=q.commonIconClass,p={themodal:"viewmod"+p,modalhead:"viewhd"+p,modalcontent:"viewcnt"+p,resizeAlso:x},v="#"+G(p.themodal),E=n.gBox,B=n.colModel,D=1,k=0,F=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("View");a.unshift(q);return Ra.apply(m,a)},I=function(){u.hideModal(v,{gb:E,jqm:q.jqModal,onClose:q.onClose,removemodal:q.removemodal})},H=V.call(m,"hover"),L=
V.call(m,"disabled"),K=isNaN(q.dataheight)?q.dataheight:q.dataheight+"px",Q=isNaN(q.datawidth)?q.datawidth:q.datawidth+"px",x=b("<div class='"+N.call(m,"dialog.body")+"'><form name='FormPost' id='"+x+"' class='FormGrid' style='width:"+Q+";overflow:auto;position:relative;height:"+K+";'></form></div>"),K=x.children("form.FormGrid"),ba=b("<table id='"+y+"' class='EditTable'><tbody></tbody></table>");b(v).remove();b(B).each(function(){var b=this.formoptions;D=Math.max(D,b?b.colpos||0:0);k=Math.max(k,
b?b.rowpos||0:0)});K.append(ba);if(F("beforeInitData",K)){d(a,ba,D);var R=(K="rtl"===n.direction?!0:!1)?"pData":"nData",Q=da.call(m,K?"nData":"pData","",xa(A,q.prevIcon),"","left"),R=da.call(m,R,"",xa(A,q.nextIcon),"","right"),z=da.call(m,"cData",q.bClose);if(0<k){var J=[];b.each(b(ba)[0].rows,function(b,a){J[b]=a});J.sort(function(b,a){return b.rp>a.rp?1:b.rp<a.rp?-1:0});b.each(J,function(a,c){b("tbody",ba).append(c)})}q.gbox=E;y=b("<div></div>").append(x).append("<div class='"+N.call(m,"dialog.footer")+
"'><table border='0' class='EditTable' id='"+y+"_2'><tbody><tr id='Act_Buttons'><td class='navButton navButton-"+n.direction+"' width='"+(q.labelswidth||"auto")+"'>"+(K?R+Q:Q+R)+"</td><td class='EditButton EditButton-"+n.direction+"'>"+z+"</td></tr></tbody></table></div>");u.createModal.call(m,p,y,q,n.gView,b(n.gView)[0]);q.viewPagerButtons||b("#pData, #nData",w).hide();y=null;b(v).keydown(function(a){var c,d;if(!0===b(r).data("disabled"))return!1;if(13===a.which&&(c=b(w).find(":focus"),d=c.attr("id"),
...
function(){b(this).removeClass(v)});Sa(b("#dData",l+"_2"),h.delicon,y);Sa(b("#eData",l+"_2"),h.cancelicon,y);b("#dData",l+"_2").click(function(){var a=[!0,""],c,k=b("#DelData>td",l),m=k.text(),t=k.data("rowids"),k={};b.isFunction(h.onclickSubmit)&&(k=h.onclickSubmit.call(e,h,m)||{});b.isFunction(h.beforeSubmit)&&(a=h.beforeSubmit.call(e,m)||a);if(a[0]&&!h.processing){h.processing=!0;q=d.prmNames;n=b.extend({},h.delData,k);r=q.oper;n[r]=q.deloper;p=q.id;m=t.slice();if(!m.length)return!1;for(c in m)m.hasOwnProperty(c)&&
(m[c]=u.stripPref(d.idPrefix,m[c]));n[p]=m.join();b(this).addClass(E);c=h.url||d.editurl;c=b.extend({url:b.isFunction(c)?c.call(e,n[p],n,h):c,type:h.mtype,data:b.isFunction(h.serializeDelData)?h.serializeDelData.call(e,n):n,complete:function(c,g){var k;b("#dData",l+"_2").removeClass(E);300<=c.status&&304!==c.status||0===c.status&&4===c.readyState?(a[0]=!1,b.isFunction(h.errorTextFormat)?a[1]=h.errorTextFormat.call(e,c):a[1]=g+" Status: '"+c.statusText+"'. Error code: "+c.status):b.isFunction(h.afterSubmit)&&
...
{},l.navOptions||{},c||{});q.position=q.position||("rtl"===l.direction?"right":"left");var r,t=l.idSel,w=l.gBox,x=q.commonIconClass,y={themodal:"alertmod_"+p,modalhead:"alerthd_"+p,modalcontent:"alertcnt_"+p},A=function(){return function(){var a=document.documentElement,c=window,d=1024,e=768,f=n.closest(".ui-jqgrid").offset();void 0===b("#"+G(y.themodal))[0]&&(q.alerttop||q.alertleft||(void 0!==c.innerWidth?(d=c.innerWidth,e=c.innerHeight):null!=a&&void 0!==a.clientWidth&&0!==a.clientWidth&&(d=a.clientWidth,
e=a.clientHeight),d=d/2-parseInt(q.alertwidth,10)/2-f.left,e=e/2-25-f.top),u.createModal.call(m,y,"<div class='"+N.call(m,"dialog.body")+"'><div>"+q.alerttext+"</div></div>",{gbox:w,jqModal:q.jqModal,drag:!0,resize:!0,caption:q.alertcap,top:null!=q.alerttop?q.alerttop:e,left:null!=q.alertleft?q.alertleft:d,width:q.alertwidth,height:q.alertheight,closeOnEscape:q.closeOnEscape,zIndex:q.alertzIndex,removemodal:q.removemodal},l.gView,b(w)[0],!1));u.viewModal.call(m,"#"+G(y.themodal),{gbox:w,toTop:q.alertToTop,
jqm:q.jqModal});var g=b("#"+G(y.modalhead)).find(".ui-jqdialog-titlebar-close");g.attr({tabindex:"0",href:"#",role:"button"});setTimeout(function(){g.focus()},50)}}(),v,E=function(a){if(13===a.which&&(a=b(this).find(".ui-pg-button").filter(":focus"),0<a.length)){var c=a[0].id,c=c.substr(0,0<b(this).closest(".ui-jqgrid-toppager").length?c.length-p.length-5:c.length-p.length-1)+"mod"+l.id,d=b(".ui-jqdialog").filter(":visible").map(function(){return this.id});if(0>b.inArray(c,d))return a.trigger("click"),
!1}},B=V.call(m,"hover"),D=V.call(m,"disabled"),k=N.call(m,"navButton","ui-pg-button");if(m.grid){m.modalAlert=A;void 0===a&&(l.pager?(a=l.pager,l.toppager&&(q.cloneToTop=!0)):l.toppager&&(a=l.toppager));var F=1,I,H,L,K,Q,J,R=["left","center","right"],z="<div class='"+N.call(m,"navButton","ui-pg-button "+V.call(m,"disabled"))+"'><span class='ui-separator'></span></div>",O=function(){ca(this,D)||b(this).addClass(B)},M=function(){b(this).removeClass(B)},W=function(){ca(this,D)||(b.isFunction(q.addfunc)?
q.addfunc.call(m):C.editGridRow.call(n,"new",d));return!1},ea=function(a,c,d){if(!ca(this,D)){var e=l.selrow;e?b.isFunction(a)?a.call(m,e):C[c].call(n,e,d):A()}return!1},S=function(){return ea.call(this,q.editfunc,"editGridRow",e)},T=function(){return ea.call(this,q.viewfunc,"viewGridRow",h)},Z=function(){var a;ca(this,D)||(l.multiselect?(a=l.selarrrow,0===a.length&&(a=null)):a=l.selrow,a?b.isFunction(q.delfunc)?q.delfunc.call(m,a):C.delGridRow.call(n,a,f):A());return!1},U=function(){ca(this,D)||
(b.isFunction(q.searchfunc)?q.searchfunc.call(m,g):C.searchGrid.call(n,g));return!1},aa=function(){if(!ca(this,D)){b.isFunction(q.beforeRefresh)&&q.beforeRefresh.call(m);l.search=!1;l.resetsearch=!0;try{if("currentfilter"!==q.refreshstate){l.postData.filters="";try{b("#fbox_"+t).jqFilter("resetFilter")}catch(a){}b.isFunction(m.clearToolbar)&&m.clearToolbar(!1)}}catch(a){}switch(q.refreshstate){case "firstpage":n.trigger("reloadGrid",[b.extend({},q.reloadGridOptions||{},{page:1})]);break;case "current":case "currentfilter":n.trigger("reloadGrid",
...
"title"]||"",id:c||a+"_"+L}).click(d).hover(O,M);return e};q.cloneToTop&&l.toppager&&(F=2);for(I=0;I<F;I++){v=b("<div class='ui-pg-table navtable' role='toolbar' style='float:"+("rtl"===l.direction?"right":"left")+";table-layout:auto;'></div>");0===I?(H=a,L=p,H===l.toppager&&(L+="_top",F=1)):(H=l.toppager,L=p+"_top");q.add&&X("add",d.id,W);q.edit&&X("edit",e.id,S);q.view&&X("view",h.id,T);q.del&&X("del",f.id,Z);(q.add||q.edit||q.del||q.view)&&b(v).append(z);q.search&&(r=X("search",g.id,U),g.showOnLoad&&
!0===g.showOnLoad&&b(r,v).click());q.refresh&&X("refresh","",aa);r=b(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px";b("body").append("<div id='testpg2' class='"+N.call(m,"gBox","ui-jqgrid")+"' style='font-size:"+r+";visibility:hidden;' ></div>");r=b(v).clone().appendTo("#testpg2").width();b("#testpg2").remove();b(H+"_"+q.position,H).append(v);if(q.hideEmptyPagerParts)for(K=0;K<R.length;K++)R[K]!==q.position&&(J=b(H+"_"+R[K],H),0===J.length||0===J[0].childNodes.length?J.hide():1===J[0].childNodes.length&&
(Q=J[0].firstChild,!b(Q).is("table.ui-pg-table")||0!==Q.rows&&0!==Q.rows[0].cells.length||J.hide()));l._nvtd&&(r>l._nvtd[0]&&(b(H+"_"+q.position,H).width(r),l._nvtd[0]=r),l._nvtd[1]=r);m.nav=!0;v.bind("keydown.jqGrid",E)}n.triggerHandler("jqGridResetFrozenHeights")}}})},navButtonAdd:function(a,c){"object"===typeof a&&(c=a,a=void 0);return this.each(function(){var e=this,d=e.p;if(e.grid){var f=b.extend({caption:"newButton",title:"",onClickButton:null,position:"last",cursor:"pointer",iconsOverText:!1},
...
"object"===typeof q||(b.isArray(h)&&b.isFunction(h[l])?h[l].call(this,g[l],q,l,e):g[l]===q)?r?(d.push(n),g[l]=q,f[l]=p):(p=f[l],p.cnt+=1,d[p.pos].cnt=p.cnt):(d.push(n),g[l]=q,r=!0,f[l]=p));q=d[p.pos];for(var u=void 0,x=void 0,y=void 0,u=0;u<p.summary.length;u++)x=p.summary[u],y=b.isArray(x.st)?x.st[n.idx]:x.st,b.isFunction(y)?x.v=y.call(this,x.v,x.nm,a,n):(x.v=t.call(b(this),y,x.v,x.nm,x.sr,x.srt,a),"avg"===y.toLowerCase()&&x.sd&&(x.vd=t.call(b(this),y,x.vd,x.sd,x.sr,x.srt,a)));q.summary=p.summary}});
...
n));return this.each(function(){var c=this,d=b(c),e=c.p,f=0,g=null,h={},l=e.colModel,m=e.prmNames;if(c.grid){var n=b.extend(!0,{keys:!1,oneditfunc:null,successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,beforeEditRow:null,mtype:"POST",focusField:!0},u.inlineEdit,e.inlineEditing||{},p),q=d.jqGrid("getInd",a,!0),k=n.focusField,F="object"===typeof k&&null!=k?b(k.target||k).closest("tr.jqgrow>td")[0]:null;if(!1!==q&&(n.extraparam[m.oper]===
m.addoper||Xa.call(c,n,"beforeEditRow",n,a))&&"0"===(b(q).attr("editable")||"0")&&!b(q).hasClass("not-editable-row")){m=u.detectRowEditing.call(c,a);if(null!=m&&"cellEditing"===m.mode){var m=m.savedRow,I=c.rows[m.id],H=V.call(c,"select");d.jqGrid("restoreCell",m.id,m.ic);b(I.cells[m.ic]).removeClass("edit-cell "+H);b(I).addClass(H).attr({"aria-selected":"true",tabindex:"0"})}u.enumEditableCells.call(c,q,b(q).hasClass("jqgrid-new-row")?"add":"edit",function(d){var k=d.cm,l=b(d.dataElement),m=d.dataWidth,
...
g),b.isFunction(h)&&(n.afterrestorefunc=h),b.isFunction(m)&&(n.beforeSaveRow=m));var l=function(b){return q.jqGrid("getGridRes",b)},n=b.extend(!0,{successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,beforeSaveRow:null,ajaxSaveOptions:{},serializeSaveData:null,mtype:"POST",saveui:"enable",savetext:l("defaults.savetext")||"Saving..."},u.inlineEdit,r.inlineEditing||{},n),w={},x={},y={},A,v,E,B;E=q.jqGrid("getInd",a,!0);var D=b(E);A=r.prmNames;
var k=l("errors.errcap"),F=l("edit.bClose"),I;if(!1!==E&&(l=n.extraparam[A.oper]===A.addoper?"add":"edit",Xa.call(p,n,"beforeSaveRow",n,a,l)&&(A=D.attr("editable"),n.url=n.url||r.editurl,I="clientArray"!==n.url,"1"===A)))if(u.enumEditableCells.call(p,E,D.hasClass("jqgrid-new-row")?"add":"edit",function(c){var d=c.cm,e=d.formatter,f=d.editoptions||{},g=d.formatoptions||{},h={},k=(b.jgrid.detectRowEditing.call(p,a)||{}).savedRow,l=u.getEditedValue.call(p,b(c.dataElement),d,h,c.editable);"select"===
d.edittype&&"select"!==d.formatter&&(x[d.name]=h.text);B=u.checkValues.call(p,l,c.iCol,void 0,void 0,b.extend(c,{oldValue:null!=k?k[d.name]:null,newValue:l,oldRowData:k}));if(null!=B&&!1===B[0])return!1;"date"===e&&!0!==g.sendFormatted&&(l=b.unformat.date.call(p,l,d));I&&!0===f.NullIfEmpty&&""===l&&(l="null");w[d.name]=l}),null!=B&&!1===B[0])try{var H=q.jqGrid("getGridRowById",a),C=u.findPos(H);t.call(p,k,B[1],F,{left:C[0],top:C[1]+b(H).outerHeight()})}catch(G){alert(B[1])}else if(H=a,A=r.prmNames,
C=!1===r.keyName?A.id:r.keyName,w&&(w[A.oper]=A.editoper,void 0===w[C]||""===w[C]?w[C]=a:E.id!==r.idPrefix+w[C]&&(E=u.stripPref(r.idPrefix,a),void 0!==r._index[E]&&(r._index[w[C]]=r._index[E],delete r._index[E]),a=r.idPrefix+w[C],D.attr("id",a),r.selrow===H&&(r.selrow=a),b.isArray(r.selarrrow)&&(E=b.inArray(H,r.selarrrow),0<=E&&(r.selarrrow[E]=a)),r.multiselect&&(E="jqg_"+r.id+"_"+a,D.find("input.cbox").attr("id",E).attr("name",E))),w=b.extend({},w,r.inlineData||{},n.extraparam)),I)q.jqGrid("progressBar",
{method:"show",loadtype:n.saveui,htmlcontent:n.savetext}),y=b.extend({},w,y),y[C]=u.stripPref(r.idPrefix,y[C]),r.autoEncodeOnEdit&&b.each(y,function(a,c){b.isFunction(c)||(y[a]=u.oldEncodePostedData(c))}),b.ajax(b.extend({url:b.isFunction(n.url)?n.url.call(p,y[C],l,y,n):n.url,data:u.serializeFeedback.call(p,b.isFunction(n.serializeSaveData)?n.serializeSaveData:r.serializeRowData,"jqGridInlineSerializeSaveData",y),type:b.isFunction(n.mtype)?n.mtype.call(p,l,n,y[C],y):n.mtype,complete:function(c,d){q.jqGrid("progressBar",
...
groupSummary:[],groupSummaryPos:[]},h={grouping:!0,groupingView:g},m=b.extend({totals:!1,useColSpanStyle:!1,trimByCollect:!0,skipSortByX:!1,skipSortByY:!1,caseSensitive:!1,footerTotals:!1,groupSummary:!0,groupSummaryPos:"header",frozenStaticCols:!1,defaultFormatting:!0,data:a},c||{}),l,n,p,q=a.length,r,t,w,x,y,A,v=m.xDimension,E=m.yDimension,B=m.aggregates,D,q=m.totalText||m.totals||m.rowTotals||m.totalHeader,k,F=d(v)?v.length:0;x=d(E)?E.length:0;var C=d(B)?B.length:0,H=x-(1===C?1:0),G=[],K=[],J=
[],d=[],N=Array(C),R=Array(x),z,O,M,W,S,V,T,Z,U,aa,X;n=function(c,d,e){c=new oa(m.trimByCollect,m.caseSensitive,d,c);b.isFunction(e)&&(c.compareVectorsEx=e);c.createDataIndex(a);return c};var ca=function(a,c,d,f,g){var k,h;switch(a){case 1:k=E[f].totalText||"{0} {1} {2}";h="y"+g+"t"+f;break;case 2:k=m.totalText||"{0}";h="t";break;default:k=1<C?c.label||"{0}":X.getItem(g)[f],h="y"+g}a=b.extend({},c,{name:h+(1<C?"a"+d:""),label:b.isFunction(k)?k.call(e,2===a?{aggregate:c,iAggregate:d,pivotOptions:m}:
{yIndex:X.getItem(g),aggregate:c,iAggregate:d,yLevel:f,pivotOptions:m}):u.template.apply(e,2===a?[k,c.aggregator,c.member,d]:[k,c.aggregator,c.member,X.getItem(g)[f],f])});delete a.member;delete a.aggregator;return a};y=function(a,b,c){var d,e;for(d=0;d<C;d++)e=B[d],void 0===e.template&&void 0===e.formatter&&m.defaultFormatting&&(e.template="count"===e.aggregator?"integer":"number"),J.push(ca(a,e,d,b,c))};z=function(a,c,d){var f,g,k,h;for(f=H-1;f>=c;f--)if(K[f]){for(g=0;g<=f;g++)U=G[g].groupHeaders,
U[U.length-1].numberOfColumns+=C;r=E[f];k=r.totalHeader;h=r.headerOnTop;for(g=f+1;g<=H-1;g++)G[g].groupHeaders.push({titleText:h&&g===f+1||!h&&g===H-1?b.isFunction(k)?k.call(e,d,f):u.template.call(e,k||"",d[f],f):"",startColumnName:"y"+(a-1)+"t"+f+(1===C?"":"a0"),numberOfColumns:C})}};var da=function(a){a=new na("count"===B[a].aggregator?"sum":B[a].aggregator,e,c);a.groupInfo={iRows:[],rows:[],ys:[],iYs:[]};return a},fa=function(){var a,b;for(a=H-1;0<=a;a--)if(K[a])for(null==R[a]&&(R[a]=Array(C)),
b=0;b<C;b++)R[a][b]=da(b)},ga=function(a,b,c,d){var e,f=X.getIndexOfDifferences(b,c),g,k;if(null!==c)for(f=Math.max(f,0),e=H-1;e>=f;e--)g="y"+a+"t"+e+(1<C?"a"+d:""),K[e]&&void 0===T[g]&&(k=R[e][d],k.getResult(T,g),T.pivotInfos[g]={colType:1,iA:d,a:B[d],level:e,iRows:k.groupInfo.iRows,rows:k.groupInfo.rows,ys:k.groupInfo.ys,iYs:k.groupInfo.iYs},b!==c&&(R[e][d]=da(d)))},ha=function(c,d,e,f,g,k,h){var l;if(c!==d)for(d=H-1;0<=d;d--)K[d]&&(l=R[d][f],l.calc(g[e.member],e.member,g,k,a),l=l.groupInfo,0>b.inArray(h,
...
t=b.extend(t,p),delete t.dataName,delete t.footerText,J.push(t);2>F&&(h.grouping=!1);h.sortname=J[F-1].name;g.hideFirstGroupCol=!0;for(n=0;n<x;n++)r=E[n],K.push(r.totals||r.rowTotals||r.totalText||r.totalHeader?!0:!1);Z=X.getItem(0);y(0,x-1,0);g=X.getIndexLength();for(t=1;t<g;t++){M=X.getItem(t);n=X.getIndexOfDifferences(M,Z);for(p=H-1;p>=n;p--)K[p]&&y(1,p,t-1);Z=M;y(0,x-1,t)}for(n=H-1;0<=n;n--)K[n]&&y(1,n,g-1);q&&y(2);Z=X.getItem(0);for(p=0;p<H;p++)G.push({useColSpanStyle:m.useColSpanStyle,groupHeaders:[{titleText:Z[p],
startColumnName:1===C?"y0":"y0a0",numberOfColumns:C}]});for(t=1;t<g;t++){M=X.getItem(t);n=X.getIndexOfDifferences(M,Z);z(t,n,Z);for(p=H-1;p>=n;p--)G[p].groupHeaders.push({titleText:M[p],startColumnName:"y"+t+(1===C?"":"a0"),numberOfColumns:C});for(p=0;p<n;p++)U=G[p].groupHeaders,U[U.length-1].numberOfColumns+=C;Z=M}z(g,0,Z);if(q)for(n=0;n<H;n++)G[n].groupHeaders.push({titleText:n<H-1?"":m.totalHeader||"",startColumnName:"t"+(1===C?"":"a0"),numberOfColumns:C});z=aa.getIndexLength();for(x=0;x<z;x++){p=
aa.getItem(x);y={iX:x,x:p};T={pivotInfos:y};for(n=0;n<F;n++)T["x"+n]=p[n];O=aa.getIndexesOfSourceData(x);if(q)for(p=0;p<C;p++)N[p]=da(p);Z=null;fa();for(t=0;t<g;t++){M=X.getItem(t);W=X.getIndexesOfSourceData(t);for(p=0;p<C;p++){null!==Z&&ga(t-1,M,Z,p);S=[];for(n=0;n<W.length;n++)w=W[n],0<=b.inArray(w,O)&&S.push(w);if(0<S.length){A=Array(S.length);V=B[p];D=new na(V.aggregator,e,c);for(w=0;w<S.length;w++)n=S[w],l=a[n],A[w]=l,D.calc(l[V.member],V.member,l,n,a),q&&(k=N[p],k.calc(l[V.member],V.member,
l,n,a),k=k.groupInfo,0>b.inArray(n,k.iYs)&&(k.iYs.push(t),k.ys.push(M)),0>b.inArray(n,k.iRows)&&(k.iRows.push(n),k.rows.push(l))),ha(M,Z,V,p,l,n,t);l="y"+t+(1===C?"":"a"+p);D.getResult(T,l);y[l]={colType:0,iY:t,y:M,iA:p,a:V,iRows:S,rows:A}}}Z=M}if(null!==Z)for(p=0;p<C;p++)ga(g-1,Z,Z,p);if(q)for(p=0;p<C;p++)l="t"+(1===C?"":"a"+p),k=N[p],k.getResult(T,l),k=k.groupInfo,y[l]={colType:2,iA:p,a:B[p],iRows:k.iRows,rows:k.rows,iYs:k.iYs,ys:k.ys};d.push(T)}if(m.footerTotals||m.colTotals){q=d.length;for(n=
0;n<F;n++)f["x"+n]=v[n].footerText||"";for(n=F;n<J.length;n++){l=J[n].name;D=new na(m.footerAggregator||"sum",e,c);for(w=0;w<q;w++)T=d[w],D.calc(T[l],l,T,w,d);D.getResult(f,l)}}c.colHeaders=G;return{colModel:J,options:c,rows:d,groupOptions:h,groupHeaders:G,summary:f}},jqPivot:function(a,c,e,d){return this.each(function(){function f(){var d=m.pivotSetup.call(h,a,c),f=d.groupHeaders,p=d.summary,q=0,r;for(r in p)p.hasOwnProperty(r)&&q++;p=0<q?!0:!1;q=d.groupOptions.groupingView;r=u.from.call(g,d.rows);
...
b(f).hasClass("ui-subgrid")&&b(f).hide();b(this).html("<div class='"+C.getGuiStyles.call(e,"subgrid.buttonDiv","sgbutton-div")+"'><a role='button' class='"+C.getGuiStyles.call(e,"subgrid.button","sgbutton")+"'><span class='"+m("plusicon")+"'></span></a></div>").removeClass("sgexpanded").addClass("sgcollapsed");d.subGridOptions.selectOnCollapse&&b(e).jqGrid("setSelection",g)}return!1},A,v,E=1;if(e.grid){A=e.rows.length;void 0!==c&&0<c&&(E=c,A=c+1);for(;E<A;)v=e.rows[E],b(v).hasClass("jqgrow")&&(v=
b(v.cells[a]),v.hasClass("ui-sgcollapsed")&&(d.scroll&&v.unbind("click"),v.bind("click",y))),E++;!0===d.subGridOptions.expandOnLoad&&b(e.rows).filter(".jqgrow").each(function(a,c){b(c.cells[0]).click()});e.subGridXml=function(a,b){w(a,b,r)};e.subGridJson=function(a,b){w(a,b,t)}}})},expandSubGridRow:function(a){return fb.call(this,a,"sgcollapsed")},collapseSubGridRow:function(a){return fb.call(this,a,"sgexpanded")},toggleSubGridRow:function(a){return fb.call(this,a,"ui-sgcollapsed")}});window.tableToGrid=
...
-1===b.inArray(d,f)&&(0<=b.inArray(c,g)?a.additionalProperties.push({name:d,search:!1,convert:function(a){return!0===a||"true"===String(a).toLowerCase()||"1"===String(a)?!0:a}}):a.additionalProperties.push(d))})}})},expandRow:function(a){this.each(function(){var c=b(this),e=this.p;if(this.grid&&e.treeGrid){var d=e.treeReader.expanded_field,f=a[e.localReader.id];if(ha.call(this,"beforeExpandRow",{rowid:f,item:a})){var g=C.getNodeChildren.call(c,a);b(g).each(function(){var a=e.idPrefix+pa(this,e.localReader.id);
b(C.getGridRowById.call(c,a)).css("display","");this[d]&&C.expandRow.call(c,this)});ha.call(this,"afterExpandRow",{rowid:f,item:a})}}})},collapseRow:function(a){this.each(function(){var c=b(this),e=this.p;if(this.grid&&e.treeGrid){var d=e.treeReader.expanded_field,f=a[e.localReader.id];if(ha.call(this,"beforeCollapseRow",{rowid:f,item:a})){var g=C.getNodeChildren.call(c,a);b(g).each(function(){var a=e.idPrefix+pa(this,e.localReader.id);b(C.getGridRowById.call(c,a)).css("display","none");this[d]&&
C.collapseRow.call(c,this)});ha.call(this,"afterCollapseRow",{rowid:f,item:a})}}})},getRootNodes:function(){var a=[];this.each(function(){var c=this.p;if(this.grid&&c.treeGrid)switch(c.treeGridModel){case "nested":var e=c.treeReader.level_field;b(c.data).each(function(){parseInt(this[e],10)===parseInt(c.tree_root_level,10)&&a.push(this)});break;case "adjacency":var d=c.treeReader.parent_id_field;b(c.data).each(function(){null!==this[d]&&"null"!==String(this[d]).toLowerCase()||a.push(this)})}});return a},
...
{nodeid:l,n_level:a[g],n_left:a[h],n_right:a[m]}:{nodeid:l,n_level:a[g],parentid:a[d]}}),b(this).trigger("reloadGrid"),a[f]=!0,C.setGridParam.call(b(this),{postData:"nested"===c.treeGridModel?{nodeid:"",n_level:"",n_left:"",n_right:""}:{nodeid:"",n_level:"",parentid:""}}));ha.call(this,"afterExpandNode",{rowid:l,item:a})}}}})},collapseNode:function(a){return this.each(function(){var c=this.p;if(this.grid&&c.treeGrid){var e=c.treeReader.expanded_field;if(a[e]){var d=pa(a,c.localReader.id);ha.call(this,
"beforeCollapseNode",{rowid:d,item:a})&&(a[e]=!1,e=b("#"+c.idPrefix+G(d),this.grid.bDiv)[0],b("div.treeclick",e).removeClass(c.treeIcons.minus+" tree-minus").addClass(c.treeIcons.commonIconClass).addClass(c.treeIcons.plus+" tree-plus"),ha.call(this,"afterCollapseNode",{rowid:d,item:a}))}}})},SortTree:function(a,c,e,d){return this.each(function(){var f=this,g=f.p,h=b(f);if(f.grid&&g.treeGrid){var m,l,n,p=[];m=C.getRootNodes.call(h);m=u.from.call(f,m);m.orderBy(a,c,e,d);var q=m.select();m=0;for(l=q.length;m<
...
H,J;for(G=0;G<F.length;G++)J=F[G][h.localReader.id],H=m.call(f,J),H>r&&(r=H,t=J)}r++;p[x]&&(w=!0,p[y]=!0,b(g.rows[k]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(h.treeIcons.leaf+" tree-leaf").addClass(h.treeIcons.commonIconClass).addClass(h.treeIcons.minus+" tree-minus"),h.data[n][x]=!1,p[D]=!0)}m=r+1;void 0===e[y]&&(e[y]=!1);void 0===e[D]&&(e[D]=!1);e[A]=q;void 0===e[x]&&(e[x]=!0);"adjacency"===h.treeGridModel&&(e[v]=
...
A=u.from.call(g,h.data).greater(B,x,{stype:"integer"}).select();if(A.length)for(K in A)A.hasOwnProperty(K)&&(A[K][B]=parseInt(A[K][B],10)+2);e[E]=x+1;e[B]=x+2}}if(null===c||C.isNodeLoaded.call(f,p)||w)C.addRowData.call(f,a,e,l,t),C.setTreeNode.call(f,r,m);p&&!p[y]&&d&&b(g.rows[k]).find("div.treeclick").click()}}});var ta="mousedown",Aa="mousemove",ua="mouseup",vb=function(a){var b=a.originalEvent.targetTouches;return b?(b=b[0],{x:b.pageX,y:b.pageY}):{x:a.pageX,y:a.pageY}},Ma={drag:function(a){var b=
...
b.jqDnR=Ma;b.fn.jqDrag=function(a){return wb(this,a,"move")};b.fn.jqResize=function(a,b){return wb(this,a,"resize",b)};var Ta=0,ga,va=[],mb=function(a){try{b(":input:visible",a.w).first().focus()}catch(c){}},Gb=function(a){var c=ga[va[va.length-1]],e=!b(a.target).parents(".jqmID"+c.s)[0],d=b(a.target).offset(),f=void 0!==a.pageX?a.pageX:d.left,g=void 0!==a.pageY?a.pageY:d.top,d=function(){var a=!1;b(".jqmID"+c.s).each(function(){var c=b(this),d=c.offset();if(d.top<=g&&g<=d.top+c.height()&&d.left<=
...
e);m&&e.w.jqmAddClose(b(m,e.w));mb(e)})):m&&e.w.jqmAddClose(b(m,e.w));g.toTop&&e.o&&(d=e.w.parent().offset(),f=parseFloat(e.w.css("left")||0),h=parseFloat(e.w.css("top")||0),e.w.before('<span id="jqmP'+e.w[0]._jqm+'"></span>').insertAfter(e.o),e.w.css({top:d.top+h,left:d.left+f}));if(g.onShow)g.onShow(e);else e.w.show();mb(e);return!1},close:function(a){a=ga[a];if(!a.a)return!1;a.a=!1;va[0]&&(va.pop(),va[0]||xb("unbind"));a.c.toTop&&a.o&&b("#jqmP"+a.w[0]._jqm).after(a.w).remove();if(a.c.onHide)a.c.onHide(a);
else a.w.hide(),a.o&&a.o.remove();return!1},params:{}};ga=b.jqm.hash;b.fmatter=b.fmatter||{};var S=b.fmatter,Na=function(a,b){var e=a.formatoptions||{};return e.hasOwnProperty(b)?e[b]:(a.editoptions||{})[b]},Ya=function(a){var b=a.colModel||a.cm,e,d=!1!==b.title?" title='"+(a.colName||b.name)+"'":"";a=Na(b,"checkedClass");e=Na(b,"uncheckedClass");var f=Na(b,"value"),g="string"===typeof f?f.split(":")[0]||"Yes":"Yes",f="string"===typeof f?f.split(":")[1]||"No":"No",h=function(a){return"<i class='"+
...
"boolean"===typeof a},isEmpty:function(a){if("string"!==typeof a&&this.isValue(a))return!1;if(!this.isValue(a))return!0;a=b.trim(a).replace(/&nbsp;/ig,"").replace(/&#160;/ig,"");return""===a},NumberFormat:function(a,b){var e=S.isNumber;e(a)||(a*=1);if(e(a)){var d=0>a,f=String(a),g=b.decimalSeparator||".";if(e(b.decimalPlaces)){var h=b.decimalPlaces,f=Math.pow(10,h),f=String(Math.round(a*f)/f),e=f.lastIndexOf(".");if(0<h)for(0>e?(f+=g,e=f.length-1):"."!==g&&(f=f.replace(".",g));f.length-1-e<h;)f+=
...
a.call(this,b.extend({},la.call(b(this),"formatter"),c),e):null};J.defaultFormat=function(a,b){return S.isValue(a)&&""!==a?a:b.defaultValue||"&#160;"};var ma=J.defaultFormat,Ab=function(a,b,e){if(void 0===a||S.isEmpty(a))a=Na(e,"defaultValue");a=String(a).toLowerCase();return zb[a]||a===b.yes.toLowerCase()?b.checked:b.unchecked};J.email=function(a,b){return S.isEmpty(a)?ma(a,b):"<a href='mailto:"+a+"'>"+a+"</a>"};J.checkbox=function(a,b){var e=Ya.call(this,b);return Ab(a,e,b.colModel)};J.checkbox.getCellBuilder=
...
d="",f={target:c.target};null!=e&&(f=b.extend({},f,e.formatoptions||{}));f.target&&(d="target="+f.target);return S.isEmpty(a)?ma(a,f):"<a "+d+" href='"+a+"'>"+a+"</a>"};J.showlink=function(a,c,e){var d=this,f=c.colModel,g={baseLinkUrl:c.baseLinkUrl,showAction:c.showAction,addParam:c.addParam||"",target:c.target,idName:c.idName,hrefDefaultValue:"#"},h="",m,l,n=function(f){return b.isFunction(f)?f.call(d,{cellValue:a,rowid:c.rowId,rowData:e,options:g}):f||""};null!=f&&(g=b.extend({},g,f.formatoptions||
{}));g.target&&(h="target="+n(g.target));f=n(g.baseLinkUrl)+n(g.showAction);m=g.idName?encodeURIComponent(n(g.idName))+"="+encodeURIComponent(n(g.rowId)||c.rowId):"";l=n(g.addParam);"object"===typeof l&&null!==l&&(l=(""!==m?"&":"")+b.param(l));f+=m||l?"?"+m+l:"";""===f&&(f=n(g.hrefDefaultValue));return"string"===typeof a||S.isNumber(a)||b.isFunction(g.cellValue)?"<a "+h+" href='"+f+"'>"+(b.isFunction(g.cellValue)?n(g.cellValue):a)+"</a>":ma(a,g)};J.showlink.getCellBuilder=function(a){var c={baseLinkUrl:a.baseLinkUrl,
...
null!==n&&(n=(""!==d?"&":"")+b.param(n));l+=d||n?"?"+d+n:"";""===l&&(l=p(c.hrefDefaultValue));return"string"===typeof a||S.isNumber(a)||b.isFunction(c.cellValue)?"<a "+m+" href='"+l+"'>"+(b.isFunction(c.cellValue)?p(c.cellValue):a)+"</a>":ma(a,c)}};J.showlink.pageFinalization=function(a){var c=b(this),e=this.p,d=e.colModel[a],f,g=this.rows,h=g.length,m,l=function(e){var f=b(this).closest(".jqgrow");if(0<f.length)return d.formatoptions.onClick.call(c[0],{iCol:a,iRow:f[0].rowIndex,rowid:f.attr("id"),
...
{}));return S.isEmpty(a)?Ua(c.defaultValue,c):Ua(S.NumberFormat(a,c),c)};J.integer=function(a,b){return nb(a,b,"integer")};J.number=function(a,b){return nb(a,b,"number")};J.currency=function(a,b){return nb(a,b,"currency")};var ob=function(a,c){var e=a.colModel,d=b.extend({},a[c]);null!=e&&(d=b.extend({},d,e.formatoptions||{}));var f=S.NumberFormat,g=d.defaultValue?Ua(d.defaultValue,d):"";return function(a){return S.isEmpty(a)?g:Ua(f(a,d),d)}};J.integer.getCellBuilder=function(a){return ob(a,"integer")};
J.number.getCellBuilder=function(a){return ob(a,"number")};J.currency.getCellBuilder=function(a){return ob(a,"currency")};J.date=function(a,c,e,d){e=c.colModel;c=b.extend({},c.date);null!=e&&(c=b.extend({},c,e.formatoptions||{}));return c.reformatAfterEdit||"edit"!==d?S.isEmpty(a)?ma(a,c):u.parseDate.call(this,c.srcformat,a,c.newformat,c):ma(a,c)};J.date.getCellBuilder=function(a,c){var e=b.extend({},a.date);null!=a.colModel&&(e=b.extend({},e,a.colModel.formatoptions||{}));var d=u.parseDate,f=e.srcformat,
g=e.newformat;return e.reformatAfterEdit||"edit"!==c?function(a){return S.isEmpty(a)?ma(a,e):d.call(this,f,a,g,e)}:function(a){return ma(a,e)}};J.select=function(a,c){var e=[],d=c.colModel,f,d=b.extend({},d.editoptions||{},d.formatoptions||{}),g=d.value,h=d.separator||":",m=d.delimiter||";";if(g){var l=!0===d.multiple?!0:!1,n=[],p=function(a,b){if(0<b)return a};l&&(n=b.map(String(a).split(","),function(a){return b.trim(a)}));if("string"===typeof g){var q=g.split(m),r,t;for(r=0;r<q.length;r++)if(m=
q[r].split(h),2<m.length&&(m[1]=b.map(m,p).join(h)),t=b.trim(m[0]),d.defaultValue===t&&(f=m[1]),l)-1<b.inArray(t,n)&&e.push(m[1]);else if(t===b.trim(a)){e=[m[1]];break}}else S.isObject(g)&&(f=g[d.defaultValue],e=l?b.map(n,function(a){return g[a]}):[void 0===g[a]?"":g[a]])}a=e.join(", ");return""!==a?a:void 0!==d.defaultValue?f:ma(a,d)};J.select.getCellBuilder=function(a){a=a.colModel;var c=J.defaultFormat,e=b.extend({},a.editoptions||{},a.formatoptions||{}),d=e.value;a=e.separator||":";var f=e.delimiter||
";",g,h=void 0!==e.defaultValue,m=!0===e.multiple?!0:!1,l,n={},p=function(a,b){if(0<b)return a};if("string"===typeof d)for(d=d.split(f),f=d.length,l=f-1;0<=l;l--)f=d[l].split(a),2<f.length&&(f[1]=b.map(f,p).join(a)),n[b.trim(f[0])]=f[1];else if(S.isObject(d))n=d;else return function(a){return a?String(a):c(a,e)};h&&(g=n[e.defaultValue]);return m?function(a){var d=[],f,l=b.map(String(a).split(","),function(a){return b.trim(a)});for(f=0;f<l.length;f++)a=l[f],n.hasOwnProperty(a)&&d.push(n[a]);a=d.join(", ");
...
(f[1]=b.map(f,m).join(d)),c)-1<b.inArray(b.trim(f[1]),h)&&(e[n]=f[0],n++);else if(b.trim(f[1])===b.trim(a)){e[0]=f[0];break}}else if(S.isObject(g)||b.isArray(g))c||(h[0]=a),e=b.map(h,function(a){var c;b.each(g,function(b,d){if(d===a)return c=b,!1});if(void 0!==c)return c});return e.join(", ")}return a||""};b.unformat.date=function(a,c){var e=b.extend(!0,{},la.call(b(this),"formatter.date"),u.formatter.date||{},c.formatoptions||{});return S.isEmpty(a)?"":u.parseDate.call(this,e.newformat,a,e.srcformat,
e)}});
