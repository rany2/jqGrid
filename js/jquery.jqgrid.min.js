/*
 ...
 Date: 2017-01-03
*/
var $jscomp={scope:{},findInternal:function(b,P,K){b instanceof String&&(b=String(b));for(var X=b.length,t=0;t<X;t++){var aa=b[t];if(P.call(K,aa,t,b))return{i:t,v:aa}}return{i:-1,v:void 0}}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(b,P,K){if(K.get||K.set)throw new TypeError("ES3 does not support getters and setters.");b!=Array.prototype&&b!=Object.prototype&&(b[P]=K.value)};
$jscomp.getGlobal=function(b){return"undefined"!=typeof window&&window===b?b:"undefined"!=typeof global&&null!=global?global:b};$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(b,P,K,X){if(P){K=$jscomp.global;b=b.split(".");for(X=0;X<b.length-1;X++){var t=b[X];t in K||(K[t]={});K=K[t]}b=b[b.length-1];X=K[b];P=P(X);P!=X&&null!=P&&$jscomp.defineProperty(K,b,{configurable:!0,writable:!0,value:P})}};
...
$jscomp.polyfill("String.prototype.startsWith",function(b){return b?b:function(b,K){var P=$jscomp.checkStringArgs(this,b,"startsWith");b+="";for(var t=P.length,aa=b.length,qa=Math.max(0,Math.min(K|0,P.length)),Q=0;Q<aa&&qa<t;)if(P[qa++]!=b[Q++])return!1;return Q>=aa}},"es6-impl","es3");
$jscomp.polyfill("String.prototype.endsWith",function(b){return b?b:function(b,K){var P=$jscomp.checkStringArgs(this,b,"endsWith");b+="";void 0===K&&(K=P.length);for(var t=Math.max(0,Math.min(K|0,P.length)),aa=b.length;0<aa&&0<t;)if(P[--t]!=b[--aa])return!1;return 0>=aa}},"es6-impl","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.symbolCounter_=0;
...
$jscomp.iteratorFromArray=function(b,P){$jscomp.initSymbolIterator();b instanceof String&&(b+="");var K=0,X={next:function(){if(K<b.length){var t=K++;return{value:P(t,b[t]),done:!1}}X.next=function(){return{done:!0,value:void 0}};return X.next()}};X[Symbol.iterator]=function(){return X};return X};$jscomp.polyfill("Array.prototype.keys",function(b){return b?b:function(){return $jscomp.iteratorFromArray(this,function(b){return b})}},"es6-impl","es3");
(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"===typeof module&&module.exports?module.exports=function(P,K){void 0===K&&(K="undefined"!==typeof window?require("jquery"):require("jquery")(P||window));b(K);return K}:b(jQuery)})(function(b){function P(b,c,d){if(!(this instanceof P))return new P(b);this.aggregator=b;this.finilized=!1;this.context=c;this.pivotOptions=d}function K(a,c,d,e,g){var f=e.length,k=function(b,a){var c=b,d=a;null==c&&(c="");null==d&&(d="");c=
...
Array(f);this.fieldSortDirection=Array(f);this.fieldCompare=Array(f);for(a=0;a<f;a++){c=e[a];this.fieldNames[a]=c[g||"dataName"];switch(c.sorttype){case "integer":case "int":this.fieldCompare[a]=m;break;case "number":case "currency":case "float":this.fieldCompare[a]=l;break;default:this.fieldCompare[a]=b.isFunction(c.compare)?c.compare:k}this.fieldSortDirection[a]="desc"===c.sortorder?-1:1}}var X={name:"English (United States)",nameEnglish:"English (United States)",isRTL:!1,defaults:{recordtext:"View {0} - {1} of {2}",
...
null==a&&(a="");return a.replace(/\{(\d+)\}/g,function(b,a){return c[a]})},template:function(a){var c=b.makeArray(arguments).slice(1),d,e=c.length;null==a&&(a="");return a.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((\.*?)?\))?)?\}/g,function(a,f){var g,l;if(!isNaN(parseInt(f,10)))return c[parseInt(f,10)];for(d=0;d<e;d++)if(b.isArray(c[d]))for(g=c[d],l=g.length;l--;)if(f===g[l].nm)return g[l].v})},msie:"Microsoft Internet Explorer"===navigator.appName,msiever:function(){var b=-1,c=/(MSIE) ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent);
...
""):c;return c},getRes:function(b,c){var a=c.split("."),e=a.length,g;if(null!=b){for(g=0;g<e;g++){if(!a[g])return null;b=b[a[g]];if(void 0===b)break;if("string"===typeof b)break}return b}},parseDate:function(a,c,d,e){var g,f,k,l=0,m=0;g="string"===typeof c?c.match(/^\/Date\((([\-+])?[0-9]+)(([\-+])([0-9]{2})([0-9]{2}))?\)\/$/):null;var n=function(b,a){b=String(b);for(a=parseInt(a,10)||2;b.length<a;)b="0"+b;return b},l={m:1,d:1,y:1970,h:0,i:0,s:0,u:0},p=function(b,a){0===b?12===a&&(a=0):12!==a&&(a+=
12);return a};e=function(b,a){var c="AmPm dayNames masks monthNames userLocalTime parseRe S srcformat".split(" "),d=a||{},e=(t.formatter||{}).date||{},g=null==b||null==b.locale?{}:((aa[b.locale]||{}).formatter||{}).date,f,k=c.length,l={},m;for(f=0;f<k;f++)m=c[f],void 0!==d[m]?l[m]=d[m]:void 0!==e[m]?l[m]=e[m]:void 0!==g[m]&&(l[m]=g[m]);return l}(this.p,e);void 0===e.parseRe&&(e.parseRe=/[#%\\\/:_;.,\t\s\-]/);e.masks.hasOwnProperty(a)&&(a=e.masks[a]);if(c&&null!=c)if(isNaN(c)||"u"!==String(a).toLowerCase())if(isNaN(c)||
"u1000"!==String(a).toLowerCase())if(c.constructor===Date)l=c;else if(null!==g)l=new Date(parseInt(g[1],10)),g[3]&&(m=60*Number(g[5])+Number(g[6]),m*="-"===g[4]?1:-1,m-=l.getTimezoneOffset(),l.setTime(Number(Number(l)+6E4*m)));else{"ISO8601Long"===e.srcformat&&"Z"===c.charAt(c.length-1)&&(m-=(new Date).getTimezoneOffset());c=String(c).replace(/\T/g,"#").replace(/\t/,"%").split(e.parseRe);a=a.replace(/\T/g,"#").replace(/\t/,"%").split(e.parseRe);f=0;for(k=Math.min(a.length,c.length);f<k;f++){switch(a[f]){case "M":g=
b.inArray(c[f],e.monthNames);-1!==g&&12>g&&(c[f]=g+1,l.m=c[f]);break;case "F":g=b.inArray(c[f],e.monthNames,12);-1!==g&&11<g&&(c[f]=g+1-12,l.m=c[f]);break;case "n":l.m=parseInt(c[f],10);break;case "j":l.d=parseInt(c[f],10);break;case "g":l.h=parseInt(c[f],10);break;case "a":g=b.inArray(c[f],e.AmPm);-1!==g&&2>g&&c[f]===e.AmPm[g]&&(c[f]=g,l.h=p(c[f],l.h));break;case "A":g=b.inArray(c[f],e.AmPm),-1!==g&&1<g&&c[f]===e.AmPm[g]&&(c[f]=g-2,l.h=p(c[f],l.h))}void 0!==c[f]&&(l[a[f].toLowerCase()]=parseInt(c[f],
...
(d="Y-m-d");m=l.getHours();a=l.getMinutes();c=l.getDate();p=l.getMonth()+1;g=l.getTimezoneOffset();f=l.getSeconds();k=l.getMilliseconds();var q=l.getDay(),r=l.getFullYear(),u=(q+6)%7+1,B=(new Date(r,p-1,c)-new Date(r,0,1))/864E5,A=5>u?Math.floor((B+u-1)/7)+1:Math.floor((B+u-1)/7)||(4>((new Date(r-1,0,1)).getDay()+6)%7?53:52),v={d:n(c),D:e.dayNames[q],j:c,l:e.dayNames[q+7],N:u,S:e.S(c),w:q,z:B,W:A,F:e.monthNames[p-1+12],m:n(p),M:e.monthNames[p-1],n:p,t:"?",L:"?",o:"?",Y:r,y:String(r).substring(2),
a:12>m?e.AmPm[0]:e.AmPm[1],A:12>m?e.AmPm[2]:e.AmPm[3],B:"?",g:m%12||12,G:m,h:n(m%12||12),H:n(m),i:n(a),s:n(f),u:k,e:"?",I:"?",O:(0<g?"-":"+")+n(100*Math.floor(Math.abs(g)/60)+Math.abs(g)%60,4),P:"?",T:(String(l).match(/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[\-+]\d{4})?)\b/g)||[""]).pop().replace(/[^\-+\dA-Z]/g,""),Z:"?",c:"?",r:"?",U:Math.floor(l/1E3)};return d.replace(/\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g,function(b){return v.hasOwnProperty(b)?
...
" ").split(" "),e=0;e<g.length;e++)f=g[e],""===f||c.hasOwnProperty(f)||(c[f]=!0,k.push(f));return k.join(" ")},hasOneFromClasses:function(a,c){var d=b(a),e=String(c).replace(/[\t\r\n\f]/g," ").split(" "),g=e.length,f;for(f=0;f<g;f++)if(d.hasClass(e[f]))return!0;return!1},hasAllClasses:function(a,c){var d=b(a),e=String(c).replace(/[\t\r\n\f]/g," ").split(" "),g=e.length,f;for(f=0;f<g;f++)if(!d.hasClass(e[f]))return!1;return!0},detectRowEditing:function(a){var c,d,e,g=this.rows,f=this.p,k=b.isFunction;
if(!this.grid||null==g||null==f||void 0===f.savedRow||0===f.savedRow.length)return null;for(c=0;c<f.savedRow.length;c++)if(d=f.savedRow[c],"number"===typeof d.id&&"number"===typeof d.ic&&void 0!==d.name&&void 0!==d.v&&null!=g[d.id]&&g[d.id].id===a&&k(b.fn.jqGrid.restoreCell)){if(e=g[d.id],null!=e&&e.id===a)return{mode:"cellEditing",savedRow:d}}else if(d.id===a&&k(b.fn.jqGrid.restoreRow))return{mode:"inlineEditing",savedRow:d};return null},getCell:function(a,c){var d=this.grid,e=this.p;if(!d||!e)return b();
...
a.autoResizing.wrapperClassName):e},enumEditableCells:function(a,c,d){var e=this.grid,g=this.rows,f=this.p;if(null==e||null==g||null==f||null==a||null==a.rowIndex||!a.id||!b.isFunction(d))return null;var k,g=f.colModel,l=g.length,m,n,p=a.rowIndex,q,r,u;k=e.fbRows;var t=(e=null!=k)?k[p]:null;e&&(a=this.rows[p]);for(k=0;k<l;k++)if(m=g[k],n=m.name,"cb"!==n&&"subgrid"!==n&&"rn"!==n&&(e&&!m.frozen&&(e=!1),q=(e?t:a).cells[k],r=b(q),!r.hasClass("not-editable-cell")&&(u=r.width(),!0===f.treeGrid&&n===f.ExpandColumn?
(u-=r.children("div.tree-wrap").outerWidth(),r=r.children("span.cell-wrapperleaf,span.cell-wrapper").first()):u=0,n={rowid:a.id,iCol:k,iRow:p,cmName:n,cm:m,mode:c,td:q,tr:a,trFrozen:t,dataElement:r[0],dataWidth:u},m.edittype||(m.edittype="text"),m=m.editable,m=b.isFunction(m)?m.call(this,n):m,!0===m||"hidden"===m)))if(n.editable=m,!1===d.call(this,n))break},getEditedValue:function(a,c,d,e){var g,f,k,l,m,n=c.formatoptions||{};f=c.editoptions||{};var p=f.custom_value,q="[name="+t.jqID(c.name)+"]",r=
b(this);if("hidden"===e||"readonly"===e)return b(this).jqGrid("getCell",a.closest("tr.jqgrow").attr("id"),c.name);switch(c.edittype){case "checkbox":g=["Yes","No"];"string"===typeof f.value&&(g=f.value.split(":"));g=a.find("input[type=checkbox]").is(":checked")?g[0]:g[1];break;case "text":case "password":case "textarea":case "button":k=a.find("input"+q+",textarea"+q);g=k.val();"date"===k.prop("type")&&3===String(g).split("-").length&&(f=n.newformat||r.jqGrid("getGridRes","formatter.date.newformat"),
g=t.parseDate.call(this,"Y-m-d",g,f));break;case "select":k=a.find("select option:selected");f.multiple?(l=[],m=[],k.each(function(){l.push(b(this).val());m.push(b(this).text())}),g=l.join(","),d.text=m.join(",")):(g=k.val(),d.text=k.text());d.value=g;break;case "custom":try{if(b.isFunction(p)){if(g=p.call(this,a.find(".customelement"),"get"),void 0===g)throw"e2";}else throw"e1";}catch(u){f=t.info_dialog;a=function(b){r.jqGrid("getGridRes",b)};switch(String(u)){case "e1":k="function 'custom_value' "+
a("edit.msg.nodefined");break;case "e2":break;default:k=u.message}f&&b.isFunction(f)?f.call(this,a("errors.errcap"),k,a("edit.bClose")):(b.isFunction(qa.fatalError)?qa.fatalError:alert)(k)}break;default:g=a.find("*"+q).text()}return g},guid:1,uidPref:"jqg",randId:function(b){return(b||t.uidPref)+t.guid++},getAccessor:function(a,c){var d,e,g=[],f;if(b.isFunction(c))return c(a);if(null!=a&&a.hasOwnProperty(c))return a[c];try{if("string"===typeof c&&(g=c.split(".")),f=g.length)for(d=a;null!=d&&f--;)e=
g.shift(),d=d[e]}catch(k){}return d},getXmlData:function(a,c,d){var e="string"===typeof c?c.match(/^(.*)\[(\w+)\]$/):null;if(b.isFunction(c))return c(a);if(e&&e[2])return e[1]?b(e[1],a).attr(e[2]):b(a).attr(e[2]);if(void 0!==a)return a=b(a).find(c),d?a:0<a.length?b(a).text():void 0},cellWidth:function(){var a=b("<div class='ui-jqgrid' style='left:10000px'><div class='ui-jqgrid-view'><div class='ui-jqgrid-bdiv'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;display:block;'></td></tr></table></div></div></div>"),
...
return c}if(!d._hasData())return[];d._performSort();return f};this.hasMatch=function(){if(!d._hasData())return!1;d.execute();return 0<f.length};this.andNot=function(b,a,c){u=!u;return d.and(b,a,c)};this.orNot=function(b,a,c){u=!u;return d.or(b,a,c)};this.not=function(b,a,c){return d.andNot(b,a,c)};this.and=function(b,a,c){B=" && ";return void 0===b?d:d._repeatCommand(b,a,c)};this.or=function(b,a,c){B=" || ";return void 0===b?d:d._repeatCommand(b,a,c)};this.orBegin=function(){r++;return d};this.orEnd=
function(){null!==m&&(m+=")");return d};this.isNot=function(b){u=!u;return d.is(b)};this.is=function(b){d._append("this."+b);d._resetNegate();return d};this._compareValues=function(b,a,e,g,h){var f;f=x?a:"this";void 0===e&&(e=null);var k=e,l=void 0===h.stype?"text":h.stype;if(null!==e)switch(l){case "int":case "integer":k=String(k).replace(n,"");k=isNaN(Number(k))||""===k?"0":Number(k);f="parseInt("+f+"||0,10)";k=String(parseInt(k,10));break;case "float":case "number":case "currency":case "numeric":k=
String(k).replace(n,"");k=isNaN(Number(k))||""===k?"0":Number(k);f="parseFloat("+f+"||0)";k=String(k);break;case "date":case "datetime":k=String(t.parseDateToNumber.call(c,h.newfmt||"Y-m-d",k));f='jQuery.jgrid.parseDateToNumber.call(self,"'+h.srcfmt+'",'+f+")";break;default:f=d._getStr(f),k=d._getStr('"'+d._toStr(k)+'"')}d._append(f+" "+g+" "+k);d._setCommand(b,a);d._resetNegate();return d};this.equals=function(b,a,c){return d._compareValues(d.equals,b,a,"==",c)};this.notEquals=function(b,a,c){return d._compareValues(d.equals,
...
"a":b.trim(c.toString().toLowerCase());null==e&&(e="text");null==g&&(g="Y-m-d");null==h&&(h=!1);if("desc"===c||"descending"===c)c="d";if("asc"===c||"ascending"===c)c="a";A.push({by:a,dir:c,type:e,datefmt:g,sfunc:h});return d};this.inSet=function(b,a,c){var e,h=void 0===c.stype?"text":c.stype;e=d._getStr('"'+d._toStr(void 0===a?null:a)+'"');if("text"!==h)return d._compareValues(d.equals,b,a,"==",c);d._append("jQuery.inArray("+d._getStr(b)+","+e+".split(',')) >= 0");d._setCommand(d.inSet,b);d._resetNegate();
...
return t.fullBoolFeedback.apply(g,k)},builderSortIcons:function(a){var c=this,d=c.p,e=b(c),g=e.jqGrid("getGuiStyles","states.disabled"),f=function(f){var k=d.colModel[a],m=null!=k&&b.isFunction(k.sortIconName)?k.sortIconName:d.sortIconName,k=b.isFunction(m)?m.call(c,{order:f,iCol:a,cm:k}):e.jqGrid("getIconRes","sort."+f);return t.mergeCssClasses("ui-grid-ico-sort","ui-icon-"+f,"horizontal"===d.viewsortcols[1]?"ui-i-"+f:"",g,k,"ui-sort-"+d.direction)};return"<span class='s-ico"+(d.sortIconsBeforeText?
" jqgrid-icons-first":"")+"' style='display:none'><span class='"+f("asc")+"'></span><span class='"+f("desc")+"'></span></span>"},builderFmButon:function(a,c,d,e,g){var f=this.p,k=b(this);return null==f?"":"<a id='"+a+"' class='"+t.mergeCssClasses("fm-button",k.jqGrid("getGuiStyles","dialog.fmButton"),k.jqGrid("getGuiStyles","dialog."+("right"===g?"rightCorner":"left"===g?"leftCorner":"defaultCorner")),"right"===e?"fm-button-icon-right":"left"===e?"fm-button-icon-left":"")+"' role='button' tabindex='0'>"+
...
"currency"===c.formatter?a=parseFloat(a):"integer"===c.formatter&&(a=parseInt(a,10))):(d=String(a).toLowerCase(),c=null!=c.editoptions&&"string"===typeof c.editoptions.value?c.editoptions.value.split(":"):["yes","no"],0<=b.inArray(d,["1","true",c[0].toLowerCase()])?a=!0:0<=b.inArray(d,["0","false",c[1].toLowerCase()])&&(a=!1));return a},parseDataToHtml:function(a,c,d,e,g,f,k){var l=this,m=l.p,n=b(l),p,q,r,u,B,A,v,x=!1,w=[],y=[],C=!0!==m.altRows||n.jqGrid("isBootstrapGuiStyle")?"":m.altclass,z=m.grouping?
!0===m.groupingView.groupCollapse:!1,h=parseInt(m.rowNum,10),F,H=b.fn.jqGrid,L=!0===m.treeGrid&&-1<m.treeANode?l.rows[m.treeANode].rowIndex+1:l.rows.length,J=l.formatCol,Z=function(b,a,c,d,e,h){a=l.formatter(b,a,c,e,"add",h);return"<td role='gridcell' "+J(c,d,a,e,b,h)+">"+a+"</td>"},T=function(a,c,d,e,h){var g="&nbsp;",f=!0;h={rowid:a,iRow:d,iCol:c,data:h,checked:e};b.isFunction(m.hasMultiselectCheckBox)&&(f=m.hasMultiselectCheckBox.call(l,h));f&&(g=b.isFunction(m.checkboxHtml)?m.checkboxHtml.call(l,
h):"<input type='checkbox' id='jqg_"+m.id+"_"+a+"' class='cbox' name='jqg_"+m.id+"_"+a+"'"+(e?" checked='checked' aria-checked='true'":" aria-checked='false'")+"/>");return"<td role='gridcell' "+J(c,d,"",null,a,!0)+">"+g+"</td>"},E=function(b,a,c,d){c=(parseInt(c,10)-1)*parseInt(d,10)+1+a;return"<td role='gridcell' class='"+H.getGuiStyles.call(n,"rowNum","jqgrid-rownum")+"' "+J(b,a,c,null,a,!0)+">"+c+"</td>"};1>=L&&(m.rowIndexes={});if("local"===m.datatype&&!m.deselectAfterSort||m.multiPageSelection)x=
!0;f&&(h*=f+1);for(f=0;f<Math.min(a,h);f++){u=c[f];B=d[f];A=null!=e?e[f]:B;p=1===g?0:g;q=1===(p+f)%2?C:"";x?m.multiselect?(r=-1!==b.inArray(u,m.selarrrow))&&null===m.selrow&&(m.selrow=u):r=u===m.selrow:r=!1;v=w.length;w.push("");for(p=0;p<m.colModel.length;p++)switch(F=m.colModel[p].name,F){case "rn":w.push(E(p,f,m.page,m.rowNum));break;case "cb":w.push(T(u,p,f,r,B));break;case "subgrid":w.push(H.addSubGridCell.call(n,p,f+g,u,B));break;default:w.push(Z(u,B[F],p,f+g,A,B))}m.grouping&&H.groupingPrepare&&
!m.groupingView._locgr&&(H.groupingPrepare.call(n,B,f),b.isFunction(m.groupingView.groupCollapse)&&(z=m.groupingView.groupCollapse.call(l,{group:m.groupingView.groups[m.groupingView.groups.length-1],rowid:u,data:B})));w[v]=l.constructTr(u,z,q,B,A,r);w.push("</tr>");m.rowIndexes[u]=L;L++;m.grouping&&(y.push(w),w=[]);w.length>m.maxItemsToJoin&&(w=[w.join("")])}m.grouping&&H.groupingRender&&(k&&(m.groupingView._locgr=!0),w=[H.groupingRender.call(n,y,h)],t.clearArray(y));return w},fillSelectOptions:function(a,
c,d,e,g,f){var k,l=[],m,n,p=!1;n=function(b,a){if(0<a)return b};if(c){"function"===typeof c&&(c=c());if("string"===typeof c)for(e=c.split(e),c=0;c<e.length;c++)k=e[c].split(d),2<k.length&&(k[1]=b.map(k,n).join(d)),l.push({value:k[0],innerHtml:k[1],selectValue:b.trim(k[0]),selectText:b.trim(k[1]),selected:!1}),""===k[0]&&(p=!0);else if("object"===typeof c)for(k in c)c.hasOwnProperty(k)&&l.push({value:k,innerHtml:c[k],selectValue:b.trim(k),selectText:b.trim(c[k]),selected:!1}),""===k&&(p=!0);if("string"===
...
a)},extend:function(a){b.extend(b.fn.jqGrid,a);this.no_legacy_api||b.fn.extend(a)}});var Q=t.clearArray,I=t.jqID,Ya=t.getGridComponentIdSelector,Za=t.getGridComponentId,Ha=t.getGridComponent,Ba=t.stripPref,xa=t.randId,ra=t.getAccessor,hb=t.convertOnSaveLocally,ib=t.stripHtml,qb=t.htmlEncode,Ma=t.htmlDecode,sa=t.mergeCssClasses,V=t.hasOneFromClasses,R=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("");a.unshift(this.p);return t.feedback.apply(this,a)};b.fn.jqGrid=function(a){var c=
b.fn.jqGrid,d;if("string"===typeof a){d=c[a];if(!d)throw"jqGrid - No such method: "+a;return d.apply(this,b.makeArray(arguments).slice(1))}return this.each(function(){if(!this.grid){var d=this,g,f,k=b(d),l=b.isFunction,m=b.isArray,n=b.extend,p=b.inArray,q=b.trim,r=b.each,u=c.setSelection,B=c.getGridRes,A=l(qa.fatalError)?qa.fatalError:alert,v=a.locale||qa.locale||"en-US",x=null!=aa[v]&&"boolean"===typeof aa[v].isRTL?aa[v].isRTL?"rtl":"ltr":"ltr",w=a.iconSet||qa.iconSet||("bootstrap"===(a.guiStyle||
qa.guiStyle)||"bootstrapPrimary"===(a.guiStyle||qa.guiStyle)?"glyph":"jQueryUI"),y=a.guiStyle||qa.guiStyle||"jQueryUI",C=function(b){return c.getIconRes.call(d,b)},z=function(b,a){return k.jqGrid("getGuiStyles",b,a)};null==a&&(a={datatype:"local"});void 0!==a.datastr&&m(a.datastr)&&(f=a.datastr,a.datastr=[]);void 0!==a.data&&(g=a.data,a.data=[]);null!=t.formatter&&null!=t.formatter.unused||A("CRITICAL ERROR!!!\n\n\nOne uses probably\n\n\t$.extend($.jgrid.defaults, {...});\n\nto set default settings of jqGrid instead of the usage the DEEP version of jQuery.extend (with true as the first parameter):\n\n\t$.extend(true, $.jgrid.defaults, {...});\n\nOne other possible reason:\n\nyou included some OLD version of language file (grid.locale-en.js for example) AFTER jquery.jqGrid.min.js. For example all language files of jqGrid 4.7.0 uses non-deep call of jQuery.extend.\n\n\nSome options of jqGrid could still work, but another one will be broken.");
...
setTimeout(function(){G.populateVisible.call(d)},h.scrollTimeout))}G.hDiv.scrollLeft=this.scrollLeft;h.footerrow&&(G.sDiv.scrollLeft=this.scrollLeft);return!1},selectionPreserver:function(){var a=b(this),c=h.selrow,d=h.selarrrow?b.makeArray(h.selarrrow):null,e=this.grid.bDiv,g=e.scrollLeft,f=function(){var b;h.selrow=null;if(!h.multiPageSelection){Q(h.selarrrow);if(h.multiselect&&d&&0<d.length)for(b=0;b<d.length;b++)d[b]!==c&&u.call(a,d[b],!1,null);c&&u.call(a,c,!1,null)}e.scrollLeft=g;a.off(".selectionPreserver",
f)};a.on("jqGridGridComplete.selectionPreserver",f)}};d.grid=G;R.call(d,"beforeInitGrid");h.iColByName=L(h.colModel);h.iPropByName=J(h.additionalProperties);var x=b("<div class='"+z("gView","ui-jqgrid-view")+"' role='grid' aria-multiselectable='"+!!h.multiselect+"'></div>"),v=t.msie,O;h.direction=q(h.direction.toLowerCase());-1===p(h.direction,["ltr","rtl"])&&(h.direction="ltr");O=h.direction;b(x).insertBefore(d);k.removeClass("scroll").appendTo(x);g=b("<div class='"+z("gBox","ui-jqgrid")+"'></div>");
b(g).attr({id:h.gBoxId,dir:O}).insertBefore(x);b(x).attr("id",h.gViewId).appendTo(g);b("<div class='"+z("overlay","jqgrid-overlay")+"' id='lui_"+h.id+"'></div>").insertBefore(x);b("<div class='"+z("loading","loading")+"' id='load_"+h.id+"'>"+F("loadtext")+"</div>").insertBefore(x);k.attr({role:"presentation","aria-labelledby":"gbox_"+d.id});var ga=function(b,a,c,e,g,f){var k=h.colModel[b],m=c,n=k.classes,p=k.align?"text-align:"+k.align+";":"",q,r=function(b){return"string"===typeof b?b.replace(/\'/g,
...
!0!==r.repeatitems){if(h.treeGrid)for(c=0;c<a;c++)D(b[c])}else for(f=!1===h.keyName?l(r.id)?r.id.call(d,b):r.id:h.keyName,isNaN(f)?l(f)||null==h.arrayReaderInfos[f]||(k=h.arrayReaderInfos[f].order):k=Number(f),c=0;c<a;c++){e=b[c];g=u?ra(e,u)||e:e;w=m(g);q={};for(t in v)v.hasOwnProperty(t)&&(x=v[t],p=ra(g,w?x.order:x.name),1===x.type&&(x=y[x.index],null!=x&&l(x.convert)&&(p=x.convert(p,g))),void 0!==p&&(q[t]=p));void 0!==q[f]?e=void 0!==q[f]?q[f]:xa():(e=ra(e,m(e)?k:f),void 0===e&&(e=ra(g,m(g)?k:f)),
void 0===e&&(e=xa()));e=String(e);q[r.id]=e;h.treeGrid&&D(q);n(b[c],q)}},gb=function(){var b=h.data.length,a,c,d,e;a=!1===h.keyName||h.loadonce?h.localReader.id:h.keyName;h._index={};for(c=0;c<b;c++)e=h.data[c],d=ra(e,a),void 0===d&&(d=String(xa()),void 0===e[a]&&(e[a]=d)),h._index[d]=c},oa=function(){var a,c,d=b.fn.fmatter;for(a=0;a<h.colModel.length;a++)c=h.colModel[a].formatter,"string"===typeof c&&null!=d&&l(d[c])&&l(d[c].pageFinalization)&&d[c].pageFinalization.call(this,a)},sb=function(a,c){var e,
g,f=h.colModel,k=f.length,m,n=function(b){return null==b||""===b?"&#160;":qb(b)},p=function(b){return null==b||""===b?"&#160;":String(b)};for(e=0;e<k;e++)g=f[e],g.cellBuilder=null,a||(m={colModel:g,gid:h.id,pos:e},void 0===g.formatter?g.cellBuilder=h.autoencode?n:p:"string"===typeof g.formatter&&null!=b.fn.fmatter&&l(b.fn.fmatter.getCellBuilder)?g.cellBuilder=b.fn.fmatter.getCellBuilder.call(d,g.formatter,m,c||"add"):l(g.getCellBuilder)&&(g.cellBuilder=g.getCellBuilder.call(d,m,c||"add")))},Y=function(a,
d,e,g){var f=b(this),k=new Date,n=h.datatype,p="local"!==n&&h.loadonce||"xmlstring"===n||"jsonstring"===n,q=("xmlstring"===n||"xml"===n)&&b.isXMLDoc(a),r=h.localReader,y=ra;if(a&&("xml"!==n||q)){-1!==h.treeANode||h.scroll?d=1<d?d:1:(G.emptyRows.call(this,!1,!0),d=1);p&&(Q(h.data),Q(h.lastSelectedData),h._index={},h.grouping&&null!=h.groupingView&&(h.groupingView.groups=[],h.groupingView._locgr=!1),h.localReader.id="_id_");h.reccount=0;switch(n){case "xml":case "xmlstring":r=h.xmlReader;y=t.getXmlData;
break;case "json":case "jsonp":case "jsonstring":r=h.jsonReader}var u,w,x,v,C,F={},z,B=h.colModel,H=B.length,A,J,na,L,la,T=h.arrayReaderInfos,Ia={},ga=function(b){return function(a){a=null!=a&&l(a.getAttribute)?a.getAttribute(b):null;return null!==a?a:void 0}},rb=function(b){return function(){var a=Ia[b];if(null!=a)return a=a.childNodes,0<a.length?a[0].nodeValue:void 0}};h.page=E(y(a,r.page),h.page);h.lastpage=E(y(a,r.total),1);h.records=E(y(a,r.records));l(r.userdata)?h.userData=r.userdata.call(this,
a)||{}:q?y(a,r.userdata,!0).each(function(){h.userData[this.getAttribute("name")]=b(this).text()}):h.userData=y(a,r.userdata)||{};sb();var da={},O=h.additionalProperties,ja=function(b,a){q&&"string"===typeof a&&(/^\w+$/.test(a)?da[b]=rb(a):/^\[\w+\]$/.test(a)&&(da[b]=ga(a.substring(1,a.length-1))))},Aa=function(b){var a=b.name,c=q?b.xmlmap||a:"local"===n&&!h.dataTypeOrg||"jsonstring"===n||"json"===n||"jsonp"===n?b.jsonmap||a:a;!1!==h.keyName&&!0===b.key&&(h.keyName=a);if("string"===typeof c||l(c))da[a]=
c;l(c)||ja(a,c)};for(u=0;u<H;u++)Aa(B[u]);H=O.length;for(u=0;u<H;u++)J=O[u],"object"===typeof J&&null!=J?Aa(J):ja(J,J);v=!1===h.keyName?l(r.id)?r.id.call(this,a):r.id:h.keyName;isNaN(v)?l(v)||(T[v]&&(C=T[v].order),q&&("string"===typeof v&&/^\[\w+\]$/.test(v)?v=ga(v.substring(1,v.length-1)):"string"===typeof v&&/^\w+$/.test(v)&&(v=rb(v)))):C=Number(v);x=y(a,r.root,!0);if(r.row)if(1===x.length&&"string"===typeof r.row&&/^\w+$/.test(r.row)){H=[];na=x[0].childNodes;L=na.length;for(J=0;J<L;J++)la=na[J],
1===la.nodeType&&la.nodeName===r.row&&H.push(la);x=H}else x=y(x,r.row,!0);null==x&&m(a)&&(x=a);x||(x=[]);a=x.length;0<a&&0>=h.page&&(h.page=1);Aa=parseInt(h.rowNum,10);g&&(Aa*=g+1);var B=[],pa=[],ka,H=[];for(u=0;u<a;u++){ka=x[u];w=r.repeatitems&&r.cell?y(ka,r.cell,!0)||ka:ka;z=r.repeatitems&&(q||m(w));F={};Ia={};if(q&&!z&&null!=w)for(na=w.childNodes,L=na.length,J=0;J<L;J++)la=na[J],1===la.nodeType&&(Ia[la.nodeName]=la);for(A in T)T.hasOwnProperty(A)&&(J=T[A],z?(na=w[J.order],q&&null!=na&&(na=na.textContent||
na.text)):na=null!=da[A]&&"string"!==typeof da[A]?da[A](w):y(w,"string"===typeof da[A]?da[A]:J.name),1===J.type&&(J=O[J.index],null!=J&&l(J.convert)&&(na=J.convert(na,w))),void 0!==na&&(F[A]=na));void 0!==F[v]?ka=void 0!==F[v]?F[v]:xa():(ka=y(ka,m(ka)?C:v),void 0===ka&&(ka=y(w,m(w)?C:v)),void 0===ka&&(ka=xa()));void 0===F[v]&&(F[v]=ka);ka=String(ka);z=h.idPrefix+ka;h.treeGrid&&D(F);if(u<Aa)pa.push(z),B.push(w),H.push(F);else if(!p)break;if(p||!0===h.treeGrid)F._id_=ka,h.data.push(F),h._index[F._id_]=
...
h.iColByName.subgrid)}catch(Db){}if(!1===h.gridview||l(h.afterInsertRow))for(u=0;u<Math.min(a,Aa);u++)R.call(this,"afterInsertRow",pa[u],H[u],B[u]);h.totaltime=new Date-k;0<u&&0===h.records&&(h.records=a);Q(d);if(!0===h.treeGrid)try{c.setTreeNode.call(f,g+1,u+g+1)}catch(Db){}h.reccount=Math.min(a,Aa);h.treeANode=-1;h.userDataOnFooter&&c.footerData.call(f,"set",h.userData,!0);p&&(h.records=a,h.lastpage=Math.ceil(a/Aa));e||this.updatepager(!1,!0);oa.call(this)}}},ba=function(){function a(b){var c=0,
...
h.columnsToReResizing[b]);Q(h.columnsToReResizing)},q=function(){R.call(e,"loadComplete",p);J();g.triggerHandler("jqGridAfterLoadComplete",[p]);fa.call(e);h.datatype="local";h.datastr=null;B()},A=function(b){g.triggerHandler("jqGridLoadComplete",[b]);u&&u.call(e,b);J();g.triggerHandler("jqGridAfterLoadComplete",[b]);k&&f.populateVisible.call(e);1===a&&fa.call(e);B()},L=function(){var b=ba.call(e);Y.call(e,b,z,1<a,y);A(b)};if(R.call(e,"beforeRequest"))if(l(h.datatype))h.datatype.call(e,h.postData,
"load_"+h.id,z,a,y);else switch(m=h.datatype.toLowerCase(),b(G.eDiv).hide(),m){case "json":case "jsonp":case "xml":case "script":b.ajax(n({url:h.url,type:h.mtype,dataType:m,data:t.serializeFeedback.call(d,h.serializeGridData,"jqGridSerializeGridData",h.postData),success:function(c,d,g){h.jqXhr=null;b(G.eDiv).hide();if(l(h.beforeProcessing)&&!1===h.beforeProcessing.call(e,c,d,g))fa.call(e);else if(Y.call(e,c,z,1<a,y),A(c),h.loadonce||h.treeGrid)h.dataTypeOrg=h.datatype,h.datatype="local",h.forceClientSorting&&
L()},error:function(b,c,d){h.jqXhr=null;l(h.loadError)&&h.loadError.call(e,b,c,d);1===a&&fa.call(e)},beforeSend:function(b,a){var c=!0;l(h.loadBeforeSend)&&(c=h.loadBeforeSend.call(e,b,a));void 0===c&&(c=!0);if(!1===c)return!1;h.jqXhr=b;S.call(e)}},t.ajaxOptions,h.ajaxGridOptions));break;case "xmlstring":S.call(e);p="string"===typeof h.datastr?b.parseXML(h.datastr):h.datastr;Y.call(e,p);q();h.forceClientSorting&&L();break;case "jsonstring":S.call(e);p=h.datastr&&"string"===typeof h.datastr?b.parseJSON(h.datastr):
h.datastr;Y.call(e,p);q();h.forceClientSorting&&L();break;case "local":case "clientside":S.call(e),h.datatype="local",L()}}},K=function(a){var c=this.grid;b(h.cb,c.hDiv).prop("checked",a);h.frozenColumns&&b(h.cb,c.fhDiv).prop("checked",a)};f=function(a,c){var e=z("states.hover"),g=z("states.disabled"),f="<td class='ui-pg-button "+g+"'><span class='ui-separator'></span></td>",k="",l="<table style='table-layout:auto;white-space: pre;"+("left"===h.pagerpos?"margin-right:auto;":"right"===h.pagerpos?"margin-left:auto;":
"margin-left:auto;margin-right:auto;")+"' class='ui-pg-table'><tbody><tr>",m="",n,p,q,r,u=function(b,a,c){if(!R.call(d,"onPaging",b,{newPage:a,currentPage:E(h.page,1),lastPage:E(h.lastpage,1),currentRowNum:E(h.rowNum,10),newRowNum:c}))return!1;h.selrow=null;h.multiselect&&(h.multiPageSelection||Q(h.selarrrow),K.call(d,!1));Q(h.savedRow);return!0};c+="_"+a;n="pg_"+a;p=a+"_left";q=a+"_center";r=a+"_right";b("#"+I(a)).append("<div id='"+n+"' class='ui-pager-control' role='group'><table class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;'><tbody><tr><td id='"+
p+"' style='text-align:left;"+(void 0!==h.pagerLeftWidth?"width:"+h.pagerLeftWidth+"px;":"")+"'></td><td id='"+q+"' style='text-align:center;white-space:pre;"+(void 0!==h.pagerCenterWidth?"width:"+h.pagerCenterWidth+"px;":"")+"'></td><td id='"+r+"' style='text-align:right;"+(void 0!==h.pagerRightWidth?"width:"+h.pagerRightWidth+"px;":"")+"'></td></tr></tbody></table></div>").attr("dir","ltr");n="#"+I(n);if(0<h.rowList.length){m="<td dir='"+O+"'>";p=F("pgrecs");m+="<select class='"+z("pager.pagerSelect",
"ui-pg-selbox")+"' "+(p?"title='"+p+"'":"")+">";for(p=0;p<h.rowList.length;p++)q=h.rowList[p].toString().split(":"),1===q.length&&(q[1]=q[0]),m+="<option value='"+q[0]+"'"+(E(h.rowNum,0)===E(q[0],0)?" selected='selected'":"")+">"+q[1]+"</option>";m+="</select></td>"}"rtl"===O&&(l+=m);!0===h.pginput&&(k="<td dir='"+O+"'>"+t.format(F("pgtext")||"","<input aria-label='Page No.' class='"+z("pager.pagerInput","ui-pg-input")+"' type='text' size='2' maxlength='7' value='0'/>","<span id='sp_1_"+a+"'>0</span>")+
"</td>");a="#"+I(a);if(!0===h.pgbuttons){q=["first","prev","next","last"];r=q.slice();var y=z("pager.pagerButton","ui-pg-button"),v=function(b,a){var d=F("pg"+b);return"<td role='button' tabindex='0' id='"+b+c+"' class='"+y+"' "+(d?"title='"+d+"'":"")+"><span class='"+C("pager."+a)+"'></span></td>"};"rtl"===O&&q.reverse();for(p=0;p<q.length;p++)l+=v(q[p],r[p]),1===p&&(l+=""!==k?f+k+f:"")}else""!==k&&(l+=k);"ltr"===O&&(l+=m);l+="</tr></tbody></table>";!0===h.viewrecords&&b("td"+a+"_"+h.recordpos,n).append("<span dir='"+
O+"' style='text-align:"+h.recordpos+"' class='ui-paging-info'></span>");var w=b("td"+a+"_"+h.pagerpos,n);w.append(l);f=N.call(this,w.children(".ui-pg-table"));h._nvtd=[];h._nvtd[0]=f?Math.floor((h.width-f)/2):Math.floor(h.width/3);h._nvtd[1]=0;l=null;b(".ui-pg-selbox",n).on("change",function(){var a=E(this.value,10),c=Math.round(h.rowNum*(h.page-1)/a-.5)+1;if(!u("records",c,a))return!1;h.page=c;h.rowNum=a;h.pager&&b(".ui-pg-selbox",h.pager).val(a);h.toppager&&b(".ui-pg-selbox",h.toppager).val(a);
...
0>b.inArray(d,a)&&a.push(d),c[d]=e[e.length-1])})},P=function(a,c){var e="",g=h.colModel[a],f,k=z("states.disabled"),l=h.frozenColumns?b(c):b(d.grid.headers[a].el);f=l.find("span.s-ico");var m=f.children("span.ui-icon-asc"),n=f.children("span.ui-icon-desc"),p=m,q=n,u=[],y={};l.find("span.ui-grid-ico-sort").addClass(k);l.attr("aria-selected","false");g.lso?(f.show(),f=g.lso.split("-"),f=f[f.length-1],"desc"===f&&(p=n,q=m),p.removeClass(k).css("display",""),h.showOneSortIcon&&q.hide(),l.attr("aria-selected",
"true")):h.viewsortcols[0]||f.hide();va(u,y,g);r(u,function(){0<e.length&&(e+=", ");e+=this+" "+y[this];h.sortorder=y[this]});h.sortname=e.substring(0,e.length-h.sortorder.length-1)},Na=function(a,d,e,g,f){var k=this.grid,l=h.colModel[d],m=z("states.disabled");if(null!=l&&l.sortable&&!(0<h.savedRow.length)){e||(h.lastsort===d&&""!==h.sortname?(h.sortorder="asc"===h.sortorder?"desc":"desc"===h.sortorder?"asc":l.firstsortorder||"asc",l.lso?"asc"===l.lso?l.lso+="-desc":"desc"===l.lso?l.lso+="-asc":"asc-desc"!==
l.lso&&"desc-asc"!==l.lso||!h.threeStateSort&&!h.multiSort||(l.lso=""):l.lso=l.firstsortorder||"asc"):l.lso=h.sortorder=l.firstsortorder||"asc",h.page=1);if(h.multiSort)P(d,f);else{if(g){if(h.lastsort===d&&h.sortorder===g&&!e)return;h.sortorder=g}l=k.headers;e=k.fhDiv;g=l[h.lastsort]?b(l[h.lastsort].el):b();f=h.frozenColumns?b(f):b(l[d].el);var n=f.find("span.s-ico"),p=n.children("span.ui-icon-"+h.sortorder),q=n.children("span.ui-icon-"+("asc"===h.sortorder?"desc":"asc")),l=h.colModel[h.lastsort];
...
h.colModel.length-1;0<=w;w--)if(!0!==h.colModel[w].hidden){h.colModel[w].resizable=!1;break}var $a,Oa,Pa,ma,M,L=[],J=[];ma=[];da="<thead><tr class='ui-jqgrid-labels' role='row'>";var pa="<tbody><tr style='display:none;'>",Ja=z("states.hover"),Fa=z("states.disabled");if(h.multiSort)for(L=h.sortname.split(","),w=0;w<L.length;w++)ma=q(L[w]).split(" "),L[w]=q(ma[0]),J[w]=ma[1]?q(ma[1]):h.sortorder||"asc";for(w=0;w<h.colNames.length;w++){y=h.colModel[w];q=h.headertitles||y.headerTitle?" title='"+ib("string"===
typeof y.headerTitle?y.headerTitle:h.colNames[w])+"'":"";da+="<th id='"+h.id+"_"+y.name+"' class='"+z("colHeaders","ui-th-column ui-th-"+O+" "+(y.labelClasses||""))+"'"+q+">";q=y.index||y.name;switch(y.labelAlign){case "left":ma="text-align:left;";break;case "right":ma="text-align:right;"+(!1===y.sortable?"":"padding-right:"+h.autoResizing.widthOfVisiblePartOfSortIcon+"px;");break;case "likeData":ma=void 0===y.align||"left"===y.align?"text-align:left;":"right"===y.align?"text-align:right;"+(!1===
...
5<Math.abs(a.pageX-l)||5<Math.abs(a.pageX-m)))return!1;R.call(d,"resizeDblClick",e,f,a)&&f.autoResizable&&c.autoResizeColumn.call(k,e);R.call(d,"afterResizeDblClick",{iCol:e,cm:f,cmName:f.name});return!1});b(x).css("width",G.width+"px");var ab="";h.footerrow&&(ab+="<table role='presentation' style='width:1px' class='"+z("gridFooter","ui-jqgrid-ftable")+"'><tbody><tr role='row' class='"+z("rowFooter","footrow footrow-"+O)+"'>");var lb="<tr class='"+z("gridRow","jqgfirstrow ui-row-"+h.direction)+"' role='row' style='height:auto'>";
h.disableClick=!1;b("th",w[0].tHead.rows[0]).each(function(a){var c=h.colModel[a],d=c.name,e=b(this),g=e.children("div"),f=g.children("span.s-ico"),k=h.showOneSortIcon;$a=c.width;void 0===c.resizable&&(c.resizable=!0);c.resizable?(Oa=document.createElement("span"),b(Oa).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+O).on("selectstart",function(){return!1}),e.addClass(h.resizeclass)):Oa="";e.css("width",$a+"px").prepend(Oa);Oa=null;var l="";!0===c.hidden&&(e.css("display","none"),l=
...
b(w[0].tHead.rows[0]))}catch(Ia){}h.footerrow&&(ab+="</tr></tbody></table>");lb+="</tr>";k.html("<tbody>"+lb+"</tbody>");k.addClass(z("grid","ui-jqgrid-btable"+(!0===h.altRows&&k.jqGrid("isBootstrapGuiStyle")?" table-striped":"")));var wa=h.caption&&!0===h.hiddengrid?!0:!1,x=b("<div class='ui-jqgrid-hbox"+("rtl"===O?"-rtl":"")+"'></div>"),q=z("top"),Ca=z("bottom");G.hDiv=document.createElement("div");b(G.hDiv).css({width:G.width+"px"}).addClass(z("hDiv","ui-jqgrid-hdiv")).append(x).scroll(function(){var a=
b(this).next(".ui-jqgrid-bdiv")[0];a&&(a.scrollLeft=this.scrollLeft);return!1});b(x).append(w);w=null;wa&&b(G.hDiv).hide();h.rowNum=parseInt(h.rowNum,10);if(isNaN(h.rowNum)||0>=h.rowNum)h.rowNum=h.maxRowNum;h.pager&&("string"===typeof h.pager&&"#"!==h.pager.substr(0,1)?(w=h.pager,x=b("#"+I(h.pager))):!0===h.pager?(w=xa(),x=b("<div id='"+w+"'></div>"),x.appendTo("body"),h.pager="#"+I(w)):(x=b(h.pager),w=x.attr("id")),0<x.length?(x.css({width:G.width+"px"}).addClass(z("pager.pager","ui-jqgrid-pager "+
Ca)).appendTo(g),wa&&x.hide(),f.call(d,w,""),h.pager="#"+I(w)):h.pager="");if(!1===h.cellEdit&&!0===h.hoverrows)k.on("mouseover.jqGrid",function(a){M=b(a.target).closest("tr.jqgrow");"ui-subgrid"!==b(M).attr("class")&&b(M).addClass(Ja)}).on("mouseout.jqGrid",function(a){M=b(a.target).closest("tr.jqgrow");b(M).removeClass(Ja)});var ta,W,U,X=function(a){var c,d;do if(c=b(a).closest("td"),0<c.length){a=c.parent();d=a.parent().parent();if(a.is(".jqgrow")&&(d[0]===this||d.is("table.ui-jqgrid-btable")&&
...
m&&n)u.call(k,ta,!0,a);else{ta=l[0].rowIndex;try{c.editCell.call(k,ta,W,!0)}catch(Ib){}}else if(n)if(h.multikey)a[h.multikey]?u.call(k,ta,!0,a):h.multiselect&&m&&(m=b("#jqg_"+I(h.id)+"_"+ta).is(":checked"),b("#jqg_"+I(h.id)+"_"+ta).prop("checked",!m));else if(h.multiselect&&h.multiboxonly){if(!m){var q=h.frozenColumns?h.id+"_frozen":"";b(h.selarrrow).each(function(a,d){var g=c.getGridRowById.call(k,d);g&&b(g).removeClass(e);b("#jqg_"+I(h.id)+"_"+I(d)).prop("checked",!1);q&&(b("#"+I(d),"#"+I(q)).removeClass(e),
b("#jqg_"+I(h.id)+"_"+I(d),"#"+I(q)).prop("checked",!1))});Q(h.selarrrow)}u.call(k,ta,!0,a)}else g=h.selrow,u.call(k,ta,!0,a),"toggle"!==h.singleSelectClickMode||h.multiselect||g!==ta||(d.grid.fbRows&&(l=l.add(d.grid.fbRows[l[0].rowIndex]===l[0]?d.rows[l[0].rowIndex]:d.grid.fbRows[l[0].rowIndex])),l.removeClass(e).attr({"aria-selected":"false",tabindex:"-1"}),h.selrow=null);else m&&b(g).prop("checked",!1)}}).on("reloadGrid",function(a,d){var e=this.grid,g=b(this);!0===h.treeGrid&&(h.datatype=h.treedatatype);
d=n({},qa.reloadGridOptions||{},h.reloadGridOptions||{},d||{});"local"===h.datatype&&h.dataTypeOrg&&h.loadonce&&d.fromServer&&(h.datatype=h.dataTypeOrg,delete h.dataTypeOrg);d.current&&e.selectionPreserver.call(this);"local"===h.datatype?(h.multiPageSelection||c.resetSelection.call(g),h.data.length&&(Xa.call(this),gb())):h.treeGrid||h.multiPageSelection||(h.selrow=null,h.multiselect&&(Q(h.selarrrow),K.call(this,!1)),Q(h.savedRow));h.iRow=-1;h.iCol=-1;h.scroll&&G.emptyRows.call(this,!0,!1);if(d.page){var f=
...
h.maxHeight+(isNaN(h.maxHeight)?"":"px"));k.css({width:"1px"});b.support.tbody||2===b(">tbody",d).length&&b(">tbody:gt(0)",d).remove();if(h.multikey)b(G.bDiv).on(t.msie?"selectstart":"mousedown",function(){return!1});wa&&b(G.bDiv).hide();G.cDiv=document.createElement("div");var ea=C("gridMinimize.visible"),ia=C("gridMinimize.hidden"),v=F("showhide"),ha=!0===h.hidegrid?b("<a role='link' class='"+z("titleButton","ui-jqgrid-titlebar-close")+"'"+(v?" title='"+v+"'":"")+"/>").hover(function(){ha.addClass(Ja)},
function(){ha.removeClass(Ja)}).append("<span class='"+ea+"'></span>"):"";b(G.cDiv).append("<span class='ui-jqgrid-title'>"+h.caption+"</span>").append(ha).addClass(z("gridTitle","ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===O?"-rtl ":" ")+q));b(G.cDiv).insertBefore(G.hDiv);h.toolbar[0]&&(G.uDiv=document.createElement("div"),"top"===h.toolbar[1]?b(G.uDiv).insertBefore(G.hDiv):"bottom"===h.toolbar[1]&&b(G.uDiv).insertAfter(G.hDiv),v=z("toolbarUpper","ui-userdata"),"both"===h.toolbar[1]?(G.ubDiv=
document.createElement("div"),b(G.uDiv).addClass(v).attr("id","t_"+h.id).insertBefore(G.hDiv),b(G.ubDiv).addClass(z("toolbarBottom","ui-userdata")).attr("id","tb_"+h.id).insertAfter(G.hDiv),wa&&b(G.ubDiv).hide()):b(G.uDiv).width(G.width).addClass(v).attr("id","t_"+h.id),wa&&b(G.uDiv).hide());"string"===typeof h.datatype&&(h.datatype=h.datatype.toLowerCase());h.toppager?(h.toppager=h.id+"_toppager",G.topDiv=b("<div id='"+h.toppager+"'></div>")[0],b(G.topDiv).addClass(z("pager.pager","ui-jqgrid-toppager"+
(h.caption?"":" "+q))).css({width:G.width+"px"}).insertBefore(G.hDiv),f.call(d,h.toppager,"_t"),h.toppager="#"+I(h.toppager)):""!==h.pager||h.scroll||(h.rowNum=h.maxRowNum);h.footerrow&&(G.sDiv=b("<div class='ui-jqgrid-sdiv'></div>")[0],x=b("<div class='ui-jqgrid-hbox"+("rtl"===O?"-rtl":"")+"'></div>"),b(G.sDiv).append(x).width(G.width).insertAfter(G.hDiv),b(x).append(ab),G.footers=b(".ui-jqgrid-ftable",G.sDiv)[0].rows[0].cells,h.rownumbers&&(G.footers[0].className=z("rowNum","jqgrid-rownum")),wa&&
b(G.sDiv).hide());x=null;if(h.caption){var ua=h.datatype;!0===h.hidegrid&&(b(".ui-jqgrid-titlebar-close",G.cDiv).click(function(a){var c=".ui-jqgrid-bdiv,.ui-jqgrid-hdiv,.ui-jqgrid-pager,.ui-jqgrid-sdiv",e=this;!0===h.toolbar[0]&&("both"===h.toolbar[1]&&(c+=",#"+I(b(G.ubDiv).attr("id"))),c+=",#"+I(b(G.uDiv).attr("id")));var g=b(c,h.gView).length;h.toppager&&(c+=","+h.toppager);"visible"===h.gridstate?b(c,h.gBox).slideUp("fast",function(){g--;0===g&&(b("span",e).removeClass(ea).addClass(ia),h.gridstate=
"hidden",b(h.gBox).hasClass("ui-resizable")&&b(".ui-resizable-handle",h.gBox).hide(),b(G.cDiv).addClass(Ca),wa||R.call(d,"onHeaderClick",h.gridstate,a))}):"hidden"===h.gridstate&&(b(G.cDiv).removeClass(Ca),b(c,h.gBox).slideDown("fast",function(){g--;0===g&&(b("span",e).removeClass(ia).addClass(ea),wa&&(h.datatype=ua,ca.call(d),wa=!1),h.gridstate="visible",b(h.gBox).hasClass("ui-resizable")&&b(".ui-resizable-handle",h.gBox).show(),wa||R.call(d,"onHeaderClick",h.gridstate,a))}));return!1}),wa&&(h.datatype=
"local",b(".ui-jqgrid-titlebar-close",G.cDiv).trigger("click")))}else b(G.cDiv).hide(),b(G.cDiv).nextAll("div:visible").first().addClass("ui-corner-top");b(G.hDiv).after(G.bDiv);G.eDiv=b("<div class='"+z("gridError","ui-jqgrid-errorbar ui-jqgrid-errorbar-"+O)+"' style='display:none;'><span class='"+z("gridErrorText","ui-jqgrid-error")+"'></span></div>")[0];b(G.hDiv).after(G.eDiv);b(g).click(T).dblclick(function(a){var e=b(h.rs),g=e.offset(),f=e.data("idx"),l=e.data("delta"),m=h.colModel[f],n=b(this).data("pageX")||
...
"first last before after afterSelected beforeSelected".split(" "))&&(d="last");var g=!1,f,k,l,m,n,p,q,r,u,B,A;c&&(b.isArray(c)?(p=!0,q=a):(c=[c],p=!1),this.each(function(){var v=this.p,x=c.length,w=b(this),y=this.rows,C=0,z=D.getGridRowById,h=v.colModel,F,H=v.additionalProperties;p||(void 0!==a?a=String(a):(a=xa(),!1!==v.keyName&&(q=v.keyName,void 0!==c[0][q]&&(a=c[0][q]))));for(r=v.altclass;C<x;){u=c[C];k=[];if(p)try{a=u[q],void 0===a&&(a=xa())}catch(L){a=xa()}A=a;F={};for(m=0;m<h.length;m++)B=h[m],
...
d.caption+"</span>");var B=N.call(this,"states.hover"),A=b("<a aria-label='Close' class='"+N.call(this,"dialog.closeButton","ui-jqdialog-titlebar-close")+"'></a>").hover(function(){A.addClass(B)},function(){A.removeClass(B)}).append("<span class='"+D.getIconRes.call(this,"form.close")+"'></span>");b(r).append(A);p=document.createElement("div");b(p).addClass(N.call(this,"dialog.content","ui-jqdialog-content")).attr("id",a.modalcontent);b(p).append(c);u.appendChild(p);b(u).prepend(r);!0===f?b("body").append(m):
...
info_dialog:function(a,c,d,e){var g=this,f=g.p,k=b.extend(!0,{width:290,height:"auto",dataheight:"auto",drag:!0,resize:!1,left:250,top:170,zIndex:1E3,jqModal:!0,modal:!1,closeOnEscape:!0,align:"center",buttonalign:"center",buttons:[]},t.jqModal||{},null!=f?f.jqModal||{}:{},{caption:"<b>"+a+"</b>"},e||{}),l=k.jqModal;b.fn.jqm&&!l&&(l=!1);a="";var m=N.call(g,"states.hover");if(0<k.buttons.length)for(e=0;e<k.buttons.length;e++)void 0===k.buttons[e].id&&(k.buttons[e].id="info_button_"+e),a+=t.builderFmButon.call(g,
...
[],F=g.customSortOperations,H=function(a,d,f){b("#sopt_menu").remove();d=parseInt(d,10);f=parseInt(f,10)+18;var n,p=0,q=[],r=b(a).data("soper"),p=b(a).data("colname"),t=b(".ui-jqgrid-view").css("font-size")||"11px";d="<ul id='sopt_menu' class='"+N.call(c,"searchToolbar.menu","ui-search-menu")+"' role='menu' tabindex='0' style='z-index:9999;display:block;font-size:"+t+";left:"+d+"px;top:"+f+"px;'>";p=g.iColByName[p];if(void 0!==p){p=m[p];f=b.extend({},p.searchoptions);var y,w;f.sopt||(f.sopt=[],f.sopt[0]=
"select"===p.stype||"checkbox"===p.stype?"eq":l.defaultSearch);b.each(h,function(){q.push(this.oper)});null!=F&&b.each(F,function(b){q.push(b)});for(p=0;p<f.sopt.length;p++)t=f.sopt[p],n=b.inArray(t,q),-1!==n&&(n=h[n],void 0!==n?(w=l.operands[t],y=n.text):null!=F&&(y=F[t],w=y.operand,y=y.text),n=r===t?B:"",d+='<li class="ui-menu-item '+n+'" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="'+k(t)+'" data-oper="'+k(w)+'"><table><tr><td style="width:25px">'+
k(w)+"</td><td>"+k(y)+"</td></tr></table></a></li>");d+="</ul>";b("body").append(d);b("#sopt_menu").addClass("ui-menu ui-widget ui-widget-content ui-corner-all");b("#sopt_menu > li > a").hover(function(){b(this).addClass(u)},function(){b(this).removeClass(u)}).click(function(){var c=b(this).attr("value"),d=b(this).data("oper");e.triggerHandler("jqGridToolbarSelectOper",[c,d,a]);b("#sopt_menu").hide();b(a).data("soper",c).text(d);!0===l.autosearch&&(d=b(a).parent().next().children()[0],(b(d).val()||
"nu"===c||"nn"===c||0<=b.inArray(c,g.customUnaryOperations))&&z())})}},L,J=[],Z=b("<tr></tr>",{"class":"ui-search-toolbar",role:"row form"});l.loadFilterDefaults&&(v=y()||{});b.each(m,function(a){var d,e,k,m,y,w=this.searchoptions||{},H=this.editoptions||{},B=b("<th></th>",{"class":N.call(c,"colHeaders","ui-th-column ui-th-"+g.direction+" "+(l.applyLabelClasses?this.labelClasses||"":"")),role:"gridcell","aria-describedby":g.id+"_"+this.name}),T=b("<div></div>");e=b("<table class='ui-search-table'><tbody><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td><td class='ui-search-clear' style='width:1px'></td></tr></tbody></table>");
var D=e.children("tbody").children("tr").children("td"),I=D.eq(0),K=D.eq(1),D=D.eq(2);!0===this.hidden&&B.css("display","none");this.search=!1===this.search?!1:!0;void 0===this.stype&&(this.stype="text");d=b.extend({mode:"filter"},w);if(this.search){if(l.searchOperators){m=g.search&&null!=v[this.name]?v[this.name].op:d.sopt?d.sopt[0]:"select"===this.stype||"checkbox"===this.stype?"eq":l.defaultSearch;for(y=0;y<h.length;y++)if(h[y].oper===m){k=l.operands[m]||"";break}if(void 0===k&&null!=F)for(var M in F)if(F.hasOwnProperty(M)&&
M===m){k=F[M].operand;break}void 0===k&&(k="=");I.append("<a title='"+(null!=d.searchtitle?d.searchtitle:n("search.operandTitle"))+"' data-soper='"+m+"' class='"+N.call(c,"searchToolbar.operButton","soptclass")+"' data-colname='"+this.name+"'>"+k+"</a>")}I.data("colindex",a);null!=d.sopt&&1!==d.sopt.length||I.hide();g.search&&null!=v[this.name]&&(d.defaultValue=v[this.name].data);void 0===d.clearSearch&&(d.clearSearch="text"===this.stype?!0:!1);d.clearSearch?(k=b.isFunction(l.resetTitle)?l.resetTitle.call(c,
{options:l,cm:this,cmName:this.name,iCol:a}):(n("search.resetTitle")||"Clear Search Value")+" "+t.stripHtml(g.colNames[a]),D.append("<a title='"+k+"' aria-label='"+k+"' class='"+N.call(c,"searchToolbar.clearButton","clearsearchclass")+"'><span>"+l.resetIcon+"</span></a>")):D.hide();T.append(e);switch(this.stype){case "checkbox":a=void 0!==d.defaultValue?d.defaultValue:"-1";w=b("<input role='search' type='checkbox' class='"+A+"' name='"+(this.index||this.name)+"' id='"+x(this.name)+"' aria-labelledby='jqgh_"+
g.id+"_"+this.name+"' data-state='"+a+"'/>");"-1"===a?w.prop("indeterminate",!0):"1"===a&&w.prop("checked",!0);w.click(function(){var a=b(this);switch(a.data("state")){case -1:C(a,1);break;case 0:C(a,-1);break;default:C(a,0)}!0===l.autosearch&&z()});K.append(w);d.attr&&w.attr(d.attr);J.push({elem:w[0],options:d});break;case "select":if(e=this.surl||d.dataUrl)b.ajax(b.extend({url:e,context:{$tdInput:K,options:d,cm:this,iCol:a},dataType:"html",success:function(a,e,f){e=this.cm;var g=this.iCol,h=this.options,
...
S.value="",S.innerHTML=d.noFilterText,S.selected=!0,w.prepend(S)),void 0!==d.defaultValue&&w.val(d.defaultValue),w.addClass(A),J.push({elem:e,options:d}),K.append(e),t.fullBoolFeedback.call(c,d.selectFilled,"jqGridSelectFilled",{elem:e,options:this.searchoptions||H,cm:this,cmName:this.name,iCol:a,mode:"filter"}),!0===l.autosearch&&w.change(function(){z();return!1}))}break;case "text":w=b("<input role='search' type='text' class='"+A+"' name='"+(this.index||this.name)+"' id='"+x(this.name)+"' aria-labelledby='jqgh_"+
g.id+"_"+this.name+"' value='"+(void 0!==d.defaultValue?d.defaultValue:"")+"'/>");K.append(w);d.attr&&w.attr(d.attr);J.push({elem:w[0],options:d});!0===l.autosearch&&(l.searchOnEnter?w.keypress(function(b){return 13===(b.charCode||b.keyCode||0)?(z(),!1):this}):w.keydown(function(b){switch(b.which){case 13:return!1;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:L&&clearTimeout(L),L=setTimeout(function(){z()},l.autosearchDelay)}}));break;case "custom":K.append("<span style='width:100%;padding:0;box-sizing:border-box;' class='"+
A+"' name='"+(this.index||this.name)+"' id='"+x(this.name)+"'/>");try{if(b.isFunction(d.custom_element)){var P=d.custom_element.call(c,void 0!==d.defaultValue?d.defaultValue:"",d);if(P)P=b(P).addClass("customelement"),T.find("span[name='"+(this.index||this.name)+"']").append(P);else throw"e2";}else throw"e1";}catch(va){"e1"===va&&f.call(c,p,"function 'custom_element' "+r.nodefined,q),"e2"===va?f.call(c,p,"function 'custom_element' "+r.novalue,q):f.call(c,p,"string"===typeof va?va:va.message,q)}}}B.append(T);
B.find(".ui-search-oper .soptclass,.ui-search-clear .clearsearchclass").hover(function(){b(this).addClass(u)},function(){b(this).removeClass(u)});Z.append(B);l.searchOperators||I.hide()});b(d.hDiv).find(">div>.ui-jqgrid-htable>thead").append(Z);b.each(J,function(){t.bindEv.call(c,this.elem,this.options)});l.searchOperators&&(b(".soptclass",Z).click(function(a){var c=b(this).offset();H(this,c.left,c.top);a.stopPropagation()}),b("body").on("click",function(a){"soptclass"!==a.target.className&&b("#sopt_menu").hide()}));
...
function(){e.filter=b.extend(!0,{},e.initFilter);this.reDraw();this.onchange()};this.hideError=function(){b("th."+B,this).html("");b("tr.error",this).hide()};this.showError=function(){b("th."+B,this).html(e.errmsg);b("tr.error",this).show()};this.toUserFriendlyString=function(){return this.getStringForGroup(e.filter)};this.toString=function(){function b(c){var d="(",e;if(void 0!==c.groups)for(e=0;e<c.groups.length;e++)1<d.length&&(d="OR"===c.groupOp?d+" || ":d+" && "),d+=b(c.groups[e]);if(void 0!==
...
e,g=0,f=0,k=!1;if(1===a.nodeType){if(a.attributes.length)for(e=0;e<a.attributes.length;e+=1)c["@"+a.attributes[e].nodeName]=(a.attributes[e].nodeValue||"").toString();if(a.firstChild){for(e=a.firstChild;e;e=e.nextSibling)1===e.nodeType?k=!0:3===e.nodeType&&e.nodeValue.match(/[^ \f\n\r\t\v]/)?g+=1:4===e.nodeType&&(f+=1);if(k)if(2>g&&2>f)for(this.removeWhite(a),e=a.firstChild;e;e=e.nextSibling)3===e.nodeType?c["#text"]=this.escape(e.nodeValue):4===e.nodeType?d.test(e.nodeValue)?c[e.nodeName]=[c[e.nodeName],
...
else for(e=a.firstChild;e;e=e.nextSibling){if(d.test(a.firstChild.nodeValue)){c=a.firstChild.nodeValue;break}c["#cdata"]=this.escape(e.nodeValue)}}a.attributes.length||a.firstChild||(c=null)}else 9===a.nodeType?c=this.toObj(a.documentElement):(null!=b.jgrid&&null!=b.jgrid.defaults&&b.isFunction(b.jgrid.defaults.fatalError)?b.jgrid.defaults.fatalError:alert)("unhandled node type: "+a.nodeType);return c},toJson:function(b,c,d,e){void 0===e&&(e=!0);var a=c?'"'+c+'"':"",f="\t",k="\n",l,m,n=[];l=[];e||
(k=f="");if("[]"===b)a+=c?":[]":"[]";else if(b instanceof Array){m=0;for(l=b.length;m<l;m+=1)n[m]=this.toJson(b[m],"",d+f,e);a+=(c?":[":"[")+(1<n.length?k+d+f+n.join(","+k+d+f)+k+d:n.join(""))+"]"}else if(null===b)a+=(c&&":")+"null";else if("object"===typeof b){for(m in b)b.hasOwnProperty(m)&&(l[l.length]=this.toJson(b[m],m,d+f,e));a+=(c?":{":"{")+(1<l.length?k+d+f+l.join(","+k+d+f)+k+d:l.join(""))+"}"}else a="string"===typeof b?a+((c&&":")+'"'+b.replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"'):a+
...
b.firstChild;b;b=b.nextSibling)a+=d(b);return a},escape:function(b){return b.replace(/[\\]/g,"\\\\").replace(/[\"]/g,'\\"').replace(/[\n]/g,"\\n").replace(/[\r]/g,"\\r")},removeWhite:function(b){b.normalize();for(var a=b.firstChild,d;a;)3===a.nodeType?a.nodeValue.match(/[^ \f\n\r\t\v]/)?a=a.nextSibling:(d=a.nextSibling,b.removeChild(a),a=d):(1===a.nodeType&&this.removeWhite(a),a=a.nextSibling);return b}};window.xmlJsonClass=La;var bb=t.feedback,Da=t.fullBoolFeedback,ea=t.builderFmButon,Qa=function(b,
c,d){!0===c[0]&&(d="<span class='"+sa("fm-button-icon",d,c[2])+"'></span>","right"===c[1]?b.addClass("fm-button-icon-right").append(d):b.addClass("fm-button-icon-left").prepend(d))},W=function(b){return N.call(this,"states."+b)},Ra=function(b){return"&nbsp;"===b||"&#160;"===b||1===b.length&&160===b.charCodeAt(0)};t.extend({searchGrid:function(a){return this.each(function(){function c(a){B("beforeShow",a)&&(b(n).data("onClose",f.onClose),t.viewModal.call(d,n,{gbox:p,jqm:f.jqModal,overlay:f.overlay,
...
{},a||{}),k="fbox_"+g.id,l=f.commonIconClass,m={themodal:"searchmod"+k,modalhead:"searchhd"+k,modalcontent:"searchcnt"+k,resizeAlso:k},n="#"+I(m.themodal),p=g.gBox,q=g.gView,r=b.each,u=g.postData[f.sFilter],B=function(){var a=b.makeArray(arguments);a.unshift("Search");a.unshift("Filter");a.unshift(f);return bb.apply(d,a)},A=function(){t.hideModal(n,{gb:p,jqm:f.jqModal,onClose:f.onClose,removemodal:f.removemodal})};"string"===typeof u&&(u=""!==b.trim(u)?b.parseJSON(u):void 0);b(n).remove();if(void 0!==
b(n)[0])c(b("#fbox_"+I(g.id)));else{var v=b("<div><div id='"+k+"' class='"+N.call(d,"dialog.body","searchFilter")+"' style='overflow:auto'></div></div>").insertBefore(q);"rtl"===g.direction&&v.attr("dir","rtl");var x="",w="",y,C=!1,z,h=-1,F=b.extend([],g.colModel);z=ea.call(d,k+"_search",f.Find,sa(l,f.findDialogIcon),"right");var H=ea.call(d,k+"_reset",f.Reset,sa(l,f.resetDialogIcon),"left");f.showQuery&&(x=ea.call(d,k+"_query","Query",sa(l,f.queryDialogIcon),"left")+"&#160;");f.searchForAdditionalProperties&&
r(g.additionalProperties,function(){var b="string"===typeof this?{name:this}:this;b.label||(b.label=b.name);b.isAddProp=!0;F.push(b)});f.columns.length?(F=f.columns,h=0,y=F[0].index||F[0].name):r(F,function(b,a){a.label||(a.label=a.isAddProp?a.name:g.colNames[b]);if(!C){var c=void 0===a.search?!0:a.search,d=!0===a.hidden;if(a.searchoptions&&!0===a.searchoptions.searchhidden&&c||c&&!d)C=!0,y=a.index||a.name,h=b}});if(!u&&y||!1===f.multipleSearch)l="eq",0<=h&&F[h].searchoptions&&F[h].searchoptions.sopt?
l=F[h].searchoptions.sopt[0]:f.sopt&&f.sopt.length&&(l=f.sopt[0]),u={groupOp:"AND",rules:[{field:y,op:l,data:""}]};C=!1;f.tmplNames&&f.tmplNames.length&&(C=!0,w=f.tmplLabel,w+="<select class='ui-template'>",w+="<option value='default'>Default</option>",r(f.tmplNames,function(b,a){w+="<option value='"+b+"'>"+a+"</option>"}),w+="</select>");z="<div class='"+N.call(d,"dialog.footer")+"'><table class='EditTable' style='border:0px none;margin-top:5px' id='"+k+"_2'><tbody><tr><td colspan='2'><hr class='"+
N.call(d,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='EditButton EditButton-"+g.direction+"'  style='float:"+("rtl"===g.direction?"right":"left")+";'>"+H+w+"</td><td class='EditButton EditButton-"+g.direction+"'>"+x+z+"</td></tr></tbody></table></div>";k=I(k);f.gbox=p;f.height="auto";k="#"+k;b(k).jqFilter({columns:F,filter:f.loadDefaults?u:null,showQuery:f.showQuery,errorcheck:f.errorcheck,sopt:f.sopt,groupButton:f.multipleGroup,ruleButtons:f.multipleSearch,afterRedraw:f.afterRedraw,
ops:f.odata,cops:g.customSortOperations,operands:f.operands,ajaxSelectOptions:g.ajaxSelectOptions,groupOps:f.groupOps,onChange:function(a,c,e){a.showQuery&&b(".query",e).text(c.toUserFriendlyString());Da.call(d,f.afterChange,"jqGridFilterAfterChange",b(k),f,a,c)},direction:g.direction,id:g.id});v.append(z);if(C&&f.tmplFilters&&f.tmplFilters.length)b(".ui-template",v).on("change",function(){var a=b(this).val();"default"===a?b(k).jqFilter("addFilter",u):b(k).jqFilter("addFilter",f.tmplFilters[parseInt(a,
10)]);return!1});!0===f.multipleGroup&&(f.multipleSearch=!0);B("onInitialize",b(k));f.layer?t.createModal.call(d,m,v,f,q,b(p)[0],"#"+I(f.layer),{position:"relative"}):t.createModal.call(d,m,v,f,q,b(p)[0]);(f.searchOnEnter||f.closeOnEscape)&&b(n).keydown(function(a){var c=b(a.target);if(!(!f.searchOnEnter||13!==a.which||c.hasClass("add-group")||c.hasClass("add-rule")||c.hasClass("delete-group")||c.hasClass("delete-rule")||c.hasClass("fm-button")&&c.is("[id$=_query]")))return b(k+"_search").click(),
!1;if(f.closeOnEscape&&27===a.which)return b("#"+I(m.modalhead)).find(".ui-jqdialog-titlebar-close").click(),!1});if(x)b(k+"_query").on("click",function(){b(".queryresult",v).toggle();return!1});void 0===f.stringResult&&(f.stringResult=f.multipleSearch);b(k+"_search").on("click",function(){var a={},c="",h,l=b(k);h=l.find(".input-elm");h.filter(":focus")&&(h=h.filter(":focus"));h.change();h=l.jqFilter("filterData");if(f.errorcheck&&(l[0].hideError(),f.showQuery||l.jqFilter("toSQLString"),l[0].p.error))return l[0].showError(),
!1;if(f.stringResult||"local"===g.datatype){try{c=window.JSON&&window.JSON.stringify?JSON.stringify(h):La.toJson(h,"","",!1)}catch(G){}"string"===typeof c&&(a[f.sFilter]=c,r([f.sField,f.sValue,f.sOper],function(){a[this]=""}))}else f.multipleSearch?(a[f.sFilter]=h,r([f.sField,f.sValue,f.sOper],function(){a[this]=""})):(a[f.sField]=h.rules[0].field,a[f.sValue]=h.rules[0].data,a[f.sOper]=h.rules[0].op,a[f.sFilter]="");g.search=!0;b.extend(g.postData,a);Da.call(d,f.onSearch,"jqGridFilterSearch",g.filters)&&
e.trigger("reloadGrid",[b.extend({page:1},f.reloadGridSearchOptions||{})]);f.closeAfterSearch&&A();return!1});b(k+"_reset").on("click",function(){var a={},c=b(k);g.search=!1;g.resetsearch=!0;!1===f.multipleSearch?a[f.sField]=a[f.sValue]=a[f.sOper]="":a[f.sFilter]="";c[0].resetFilter();C&&b(".ui-template",v).val("default");b.extend(g.postData,a);Da.call(d,f.onReset,"jqGridFilterReset")&&e.trigger("reloadGrid",[b.extend({page:1},f.reloadGridResetOptions||{})]);f.closeAfterReset&&A();return!1});c(b(k));
var L=W.call(d,"hover");b(".fm-button:not(."+W.call(d,"disabled").split(" ").join(".")+")",v).hover(function(){b(this).addClass(L)},function(){b(this).removeClass(L)})}}})},editGridRow:function(a,c){return this.each(function(){function d(){b(C+" > tbody > tr > td .FormElement").each(function(){var a=b(".customelement",this),c=this.name;if(a.length){if(c=a.attr("name"),a=J[c],void 0!==a&&(a=L[a],a=a.editoptions||{},b.isFunction(a.custom_value))){try{if(E[c]=a.custom_value.call(p,b("#"+I(c),C),"get"),
void 0===E[c])throw"e1";}catch(pa){"e1"===pa?t.info_dialog.call(p,K,"function 'custom_value' "+v.msg.novalue,v.bClose):t.info_dialog.call(p,K,pa.message,v.bClose)}return!0}}else switch(a=b(this)[0].type,a){case "checkbox":E[c]=b(this).is(":checked")?b(this).val():b(this).data("offval");break;case "select-one":E[c]=b("option:selected",this).val();break;case "select-multiple":E[c]=b(this).val();E[c]=E[c]?E[c].join(","):"";b("option:selected",this).each(function(a,c){b(c).text()});break;case "date":E[c]=
b(this).val();3===String(E[c]).split("-").length&&(a=J[c],void 0!==a&&(a=L[a],a=a.formatoptions||{},a=a.newformat||B.call(q,"formatter.date.newformat"),E[c]=t.parseDate.call(q[0],"Y-m-d",E[c],a)));break;default:void 0!==a&&0>b.inArray(a,v.skipPostTypes)&&(E[c]=b(this).val())}});return!0}function e(a,c){var d,e=0,f,g,h,k;if(v.checkOnSubmit||v.checkOnUpdate)v._savedData={},v._savedData[u+"_id"]=a;var l=r.colModel;if("_empty"===a)b(l).each(function(){d=this.name;g=b.extend({},this.editoptions||{});(f=
...
!1:this.selected=!1:this.selected=!0});break;case "checkbox":g=String(g);l[f].editoptions&&l[f].editoptions.value?g=l[f].editoptions.value.split(":")[0]===g:(g=g.toLowerCase(),g=0>g.search(/(false|f|0|no|n|off|undefined)/i)&&""!==g);b(d,c).prop({checked:g,defaultChecked:g});break;case "custom":try{if(l[f].editoptions&&b.isFunction(l[f].editoptions.custom_value))l[f].editoptions.custom_value.call(p,b(d,c),"set",g);else throw"e1";}catch(Ca){"e1"===Ca?t.info_dialog.call(p,K,"function 'custom_value' "+
v.msg.nodefined,v.bClose):t.info_dialog.call(p,K,Ca.message,v.bClose)}}e++}}),0<e&&b("#id_g",C).val(a))}}function g(){var a=v.url||r.editurl;b.each(L,function(c,d){var e=d.name,f=E[e];"date"!==d.formatter||null!=d.formatoptions&&!0===d.formatoptions.sendFormatted||(E[e]=b.unformat.date.call(p,f,d));"clientArray"!==a&&d.editoptions&&!0===d.editoptions.NullIfEmpty&&E.hasOwnProperty(e)&&""===f&&(E[e]="null")})}function f(){var c=[!0,"",""],d=c,f={},h=r.prmNames,k,l,m,n,w,y,B=D.getInd.call(q,a),F=!1===
B?null:p.rows[B];(y=q.triggerHandler("jqGridAddEditBeforeCheckValues",[b(x),O]))&&"object"===typeof y&&(E=y);B=!1===B?-1:B;b.isFunction(v.beforeCheckValues)&&(y=v.beforeCheckValues.call(p,E,b(x),O))&&"object"===typeof y&&(E=y);for(m in E)if(E.hasOwnProperty(m)){y=r.iColByName[m];d=t.checkValues.call(p,E[m],m,void 0,void 0,{oldValue:"_empty"===a?null:D.getCell.call(q,a,y),newValue:E[m],cmName:m,rowid:a,cm:L[y],iCol:y,iRow:B,tr:F,td:null==F?null:F.cells[y],mode:"_empty"===a?"addForm":"editForm"});if(null==
d||!0===d)d=c;if(!1===d[0])break}g();if(d[0]){f=q.triggerHandler("jqGridAddEditClickSubmit",[v,E,O]);void 0===f&&b.isFunction(v.onclickSubmit)&&(f=v.onclickSubmit.call(p,v,E,O)||{});d=q.triggerHandler("jqGridAddEditBeforeSubmit",[E,b(x),O]);if(null==d||!0===d)d=c;d[0]&&b.isFunction(v.beforeSubmit)&&(d=v.beforeSubmit.call(p,E,b(x),O),null==d||!0===d)&&(d=c)}if(d[0]&&!v.processing){v.processing=!0;b("#sData",z).addClass(Y);m=v.url||r.editurl;l=h.oper;k="clientArray"===m&&!1!==r.keyName?r.keyName:h.id;
E[l]="_empty"===b.trim(E[u+"_id"])?h.addoper:h.editoper;E[l]!==h.addoper?E[k]=E[u+"_id"]:void 0===E[k]&&(E[k]=E[u+"_id"]);delete E[u+"_id"];E=b.extend(E,v.editData,f);if(!0===r.treeGrid)for(w in E[l]===h.addoper&&(n=r.selrow,E["adjacency"===r.treeGridModel?r.treeReader.parent_id_field:"parent_id"]=n),r.treeReader)r.treeReader.hasOwnProperty(w)&&(f=r.treeReader[w],!E.hasOwnProperty(f)||E[l]===h.addoper&&"parent_id_field"===w||delete E[f]);E[k]=t.stripPref(r.idPrefix,E[k]);r.autoEncodeOnEdit&&b.each(E,
function(a,c){b.isFunction(c)||(E[a]=t.oldEncodePostedData(c))});w=b.extend({url:b.isFunction(m)?m.call(p,E[k],O,E,v):m,type:b.isFunction(v.mtype)?v.mtype.call(p,O,v,E[k],E):v.mtype,data:t.serializeFeedback.call(p,b.isFunction(v.serializeEditData)?v.serializeEditData:r.serializeEditData,"jqGridAddEditSerializeEditData",E),complete:function(a,f){q.jqGrid("progressBar",{method:"hide",loadtype:v.saveui});b("#sData",z).removeClass(Y);E[k]=b("#id_g",C).val();if(300<=a.status&&304!==a.status||0===a.status&&
4===a.readyState)d[0]=!1,d[1]=q.triggerHandler("jqGridAddEditErrorTextFormat",[a,O]),b.isFunction(v.errorTextFormat)?d[1]=v.errorTextFormat.call(p,a,O):d[1]=f+" Status: '"+a.statusText+"'. Error code: "+a.status;else{d=q.triggerHandler("jqGridAddEditAfterSubmit",[a,E,O]);if(null==d||!0===d)d=c;d[0]&&b.isFunction(v.afterSubmit)&&(d=v.afterSubmit.call(p,a,E,O),null==d||!0===d)&&(d=c)}if(!1===d[0])b("#FormError>td",C).html(d[1]),b("#FormError",C).show();else{r.autoEncodeOnEdit&&b.each(E,function(b,a){E[b]=
t.oldDecodePostedData(a)});var g=[b.extend({},v.reloadGridOptions||{})];E[l]===h.addoper?(d[2]||(d[2]=t.randId()),null==E[k]||"_empty"===E[k]||E[l]===h.addoper?E[k]=d[2]:d[2]=E[k],v.reloadAfterSubmit?q.trigger("reloadGrid",g):!0===r.treeGrid?D.addChildNode.call(q,d[2],n,E):D.addRowData.call(q,d[2],E,v.addedrow),v.closeAfterAdd?(!0!==r.treeGrid&&A.call(q,d[2]),ja()):v.clearAfterAdd&&e("_empty",x)):(v.reloadAfterSubmit?(q.trigger("reloadGrid",g),v.closeAfterEdit||setTimeout(function(){A.call(q,E[k])},
1E3)):!0===r.treeGrid?D.setTreeRow.call(q,E[k],E):D.setRowData.call(q,E[k],E),v.closeAfterEdit&&ja());if(b.isFunction(v.afterComplete)){var m=a;setTimeout(function(){q.triggerHandler("jqGridAddEditAfterComplete",[m,E,b(x),O]);v.afterComplete.call(p,m,E,b(x),O);m=null},50)}if(v.checkOnSubmit||v.checkOnUpdate)if(b(x).data("disabled",!1),"_empty"!==v._savedData[u+"_id"])for(var w in v._savedData)v._savedData.hasOwnProperty(w)&&E[w]&&(v._savedData[w]=E[w])}v.processing=!1;try{b(":input:visible",x)[0].focus()}catch(Kb){}}},
t.ajaxOptions,v.ajaxEditOptions);w.url||v.useDataProxy||(b.isFunction(r.dataProxy)?v.useDataProxy=!0:(d[0]=!1,d[1]+=" "+t.errors.nourl));d[0]&&(q.jqGrid("progressBar",{method:"show",loadtype:v.saveui,htmlcontent:v.savetext}),v.useDataProxy?(f=r.dataProxy.call(p,w,"set_"+u),void 0===f&&(f=[!0,""]),!1===f[0]?(d[0]=!1,d[1]=f[1]||"Error deleting the selected row!"):(w.data.oper===h.addoper&&v.closeAfterAdd&&ja(),w.data.oper===h.editoper&&v.closeAfterEdit&&ja())):"clientArray"===w.url?(v.reloadAfterSubmit=
!1,E=w.data,w.complete({status:200,statusText:""},"")):b.ajax(w))}!1===d[0]&&(b("#FormError>td",C).html(d[1]),b("#FormError",C).show())}function k(b,a){var c=!1,d;for(d in b)if(b.hasOwnProperty(d)&&String(b[d])!==String(a[d])){c=!0;break}return c}function l(){var a=!0;b("#FormError",C).hide();v.checkOnUpdate&&(E={},d(),G=k(E,v._savedData))&&(b(x).data("disabled",!0),b(".confirm",F).show(),a=!1);return a}function m(a,c){var d=c[1].length-1;0===a?b("#pData",z).addClass(oa):void 0!==c[1][a-1]&&V(b("#"+
I(c[1][a-1])),oa)?b("#pData",z).addClass(oa):b("#pData",z).removeClass(oa);a===d?b("#nData",z).addClass(oa):void 0!==c[1][a+1]&&V(b("#"+I(c[1][a+1])),oa)?b("#nData",z).addClass(oa):b("#nData",z).removeClass(oa)}function n(){var a=D.getDataIDs.call(q),c=b("#id_g",C).val();return[b.inArray(c,a),a]}var p=this,q=b(p),r=p.p;if(p.grid&&null!=r&&a){var u=r.id,B=D.getGridRes,A=D.setSelection,v=b.extend(!0,{top:0,left:0,width:300,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,url:null,
...
overlayClass:N.call(this,"overlay"),removemodal:!0,skipPostTypes:["image","file"],saveui:"enable",savetext:B.call(q,"defaults.savetext")||"Saving..."},B.call(q,"edit"),t.edit,r.formEditing||{},c||{}),x="FrmGrid_"+u,w=x,y="TblGrid_"+u,C="#"+I(y),z=C+"_2",h={themodal:"editmod"+u,modalhead:"edithd"+u,modalcontent:"editcnt"+u,resizeAlso:x},F="#"+I(h.themodal),H=r.gBox,L=r.colModel,J=r.iColByName,Z=1,T=0,E,G,O,ga=v.commonIconClass,ja=function(){t.hideModal(F,{gb:H,jqm:v.jqModal,onClose:v.onClose,removemodal:v.removemodal})},
K=B.call(q,"errors.errcap"),M=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("AddEdit");a.unshift(v);return bb.apply(p,a)},P=W.call(p,"hover"),oa=W.call(p,"disabled"),R=W.call(p,"select"),Y=W.call(p,"active"),ba=W.call(p,"error");b(F).remove();x="#"+I(x);"new"===a?(a="_empty",O="add",v.caption=v.addCaption):(v.caption=v.editCaption,O="edit");var Q=!0;!v.checkOnUpdate||!0!==v.jqModal&&void 0!==v.jqModal||v.modal||(Q=!1);var S=isNaN(v.dataheight)?v.dataheight:v.dataheight+"px",fa=isNaN(v.datawidth)?
v.datawidth:v.datawidth+"px",w=b("<form name='FormPost' id='"+w+"' class='FormGrid' onSubmit='return false;' style='width:"+fa+";overflow:auto;position:relative;height:"+S+";'></form>").data("disabled",!1),ca=b("<table id='"+y+"' class='EditTable'><tbody></tbody></table>");b(L).each(function(){var b=this.formoptions;Z=Math.max(Z,b?b.colpos||0:0);T=Math.max(T,b?b.rowpos||0:0)});b(w).append(ca);ba=b("<tr id='FormError' style='display:none'><td class='"+ba+"' colspan='"+2*Z+"'>&#160;</td></tr>");ba[0].rp=
0;b(ca).append(ba);ba=b("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*Z+"'>"+(v.topinfo||"&#160;")+"</td></tr>");ba[0].rp=0;b(ca).append(ba);if(M("beforeInitData",w,O)){(function(){var c=t.detectRowEditing.call(p,a);if(null!=c)if("inlineEditing"===c.mode)D.restoreRow.call(q,a);else{var c=c.savedRow,d=p.rows[c.id];D.restoreCell.call(q,c.id,c.ic);b(d.cells[c.ic]).removeClass("edit-cell "+R);b(d).addClass(R).attr({"aria-selected":"true",tabindex:"0"})}})();S=(ba="rtl"===r.direction?
!0:!1)?"nData":"pData";fa=ba?"pData":"nData";(function(a,c,d){var e=0,f=[],g=!1,h="",k;for(k=1;k<=d;k++)h+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==a&&(g=D.getInd.call(q,a));b(L).each(function(k){var l=this.name,m,n,q,w,u;m=this.editable;var y=!1,z=!1;u="_empty"===a?"addForm":"editForm";b.isFunction(m)&&(m=m.call(p,{rowid:a,iCol:k,iRow:g,cmName:l,cm:this,mode:u}));w=(this.editrules&&!0===this.editrules.edithidden?0:!0===this.hidden||"hidden"===m)?"style='display:none'":
"";switch(String(m).toLowerCase()){case "hidden":m=!0;break;case "disabled":y=m=!0;break;case "readonly":z=m=!0}if("cb"!==l&&"subgrid"!==l&&!0===m&&"rn"!==l){if(!1===g)q="";else{m=b(p.rows[g].cells[k]);try{q=b.unformat.call(p,m,{rowId:a,colModel:this},k)}catch(Lb){q=this.edittype&&"textarea"===this.edittype?m.text():m.html()}Ra(q)&&(q="")}m=b.extend({},this.editoptions||{},{id:l,name:l,rowId:a,mode:u,cm:this,iCol:k});var C=b.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||
{}),B=parseInt(C.rowpos,10)||e+1,F=parseInt(2*(parseInt(C.colpos,10)||1),10);"_empty"===a&&m.defaultValue&&(q=b.isFunction(m.defaultValue)?m.defaultValue.call(p):m.defaultValue);this.edittype||(this.edittype="text");r.autoEncodeOnEdit&&(q=t.oldDecodePostedData(q));u=t.createEl.call(p,this.edittype,m,q,!1,b.extend({},t.ajaxOptions,r.ajaxSelectOptions||{}));if(v.checkOnSubmit||v.checkOnUpdate)v._savedData[l]=q;b(u).addClass("FormElement");-1<b.inArray(this.edittype,["text","textarea","checkbox","password",
"select"])&&b(u).addClass(N.call(p,"dialog.dataField"));n=b(c).find("tr[data-rowpos="+B+"]");if(C.rowabove){var A=b("<tr><td class='contentinfo' colspan='"+2*d+"'>"+C.rowcontent+"</td></tr>");b(c).append(A);A[0].rp=B}0===n.length&&(n=b("<tr "+w+" data-rowpos='"+B+"'></tr>").addClass("FormData").attr("id","tr_"+l),b(n).append(h),b(c).append(n),n[0].rp=B);w=b("td:eq("+(F-2)+")",n[0]);n=b("td:eq("+(F-1)+")",n[0]);w.html(void 0===C.label?r.colNames[k]:C.label||"&#160;");n[Ra(n.html())?"html":"append"](C.elmprefix).append(u).append(C.elmsuffix);
y?(w.addClass(oa),n.addClass(oa),b(u).prop("readonly",!0),b(u).prop("disabled",!0)):z&&b(u).prop("readonly",!0);"custom"===this.edittype&&b.isFunction(m.custom_value)&&m.custom_value.call(p,b("#"+I(l),x),"set",q);t.bindEv.call(p,u,m);f[e]=k;e++}});0<e&&(k=b("<tr class='FormData' style='display:none'><td class='CaptionTD'>&#160;</td><td colspan='"+(2*d-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+u+"_id' value='"+a+"'/></td></tr>"),k[0].rp=e+999,b(c).append(k),v.checkOnSubmit||
v.checkOnUpdate)&&(v._savedData[u+"_id"]=a);return f})(a,ca,Z);var S=ea.call(p,S,"",sa(ga,v.prevIcon),"","left"),fa=ea.call(p,fa,"",sa(ga,v.nextIcon),"","right"),kb=ea.call(p,"sData",v.bSubmit),va=ea.call(p,"cData",v.bCancel),y="<div class='"+N.call(p,"dialog.footer")+"'><table class='EditTable' id='"+y+"_2'><tbody><tr><td colspan='2'><hr class='"+N.call(p,"dialog.hr")+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton navButton-"+r.direction+"'>"+(ba?fa+S:S+fa)+"</td><td class='EditButton EditButton-"+
r.direction+"'>"+kb+"&#160;"+va+"</td></tr>",y=y+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+(v.bottominfo||"&#160;")+"</td></tr>"),y=y+"</tbody></table></div>";if(0<T){var U=[];b.each(b(ca)[0].rows,function(b,a){U[b]=a});U.sort(function(b,a){return b.rp>a.rp?1:b.rp<a.rp?-1:0});b.each(U,function(a,c){b("tbody",ca).append(c)})}v.gbox=H;var Na=!1;!0===v.closeOnEscape&&(v.closeOnEscape=!1,Na=!0);y=b("<div></div>").append(b("<div class='"+N.call(p,"dialog.body")+"'></div>").append(w)).append(y);
t.createModal.call(p,h,y,v,r.gView,b(H)[0]);v.topinfo&&b(".tinfo",C).show();v.bottominfo&&b(".binfo",z).show();y=y=null;b(F).keydown(function(a){var c=(a.target.tagName||"").toUpperCase(),d,e;if(!0===b(x).data("disabled"))return!1;if(13===a.which&&"TEXTAREA"!==c){d=b(z).find(":focus");e=d.attr("id");if(0<d.length&&0<=b.inArray(e,["pData","nData","cData"]))return d.trigger("click"),!1;if(!0===v.savekey[0]&&13===v.savekey[1])return b("#sData",z).trigger("click"),!1}if(!0===v.savekey[0]&&a.which===v.savekey[1]&&
"TEXTAREA"!==c)return b("#sData",z).trigger("click"),!1;if(27===a.which){if(!l())return!1;Na&&ja();return!1}if(!0===v.navkeys[0]){if("_empty"===b("#id_g",C).val())return!0;if(a.which===v.navkeys[1])return b("#pData",z).trigger("click"),!1;if(a.which===v.navkeys[2])return b("#nData",z).trigger("click"),!1}});v.checkOnUpdate&&(b("a.ui-jqdialog-titlebar-close span",F).removeClass("jqmClose"),b("a.ui-jqdialog-titlebar-close",F).off("click").click(function(){if(!l())return!1;ja();return!1}));Qa(b("#sData",
z),v.saveicon,ga);Qa(b("#cData",z),v.closeicon,ga);if(v.checkOnSubmit||v.checkOnUpdate)kb=ea.call(p,"sNew",v.bYes),fa=ea.call(p,"nNew",v.bNo),va=ea.call(p,"cNew",v.bExit),h=v.zIndex||999,h++,b("<div class='"+v.overlayClass+" jqgrid-overlay confirm' style='z-index:"+h+";display:none;'>&#160;</div><div class='"+N.call(p,"dialog.content","confirm ui-jqconfirm")+"' style='z-index:"+(h+1)+"'>"+v.saveData+"<br/><br/>"+kb+fa+va+"</div>").insertAfter(x),b("#sNew",F).click(function(){f();b(x).data("disabled",
!1);b(".confirm",F).hide();return!1}),b("#nNew",F).click(function(){b(".confirm",F).hide();b(x).data("disabled",!1);setTimeout(function(){b(":input:visible",x)[0].focus()},0);return!1}),b("#cNew",F).click(function(){b(".confirm",F).hide();b(x).data("disabled",!1);ja();return!1});M("onInitializeForm",b(x),O);"_empty"!==a&&v.viewPagerButtons?b("#pData,#nData",z).show():b("#pData,#nData",z).hide();M("beforeShowForm",b(x),O);b(F).data("onClose",v.onClose);t.viewModal.call(p,F,{gbox:H,jqm:v.jqModal,overlay:v.overlay,
modal:v.modal,overlayClass:v.overlayClass,toTop:v.toTop,onHide:function(b){b.w.remove();b.o&&b.o.remove()}});Q||b("."+I(v.overlayClass)).click(function(){if(!l())return!1;ja();return!1});b(".fm-button",F).hover(function(){b(this).addClass(P)},function(){b(this).removeClass(P)});b("#sData",z).click(function(){E={};b("#FormError",C).hide();d();"_empty"===E[u+"_id"]?f():!0===v.checkOnSubmit?(G=k(E,v._savedData))?(b(x).data("disabled",!0),b(".confirm",F).show()):f():f();return!1});b("#cData",z).click(function(){if(!l())return!1;
ja();return!1});b("#nData",z).click(function(){if(!l())return!1;b("#FormError",C).hide();var a=n();a[0]=parseInt(a[0],10);if(-1!==a[0]&&a[1][a[0]+1]){if(!M("onclickPgButtons","next",b(x),a[1][a[0]]))return!1;e(a[1][a[0]+1],x);A.call(q,a[1][a[0]+1]);M("afterclickPgButtons","next",b(x),a[1][a[0]+1]);m(a[0]+1,a)}return!1});b("#pData",z).click(function(){if(!l())return!1;b("#FormError",C).hide();var a=n();if(-1!==a[0]&&a[1][a[0]-1]){if(!M("onclickPgButtons","prev",b(x),a[1][a[0]])||V(b("#"+I(a[1][a[0]-
1])),oa))return!1;e(a[1][a[0]-1],x);A.call(q,a[1][a[0]-1]);M("afterclickPgButtons","prev",b(x),a[1][a[0]-1]);m(a[0]-1,a)}return!1});M("afterShowForm",b(x),O);Q=n();m(Q[0],Q)}}})},viewGridRow:function(a,c){return this.each(function(){function d(){!0!==p.closeOnEscape&&!0!==p.navkeys[0]||setTimeout(function(){b("#cData").focus()},0)}function e(a){var c,d,e=0,f=D.getInd.call(l,a,!0),g;f&&(b("td",f).each(function(a){g=y[a];c=g.name;d=g.editrules&&!0===g.editrules.edithidden?!1:!0===g.hidden?!0:!1;"cb"!==
c&&"subgrid"!==c&&"rn"!==c&&(c=I("v_"+c),b("#"+c+" span",r).html(t.getDataFieldOfCell.call(k,f,a).html()),d&&b("#"+c,r).parents("tr:first").hide(),e++)}),0<e&&b("#id_g",r).val(a))}function g(a,c){var d=c[1].length-1;0===a?b("#pData",u).addClass(L):void 0!==c[1][a-1]&&V(b("#"+I(c[1][a-1])),L)?b("#pData",u).addClass(L):b("#pData",u).removeClass(L);a===d?b("#nData",u).addClass(L):void 0!==c[1][a+1]&&V(b("#"+I(c[1][a+1])),L)?b("#nData",u).addClass(L):b("#nData",u).removeClass(L)}function f(){var a=D.getDataIDs.call(l),
c=b("#id_g",r).val();return[b.inArray(c,a),a]}var k=this,l=b(k),m=k.p;if(k.grid&&null!=m&&a){var n=m.id,p=b.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,closeOnEscape:!1,labelswidth:"",navkeys:[!1,38,40],onClose:null,beforeShowForm:null,beforeInitData:null,viewPagerButtons:!0,removemodal:!0},D.getGridRes.call(l,"view"),t.view||{},m.formViewing||{},c||{}),q="#ViewGrid_"+I(n),r="#ViewTbl_"+I(n),u=r+"_2",B="ViewGrid_"+n,A="ViewTbl_"+n,v=p.commonIconClass,
n={themodal:"viewmod"+n,modalhead:"viewhd"+n,modalcontent:"viewcnt"+n,resizeAlso:B},x="#"+I(n.themodal),w=m.gBox,y=m.colModel,C=1,z=0,h=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("View");a.unshift(p);return bb.apply(k,a)},F=function(){t.hideModal(x,{gb:w,jqm:p.jqModal,onClose:p.onClose,removemodal:p.removemodal})},H=W.call(k,"hover"),L=W.call(k,"disabled"),J=isNaN(p.dataheight)?p.dataheight:p.dataheight+"px",Z=isNaN(p.datawidth)?p.datawidth:p.datawidth+"px",B=b("<div class='"+
N.call(k,"dialog.body")+"'><form name='FormPost' id='"+B+"' class='FormGrid' style='width:"+Z+";overflow:auto;position:relative;height:"+J+";'></form></div>"),J=B.children("form.FormGrid"),T=b("<table id='"+A+"' class='EditTable'><tbody></tbody></table>");b(x).remove();b(y).each(function(){var b=this.formoptions;C=Math.max(C,b?b.colpos||0:0);z=Math.max(z,b?b.rowpos||0:0)});J.append(T);if(h("beforeInitData",J)){(function(a,c,d){var e,f,g,h=0,n,q,r=[],w=D.getInd.call(l,a),u,v=N.call(k,"dialog.viewData"),
x=N.call(k,"dialog.viewLabel");u=String(p.labelswidth)+(!p.labelswidth||isNaN(p.labelswidth)?"":"px");var z="<td class='"+N.call(k,"dialog.viewCellLabel","CaptionTD form-view-label")+(u?"' style='width:"+u+";":"")+"'>&#160;</td><td class='"+N.call(k,"dialog.viewCellData","DataTD form-view-data")+"'>&#160;</td>",C="",B=["integer","number","currency"],F=0,A=0,G,H,E;for(u=0;u<d;u++)C+=z;b(y).each(function(){(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||
(this.formatter&&-1!==b.inArray(this.formatter,B)?F=Math.max(F,parseInt(this.width,10)):A=Math.max(A,parseInt(this.width,10)))});G=0!==F?F:0!==A?A:0;b(y).each(function(a){e=this.name;H=!1;q=(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";E="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==e&&"subgrid"!==e&&"rn"!==e&&E){n=!1===w?"":t.getDataFieldOfCell.call(k,k.rows[w],a).html();H="right"===this.align&&0!==G?!0:!1;var l=b.extend({},{rowabove:!1,
rowcontent:""},this.formoptions||{}),p=parseInt(l.rowpos,10)||h+1,u=parseInt(2*(parseInt(l.colpos,10)||1),10);if(l.rowabove){var y=b("<tr><td class='contentinfo' colspan='"+2*d+"'>"+l.rowcontent+"</td></tr>");b(c).append(y);y[0].rp=p}g=b(c).find("tr[data-rowpos="+p+"]");0===g.length&&(g=b("<tr "+q+" data-rowpos='"+p+"'></tr>").addClass("FormData").attr("id","trv_"+e),g.append(C),b(c).append(g),g[0].rp=p);l=void 0===l.label?m.colNames[a]:l.label;p=b("td:eq("+(u-1)+")",g[0]);b("td:eq("+(u-2)+")",g[0]).html("<label for='"+
...
return r})(a,T,C);var E=(J="rtl"===m.direction?!0:!1)?"pData":"nData",Z=ea.call(k,J?"nData":"pData","",sa(v,p.prevIcon),"","left"),E=ea.call(k,E,"",sa(v,p.nextIcon),"","right"),G=ea.call(k,"cData",p.bClose);if(0<z){var O=[];b.each(b(T)[0].rows,function(b,a){O[b]=a});O.sort(function(b,a){return b.rp>a.rp?1:b.rp<a.rp?-1:0});b.each(O,function(a,c){b("tbody",T).append(c)})}p.gbox=w;A=b("<div></div>").append(B).append("<div class='"+N.call(k,"dialog.footer")+"'><table border='0' class='EditTable' id='"+
A+"_2'><tbody><tr id='Act_Buttons'><td class='navButton navButton-"+m.direction+"' width='"+(p.labelswidth||"auto")+"'>"+(J?E+Z:Z+E)+"</td><td class='EditButton EditButton-"+m.direction+"'>"+G+"</td></tr></tbody></table></div>");t.createModal.call(k,n,A,p,m.gView,b(m.gView)[0]);p.viewPagerButtons||b("#pData, #nData",u).hide();A=null;b(x).keydown(function(a){var c,d;if(!0===b(q).data("disabled"))return!1;if(13===a.which&&(c=b(u).find(":focus"),d=c.attr("id"),0<c.length&&0<=b.inArray(d,["pData","nData",
...
beforeSubmit:null,onclickSubmit:null,afterSubmit:null,closeOnEscape:!1,delData:{},onClose:null,ajaxDelOptions:{},processing:!1,serializeDelData:null,useDataProxy:!1},D.getGridRes.call(g,"del"),t.del||{},e.formDeleting||{},c||{}),l="DelTbl_"+f,m="#DelTbl_"+I(f),n,p,q,r,u={themodal:"delmod"+f,modalhead:"delhd"+f,modalcontent:"delcnt"+f,resizeAlso:l},B="#"+I(u.themodal),A=e.gBox,v=k.commonIconClass,x=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("Delete");a.unshift(k);return bb.apply(d,
a)},w=W.call(d,"hover"),y=W.call(d,"active"),C=W.call(d,"error");b.isArray(a)||(a=[String(a)]);if(void 0!==b(B)[0]){if(!x("beforeInitData",b(m)))return;b("#DelData>td",m).text(a.join()).data("rowids",a);b("#DelError",m).hide();!0===k.processing&&(k.processing=!1,b("#dData",m).removeClass(y));x("beforeShowForm",b(m));t.viewModal.call(d,B,{gbox:A,jqm:k.jqModal,jqM:!1,overlay:k.overlay,toTop:k.toTop,modal:k.modal})}else{var z=isNaN(k.dataheight)?k.dataheight:k.dataheight+"px",h=isNaN(k.datawidth)?k.datawidth:
k.datawidth+"px",z="<div class='"+N.call(d,"dialog.body")+"'><div id='"+l+"' class='formdata' style='width:"+h+";overflow:auto;position:relative;height:"+z+";'>",z=z+"<table class='DelTable'><tbody>"+("<tr id='DelError' style='display:none'><td class='"+C+"'></td></tr>")+("<tr id='DelData' style='display:none'><td >"+a.join()+"</td></tr>"),z=z+("<tr><td class='delmsg' style='white-space:pre;'>"+k.msg+"</td></tr>"),z=z+"</tbody></table></div></div>",C=ea.call(d,"dData",k.bSubmit),h=ea.call(d,"eData",
k.bCancel),z=z+("<div class='"+N.call(d,"dialog.footer")+"'><table class='EditTable' id='"+l+"_2'><tbody><tr><td><hr class='"+N.call(d,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton EditButton-"+e.direction+"'>"+C+"&#160;"+h+"</td></tr></tbody></table></div>");k.gbox=A;t.createModal.call(d,u,z,k,e.gView,b(e.gView)[0]);b("#DelData>td",m).data("rowids",a);if(!x("beforeInitData",b(z)))return;b(".fm-button",m+"_2").hover(function(){b(this).addClass(w)},function(){b(this).removeClass(w)});
Qa(b("#dData",m+"_2"),k.delicon,v);Qa(b("#eData",m+"_2"),k.cancelicon,v);b("#dData",m+"_2").click(function(){var a=[!0,""],c,h=b("#DelData>td",m),l=h.text(),u=h.data("rowids"),h={};b.isFunction(k.onclickSubmit)&&(h=k.onclickSubmit.call(d,k,l)||{});b.isFunction(k.beforeSubmit)&&(a=k.beforeSubmit.call(d,l)||a);if(a[0]&&!k.processing){k.processing=!0;q=e.prmNames;n=b.extend({},k.delData,h);r=q.oper;n[r]=q.deloper;p=q.id;l=u.slice();if(!l.length)return!1;for(c in l)l.hasOwnProperty(c)&&(l[c]=t.stripPref(e.idPrefix,
l[c]));n[p]=l.join();b(this).addClass(y);c=k.url||e.editurl;c=b.extend({url:b.isFunction(c)?c.call(d,n[p],n,k):c,type:k.mtype,data:b.isFunction(k.serializeDelData)?k.serializeDelData.call(d,n):n,complete:function(c,f){var h;b("#dData",m+"_2").removeClass(y);300<=c.status&&304!==c.status||0===c.status&&4===c.readyState?(a[0]=!1,b.isFunction(k.errorTextFormat)?a[1]=k.errorTextFormat.call(d,c):a[1]=f+" Status: '"+c.statusText+"'. Error code: "+c.status):b.isFunction(k.afterSubmit)&&(a=k.afterSubmit.call(d,
c,n)||[!0]);if(!1===a[0])b("#DelError>td",m).html(a[1]),b("#DelError",m).show();else{if(k.reloadAfterSubmit&&"local"!==e.datatype)g.trigger("reloadGrid",[b.extend({},k.reloadGridOptions||{})]);else if(!0===e.treeGrid)try{D.delTreeNode.call(g,u[0])}catch(O){}else for(u=u.slice(),h=0;h<u.length;h++)D.delRowData.call(g,u[h]);setTimeout(function(){x("afterComplete",c,l,b(m))},50)}k.processing=!1;a[0]&&t.hideModal(B,{gb:A,jqm:k.jqModal,onClose:k.onClose,removemodal:k.removemodal})}},t.ajaxOptions,k.ajaxDelOptions);
c.url||k.useDataProxy||(b.isFunction(e.dataProxy)?k.useDataProxy=!0:(a[0]=!1,a[1]+=" "+t.errors.nourl));a[0]&&(k.useDataProxy?(c=e.dataProxy.call(d,c,"del_"+f),void 0===c&&(c=[!0,""]),!1===c[0]?(a[0]=!1,a[1]=c[1]||"Error deleting the selected row!"):t.hideModal(B,{gb:A,jqm:k.jqModal,onClose:k.onClose,removemodal:k.removemodal})):"clientArray"===c.url?(n=c.data,c.complete({status:200,statusText:""},"")):b.ajax(c))}!1===a[0]&&(b("#DelError>td",m).html(a[1]),b("#DelError",m).show());return!1});b("#eData",
m+"_2").click(function(){t.hideModal(B,{gb:A,jqm:k.jqModal,onClose:k.onClose,removemodal:k.removemodal});return!1});x("beforeShowForm",b(m));t.viewModal.call(d,B,{gbox:A,jqm:k.jqModal,overlay:k.overlay,toTop:k.toTop,modal:k.modal})}x("afterShowForm",b(m));!0===k.closeOnEscape&&setTimeout(function(){b(".ui-jqdialog-titlebar-close","#"+I(u.modalhead)).attr("tabindex","-1").focus()},0)}})},navGrid:function(a,c,d,e,g,f,k){"object"===typeof a&&(k=f,f=g,g=e,e=d,d=c,c=a,a=void 0);e=e||{};d=d||{};k=k||{};
g=g||{};f=f||{};return this.each(function(){var l=this,m=l.p,n=b(l);if(l.grid&&null!=m&&!(l.nav&&0<b(a).find(".navtable").length)){var p=m.id,q=b.extend({edit:!0,add:!0,del:!0,search:!0,refresh:!0,refreshstate:"firstpage",view:!1,closeOnEscape:!0,beforeRefresh:null,afterRefresh:null,cloneToTop:!1,hideEmptyPagerParts:!0,alertwidth:200,alertheight:"auto",alerttop:null,removemodal:!0,alertleft:null,alertzIndex:null,iconsOverText:!1},D.getGridRes.call(n,"nav"),t.nav||{},m.navOptions||{},c||{});q.position=
q.position||("rtl"===m.direction?"right":"left");var r,u=m.idSel,B=m.gBox,A=q.commonIconClass,v={themodal:"alertmod_"+p,modalhead:"alerthd_"+p,modalcontent:"alertcnt_"+p},x=function(){return function(){var a=document.documentElement,c=window,d=1024,e=768,f=n.closest(".ui-jqgrid").offset();void 0===b("#"+I(v.themodal))[0]&&(q.alerttop||q.alertleft||(void 0!==c.innerWidth?(d=c.innerWidth,e=c.innerHeight):null!=a&&void 0!==a.clientWidth&&0!==a.clientWidth&&(d=a.clientWidth,e=a.clientHeight),d=d/2-parseInt(q.alertwidth,
10)/2-f.left,e=e/2-25-f.top),t.createModal.call(l,v,"<div class='"+N.call(l,"dialog.body")+"'><div>"+q.alerttext+"</div></div>",{gbox:B,jqModal:q.jqModal,drag:!0,resize:!0,caption:q.alertcap,top:null!=q.alerttop?q.alerttop:e,left:null!=q.alertleft?q.alertleft:d,width:q.alertwidth,height:q.alertheight,closeOnEscape:q.closeOnEscape,zIndex:q.alertzIndex,removemodal:q.removemodal},m.gView,b(B)[0],!1));t.viewModal.call(l,"#"+I(v.themodal),{gbox:B,toTop:q.alertToTop,jqm:q.jqModal});var g=b("#"+I(v.modalhead)).find(".ui-jqdialog-titlebar-close");
g.attr({tabindex:"0",href:"#",role:"button"});setTimeout(function(){g.focus()},50)}}(),w,y=function(a){if(13===a.which&&(a=b(this).find(".ui-pg-button").filter(":focus"),0<a.length)){var c=a[0].id,c=c.substr(0,0<b(this).closest(".ui-jqgrid-toppager").length?c.length-p.length-5:c.length-p.length-1)+"mod"+m.id,d=b(".ui-jqdialog").filter(":visible").map(function(){return this.id});if(0>b.inArray(c,d))return a.trigger("click"),!1}},C=W.call(l,"hover"),z=W.call(l,"disabled"),h=N.call(l,"navButton","ui-pg-button");
if(l.grid){l.modalAlert=x;void 0===a&&(m.pager?(a=m.pager,m.toppager&&(q.cloneToTop=!0)):m.toppager&&(a=m.toppager));var F=1,H,L,J,Z,T,E,G=["left","center","right"],O="<div class='"+N.call(l,"navButton","ui-pg-button "+W.call(l,"disabled"))+"'><span class='ui-separator'></span></div>",K=function(){V(this,z)||b(this).addClass(C)},M=function(){b(this).removeClass(C)},P=function(){V(this,z)||(b.isFunction(q.addfunc)?q.addfunc.call(l):D.editGridRow.call(n,"new",e));return!1},R=function(a,c,d){if(!V(this,
z)){var e=m.selrow;e?b.isFunction(a)?a.call(l,e):D[c].call(n,e,d):x()}return!1},Q=function(){return R.call(this,q.editfunc,"editGridRow",d)},oa=function(){return R.call(this,q.viewfunc,"viewGridRow",k)},U=function(){var a;V(this,z)||(m.multiselect?(a=m.selarrrow,0===a.length&&(a=null)):a=m.selrow,a?b.isFunction(q.delfunc)?q.delfunc.call(l,a):D.delGridRow.call(n,a,g):x());return!1},Y=function(){V(this,z)||(b.isFunction(q.searchfunc)?q.searchfunc.call(l,f):D.searchGrid.call(n,f));return!1},ba=function(){if(!V(this,
z)){b.isFunction(q.beforeRefresh)&&q.beforeRefresh.call(l);m.search=!1;m.resetsearch=!0;try{if("currentfilter"!==q.refreshstate){m.postData.filters="";try{b("#fbox_"+u).jqFilter("resetFilter")}catch(S){}b.isFunction(l.clearToolbar)&&l.clearToolbar(!1)}}catch(S){}switch(q.refreshstate){case "firstpage":n.trigger("reloadGrid",[b.extend({},q.reloadGridOptions||{},{page:1})]);break;case "current":case "currentfilter":n.trigger("reloadGrid",[b.extend({},q.reloadGridOptions||{},{current:!0})])}b.isFunction(q.afterRefresh)&&
q.afterRefresh.call(l)}return!1},X=function(a,c,d){var e=b("<div class='"+h+"' tabindex='0' role='button'></div>"),f=q[a+"icon"],g=b.trim(q[a+"text"]);e.append("<div class='ui-pg-div'><span class='"+(q.iconsOverText?sa("ui-pg-button-icon-over-text",A,f):sa(A,f))+"'></span>"+(g?"<span class='ui-pg-button-text"+(q.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+g+"</span>":"")+"</div>");b(w).append(e);e.attr({title:q[a+"title"]||"",id:c||a+"_"+J}).click(d).hover(K,M);return e};q.cloneToTop&&m.toppager&&
(F=2);for(H=0;H<F;H++){w=b("<div class='ui-pg-table navtable' role='toolbar' style='float:"+("rtl"===m.direction?"right":"left")+";table-layout:auto;'></div>");0===H?(L=a,J=p,L===m.toppager&&(J+="_top",F=1)):(L=m.toppager,J=p+"_top");q.add&&X("add",e.id,P);q.edit&&X("edit",d.id,Q);q.view&&X("view",k.id,oa);q.del&&X("del",g.id,U);(q.add||q.edit||q.del||q.view)&&b(w).append(O);q.search&&(r=X("search",f.id,Y),f.showOnLoad&&!0===f.showOnLoad&&b(r,w).click());q.refresh&&X("refresh","",ba);r=b(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||
"11px";b("body").append("<div id='testpg2' class='"+N.call(l,"gBox","ui-jqgrid")+"' style='font-size:"+r+";visibility:hidden;' ></div>");r=b(w).clone().appendTo("#testpg2").width();b("#testpg2").remove();b(L+"_"+q.position,L).append(w);if(q.hideEmptyPagerParts)for(Z=0;Z<G.length;Z++)G[Z]!==q.position&&(E=b(L+"_"+G[Z],L),0===E.length||0===E[0].childNodes.length?E.hide():1===E[0].childNodes.length&&(T=E[0].firstChild,!b(T).is("table.ui-pg-table")||0!==T.rows&&0!==T.rows[0].cells.length||E.hide()));
m._nvtd&&(r>m._nvtd[0]&&(b(L+"_"+q.position,L).width(r),m._nvtd[0]=r),m._nvtd[1]=r);l.nav=!0;w.on("keydown.jqGrid",y)}n.triggerHandler("jqGridResetFrozenHeights")}}})},navButtonAdd:function(a,c){"object"===typeof a&&(c=a,a=void 0);return this.each(function(){var d=this,e=d.p;if(d.grid){var g=b.extend({caption:"newButton",title:"",onClickButton:null,position:"last",cursor:"pointer",iconsOverText:!1},D.getGridRes.call(b(d),"nav"),t.nav||{},e.navOptions||{},c||{}),f=g.id,k=W.call(d,"hover"),l=W.call(d,
"disabled"),m=N.call(d,"navButton","ui-pg-button");if(void 0===a)if(e.pager)if(D.navButtonAdd.call(b(d),e.pager,g),e.toppager)a=e.toppager,f&&(f+="_top");else return;else e.toppager&&(a=e.toppager);"string"===typeof a&&0!==a.indexOf("#")&&(a="#"+I(a));var e=b(".navtable",a),n=g.commonIconClass;if(0<e.length&&!(f&&0<e.find("#"+I(f)).length)){var p=b("<div tabindex='0' role='button'></div>");"NONE"===g.buttonicon.toString().toUpperCase()?b(p).addClass(m).append("<div class='ui-pg-div'>"+(g.caption?
"<span class='ui-pg-button-text"+(g.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+g.caption+"</span>":"")+"</div>"):b(p).addClass(m).append("<div class='ui-pg-div'><span class='"+(g.iconsOverText?sa("ui-pg-button-icon-over-text",n,g.buttonicon):sa(n,g.buttonicon))+"'></span>"+(g.caption?"<span class='ui-pg-button-text"+(g.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+g.caption+"</span>":"")+"</div>");f&&b(p).attr("id",f);"first"===g.position&&0<e.children("div.ui-pg-button").length?
...
e.summary=[];e.hideFirstGroupCol&&(e.formatDisplayField[0]=function(a){return a});a=0;for(c=d.length;a<c;a++)g=d[a],e.hideFirstGroupCol&&!g.hidden&&e.groupField[0]===g.name&&(g.formatter=k),g.summaryType&&(f={nm:g.name,st:g.summaryType,v:"",sr:g.summaryRound,srt:g.summaryRoundType||"round"},g.summaryDivider&&(f.sd=g.summaryDivider,f.vd=""),e.summary.push(f))}else c.grouping=!1})},groupingPrepare:function(a,c){this.each(function(){var d=this.p.groupingView,e=d.groups,g=d.counters,f=d.lastvalues,k=
d.isInTheSameGroup,l=d.groupField.length,m,n,p,q,r,u,t=!1,A=D.groupingCalculations.handler;for(m=0;m<l;m++)if(q=d.groupField[m],n=d.displayField[m],r=a[q],u=null==n?null:a[n],null==u&&(u=r),void 0!==r){p=[];for(n=0;n<=m;n++)p.push(a[d.groupField[n]]);n={idx:m,dataIndex:q,value:r,displayValue:u,startRow:c,cnt:1,keys:p,summary:[]};q={cnt:1,pos:e.length,summary:b.extend(!0,[],d.summary)};0===c?(e.push(n),f[m]=r,g[m]=q):"object"===typeof r||(b.isArray(k)&&b.isFunction(k[m])?k[m].call(this,f[m],r,m,d):
f[m]===r)?t?(e.push(n),f[m]=r,g[m]=q):(q=g[m],q.cnt+=1,e[q.pos].cnt=q.cnt):(e.push(n),f[m]=r,t=!0,g[m]=q);r=e[q.pos];var v;for(v=0;v<q.summary.length;v++)u=q.summary[v],p=b.isArray(u.st)?u.st[n.idx]:u.st,b.isFunction(p)?u.v=p.call(this,u.v,u.nm,a,n):(u.v=A.call(b(this),p,u.v,u.nm,u.sr,u.srt,a),"avg"===p.toLowerCase()&&u.sd&&(u.vd=A.call(b(this),p,u.vd,u.sd,u.sr,u.srt,a)));r.summary=q.summary;for(n=q.pos-1;0<=n;n--)if(e[n].idx<e[q.pos].idx){e[q.pos].parentGroupIndex=n;e[q.pos].parentGroup=e[n];break}}});
return this},getGroupHeaderIndex:function(a,c){var d=this[0].p,e=c?b(c).closest("tr.jqgroup"):b("#"+t.jqID(a)),g=parseInt(e.data("jqgrouplevel"),10),d=d.id+"ghead_"+g+"_";return isNaN(g)||!e.hasClass("jqgroup")||a.length<=d.length?-1:parseInt(a.substring(d.length),10)},groupingToggle:function(a,c){this.each(function(){var d=this.p,e=d.groupingView,g=e.minusicon,f=e.plusicon,k=c?b(c).closest("tr.jqgroup"):b("#"+t.jqID(a)),l,m,n=!0,p=!1,q=[],r=function(a){var b,c=a.length;for(b=0;b<c;b++)q.push(a[b])},
u=parseInt(k.data("jqgrouplevel"),10);d.frozenColumns&&0<k.length&&(m=k[0].rowIndex,k=b(this.rows[m]),k=k.add(this.grid.fbRows[m]));l=k.find(">td>span.tree-wrap");t.hasAllClasses(l,g)?(l.removeClass(g).addClass(f),p=!0):l.removeClass(f).addClass(g);for(k=k.next();k.length;k=k.next())if(k.hasClass("jqfoot"))if(l=parseInt(k.data("jqfootlevel"),10),p){if(l=parseInt(k.data("jqfootlevel"),10),(!e.showSummaryOnHide&&l===u||l>u)&&r(k),l<u)break}else{if((l===u||e.showSummaryOnHide&&l===u+1)&&r(k),l<=u)break}else if(k.hasClass("jqgroup"))if(l=
parseInt(k.data("jqgrouplevel"),10),p){if(l<=u)break;r(k)}else{if(l<=u)break;l===u+1&&(k.find(">td>span.tree-wrap").removeClass(g).addClass(f),r(k));n=!1}else(p||n)&&r(k);b(q).css("display",p?"none":"");d.frozenColumns&&b(this).triggerHandler("jqGridResetFrozenHeights",[{header:{resizeDiv:!1,resizedRows:{iRowStart:-1,iRowEnd:-1}},resizeFooter:!1,body:{resizeDiv:!0,resizedRows:{iRowStart:m,iRowEnd:k.length?k[0].rowIndex-1:-1}}}]);this.fixScrollOffsetAndhBoxPadding();b(this).triggerHandler("jqGridGroupingClickGroup",
[a,p]);b.isFunction(d.onClickGroup)&&d.onClickGroup.call(this,a,p)});return!1},groupingRender:function(a,c){function d(a,c,d,e,k){var h=q[a],l,n="",p,w,v,x=0,y,z,C,B=!0;if(0!==c&&0!==q[a].idx)for(l=a;0<=l;l--)if(q[l].idx===q[a].idx-c){h=q[l];break}a=h.cnt;for(y=void 0===k?e:0;y<u;y++){c="&#160;";l=r[y];for(p=0;p<h.summary.length;p++)if(w=h.summary[p],z=b.isArray(w.st)?w.st[d.idx]:w.st,C=b.isArray(l.summaryTpl)?l.summaryTpl[d.idx]:l.summaryTpl||"{0}",w.nm===l.name){"string"===typeof z&&"avg"===z.toLowerCase()&&
(w.sd&&w.vd?w.v/=w.vd:w.v&&0<a&&(w.v/=a));try{w.groupCount=h.cnt,w.groupIndex=h.dataIndex,w.groupValue=h.value,v=g.formatter("",w.v,y,w)}catch(ja){v=w.v}c=t.format(C,v);l.summaryFormat&&(c=l.summaryFormat.call(g,d,c,v,l,w));break}w=p=!1;void 0!==k&&B&&!l.hidden&&(c=k,B=!1,1<e&&(p=!0,x=e-1),w=l.align,l.align="rtl"===f.direction?"right":"left",m.iconColumnName=l.name);0<x&&!l.hidden&&"&#160;"===c?(w&&(l.align=w),x--):(n+="<td role='gridcell' "+g.formatCol(y,1,"")+(p?"colspan='"+e+"'":"")+">"+c+"</td>",
w&&(l.align=w))}return n}var e="",g=this[0],f=g.p,k=0,l=[],m=f.groupingView,n=b.makeArray(m.groupSummary),p=m.groupField.length,q=m.groups,r=f.colModel,u=r.length,B=f.page,A=D.getGuiStyles.call(g,"gridRow","jqgroup ui-row-"+f.direction),v=D.getGuiStyles.call(g,"gridRow","jqfoot ui-row-"+f.direction);b.each(r,function(a,b){var c;for(c=0;c<p;c++)if(m.groupField[c]===b.name){l[c]=a;break}});n.reverse();b.each(q,function(x,w){var y,C=f.id+"ghead_"+w.idx,z=C+"_"+x,h=b.isFunction(m.groupCollapse)?m.groupCollapse.call(g,
{group:w,rowid:z}):m.groupCollapse,F,H;H=0;var D,J;D=p-1===w.idx;var I=null!=w.parentGroup?w.parentGroup.collapsed:!1;J="<span style='cursor:pointer;margin-"+("rtl"===f.direction?"right:":"left:")+12*w.idx+"px;' class='"+m.commonIconClass+" "+(h?m.plusicon:m.minusicon)+" tree-wrap' onclick=\"jQuery('#"+t.jqID(f.id).replace("\\","\\\\")+"').jqGrid('groupingToggle','"+z+"', this);return false;\"></span>";if(m._locgr&&!(w.startRow+w.cnt>(B-1)*c&&w.startRow<B*c))return!0;I&&(h=!0);void 0!==h&&(w.collapsed=
h);k++;try{b.isArray(m.formatDisplayField)&&b.isFunction(m.formatDisplayField[w.idx])?(w.displayValue=m.formatDisplayField[w.idx].call(g,w.displayValue,w.value,r[l[w.idx]],w.idx,m),y=w.displayValue):y=g.formatter(z,w.displayValue,l[w.idx],w.value)}catch(T){y=w.displayValue}e+="<tr id='"+z+"' data-jqgrouplevel='"+w.idx+"' "+(h&&I?"style='display:none;' ":"")+"role='row' class='"+A+" "+C+"'>";C=b.isFunction(m.groupText[w.idx])?m.groupText[w.idx].call(g,y,w.cnt,w.summary):t.template(m.groupText[w.idx],
y,w.cnt,w.summary);"string"!==typeof C&&"number"!==typeof C&&(C=y);"header"===m.groupSummaryPos[w.idx]?(y=1,"cb"!==r[0].name&&"cb"!==r[1].name||y++,"subgrid"!==r[0].name&&"subgrid"!==r[1].name||y++,e+=d(x,0,w,y,J+"<span class='cell-wrapper'>"+C+"</span>")):e+="<td role='gridcell' style='padding-left:"+12*w.idx+"px;' colspan='"+u+"'>"+J+C+"</td>";e+="</tr>";if(D){D=q[x+1];y=w.startRow;J=void 0!==D?D.startRow:q[x].startRow+q[x].cnt;m._locgr&&(H=(B-1)*c,H>w.startRow&&(y=H));for(;y<J&&a[y-H];y++)e+=a[y-
H].join("");if("header"!==m.groupSummaryPos[w.idx]){if(void 0!==D){for(F=0;F<m.groupField.length&&D.dataIndex!==m.groupField[F];F++);k=m.groupField.length-F}for(H=0;H<k;H++)n[H]&&(e+="<tr data-jqfootlevel='"+(w.idx-H)+(h&&(0<w.idx-H||!m.showSummaryOnHide)?"' style='display:none;'":"'")+" role='row' class='"+v+"'>",e+=d(x,H,q[w.idx-H],0),e+="</tr>");k=F}}});this.off("jqGridShowHideCol.groupingRender").on("jqGridShowHideCol.groupingRender",function(){var a=f.iColByName[m.iconColumnName],c,d,e;if(0<=
...
b.makeArray(arguments).slice(1);c.unshift("");c.unshift("Inline");c.unshift(a);return t.feedback.apply(this,c)};t.inlineEdit=t.inlineEdit||{};t.extend({editRow:function(a,c,d,e,g,f,k,l,m,n){var p={},q=b.makeArray(arguments).slice(1);"object"===b.type(q[0])?p=q[0]:(void 0!==c&&(p.keys=c),b.isFunction(d)&&(p.oneditfunc=d),b.isFunction(e)&&(p.successfunc=e),void 0!==g&&(p.url=g),null!=f&&(p.extraparam=f),b.isFunction(k)&&(p.aftersavefunc=k),b.isFunction(l)&&(p.errorfunc=l),b.isFunction(m)&&(p.afterrestorefunc=
m),b.isFunction(n)&&(p.beforeEditRow=n));return this.each(function(){var c=this,d=b(c),e=c.p,f=0,g=null,k={},l=e.colModel,m=e.prmNames;if(c.grid){var n=b.extend(!0,{keys:!1,oneditfunc:null,successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,beforeEditRow:null,mtype:"POST",focusField:!0},t.inlineEdit,e.inlineEditing||{},p),q=d.jqGrid("getInd",a,!0),h=n.focusField,F="object"===typeof h&&null!=h?b(h.target||h).closest("tr.jqgrow>td")[0]:
null;if(!1!==q&&(n.extraparam[m.oper]===m.addoper||cb.call(c,n,"beforeEditRow",n,a))&&"0"===(b(q).attr("editable")||"0")&&!b(q).hasClass("not-editable-row")){m=t.detectRowEditing.call(c,a);if(null!=m&&"cellEditing"===m.mode){var m=m.savedRow,H=c.rows[m.id],D=W.call(c,"select");d.jqGrid("restoreCell",m.id,m.ic);b(H.cells[m.ic]).removeClass("edit-cell "+D);b(H).addClass(D).attr({"aria-selected":"true",tabindex:"0"})}t.enumEditableCells.call(c,q,b(q).hasClass("jqgrid-new-row")?"add":"edit",function(d){var h=
...
e&&(n.extraparam=e),A(g)&&(n.aftersavefunc=g),A(f)&&(n.errorfunc=f),A(k)&&(n.afterrestorefunc=k),A(l)&&(n.beforeSaveRow=l));var m=function(a){return q.jqGrid("getGridRes",a)},n=b.extend(!0,{successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,beforeSaveRow:null,ajaxSaveOptions:{},serializeSaveData:null,mtype:"POST",saveui:"enable",savetext:m("defaults.savetext")||"Saving..."},t.inlineEdit,r.inlineEditing||{},n),x={},w={},y={},C,z,h,F=
q.jqGrid("getInd",a,!0),H=b(F),D=r.prmNames,J=m("errors.errcap"),I=m("edit.bClose"),K,E;if(!1!==F&&(u=n.extraparam[D.oper]===D.addoper?"add":"edit",cb.call(p,n,"beforeSaveRow",n,a,u)&&(m=H.attr("editable"),n.url=n.url||r.editurl,K="clientArray"!==n.url,"1"===m&&(t.enumEditableCells.call(p,F,H.hasClass("jqgrid-new-row")?"add":"edit",function(c){var d=c.cm,e=d.formatter,f=d.editoptions||{},g=d.formatoptions||{},k={},l=(b.jgrid.detectRowEditing.call(p,a)||{}).savedRow,m=t.getEditedValue.call(p,b(c.dataElement),
d,k,c.editable);"select"===d.edittype&&"select"!==d.formatter&&(w[d.name]=k.text);h=t.checkValues.call(p,m,c.iCol,void 0,void 0,b.extend(c,{oldValue:null!=l?l[d.name]:null,newValue:m,oldRowData:l}));if(null!=h&&!1===h[0]){E=!0;try{var n=t.getRelativeRect.call(p,c.td);B.call(p,J,h[1],I,{top:n.top,left:n.left+b(p).closest(".ui-jqgrid").offset().left})}catch(Y){v(h[1])}return!1}"date"===e&&!0!==g.sendFormatted&&(m=b.unformat.date.call(p,m,d));K&&!0===f.NullIfEmpty&&""===m&&(m="null");x[d.name]=m}),!E))))if(m=
a,D=r.prmNames,z=!1===r.keyName?D.id:r.keyName,x&&(x[D.oper]=D.editoper,void 0===x[z]||""===x[z]?x[z]=a:F.id!==r.idPrefix+x[z]&&(F=t.stripPref(r.idPrefix,a),void 0!==r._index[F]&&(r._index[x[z]]=r._index[F],delete r._index[F]),a=r.idPrefix+x[z],H.attr("id",a),r.selrow===m&&(r.selrow=a),b.isArray(r.selarrrow)&&(F=b.inArray(m,r.selarrrow),0<=F&&(r.selarrrow[F]=a)),r.multiselect&&(F="jqg_"+r.id+"_"+a,H.find("input.cbox").attr("id",F).attr("name",F))),x=b.extend({},x,r.inlineData||{},n.extraparam)),K)q.jqGrid("progressBar",
{method:"show",loadtype:n.saveui,htmlcontent:n.savetext}),y=b.extend({},x,y),y[z]=t.stripPref(r.idPrefix,y[z]),r.autoEncodeOnEdit&&b.each(y,function(a,b){A(b)||(y[a]=t.oldEncodePostedData(b))}),b.ajax(b.extend({url:A(n.url)?n.url.call(p,y[z],u,y,n):n.url,data:t.serializeFeedback.call(p,A(n.serializeSaveData)?n.serializeSaveData:r.serializeRowData,"jqGridInlineSerializeSaveData",y),type:A(n.mtype)?n.mtype.call(p,u,n,y[z],y):n.mtype,complete:function(c,d){q.jqGrid("progressBar",{method:"hide",loadtype:n.saveui});
if((300>c.status||304===c.status)&&(0!==c.status||4!==c.readyState)){var e,f;f=q.triggerHandler("jqGridInlineSuccessSaveRow",[c,a,n]);if(null==f||!0===f)f=[!0,x];f[0]&&A(n.successfunc)&&(f=n.successfunc.call(p,c));b.isArray(f)?(e=f[0],x=f[1]||x):e=f;if(!0===e){r.autoEncodeOnEdit&&b.each(x,function(a,b){x[a]=t.oldDecodePostedData(b)});x=b.extend({},x,w);q.jqGrid("setRowData",a,x);H.attr("editable","0");for(e=0;e<r.savedRow.length;e++)if(String(r.savedRow[e].id)===String(a)){C=e;break}0<=C&&r.savedRow.splice(C,
1);Da.call(p,n.aftersavefunc,"jqGridInlineAfterSaveRow",a,c,x,n);H.removeClass("jqgrid-new-row").off("keydown")}else Da.call(p,n.errorfunc,"jqGridInlineErrorSaveRow",a,c,d,null,n),!0===n.restoreAfterError&&q.jqGrid("restoreRow",a,n.afterrestorefunc)}},error:function(b,c,d){q.triggerHandler("jqGridInlineErrorSaveRow",[a,b,c,d,n]);if(A(n.errorfunc))n.errorfunc.call(p,a,b,c,d);else{b=b.responseText||b.statusText;try{B.call(p,J,'<div class="'+W.call(p,"error")+'">'+b+"</div>",I,{buttonalign:"right"})}catch(ja){v(b)}}!0===
n.restoreAfterError&&q.jqGrid("restoreRow",a,n.afterrestorefunc)}},t.ajaxOptions,r.ajaxRowOptions,n.ajaxSaveOptions||{}));else{x=b.extend({},x,w);z=q.jqGrid("setRowData",a,x);H.attr("editable","0");for(u=0;u<r.savedRow.length;u++)if(String(r.savedRow[u].id)===String(m)){C=u;break}0<=C&&r.savedRow.splice(C,1);Da.call(p,n.aftersavefunc,"jqGridInlineAfterSaveRow",a,z,x,n);H.removeClass("jqgrid-new-row").off("keydown")}}},restoreRow:function(a,c){var d=b.makeArray(arguments).slice(1),e={};"object"===
b.type(d[0])?e=d[0]:b.isFunction(c)&&(e.afterrestorefunc=c);return this.each(function(){var c=this,d=b(c),k=c.p,l=-1,m={},n;if(c.grid){var p=b.extend(!0,{},t.inlineEdit,k.inlineEditing||{},e),q=d.jqGrid("getInd",a,!0);if(!1!==q&&cb.call(c,p,"beforeCancelRow",p,a)){for(n=0;n<k.savedRow.length;n++)if(String(k.savedRow[n].id)===String(a)){l=n;break}if(0<=l){if(b.isFunction(b.fn.datepicker))try{b("input.hasDatepicker","#"+t.jqID(q.id)).datepicker("hide")}catch(r){}b.each(k.colModel,function(){var a=this.name;
k.savedRow[l].hasOwnProperty(a)&&(m[a]=k.savedRow[l][a],!this.formatter||"date"!==this.formatter||null!=this.formatoptions&&!0===this.formatoptions.sendFormatted||(m[a]=b.unformat.date.call(c,m[a],this)))});d.jqGrid("setRowData",a,m);b(q).attr("editable","0").off("keydown");k.savedRow.splice(l,1);b("#"+t.jqID(a),c).hasClass("jqgrid-new-row")&&setTimeout(function(){d.jqGrid("delRowData",a);d.jqGrid("showAddEditButtons",!1)},0)}Da.call(c,p.afterrestorefunc,"jqGridInlineAfterRestoreRow",a)}}})},addRow:function(a){return this.each(function(){if(this.grid){var c=
this,d=b(c),e=c.p,g=b.extend(!0,{rowID:null,initdata:{},position:"first",useDefValues:!0,useFormatter:!1,beforeAddRow:null,addRowParams:{extraparam:{}}},t.inlineEdit,e.inlineEditing||{},a||{});cb.call(c,g,"beforeAddRow",g.addRowParams)&&(g.rowID=b.isFunction(g.rowID)?g.rowID.call(c,g):null!=g.rowID?g.rowID:t.randId(),!0===g.useDefValues&&b(e.colModel).each(function(){if(this.editoptions&&this.editoptions.defaultValue){var a=this.editoptions.defaultValue;g.initdata[this.name]=b.isFunction(a)?a.call(c):
a}}),g.rowID=e.idPrefix+g.rowID,d.jqGrid("addRowData",g.rowID,g.initdata,g.position),b("#"+t.jqID(g.rowID),c).addClass("jqgrid-new-row"),g.useFormatter?b("#"+t.jqID(g.rowID)+" .ui-inline-edit",c).click():(e=e.prmNames,g.addRowParams.extraparam[e.oper]=e.addoper,d.jqGrid("editRow",g.rowID,g.addRowParams),d.jqGrid("setSelection",g.rowID)))}})},inlineNav:function(a,c){"object"===typeof a&&(c=a,a=void 0);return this.each(function(){var d=this,e=b(d),g=d.p;if(this.grid&&null!=g){var f,k=a===g.toppager?
...
function(){e.jqGrid("showAddEditButtons",!1)});e.on("jqGridInlineEditRow",function(a,b){e.jqGrid("showAddEditButtons",!0,b)})}}})},showAddEditButtons:function(a){return this.each(function(){if(this.grid){var c=this.p,d=c.idSel,e=W.call(this,"disabled"),g=d+"_ilsave,"+d+"_ilcancel"+(c.toppager?","+d+"_top_ilsave,"+d+"_top_ilcancel":""),c=d+"_iladd,"+d+"_iledit"+(c.toppager?","+d+"_top_iladd,"+d+"_top_iledit":"");b(a?c:g).addClass(e);b(a?g:c).removeClass(e)}})}});var ia=null!=b.ui?b.ui.multiselect:
null,tb=function(a){if(null!=this.grid&&null!=this.grid.p){var c=this,d=this.grid.p,e,g,f,k,l=this.gh,m=this.selectedList,n=this.inGroup,p=m.find("li"),q=p.length-1,r=function(a,c,d){var e,f=m.find("li");for(void 0===c&&(c=d?f.length-1:0);d?0<=c:c<f.length;d?c--:c++)if((e=b(f[c]).data("optionLink"))&&a.call(f[c],parseInt(e.val(),10),c))return c},u=function(){g=b.inArray(d.colModel[a].name,c.newColOrder);0<=g&&c.newColOrder.splice(g,1);p=m.find("li");e=0;r(function(f,g){if(f===a){for(q=g;0<=e&&e<d.colModel.length&&
(d.colModel[e].hidden||d.colModel[e].hidedlg)&&null!=n&&n[e]===n[a];)e++;c.newColOrder.splice(e,0,d.colModel[a].name);return!0}e=b.inArray(d.colModel[f].name,c.newColOrder,e);0>e&&(e=b.inArray(d.colModel[f].name,c.newColOrder));e++})},t=function(c){if(n[c]===n[a])return b(this).after(p[q]),u(),!0},A=function(c){if(n[c]===n[a])return b(this).before(p[q]),u(),!0},v=function(b){if(n[b]===n[a]&&void 0!==n[b])return l[n[b]].startColumnName=d.colModel[b].name,!0};u();if(l&&void 0!==l[n[a]])for(k=l[n[a]],
g=0;g<k.numberOfColumns;g++){if(e=d.iColByName[k.startColumnName]+g,!d.colModel[e].hidden&&!d.colModel[e].hidedlg){r(t,q-1,!0);r(A,q+1);r(v);break}}else!l||(p=m.find("li"),g=r(function(b){if(b===a)return!0}),g+1>=p.length||0>g||!(k=b(p[g+1]).data("optionLink")))||(f=n[parseInt(k.val(),10)],void 0!==f&&(k=b(p[g-1]).data("optionLink"))&&n[parseInt(k.val(),10)]===f&&(k=r(function(a){if(n[a]!==f)return!0},g+1),b(p[void 0===k||k>=p.length?p.length-1:k-1]).after(p[q]),u()))}};t.msie&&8===t.msiever()&&(b.expr[":"].hidden=
function(a){return 0===a.offsetWidth||0===a.offsetHeight||"none"===a.style.display});t._multiselect=!1;if(ia){if(ia.prototype._setSelected){var Fb=ia.prototype._setSelected;ia.prototype._setSelected=function(a,c){var d=Fb.call(this,a,c),e=this.element,g=parseInt(a.data("optionLink").val(),10);c&&this.selectedList&&(tb.call(this,g),this.selectedList.find("li").each(function(){b(this).data("optionLink")&&b(this).data("optionLink").remove().appendTo(e)}));return d}}ia.prototype.destroy&&(ia.prototype.destroy=
...
e.id+"_",k=[];f.each(function(){var a=b(">div",this).get(0).id.replace(/^jqgh_/,"").replace(g,""),a=e.iColByName[a];void 0!==a&&k.push(a)});b(d).jqGrid("remapColumns",k,!0,!0);b.isFunction(e.sortable.update)&&e.sortable.update(k);setTimeout(function(){e.disableClick=!1},50)}};e.sortable.options?b.extend(g,e.sortable.options):b.isFunction(e.sortable)&&(e.sortable={update:e.sortable});if(g.start){var f=g.start;g.start=function(a,b){c();f.call(this,a,b)}}else g.start=c;e.sortable.exclude&&(g.items+=
":not("+e.sortable.exclude+")");g=a.sortable(g);g=g.data("sortable")||g.data("uiSortable")||g.data("ui-sortable");null!=g&&(g.floating=!0)})},columnChooser:function(a){function c(a,c){a&&("string"===typeof a?b.fn[a]&&b.fn[a].apply(c,b.makeArray(arguments).slice(2)):b.isFunction(a)&&a.apply(c,b.makeArray(arguments).slice(2)))}var d=this,e=d[0],g=e.p,f,k,l,m,n,p=g.colModel,q=p.length,r=g.colNames,u=function(a){return ia&&ia.prototype&&a.data(ia.prototype.widgetFullName||ia.prototype.widgetName)||a.data("ui-multiselect")||
a.data("multiselect")};if(!b("#colchooser_"+I(g.id)).length){f=b('<div id="colchooser_'+g.id+'" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>');k=b("select",f);a=b.extend({width:400,height:240,classname:null,done:function(a){a&&d.jqGrid("remapColumns",a,!0)},msel:"multiselect",dlog:"dialog",dialog_opts:{minWidth:470,dialogClass:"ui-jqdialog"},dlog_opts:function(a){var c={};c[a.bSubmit]=function(){a.apply_perm();a.cleanup(!1)};c[a.bCancel]=function(){a.cleanup(!0)};
...
m.gh,null!=g.pivotOptions&&null!=g.pivotOptions.colHeaders&&1<g.pivotOptions.colHeaders.length)for(c=g.pivotOptions.colHeaders,e=0;e<c.length;e++)c[e]&&c[e].groupHeaders.length&&d.jqGrid("setGroupHeaders",c[e]);else d.jqGrid("setGroupHeaders",g.groupHeader);e=g.autowidth||void 0!==g.widthOrg&&"auto"!==g.widthOrg&&"100%"!==g.widthOrg?g.width:g.tblwidth;e!==g.width&&d.jqGrid("setGridWidth",e,g.shrinkToFit)},cleanup:function(b){c(a.dlog,f,"destroy");c(a.msel,k,"destroy");f.remove();b&&a.done&&a.done.call(d)},
msel_opts:{}},d.jqGrid("getGridRes","col"),t.col,a||{});if(b.ui&&ia&&ia.defaults){if(!t._multiselect){(null!=t.defaults&&b.isFunction(t.defaults.fatalError)?t.defaults.fatalError:alert)("Multiselect plugin loaded after jqGrid. Please load the plugin before the jqGrid!");return}a.msel_opts=b.extend(ia.defaults,a.msel_opts)}a.caption&&f.attr("title",a.caption);a.classname&&(f.addClass(a.classname),k.addClass(a.classname));a.width&&(b(">div",f).css({width:a.width,margin:"0 auto"}),k.css("width",a.width));
a.height&&(b(">div",f).css("height",a.height),k.css("height",a.height-10));k.empty();n=null!=g.groupHeader?g.groupHeader.groupHeaders:0;var B={},A,v,x;if(n)for(A=0;A<n.length;A++)for(x=n[A],v=0;v<x.numberOfColumns;v++)l=g.iColByName[x.startColumnName]+v,B[l]=b.isFunction(a.buildItemText)?a.buildItemText.call(d[0],{iCol:l,cm:p[l],cmName:p[l].name,colName:r[l],groupTitleText:x.titleText}):b.jgrid.stripHtml(x.titleText)+": "+b.jgrid.stripHtml(""===r[l]?p[l].name:r[l]);for(l=0;l<q;l++)void 0===B[l]&&
(B[l]=b.isFunction(a.buildItemText)?a.buildItemText.call(d[0],{iCol:l,cm:p[l],cmName:p[l].name,colName:r[l],groupTitleText:null}):b.jgrid.stripHtml(r[l]));b.each(p,function(a){this.hidedlg||k.append("<option value='"+a+"'"+(g.headertitles||this.headerTitle?" title='"+t.stripHtml("string"===typeof this.headerTitle?this.headerTitle:B[a])+"'":"")+(this.hidden?"":" selected='selected'")+">"+B[a]+"</option>")});l=b.isFunction(a.dlog_opts)?a.dlog_opts.call(d,a):a.dlog_opts;c(a.dlog,f,l);l=b.isFunction(a.msel_opts)?
a.msel_opts.call(d,a):a.msel_opts;c(a.msel,k,l);l=b("#colchooser_"+I(g.id));l.css({margin:"auto"});l.find(">div").css({width:"100%",height:"100%",margin:"auto"});if(m=u(k)){m.grid=e;if(n)for(m.gh=b.extend(!0,[],n),m.inGroup=Array(g.colModel.length),q=0;q<n.length;q++)for(r=n[q],l=0;l<r.numberOfColumns;l++)m.inGroup[g.iColByName[r.startColumnName]+l]=q;m.newColOrder=b.map(p,function(a){return a.name});m.container.css({width:"100%",height:"100%",margin:"auto"});m.selectedContainer.css({width:100*m.options.dividerLocation+
...
a._update_=!1,a.start=function(g,f){b(f.item).css("border-width","0");b("td",f.item).each(function(a){this.style.width=d.cols[a].style.width});if(e.subGrid){var k=b(f.item).attr("id");try{b(c).jqGrid("collapseSubGridRow",k)}catch(l){}}a._start_&&a._start_.apply(this,[g,f])},a.update=function(d,f){b(f.item).css("border-width","");!0===e.rownumbers&&b("td.jqgrid-rownum",c.rows).each(function(a){b(this).html(a+1+(parseInt(e.page,10)-1)*parseInt(e.rowNum,10))});a._update_&&a._update_.apply(this,[d,f])},
...
"dnd").connectWith,-1!==b.inArray("#"+I(this.id),a)?!0:!1):!1},drop:function(c,e){if(b(e.draggable).hasClass("jqgrow")){var f=b(e.draggable).attr("id"),f=e.draggable.parent().parent().jqGrid("getRowData",f);if(!a.dropbyname){var g=0,k={},l,r,u=b("#"+I(this.id)).jqGrid("getGridParam","colModel");try{for(r in f)f.hasOwnProperty(r)&&(l=u[g].name,"cb"!==l&&"rn"!==l&&"subgrid"!==l&&f.hasOwnProperty(r)&&u[g]&&(k[l]=f[r]),g++);f=k}catch(A){}}e.helper.dropped=!0;a.beforedrop&&b.isFunction(a.beforedrop)&&
...
e=c.p,g=e.gView+">.ui-jqgrid-bdiv",f=!1,k,l=e.height;if(d&&b.fn.resizable){a=b.extend({},a||{});a.alsoResize?(a._alsoResize_=a.alsoResize,delete a.alsoResize):a._alsoResize_=!1;a.stop&&b.isFunction(a.stop)?(a._stop_=a.stop,delete a.stop):a._stop_=!1;a.stop=function(m,p){b(c).jqGrid("setGridWidth",p.size.width,a.shrinkToFit);b(e.gView+">.ui-jqgrid-titlebar").css("width","");f?(b(k).each(function(){b(this).css("height","")}),"auto"!==l&&"100%"!==l||b(d.bDiv).css("height",l)):b(c).jqGrid("setGridParam",
{height:b(g).height()});c.fixScrollOffsetAndhBoxPadding&&c.fixScrollOffsetAndhBoxPadding();a._stop_&&a._stop_.call(c,m,p)};k=g;"auto"!==l&&"100%"!==l||void 0!==a.handles||(a.handles="e,w");if(a.handles){var m=b.map(String(a.handles).split(","),function(a){return b.trim(a)});2===m.length&&("e"===m[0]&&"w"===m[1]||"e"===m[1]&&"w"===m[1])&&(k=e.gView+">div:not(.frozen-div)",f=!0,e.pager&&(k+=","+e.pager))}a.alsoResize=a._alsoResize_?k+","+a._alsoResize_:k;delete a._alsoResize_;b(e.gBox).resizable(a)}})}});
...
this.aggregator.call(this.context,{previousResult:this.result,value:a,fieldName:c,item:d,iItem:e,items:g}))}};P.prototype.getResult=function(a,b,d){if(void 0!==this.result||d)d&&void 0!==this.result&&(this.count=this.result=0),void 0===this.result||this.finilized||"avg"!==this.aggregator||(this.result/=this.count,this.finilized=!0),a[b]=this.result};K.prototype.compareVectorsEx=function(a,b){var c=this.fieldLength,e,g;for(e=0;e<c;e++)if(g=this.fieldCompare[e](a[e],b[e]),0!==g)return{index:e,result:g};
...
function(a){var c,d=a.length,e=this.fieldLength,g,f,k=this.fieldNames,l=this.indexesOfSourceData,m,n,p=this.items,q;for(c=0;c<d;c++){n=a[c];g=Array(e);for(m=0;m<e;m++)f=n[k[m]],void 0!==f&&("string"===typeof f&&this.trimByCollect&&(f=b.trim(f)),g[m]=f);n=0;q=p.length-1;if(0>q)p.push(g),l.push([c]);else if(f=this.compareVectors(g,p[q]),0===f)l[q].push(c);else if(1===f||this.skipSort)p.push(g),l.push([c]);else if(f=this.compareVectors(p[0],g),1===f)p.unshift(g),l.unshift([c]);else if(0===f)l[0].push(c);
else for(;;){if(2>q-n){p.splice(q,0,g);l.splice(q,0,[c]);break}m=Math.floor((n+q)/2);f=this.compareVectors(p[m],g);if(0===f){l[m].push(c);break}1===f?q=m:n=m}}};t.extend({pivotSetup:function(a,c){var d=this[0],e=b.isArray,g={},f={groupField:[],groupSummary:[],groupSummaryPos:[]},k={grouping:!0,groupingView:f},l=b.extend({totals:!1,useColSpanStyle:!1,trimByCollect:!0,skipSortByX:!1,skipSortByY:!1,caseSensitive:!1,footerTotals:!1,groupSummary:!0,groupSummaryPos:"header",frozenStaticCols:!1,defaultFormatting:!0,
data:a},c||{}),m,n,p,q=a.length,r,u,B,A,v,x,w=l.xDimension,y=l.yDimension,C=l.aggregates,z,q=l.totalText||l.totals||l.rowTotals||l.totalHeader,h,F=e(w)?w.length:0;A=e(y)?y.length:0;var H=e(C)?C.length:0,D=A-(1===H?1:0),J=[],I=[],M=[],e=[],E=["pivotInfos"],G=Array(H),O=Array(A),N,R,Q,X,U,W,V,Y,ba,aa,S;n=function(c,d,e){c=new K(l.trimByCollect,l.caseSensitive,d,c);b.isFunction(e)&&(c.compareVectorsEx=e);c.createDataIndex(a);return c};var fa=function(a,c,e,f,g){var h,k;switch(a){case 1:h=y[f].totalText||
...
e;for(d=0;d<H;d++)e=C[d],void 0===e.template&&void 0===e.formatter&&l.defaultFormatting&&(e.template="count"===e.aggregator?"integer":"number"),M.push(fa(a,e,d,b,c))};N=function(a,c,e){var f,g,h,k;for(f=D-1;f>=c;f--)if(I[f]){for(g=0;g<=f;g++)ba=J[g].groupHeaders,ba[ba.length-1].numberOfColumns+=H;r=y[f];h=r.totalHeader;k=r.headerOnTop;for(g=f+1;g<=D-1;g++)J[g].groupHeaders.push({titleText:k&&g===f+1||!k&&g===D-1?b.isFunction(h)?h.call(d,e,f):t.template.call(d,String(h||""),e[f],f):"",startColumnName:"y"+
(a-1)+"t"+f+(1===H?"":"a0"),numberOfColumns:H})}};var ca=function(a){a=new P("count"===C[a].aggregator?"sum":C[a].aggregator,d,c);a.groupInfo={iRows:[],rows:[],ys:[],iYs:[]};return a},ea=function(){var a,b;for(a=D-1;0<=a;a--)if(I[a])for(null==O[a]&&(O[a]=Array(H)),b=0;b<H;b++)O[a][b]=ca(b)},ha=function(a,b,c,d){var e,f=S.getIndexOfDifferences(b,c),g,h;if(null!==c)for(f=Math.max(f,0),e=D-1;e>=f;e--)g="y"+a+"t"+e+(1<H?"a"+d:""),I[e]&&void 0===V[g]&&(h=O[e][d],h.getResult(V,g),V.pivotInfos[g]={colType:1,
iA:d,a:C[d],level:e,iRows:h.groupInfo.iRows,rows:h.groupInfo.rows,ys:h.groupInfo.ys,iYs:h.groupInfo.iYs},b!==c&&(O[e][d]=ca(d)))},ia=function(c,d,e,f,g,h,k){var l;if(c!==d)for(d=D-1;0<=d;d--)I[d]&&(l=O[d][f],l.calc(g[e.member],e.member,g,h,a),l=l.groupInfo,0>b.inArray(k,l.iYs)&&(l.iYs.push(k),l.ys.push(c)),0>b.inArray(h,l.iRows)&&(l.iRows.push(h),l.rows.push(g)))};if(0===F||0===H)throw"xDimension or aggregates options are not set!";aa=n(w,l.skipSortByX,l.compareVectorsByX);S=n(y,l.skipSortByY,l.compareVectorsByY);
c.xIndex=aa;c.yIndex=S;for(n=0;n<F;n++)p=w[n],u={name:"x"+n,label:null!=p.label?b.isFunction(p.label)?p.label.call(d,p,n,l):p.label:p.dataName,frozen:l.frozenStaticCols},n<F-1&&!p.skipGrouping&&!p.additionalProperty&&(f.groupField.push(u.name),f.groupSummary.push(l.groupSummary),f.groupSummaryPos.push(l.groupSummaryPos)),u=b.extend(u,p),delete u.dataName,delete u.footerText,p.additionalProperty?E.push(u.name):(M.push(u),k.sortname=u.name);2>F&&(k.grouping=!1);f.hideFirstGroupCol=!0;for(n=0;n<A;n++)r=
y[n],I.push(r.totals||r.rowTotals||r.totalText||r.totalHeader?!0:!1);Y=S.getItem(0);v(0,A-1,0);f=S.getIndexLength();for(u=1;u<f;u++){Q=S.getItem(u);n=S.getIndexOfDifferences(Q,Y);for(p=D-1;p>=n;p--)I[p]&&v(1,p,u-1);Y=Q;v(0,A-1,u)}for(n=D-1;0<=n;n--)I[n]&&v(1,n,f-1);q&&v(2);Y=S.getItem(0);for(p=0;p<D;p++)J.push({useColSpanStyle:l.useColSpanStyle,groupHeaders:[{titleText:Y[p],startColumnName:1===H?"y0":"y0a0",numberOfColumns:H}]});for(u=1;u<f;u++){Q=S.getItem(u);n=S.getIndexOfDifferences(Q,Y);N(u,n,
Y);for(p=D-1;p>=n;p--)J[p].groupHeaders.push({titleText:Q[p],startColumnName:"y"+u+(1===H?"":"a0"),numberOfColumns:H});for(p=0;p<n;p++)ba=J[p].groupHeaders,ba[ba.length-1].numberOfColumns+=H;Y=Q}N(f,0,Y);if(q)for(n=0;n<D;n++)J[n].groupHeaders.push({titleText:n<D-1?"":l.totalHeader||"",startColumnName:"t"+(1===H?"":"a0"),numberOfColumns:H});N=aa.getIndexLength();for(A=0;A<N;A++){p=aa.getItem(A);v={iX:A,x:p};V={pivotInfos:v};for(n=0;n<F;n++)V["x"+n]=p[n];R=aa.getIndexesOfSourceData(A);if(q)for(p=0;p<
H;p++)G[p]=ca(p);Y=null;ea();for(u=0;u<f;u++){Q=S.getItem(u);X=S.getIndexesOfSourceData(u);for(p=0;p<H;p++){null!==Y&&ha(u-1,Q,Y,p);U=[];for(n=0;n<X.length;n++)B=X[n],0<=b.inArray(B,R)&&U.push(B);if(0<U.length){x=Array(U.length);W=C[p];z=new P(W.aggregator,d,c);for(B=0;B<U.length;B++)n=U[B],m=a[n],x[B]=m,z.calc(m[W.member],W.member,m,n,a),q&&(h=G[p],h.calc(m[W.member],W.member,m,n,a),h=h.groupInfo,0>b.inArray(n,h.iYs)&&(h.iYs.push(u),h.ys.push(Q)),0>b.inArray(n,h.iRows)&&(h.iRows.push(n),h.rows.push(m))),
ia(Q,Y,W,p,m,n,u);m="y"+u+(1===H?"":"a"+p);z.getResult(V,m);v[m]={colType:0,iY:u,y:Q,iA:p,a:W,iRows:U,rows:x}}}Y=Q}if(null!==Y)for(p=0;p<H;p++)ha(f-1,Y,Y,p);if(q)for(p=0;p<H;p++)m="t"+(1===H?"":"a"+p),h=G[p],h.getResult(V,m),h=h.groupInfo,v[m]={colType:2,iA:p,a:C[p],iRows:h.iRows,rows:h.rows,iYs:h.iYs,ys:h.ys};e.push(V)}if(l.footerTotals||l.colTotals){q=e.length;for(n=0;n<F;n++)g["x"+n]=w[n].footerText||"";for(n=F;n<M.length;n++){m=M[n].name;z=new P(l.footerAggregator||"sum",d,c);for(B=0;B<q;B++)V=
e[B],z.calc(V[m],m,V,B,e);z.getResult(g,m)}}c.colHeaders=J;return{colModel:M,additionalProperties:E,options:c,rows:e,groupOptions:k,groupHeaders:J,summary:g}},jqPivot:function(a,c,d,e){return this.each(function(){function g(){var e=l.pivotSetup.call(k,a,c),g=e.groupHeaders,p=e.summary,q=0,r;for(r in p)p.hasOwnProperty(r)&&q++;p=0<q?!0:!1;q=e.groupOptions.groupingView;r=t.from.call(f,e.rows);var u;if(c.skipSortByX)for(u=0;u<q.groupField.length;u++)r.orderBy(q.groupField[u],null!=d&&d.groupingView&&
null!=d.groupingView.groupOrder&&"desc"===d.groupingView.groupOrder[u]?"d":"a","text","");c.data=a;l.call(k,b.extend(!0,{datastr:b.extend(r.select(),p?{userdata:e.summary}:{}),datatype:"jsonstring",footerrow:p,userDataOnFooter:p,colModel:e.colModel,additionalProperties:e.additionalProperties,pivotOptions:e.options,viewrecords:!0,sortname:c.xDimension[0].dataName},e.groupOptions,d||{}));if(g.length)for(u=0;u<g.length;u++)g[u]&&g[u].groupHeaders.length&&l.setGroupHeaders.call(k,g[u]);c.frozenStaticCols&&
...
"subgrid.button","sgbutton")+"'><span class='"+t.mergeCssClasses(f.commonIconClass,f.plusicon)+"'></span></a></div>":"&nbsp;")+"</td>"},addSubGrid:function(a,c){return this.each(function(){var d=this,e=d.p,g=e.subGridModel[0],f=function(a,b){return D.getGuiStyles.call(d,"subgrid."+a,b||"")},k=f("thSubgrid","ui-th-subgrid ui-th-column ui-th-"+e.direction),l=f("rowSubTable","ui-subtblcell"),m=f("row","ui-subgrid ui-row-"+e.direction),n=f("tdWithIcon","subgrid-cell"),p=f("tdData","subgrid-data"),q=function(a,
c,d){d=g.align[d];c=b("<td"+(d?" style='text-align:"+d+";'":"")+"></td>").html(c);a.append(c)},r=function(a,c){var d=e.xmlReader.subgrid;b(d.root+" "+d.row,a).each(function(){var a,e,f=b("<tr class='"+l+"'></tr>");if(!0===d.repeatitems)b(d.cell,this).each(function(a){q(f,b(this).text()||"&#160;",a)});else if(a=g.mapping||g.name)for(e=0;e<a.length;e++)q(f,b(a[e],this).text()||"&#160;",e);c.append(f)})},u=function(a,c){var d,f,k,m,n,p=e.jsonReader.subgrid,r=t.getAccessor(a,p.root);if(null!=r)for(f=
0;f<r.length;f++){n=r[f];d=b("<tr class='"+l+"'></tr>");if(!0===p.repeatitems)for(p.cell&&(n=n[p.cell]),k=0;k<n.length;k++)q(d,n[k]||"&#160;",k);else if(m=g.mapping||g.name,m.length)for(k=0;k<m.length;k++)q(d,n[m[k]]||"&#160;",k);c.append(d)}},B=function(a,c,h){var l,m;l=f("legacyTable","ui-jqgrid-legacy-subgrid"+(!0===e.altRows&&b(d).jqGrid("isBootstrapGuiStyle")?" table-striped":""));var n=b("<table"+(l?" style='width:1px' role='presentation' class='"+l+"'":"")+"><thead></thead><tbody></tbody></table>"),
p=b("<tr></tr>");d.grid.endReq.call(d);for(m=0;m<g.name.length;m++)l=b("<th class='"+k+"'></th>").html(g.name[m]).width(g.width[m]),p.append(l);p.appendTo(n[0].tHead);h(a,b(n[0].tBodies[0]));b("#"+I(e.id+"_"+c)).append(n);return!1},A=function(a){var c=b(a).attr("id"),f={nd_:(new Date).getTime()},k,l;f[e.prmNames.subgridid]=c;if(!g)return!1;if(g.params)for(l=0;l<g.params.length;l++)k=e.iColByName[g.params[l]],void 0!==k&&(f[e.colModel[k].name]=b(a.cells[k]).text().replace(/\&#160\;/ig,""));if(!d.grid.hDiv.loading)switch(d.grid.beginReq.call(d),
e.subgridtype||(e.subgridtype=e.datatype),b.isFunction(e.subgridtype)?e.subgridtype.call(d,f):e.subgridtype=e.subgridtype.toLowerCase(),e.subgridtype){case "xml":case "json":b.ajax(b.extend({type:e.mtype,url:b.isFunction(e.subGridUrl)?e.subGridUrl.call(d,f):e.subGridUrl,dataType:e.subgridtype,context:c,data:t.serializeFeedback.call(d,e.serializeSubGridData,"jqGridSerializeSubGridData",f),success:function(a){B(a,this,"xml"===e.subgridtype?r:u)},error:function(a,c,f){var g=void 0===e.loadSubgridError?
...
getNodeDepth:function(a){var c=null;this.each(function(){var d=this.p;if(this.grid&&d.treeGrid)switch(d.treeGridModel){case "nested":c=parseInt(a[d.treeReader.level_field],10)-parseInt(d.tree_root_level,10);break;case "adjacency":c=D.getNodeAncestors.call(b(this),a).length}});return c},getNodeParent:function(a){var c=this[0];if(!c||!c.grid||null==c.p||!c.p.treeGrid||null==a)return null;var c=c.p,d=c.treeReader,e=a[d.parent_id_field];if("nested"===c.treeGridModel){var g=null,f=d.left_field,k=d.right_field,
l=d.level_field,m=parseInt(a[f],10),n=parseInt(a[k],10),p=parseInt(a[l],10);b(c.data).each(function(){if(parseInt(this[l],10)===p-1&&parseInt(this[f],10)<m&&parseInt(this[k],10)>n)return g=this,!1});return g}if(null===e||"null"===e)return null;a=c._index[e];return void 0!==a?c.data[a]:null},getNodeChildren:function(a){var c=[];this.each(function(){var d=this.p;if(this.grid&&d.treeGrid)switch(d.treeGridModel){case "nested":var e=d.treeReader.left_field,g=d.treeReader.right_field,f=d.treeReader.level_field,
k=parseInt(a[e],10),l=parseInt(a[g],10),m=parseInt(a[f],10);b(d.data).each(function(){parseInt(this[f],10)===m+1&&parseInt(this[e],10)>k&&parseInt(this[g],10)<l&&c.push(this)});break;case "adjacency":var n=d.treeReader.parent_id_field,p=d.localReader.id;b(d.data).each(function(){String(this[n])===String(a[p])&&c.push(this)})}});return c},getFullTreeNode:function(a){var c=[];this.each(function(){var d=this.p,e;if(this.grid&&d.treeGrid)switch(d.treeGridModel){case "nested":var g=d.treeReader.left_field,
f=d.treeReader.right_field,k=d.treeReader.level_field,l=parseInt(a[g],10),m=parseInt(a[f],10),n=parseInt(a[k],10);b(d.data).each(function(){parseInt(this[k],10)>=n&&parseInt(this[g],10)>=l&&parseInt(this[g],10)<=m&&c.push(this)});break;case "adjacency":if(a){c.push(a);var p=d.treeReader.parent_id_field,q=d.localReader.id;b(d.data).each(function(){var a;e=c.length;for(a=0;a<e;a++)if(String(c[a][q])===String(this[p])){c.push(this);break}})}}});return c},getNodeAncestors:function(a){var c=[];this.each(function(){var d=
...
this,f=g.p,k=b(g);if(g.grid&&f.treeGrid){var l,m,n,p=[];l=D.getRootNodes.call(k);l=t.from.call(g,l);l.orderBy(a,c,d,e);var q=l.select();l=0;for(m=q.length;l<m;l++)n=q[l],p.push(n),D.collectChildrenSortTree.call(k,p,n,a,c,d,e);b.each(p,function(a){var c=ra(this,f.localReader.id);b(g.rows[a]).after(k.find(">tbody>tr#"+I(c)))})}})},collectChildrenSortTree:function(a,c,d,e,g,f){return this.each(function(){var k=b(this);if(this.grid&&this.p.treeGrid){var l,m,n;l=D.getNodeChildren.call(k,c);l=t.from.call(this,
l);l.orderBy(d,e,g,f);var p=l.select();l=0;for(m=p.length;l<m;l++)n=p[l],a.push(n),D.collectChildrenSortTree.call(k,a,n,d,e,g,f)}})},setTreeRow:function(a,c){var d=!1;this.each(function(){this.grid&&this.p.treeGrid&&(d=D.setRowData.call(b(this),a,c))});return d},delTreeNode:function(a,c){return this.each(function(){var d=this.p,e,g,f,k;f=d.localReader.id;var l,m=b(this),n=d.treeReader.left_field,p=d.treeReader.right_field;if(this.grid&&d.treeGrid&&(l=d._index[a],void 0!==l)){e=parseInt(d.data[l][p],
10);g=e-parseInt(d.data[l][n],10)+1;var q=D.getFullTreeNode.call(m,d.data[l]);if(0<q.length)for(l=0;l<q.length;l++)c&&a===q[l][f]||D.delRowData.call(m,q[l][f]);if("nested"===d.treeGridModel){f=t.from.call(this,d.data).greater(n,e,{stype:"integer"}).select();if(f.length)for(k in f)f.hasOwnProperty(k)&&(f[k][n]=parseInt(f[k][n],10)-g);f=t.from.call(this,d.data).greater(p,e,{stype:"integer"}).select();if(f.length)for(k in f)f.hasOwnProperty(k)&&(f[k][p]=parseInt(f[k][p],10)-g)}}})},addChildNode:function(a,
c,d,e){var g=b(this),f=g[0],k=f.p,l=D.getInd;if(d){var m,n,p,q,r;m=0;var u=c,B,A,v=k.treeReader.expanded_field;A=k.treeReader.leaf_field;var x=k.treeReader.level_field,w=k.treeReader.parent_id_field,y=k.treeReader.left_field,C=k.treeReader.right_field,z=k.treeReader.loaded;void 0===e&&(e=!1);if(null==a){r=k.data.length-1;if(0<=r)for(;0<=r;)m=Math.max(m,parseInt(k.data[r][k.localReader.id],10)),r--;a=m+1}var h=l.call(g,c);B=!1;if(void 0===c||null===c||""===c)u=c=null,m="last",q=k.tree_root_level,r=
k.data.length+1;else{m="after";n=k._index[c];p=k.data[n];c=p[k.localReader.id];r=l.call(g,c);q=parseInt(p[x],10)+1;var F=D.getFullTreeNode.call(g,p);if(F.length){var H,I,J;for(H=0;H<F.length;H++)J=F[H][k.localReader.id],I=l.call(g,J),I>r&&(r=I,u=J)}r++;p[A]&&(B=!0,p[v]=!0,b(f.rows[h]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(k.treeIcons.leaf+" tree-leaf").addClass(k.treeIcons.commonIconClass).addClass(k.treeIcons.minus+
" tree-minus"),k.data[n][A]=!1,p[z]=!0)}l=r+1;void 0===d[v]&&(d[v]=!1);void 0===d[z]&&(d[z]=!1);d[x]=q;void 0===d[A]&&(d[A]=!0);"adjacency"===k.treeGridModel&&(d[w]=c);if("nested"===k.treeGridModel){var K;if(null!==c){A=parseInt(p[C],10);k=t.from.call(f,k.data);k=k.greaterOrEquals(C,A,{stype:"integer"});x=k.select();if(x.length)for(K in x)x.hasOwnProperty(K)&&(x[K][y]=x[K][y]>A?parseInt(x[K][y],10)+2:x[K][y],x[K][C]=x[K][C]>=A?parseInt(x[K][C],10)+2:x[K][C]);d[y]=A;d[C]=A+1}else{A=parseInt(D.getCol.call(g,
C,!1,"max"),10);x=t.from.call(f,k.data).greater(y,A,{stype:"integer"}).select();if(x.length)for(K in x)x.hasOwnProperty(K)&&(x[K][y]=parseInt(x[K][y],10)+2);x=t.from.call(f,k.data).greater(C,A,{stype:"integer"}).select();if(x.length)for(K in x)x.hasOwnProperty(K)&&(x[K][C]=parseInt(x[K][C],10)+2);d[y]=A+1;d[C]=A+2}}if(null===c||D.isNodeLoaded.call(g,p)||B)D.addRowData.call(g,a,d,m,u),D.setTreeNode.call(g,r,l);p&&!p[v]&&e&&b(f.rows[h]).find("div.treeclick").click()}}});var db="mousedown",Sa="mousemove",
...
typeof a||U.isNumber(a)||b.isFunction(f.cellValue)?"<a "+k+" href='"+ua(g)+"'>"+(b.isFunction(f.cellValue)?n(f.cellValue):a)+"</a>":za(a,f)};M.showlink.getCellBuilder=function(a){var c={baseLinkUrl:a.baseLinkUrl,showAction:a.showAction,addParam:a.addParam||"",target:a.target,idName:a.idName,hrefDefaultValue:"#"};a=a.colModel;null!=a&&(c=b.extend({},c,a.formatoptions||{}));return function(a,e,g){var d=this,k=e.rowId,l="",m,n,p=function(e){return b.isFunction(e)?e.call(d,{cellValue:a,rowid:k,rowData:g,
options:c}):e||""};c.target&&(l="target="+p(c.target));m=p(c.baseLinkUrl)+p(c.showAction);e=c.idName?encodeURIComponent(p(c.idName))+"="+encodeURIComponent(p(k)||e.rowId):"";n=p(c.addParam);"object"===typeof n&&null!==n&&(n=(""!==e?"&":"")+b.param(n));m+=e||n?"?"+e+n:"";""===m&&(m=p(c.hrefDefaultValue));return"string"===typeof a||U.isNumber(a)||b.isFunction(c.cellValue)?"<a "+l+" href='"+ua(m)+"'>"+(b.isFunction(c.cellValue)?p(c.cellValue):a)+"</a>":za(a,c)}};M.showlink.pageFinalization=function(a){var c=
...
null!=l))b(l.firstChild).on("click",m)};var fb=function(a,b){a=b.prefix?b.prefix+a:a;return b.suffix?a+b.suffix:a},ob=function(a,c,d){var e=c.colModel;c=b.extend({},c[d]);null!=e&&(c=b.extend({},c,e.formatoptions||{}));return U.isEmpty(a)?fb(c.defaultValue,c):fb(U.NumberFormat(a,c),c)};M.integer=function(a,b){return ob(a,b,"integer")};M.number=function(a,b){return ob(a,b,"number")};M.currency=function(a,b){return ob(a,b,"currency")};var pb=function(a,c){var d=a.colModel,e=b.extend({},a[c]);null!=
d&&(e=b.extend({},e,d.formatoptions||{}));var g=U.NumberFormat,f=e.defaultValue?fb(e.defaultValue,e):"";return function(a){return U.isEmpty(a)?f:fb(g(a,e),e)}};M.integer.getCellBuilder=function(a){return pb(a,"integer")};M.number.getCellBuilder=function(a){return pb(a,"number")};M.currency.getCellBuilder=function(a){return pb(a,"currency")};M.date=function(a,c,d,e){d=c.colModel;c=b.extend({},c.date);null!=d&&(c=b.extend({},c,d.formatoptions||{}));return c.reformatAfterEdit||"edit"!==e?U.isEmpty(a)?
za(a,c):t.parseDate.call(this,c.srcformat,a,c.newformat,c):za(a,c)};M.date.getCellBuilder=function(a,c){var d=b.extend({},a.date);null!=a.colModel&&(d=b.extend({},d,a.colModel.formatoptions||{}));var e=t.parseDate,g=d.srcformat,f=d.newformat;return d.reformatAfterEdit||"edit"!==c?function(a){return U.isEmpty(a)?za(a,d):e.call(this,g,a,f,d)}:function(a){return za(a,d)}};M.select=function(a,c){var d=[],e=c.colModel,g,e=b.extend({},e.editoptions||{},e.formatoptions||{}),f=e.value,k=e.separator||":",
