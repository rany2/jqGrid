...
b.fn.jqGrid,e;if("string"===typeof a){e=c[a];if(!e)throw"jqGrid - No such method: "+a;return e.apply(this,b.makeArray(arguments).slice(1))}return this.each(function(){if(!this.grid){var d=this,e,g,h=b(d),m=b.isFunction,l=b.isArray,n=b.extend,p=b.inArray,q=b.trim,r=b.each,t=c.setSelection,w=c.getGridRes,x=m(Ia.fatalError)?Ia.fatalError:alert,B=a.locale||Ia.locale||"en-US",z=null!=Ha[B]&&"boolean"===typeof Ha[B].isRTL?Ha[B].isRTL?"rtl":"ltr":"ltr",v=a.iconSet||Ia.iconSet||("bootstrap"===(a.guiStyle||
Ia.guiStyle)||"bootstrapPrimary"===(a.guiStyle||Ia.guiStyle)?"glyph":"jQueryUI"),E=a.guiStyle||Ia.guiStyle||"jQueryUI",A=function(b){return c.getIconRes.call(d,b)},D=function(b,a){return h.jqGrid("getGuiStyles",b,a)};null==a&&(a={datatype:"local"});void 0!==a.datastr&&l(a.datastr)&&(g=a.datastr,a.datastr=[]);void 0!==a.data&&(e=a.data,a.data=[]);null!=u.formatter&&null!=u.formatter.unused||x("CRITICAL ERROR!!!\n\n\nOne uses probably\n\n\t$.extend($.jgrid.defaults, {...});\n\nto set default settings of jqGrid instead of the usage the DEEP version of jQuery.extend (with true as the first parameter):\n\n\t$.extend(true, $.jgrid.defaults, {...});\n\nOne other possible reason:\n\nyou included some OLD version of language file (grid.locale-en.js for example) AFTER jquery.jqGrid.min.js. For example all language files of jqGrid 4.7.0 uses non-deep call of jQuery.extend.\n\n\nSome options of jqGrid could still work, but another one will be broken.");
...
"px");this.curGbox.data("idx",a);this.curGbox.data("delta",e-c.pageX);pa.call(this.curGbox,c);Q.call($a(21,f)[0],"resizeStart",c,a);document.onselectstart=function(){return!1};b(document).bind("mousemove.jqGrid",function(b){if(y.resizing)return y.dragMove(b),!1}).bind("mouseup.jqGrid"+k.id,function(){if(y.resizing)return y.dragEnd(),!1})},dragMove:function(a){var c=this.resizing;if(c){var d=a.pageX+c.delta-c.startX,e=this.headers;a=e[c.idx];var f="ltr"===k.direction?a.width+d:a.width-d,g=((k.colModel[c.idx]||
...
b.makeArray(k.selarrrow):null,e=this.grid.bDiv,f=e.scrollLeft,g=function(){var b;k.selrow=null;if(!k.multiPageSelection){W(k.selarrrow);if(k.multiselect&&d&&0<d.length)for(b=0;b<d.length;b++)d[b]!==c&&t.call(a,d[b],!1,null);c&&t.call(a,c,!1,null)}e.scrollLeft=f;a.unbind(".selectionPreserver",g)};a.bind("jqGridGridComplete.selectionPreserver",g)}};d.grid=y;Q.call(d,"beforeInitGrid");k.iColByName=H(k.colModel);k.iPropByName=L(k.additionalProperties);var C=b("<div class='"+D("gView","ui-jqgrid-view")+
"' role='grid' aria-multiselectable='"+!!k.multiselect+"'></div>"),M=u.msie,ba;k.direction=q(k.direction.toLowerCase());-1===p(k.direction,["ltr","rtl"])&&(k.direction="ltr");ba=k.direction;b(C).insertBefore(d);h.removeClass("scroll").appendTo(C);var O=b("<div class='"+D("gBox","ui-jqgrid")+"'></div>");b(O).attr({id:k.gBoxId,dir:ba}).insertBefore(C);b(C).attr("id",k.gViewId).appendTo(O);b("<div class='"+D("overlay","jqgrid-overlay")+"' id='lui_"+k.id+"'></div>").insertBefore(C);b("<div class='"+D("loading",
...
n||"xml"===n)&&b.isXMLDoc(a),q=k.localReader,v=qa;if(a&&("xml"!==n||r)){-1!==k.treeANode||k.scroll?d=1<d?d:1:(y.emptyRows.call(this,!1,!0),d=1);p&&(W(k.data),W(k.lastSelectedData),k._index={},k.grouping&&null!=k.groupingView&&(k.groupingView.groups=[],k.groupingView._locgr=!1),k.localReader.id="_id_");k.reccount=0;switch(n){case "xml":case "xmlstring":q=k.xmlReader;v=u.getXmlData;break;case "json":case "jsonp":case "jsonstring":q=k.jsonReader}var t,w,x,z,F,A={},B,L=k.colModel,D=L.length,E,I,da,H,
...
eb=function(b,a){r&&"string"===typeof a&&(/^\w+$/.test(a)?O[b]=pa(a):/^\[\w+\]$/.test(a)&&(O[b]=C(a.substring(1,a.length-1))))},ha=function(b){var a=b.name,c=r?b.xmlmap||a:"local"===n&&!k.dataTypeOrg||"json"===n||"jsonp"===n?b.jsonmap||a:a;!1!==k.keyName&&!0===b.key&&(k.keyName=a);if("string"===typeof c||m(c))O[a]=c;m(c)||eb(a,c)};for(t=0;t<D;t++)ha(L[t]);D=Ja.length;for(t=0;t<D;t++)I=Ja[t],"object"===typeof I&&null!=I?ha(I):eb(I,I);z=!1===k.keyName?m(q.id)?q.id.call(this,a):q.id:k.keyName;isNaN(z)?
m(z)||(M[z]&&(F=M[z].order),r&&("string"===typeof z&&/^\[\w+\]$/.test(z)?z=C(z.substring(1,z.length-1)):"string"===typeof z&&/^\w+$/.test(z)&&(z=pa(z)))):F=Number(z);x=v(a,q.root,!0);if(q.row)if(1===x.length&&"string"===typeof q.row&&/^\w+$/.test(q.row)){D=[];da=x[0].childNodes;H=da.length;for(I=0;I<H;I++)S=da[I],1===S.nodeType&&S.nodeName===q.row&&D.push(S);x=D}else x=v(x,q.row,!0);null==x&&l(a)&&(x=a);x||(x=[]);a=x.length;0<a&&0>=k.page&&(k.page=1);ha=parseInt(k.rowNum,10);f&&(ha*=f+1);var L=[],
...
da));void 0!==A[z]?G=void 0!==A[z]?A[z]:Da():(G=v(G,l(G)?F:z),void 0===G&&(G=v(w,l(w)?F:z)),void 0===G&&(G=Da()));void 0===A[z]&&(A[z]=G);G=String(G);B=k.idPrefix+G;k.treeGrid&&V(A);if(t<ha)kb.push(B),L.push(w),D.push(A);else if(!p)break;if(p||!0===k.treeGrid)A._id_=G,k.data.push(A),k._index[A._id_]=k.data.length-1}if(!p||!k.forceClientSorting||!0===k.treeGrid){d=u.parseDataToHtml.call(this,a,kb,D,L,d,f,p);K(!0);f=-1<k.treeANode?k.treeANode:0;q=b(this.tBodies[0]);!0===k.treeGrid&&0<f?b(this.rows[f]).after(d.join("")):
k.scroll?q.append(d.join("")):(null==this.firstElementChild||void 0!==document.documentMode&&9>=document.documentMode?q.html(q.html()+d.join("")):this.firstElementChild.innerHTML+=d.join(""),this.grid.cols=this.rows[0].cells);k.grouping&&J.call(this);if(!0===k.subGrid)try{c.addSubGrid.call(g,k.iColByName.subgrid)}catch(Z){}if(!1===k.gridview||m(k.afterInsertRow))for(t=0;t<Math.min(a,ha);t++)Q.call(this,"afterInsertRow",kb[t],D[t],L[t]);k.totaltime=new Date-h;0<t&&0===k.records&&(k.records=a);W(d);
...
(L=L.custom(h.op,h.field,h.data)),c++;f&&L.orEnd()}catch(r){x(r)}}var d=b(this),e=k.multiSort?[]:"",f={},g=!1,n={},p=[],q=[],v=w.call(h,"formatter.date.srcformat"),t=w.call(h,"formatter.date.newformat");if(!l(k.data))return{};k.multiSort&&rb(e,f);var z=k.grouping?k.groupingView:!1,y,A,F=function(b,a,c){var d=b.index||b.name,f=b.sorttype||"text";n[b.name]={reader:k.dataTypeOrg?b.name:b.jsonmap||b.name,iCol:a,stype:f,srcfmt:"",newfmt:"",sfunc:b.sortfunc||null,isAddProp:!0===c?!0:!1};if("date"===f||
"datetime"===f)b.formatter&&"string"===typeof b.formatter&&"date"===b.formatter?(a=b.formatoptions&&b.formatoptions.srcformat?b.formatoptions.srcformat:v,c=b.formatoptions&&b.formatoptions.newformat?b.formatoptions.newformat:t):a=c=b.datefmt||"Y-m-d",n[b.name].srcfmt=a,n[b.name].newfmt=c;if(k.grouping)for(A=0,y=z.groupField.length;A<y;A++)b.name===z.groupField[A]&&(p[A]=n[d],q[A]=d);k.multiSort||g||b.index!==k.sortname&&b.name!==k.sortname||(e=b.name,g=!0)};r(k.colModel,function(b){F(this,b)});r(k.additionalProperties,
function(b){F("string"===typeof this?{name:this}:this,b,!0)});if(k.treeGrid)return c.SortTree.call(d,e,k.sortorder,null!=n[e]&&n[e].stype?n[e].stype:"text",null!=n[e]&&n[e].srcfmt?n[e].srcfmt:""),!1;var B={eq:function(b){return b.equals},ne:function(b){return b.notEquals},lt:function(b){return b.less},le:function(b){return b.lessOrEquals},gt:function(b){return b.greater},ge:function(b){return b.greaterOrEquals},cn:function(b){return b.contains},nc:function(b,a){return"OR"===a?b.orNot().contains:b.andNot().contains},
...
b);ha.call(e,a-1)}:null!==r.npage&&delete k.postData[r.npage];if(k.grouping&&c.groupingSetup){c.groupingSetup.call(f);var z=k.groupingView,x,w="",A,L,F;for(x=0;x<z.groupField.length;x++){A=z.groupField[x];for(L=0;L<k.colModel.length;L++)F=k.colModel[L],F.name===A&&F.index&&(A=F.index);w+=A+" "+z.groupOrder[x]+", "}l[r.sort]=w+l[r.sort]}n(k.postData,l);var B=k.scroll?e.rows.length-1:1,J=function(){I.call(e);var b=f.width(),a=f.closest(".ui-jqgrid-view").width(),d=f.css("height");a<b&&0===k.reccount?
...
"")+"'></td><td id='"+r+"' style='text-align:center;white-space:pre;"+(void 0!==k.pagerCenterWidth?"width:"+k.pagerCenterWidth+"px;":"")+"'></td><td id='"+q+"' style='text-align:right;"+(void 0!==k.pagerRightWidth?"width:"+k.pagerRightWidth+"px;":"")+"'></td></tr></tbody></table></div>").attr("dir","ltr");n="#"+G(n);if(0<k.rowList.length){m="<td dir='"+ba+"'>";p=F("pgrecs");m+="<select class='"+D("pager.pagerSelect","ui-pg-selbox")+"' "+(p?"title='"+p+"'":"")+">";for(p=0;p<k.rowList.length;p++)r=
k.rowList[p].toString().split(":"),1===r.length&&(r[1]=r[0]),m+="<option value='"+r[0]+"'"+(P(k.rowNum,0)===P(r[0],0)?" selected='selected'":"")+">"+r[1]+"</option>";m+="</select></td>"}"rtl"===ba&&(l+=m);!0===k.pginput&&(h="<td dir='"+ba+"'>"+u.format(F("pgtext")||"","<input class='"+D("pager.pagerInput","ui-pg-input")+"' type='text' size='2' maxlength='7' value='0'/>","<span id='sp_1_"+a+"'>0</span>")+"</td>");a="#"+G(a);if(!0===k.pgbuttons){r=["first","prev","next","last"];var t=D("pager.pagerButton",
"ui-pg-button");q=function(b){var a=F("pg"+b);return"<td role='button' tabindex='0' id='"+b+c+"' class='"+t+"' "+(a?"title='"+a+"'":"")+"><span class='"+A("pager."+b)+"'></span></td>"};"rtl"===ba&&r.reverse();for(p=0;p<r.length;p++)l+=q(r[p]),1===p&&(l+=""!==h?g+h+g:"")}else""!==h&&(l+=h);"ltr"===ba&&(l+=m);l+="</tr></tbody></table>";!0===k.viewrecords&&b("td"+a+"_"+k.recordpos,n).append("<span dir='"+ba+"' style='text-align:"+k.recordpos+"' class='ui-paging-info'></span>");var z=b("td"+a+"_"+k.pagerpos,
n);z.append(l);g=Ya.call(this,z.children(".ui-pg-table"));k._nvtd=[];k._nvtd[0]=g?Math.floor((k.width-g)/2):Math.floor(k.width/3);k._nvtd[1]=0;l=null;b(".ui-pg-selbox",n).bind("change",function(){var a=P(this.value,10),c=Math.round(k.rowNum*(k.page-1)/a-.5)+1;if(!v("records",c,a))return!1;k.page=c;k.rowNum=a;k.pager&&b(".ui-pg-selbox",k.pager).val(a);k.toppager&&b(".ui-pg-selbox",k.toppager).val(a);ha.call(d);return!1});!0===k.pgbuttons&&(b(".ui-pg-button",n).hover(function(){ca(this,f)?this.style.cursor=
...
t[this]});k.sortname=e.substring(0,e.length-k.sortorder.length-1)},tb=function(a,d,e,f,g){var h=this.grid,l=k.colModel[d],m=D("states.disabled");if(null!=l&&l.sortable&&!(0<k.savedRow.length)){e||(k.lastsort===d&&""!==k.sortname?(k.sortorder="asc"===k.sortorder?"desc":"desc"===k.sortorder?"asc":l.firstsortorder||"asc",l.lso?"asc"===l.lso?l.lso+="-desc":"desc"===l.lso?l.lso+="-asc":"asc-desc"!==l.lso&&"desc-asc"!==l.lso||!k.threeStateSort&&!k.multiSort||(l.lso=""):l.lso=l.firstsortorder||"asc"):l.lso=
...
k.multiselect&&(ib.call(this,!1),W(k.selarrrow))),W(k.savedRow),k.scroll&&(m=h.bDiv.scrollLeft,y.emptyRows.call(this,!0,!1),h.hDiv.scrollLeft=m),k.subGrid&&"local"===k.datatype&&b("td.sgexpanded","#"+G(k.id)).each(function(){b(this).trigger("click")}),ha.call(this),k.lastsort=d,k.sortname!==a&&d&&(k.lastsort=d)):k.lastsort=d}},Eb=function(){var b=0,a=u.cell_width?0:P(k.cellLayout,0),c=0,d,e=P(k.scrollOffset,0),f,g=!1,h,l=0,m,n=u.isCellClassHidden;r(k.colModel,function(){void 0===this.hidden&&(this.hidden=
!1);if(k.grouping&&k.autowidth){var d=p(this.name,k.groupingView.groupField);0<=d&&k.groupingView.groupColumnShow.length>d&&(this.hidden=!k.groupingView.groupColumnShow[d])}this.widthOrg=f=P(this.width,0);!1!==this.hidden||n(this.classes)||(b+=f+a,this.fixed?l+=f+a:c++)});isNaN(k.width)&&(k.width=b+(!1!==k.shrinkToFit||isNaN(k.height)?0:e));y.width=k.width;k.tblwidth=b;!1===k.shrinkToFit&&!0===k.forceFit&&(k.forceFit=!1);!0===k.shrinkToFit&&0<c&&(h=y.width-a*c-l,isNaN(k.height)||(h-=e,g=!0),b=0,r(k.colModel,
function(e){!1!==this.hidden||n(this.classes)||this.fixed||(this.width=f=Math.round(h*this.width/(k.tblwidth-a*c-l)),b+=f,d=e)}),m=0,g?y.width-l-(b+a*c)!==e&&(m=y.width-l-(b+a*c)-e):g||1===Math.abs(y.width-l-(b+a*c))||(m=y.width-l-(b+a*c)),k.colModel[d].width+=m,k.tblwidth=b+m+a*c+l,k.tblwidth>k.width&&(k.colModel[d].width-=k.tblwidth-parseInt(k.width,10),k.tblwidth=k.width))},aa=function(b){var a=b,c;for(c=b+1;c<k.colModel.length;c++)if(!0!==k.colModel[c].hidden){a=c;break}return a-b},bb;-1===p(k.multikey,
...
k.colModel.length-1;0<=Y;Y--)if(!0!==k.colModel[Y].hidden){k.colModel[Y].resizable=!1;break}var U,ea,cb,fa,la,ga,ma,oa=[],Ca=[],ia=[],ka="<thead><tr class='ui-jqgrid-labels' role='row'>",za,va="<tbody><tr style='display:none;'>",na=D("states.hover"),ua=D("states.disabled");if(k.multiSort){var oa=k.sortname.split(","),wa;for(wa=0;wa<oa.length;wa++)ia=q(oa[wa]).split(" "),oa[wa]=q(ia[0]),Ca[wa]=ia[1]?q(ia[1]):k.sortorder||"asc"}for(Y=0;Y<k.colNames.length;Y++){R=k.colModel[Y];la=k.headertitles||R.headerTitle?
" title='"+lb("string"===typeof R.headerTitle?R.headerTitle:k.colNames[Y])+"'":"";ka+="<th id='"+k.id+"_"+R.name+"' class='"+D("colHeaders","ui-th-column ui-th-"+ba+" "+(R.labelClasses||""))+"'"+la+">";U=R.index||R.name;switch(R.labelAlign){case "left":ga="text-align:left;";break;case "right":ga="text-align:right;"+(!1===R.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;");break;case "likeData":ga=void 0===R.align||"left"===R.align?"text-align:left;":"right"===R.align?
...
Y));ka+="</div></th>";va+="<td></td>";R.width=R.width?parseInt(R.width,10):150;"boolean"!==typeof R.title&&(R.title=!0);R.lso="";U===k.sortname&&(k.lastsort=Y,R.lso=k.sortorder||R.firstsortorder||"asc");k.multiSort&&(ia=p(U,oa),-1!==ia&&(R.lso=Ca[ia]))}var ka=ka+"</tr></thead>",va=va+"</tr></tbody>",ya=b("<table class='"+D("hTable","ui-jqgrid-htable")+"' style='width:1px' role='presentation' aria-labelledby='gbox_"+k.id+"'>"+ka+va+"</table>");b(ya[0].tHead).children("tr").children("th").hover(function(){b(this).addClass(na)},
function(){b(this).removeClass(na)});k.multiselect&&b(k.cb,ya).bind("click",function(){var a=D("states.select"),c,e=[],f=k.iColByName.cb,g=function(c,d){b(c)[d?"addClass":"removeClass"](a).attr(d?{"aria-selected":"true",tabindex:"0"}:{"aria-selected":"false",tabindex:"-1"});void 0!==f&&b(c.cells[f]).children("input.cbox").prop("checked",d)},h=y.fbRows,l=ua+" ui-subgrid jqgroup jqfoot jqgfirstrow jqgskipselect",m,n=k._index;W(k.selarrrow);if(this.checked){if(c=!0,k.selrow=1<d.rows.length?d.rows[d.rows.length-
...
k.width=Number(k.width);k.widthOrg=k.width;Eb();b(O).css("width",y.width+"px").append("<div class='"+D("resizer","ui-jqgrid-resize-mark")+"' id='"+k.rsId+"'>&#160;</div>");b(k.rs).bind("selectstart",function(){return!1}).click(pa).dblclick(function(a){var e=b(this).data("idx"),f=b(this).data("pageX"),g=k.colModel[e];if(null==f||null==g)return!1;var f=String(f).split(";"),l=parseFloat(f[0]),m=parseFloat(f[1]);if(2===f.length&&(5<Math.abs(l-m)||5<Math.abs(a.pageX-l)||5<Math.abs(a.pageX-m)))return!1;
Q.call(d,"resizeDblClick",e,g,a)&&g.autoResizable&&c.autoResizeColumn.call(h,e);Q.call(d,"afterResizeDblClick",{iCol:e,cm:g,cmName:g.name});return!1});b(C).css("width",y.width+"px");var Ta="";k.footerrow&&(Ta+="<table role='presentation' style='width:1px' class='"+D("gridFooter","ui-jqgrid-ftable")+"'><tbody><tr role='row' class='"+D("rowFooter","footrow footrow-"+ba)+"'>");var Aa="<tr class='jqgfirstrow' role='row' style='height:auto'>";k.disableClick=!1;b("th",ya[0].tHead.rows[0]).each(function(a){var c=
...
e=function(){var a=[c.position().left+c.outerWidth()];"rtl"===k.direction&&(a[0]=k.width-a[0]);a[0]-=d?0:y.bDiv.scrollLeft;a.push(b(y.hDiv).position().top);a.push(b(y.bDiv).offset().top-b(y.hDiv).offset().top+b(y.bDiv).height()+(y.sDiv?b(y.sDiv).height():0));return a},f;if(1===b(a.target).closest("th>span.ui-jqgrid-resize").length)return f=k.iColByName[(this.id||"").substring(k.id.length+1)],null!=f&&(!0===k.forceFit&&(k.nv=aa(f)),y.dragStart(f,a,e(),c)),!1}).click(function(a){if(k.disableClick)return k.disableClick=
...
d.current&&e.selectionPreserver.call(this);"local"===k.datatype?(k.multiPageSelection||c.resetSelection.call(f),k.data.length&&(ja.call(this),ra())):k.treeGrid||k.multiPageSelection||(k.selrow=null,k.multiselect&&(W(k.selarrrow),ib.call(this,!1)),W(k.savedRow));k.iRow=-1;k.iCol=-1;k.scroll&&y.emptyRows.call(this,!0,!1);if(d.page){var g=parseInt(d.page,10);g>k.lastpage&&(g=k.lastpage);1>g&&(g=1);k.page=g;e.bDiv.scrollTop=e.prevRowHeight?(g-1)*e.prevRowHeight*k.rowNum:0}e.prevRowHeight&&k.scroll&&void 0===
...
y.bDiv=document.createElement("div");M&&"auto"===String(k.height).toLowerCase()&&(k.height="100%");b(y.bDiv).append(b("<div style='position:relative;'></div>").append("<div></div>").append(d)).addClass("ui-jqgrid-bdiv").css({height:k.height+(isNaN(k.height)?"":"px"),width:y.width+"px"}).scroll(y.scrollGrid);k.maxHeight&&b(y.bDiv).css("max-height",k.maxHeight+(isNaN(k.maxHeight)?"":"px"));h.css({width:"1px"});b.support.tbody||2===b(">tbody",d).length&&b(">tbody:gt(0)",d).remove();k.multikey&&b(y.bDiv).bind(u.msie?
"selectstart":"mousedown",function(){return!1});Ba&&b(y.bDiv).hide();y.cDiv=document.createElement("div");var Pa=A("gridMinimize.visible"),Va=A("gridMinimize.hidden"),Wa=F("showhide"),Sa=!0===k.hidegrid?b("<a role='link' class='"+D("titleButton","ui-jqgrid-titlebar-close")+"'"+(Wa?" title='"+Wa+"'":"")+"/>").hover(function(){Sa.addClass(na)},function(){Sa.removeClass(na)}).append("<span class='"+Pa+"'></span>"):"";b(y.cDiv).append("<span class='ui-jqgrid-title'>"+k.caption+"</span>").append(Sa).addClass(D("gridTitle",
"ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===ba?"-rtl ":" ")+Qa));b(y.cDiv).insertBefore(y.hDiv);if(k.toolbar[0]){y.uDiv=document.createElement("div");"top"===k.toolbar[1]?b(y.uDiv).insertBefore(y.hDiv):"bottom"===k.toolbar[1]&&b(y.uDiv).insertAfter(y.hDiv);var Xa=D("toolbarUpper","ui-userdata");"both"===k.toolbar[1]?(y.ubDiv=document.createElement("div"),b(y.uDiv).addClass(Xa).attr("id","t_"+k.id).insertBefore(y.hDiv),b(y.ubDiv).addClass(D("toolbarBottom","ui-userdata")).attr("id","tb_"+k.id).insertAfter(y.hDiv),
Ba&&b(y.ubDiv).hide()):b(y.uDiv).width(y.width).addClass(Xa).attr("id","t_"+k.id);Ba&&b(y.uDiv).hide()}"string"===typeof k.datatype&&(k.datatype=k.datatype.toLowerCase());k.toppager?(k.toppager=k.id+"_toppager",y.topDiv=b("<div id='"+k.toppager+"'></div>")[0],b(y.topDiv).addClass(D("pager.pager","ui-jqgrid-toppager"+(k.caption?"":" "+Qa))).css({width:y.width+"px"}).insertBefore(y.hDiv),sb.call(d,k.toppager,"_t"),k.toppager="#"+G(k.toppager)):""!==k.pager||k.scroll||(k.rowNum=k.maxRowNum);k.footerrow&&
(y.sDiv=b("<div class='ui-jqgrid-sdiv'></div>")[0],Za=b("<div class='ui-jqgrid-hbox"+("rtl"===ba?"-rtl":"")+"'></div>"),b(y.sDiv).append(Za).width(y.width).insertAfter(y.hDiv),b(Za).append(Ta),y.footers=b(".ui-jqgrid-ftable",y.sDiv)[0].rows[0].cells,k.rownumbers&&(y.footers[0].className=D("rowNum","jqgrid-rownum")),Ba&&b(y.sDiv).hide());Za=null;if(k.caption){var db=k.datatype;!0===k.hidegrid&&(b(".ui-jqgrid-titlebar-close",y.cDiv).click(function(a){var c=".ui-jqgrid-bdiv,.ui-jqgrid-hdiv,.ui-jqgrid-pager,.ui-jqgrid-sdiv",
e=this;!0===k.toolbar[0]&&("both"===k.toolbar[1]&&(c+=",#"+G(b(y.ubDiv).attr("id"))),c+=",#"+G(b(y.uDiv).attr("id")));var f=b(c,k.gView).length;k.toppager&&(c+=","+k.toppager);"visible"===k.gridstate?b(c,k.gBox).slideUp("fast",function(){f--;0===f&&(b("span",e).removeClass(Pa).addClass(Va),k.gridstate="hidden",b(k.gBox).hasClass("ui-resizable")&&b(".ui-resizable-handle",k.gBox).hide(),b(y.cDiv).addClass(Ga),Ba||Q.call(d,"onHeaderClick",k.gridstate,a))}):"hidden"===k.gridstate&&(b(y.cDiv).removeClass(Ga),
b(c,k.gBox).slideDown("fast",function(){f--;0===f&&(b("span",e).removeClass(Va).addClass(Pa),Ba&&(k.datatype=db,ha.call(d),Ba=!1),k.gridstate="visible",b(k.gBox).hasClass("ui-resizable")&&b(".ui-resizable-handle",k.gBox).show(),Ba||Q.call(d,"onHeaderClick",k.gridstate,a))}));return!1}),Ba&&(k.datatype="local",b(".ui-jqgrid-titlebar-close",y.cDiv).trigger("click")))}else b(y.cDiv).hide(),b(y.cDiv).nextAll("div:visible").first().addClass("ui-corner-top");b(y.hDiv).after(y.bDiv);y.eDiv=b("<div class='"+
D("gridError","ui-jqgrid-errorbar ui-jqgrid-errorbar-"+ba)+"' style='display:none;'><span class='ui-jqgrid-error'></span></div>")[0];b(y.hDiv).after(y.eDiv);b(O).click(pa).dblclick(function(a){var e=b(k.rs),f=e.offset(),g=e.data("idx"),l=e.data("delta"),m=k.colModel[g],n=b(this).data("pageX")||e.data("pageX");if(null==n||null==m)return!1;var n=String(n).split(";"),p=parseFloat(n[0]),r=parseFloat(n[1]);if(2===n.length&&(5<Math.abs(p-r)||5<Math.abs(a.pageX-p)||5<Math.abs(a.pageX-r)))return!1;Q.call(d,
"resizeDblClick",g,m)&&f.left-1<=a.pageX+l&&a.pageX+l<=f.left+e.outerWidth()+1&&m.autoResizable&&c.autoResizeColumn.call(h,g);Q.call(d,"afterResizeDblClick",{iCol:g,cm:m,cmName:m.name});return!1});k.pager||b(y.cDiv).nextAll("div:visible").filter(":last").addClass(Ga);b(".ui-jqgrid-labels",y.hDiv).bind("selectstart",function(){return!1});d.formatCol=T;d.sortData=tb;d.updatepager=hb;d.refreshIndex=ra;d.setHeadCheckBox=ib;d.fixScrollOffsetAndhBoxPadding=I;d.constructTr=sa;d.formatter=N;n(y,{populate:ha,
...
t,l))}Q.call(f,"afterSetRow",{rowid:a,inputData:c,iData:q,iRow:h.rowIndex,tr:h,localData:l,cssProp:e})}catch(u){d=!1}d&&("string"===m?b(h).addClass(e):null!==e&&"object"===m&&b(h).css(e))});return d},addRowData:function(a,c,e,d){0>b.inArray(e,"first last before after afterSelected beforeSelected".split(" "))&&(e="last");var f=!1,g,h,m,l,n,p,q,r,t,w,x;c&&(b.isArray(c)?(p=!0,q=a):(c=[c],p=!1),this.each(function(){var B=this.p,z=c.length,v=b(this),E=this.rows,A=0,D=C.getGridRowById,k=B.colModel,F,I=
B.additionalProperties;p||(void 0!==a?a=String(a):(a=Da(),!1!==B.keyName&&(q=B.keyName,void 0!==c[0][q]&&(a=c[0][q]))));for(r=B.altclass;A<z;){t=c[A];h=[];if(p)try{a=t[q],void 0===a&&(a=Da())}catch(H){a=Da()}x=a;F={};for(l=0;l<k.length;l++)w=k[l],g=w.name,"rn"!==g&&"cb"!==g&&"subgrid"!==g&&(n=Xa.call(this,t[g],w,void 0,x,{},l),b.isFunction(w.saveLocally)?w.saveLocally.call(this,{newValue:n,newItem:F,oldItem:{},id:x,cm:w,cmName:g,iCol:l}):void 0!==n&&(F[g]=n));for(l=0;l<I.length;l++)g=I[l],"object"===
typeof g&&g.hasOwnProperty("name")&&(g=g.name),n=qa(t,g),void 0!==n&&(F[g]=n);"local"===B.datatype&&(F[B.localReader.id]=x,B._index[x]=B.data.length,B.data.push(F));h=u.parseDataToHtml.call(this,1,[a],[t]);h=h.join("");if(0===E.length)b(this.tBodies[0]).append(h);else{if("afterSelected"===e||"beforeSelected"===e)void 0===d&&null!==B.selrow?(d=B.selrow,e="afterSelected"===e?"after":"before"):e="afterSelected"===e?"last":"first";switch(e){case "last":b(E[E.length-1]).after(h);m=E.length-1;break;case "first":b(E[0]).after(h);
m=1;break;case "after":if(m=D.call(v,d))b(E[m.rowIndex+1]).hasClass("ui-subgrid")?(b(E[m.rowIndex+1]).after(h),m=m.rowIndex+2):(b(m).after(h),m=m.rowIndex+1);break;case "before":if(m=D.call(v,d))b(m).before(h),m=m.rowIndex-1}}!0===B.subGrid&&C.addSubGrid.call(v,B.iColByName.subgrid,m);B.records++;B.reccount++;0===B.lastpage&&(B.lastpage=1);Q.call(this,"afterAddRow",{rowid:a,inputData:c,position:e,srcRowid:d,iRow:m,localData:F,iData:B.data.length-1});A++}!0!==B.altRows||p||v.jqGrid("isBootstrapGuiStyle")||
...
this.hidden||q(this.classes)||(d=this.widthOrg,g+=d+x,this.fixed?p+=this.width+x:m++)});if(0===m)return;e.tblwidth=parseInt(g,10);n=r-x*m-p;!isNaN(e.height)&&(v.clientHeight<v.scrollHeight||1===this.rows.length)&&(l=!0,n-=w);F=n/(e.tblwidth-x*m-p);if(0>F)return;g=0;k=0<D.length;b.each(t,function(b){!1!==this.hidden||q(this.classes)||this.fixed||(this.width=d=Math.round(this.widthOrg*F),g+=d,B[b].width=d,I[b].style.width=d+"px",e.footerrow&&(z[b].style.width=d+"px"),k&&(D[b].style.width=d+"px"),h=
b)});if(!h)return;n=0;l?r-p-(g+x*m)!==w&&(n=r-p-(g+x*m)-w):1!==Math.abs(r-p-(g+x*m))&&(n=r-p-(g+x*m));t=t[h];t.width+=n;e.tblwidth=parseInt(g+n+x*m+p,10);e.tblwidth>r&&(n=e.tblwidth-parseInt(r,10),e.tblwidth=r,t.width-=n);d=t.width;r=B[h];r.width=d;I[h].style.width=d+"px";k&&(D[h].style.width=d+"px");e.footerrow&&(z[h].style.width=d+"px");e.tblwidth+(l?w:0)<e.width&&H(e.tblwidth+(l?w:0));v.offsetWidth>v.clientWidth&&(e.autowidth||void 0!==e.widthOrg&&"auto"!==e.widthOrg&&"100%"!==e.widthOrg||H(v.offsetWidth))}e.tblwidth&&
...
B=g.savedRow;if(null!=q){g.selrow=q;g.knv||f.jqGrid("GridNav");if(0<B.length){if(!0===e&&a===w&&c===t)return;f.jqGrid("saveCell",B[0].id,B[0].ic)}else setTimeout(function(){b("#"+u.jqID(g.knv)).attr("tabindex","-1").focus()},1);n=g.colModel[c];h=n.name;if("subgrid"!==h&&"cb"!==h&&"rn"!==h){l=ya.call(d,p,c);p=n.editable;b.isFunction(p)&&(p=p.call(d,{rowid:q,iCol:c,iRow:a,name:h,cm:n,mode:"cell"}));var z=f.jqGrid("getGuiStyles","select","edit-cell"),v=f.jqGrid("getGuiStyles","hover","selected-row");
...
z,v=ya.call(e,r,c),E={},A=u.getEditedValue.call(e,v,x,E);if(A!==p[q].v){z=d.triggerHandler("jqGridBeforeSaveCell",[t,B,A,a,c]);void 0!==z&&(A=z);b.isFunction(f.beforeSaveCell)&&(z=f.beforeSaveCell.call(e,t,B,A,a,c),void 0!==z&&(A=z));var D=u.checkValues.call(e,A,c,void 0,void 0,{oldValue:p[q].v,newValue:A,cmName:B,rowid:t,iCol:c,iRow:a,cm:x,tr:r,td:v,mode:"cell"}),r=x.formatoptions||{};if(!0===D[0]){q=d.triggerHandler("jqGridBeforeSubmitCell",[t,B,A,a,c])||{};b.isFunction(f.beforeSubmitCell)&&((q=
f.beforeSubmitCell.call(e,t,B,A,a,c))||(q={}));0<b("input.hasDatepicker",v).length&&b("input.hasDatepicker",v).datepicker("hide");"date"===x.formatter&&!0!==r.sendFormatted&&(A=b.unformat.date.call(e,A,x));if("remote"===f.cellsubmit)if(f.cellurl){var k={};k[B]=A;var m=f.prmNames,r=m.oper,F=e.grid.hDiv;k[m.id]=u.stripPref(f.idPrefix,t);k[r]=m.editoper;k=b.extend(q,k);f.autoEncodeOnEdit&&b.each(k,function(a,c){b.isFunction(c)||(k[a]=u.oldEncodePostedData(c))});d.jqGrid("progressBar",{method:"show",
loadtype:f.loadui,htmlcontent:u.defaults.savetext||"Saving..."});F.loading=!0;b.ajax(b.extend({url:b.isFunction(f.cellurl)?f.cellurl.call(e,f.cellurl,a,c,t,A,B):f.cellurl,data:u.serializeFeedback.call(e,f.serializeCellData,"jqGridSerializeCellData",k),type:"POST",complete:function(h){d.jqGrid("progressBar",{method:"hide",loadtype:f.loadui});F.loading=!1;if((300>h.status||304===h.status)&&(0!==h.status||4!==h.readyState)){var m=d.triggerHandler("jqGridAfterSubmitCell",[e,h,k.id,B,A,a,c])||[!0,""];
!0===m[0]&&b.isFunction(f.afterSubmitCell)&&(m=f.afterSubmitCell.call(e,h,k.id,B,A,a,c));!0===m[0]?(d.jqGrid("setCell",t,c,A,!1,!1,!0),v.addClass("dirty-cell"),w.addClass("edited"),Q.call(e,"afterSaveCell",t,B,A,a,c),p.splice(0,1)):(g.call(e,l,m[1],n),d.jqGrid("restoreCell",a,c))}},error:function(k,m,p){b("#lui_"+h(f.id)).hide();F.loading=!1;d.triggerHandler("jqGridErrorCell",[k,m,p]);b.isFunction(f.errorCell)?f.errorCell.call(e,k,m,p):g.call(e,l,k.status+" : "+k.statusText+"<br/>"+m,n);d.jqGrid("restoreCell",
...
c.size||(c.size=20));b(h).attr("role",t);break;case "image":case "file":h=document.createElement("input");h.type=a;g(h,c);break;case "custom":h=document.createElement("span");try{if(b.isFunction(c.custom_element)){var z=c.custom_element.call(m,e,c);if(z instanceof jQuery||u.isHTMLElement(z)||"string"===typeof z)z=b(z).addClass("customelement").attr({id:c.id,name:c.name}),b(h).empty().append(z);else throw"editoptions.custom_element returns value of a wrong type";}else throw"editoptions.custom_element is not a function";
...
this.name)+"' id='"+v(this.name)+"'/>");b(C).append(O);try{if(b.isFunction(d.custom_element)){var ra=d.custom_element.call(c,void 0!==d.defaultValue?d.defaultValue:"",d);if(ra)ra=b(ra).addClass("customelement"),b(C).find("span[name='"+(this.index||this.name)+"']").append(ra);else throw"e2";}else throw"e1";}catch(sa){"e1"===sa&&h.call(c,q,"function 'custom_element' "+t.nodefined,r),"e2"===sa?h.call(c,q,"function 'custom_element' "+t.novalue,r):h.call(c,q,"string"===typeof sa?sa:sa.message,r)}}}b(E).append(C);
...
y[c],a)));break;default:void 0!==a&&0>b.inArray(a,v.skipPostTypes)&&(y[c]=b(this).val())}});return!0}function d(a,c,d){var e=0,f=[],g=!1,h="",k;for(k=1;k<=d;k++)h+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==a&&(g=C.getInd.call(t,a));b(J).each(function(k){var l=this.name,m,n,p,q,t;m=this.editable;var y=!1,x=!1;t="_empty"===a?"addForm":"editForm";b.isFunction(m)&&(m=m.call(r,{rowid:a,iCol:k,iRow:g,cmName:l,cm:this,mode:t}));q=(this.editrules&&!0===this.editrules.edithidden?
0:!0===this.hidden||"hidden"===m)?"style='display:none'":"";switch(String(m).toLowerCase()){case "hidden":m=!0;break;case "disabled":y=m=!0;break;case "readonly":x=m=!0}if("cb"!==l&&"subgrid"!==l&&!0===m&&"rn"!==l){if(!1===g)p="";else{m=b(r.rows[g].cells[k]);try{p=b.unformat.call(r,m,{rowId:a,colModel:this},k)}catch(F){p=this.edittype&&"textarea"===this.edittype?m.text():m.html()}Ga(p)&&(p="")}m=b.extend({},this.editoptions||{},{id:l,name:l,rowId:a,mode:t,cm:this,iCol:k});var A=b.extend({},{elmprefix:"",
...
f=y[e];"date"!==d.formatter||null!=d.formatoptions&&!0===d.formatoptions.sendFormatted||(y[e]=b.unformat.date.call(r,f,d));"clientArray"!==a&&d.editoptions&&!0===d.editoptions.NullIfEmpty&&y.hasOwnProperty(e)&&""===f&&(y[e]="null")})}function h(){var c=[!0,"",""],d={},e=w.prmNames,h,l,m,n,p,q,A=C.getInd.call(t,a),D=!1===A?null:r.rows[A];(q=t.triggerHandler("jqGridAddEditBeforeCheckValues",[b(E),M]))&&"object"===typeof q&&(y=q);A=!1===A?-1:A;b.isFunction(v.beforeCheckValues)&&(q=v.beforeCheckValues.call(r,
...
[y,b(E),M]),null==c&&(c=[!0,"",""]),c[0]&&b.isFunction(v.beforeSubmit)&&(c=v.beforeSubmit.call(r,y,b(E),M),null==c&&(c=[!0,"",""])));if(c[0]&&!v.processing){v.processing=!0;b("#sData",F).addClass(X);m=v.url||w.editurl;l=e.oper;h="clientArray"===m&&!1!==w.keyName?w.keyName:e.id;y[l]="_empty"===b.trim(y[x+"_id"])?e.addoper:e.editoper;y[l]!==e.addoper?y[h]=y[x+"_id"]:void 0===y[h]&&(y[h]=y[x+"_id"]);delete y[x+"_id"];y=b.extend(y,v.editData,d);if(!0===w.treeGrid)for(p in y[l]===e.addoper&&(n=w.selrow,
y["adjacency"===w.treeGridModel?w.treeReader.parent_id_field:"parent_id"]=n),w.treeReader)w.treeReader.hasOwnProperty(p)&&(d=w.treeReader[p],!y.hasOwnProperty(d)||y[l]===e.addoper&&"parent_id_field"===p||delete y[d]);y[h]=u.stripPref(w.idPrefix,y[h]);w.autoEncodeOnEdit&&b.each(y,function(a,c){b.isFunction(c)||(y[a]=u.oldEncodePostedData(c))});p=b.extend({url:b.isFunction(m)?m.call(r,y[h],M,y,v):m,type:b.isFunction(v.mtype)?v.mtype.call(r,M,v,y[h],y):v.mtype,data:u.serializeFeedback.call(r,b.isFunction(v.serializeEditData)?
v.serializeEditData:w.serializeEditData,"jqGridAddEditSerializeEditData",y),complete:function(a,d){b("#sData",F).removeClass(X);y[h]=b("#id_g",k).val();300<=a.status&&304!==a.status||0===a.status&&4===a.readyState?(c[0]=!1,c[1]=t.triggerHandler("jqGridAddEditErrorTextFormat",[a,M]),b.isFunction(v.errorTextFormat)?c[1]=v.errorTextFormat.call(r,a,M):c[1]=d+" Status: '"+a.statusText+"'. Error code: "+a.status):(c=t.triggerHandler("jqGridAddEditAfterSubmit",[a,y,M]),null==c&&(c=[!0,"",""]),c[0]&&b.isFunction(v.afterSubmit)&&
(c=v.afterSubmit.call(r,a,y,M),null==c&&(c=[!0,"",""])));if(!1===c[0])b("#FormError>td",k).html(c[1]),b("#FormError",k).show();else{w.autoEncodeOnEdit&&b.each(y,function(b,a){y[b]=u.oldDecodePostedData(a)});var g=[b.extend({},v.reloadGridOptions||{})];y[l]===e.addoper?(c[2]||(c[2]=u.randId()),null==y[h]||"_empty"===y[h]||y[l]===e.addoper?y[h]=c[2]:c[2]=y[h],v.reloadAfterSubmit?t.trigger("reloadGrid",g):!0===w.treeGrid?C.addChildNode.call(t,c[2],n,y):C.addRowData.call(t,c[2],y,v.addedrow),v.closeAfterAdd?
(!0!==w.treeGrid&&z.call(t,c[2]),O()):v.clearAfterAdd&&f("_empty",E)):(v.reloadAfterSubmit?(t.trigger("reloadGrid",g),v.closeAfterEdit||setTimeout(function(){z.call(t,y[h])},1E3)):!0===w.treeGrid?C.setTreeRow.call(t,y[h],y):C.setRowData.call(t,y[h],y),v.closeAfterEdit&&O());if(b.isFunction(v.afterComplete)){var m=a;setTimeout(function(){t.triggerHandler("jqGridAddEditAfterComplete",[m,y,b(E),M]);v.afterComplete.call(r,m,y,b(E),M);m=null},50)}if(v.checkOnSubmit||v.checkOnUpdate)if(b(E).data("disabled",
...
O(),p.data.oper===e.editoper&&v.closeAfterEdit&&O())):"clientArray"===p.url?(v.reloadAfterSubmit=!1,y=p.data,p.complete({status:200,statusText:""},"")):b.ajax(p))}!1===c[0]&&(b("#FormError>td",k).html(c[1]),b("#FormError",k).show())}function m(b,a){var c=!1,d;for(d in b)if(b.hasOwnProperty(d)&&String(b[d])!==String(a[d])){c=!0;break}return c}function l(){var a=!0;b("#FormError",k).hide();v.checkOnUpdate&&(y={},e(),K=m(y,v._savedData))&&(b(E).data("disabled",!0),b(".confirm",H).show(),a=!1);return a}
...
1]&&ca(b("#"+G(c[1][a+1])),V)?b("#nData",F).addClass(V):b("#nData",F).removeClass(V)}function q(){var a=C.getDataIDs.call(t),c=b("#id_g",k).val();return[b.inArray(c,a),a]}var r=this,t=b(r),w=r.p;if(r.grid&&null!=w&&a){var x=w.id,B=C.getGridRes,z=C.setSelection,v=b.extend(!0,{top:0,left:0,width:300,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,url:null,mtype:"POST",clearAfterAdd:!0,closeAfterEdit:!1,reloadAfterSubmit:!0,onInitializeForm:null,beforeInitData:null,beforeShowForm:null,
...
!0);D=b("<div></div>").append(b("<div class='"+N.call(r,"dialog.body")+"'></div>").append(A)).append(D);u.createModal.call(r,I,D,v,w.gView,b(L)[0]);v.topinfo&&b(".tinfo",k).show();v.bottominfo&&b(".binfo",F).show();D=D=null;b(H).keydown(function(a){var c=(a.target.tagName||"").toUpperCase(),d,e;if(!0===b(E).data("disabled"))return!1;if(13===a.which&&"TEXTAREA"!==c){d=b(F).find(":focus");e=d.attr("id");if(0<d.length&&0<=b.inArray(e,["pData","nData","cData"]))return d.trigger("click"),!1;if(!0===v.savekey[0]&&
13===v.savekey[1])return b("#sData",F).trigger("click"),!1}if(!0===v.savekey[0]&&a.which===v.savekey[1]&&"TEXTAREA"!==c)return b("#sData",F).trigger("click"),!1;if(27===a.which){if(!l())return!1;hb&&O();return!1}if(!0===v.navkeys[0]){if("_empty"===b("#id_g",k).val())return!0;if(a.which===v.navkeys[1])return b("#pData",F).trigger("click"),!1;if(a.which===v.navkeys[2])return b("#nData",F).trigger("click"),!1}});v.checkOnUpdate&&(b("a.ui-jqdialog-titlebar-close span",H).removeClass("jqmClose"),b("a.ui-jqdialog-titlebar-close",
...
(a=h.afterSubmit.call(e,c,n)||[!0]);if(!1===a[0])b("#DelError>td",l).html(a[1]),b("#DelError",l).show();else{if(h.reloadAfterSubmit&&"local"!==d.datatype)f.trigger("reloadGrid",[b.extend({},h.reloadGridOptions||{})]);else if(!0===d.treeGrid)try{C.delTreeNode.call(f,t[0])}catch(p){}else for(t=t.slice(),k=0;k<t.length;k++)C.delRowData.call(f,t[k]);setTimeout(function(){z("afterComplete",c,m,b(l))},50)}h.processing=!1;a[0]&&u.hideModal(w,{gb:x,jqm:h.jqModal,onClose:h.onClose,removemodal:h.removemodal})}},
...
!1}},A=aa.call(m,"hover"),D=aa.call(m,"disabled"),k=N.call(m,"navButton","ui-pg-button");if(m.grid){m.modalAlert=z;void 0===a&&(l.pager?(a=l.pager,l.toppager&&(q.cloneToTop=!0)):l.toppager&&(a=l.toppager));var F=1,I,H,L,J,S,K,P=["left","center","right"],y="<div class='"+N.call(m,"navButton","ui-pg-button "+aa.call(m,"disabled"))+"'><span class='ui-separator'></span></div>",Q=function(){ca(this,D)||b(this).addClass(A)},M=function(){b(this).removeClass(A)},ba=function(){ca(this,D)||(b.isFunction(q.addfunc)?
q.addfunc.call(m):C.editGridRow.call(n,"new",d));return!1},O=function(a,c,d){if(!ca(this,D)){var e=l.selrow;e?b.isFunction(a)?a.call(m,e):C[c].call(n,e,d):z()}return!1},W=function(){return O.call(this,q.editfunc,"editGridRow",e)},T=function(){return O.call(this,q.viewfunc,"viewGridRow",h)},Z=function(){var a;ca(this,D)||(l.multiselect?(a=l.selarrrow,0===a.length&&(a=null)):a=l.selrow,a?b.isFunction(q.delfunc)?q.delfunc.call(m,a):C.delGridRow.call(n,a,f):z());return!1},V=function(){ca(this,D)||(b.isFunction(q.searchfunc)?
...
b(this).triggerHandler("jqGridResetFrozenHeights",[{header:{resizeDiv:!1,resizedRows:{iRowStart:-1,iRowEnd:-1}},resizeFooter:!1,body:{resizeDiv:!0,resizedRows:{iRowStart:l,iRowEnd:h.length?h[0].rowIndex-1:-1}}}]);this.fixScrollOffsetAndhBoxPadding();b(this).triggerHandler("jqGridGroupingClickGroup",[a,p]);b.isFunction(e.onClickGroup)&&e.onClickGroup.call(this,a,p)});return!1},groupingRender:function(a,c){function e(a,c,d,e,h){var l=B[a],m,n="",p,q,t,w=0,x,A,D,E=!0;if(0!==c&&0!==B[a].idx)for(m=a;0<=
m;m--)if(B[m].idx===B[a].idx-c){l=B[m];break}a=l.cnt;for(x=void 0===h?e:0;x<v;x++){c="&#160;";m=z[x];for(p=0;p<l.summary.length;p++)if(q=l.summary[p],A=b.isArray(q.st)?q.st[d.idx]:q.st,D=b.isArray(m.summaryTpl)?m.summaryTpl[d.idx]:m.summaryTpl||"{0}",q.nm===m.name){"string"===typeof A&&"avg"===A.toLowerCase()&&(q.sd&&q.vd?q.v/=q.vd:q.v&&0<a&&(q.v/=a));try{q.groupCount=l.cnt,q.groupIndex=l.dataIndex,q.groupValue=l.value,t=f.formatter("",q.v,x,q)}catch(C){t=q.v}c=u.format(D,t);break}q=p=!1;void 0!==
...
var k=l("errors.errcap"),F=l("edit.bClose"),I;if(!1!==E&&(l=n.extraparam[z.oper]===z.addoper?"add":"edit",Va.call(p,n,"beforeSaveRow",n,a,l)&&(z=D.attr("editable"),n.url=n.url||r.editurl,I="clientArray"!==n.url,"1"===z)))if(u.enumEditableCells.call(p,E,D.hasClass("jqgrid-new-row")?"add":"edit",function(c){var d=c.cm,e=d.formatter,f=d.editoptions||{},g=d.formatoptions||{},h={},k=(b.jgrid.detectRowEditing.call(p,a)||{}).savedRow,l=u.getEditedValue.call(p,b(c.dataElement),d,h,c.editable);"select"===
d.edittype&&"select"!==d.formatter&&(x[d.name]=h.text);A=u.checkValues.call(p,l,c.iCol,void 0,void 0,b.extend(c,{oldValue:null!=k?k[d.name]:null,newValue:l,oldRowData:k}));if(!1===A[0])return!1;"date"===e&&!0!==g.sendFormatted&&(l=b.unformat.date.call(p,l,d));I&&!0===f.NullIfEmpty&&""===l&&(l="null");w[d.name]=l}),!1===A[0])try{var H=q.jqGrid("getGridRowById",a),C=u.findPos(H);t.call(p,k,A[1],F,{left:C[0],top:C[1]+b(H).outerHeight()})}catch(J){alert(A[1])}else if(H=a,z=r.prmNames,C=!1===r.keyName?
...
c.treeGridModel){f=u.from.call(this,c.data).greater(l,e,{stype:"integer"}).select();if(f.length)for(g in f)f.hasOwnProperty(g)&&(f[g][l]=parseInt(f[g][l],10)-d);f=u.from.call(this,c.data).greater(n,e,{stype:"integer"}).select();if(f.length)for(g in f)f.hasOwnProperty(g)&&(f[g][n]=parseInt(f[g][n],10)-d)}}})},addChildNode:function(a,c,e,d){var f=b(this),g=f[0],h=g.p,m=C.getInd;if(e){var l,n,p,q,r;l=0;var t=c,w,x,B=h.treeReader.expanded_field;x=h.treeReader.leaf_field;var z=h.treeReader.level_field,
v=h.treeReader.parent_id_field,E=h.treeReader.left_field,A=h.treeReader.right_field,D=h.treeReader.loaded;void 0===d&&(d=!1);if(null==a){r=h.data.length-1;if(0<=r)for(;0<=r;)l=Math.max(l,parseInt(h.data[r][h.localReader.id],10)),r--;a=l+1}var k=m.call(f,c);w=!1;if(void 0===c||null===c||""===c)t=c=null,l="last",q=h.tree_root_level,r=h.data.length+1;else{l="after";n=h._index[c];p=h.data[n];c=p[h.localReader.id];r=m.call(f,c);q=parseInt(p[z],10)+1;var F=C.getFullTreeNode.call(f,p);if(F.length){var G,
H,K;for(G=0;G<F.length;G++)K=F[G][h.localReader.id],H=m.call(f,K),H>r&&(r=H,t=K)}r++;p[x]&&(w=!0,p[B]=!0,b(g.rows[k]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(h.treeIcons.leaf+" tree-leaf").addClass(h.treeIcons.commonIconClass).addClass(h.treeIcons.minus+" tree-minus"),h.data[n][x]=!1,p[D]=!0)}m=r+1;void 0===e[B]&&(e[B]=!1);void 0===e[D]&&(e[D]=!1);e[z]=q;void 0===e[x]&&(e[x]=!0);"adjacency"===h.treeGridModel&&(e[v]=
c);if("nested"===h.treeGridModel){var J;if(null!==c){x=parseInt(p[A],10);h=u.from.call(g,h.data);h=h.greaterOrEquals(A,x,{stype:"integer"});z=h.select();if(z.length)for(J in z)z.hasOwnProperty(J)&&(z[J][E]=z[J][E]>x?parseInt(z[J][E],10)+2:z[J][E],z[J][A]=z[J][A]>=x?parseInt(z[J][A],10)+2:z[J][A]);e[E]=x;e[A]=x+1}else{x=parseInt(C.getCol.call(f,A,!1,"max"),10);z=u.from.call(g,h.data).greater(E,x,{stype:"integer"}).select();if(z.length)for(J in z)z.hasOwnProperty(J)&&(z[J][E]=parseInt(z[J][E],10)+2);
z=u.from.call(g,h.data).greater(A,x,{stype:"integer"}).select();if(z.length)for(J in z)z.hasOwnProperty(J)&&(z[J][A]=parseInt(z[J][A],10)+2);e[E]=x+1;e[A]=x+2}}if(null===c||C.isNodeLoaded.call(f,p)||w)C.addRowData.call(f,a,e,l,t),C.setTreeNode.call(f,r,m);p&&!p[B]&&d&&b(g.rows[k]).find("div.treeclick").click()}}});var ua="mousedown",za="mousemove",va="mouseup",wb=function(a){var b=a.originalEvent.targetTouches;return b?(b=b[0],{x:b.pageX,y:b.pageY}):{x:a.pageX,y:a.pageY}},La={drag:function(a){var b=
