...
if(!d)return{top:0,left:0};c=null!=c.getBoundingClientRect?c.getBoundingClientRect():b(c).offset();d=null!=d.getBoundingClientRect?d.getBoundingClientRect():b(d).offset();return{top:c.top+a-d.top,left:c.left-d.left}},getCellIndex:function(a){a=b(a);if(a.is("tr"))return-1;a=(a.is("td")||a.is("th")?a:a.closest("td,th"))[0];return null==a?-1:t.msie?b.inArray(a,a.parentNode.cells):a.cellIndex},stripHtml:function(b){return(b=String(b))?(b=b.replace(/<("[^"]*"|'[^']*'|[^'">])*>/gi,""))&&"&nbsp;"!==b&&"&#160;"!==
b?b.replace(/\"/g,"'"):"":b},stripPref:function(a,c){var d=b.type(a);if("string"===d||"number"===d)a=String(a),c=""!==a?String(c).replace(String(a),""):c;return c},getRes:function(b,c){var a=c.split("."),e=a.length,g;if(null!=b){for(g=0;g<e;g++){if(!a[g])return null;b=b[a[g]];if(void 0===b)break;if("string"===typeof b)break}return b}},parseDate:function(a,c,d,e){var g,f,k,l=0,m=0;g="string"===typeof c?c.match(/^\/Date\((([\-+])?[0-9]+)(([\-+])([0-9]{2})([0-9]{2}))?\)\/$/):null;var n=function(b,a){b=
String(b);for(a=parseInt(a,10)||2;b.length<a;)b="0"+b;return b},l={m:1,d:1,y:1970,h:0,i:0,s:0,u:0},p=function(b,a){0===b?12===a&&(a=0):12!==a&&(a+=12);return a};e=function(b,a){var c="AmPm dayNames masks monthNames userLocalTime parseRe S srcformat".split(" "),d=a||{},e=(t.formatter||{}).date||{},g=null==b||null==b.locale?{}:((ea[b.locale]||{}).formatter||{}).date,f,k=c.length,l={},m;for(f=0;f<k;f++)m=c[f],void 0!==d[m]?l[m]=d[m]:void 0!==e[m]?l[m]=e[m]:void 0!==g[m]&&(l[m]=g[m]);return l}(this.p,
e);void 0===e.parseRe&&(e.parseRe=/[#%\\\/:_;.,\t\s\-]/);e.masks.hasOwnProperty(a)&&(a=e.masks[a]);if(c&&null!=c)if(isNaN(c)||"u"!==String(a).toLowerCase())if(isNaN(c)||"u1000"!==String(a).toLowerCase())if(c.constructor===Date)l=c;else if(null!==g)l=new Date(parseInt(g[1],10)),g[3]&&(m=60*Number(g[5])+Number(g[6]),m*="-"===g[4]?1:-1,m-=l.getTimezoneOffset(),l.setTime(Number(Number(l)+6E4*m)));else{"ISO8601Long"===e.srcformat&&"Z"===c.charAt(c.length-1)&&(m-=(new Date).getTimezoneOffset());c=String(c).replace(/\T/g,
"#").replace(/\t/,"%").split(e.parseRe);a=a.replace(/\T/g,"#").replace(/\t/,"%").split(e.parseRe);f=0;for(k=Math.min(a.length,c.length);f<k;f++){switch(a[f]){case "M":g=b.inArray(c[f],e.monthNames);-1!==g&&12>g&&(c[f]=g+1,l.m=c[f]);break;case "F":g=b.inArray(c[f],e.monthNames,12);-1!==g&&11<g&&(c[f]=g+1-12,l.m=c[f]);break;case "n":l.m=parseInt(c[f],10);break;case "j":l.d=parseInt(c[f],10);break;case "g":l.h=parseInt(c[f],10);break;case "a":g=b.inArray(c[f],e.AmPm);-1!==g&&2>g&&c[f]===e.AmPm[g]&&(c[f]=
g,l.h=p(c[f],l.h));break;case "A":g=b.inArray(c[f],e.AmPm),-1!==g&&1<g&&c[f]===e.AmPm[g]&&(c[f]=g-2,l.h=p(c[f],l.h))}void 0!==c[f]&&(l[a[f].toLowerCase()]=parseInt(c[f],10))}l.f&&(l.m=l.f);if(0===l.m&&0===l.y&&0===l.d)return"&#160;";l.m=parseInt(l.m,10)-1;a=l.y;70<=a&&99>=a?l.y=1900+l.y:0<=a&&69>=a&&(l.y=2E3+l.y);l=new Date(l.y,l.m,l.d,l.h,l.i,l.s,l.u);0<m&&l.setTime(Number(Number(l)+6E4*m))}else l=new Date(parseFloat(c));else l=new Date(1E3*parseFloat(c));else l=new Date(l.y,l.m,l.d,l.h,l.i,l.s,
l.u);e.userLocalTime&&0===m&&(m-=(new Date).getTimezoneOffset(),0<m&&l.setTime(Number(Number(l)+6E4*m)));if(void 0===d)return l;e.masks.hasOwnProperty(d)?d=e.masks[d]:d||(d="Y-m-d");m=l.getHours();a=l.getMinutes();c=l.getDate();p=l.getMonth()+1;g=l.getTimezoneOffset();f=l.getSeconds();k=l.getMilliseconds();var q=l.getDay(),r=l.getFullYear(),w=(q+6)%7+1,z=(new Date(r,p-1,c)-new Date(r,0,1))/864E5,B=5>w?Math.floor((z+w-1)/7)+1:Math.floor((z+w-1)/7)||(4>((new Date(r-1,0,1)).getDay()+6)%7?53:52),v={d:n(c),
D:e.dayNames[q],j:c,l:e.dayNames[q+7],N:w,S:e.S(c),w:q,z:z,W:B,F:e.monthNames[p-1+12],m:n(p),M:e.monthNames[p-1],n:p,t:"?",L:"?",o:"?",Y:r,y:String(r).substring(2),a:12>m?e.AmPm[0]:e.AmPm[1],A:12>m?e.AmPm[2]:e.AmPm[3],B:"?",g:m%12||12,G:m,h:n(m%12||12),H:n(m),i:n(a),s:n(f),u:k,e:"?",I:"?",O:(0<g?"-":"+")+n(100*Math.floor(Math.abs(g)/60)+Math.abs(g)%60,4),P:"?",T:(String(l).match(/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[\-+]\d{4})?)\b/g)||
...
"";return k?a:a.toUpperCase()};b.each(a,function(b,a){r=""!==e?t.getAccessor(a,e):a;void 0===r&&(r="");r=y(r,a);p.push({vSort:r,data:a,index:b})});b.isFunction(l)?p.sort(function(b,a){return l.call(c,b.vSort,a.vSort,q,b.data,a.data)}):p.sort(function(b,a){return d._compare(b.vSort,a.vSort,q)});f=0;for(var u=a.length;f<u;)g=p[f].index,m.push(a[g]),f++;return m};this._getGroup=function(a,c,e,g,h){var f=[],k=null,l=null;b.each(d._getOrder(a,c,e,g,h),function(b,a){var e=t.getAccessor(a,c);null==e&&(e=
...
c.formatter?"number"!==typeof d||isNaN(a)||("number"===c.formatter||"currency"===c.formatter?a=parseFloat(a):"integer"===c.formatter&&(a=parseInt(a,10))):(d=String(a).toLowerCase(),c=null!=c.editoptions&&"string"===typeof c.editoptions.value?c.editoptions.value.split(":"):["yes","no"],0<=b.inArray(d,["1","true",c[0].toLowerCase()])?a=!0:0<=b.inArray(d,["0","false",c[1].toLowerCase()])&&(a=!1));return a},parseDataToHtml:function(a,c,d,e,g,f,k){var l=this,m=l.p,n=b(l),p,q,r,w,z,B,v,x=!1,u=[],y=[],C=
!0!==m.altRows||n.jqGrid("isBootstrapGuiStyle")?"":m.altclass,A=m.grouping?!0===m.groupingView.groupCollapse:!1,h=parseInt(m.rowNum,10),E,H=b.fn.jqGrid,L=!0===m.treeGrid&&-1<m.treeANode?l.rows[m.treeANode].rowIndex+1:l.rows.length,J=l.formatCol,aa=function(b,a,c,d,e,h){a=l.formatter(b,a,c,e,"add",h);return"<td role='gridcell' "+J(c,d,a,e,b,h)+">"+a+"</td>"},Q=function(a,c,d,e,h){var g="&nbsp;",f=!0;h={rowid:a,iRow:d,iCol:c,data:h,checked:e};b.isFunction(m.hasMultiselectCheckBox)&&(f=m.hasMultiselectCheckBox.call(l,
h));f&&(g=b.isFunction(m.checkboxHtml)?m.checkboxHtml.call(l,h):"<input type='checkbox' id='jqg_"+m.id+"_"+a+"' class='cbox' name='jqg_"+m.id+"_"+a+"'"+(e?" checked='checked' aria-checked='true'":" aria-checked='false'")+"/>");return"<td role='gridcell' "+J(c,d,"",null,a,!0)+">"+g+"</td>"},F=function(b,a,c,d){c=(parseInt(c,10)-1)*parseInt(d,10)+1+a;return"<td role='gridcell' class='"+H.getGuiStyles.call(n,"rowNum","jqgrid-rownum")+"' "+J(b,a,c,null,a,!0)+">"+c+"</td>"};1>=L&&(m.rowIndexes={});if("local"===
m.datatype&&!m.deselectAfterSort||m.multiPageSelection)x=!0;f&&(h*=f+1);for(f=0;f<Math.min(a,h);f++){w=c[f];z=d[f];B=null!=e?e[f]:z;p=1===g?0:g;q=1===(p+f)%2?C:"";x?m.multiselect?(r=-1!==b.inArray(w,m.selarrrow))&&null===m.selrow&&(m.selrow=w):r=w===m.selrow:r=!1;v=u.length;u.push("");for(p=0;p<m.colModel.length;p++)switch(E=m.colModel[p].name,E){case "rn":u.push(F(p,f,m.page,m.rowNum));break;case "cb":u.push(Q(w,p,f,r,z));break;case "subgrid":u.push(H.addSubGridCell.call(n,p,f+g,w,z));break;default:u.push(aa(w,
z[E],p,f+g,B,z))}m.grouping&&H.groupingPrepare&&!m.groupingView._locgr&&(H.groupingPrepare.call(n,z,f),b.isFunction(m.groupingView.groupCollapse)&&(A=m.groupingView.groupCollapse.call(l,{group:m.groupingView.groups[m.groupingView.groups.length-1],rowid:w,data:z})));u[v]=l.constructTr(w,A,q,z,B,r);u.push("</tr>");m.rowIndexes[w]=L;L++;m.grouping&&(y.push(u),u=[]);u.length>m.maxItemsToJoin&&(u=[u.join("")])}m.grouping&&H.groupingRender&&(k&&(m.groupingView._locgr=!0),u=[H.groupingRender.call(n,y,h)],
t.clearArray(y));return u},fillSelectOptions:function(a,c,d,e,g,f){var k,l=[],m,n,p=!1;n=function(b,a){if(0<a)return b};if(c){"function"===typeof c&&(c=c());if("string"===typeof c)for(e=c.split(e),c=0;c<e.length;c++)k=e[c].split(d),2<k.length&&(k[1]=b.map(k,n).join(d)),l.push({value:k[0],innerHtml:k[1],selectValue:b.trim(k[0]),selectText:b.trim(k[1]),selected:!1}),""===k[0]&&(p=!0);else if("object"===typeof c)for(k in c)c.hasOwnProperty(k)&&l.push({value:k,innerHtml:c[k],selectValue:b.trim(k),selectText:b.trim(c[k]),
...
!0),a.appendChild(g);return p}},getMethod:function(a){return this.getAccessor(b.fn.jqGrid,a)},extend:function(a){b.extend(b.fn.jqGrid,a);this.no_legacy_api||b.fn.extend(a)}});var V=t.clearArray,I=t.jqID,Ya=t.getGridComponentIdSelector,Za=t.getGridComponentId,Ha=t.getGridComponent,Ba=t.stripPref,ya=t.randId,ra=t.getAccessor,hb=t.convertOnSaveLocally,ib=t.stripHtml,pb=t.htmlEncode,Ma=t.htmlDecode,ta=t.mergeCssClasses,Y=t.hasOneFromClasses,N=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("");
a.unshift(this.p);return t.feedback.apply(this,a)};b.fn.jqGrid=function(a){var c=b.fn.jqGrid,d;if("string"===typeof a){d=c[a];if(!d)throw"jqGrid - No such method: "+a;return d.apply(this,b.makeArray(arguments).slice(1))}return this.each(function(){if(!this.grid){var d=this,g,f,k=b(d),l=b.isFunction,m=b.isArray,n=b.extend,p=b.inArray,q=b.trim,r=b.each,w=c.setSelection,z=c.getGridRes,B=l(qa.fatalError)?qa.fatalError:alert,v=a.locale||qa.locale||"en-US",x=null!=ea[v]&&"boolean"===typeof ea[v].isRTL?
ea[v].isRTL?"rtl":"ltr":"ltr",u=a.iconSet||qa.iconSet||("bootstrap"===(a.guiStyle||qa.guiStyle)||"bootstrapPrimary"===(a.guiStyle||qa.guiStyle)?"glyph":"jQueryUI"),y=a.guiStyle||qa.guiStyle||"jQueryUI",C=function(b){return c.getIconRes.call(d,b)},A=function(b,a){return k.jqGrid("getGuiStyles",b,a)};null==a&&(a={datatype:"local"});void 0!==a.datastr&&m(a.datastr)&&(f=a.datastr,a.datastr=[]);void 0!==a.data&&(g=a.data,a.data=[]);null!=t.formatter&&null!=t.formatter.unused||B("CRITICAL ERROR!!!\n\n\nOne uses probably\n\n\t$.extend($.jgrid.defaults, {...});\n\nto set default settings of jqGrid instead of the usage the DEEP version of jQuery.extend (with true as the first parameter):\n\n\t$.extend(true, $.jgrid.defaults, {...});\n\nOne other possible reason:\n\nyou included some OLD version of language file (grid.locale-en.js for example) AFTER jquery.jqGrid.min.js. For example all language files of jqGrid 4.7.0 uses non-deep call of jQuery.extend.\n\n\nSome options of jqGrid could still work, but another one will be broken.");
...
f)};a.on("jqGridGridComplete.selectionPreserver",f)}};d.grid=G;N.call(d,"beforeInitGrid");h.iColByName=L(h.colModel);h.iPropByName=J(h.additionalProperties);var x=b("<div class='"+A("gView","ui-jqgrid-view")+"' role='grid' aria-multiselectable='"+!!h.multiselect+"'></div>"),v=t.msie,M;h.direction=q(h.direction.toLowerCase());-1===p(h.direction,["ltr","rtl"])&&(h.direction="ltr");M=h.direction;b(x).insertBefore(d);k.removeClass("scroll").appendTo(x);g=b("<div class='"+A("gBox","ui-jqgrid")+"'></div>");
...
d,e,g){var f=b(this),k=new Date,n=h.datatype,p="local"!==n&&h.loadonce||"xmlstring"===n||"jsonstring"===n,q=("xmlstring"===n||"xml"===n)&&b.isXMLDoc(a),r=h.localReader,y=ra;if(a&&("xml"!==n||q)){-1!==h.treeANode||h.scroll?d=1<d?d:1:(G.emptyRows.call(this,!1,!0),d=1);p&&(V(h.data),V(h.lastSelectedData),h._index={},h.grouping&&null!=h.groupingView&&(h.groupingView.groups=[],h.groupingView._locgr=!1),h.localReader.id="_id_");h.reccount=0;switch(n){case "xml":case "xmlstring":r=h.xmlReader;y=t.getXmlData;
break;case "json":case "jsonp":case "jsonstring":r=h.jsonReader}var w,u,x,v,C,E={},A,z=h.colModel,B=z.length,H,J,ma,L,ka,Q=h.arrayReaderInfos,Ia={},ga=function(b){return function(a){a=null!=a&&l(a.getAttribute)?a.getAttribute(b):null;return null!==a?a:void 0}},qb=function(b){return function(){var a=Ia[b];if(null!=a)return a=a.childNodes,0<a.length?a[0].nodeValue:void 0}};h.page=F(y(a,r.page),h.page);h.lastpage=F(y(a,r.total),1);h.records=F(y(a,r.records));l(r.userdata)?h.userData=r.userdata.call(this,
a)||{}:q?y(a,r.userdata,!0).each(function(){h.userData[this.getAttribute("name")]=b(this).text()}):h.userData=y(a,r.userdata)||{};rb();var ca={},M=h.additionalProperties,ia=function(b,a){q&&"string"===typeof a&&(/^\w+$/.test(a)?ca[b]=qb(a):/^\[\w+\]$/.test(a)&&(ca[b]=ga(a.substring(1,a.length-1))))},sa=function(b){var a=b.name,c=q?b.xmlmap||a:"local"===n&&!h.dataTypeOrg||"jsonstring"===n||"json"===n||"jsonp"===n?b.jsonmap||a:a;!1!==h.keyName&&!0===b.key&&(h.keyName=a);if("string"===typeof c||l(c))ca[a]=
c;l(c)||ia(a,c)};for(w=0;w<B;w++)sa(z[w]);B=M.length;for(w=0;w<B;w++)J=M[w],"object"===typeof J&&null!=J?sa(J):ia(J,J);v=!1===h.keyName?l(r.id)?r.id.call(this,a):r.id:h.keyName;isNaN(v)?l(v)||(Q[v]&&(C=Q[v].order),q&&("string"===typeof v&&/^\[\w+\]$/.test(v)?v=ga(v.substring(1,v.length-1)):"string"===typeof v&&/^\w+$/.test(v)&&(v=qb(v)))):C=Number(v);x=y(a,r.root,!0);if(r.row)if(1===x.length&&"string"===typeof r.row&&/^\w+$/.test(r.row)){B=[];ma=x[0].childNodes;L=ma.length;for(J=0;J<L;J++)ka=ma[J],
1===ka.nodeType&&ka.nodeName===r.row&&B.push(ka);x=B}else x=y(x,r.row,!0);null==x&&m(a)&&(x=a);x||(x=[]);a=x.length;0<a&&0>=h.page&&(h.page=1);sa=parseInt(h.rowNum,10);g&&(sa*=g+1);var z=[],pa=[],ja,B=[];for(w=0;w<a;w++){ja=x[w];u=r.repeatitems&&r.cell?y(ja,r.cell,!0)||ja:ja;A=r.repeatitems&&(q||m(u));E={};Ia={};if(q&&!A&&null!=u)for(ma=u.childNodes,L=ma.length,J=0;J<L;J++)ka=ma[J],1===ka.nodeType&&(Ia[ka.nodeName]=ka);for(H in Q)Q.hasOwnProperty(H)&&(J=Q[H],A?(ma=u[J.order],q&&null!=ma&&(ma=ma.textContent||
ma.text)):ma=null!=ca[H]&&"string"!==typeof ca[H]?ca[H](u):y(u,"string"===typeof ca[H]?ca[H]:J.name),1===J.type&&(J=M[J.index],null!=J&&l(J.convert)&&(ma=J.convert(ma,u))),void 0!==ma&&(E[H]=ma));void 0!==E[v]?ja=void 0!==E[v]?E[v]:ya():(ja=y(ja,m(ja)?C:v),void 0===ja&&(ja=y(u,m(u)?C:v)),void 0===ja&&(ja=ya()));void 0===E[v]&&(E[v]=ja);ja=String(ja);A=h.idPrefix+ja;h.treeGrid&&D(E);if(w<sa)pa.push(A),z.push(u),B.push(E);else if(!p)break;if(p||!0===h.treeGrid)E._id_=ja,h.data.push(E),h._index[E._id_]=
...
h.iColByName.subgrid)}catch(Cb){}if(!1===h.gridview||l(h.afterInsertRow))for(w=0;w<Math.min(a,sa);w++)N.call(this,"afterInsertRow",pa[w],B[w],z[w]);h.totaltime=new Date-k;0<w&&0===h.records&&(h.records=a);V(d);if(!0===h.treeGrid)try{c.setTreeNode.call(f,g+1,w+g+1)}catch(Cb){}h.reccount=Math.min(a,sa);h.treeANode=-1;h.userDataOnFooter&&c.footerData.call(f,"set",h.userData,!0);p&&(h.records=a,h.lastpage=Math.ceil(a/sa));e||this.updatepager(!1,!0);oa.call(this)}}},X=function(){function a(b){var c=0,
...
h.idSel+'")[0].p.colModel['+p.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+m+"')",k.data,n[k.field]))):null!=h.customSortOperations&&null!=h.customSortOperations[k.op]&&l(h.customSortOperations[k.op].filter)&&(F=F.custom(k.op,k.field,k.data)),c++;g&&F.orEnd()}catch(jb){B(jb)}}var d=b(this),e=h.multiSort?[]:"",g={},f=!1,n={},p=[],q=[],w=z.call(k,"formatter.date.srcformat"),y=z.call(k,"formatter.date.newformat");if(!m(h.data))return{};h.multiSort&&wa(e,g);var u=h.grouping?h.groupingView:!1,x,
v,C=function(b,a,c){var d=b.index||b.name,g=b.sorttype||"text";n[b.name]={reader:h.dataTypeOrg?b.name:b.jsonmap||b.name,iCol:a,stype:g,srcfmt:"",newfmt:"",sfunc:b.sortfunc||null,isAddProp:!0===c?!0:!1};if("date"===g||"datetime"===g)b.formatter&&"string"===typeof b.formatter&&"date"===b.formatter?(a=b.formatoptions&&b.formatoptions.srcformat?b.formatoptions.srcformat:w,c=b.formatoptions&&b.formatoptions.newformat?b.formatoptions.newformat:y):a=c=b.datefmt||"Y-m-d",n[b.name].srcfmt=a,n[b.name].newfmt=
c;if(h.grouping)for(v=0,x=u.groupField.length;v<x;v++)b.name===u.groupField[v]&&(p[v]=n[d],q[v]=d);h.multiSort||f||b.index!==h.sortname&&b.name!==h.sortname||(e=b.name,f=!0)};r(h.colModel,function(b){C(this,b)});r(h.additionalProperties,function(b){C("string"===typeof this?{name:this}:this,b,!0)});if(h.treeGrid)return c.SortTree.call(d,e,h.sortorder,null!=n[e]&&n[e].stype?n[e].stype:"text",null!=n[e]&&n[e].srcfmt?n[e].srcfmt:""),!1;var E={eq:function(b){return b.equals},ne:function(b){return b.notEquals},
...
b.andNot().inSet},"in":function(b){return b.inSet},nu:function(b){return b.isNull},nn:function(b,a){return"OR"===a?b.orNot().isNull:b.andNot().isNull}},F=t.from.call(this,h.data);h.ignoreCase&&(F=F.ignoreCase());if(!0===h.search){var A=h.postData.filters;if(A)"string"===typeof A&&(A=b.parseJSON(A)),a(A);else try{var H=n[h.postData.searchField],F=E[h.postData.searchOper](F)(l(H.reader)?'jQuery.jgrid.getAccessor(this,jQuery("'+h.idSel+'")[0].p.colModel['+H.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+
H.reader+"')",h.postData.searchString,n[h.postData.searchField])}catch(Ib){}}if(h.grouping)for(v=0;v<x;v++)F.orderBy(q[v],u.groupOrder[v],p[v].stype,p[v].srcfmt);h.multiSort?r(e,function(){F.orderBy(this,g[this],n[this].stype,n[this].srcfmt,n[this].sfunc)}):e&&h.sortorder&&f&&F.orderBy(h.sortname,"DESC"===h.sortorder.toUpperCase()?"d":"a",n[e].stype,n[e].srcfmt,n[e].sfunc);h.lastSelectedData=F.select();var A=parseInt(h.rowNum,10),H=h.lastSelectedData.length,J=parseInt(h.page,10),G=Math.ceil(H/A),
L={};if(h.grouping&&h.groupingView._locgr){h.groupingView.groups=[];var ka,Q,ga;if(h.footerrow&&h.userDataOnFooter){for(Q in h.userData)h.userData.hasOwnProperty(Q)&&(h.userData[Q]=0);ga=!0}for(ka=0;ka<H;ka++){if(ga)for(Q in h.userData)h.userData.hasOwnProperty(Q)&&(h.userData[Q]+=parseFloat(h.lastSelectedData[ka][Q]||0));c.groupingPrepare.call(d,h.lastSelectedData[ka],ka,A)}}n=F=null;d=h.localReader;L[d.total]=G;L[d.page]=J;L[d.records]=H;L[d.root]=h.lastSelectedData.slice((J-1)*A,J*A);L[d.userdata]=
...
q.page&&(m[q.page]=h.page);null!==q.sort&&(m[q.sort]=h.sortname);null!==q.order&&(m[q.order]=h.sortorder);null!==h.rowTotal&&null!==q.totalrows&&(m[q.totalrows]=h.rowTotal);var r=l(h.loadComplete),w=r?h.loadComplete:null,y=0;a=a||1;1<a?null!==q.npage?(m[q.npage]=a,y=a-1,a=1):w=function(b){h.page++;f.hDiv.loading=!1;r&&h.loadComplete.call(e,b);ba.call(e,a-1)}:null!==q.npage&&delete h.postData[q.npage];if(h.grouping&&c.groupingSetup){c.groupingSetup.call(g);var v=h.groupingView,u,x="",C,E,F;for(u=0;u<
v.groupField.length;u++){C=v.groupField[u];for(E=0;E<h.colModel.length;E++)F=h.colModel[E],F.name===C&&F.index&&(C=F.index);x+=C+" "+v.groupOrder[u]+", "}m[q.sort]=x+m[q.sort]}n(h.postData,m);var A=h.scroll?e.rows.length-1:1,z=function(){H.call(e);h.autowidth||void 0!==h.widthOrg&&"auto"!==h.widthOrg&&"100%"!==h.widthOrg||c.setGridWidth.call(g,h.tblwidth+h.scrollOffset,!1)},J=function(){var b;if(h.autoresizeOnLoad)c.autoResizeAllColumns.call(g);else for(b=0;b<h.columnsToReResizing.length;b++)c.autoResizeColumn.call(g,
h.columnsToReResizing[b]);V(h.columnsToReResizing)},q=function(){N.call(e,"loadComplete",p);J();g.triggerHandler("jqGridAfterLoadComplete",[p]);fa.call(e);h.datatype="local";h.datastr=null;z()},B=function(b){g.triggerHandler("jqGridLoadComplete",[b]);w&&w.call(e,b);J();g.triggerHandler("jqGridAfterLoadComplete",[b]);k&&f.populateVisible.call(e);1===a&&fa.call(e);z()},L=function(){var b=X.call(e);Z.call(e,b,A,1<a,y);B(b)};if(N.call(e,"beforeRequest"))if(l(h.datatype))h.datatype.call(e,h.postData,"load_"+
h.id,A,a,y);else switch(m=h.datatype.toLowerCase(),b(G.eDiv).hide(),m){case "json":case "jsonp":case "xml":case "script":b.ajax(n({url:h.url,type:h.mtype,dataType:m,data:t.serializeFeedback.call(d,h.serializeGridData,"jqGridSerializeGridData",h.postData),success:function(c,d,g){h.jqXhr=null;b(G.eDiv).hide();if(l(h.beforeProcessing)&&!1===h.beforeProcessing.call(e,c,d,g))fa.call(e);else if(Z.call(e,c,A,1<a,y),B(c),h.loadonce||h.treeGrid)h.dataTypeOrg=h.datatype,h.datatype="local",h.forceClientSorting&&
...
"</td>");a="#"+I(a);if(!0===h.pgbuttons){q=["first","prev","next","last"];r=q.slice();var y=A("pager.pagerButton","ui-pg-button"),u=function(b,a){var d=E("pg"+b);return"<td role='button' tabindex='0' id='"+b+c+"' class='"+y+"' "+(d?"title='"+d+"'":"")+"><span class='"+C("pager."+a)+"'></span></td>"};"rtl"===M&&q.reverse();for(p=0;p<q.length;p++)l+=u(q[p],r[p]),1===p&&(l+=""!==k?f+k+f:"")}else""!==k&&(l+=k);"ltr"===M&&(l+=m);l+="</tr></tbody></table>";!0===h.viewrecords&&b("td"+a+"_"+h.recordpos,n).append("<span dir='"+
M+"' style='text-align:"+h.recordpos+"' class='ui-paging-info'></span>");var v=b("td"+a+"_"+h.pagerpos,n);v.append(l);f=O.call(this,v.children(".ui-pg-table"));h._nvtd=[];h._nvtd[0]=f?Math.floor((h.width-f)/2):Math.floor(h.width/3);h._nvtd[1]=0;l=null;b(".ui-pg-selbox",n).on("change",function(){var a=F(this.value,10),c=Math.round(h.rowNum*(h.page-1)/a-.5)+1;if(!w("records",c,a))return!1;h.page=c;h.rowNum=a;h.pager&&b(".ui-pg-selbox",h.pager).val(a);h.toppager&&b(".ui-pg-selbox",h.toppager).val(a);
...
0===b&&(p=n=!1,b=f-1);this.id==="first"+c&&l&&(e="first",a=1,k=!0);this.id==="prev"+c&&m&&(e="prev",a=b-1,k=!0);this.id==="next"+c&&n&&(e="next",a=b+1,k=!0);this.id==="last"+c&&p&&(e="last",a=f,k=!0);if(!w(e,a,F(h.rowNum,10)))return!1;h.page=a;k&&ba.call(d);return!1}));if(!0===h.pginput)b("input.ui-pg-input",n).on("keypress.jqGrid",function(a){a=a.charCode||a.keyCode||0;var c=F(b(this).val(),1);if(13===a){if(!w("user",c,F(h.rowNum,10)))return!1;b(this).val(c);h.page=0<b(this).val()?b(this).val():
h.page;ba.call(d);return!1}return this});v.children(".ui-pg-table").on("keydown.jqGrid",function(b){13===b.which&&(b=v.find(":focus"),0<b.length&&b.trigger("click"))})};var wa=function(a,c,d){r((h.sortname+" "+h.sortorder).split(","),function(){var c=b.trim(this).split(" ");2===c.length&&a.push(c[0])});if(null!=d){var e=b.inArray(d.index||d.name,a);""!==d.lso&&0>e?a.push(d.index||d.name):""===d.lso&&0<=e&&a.splice(e,1)}r(h.colModel,function(){var d=this.index||this.name,e;this.lso&&(e=this.lso.split("-"),
0>b.inArray(d,a)&&a.push(d),c[d]=e[e.length-1])})},R=function(a,c){var e="",g=h.colModel[a],f,k=A("states.disabled"),l=h.frozenColumns?b(c):b(d.grid.headers[a].el);f=l.find("span.s-ico");var m=f.children("span.ui-icon-asc"),n=f.children("span.ui-icon-desc"),p=m,q=n,w=[],y={};l.find("span.ui-grid-ico-sort").addClass(k);l.attr("aria-selected","false");g.lso?(f.show(),f=g.lso.split("-"),f=f[f.length-1],"desc"===f&&(p=n,q=m),p.removeClass(k).css("display",""),h.showOneSortIcon&&q.hide(),l.attr("aria-selected",
"true")):h.viewsortcols[0]||f.hide();wa(w,y,g);r(w,function(){0<e.length&&(e+=", ");e+=this+" "+y[this];h.sortorder=y[this]});h.sortname=e.substring(0,e.length-h.sortorder.length-1)},Na=function(a,d,e,g,f){var k=this.grid,l=h.colModel[d],m=A("states.disabled");if(null!=l&&l.sortable&&!(0<h.savedRow.length)){e||(h.lastsort===d&&""!==h.sortname?(h.sortorder="asc"===h.sortorder?"desc":"desc"===h.sortorder?"asc":l.firstsortorder||"asc",l.lso?"asc"===l.lso?l.lso+="-desc":"desc"===l.lso?l.lso+="-asc":"asc-desc"!==
...
y.sortable?"":"padding-right:"+h.autoResizing.widthOfVisiblePartOfSortIcon+"px;"):"";break;default:la=""}ca+="<div id='jqgh_"+h.id+"_"+y.name+"'"+(v?" class='ui-th-div-ie'":"")+(""===la?"":" style='"+la+"'")+" role='columnheader'>";la=y.autoResizable&&"actions"!==y.formatter?"<span class='"+h.autoResizing.wrapperClassName+"'>"+h.colNames[u]+"</span>":h.colNames[u];h.sortIconsBeforeText?(ca+=(h.builderSortIcons||t.builderSortIcons).call(d,u),ca+=la):(ca+=la,ca+=(h.builderSortIcons||t.builderSortIcons).call(d,
...
Ca)).appendTo(g),xa&&x.hide(),f.call(d,u,""),h.pager="#"+I(u)):h.pager="");if(!1===h.cellEdit&&!0===h.hoverrows)k.on("mouseover.jqGrid",function(a){P=b(a.target).closest("tr.jqgrow");"ui-subgrid"!==b(P).attr("class")&&b(P).addClass(Ja)}).on("mouseout.jqGrid",function(a){P=b(a.target).closest("tr.jqgrow");b(P).removeClass(Ja)});var ua,U,W,S=function(a){var c,d;do if(c=b(a).closest("td"),0<c.length){a=c.parent();d=a.parent().parent();if(a.is(".jqgrow")&&(d[0]===this||d.is("table.ui-jqgrid-btable")&&
...
h.maxHeight+(isNaN(h.maxHeight)?"":"px"));k.css({width:"1px"});b.support.tbody||2===b(">tbody",d).length&&b(">tbody:gt(0)",d).remove();if(h.multikey)b(G.bDiv).on(t.msie?"selectstart":"mousedown",function(){return!1});xa&&b(G.bDiv).hide();G.cDiv=document.createElement("div");var da=C("gridMinimize.visible"),na=C("gridMinimize.hidden"),v=E("showhide"),ha=!0===h.hidegrid?b("<a role='link' class='"+A("titleButton","ui-jqgrid-titlebar-close")+"'"+(v?" title='"+v+"'":"")+"/>").hover(function(){ha.addClass(Ja)},
...
function(){return!1});d.formatCol=ga;d.sortData=Na;d.updatepager=function(a,c){var d=this,e=b(d),g=d.grid,f,l,m,n,p,q,r=h.pager||"",w=h.pager?"_"+h.pager.substr(1):"";f=g.bDiv;var y=b.fmatter?b.fmatter.NumberFormat:null,v=h.toppager?"_"+h.toppager.substr(1):"",u=A("states.hover"),x=A("states.disabled");l=parseInt(h.page,10)-1;0>l&&(l=0);l*=parseInt(h.rowNum,10);n=l+h.reccount;if(h.scroll){q=b(Ha(21,f)[0].rows).slice(1);l=n-q.length;h.reccount=q.length;if(q=q.outerHeight()||g.prevRowHeight)m=l*q,p=
...
parseInt(b(this).attr("size"),10);0<a&&a<C&&b(this).attr("size",C)});m=h.toppager?"#sp_1"+w+",#sp_1"+v:"#sp_1"+w;b(m).html(b.fmatter?y(h.lastpage,q):h.lastpage).closest(".ui-pg-table").each(function(){O.call(d,b(this))})}h.viewrecords&&(0===h.reccount?b(".ui-paging-info",r).html(E("emptyrecords")):(m=l+1,p=h.records,b.fmatter&&(m=y(m,q),n=y(n,q),p=y(p,q)),b(".ui-paging-info",r).html(t.format(E("recordtext"),m,n,p))));!0===h.pgbuttons&&(0>=f&&(g=0),0>=g&&(g=f=0),1===g||0===g?(b("#first"+w+", #prev"+
w).addClass(x).removeClass(u),h.toppager&&b("#first_t"+v+", #prev_t"+v).addClass(x).removeClass(u)):(b("#first"+w+", #prev"+w).removeClass(x),h.toppager&&b("#first_t"+v+", #prev_t"+v).removeClass(x)),g===f||0===g?(b("#next"+w+", #last"+w).addClass(x).removeClass(u),h.toppager&&b("#next_t"+v+", #last_t"+v).addClass(x).removeClass(u)):(b("#next"+w+", #last"+w).removeClass(x),h.toppager&&b("#next_t"+v+", #last_t"+v).removeClass(x)))}!0===a&&!0===h.rownumbers&&b(">td.jqgrid-rownum",d.rows).each(function(a){b(this).html(l+
...
"first last before after afterSelected beforeSelected".split(" "))&&(d="last");var g=!1,f,k,l,m,n,p,q,r,w,z,B;c&&(b.isArray(c)?(p=!0,q=a):(c=[c],p=!1),this.each(function(){var v=this.p,x=c.length,u=b(this),y=this.rows,C=0,A=D.getGridRowById,h=v.colModel,E,H=v.additionalProperties;p||(void 0!==a?a=String(a):(a=ya(),!1!==v.keyName&&(q=v.keyName,void 0!==c[0][q]&&(a=c[0][q]))));for(r=v.altclass;C<x;){w=c[C];k=[];if(p)try{a=w[q],void 0===a&&(a=ya())}catch(L){a=ya()}B=a;E={};for(m=0;m<h.length;m++)z=h[m],
f=z.name,"rn"!==f&&"cb"!==f&&"subgrid"!==f&&(n=hb.call(this,w[f],z,void 0,B,{},m),b.isFunction(z.saveLocally)?z.saveLocally.call(this,{newValue:n,newItem:E,oldItem:{},id:B,cm:z,cmName:f,iCol:m}):void 0!==n&&(E[f]=n));for(m=0;m<H.length;m++)f=H[m],"object"===typeof f&&f.hasOwnProperty("name")&&(f=f.name),n=ra(w,f),void 0!==n&&(E[f]=n);"local"===v.datatype&&(E[v.localReader.id]=B,v._index[B]=v.data.length,v.data.push(E));k=t.parseDataToHtml.call(this,1,[a],[w]);k=k.join("");if(0===y.length)b(this.tBodies[0]).append(k);
else{if("afterSelected"===d||"beforeSelected"===d)void 0===e&&null!==v.selrow?(e=v.selrow,d="afterSelected"===d?"after":"before"):d="afterSelected"===d?"last":"first";switch(d){case "last":b(y[y.length-1]).after(k);l=y.length-1;break;case "first":b(y[0]).after(k);l=1;break;case "after":if(l=A.call(u,e))b(y[l.rowIndex+1]).hasClass("ui-subgrid")?(b(y[l.rowIndex+1]).after(k),l=l.rowIndex+2):(b(l).after(k),l=l.rowIndex+1);break;case "before":if(l=A.call(u,e))b(l).before(k),l=l.rowIndex-1}}!0===v.subGrid&&
D.addSubGrid.call(u,v.iColByName.subgrid,l);v.records++;v.reccount++;0===v.lastpage&&(v.lastpage=1);N.call(this,"afterAddRow",{rowid:a,inputData:c,position:d,srcRowid:e,iRow:l,localData:E,iData:v.data.length-1});C++}!0!==v.altRows||p||u.jqGrid("isBootstrapGuiStyle")||("last"===d?0===(y.length-1)%2&&b(y[y.length-1]).addClass(r):b(y).each(function(a){1===a%2?b(this).addClass(r):b(this).removeClass(r)}));this.rebuildRowIndexes();this.updatepager(!0,!0);g=!0}));return g},footerData:function(a,c,d){var e=
...
B=t.cell_width?0:d.cellLayout,v=g.headers,x=g.footers,u=g.bDiv,y=g.hDiv,C=g.sDiv,A=g.cols,h,E,H=b(y).find(">div>.ui-jqgrid-htable>thead>tr").first()[0].cells,L=function(a){g.width=d.width=a;b(d.gBox).css("width",a+"px");b(d.gView).css("width",a+"px");b(u).css("width",a+"px");b(y).css("width",a+"px");d.pager&&b(d.pager).css("width",a+"px");d.toppager&&b(d.toppager).css("width",a+"px");!0===d.toolbar[0]&&(b(g.uDiv).css("width",a+"px"),"both"===d.toolbar[1]&&b(g.ubDiv).css("width",a+"px"));d.footerrow&&
b(C).css("width",a+"px")};"boolean"!==typeof c&&(c=d.shrinkToFit);if(!isNaN(r)){r=parseInt(r,10);L(r);!1===c&&!0===d.forceFit&&(d.forceFit=!1);if(!0===c){b.each(w,function(){!1!==this.hidden||q(this.classes)||(e=this.widthOrg,f+=e+B,this.fixed?p+=this.width+B:l++)});if(0===l)return;d.tblwidth=parseInt(f,10);n=r-B*l-p;!isNaN(d.height)&&(u.clientHeight<u.scrollHeight||1===this.rows.length)&&(m=!0,n-=z);E=n/(d.tblwidth-B*l-p);if(0>E)return;f=0;h=0<A.length;b.each(w,function(b){!1!==this.hidden||q(this.classes)||
this.fixed||(this.width=e=Math.round(this.widthOrg*E),f+=e,v[b].width=e,H[b].style.width=e+"px",d.footerrow&&(x[b].style.width=e+"px"),h&&(A[b].style.width=e+"px"),k=b)});if(!k)return;n=0;m?r-p-(f+B*l)!==z&&(n=r-p-(f+B*l)-z):1!==Math.abs(r-p-(f+B*l))&&(n=r-p-(f+B*l));w=w[k];w.width+=n;d.tblwidth=parseInt(f+n+B*l+p,10);d.tblwidth>r&&(n=d.tblwidth-parseInt(r,10),d.tblwidth=r,w.width-=n);e=w.width;r=v[k];r.width=e;H[k].style.width=e+"px";h&&(A[k].style.width=e+"px");d.footerrow&&(x[k].style.width=e+
...
b(p),w=parseInt(f.iCol,10),z=parseInt(f.iRow,10),B=b(k[z]),v=f.savedRow;if(null!=q){f.selrow=q;f.knv||g.jqGrid("GridNav");if(0<v.length){if(!0===d&&a===z&&c===w)return;g.jqGrid("saveCell",v[0].id,v[0].ic)}else setTimeout(function(){b("#"+t.jqID(f.knv)).attr("tabindex","-1").focus()},1);n=f.colModel[c];k=n.name;if("subgrid"!==k&&"cb"!==k&&"rn"!==k){m=Ka.call(e,p,c);p=n.editable;b.isFunction(p)&&(p=p.call(e,{rowid:q,iCol:c,iRow:a,name:k,cm:n,mode:"cell"}));var x=g.jqGrid("getGuiStyles","states.select",
"edit-cell"),u=g.jqGrid("getGuiStyles","states.hover","selected-row");if(!0!==p||!0!==d||m.hasClass("not-editable-cell"))0<=w&&0<=z&&(Ka.call(e,B[0],w).removeClass(x),B.removeClass(u)),m.addClass(x),r.addClass(u),l=m.html().replace(/&#160;/ig,""),N.call(e,"onSelectCell",q,k,l,a,c);else{0<=w&&0<=z&&(Ka.call(e,B[0],w).removeClass(x),B.removeClass(u));m.addClass(x);r.addClass(u);n.edittype||(n.edittype="text");r=n.edittype;try{l=b.unformat.call(e,m,{rowId:q,colModel:n},c)}catch(C){l="textarea"===r?m.text():
m.html()}f.autoEncodeOnEdit&&(l=t.oldDecodePostedData(l));v.push({id:a,ic:c,name:k,v:l});if("&nbsp;"===l||"&#160;"===l||1===l.length&&160===l.charCodeAt(0))l="";b.isFunction(f.formatCell)&&(w=f.formatCell.call(e,q,k,l,a,c),void 0!==w&&(l=w));N.call(e,"beforeEditCell",q,k,l,a,c);n=b.extend({},n.editoptions||{},{id:a+"_"+k,name:k,rowId:q,mode:"cell",cm:n,iCol:c});var y=t.createEl.call(e,r,n,l,!0,b.extend({},t.ajaxOptions,f.ajaxSelectOptions||{})),r=m;(w=!0===f.treeGrid&&k===f.ExpandColumn)&&(r=m.children("span.cell-wrapperleaf,span.cell-wrapper"));
...
x=v.name,u,y=Ka.call(d,w,c),C={},A=t.getEditedValue.call(d,y,v,C);if(A!==q[r].v){u=e.triggerHandler("jqGridBeforeSaveCell",[z,x,A,a,c]);void 0!==u&&(A=u);b.isFunction(g.beforeSaveCell)&&(u=g.beforeSaveCell.call(d,z,x,A,a,c),void 0!==u&&(A=u));var h=t.checkValues.call(d,A,c,void 0,void 0,{oldValue:q[r].v,newValue:A,cmName:x,rowid:z,iCol:c,iRow:a,cm:v,tr:w,td:y,mode:"cell"}),w=v.formatoptions||{};if(null==h||!0===h||!0===h[0]){r=e.triggerHandler("jqGridBeforeSubmitCell",[z,x,A,a,c])||{};b.isFunction(g.beforeSubmitCell)&&
((r=g.beforeSubmitCell.call(d,z,x,A,a,c))||(r={}));0<b("input.hasDatepicker",y).length&&b("input.hasDatepicker",y).datepicker("hide");"date"===v.formatter&&!0!==w.sendFormatted&&(A=b.unformat.date.call(d,A,v));if("remote"===g.cellsubmit)if(g.cellurl){var E={};E[x]=A;m=g.prmNames;w=m.oper;E[m.id]=t.stripPref(g.idPrefix,z);E[w]=m.editoper;E=b.extend(r,E);g.autoEncodeOnEdit&&b.each(E,function(a,c){b.isFunction(c)||(E[a]=t.oldEncodePostedData(c))});e.jqGrid("progressBar",{method:"show",loadtype:g.loadui,
...
info_dialog:function(a,c,d,e){var g=this,f=g.p,k=b.extend(!0,{width:290,height:"auto",dataheight:"auto",drag:!0,resize:!1,left:250,top:170,zIndex:1E3,jqModal:!0,modal:!1,closeOnEscape:!0,align:"center",buttonalign:"center",buttons:[]},t.jqModal||{},null!=f?f.jqModal||{}:{},{caption:"<b>"+a+"</b>"},e||{}),l=k.jqModal;b.fn.jqm&&!l&&(l=!1);a="";var m=O.call(g,"states.hover");if(0<k.buttons.length)for(e=0;e<k.buttons.length;e++)void 0===k.buttons[e].id&&(k.buttons[e].id="info_button_"+e),a+=t.builderFmButon.call(g,
...
"true"),n=d.split(","),n=b.map(n,function(a){return b.trim(a)})):(e=!1,n[0]=b.trim(d));void 0===c.size&&(c.size=e?3:1);try{a=c.rowId}catch(B){}m&&m.idPrefix&&(a=t.stripPref(m.idPrefix,a));if(void 0!==c.dataUrl){var w=c.postData||g.postData,m={elem:k,options:c,cm:c.cm,mode:c.mode,rowid:a,iCol:c.iCol,ovm:n};b.ajax(b.extend({url:b.isFunction(c.dataUrl)?c.dataUrl.call(l,a,d,String(c.name),m):c.dataUrl,type:"GET",dataType:"html",data:b.isFunction(w)?w.call(l,a,d,String(c.name)):w,context:m,success:function(a,
c,d){var e=this.ovm,g=this.elem,k=this.cm,m=this.iCol,h=b.extend({},this.options),n=this.rowid,p=this.mode;a=b.isFunction(h.buildSelect)?h.buildSelect.call(l,a,d,k,m):a;"string"===typeof a&&(a=b(b.trim(a)).html());a&&(b(g).append(a),f(g,h,w?["postData"]:void 0),setTimeout(function(){var a;b("option",g).each(function(c){0===c&&g.multiple&&(this.selected=!1);-1<b.inArray(b.trim(b(this).val()),e)&&(a=this.selected=!0)});a||b("option",g).each(function(){-1<b.inArray(b.trim(b(this).text()),e)&&(this.selected=
...
"button"===a?"button":"textbox";k=document.createElement("input");k.type=a;f(k,c);k.value=d;"button"!==a&&(e?c.size||b(k).css({width:"100%","box-sizing":"border-box"}):c.size||(c.size=20));b(k).attr("role",g);break;case "image":case "file":k=document.createElement("input");k.type=a;f(k,c);break;case "custom":k=document.createElement("span");try{if(b.isFunction(c.custom_element)){var z=c.custom_element.call(l,d,c);if(z instanceof jQuery||t.isHTMLElement(z)||"string"===typeof z)z=b(z).addClass("customelement").attr({id:c.id,
name:c.name}),b(k).empty().append(z);else throw"editoptions.custom_element returns value of a wrong type";}else throw"editoptions.custom_element is not a function";}catch(B){"e1"===B&&n.call(l,p,"function 'custom_element' "+r.nodefined,q),"e2"===B?n.call(l,p,"function 'custom_element' "+r.novalue,q):n.call(l,p,"string"===typeof B?B:B.message,q)}}return k},checkDate:function(b,c){var a={},e;b=b.toLowerCase();e=-1!==b.indexOf("/")?"/":-1!==b.indexOf("-")?"-":-1!==b.indexOf(".")?".":"/";b=b.split(e);
...
a);var r;g.searchurl&&(r=g.url,e.jqGrid("setGridParam",{url:g.searchurl}));var w="stop"===e.triggerHandler("jqGridToolbarBeforeSearch")?!0:!1;!w&&b.isFunction(l.beforeSearch)&&(w=l.beforeSearch.call(c));w||e.jqGrid("setGridParam",{search:k}).trigger("reloadGrid",[b.extend({page:1},l.reloadGridSearchOptions||{})]);r&&e.jqGrid("setGridParam",{url:r});e.triggerHandler("jqGridToolbarAfterSearch");b.isFunction(l.afterSearch)&&l.afterSearch.call(c)},h=n("search.odata")||[],E=g.customSortOperations,H=function(a,
d,f){b("#sopt_menu").remove();d=parseInt(d,10);f=parseInt(f,10)+18;var n,p=0,q=[],r=b(a).data("soper"),p=b(a).data("colname"),t=b(".ui-jqgrid-view").css("font-size")||"11px";d="<ul id='sopt_menu' class='"+O.call(c,"searchToolbar.menu","ui-search-menu")+"' role='menu' tabindex='0' style='z-index:9999;display:block;font-size:"+t+";left:"+d+"px;top:"+f+"px;'>";p=g.iColByName[p];if(void 0!==p){p=m[p];f=b.extend({},p.searchoptions);var y,u;f.sopt||(f.sopt=[],f.sopt[0]="select"===p.stype||"checkbox"===
p.stype?"eq":l.defaultSearch);b.each(h,function(){q.push(this.oper)});null!=E&&b.each(E,function(b){q.push(b)});for(p=0;p<f.sopt.length;p++)t=f.sopt[p],n=b.inArray(t,q),-1!==n&&(n=h[n],void 0!==n?(u=l.operands[t],y=n.text):null!=E&&(y=E[t],u=y.operand,y=y.text),n=r===t?z:"",d+='<li class="ui-menu-item '+n+'" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="'+k(t)+'" data-oper="'+k(u)+'"><table><tr><td style="width:25px">'+k(u)+"</td><td>"+k(y)+"</td></tr></table></a></li>");
...
b(c),e=c.p,g=c.grid;if(g&&null!=e&&!0!==e.frozenColumns){var f=e.colModel,k,l=f.length,m=-1,n=!1,p=[],q=I(e.id),r=O.call(c,"states.hover"),w=O.call(c,"states.disabled");if(!0!==e.subGrid&&!0!==e.treeGrid&&!e.scroll){for(k=0;k<l&&!0===f[k].frozen;k++)n=!0,m=k,p.push("#jqgh_"+q+"_"+I(f[k].name));e.sortable&&(f=b(g.hDiv).find(".ui-jqgrid-htable .ui-jqgrid-labels"),f.sortable("destroy"),d.jqGrid("setGridParam",{sortable:{options:{items:0<p.length?">th:not(:has("+p.join(",")+"),:hidden)":">th:not(:hidden)"}}}),
...
e.lastsort+")",g.fhDiv);c=b("tr.ui-jqgrid-labels:last th:eq("+d+")",g.fhDiv);b("span.ui-grid-ico-sort",a).addClass(w);b(a).attr("aria-selected","false");b("span.ui-icon-"+e.sortorder,c).removeClass(w);b(c).attr("aria-selected","true");e.viewsortcols[0]||e.lastsort===d||(b("span.s-ico",a).hide(),b("span.s-ico",c).show())});b(e.gView).append(g.fbDiv);b(g.bDiv).scroll(function(){b(g.fbDiv).scrollTop(b(this).scrollTop())});b(g.fbDiv).on("mousewheel.setFrozenColumns DOMMouseScroll.setFrozenColumns",function(d){g.bDiv.scrollTop+=
...
var r,t,w;if(null!=a&&0<a.length){a[0].scrollTop=c.scrollTop;a.css("rtl"===e.direction?{top:q,right:0}:{top:q,left:0});h=a.children("table").children("thead").children("tr");m=b(c).children("div").children("table").children("thead").children("tr");0===m.length&&(h=b(a.children("table")[0].rows),m=b(b(c).children("div").children("table")[0].rows));g=Math.min(h.length,m.length);r=0<g?b(h[0]).position().top:0;t=0<g?b(m[0]).position().top:0;if(0<=d)for(0<=f&&(g=Math.min(f+1,g));d<g;d++)if(l=b(m[d]),"none"!==
l.css("display")&&l.is(":visible")){q=l.position().top;f=b(h[d]);n=f.position().top;p=l.height();if(null!=e.groupHeader&&e.groupHeader.useColSpanStyle)for(w=l[0].cells,k=0;k<w.length;k++)l=w[k],null!=l&&"TH"===l.nodeName.toUpperCase()&&(p=Math.max(p,b(l).height()));q=p+(q-t)+(r-n);u(f,q)}u(a,c.clientHeight)}},n={resizeDiv:!0,resizedRows:{iRowStart:0,iRowEnd:-1}},A={header:n,resizeFooter:!0,body:n};d.on("jqGridAfterGridComplete.setFrozenColumns",function(){b(e.idSel+"_frozen").remove();b(g.fbDiv).height(g.hDiv.clientHeight);
...
f.field){k=a.p.columns[g];break}k&&v(f.data,k)}d+=f.op+"(item."+f.field+",'"+f.data+"')"}d+=")";return"()"===d?"":d}var a=this;return b(e.filter)};this.reDraw();if(e.showQuery)this.onchange();this.filter=!0}}})};b.extend(b.fn.jqFilter,{toSQLString:function(){var b="";this.each(function(){b=this.toUserFriendlyString()});return b},filterData:function(){var b;this.each(function(){b=this.p.filter});return b},getParameter:function(b){return void 0!==b&&this.p.hasOwnProperty(b)?this.p[b]:this.p},resetFilter:function(){return this.each(function(){this.resetFilter()})},
...
a.unshift(f);return bb.apply(d,a)},B=function(){t.hideModal(n,{gb:p,jqm:f.jqModal,onClose:f.onClose,removemodal:f.removemodal})};"string"===typeof w&&(w=""!==b.trim(w)?b.parseJSON(w):void 0);b(n).remove();if(void 0!==b(n)[0])c(b("#fbox_"+I(g.id)));else{var v=b("<div><div id='"+k+"' class='"+O.call(d,"dialog.body","searchFilter")+"' style='overflow:auto'></div></div>").insertBefore(q);"rtl"===g.direction&&v.attr("dir","rtl");var x="",u="",y,C=!1,A,h=-1,E=b.extend([],g.colModel);A=da.call(d,k+"_search",
...
void 0===a.search?!0:a.search,d=!0===a.hidden;if(a.searchoptions&&!0===a.searchoptions.searchhidden&&c||c&&!d)C=!0,y=a.index||a.name,h=b}});if(!w&&y||!1===f.multipleSearch)l="eq",0<=h&&E[h].searchoptions&&E[h].searchoptions.sopt?l=E[h].searchoptions.sopt[0]:f.sopt&&f.sopt.length&&(l=f.sopt[0]),w={groupOp:"AND",rules:[{field:y,op:l,data:""}]};C=!1;f.tmplNames&&f.tmplNames.length&&(C=!0,u=f.tmplLabel,u+="<select class='ui-template'>",u+="<option value='default'>Default</option>",r(f.tmplNames,function(b,
a){u+="<option value='"+b+"'>"+a+"</option>"}),u+="</select>");A="<div class='"+O.call(d,"dialog.footer")+"'><table class='EditTable' style='border:0px none;margin-top:5px' id='"+k+"_2'><tbody><tr><td colspan='2'><hr class='"+O.call(d,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='EditButton EditButton-"+g.direction+"'  style='float:"+("rtl"===g.direction?"right":"left")+";'>"+H+u+"</td><td class='EditButton EditButton-"+g.direction+"'>"+x+A+"</td></tr></tbody></table></div>";k=I(k);
...
id:g.id});v.append(A);if(C&&f.tmplFilters&&f.tmplFilters.length)b(".ui-template",v).on("change",function(){var a=b(this).val();"default"===a?b(k).jqFilter("addFilter",w):b(k).jqFilter("addFilter",f.tmplFilters[parseInt(a,10)]);return!1});!0===f.multipleGroup&&(f.multipleSearch=!0);z("onInitialize",b(k));f.layer?t.createModal.call(d,m,v,f,q,b(p)[0],"#"+I(f.layer),{position:"relative"}):t.createModal.call(d,m,v,f,q,b(p)[0]);(f.searchOnEnter||f.closeOnEscape)&&b(n).keydown(function(a){var c=b(a.target);
...
0,f,g,h,k;if(v.checkOnSubmit||v.checkOnUpdate)v._savedData={},v._savedData[w+"_id"]=a;var l=r.colModel;if("_empty"===a)b(l).each(function(){d=this.name;g=b.extend({},this.editoptions||{});(f=b("#"+I(d),c))&&f.length&&null!==f[0]&&(h="","custom"===this.edittype&&b.isFunction(g.custom_value)?g.custom_value.call(p,f,"set",h):g.defaultValue?(h=b.isFunction(g.defaultValue)?g.defaultValue.call(p):g.defaultValue,"checkbox"===f[0].type?(k=h.toLowerCase(),0>k.search(/(false|f|0|no|n|off|undefined)/i)&&""!==
...
b.isFunction(l[f].editoptions.custom_value))l[f].editoptions.custom_value.call(p,b(d,c),"set",g);else throw"e1";}catch(Ca){"e1"===Ca?t.info_dialog.call(p,sa,"function 'custom_value' "+v.msg.nodefined,v.bClose):t.info_dialog.call(p,sa,Ca.message,v.bClose)}}e++}}),0<e&&b("#id_g",C).val(a))}}function g(){var a=v.url||r.editurl;b.each(L,function(c,d){var e=d.name,f=F[e];"date"!==d.formatter||null!=d.formatoptions&&!0===d.formatoptions.sendFormatted||(F[e]=b.unformat.date.call(p,f,d));"clientArray"!==
a&&d.editoptions&&!0===d.editoptions.NullIfEmpty&&F.hasOwnProperty(e)&&""===f&&(F[e]="null")})}function f(){var c=[!0,"",""],d=c,f={},h=r.prmNames,k,l,m,n,u,y,z=D.getInd.call(q,a),E=!1===z?null:p.rows[z];(y=q.triggerHandler("jqGridAddEditBeforeCheckValues",[b(x),M]))&&"object"===typeof y&&(F=y);z=!1===z?-1:z;b.isFunction(v.beforeCheckValues)&&(y=v.beforeCheckValues.call(p,F,b(x),M))&&"object"===typeof y&&(F=y);for(m in F)if(F.hasOwnProperty(m)){y=r.iColByName[m];d=t.checkValues.call(p,F[m],m,void 0,
void 0,{oldValue:"_empty"===a?null:D.getCell.call(q,a,y),newValue:F[m],cmName:m,rowid:a,cm:L[y],iCol:y,iRow:z,tr:E,td:null==E?null:E.cells[y],mode:"_empty"===a?"addForm":"editForm"});if(null==d||!0===d)d=c;if(!1===d[0])break}g();if(d[0]){f=q.triggerHandler("jqGridAddEditClickSubmit",[v,F,M]);void 0===f&&b.isFunction(v.onclickSubmit)&&(f=v.onclickSubmit.call(p,v,F,M)||{});d=q.triggerHandler("jqGridAddEditBeforeSubmit",[F,b(x),M]);if(null==d||!0===d)d=c;d[0]&&b.isFunction(v.beforeSubmit)&&(d=v.beforeSubmit.call(p,
F,b(x),M),null==d||!0===d)&&(d=c)}if(d[0]&&!v.processing){v.processing=!0;b("#sData",A).addClass(N);m=v.url||r.editurl;l=h.oper;k="clientArray"===m&&!1!==r.keyName?r.keyName:h.id;F[l]="_empty"===b.trim(F[w+"_id"])?h.addoper:h.editoper;F[l]!==h.addoper?F[k]=F[w+"_id"]:void 0===F[k]&&(F[k]=F[w+"_id"]);delete F[w+"_id"];F=b.extend(F,v.editData,f);if(!0===r.treeGrid)for(u in F[l]===h.addoper&&(n=r.selrow,F["adjacency"===r.treeGridModel?r.treeReader.parent_id_field:"parent_id"]=n),r.treeReader)r.treeReader.hasOwnProperty(u)&&
(f=r.treeReader[u],!F.hasOwnProperty(f)||F[l]===h.addoper&&"parent_id_field"===u||delete F[f]);F[k]=t.stripPref(r.idPrefix,F[k]);r.autoEncodeOnEdit&&b.each(F,function(a,c){b.isFunction(c)||(F[a]=t.oldEncodePostedData(c))});u=b.extend({url:b.isFunction(m)?m.call(p,F[k],M,F,v):m,type:b.isFunction(v.mtype)?v.mtype.call(p,M,v,F[k],F):v.mtype,data:t.serializeFeedback.call(p,b.isFunction(v.serializeEditData)?v.serializeEditData:r.serializeEditData,"jqGridAddEditSerializeEditData",F),complete:function(a,
f){q.jqGrid("progressBar",{method:"hide",loadtype:v.saveui});b("#sData",A).removeClass(N);F[k]=b("#id_g",C).val();if(300<=a.status&&304!==a.status||0===a.status&&4===a.readyState)d[0]=!1,d[1]=q.triggerHandler("jqGridAddEditErrorTextFormat",[a,M]),b.isFunction(v.errorTextFormat)?d[1]=v.errorTextFormat.call(p,a,M):d[1]=f+" Status: '"+a.statusText+"'. Error code: "+a.status;else{d=q.triggerHandler("jqGridAddEditAfterSubmit",[a,F,M]);if(null==d||!0===d)d=c;d[0]&&b.isFunction(v.afterSubmit)&&(d=v.afterSubmit.call(p,
a,F,M),null==d||!0===d)&&(d=c)}if(!1===d[0])b("#FormError>td",C).html(d[1]),b("#FormError",C).show();else{r.autoEncodeOnEdit&&b.each(F,function(b,a){F[b]=t.oldDecodePostedData(a)});var g=[b.extend({},v.reloadGridOptions||{})];F[l]===h.addoper?(d[2]||(d[2]=t.randId()),null==F[k]||"_empty"===F[k]||F[l]===h.addoper?F[k]=d[2]:d[2]=F[k],v.reloadAfterSubmit?q.trigger("reloadGrid",g):!0===r.treeGrid?D.addChildNode.call(q,d[2],n,F):D.addRowData.call(q,d[2],F,v.addedrow),v.closeAfterAdd?(!0!==r.treeGrid&&
B.call(q,d[2]),ia()):v.clearAfterAdd&&e("_empty",x)):(v.reloadAfterSubmit?(q.trigger("reloadGrid",g),v.closeAfterEdit||setTimeout(function(){B.call(q,F[k])},1E3)):!0===r.treeGrid?D.setTreeRow.call(q,F[k],F):D.setRowData.call(q,F[k],F),v.closeAfterEdit&&ia());if(b.isFunction(v.afterComplete)){var m=a;setTimeout(function(){q.triggerHandler("jqGridAddEditAfterComplete",[m,F,b(x),M]);v.afterComplete.call(p,m,F,b(x),M);m=null},50)}if(v.checkOnSubmit||v.checkOnUpdate)if(b(x).data("disabled",!1),"_empty"!==
v._savedData[w+"_id"])for(var u in v._savedData)v._savedData.hasOwnProperty(u)&&F[u]&&(v._savedData[u]=F[u])}v.processing=!1;try{b(":input:visible",x)[0].focus()}catch(Jb){}}},t.ajaxOptions,v.ajaxEditOptions);u.url||v.useDataProxy||(b.isFunction(r.dataProxy)?v.useDataProxy=!0:(d[0]=!1,d[1]+=" "+t.errors.nourl));d[0]&&(q.jqGrid("progressBar",{method:"show",loadtype:v.saveui,htmlcontent:v.savetext}),v.useDataProxy?(f=r.dataProxy.call(p,u,"set_"+w),void 0===f&&(f=[!0,""]),!1===f[0]?(d[0]=!1,d[1]=f[1]||
"Error deleting the selected row!"):(u.data.oper===h.addoper&&v.closeAfterAdd&&ia(),u.data.oper===h.editoper&&v.closeAfterEdit&&ia())):"clientArray"===u.url?(v.reloadAfterSubmit=!1,F=u.data,u.complete({status:200,statusText:""},"")):b.ajax(u))}!1===d[0]&&(b("#FormError>td",C).html(d[1]),b("#FormError",C).show())}function k(b,a){var c=!1,d;for(d in b)if(b.hasOwnProperty(d)&&String(b[d])!==String(a[d])){c=!0;break}return c}function l(){var a=!0;b("#FormError",C).hide();v.checkOnUpdate&&(F={},d(),G=
k(F,v._savedData))&&(b(x).data("disabled",!0),b(".confirm",E).show(),a=!1);return a}function m(a,c){var d=c[1].length-1;0===a?b("#pData",A).addClass(oa):void 0!==c[1][a-1]&&Y(b("#"+I(c[1][a-1])),oa)?b("#pData",A).addClass(oa):b("#pData",A).removeClass(oa);a===d?b("#nData",A).addClass(oa):void 0!==c[1][a+1]&&Y(b("#"+I(c[1][a+1])),oa)?b("#nData",A).addClass(oa):b("#nData",A).removeClass(oa)}function n(){var a=D.getDataIDs.call(q),c=b("#id_g",C).val();return[b.inArray(c,a),a]}var p=this,q=b(p),r=p.p;
...
bottominfo:"",savekey:[!1,13],navkeys:[!1,38,40],checkOnSubmit:!1,checkOnUpdate:!1,_savedData:{},processing:!1,onClose:null,ajaxEditOptions:{},serializeEditData:null,viewPagerButtons:!0,overlayClass:O.call(this,"overlay"),removemodal:!0,skipPostTypes:["image","file"],saveui:"enable",savetext:z.call(q,"defaults.savetext")||"Saving..."},z.call(q,"edit"),t.edit,r.formEditing||{},c||{}),x="FrmGrid_"+w,u=x,y="TblGrid_"+w,C="#"+I(y),A=C+"_2",h={themodal:"editmod"+w,modalhead:"edithd"+w,modalcontent:"editcnt"+
w,resizeAlso:x},E="#"+I(h.themodal),H=r.gBox,L=r.colModel,J=r.iColByName,aa=1,Q=0,F,G,M,ga=v.commonIconClass,ia=function(){t.hideModal(E,{gb:H,jqm:v.jqModal,onClose:v.onClose,removemodal:v.removemodal})},sa=z.call(q,"errors.errcap"),K=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("AddEdit");a.unshift(v);return bb.apply(p,a)},P=U.call(p,"hover"),oa=U.call(p,"disabled"),R=U.call(p,"select"),N=U.call(p,"active"),X=U.call(p,"error");b(E).remove();x="#"+I(x);"new"===a?(a="_empty",M="add",
v.caption=v.addCaption):(v.caption=v.editCaption,M="edit");var V=!0;!v.checkOnUpdate||!0!==v.jqModal&&void 0!==v.jqModal||v.modal||(V=!1);var T=isNaN(v.dataheight)?v.dataheight:v.dataheight+"px",fa=isNaN(v.datawidth)?v.datawidth:v.datawidth+"px",u=b("<form name='FormPost' id='"+u+"' class='FormGrid' onSubmit='return false;' style='width:"+fa+";overflow:auto;position:relative;height:"+T+";'></form>").data("disabled",!1),ba=b("<table id='"+y+"' class='EditTable'><tbody></tbody></table>");b(L).each(function(){var b=
this.formoptions;aa=Math.max(aa,b?b.colpos||0:0);Q=Math.max(Q,b?b.rowpos||0:0)});b(u).append(ba);X=b("<tr id='FormError' style='display:none'><td class='"+X+"' colspan='"+2*aa+"'>&#160;</td></tr>");X[0].rp=0;b(ba).append(X);X=b("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*aa+"'>"+(v.topinfo||"&#160;")+"</td></tr>");X[0].rp=0;b(ba).append(X);if(K("beforeInitData",u,M)){(function(){var c=t.detectRowEditing.call(p,a);if(null!=c)if("inlineEditing"===c.mode)D.restoreRow.call(q,
a);else{var c=c.savedRow,d=p.rows[c.id];D.restoreCell.call(q,c.id,c.ic);b(d.cells[c.ic]).removeClass("edit-cell "+R);b(d).addClass(R).attr({"aria-selected":"true",tabindex:"0"})}})();T=(X="rtl"===r.direction?!0:!1)?"nData":"pData";fa=X?"pData":"nData";(function(a,c,d){var e=0,f=[],g=!1,h="",k;for(k=1;k<=d;k++)h+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";"_empty"!==a&&(g=D.getInd.call(q,a));b(L).each(function(k){var l=this.name,m,n,q,u,w;m=this.editable;var y=!1,A=!1;w="_empty"===
...
this.edittype?m.text():m.html()}Ra(q)&&(q="")}m=b.extend({},this.editoptions||{},{id:l,name:l,rowId:a,mode:w,cm:this,iCol:k});var C=b.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),z=parseInt(C.rowpos,10)||e+1,E=parseInt(2*(parseInt(C.colpos,10)||1),10);"_empty"===a&&m.defaultValue&&(q=b.isFunction(m.defaultValue)?m.defaultValue.call(p):m.defaultValue);this.edittype||(this.edittype="text");r.autoEncodeOnEdit&&(q=t.oldDecodePostedData(q));w=t.createEl.call(p,
this.edittype,m,q,!1,b.extend({},t.ajaxOptions,r.ajaxSelectOptions||{}));if(v.checkOnSubmit||v.checkOnUpdate)v._savedData[l]=q;b(w).addClass("FormElement");-1<b.inArray(this.edittype,["text","textarea","checkbox","password","select"])&&b(w).addClass(O.call(p,"dialog.dataField"));n=b(c).find("tr[data-rowpos="+z+"]");if(C.rowabove){var B=b("<tr><td class='contentinfo' colspan='"+2*d+"'>"+C.rowcontent+"</td></tr>");b(c).append(B);B[0].rp=z}0===n.length&&(n=b("<tr "+u+" data-rowpos='"+z+"'></tr>").addClass("FormData").attr("id",
"tr_"+l),b(n).append(h),b(c).append(n),n[0].rp=z);u=b("td:eq("+(E-2)+")",n[0]);n=b("td:eq("+(E-1)+")",n[0]);u.html(void 0===C.label?r.colNames[k]:C.label||"&#160;");n[Ra(n.html())?"html":"append"](C.elmprefix).append(w).append(C.elmsuffix);y?(u.addClass(oa),n.addClass(oa),b(w).prop("readonly",!0),b(w).prop("disabled",!0)):A&&b(w).prop("readonly",!0);"custom"===this.edittype&&b.isFunction(m.custom_value)&&m.custom_value.call(p,b("#"+I(l),x),"set",q);t.bindEv.call(p,w,m);f[e]=k;e++}});0<e&&(k=b("<tr class='FormData' style='display:none'><td class='CaptionTD'>&#160;</td><td colspan='"+
(2*d-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+w+"_id' value='"+a+"'/></td></tr>"),k[0].rp=e+999,b(c).append(k),v.checkOnSubmit||v.checkOnUpdate)&&(v._savedData[w+"_id"]=a);return f})(a,ba,aa);var T=da.call(p,T,"",ta(ga,v.prevIcon),"","left"),fa=da.call(p,fa,"",ta(ga,v.nextIcon),"","right"),W=da.call(p,"sData",v.bSubmit),wa=da.call(p,"cData",v.bCancel),y="<div class='"+O.call(p,"dialog.footer")+"'><table class='EditTable' id='"+y+"_2'><tbody><tr><td colspan='2'><hr class='"+
O.call(p,"dialog.hr")+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton navButton-"+r.direction+"'>"+(X?fa+T:T+fa)+"</td><td class='EditButton EditButton-"+r.direction+"'>"+W+"&#160;"+wa+"</td></tr>",y=y+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+(v.bottominfo||"&#160;")+"</td></tr>"),y=y+"</tbody></table></div>";if(0<Q){var S=[];b.each(b(ba)[0].rows,function(b,a){S[b]=a});S.sort(function(b,a){return b.rp>a.rp?1:b.rp<a.rp?-1:0});b.each(S,
function(a,c){b("tbody",ba).append(c)})}v.gbox=H;var Na=!1;!0===v.closeOnEscape&&(v.closeOnEscape=!1,Na=!0);y=b("<div></div>").append(b("<div class='"+O.call(p,"dialog.body")+"'></div>").append(u)).append(y);t.createModal.call(p,h,y,v,r.gView,b(H)[0]);v.topinfo&&b(".tinfo",C).show();v.bottominfo&&b(".binfo",A).show();y=y=null;b(E).keydown(function(a){var c=(a.target.tagName||"").toUpperCase(),d,e;if(!0===b(x).data("disabled"))return!1;if(13===a.which&&"TEXTAREA"!==c){d=b(A).find(":focus");e=d.attr("id");
if(0<d.length&&0<=b.inArray(e,["pData","nData","cData"]))return d.trigger("click"),!1;if(!0===v.savekey[0]&&13===v.savekey[1])return b("#sData",A).trigger("click"),!1}if(!0===v.savekey[0]&&a.which===v.savekey[1]&&"TEXTAREA"!==c)return b("#sData",A).trigger("click"),!1;if(27===a.which){if(!l())return!1;Na&&ia();return!1}if(!0===v.navkeys[0]){if("_empty"===b("#id_g",C).val())return!0;if(a.which===v.navkeys[1])return b("#pData",A).trigger("click"),!1;if(a.which===v.navkeys[2])return b("#nData",A).trigger("click"),
!1}});v.checkOnUpdate&&(b("a.ui-jqdialog-titlebar-close span",E).removeClass("jqmClose"),b("a.ui-jqdialog-titlebar-close",E).off("click").click(function(){if(!l())return!1;ia();return!1}));Qa(b("#sData",A),v.saveicon,ga);Qa(b("#cData",A),v.closeicon,ga);if(v.checkOnSubmit||v.checkOnUpdate)W=da.call(p,"sNew",v.bYes),fa=da.call(p,"nNew",v.bNo),wa=da.call(p,"cNew",v.bExit),h=v.zIndex||999,h++,b("<div class='"+v.overlayClass+" jqgrid-overlay confirm' style='z-index:"+h+";display:none;'>&#160;</div><div class='"+
O.call(p,"dialog.content","confirm ui-jqconfirm")+"' style='z-index:"+(h+1)+"'>"+v.saveData+"<br/><br/>"+W+fa+wa+"</div>").insertAfter(x),b("#sNew",E).click(function(){f();b(x).data("disabled",!1);b(".confirm",E).hide();return!1}),b("#nNew",E).click(function(){b(".confirm",E).hide();b(x).data("disabled",!1);setTimeout(function(){b(":input:visible",x)[0].focus()},0);return!1}),b("#cNew",E).click(function(){b(".confirm",E).hide();b(x).data("disabled",!1);ia();return!1});K("onInitializeForm",b(x),M);
"_empty"!==a&&v.viewPagerButtons?b("#pData,#nData",A).show():b("#pData,#nData",A).hide();K("beforeShowForm",b(x),M);b(E).data("onClose",v.onClose);t.viewModal.call(p,E,{gbox:H,jqm:v.jqModal,overlay:v.overlay,modal:v.modal,overlayClass:v.overlayClass,toTop:v.toTop,onHide:function(b){b.w.remove();b.o&&b.o.remove()}});V||b("."+I(v.overlayClass)).click(function(){if(!l())return!1;ia();return!1});b(".fm-button",E).hover(function(){b(this).addClass(P)},function(){b(this).removeClass(P)});b("#sData",A).click(function(){F=
{};b("#FormError",C).hide();d();"_empty"===F[w+"_id"]?f():!0===v.checkOnSubmit?(G=k(F,v._savedData))?(b(x).data("disabled",!0),b(".confirm",E).show()):f():f();return!1});b("#cData",A).click(function(){if(!l())return!1;ia();return!1});b("#nData",A).click(function(){if(!l())return!1;b("#FormError",C).hide();var a=n();a[0]=parseInt(a[0],10);if(-1!==a[0]&&a[1][a[0]+1]){if(!K("onclickPgButtons","next",b(x),a[1][a[0]]))return!1;e(a[1][a[0]+1],x);B.call(q,a[1][a[0]+1]);K("afterclickPgButtons","next",b(x),
...
b(y).each(function(){var b=this.formoptions;C=Math.max(C,b?b.colpos||0:0);A=Math.max(A,b?b.rowpos||0:0)});J.append(Q);if(h("beforeInitData",J)){(function(a,c,d){var e,f,g,h=0,n,q,r=[],w=D.getInd.call(l,a),u;u=O.call(k,"dialog.viewData","DataTD form-view-data");var v=O.call(k,"dialog.viewLabel","CaptionTD form-view-label"),x="<td class='"+v+"' width='"+p.labelswidth+"'>&#160;</td><td class='"+u+" ui-helper-reset'>&#160;</td>",A="",v="<td class='"+v+"'></td><td class='"+u+"'></td>",C=["integer","number",
"currency"],z=0,E=0,B,G,H;for(u=1;u<=d;u++)A+=1===u?x:v;b(y).each(function(){(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==b.inArray(this.formatter,C)?z=Math.max(z,parseInt(this.width,10)):E=Math.max(E,parseInt(this.width,10)))});B=0!==z?z:0!==E?E:0;b(y).each(function(a){e=this.name;G=!1;q=(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";H="boolean"!==typeof this.viewable?
!0:this.viewable;if("cb"!==e&&"subgrid"!==e&&"rn"!==e&&H){n=!1===w?"":t.getDataFieldOfCell.call(k,k.rows[w],a).html();G="right"===this.align&&0!==B?!0:!1;var l=b.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),p=parseInt(l.rowpos,10)||h+1,u=parseInt(2*(parseInt(l.colpos,10)||1),10);if(l.rowabove){var v=b("<tr><td class='contentinfo' colspan='"+2*d+"'>"+l.rowcontent+"</td></tr>");b(c).append(v);v[0].rp=p}g=b(c).find("tr[data-rowpos="+p+"]");0===g.length&&(g=b("<tr "+q+" data-rowpos='"+
p+"'></tr>").addClass("FormData").attr("id","trv_"+e),b(g).append(A),b(c).append(g),g[0].rp=p);l=void 0===l.label?m.colNames[a]:l.label;p=b("td:eq("+(u-1)+")",g[0]);b("td:eq("+(u-2)+")",g[0]).html("<b>"+(l||"&nbsp;")+"</b>");p[Ra(p.html())?"html":"append"]("<span>"+(n||"&nbsp;")+"</span>").attr("id","v_"+e);G&&b("td:eq("+(u-1)+") span",g[0]).css({"text-align":"right",width:B+"px"});r[h]=a;h++}});0<h&&(a=b("<tr class='FormData' style='display:none'><td class='CaptionTD'>&#160;</td><td colspan='"+(2*
d-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+a+"'/></td></tr>"),a[0].rp=h+99,b(c).append(a));return r})(a,Q,C);var F=(J="rtl"===m.direction?!0:!1)?"pData":"nData",aa=da.call(k,J?"nData":"pData","",ta(v,p.prevIcon),"","left"),F=da.call(k,F,"",ta(v,p.nextIcon),"","right"),G=da.call(k,"cData",p.bClose);if(0<A){var M=[];b.each(b(Q)[0].rows,function(b,a){M[b]=a});M.sort(function(b,a){return b.rp>a.rp?1:b.rp<a.rp?-1:0});b.each(M,function(a,c){b("tbody",Q).append(c)})}p.gbox=
...
w,A,k,e.gView,b(e.gView)[0]);b("#DelData>td",m).data("rowids",a);if(!x("beforeInitData",b(A)))return;b(".fm-button",m+"_2").hover(function(){b(this).addClass(u)},function(){b(this).removeClass(u)});Qa(b("#dData",m+"_2"),k.delicon,v);Qa(b("#eData",m+"_2"),k.cancelicon,v);b("#dData",m+"_2").click(function(){var a=[!0,""],c,h=b("#DelData>td",m),l=h.text(),u=h.data("rowids"),h={};b.isFunction(k.onclickSubmit)&&(h=k.onclickSubmit.call(d,k,l)||{});b.isFunction(k.beforeSubmit)&&(a=k.beforeSubmit.call(d,
...
0===c.status&&4===c.readyState?(a[0]=!1,b.isFunction(k.errorTextFormat)?a[1]=k.errorTextFormat.call(d,c):a[1]=f+" Status: '"+c.statusText+"'. Error code: "+c.status):b.isFunction(k.afterSubmit)&&(a=k.afterSubmit.call(d,c,n)||[!0]);if(!1===a[0])b("#DelError>td",m).html(a[1]),b("#DelError",m).show();else{if(k.reloadAfterSubmit&&"local"!==e.datatype)g.trigger("reloadGrid",[b.extend({},k.reloadGridOptions||{})]);else if(!0===e.treeGrid)try{D.delTreeNode.call(g,u[0])}catch(M){}else for(u=u.slice(),h=0;h<
u.length;h++)D.delRowData.call(g,u[h]);setTimeout(function(){x("afterComplete",c,l,b(m))},50)}k.processing=!1;a[0]&&t.hideModal(z,{gb:B,jqm:k.jqModal,onClose:k.onClose,removemodal:k.removemodal})}},t.ajaxOptions,k.ajaxDelOptions);c.url||k.useDataProxy||(b.isFunction(e.dataProxy)?k.useDataProxy=!0:(a[0]=!1,a[1]+=" "+t.errors.nourl));a[0]&&(k.useDataProxy?(c=e.dataProxy.call(d,c,"del_"+f),void 0===c&&(c=[!0,""]),!1===c[0]?(a[0]=!1,a[1]=c[1]||"Error deleting the selected row!"):t.hideModal(z,{gb:B,jqm:k.jqModal,
...
void 0===b("#"+I(v.themodal))[0]&&(q.alerttop||q.alertleft||(void 0!==c.innerWidth?(d=c.innerWidth,e=c.innerHeight):null!=a&&void 0!==a.clientWidth&&0!==a.clientWidth&&(d=a.clientWidth,e=a.clientHeight),d=d/2-parseInt(q.alertwidth,10)/2-f.left,e=e/2-25-f.top),t.createModal.call(l,v,"<div class='"+O.call(l,"dialog.body")+"'><div>"+q.alerttext+"</div></div>",{gbox:z,jqModal:q.jqModal,drag:!0,resize:!0,caption:q.alertcap,top:null!=q.alerttop?q.alerttop:e,left:null!=q.alertleft?q.alertleft:d,width:q.alertwidth,
height:q.alertheight,closeOnEscape:q.closeOnEscape,zIndex:q.alertzIndex,removemodal:q.removemodal},m.gView,b(z)[0],!1));t.viewModal.call(l,"#"+I(v.themodal),{gbox:z,toTop:q.alertToTop,jqm:q.jqModal});var g=b("#"+I(v.modalhead)).find(".ui-jqdialog-titlebar-close");g.attr({tabindex:"0",href:"#",role:"button"});setTimeout(function(){g.focus()},50)}}(),u,y=function(a){if(13===a.which&&(a=b(this).find(".ui-pg-button").filter(":focus"),0<a.length)){var c=a[0].id,c=c.substr(0,0<b(this).closest(".ui-jqgrid-toppager").length?
...
srt:g.summaryRoundType||"round"},g.summaryDivider&&(f.sd=g.summaryDivider,f.vd=""),e.summary.push(f))}else c.grouping=!1})},groupingPrepare:function(a,c){this.each(function(){var d=this.p.groupingView,e=d.groups,g=d.counters,f=d.lastvalues,k=d.isInTheSameGroup,l=d.groupField.length,m,n,p,q,r,w,t=!1,B=D.groupingCalculations.handler;for(m=0;m<l;m++)if(q=d.groupField[m],n=d.displayField[m],r=a[q],w=null==n?null:a[n],null==w&&(w=r),void 0!==r){p=[];for(n=0;n<=m;n++)p.push(a[d.groupField[n]]);n={idx:m,
dataIndex:q,value:r,displayValue:w,startRow:c,cnt:1,keys:p,summary:[]};q={cnt:1,pos:e.length,summary:b.extend(!0,[],d.summary)};0===c?(e.push(n),f[m]=r,g[m]=q):"object"===typeof r||(b.isArray(k)&&b.isFunction(k[m])?k[m].call(this,f[m],r,m,d):f[m]===r)?t?(e.push(n),f[m]=r,g[m]=q):(q=g[m],q.cnt+=1,e[q.pos].cnt=q.cnt):(e.push(n),f[m]=r,t=!0,g[m]=q);r=e[q.pos];var v;for(p=0;p<q.summary.length;p++)w=q.summary[p],v=b.isArray(w.st)?w.st[n.idx]:w.st,b.isFunction(v)?w.v=v.call(this,w.v,w.nm,a,n):(w.v=B.call(b(this),
v,w.v,w.nm,w.sr,w.srt,a),"avg"===v.toLowerCase()&&w.sd&&(w.vd=B.call(b(this),v,w.vd,w.sd,w.sr,w.srt,a)));r.summary=q.summary;for(n=q.pos-1;0<=n;n--)if(e[n].idx<e[q.pos].idx){e[q.pos].parentGroupIndex=n;e[q.pos].parentGroup=e[n];break}}});return this},getGroupHeaderIndex:function(a,c){var d=this[0].p,e=c?b(c).closest("tr.jqgroup"):b("#"+t.jqID(a)),g=parseInt(e.data("jqgrouplevel"),10),d=d.id+"ghead_"+g+"_";return isNaN(g)||!e.hasClass("jqgroup")||a.length<=d.length?-1:parseInt(a.substring(d.length),
...
[{header:{resizeDiv:!1,resizedRows:{iRowStart:-1,iRowEnd:-1}},resizeFooter:!1,body:{resizeDiv:!0,resizedRows:{iRowStart:m,iRowEnd:k.length?k[0].rowIndex-1:-1}}}]);this.fixScrollOffsetAndhBoxPadding();b(this).triggerHandler("jqGridGroupingClickGroup",[a,p]);b.isFunction(d.onClickGroup)&&d.onClickGroup.call(this,a,p)});return!1},groupingRender:function(a,c){function d(a,c,d,e,k){var h=q[a],l,n="",p,u,v,x=0,y,A,C,z=!0;if(0!==c&&0!==q[a].idx)for(l=a;0<=l;l--)if(q[l].idx===q[a].idx-c){h=q[l];break}a=h.cnt;
for(y=void 0===k?e:0;y<w;y++){c="&#160;";l=r[y];for(p=0;p<h.summary.length;p++)if(u=h.summary[p],A=b.isArray(u.st)?u.st[d.idx]:u.st,C=b.isArray(l.summaryTpl)?l.summaryTpl[d.idx]:l.summaryTpl||"{0}",u.nm===l.name){"string"===typeof A&&"avg"===A.toLowerCase()&&(u.sd&&u.vd?u.v/=u.vd:u.v&&0<a&&(u.v/=a));try{u.groupCount=h.cnt,u.groupIndex=h.dataIndex,u.groupValue=h.value,v=g.formatter("",u.v,y,u)}catch(ia){v=u.v}c=t.format(C,v);l.summaryFormat&&(c=l.summaryFormat.call(g,d,c,v,l,u));break}u=p=!1;void 0!==
k&&z&&!l.hidden&&(c=k,z=!1,1<e&&(p=!0,x=e-1),u=l.align,l.align="rtl"===f.direction?"right":"left",m.iconColumnName=l.name);0<x&&!l.hidden&&"&#160;"===c?(u&&(l.align=u),x--):(n+="<td role='gridcell' "+g.formatCol(y,1,"")+(p?"colspan='"+e+"'":"")+">"+c+"</td>",u&&(l.align=u))}return n}var e="",g=this[0],f=g.p,k=0,l=[],m=f.groupingView,n=b.makeArray(m.groupSummary),p=m.groupField.length,q=m.groups,r=f.colModel,w=r.length,z=f.page,B=D.getGuiStyles.call(g,"gridRow","jqgroup ui-row-"+f.direction),v=D.getGuiStyles.call(g,
"gridRow","jqfoot ui-row-"+f.direction);b.each(r,function(a,b){var c;for(c=0;c<p;c++)if(m.groupField[c]===b.name){l[c]=a;break}});n.reverse();b.each(q,function(x,u){var y,C=f.id+"ghead_"+u.idx,A=C+"_"+x,h=b.isFunction(m.groupCollapse)?m.groupCollapse.call(g,{group:u,rowid:A}):m.groupCollapse,E,H;H=0;var D,J;D=p-1===u.idx;var I=null!=u.parentGroup?u.parentGroup.collapsed:!1;J="<span style='cursor:pointer;margin-"+("rtl"===f.direction?"right:":"left:")+12*u.idx+"px;' class='"+m.commonIconClass+" "+
(h?m.plusicon:m.minusicon)+" tree-wrap' onclick=\"jQuery('#"+t.jqID(f.id).replace("\\","\\\\")+"').jqGrid('groupingToggle','"+A+"', this);return false;\"></span>";if(m._locgr&&!(u.startRow+u.cnt>(z-1)*c&&u.startRow<z*c))return!0;I&&(h=!0);void 0!==h&&(u.collapsed=h);k++;try{b.isArray(m.formatDisplayField)&&b.isFunction(m.formatDisplayField[u.idx])?(u.displayValue=m.formatDisplayField[u.idx].call(g,u.displayValue,u.value,r[l[u.idx]],u.idx,m),y=u.displayValue):y=g.formatter(A,u.displayValue,l[u.idx],
u.value)}catch(Q){y=u.displayValue}e+="<tr id='"+A+"' data-jqgrouplevel='"+u.idx+"' "+(h&&I?"style='display:none;' ":"")+"role='row' class='"+B+" "+C+"'>";C=b.isFunction(m.groupText[u.idx])?m.groupText[u.idx].call(g,y,u.cnt,u.summary):t.template(m.groupText[u.idx],y,u.cnt,u.summary);"string"!==typeof C&&"number"!==typeof C&&(C=y);"header"===m.groupSummaryPos[u.idx]?(y=1,"cb"!==r[0].name&&"cb"!==r[1].name||y++,"subgrid"!==r[0].name&&"subgrid"!==r[1].name||y++,e+=d(x,0,u,y,J+"<span class='cell-wrapper'>"+
C+"</span>")):e+="<td role='gridcell' style='padding-left:"+12*u.idx+"px;' colspan='"+w+"'>"+J+C+"</td>";e+="</tr>";if(D){D=q[x+1];y=u.startRow;J=void 0!==D?D.startRow:q[x].startRow+q[x].cnt;m._locgr&&(H=(z-1)*c,H>u.startRow&&(y=H));for(;y<J&&a[y-H];y++)e+=a[y-H].join("");if("header"!==m.groupSummaryPos[u.idx]){if(void 0!==D){for(E=0;E<m.groupField.length&&D.dataIndex!==m.groupField[E];E++);k=m.groupField.length-E}for(H=0;H<k;H++)n[H]&&(e+="<tr data-jqfootlevel='"+(u.idx-H)+(h&&(0<u.idx-H||!m.showSummaryOnHide)?
"' style='display:none;'":"'")+" role='row' class='"+v+"'>",e+=d(x,H,q[u.idx-H],0),e+="</tr>");k=E}}});this.off("jqGridShowHideCol.groupingRender").on("jqGridShowHideCol.groupingRender",function(){var a=f.iColByName[m.iconColumnName],c,d,e;if(0<=b.inArray("header",m.groupSummaryPos)){for(c=0;c<r.length;c++)if(!r[c].hidden){e=c;break}if(void 0!==e&&a!==e){for(c=0;c<g.rows.length;c++)d=g.rows[c],b(d).hasClass("jqgroup")&&(b(d.cells[e]).html(d.cells[a].innerHTML),b(d.cells[a]).html("&nbsp;"));m.iconColumnName=
...
url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,beforeSaveRow:null,ajaxSaveOptions:{},serializeSaveData:null,mtype:"POST",saveui:"enable",savetext:m("defaults.savetext")||"Saving..."},t.inlineEdit,r.inlineEditing||{},n),x={},u={},y={},C,A,h,E=q.jqGrid("getInd",a,!0),H=b(E),D=r.prmNames,J=m("errors.errcap"),I=m("edit.bClose"),K,F;if(!1!==E&&(w=n.extraparam[D.oper]===D.addoper?"add":"edit",cb.call(p,n,"beforeSaveRow",n,a,w)&&(m=H.attr("editable"),
...
if(null!=h&&!1===h[0]){F=!0;try{var n=t.getRelativeRect.call(p,c.td);z.call(p,J,h[1],I,{top:n.top,left:n.left+b(p).closest(".ui-jqgrid").offset().left})}catch(Z){v(h[1])}return!1}"date"===e&&!0!==g.sendFormatted&&(m=b.unformat.date.call(p,m,d));K&&!0===f.NullIfEmpty&&""===m&&(m="null");x[d.name]=m}),!F))))if(m=a,D=r.prmNames,A=!1===r.keyName?D.id:r.keyName,x&&(x[D.oper]=D.editoper,void 0===x[A]||""===x[A]?x[A]=a:E.id!==r.idPrefix+x[A]&&(E=t.stripPref(r.idPrefix,a),void 0!==r._index[E]&&(r._index[x[A]]=
r._index[E],delete r._index[E]),a=r.idPrefix+x[A],H.attr("id",a),r.selrow===m&&(r.selrow=a),b.isArray(r.selarrrow)&&(E=b.inArray(m,r.selarrrow),0<=E&&(r.selarrrow[E]=a)),r.multiselect&&(E="jqg_"+r.id+"_"+a,H.find("input.cbox").attr("id",E).attr("name",E))),x=b.extend({},x,r.inlineData||{},n.extraparam)),K)q.jqGrid("progressBar",{method:"show",loadtype:n.saveui,htmlcontent:n.savetext}),y=b.extend({},x,y),y[A]=t.stripPref(r.idPrefix,y[A]),r.autoEncodeOnEdit&&b.each(y,function(a,b){B(b)||(y[a]=t.oldEncodePostedData(b))}),
b.ajax(b.extend({url:B(n.url)?n.url.call(p,y[A],w,y,n):n.url,data:t.serializeFeedback.call(p,B(n.serializeSaveData)?n.serializeSaveData:r.serializeRowData,"jqGridInlineSerializeSaveData",y),type:B(n.mtype)?n.mtype.call(p,w,n,y[A],y):n.mtype,complete:function(c,d){q.jqGrid("progressBar",{method:"hide",loadtype:n.saveui});if((300>c.status||304===c.status)&&(0!==c.status||4!==c.readyState)){var e,f;f=q.triggerHandler("jqGridInlineSuccessSaveRow",[c,a,n]);if(null==f||!0===f)f=[!0,x];f[0]&&B(n.successfunc)&&
(f=n.successfunc.call(p,c));b.isArray(f)?(e=f[0],x=f[1]||x):e=f;if(!0===e){r.autoEncodeOnEdit&&b.each(x,function(a,b){x[a]=t.oldDecodePostedData(b)});x=b.extend({},x,u);q.jqGrid("setRowData",a,x);H.attr("editable","0");for(e=0;e<r.savedRow.length;e++)if(String(r.savedRow[e].id)===String(a)){C=e;break}0<=C&&r.savedRow.splice(C,1);Da.call(p,n.aftersavefunc,"jqGridInlineAfterSaveRow",a,c,x,n);H.removeClass("jqgrid-new-row").off("keydown")}else Da.call(p,n.errorfunc,"jqGridInlineErrorSaveRow",a,c,d,null,
n),!0===n.restoreAfterError&&q.jqGrid("restoreRow",a,n.afterrestorefunc)}},error:function(b,c,d){q.triggerHandler("jqGridInlineErrorSaveRow",[a,b,c,d,n]);if(B(n.errorfunc))n.errorfunc.call(p,a,b,c,d);else{b=b.responseText||b.statusText;try{z.call(p,J,'<div class="'+U.call(p,"error")+'">'+b+"</div>",I,{buttonalign:"right"})}catch(ia){v(b)}}!0===n.restoreAfterError&&q.jqGrid("restoreRow",a,n.afterrestorefunc)}},t.ajaxOptions,r.ajaxRowOptions,n.ajaxSaveOptions||{}));else{x=b.extend({},x,u);A=q.jqGrid("setRowData",
...
c.newColOrder));e++})},z=function(c){if(n[c]===n[a])return b(this).after(p[q]),t(),!0},B=function(c){if(n[c]===n[a])return b(this).before(p[q]),t(),!0},v=function(b){if(n[b]===n[a]&&void 0!==n[b])return l[n[b]].startColumnName=d.colModel[b].name,!0};t();if(l&&void 0!==l[n[a]])for(k=l[n[a]],g=0;g<k.numberOfColumns;g++){if(e=d.iColByName[k.startColumnName]+g,!d.colModel[e].hidden&&!d.colModel[e].hidedlg){r(z,q-1,!0);r(B,q+1);r(v);break}}else!l||(p=m.find("li"),g=r(function(b){if(b===a)return!0}),g+
...
k={grouping:!0,groupingView:f},l=b.extend({totals:!1,useColSpanStyle:!1,trimByCollect:!0,skipSortByX:!1,skipSortByY:!1,caseSensitive:!1,footerTotals:!1,groupSummary:!0,groupSummaryPos:"header",frozenStaticCols:!1,defaultFormatting:!0,data:a},c||{}),m,n,p,q=a.length,r,w,z,B,v,x,u=l.xDimension,y=l.yDimension,C=l.aggregates,A,q=l.totalText||l.totals||l.rowTotals||l.totalHeader,h,E=e(u)?u.length:0;B=e(y)?y.length:0;var H=e(C)?C.length:0,D=B-(1===H?1:0),J=[],I=[],Q=[],e=[],F=["pivotInfos"],G=Array(H),
...
0>b.inArray(h,l.iRows)&&(l.iRows.push(h),l.rows.push(g)))};if(0===E||0===H)throw"xDimension or aggregates options are not set!";Y=n(u,l.skipSortByX,l.compareVectorsByX);T=n(y,l.skipSortByY,l.compareVectorsByY);c.xIndex=Y;c.yIndex=T;for(n=0;n<E;n++)p=u[n],w={name:"x"+n,label:null!=p.label?b.isFunction(p.label)?p.label.call(d,p,n,l):p.label:p.dataName,frozen:l.frozenStaticCols},n<E-1&&!p.skipGrouping&&!p.additionalProperty&&(f.groupField.push(w.name),f.groupSummary.push(l.groupSummary),f.groupSummaryPos.push(l.groupSummaryPos)),
w=b.extend(w,p),delete w.dataName,delete w.footerText,p.additionalProperty?F.push(w.name):(Q.push(w),k.sortname=w.name);2>E&&(k.grouping=!1);f.hideFirstGroupCol=!0;for(n=0;n<B;n++)r=y[n],I.push(r.totals||r.rowTotals||r.totalText||r.totalHeader?!0:!1);Z=T.getItem(0);v(0,B-1,0);f=T.getIndexLength();for(w=1;w<f;w++){N=T.getItem(w);n=T.getIndexOfDifferences(N,Z);for(p=D-1;p>=n;p--)I[p]&&v(1,p,w-1);Z=N;v(0,B-1,w)}for(n=D-1;0<=n;n--)I[n]&&v(1,n,f-1);q&&v(2);Z=T.getItem(0);for(p=0;p<D;p++)J.push({useColSpanStyle:l.useColSpanStyle,
...
for(B=0;B<O;B++){p=Y.getItem(B);v={iX:B,x:p};U={pivotInfos:v};for(n=0;n<E;n++)U["x"+n]=p[n];R=Y.getIndexesOfSourceData(B);if(q)for(p=0;p<H;p++)G[p]=ba(p);Z=null;ea();for(w=0;w<f;w++){N=T.getItem(w);V=T.getIndexesOfSourceData(w);for(p=0;p<H;p++){null!==Z&&da(w-1,N,Z,p);S=[];for(n=0;n<V.length;n++)z=V[n],0<=b.inArray(z,R)&&S.push(z);if(0<S.length){x=Array(S.length);W=C[p];A=new P(W.aggregator,d,c);for(z=0;z<S.length;z++)n=S[z],m=a[n],x[z]=m,A.calc(m[W.member],W.member,m,n,a),q&&(h=G[p],h.calc(m[W.member],
W.member,m,n,a),h=h.groupInfo,0>b.inArray(n,h.iYs)&&(h.iYs.push(w),h.ys.push(N)),0>b.inArray(n,h.iRows)&&(h.iRows.push(n),h.rows.push(m))),ha(N,Z,W,p,m,n,w);m="y"+w+(1===H?"":"a"+p);A.getResult(U,m);v[m]={colType:0,iY:w,y:N,iA:p,a:W,iRows:S,rows:x}}}Z=N}if(null!==Z)for(p=0;p<H;p++)da(f-1,Z,Z,p);if(q)for(p=0;p<H;p++)m="t"+(1===H?"":"a"+p),h=G[p],h.getResult(U,m),h=h.groupInfo,v[m]={colType:2,iA:p,a:C[p],iRows:h.iRows,rows:h.rows,iYs:h.iYs,ys:h.ys};e.push(U)}if(l.footerTotals||l.colTotals){q=e.length;
for(n=0;n<E;n++)g["x"+n]=u[n].footerText||"";for(n=E;n<Q.length;n++){m=Q[n].name;A=new P(l.footerAggregator||"sum",d,c);for(z=0;z<q;z++)U=e[z],A.calc(U[m],m,U,z,e);A.getResult(g,m)}}c.colHeaders=J;return{colModel:Q,additionalProperties:F,options:c,rows:e,groupOptions:k,groupHeaders:J,summary:g}},jqPivot:function(a,c,d,e){return this.each(function(){function g(){var e=l.pivotSetup.call(k,a,c),g=e.groupHeaders,p=e.summary,q=0,r;for(r in p)p.hasOwnProperty(r)&&q++;p=0<q?!0:!1;q=e.groupOptions.groupingView;
...
(f[k][p]=parseInt(f[k][p],10)-g)}}})},addChildNode:function(a,c,d,e){var g=b(this),f=g[0],k=f.p,l=D.getInd;if(d){var m,n,p,q,r;m=0;var w=c,z,B,v=k.treeReader.expanded_field;B=k.treeReader.leaf_field;var x=k.treeReader.level_field,u=k.treeReader.parent_id_field,y=k.treeReader.left_field,C=k.treeReader.right_field,A=k.treeReader.loaded;void 0===e&&(e=!1);if(null==a){r=k.data.length-1;if(0<=r)for(;0<=r;)m=Math.max(m,parseInt(k.data[r][k.localReader.id],10)),r--;a=m+1}var h=l.call(g,c);z=!1;if(void 0===
c||null===c||""===c)w=c=null,m="last",q=k.tree_root_level,r=k.data.length+1;else{m="after";n=k._index[c];p=k.data[n];c=p[k.localReader.id];r=l.call(g,c);q=parseInt(p[x],10)+1;var E=D.getFullTreeNode.call(g,p);if(E.length){var H,I,J;for(H=0;H<E.length;H++)J=E[H][k.localReader.id],I=l.call(g,J),I>r&&(r=I,w=J)}r++;p[B]&&(z=!0,p[v]=!0,b(f.rows[h]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(k.treeIcons.leaf+" tree-leaf").addClass(k.treeIcons.commonIconClass).addClass(k.treeIcons.minus+
" tree-minus"),k.data[n][B]=!1,p[A]=!0)}l=r+1;void 0===d[v]&&(d[v]=!1);void 0===d[A]&&(d[A]=!1);d[x]=q;void 0===d[B]&&(d[B]=!0);"adjacency"===k.treeGridModel&&(d[u]=c);if("nested"===k.treeGridModel){var K;if(null!==c){B=parseInt(p[C],10);k=t.from.call(f,k.data);k=k.greaterOrEquals(C,B,{stype:"integer"});x=k.select();if(x.length)for(K in x)x.hasOwnProperty(K)&&(x[K][y]=x[K][y]>B?parseInt(x[K][y],10)+2:x[K][y],x[K][C]=x[K][C]>=B?parseInt(x[K][C],10)+2:x[K][C]);d[y]=B;d[C]=B+1}else{B=parseInt(D.getCol.call(g,
C,!1,"max"),10);x=t.from.call(f,k.data).greater(y,B,{stype:"integer"}).select();if(x.length)for(K in x)x.hasOwnProperty(K)&&(x[K][y]=parseInt(x[K][y],10)+2);x=t.from.call(f,k.data).greater(C,B,{stype:"integer"}).select();if(x.length)for(K in x)x.hasOwnProperty(K)&&(x[K][C]=parseInt(x[K][C],10)+2);d[y]=B+1;d[C]=B+2}}if(null===c||D.isNodeLoaded.call(g,p)||z)D.addRowData.call(g,a,d,m,w),D.setTreeNode.call(g,r,l);p&&!p[v]&&e&&b(f.rows[h]).find("div.treeclick").click()}}});var db="mousedown",Sa="mousemove",
...
(g[1]=b.map(g,l).join(e)),c)-1<b.inArray(b.trim(g[1]),k)&&(d[n]=g[0],n++);else if(b.trim(g[1])===b.trim(a)){d[0]=g[0];break}}else if(W.isObject(f)||b.isArray(f))c||(k[0]=a),d=b.map(k,function(a){var c;b.each(f,function(b,d){if(d===a)return c=b,!1});if(void 0!==c)return c});return d.join(", ")}return a||""};b.unformat.date=function(a,c){var d=b.extend(!0,{},ha.call(b(this),"formatter.date"),t.formatter.date||{},c.formatoptions||{});return W.isEmpty(a)?"":t.parseDate.call(this,d.newformat,a,d.srcformat,
d)}});
