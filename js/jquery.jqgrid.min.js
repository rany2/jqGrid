...
a.andNot().startsWith},en:function(a,b){return"OR"===b?a.orNot().endsWith:a.andNot().endsWith},ew:function(a){return a.endsWith},ni:function(a,b){return"OR"===b?a.orNot().equals:a.andNot().equals},"in":function(a){return a.equals},nu:function(a){return a.isNull},nn:function(a,b){return"OR"===b?a.orNot().isNull:a.andNot().isNull}},G=v.from.call(this,k.data);k.ignoreCase&&(G=G.ignoreCase());if(!0===k.search){var B=k.postData.filters;if(B)"string"===typeof B&&(B=v.parse(B)),b(B);else try{R=n[k.postData.searchField],
G=H[k.postData.searchOper](G)(m(R.reader)?'jQuery.jgrid.getAccessor(this,jQuery("'+k.idSel+'")[0].p.colModel['+R.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+R.reader+"')",k.postData.searchString,n[k.postData.searchField])}catch(F){}}if(k.grouping)for(y=0;y<z;y++)G.orderBy(q[y],C.groupOrder[y],p[y].stype,p[y].srcfmt);k.multiSort?r(e,function(){G.orderBy(this,f[this],n[this].stype,n[this].srcfmt,n[this].sfunc)}):e&&k.sortorder&&g&&G.orderBy(k.sortname,"DESC"===k.sortorder.toUpperCase()?"d":
"a",n[e].stype,n[e].srcfmt,n[e].sfunc);k.lastSelectedData=G.select();var B=parseInt(k.rowNum,10),A=k.lastSelectedData.length,K=parseInt(k.page,10),va=Math.ceil(A/B),J={};if(k.grouping&&k.groupingView._locgr){k.groupingView.groups=[];var O,P,N;if(k.footerrow&&k.userDataOnFooter){for(P in k.userData)k.userData.hasOwnProperty(P)&&(k.userData[P]=0);N=!0}for(O=0;O<A;O++){if(N)for(P in k.userData)k.userData.hasOwnProperty(P)&&(k.userData[P]+=parseFloat(k.lastSelectedData[O][P]||0));c.groupingPrepare.call(d,
k.lastSelectedData[O],O,B)}}n=G=null;d=k.localReader;J[d.total]=va;J[d.page]=K;J[d.records]=A;J[d.root]=k.lastSelectedData.slice((K-1)*B,K*B);J[d.userdata]=k.userData;return J},eb=function(b){var c=b.outerWidth();0>=c&&(c=a(this).closest(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px",a(document.body).append("<div id='testpg' class='"+F("gBox","ui-jqgrid")+"' style='font-size:"+c+";visibility:hidden;margin:0;padding:0;' ></div>"),a(b).clone().appendTo("#testpg"),c=a("#testpg>.ui-pg-table").width(),
...
10))||0>=parseInt(k.rowNum,10))k.rowNum=k.maxRowNum;null!==q.rows&&(l[q.rows]=k.rowNum);null!==q.page&&(l[q.page]=k.page);null!==q.sort&&(l[q.sort]=k.sortname);null!==q.order&&(l[q.order]=k.sortorder);null!==k.rowTotal&&null!==q.totalrows&&(l[q.totalrows]=k.rowTotal);var r=m(k.loadComplete),t=r?k.loadComplete:null,u=0;b=b||1;1<b?null!==q.npage?(l[q.npage]=b,u=b-1,b=1):t=function(a){k.page++;g.hDiv.loading=!1;r&&k.loadComplete.call(e,a);fa.call(e,b-1)}:null!==q.npage&&delete k.postData[q.npage];if(k.grouping&&
c.groupingSetup){c.groupingSetup.call(f);var x=k.groupingView,w,C="",y,E,H;for(w=0;w<x.groupField.length;w++){y=x.groupField[w];for(E=0;E<k.colModel.length;E++)H=k.colModel[E],H.name===y&&H.index&&(y=H.index);C+=y+" "+x.groupOrder[w]+", "}l[q.sort]=C+l[q.sort]}n(k.postData,l);var B=k.scroll?e.rows.length-1:1,A=function(){G.call(e);var a=f.width(),b=f.closest(".ui-jqgrid-view").width(),d=f.css("height");b<a&&0===k.reccount?f.css("height","1px"):"0"!==d&&"0px"!==d&&f.css("height","");k.autowidth||void 0!==
...
var a=N(k.page,1),b=a,e=this.id,g=N(k.lastpage,1),h=!1,l=!0,m=!0,n=!0,p=!0;0===g||1===g?(1>=a&&(m=l=!1),p=n=!1):1<g&&1<=a?1===a?m=l=!1:a===g&&(p=n=!1):1<g&&0===a&&(p=n=!1,a=g-1);this.id==="first"+c&&l&&(e="first",b=1,h=!0);this.id==="prev"+c&&m&&(e="prev",b=a-1,h=!0);this.id==="next"+c&&n&&(e="next",b=a+1,h=!0);this.id==="last"+c&&p&&(e="last",b=g,h=!0);if(!t(e,b,N(k.rowNum,10)))return!1;k.page=b;h&&fa.call(d);return!1}));!0===k.pginput&&a("input.ui-pg-input",n).bind("keypress.jqGrid",function(b){b=
b.charCode||b.keyCode||0;var c=N(a(this).val(),1);if(13===b){if(!t("user",c,N(k.rowNum,10)))return!1;a(this).val(c);k.page=0<a(this).val()?a(this).val():k.page;fa.call(d);return!1}return this});w.children(".ui-pg-table").bind("keydown.jqGrid",function(a){13===a.which&&(a=w.find(":focus"),0<a.length&&a.trigger("click"))})},ub=function(b,c,d){r((k.sortname+" "+k.sortorder).split(","),function(){var c=a.trim(this).split(" ");2===c.length&&b.push(c[0])});if(null!=d){var e=a.inArray(d.index||d.name,b);
...
"#"+I(k.id)).each(function(){a(this).trigger("click")}),fa.call(this),k.lastsort=d,k.sortname!==b&&d&&(k.lastsort=d)):k.lastsort=d}},Fb=function(){var a=0,b=v.cell_width?0:N(k.cellLayout,0),c=0,d,e=N(k.scrollOffset,0),f,g=!1,h,l=0,m,n=v.isCellClassHidden;r(k.colModel,function(){void 0===this.hidden&&(this.hidden=!1);if(k.grouping&&k.autowidth){var d=p(this.name,k.groupingView.groupField);0<=d&&k.groupingView.groupColumnShow.length>d&&(this.hidden=!k.groupingView.groupColumnShow[d])}this.widthOrg=
...
c)-e):g||1===Math.abs(z.width-l-(a+b*c))||(m=z.width-l-(a+b*c)),k.colModel[d].width+=m,k.tblwidth=a+m+b*c+l,k.tblwidth>k.width&&(k.colModel[d].width-=k.tblwidth-parseInt(k.width,10),k.tblwidth=k.width))},Gb=function(a){var b=a,c;for(c=a+1;c<k.colModel.length;c++)if(!0!==k.colModel[c].hidden){b=c;break}return b-a},fb;-1===p(k.multikey,["shiftKey","altKey","ctrlKey"])&&(k.multikey=!1);k.keyName=!1;k.sortorder=k.sortorder.toLowerCase();v.cell_width=v.cellWidth();var kb=v.cmTemplate,Z,la;for(Z=0;Z<k.colModel.length;Z++)R=
k.colModel[Z],fb="string"===typeof R.template?null==kb||"object"!==typeof kb[R.template]&&!a.isFunction(kb[R.template])?{}:kb[R.template]:R.template,m(fb)&&(fb=fb.call(d,{cm:R,iCol:Z})),R=n(!0,{},k.cmTemplate,fb||{},R),!1===k.keyName&&!0===R.key&&(k.keyName=R.name),k.colModel[Z]=R;for(Z=0;Z<k.additionalProperties.length;Z++)R=k.additionalProperties[Z],!1===k.keyName&&!0===R.key&&(k.keyName=R.name);if(0===k.colNames.length)for(Z=0;Z<k.colModel.length;Z++)k.colNames[Z]=void 0!==k.colModel[Z].label?
...
cell:"cell"}},k.localReader);k.scroll&&(k.pgbuttons=!1,k.pginput=!1,k.rowList=[]);if(!0===k.treeGrid){try{c.setTreeGrid.call(h)}catch(tb){}"local"!==k.datatype&&(k.localReader={id:"_id_"});k.iPropByName=J(k.additionalProperties)}L();D();k.data.length&&(ya.call(d),mb());if(!0===k.shrinkToFit&&!0===k.forceFit)for(Z=k.colModel.length-1;0<=Z;Z--)if(!0!==k.colModel[Z].hidden){k.colModel[Z].resizable=!1;break}var da,ea,S,ga,R,ta,ja,ma,qa=[],Da=[],ka=[],ia="<thead><tr class='ui-jqgrid-labels' role='row'>",
Aa,ua="<tbody><tr>",ra=F("states.hover"),sa=F("states.disabled");if(k.multiSort){var qa=k.sortname.split(","),wa;for(wa=0;wa<qa.length;wa++)ka=q(qa[wa]).split(" "),qa[wa]=q(ka[0]),Da[wa]=ka[1]?q(ka[1]):k.sortorder||"asc"}for(Z=0;Z<k.colNames.length;Z++){R=k.colModel[Z];ta=k.headertitles||R.headerTitle?" title='"+ib("string"===typeof R.headerTitle?R.headerTitle:k.colNames[Z])+"'":"";ia+="<th id='"+k.id+"_"+R.name+"' class='"+F("colHeaders","ui-th-column ui-th-"+la+" "+(R.labelClasses||""))+"'"+ta+
">";da=R.index||R.name;switch(R.labelAlign){case "left":ja="text-align:left;";break;case "right":ja="text-align:right;"+(!1===R.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;");break;case "likeData":ja=void 0===R.align||"left"===R.align?"text-align:left;":"right"===R.align?"text-align:right;"+(!1===R.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;"):"";break;default:ja=""}ia+="<div id='jqgh_"+k.id+"_"+R.name+"'"+(U?" class='ui-th-div-ie'":
"")+(""===ja?"":" style='"+ja+"'")+">";Aa=R.autoResizable&&"actions"!==R.formatter?"<span class='"+k.autoResizing.wrapperClassName+"'>"+k.colNames[Z]+"</span>":k.colNames[Z];k.sortIconsBeforeText?(ia+=(k.builderSortIcons||v.builderSortIcons).call(d,Z),ia+=Aa):(ia+=Aa,ia+=(k.builderSortIcons||v.builderSortIcons).call(d,Z));ia+="</div></th>";ua+="<td></td>";R.width=R.width?parseInt(R.width,10):150;"boolean"!==typeof R.title&&(R.title=!0);R.lso="";da===k.sortname&&(k.lastsort=Z,R.lso=k.sortorder||R.firstsortorder||
"asc");k.multiSort&&(ka=p(da,qa),-1!==ka&&(R.lso=Da[ka]))}var ia=ia+"</tr></thead>",ua=ua+"</tr></tbody>",xa=a("<table class='"+F("hTable","ui-jqgrid-htable")+"' style='width:1px' role='presentation' aria-labelledby='gbox_"+k.id+"'"+(Ba?" cellspacing='0'":"")+">"+ia+ua+"</table>");a(xa[0].tHead).children("tr").children("th").hover(function(){a(this).addClass(ra)},function(){a(this).removeClass(ra)});k.multiselect&&a(k.cb,xa).bind("click",function(){var b=F("states.select"),c,e=[],f=k.iColByName.cb,
...
!0);c.resizable?(S=document.createElement("span"),a(S).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+la).bind("selectstart",function(){return!1}),e.addClass(k.resizeclass)):S="";e.css("width",ea+"px").prepend(S);S=null;var l="";!0===c.hidden&&(e.css("display","none"),l="display:none;");za+="<td role='gridcell' "+(c.classes?"class='"+c.classes+"' ":"")+"style='height:0;width:"+ea+"px;"+l+"'></td>";z.headers[b]={width:ea,el:this};ga=c.sortable;"boolean"!==typeof ga&&(ga=c.sortable=!0);
...
U="edit");if(!u.recreateForm){var ya=t.data("formProp");ya&&(ya.top=Math.max(ya.top,0),ya.left=Math.max(ya.left,0),a.extend(u,ya))}ya=!0;!u.checkOnUpdate||!0!==u.jqModal&&void 0!==u.jqModal||u.modal||(ya=!1);var W=isNaN(u.dataheight)?u.dataheight:u.dataheight+"px",V=isNaN(u.datawidth)?u.datawidth:u.datawidth+"px",B=a("<form name='FormPost' id='"+B+"' class='FormGrid' onSubmit='return false;' style='width:"+V+";overflow:auto;position:relative;height:"+W+";'></form>").data("disabled",!1),S=a("<table id='"+
F+"' class='EditTable'"+(v.msie&&8>v.msiever()?" cellspacing='0'":"")+"><tbody></tbody></table>");a(O).each(function(){var a=this.formoptions;ha=Math.max(ha,a?a.colpos||0:0);N=Math.max(N,a?a.rowpos||0:0)});a(B).append(S);M=a("<tr id='FormError' style='display:none'><td class='"+M+"' colspan='"+2*ha+"'>&#160;</td></tr>");M[0].rp=0;a(S).append(M);M=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*ha+"'>"+(u.topinfo||"&#160;")+"</td></tr>");M[0].rp=0;a(S).append(M);if(L("beforeInitData",
B,U)){n();W=(M="rtl"===w.direction?!0:!1)?"nData":"pData";V=M?"pData":"nData";d(b,S,ha);var W=ea.call(r,W,"",oa(Ba,u.prevIcon),"","left"),V=ea.call(r,V,"",oa(Ba,u.nextIcon),"","right"),ab=ea.call(r,"sData",u.bSubmit),Fa=ea.call(r,"cData",u.bCancel),F="<table"+(v.msie&&8>v.msiever()?" cellspacing='0'":"")+" class='EditTable' id='"+F+"_2'><tbody><tr><td colspan='2'><hr class='"+aa.call(r,"dialog.hr")+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton navButton-"+w.direction+
"'>"+(M?V+W:W+V)+"</td><td class='EditButton EditButton-"+w.direction+"'>"+ab+"&#160;"+Fa+"</td></tr>",F=F+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+(u.bottominfo||"&#160;")+"</td></tr>"),F=F+"</tbody></table>";if(0<N){var db=[];a.each(a(S)[0].rows,function(a,b){db[a]=b});db.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(db,function(b,c){a("tbody",S).append(c)})}u.gbox=K;var eb=!1;!0===u.closeOnEscape&&(u.closeOnEscape=!1,eb=!0);F=a("<div></div>").append(B).append(F);
...
a.fn[b].apply(c,a.makeArray(arguments).slice(2)):a.isFunction(b)&&b.apply(c,a.makeArray(arguments).slice(2)))}var e=this,d=e[0].p,f,g,h={},m=[],l,n,p=d.colModel;l=p.length;n=d.colNames;var q=function(a){return S&&S.prototype&&a.data(S.prototype.widgetFullName||S.prototype.widgetName)||a.data("ui-multiselect")||a.data("multiselect")};if(!a("#colchooser_"+I(d.id)).length){f=a('<div id="colchooser_'+d.id+'" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>');
...
e.jqGrid("getGridRes","col"),v.col,b||{});if(a.ui&&S&&S.defaults){if(!v._multiselect){alert("Multiselect plugin loaded after jqGrid. Please load the plugin before the jqGrid!");return}b.msel_opts=a.extend(S.defaults,b.msel_opts)}b.caption&&f.attr("title",b.caption);b.classname&&(f.addClass(b.classname),g.addClass(b.classname));b.width&&(a(">div",f).css({width:b.width,margin:"0 auto"}),g.css("width",b.width));b.height&&(a(">div",f).css("height",b.height),g.css("height",b.height-10));g.empty();var r=
...
data:b},c||{}),l,n,p,q=b.length,r,t,w,x,y,A,u=m.xDimension,E=m.yDimension,B=m.aggregates,F,q=m.totalText||m.totals||m.rowTotals||m.totalHeader,k,C=d(u)?u.length:0;x=d(E)?E.length:0;var D=d(B)?B.length:0,G=x-(1===D?1:0),K=[],J=[],I=[],d=[],M=Array(D),Q=Array(x),N,z,P,U,V,X,L,Y,T,W,S;n=function(c,d,e){c=new ma(m.trimByCollect,m.caseSensitive,d,c);a.isFunction(e)&&(c.compareVectorsEx=e);c.createDataIndex(b);return c};var ba=function(b,c,d,f,g){var h,k;switch(b){case 1:h=E[f].totalText||"{0} {1} {2}";
k="y"+g+"t"+f;break;case 2:h=m.totalText||"{0}";k="t";break;default:h=1<D?c.label||"{0}":S.getItem(g)[f],k="y"+g}b=a.extend({},c,{name:k+(1<D?"a"+d:""),label:a.isFunction(h)?h.call(e,2===b?{aggregate:c,iAggregate:d,pivotOptions:m}:{yIndex:S.getItem(g),aggregate:c,iAggregate:d,yLevel:f,pivotOptions:m}):v.template.apply(e,2===b?[h,c.aggregator,c.member,d]:[h,c.aggregator,c.member,S.getItem(g)[f],f])});delete b.member;delete b.aggregator;return b};y=function(a,b,c){var d,e;for(d=0;d<D;d++)e=B[d],void 0===
