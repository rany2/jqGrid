...
{},e=(v.formatter||{}).date||{},k=null==a||null==a.locale?{}:((Fa[a.locale]||{}).formatter||{}).date,f,g=c.length,h={},l;for(f=0;f<g;f++)l=c[f],void 0!==d[l]?h[l]=d[l]:void 0!==e[l]?h[l]=e[l]:void 0!==k[l]&&(h[l]=k[l]);return h}(this.p,d);void 0===d.parseRe&&(d.parseRe=/[#%\\\/:_;.,\t\s\-]/);d.masks.hasOwnProperty(b)&&(b=d.masks[b]);if(c&&null!=c)if(isNaN(c)||"u"!==String(b).toLowerCase())if(isNaN(c)||"u1000"!==String(b).toLowerCase())if(c.constructor===Date)m=c;else if(null!==f)m=new Date(parseInt(f[1],
...
void 0!==document.documentMode&&5>=document.documentMode)x("Grid can not be used in this ('quirks') mode!");else{h.empty().attr("tabindex","0");d.p=k;k.id=d.id;k.idSel="#"+H(d.id);k.gBoxId=hb.call(d,0);k.gBox=gb.call(d,0);k.gViewId=hb.call(d,8);k.gView=gb.call(d,8);k.rsId=hb.call(d,43);k.rs=gb.call(d,43);k.cbId=hb.call(d,45);k.cb=gb.call(d,45);k.useProp=!!a.fn.prop;k.propOrAttr=k.useProp?"prop":"attr";var I=k.propOrAttr,G=v.fixScrollOffsetAndhBoxPadding,J=function(a){var b={},c,d=a.length;for(c=0;c<
d;c++)b[a[c].name]=c;return b},K=function(a){var b={},c,d=a.length,e;for(c=0;c<d;c++)e=a[c],b["string"===typeof e?e:e.name]=c;return b},O=function(){var b={},c,d;this.p.rowIndexes=b;for(d=0;d<this.rows.length;d++)c=this.rows[d],a(c).hasClass("jqgrow")&&(b[c.id]=c.rowIndex)},D=function(){var b,c=k.colModel;b=k.cmNamesInputOrder;var d=k.additionalProperties,e=b.length,f,g,h,l;k.arrayReaderInfos={};f=k.arrayReaderInfos;for(l=0;l<e;l++)g=b[l],0>p(g,k.reservedColumnNames)&&!f.hasOwnProperty(g)&&(h=k.iColByName[g],
void 0!==h?f[g]={name:c[h].name,index:h,order:l,type:0}:(h=k.iPropByName[g],void 0!==h?f[g]={name:c[h].name,index:h,order:l,type:1}:g===(k.prmNames.rowidName||"rowid")&&(f[g]={index:h,type:2})));e=c.length;for(b=0;b<e;b++)g=c[b].name,0>p(g,k.reservedColumnNames)&&!f.hasOwnProperty(g)&&(f[g]={name:g,index:b,order:l,type:0},l++);e=d.length;for(b=0;b<e;b++)g=d[b],null==g||f.hasOwnProperty(g)||("object"===typeof g&&"string"===a.type(g.name)&&(g=g.name),f[g]={name:g,index:b,order:l,type:1},l++)},ha=function(b){var c=
a(this).data("pageX");c?(c=String(c).split(";"),c=c[c.length-1],a(this).data("pageX",c+";"+b.pageX)):a(this).data("pageX",b.pageX)},N=function(a,b){a=parseInt(a,10);return isNaN(a)?b||0:a},z={headers:[],cols:[],footers:[],dragStart:function(b,c,d,e){var f=a(this.bDiv),g=f.closest(k.gBox).offset();e=e.offset().left+("rtl"===k.direction?0:this.headers[b].width+(v.cell_width?0:N(k.cellLayout,0))-2);this.resizing={idx:b,startX:e,sOL:e,moved:!1,delta:e-c.pageX};this.curGbox=a(k.rs);this.curGbox.prependTo("body");
this.curGbox.css({display:"block",left:e,top:d[1]+g.top+1,height:d[2]});this.curGbox.css("height",d[2]-(this.curGbox.outerHeight()-this.curGbox.height())+"px");this.curGbox.data("idx",b);this.curGbox.data("delta",e-c.pageX);ha.call(this.curGbox,c);Q.call(Ga(21,f)[0],"resizeStart",c,b);document.onselectstart=function(){return!1};a(document).bind("mousemove.jqGrid",function(a){if(z.resizing)return z.dragMove(a),!1}).bind("mouseup.jqGrid"+k.id,function(){if(z.resizing)return z.dragEnd(),!1})},dragMove:function(b){var c=
...
resizeColumn:function(b,d,e){var f=this.headers,g=this.footers,h=f[b],l=h.newWidth||h.width,m=Ga(21,this.bDiv),n=Ga(14,this.hDiv).children("thead").children("tr").first()[0].cells,l=parseInt(l,10);k.colModel[b].width=l;h.width=l;n[b].style.width=l+"px";this.cols[b].style.width=l+"px";this.fbRows&&(a(this.fbRows[0].cells[b]).css("width",l),a(Ga(31,this.fhDiv)[0].rows[0].cells[b]).css("width",l),k.footerrow&&a(Ga(36,this.fsDiv)[0].rows[0].cells[b]).css("width",l));0<g.length&&(g[b].style.width=l+"px");
!0!==e&&G.call(m[0]);!0===k.forceFit?(f=f[b+k.nv],l=f.newWidth||f.width,f.width=l,n[b+k.nv].style.width=l+"px",this.cols[b+k.nv].style.width=l+"px",0<g.length&&(g[b+k.nv].style.width=l+"px"),k.colModel[b+k.nv].width=l):(k.tblwidth=this.newWidth||k.tblwidth,!0!==e&&(this.hDiv.scrollLeft=this.bDiv.scrollLeft,k.footerrow&&(Ga(27,this.sDiv).css("width",k.tblwidth+"px"),this.sDiv.scrollLeft=this.bDiv.scrollLeft)));k.autowidth||void 0!==k.widthOrg&&"auto"!==k.widthOrg&&"100%"!==k.widthOrg||!0===e||c.setGridWidth.call(m,
...
if(k.multiselect&&d&&0<d.length)for(a=0;a<d.length;a++)d[a]!==c&&t.call(b,d[a],!1,null);c&&t.call(b,c,!1,null)}e.scrollLeft=f;b.unbind(".selectionPreserver",g)};b.bind("jqGridGridComplete.selectionPreserver",g)}};d.grid=z;Q.call(d,"beforeInitGrid");k.iColByName=J(k.colModel);k.iPropByName=K(k.additionalProperties);var P=a("<div class='ui-jqgrid-view' role='grid' aria-multiselectable='"+!!k.multiselect+"'></div>"),U=v.msie,Aa=U&&8>v.msiever();k.direction=q(k.direction.toLowerCase());-1===p(k.direction,
["ltr","rtl"])&&(k.direction="ltr");oa=k.direction;a(P).insertBefore(d);h.removeClass("scroll").appendTo(P);var X=a("<div class='"+F("gBox","ui-jqgrid")+"'></div>");a(X).attr({id:k.gBoxId,dir:oa}).insertBefore(P);a(P).attr("id",k.gViewId).appendTo(X);a("<div class='"+F("overlay","jqgrid-overlay")+"' id='lui_"+k.id+"'></div>").insertBefore(P);a("<div class='"+F("loading","loading")+"' id='load_"+k.id+"'>"+C("loadtext")+"</div>").insertBefore(P);Aa&&h.attr({cellspacing:"0"});h.attr({role:"presentation",
...
c="<div class='tree-wrap' style='width:"+18*(b+1)+"px;'><div class='"+na(k.treeIcons.commonIconClass,e?(null!=h&&""!==h?h:k.treeIcons.leaf)+" tree-leaf":g?k.treeIcons.minus+" tree-minus":k.treeIcons.plus+" tree-plus","treeclick")+"' style='"+(!0===k.ExpandColClick?"cursor:pointer;":"")+("rtl"===k.direction?"margin-right:":"margin-left:")+18*b+"px;'></div></div><span class='cell-wrapper"+(e?"leaf":"")+"'"+(k.ExpandColClick?" style='cursor:pointer;'":"")+">"+c+"</span>");return c},M=function(b,c){var d=
...
display:"none"}),0!==d.scrollTop&&(d.scrollTop=0));!0===c&&k.treeGrid&&(V(k.data),V(k.lastSelectedData),k._index={});k.rowIndexes={};k.iRow=-1;k.iCol=-1},xa=function(){var a=k.data,b=a.length,c,e,f,g,h,p,r,q=k.localReader,t=k.additionalProperties,u=q.cell,w,v,x,z=k.arrayReaderInfos;if("local"!==k.datatype||!0!==q.repeatitems){if(k.treeGrid)for(c=0;c<b;c++)$a(a[c])}else for(g=!1===k.keyName?m(q.id)?q.id.call(d,a):q.id:k.keyName,isNaN(g)?m(g)||null==k.arrayReaderInfos[g]||(h=k.arrayReaderInfos[g].order):
h=Number(g),c=0;c<b;c++){e=a[c];f=u?ma(e,u)||e:e;v=l(f);r={};for(w in z)z.hasOwnProperty(w)&&(x=z[w],p=ma(f,v?x.order:x.name),1===x.type&&(x=t[x.index],null!=x&&m(x.convert)&&(p=x.convert(p,f))),void 0!==p&&(r[w]=p));void 0!==r[g]?e=void 0!==r[g]?r[g]:Ha():(e=ma(e,l(e)?h:g),void 0===e&&(e=ma(f,l(f)?h:g)),void 0===e&&(e=Ha()));e=String(e);r[q.id]=e;k.treeGrid&&$a(r);n(a[c],r)}},mb=function(){var a=k.data.length,b,c,d;b=!1===k.keyName||k.loadonce?k.localReader.id:k.keyName;k._index={};for(c=0;c<a;c++)d=
ma(k.data[c],b),void 0===d&&(d=String(c+1)),k._index[d]=c},ba=function(b,d,e,f,g,h){var l="-1",n="",p,r=d?"display:none;":"";e=F("gridRow","jqgrow ui-row-"+k.direction)+(e?" "+e:"")+(h?" "+F("states.select"):"");h=a(this).triggerHandler("jqGridRowAttr",[f,g,b]);"object"!==typeof h&&(h=m(k.rowattr)?k.rowattr.call(this,f,g,b):"string"===typeof k.rowattr&&null!=v.rowattr&&m(v.rowattr[k.rowattr])?v.rowattr[k.rowattr].call(this,f,g,b):{});if(null!=h&&!a.isEmptyObject(h)){h.hasOwnProperty("id")&&(b=h.id,
...
(l={colModel:f,gid:k.id,pos:e},void 0===f.formatter?f.cellBuilder=k.autoencode?n:p:"string"===typeof f.formatter&&null!=a.fn.fmatter&&m(a.fn.fmatter.getCellBuilder)?f.cellBuilder=a.fn.fmatter.getCellBuilder.call(d,f.formatter,l,c||"add"):m(f.getCellBuilder)&&(f.cellBuilder=f.getCellBuilder.call(d,l,c||"add")))},Ea=function(b,d,e,f){var g=a(this),h=new Date,n=k.datatype,p="local"!==n&&k.loadonce||"xmlstring"===n||"jsonstring"===n,r=("xmlstring"===n||"xml"===n)&&a.isXMLDoc(b),q=k.localReader,t=ma;if(b&&
("xml"!==n||r)){-1!==k.treeANode||k.scroll?d=1<d?d:1:(z.emptyRows.call(this,!1,!0),d=1);p&&(V(k.data),V(k.lastSelectedData),k._index={},k.grouping&&null!=k.groupingView&&(k.groupingView.groups=[],k.groupingView._locgr=!1),k.localReader.id="_id_");k.reccount=0;switch(n){case "xml":case "xmlstring":q=k.xmlReader;t=v.getXmlData;break;case "json":case "jsonp":case "jsonstring":q=k.jsonReader}var u,w,x,C,E,y={},I,B=k.colModel,G=B.length,A,F,J,Oa,K,P=k.arrayReaderInfos,ha={},D=function(a){return function(b){b=
b.getAttribute(a);return null!==b?b:void 0}},Pa=function(a){return function(){var b=ha[a];if(null!=b)return b=b.childNodes,0<b.length?b[0].nodeValue:void 0}};k.page=N(t(b,q.page),k.page);k.lastpage=N(t(b,q.total),1);k.records=N(t(b,q.records));m(q.userdata)?k.userData=q.userdata.call(this,b)||{}:r?t(b,q.userdata,!0).each(function(){k.userData[this.getAttribute("name")]=a(this).text()}):k.userData=t(b,q.userdata)||{};ab();var U={},Ia=k.additionalProperties,H=function(a,b){r&&"string"===typeof b&&(/^\w+$/.test(b)?
U[a]=Pa(b):/^\[\w+\]$/.test(b)&&(U[a]=D(b.substring(1,b.length-1))))},fa=function(a){var b=a.name,c=r?a.xmlmap||b:"local"===n&&!k.dataTypeOrg||"json"===n||"jsonp"===n?a.jsonmap||b:b;!1!==k.keyName&&!0===a.key&&(k.keyName=b);if("string"===typeof c||m(c))U[b]=c;m(c)||H(b,c)};for(u=0;u<G;u++)fa(B[u]);G=Ia.length;for(u=0;u<G;u++)F=Ia[u],"object"===typeof F&&null!=F?fa(F):H(F,F);C=!1===k.keyName?m(q.id)?q.id.call(this,b):q.id:k.keyName;isNaN(C)?m(C)||(P[C]&&(E=P[C].order),r&&("string"===typeof C&&/^\[\w+\]$/.test(C)?
C=D(C.substring(1,C.length-1)):"string"===typeof C&&/^\w+$/.test(C)&&(C=Pa(C)))):E=Number(C);x=t(b,q.root,!0);if(q.row)if(1===x.length&&"string"===typeof q.row&&/^\w+$/.test(q.row)){G=[];J=x[0].childNodes;Oa=J.length;for(F=0;F<Oa;F++)K=J[F],1===K.nodeType&&K.nodeName===q.row&&G.push(K);x=G}else x=t(x,q.row,!0);null==x&&l(b)&&(x=b);x||(x=[]);b=x.length;0<b&&0>=k.page&&(k.page=1);fa=parseInt(k.rowNum,10);f&&(fa*=f+1);var B=[],Za=[],L,G=[];for(u=0;u<b;u++){L=x[u];w=q.repeatitems&&q.cell?t(L,q.cell,!0)||
L:L;I=q.repeatitems&&(r||l(w));y={};ha={};if(r&&!I&&null!=w)for(J=w.childNodes,Oa=J.length,F=0;F<Oa;F++)K=J[F],1===K.nodeType&&(ha[K.nodeName]=K);for(A in P)P.hasOwnProperty(A)&&(F=P[A],I?(J=w[F.order],r&&null!=J&&(J=J.textContent||J.text)):J=null!=U[A]&&"string"!==typeof U[A]?U[A](w):t(w,"string"===typeof U[A]?U[A]:F.name),1===F.type&&(F=Ia[F.index],null!=F&&m(F.convert)&&(J=F.convert(J,w))),void 0!==J&&(y[A]=J));void 0!==y[C]?L=void 0!==y[C]?y[C]:Ha():(L=t(L,l(L)?E:C),void 0===L&&(L=t(w,l(w)?E:
C)),void 0===L&&(L=Ha()));L=String(L);I=k.idPrefix+L;k.treeGrid&&$a(y);if(u<fa)Za.push(I),B.push(w),G.push(y);else if(!p)break;if(p||!0===k.treeGrid)y._id_=L,k.data.push(y),k._index[y._id_]=k.data.length-1}if(!p||!k.forceClientSorting||!0===k.treeGrid){d=v.parseDataToHtml.call(this,b,Za,G,B,d,f,p);ab(!0);f=-1<k.treeANode?k.treeANode:0;q=a(this.tBodies[0]);!0===k.treeGrid&&0<f?a(this.rows[f]).after(d.join("")):k.scroll?q.append(d.join("")):(null==this.firstElementChild||void 0!==document.documentMode&&
9>=document.documentMode?q.html(q.html()+d.join("")):this.firstElementChild.innerHTML+=d.join(""),this.grid.cols=this.rows[0].cells);k.grouping&&O.call(this);if(!0===k.subGrid)try{c.addSubGrid.call(g,k.iColByName.subgrid)}catch(T){}if(!1===k.gridview||m(k.afterInsertRow))for(u=0;u<Math.min(b,fa);u++)Q.call(this,"afterInsertRow",Za[u],G[u],B[u]);k.totaltime=new Date-h;0<u&&0===k.records&&(k.records=b);V(d);if(!0===k.treeGrid)try{c.setTreeNode.call(g,f+1,u+f+1)}catch(T){}k.reccount=Math.min(b,fa);k.treeANode=
...
a.rules[d],g=a.groupOp.toString().toUpperCase(),I[h.op]&&h.field?(0<c&&g&&"OR"===g&&(G=G.or()),p=n[h.field],l=p.reader,G=I[h.op](G,g)(m(l)?'jQuery.jgrid.getAccessor(this,jQuery("'+k.idSel+'")[0].p.colModel['+p.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+l+"')",h.data,n[h.field])):null!=k.customSortOperations&&null!=k.customSortOperations[h.op]&&m(k.customSortOperations[h.op].filter)&&(G=G.custom(h.op,h.field,h.data)),c++;f&&G.orEnd()}catch(q){x(q)}}var d=a(this),e=k.multiSort?[]:"",f={},g=
...
a.andNot().startsWith},en:function(a,b){return"OR"===b?a.orNot().endsWith:a.andNot().endsWith},ew:function(a){return a.endsWith},ni:function(a,b){return"OR"===b?a.orNot().equals:a.andNot().equals},"in":function(a){return a.equals},nu:function(a){return a.isNull},nn:function(a,b){return"OR"===b?a.orNot().isNull:a.andNot().isNull}},G=v.from.call(this,k.data);k.ignoreCase&&(G=G.ignoreCase());if(!0===k.search){var B=k.postData.filters;if(B)"string"===typeof B&&(B=v.parse(B)),b(B);else try{G=I[k.postData.searchOper](G)(k.postData.searchField,
k.postData.searchString,n[k.postData.searchField])}catch(A){}}if(k.grouping)for(y=0;y<z;y++)G.orderBy(q[y],C.groupOrder[y],p[y].stype,p[y].srcfmt);k.multiSort?r(e,function(){G.orderBy(this,f[this],n[this].stype,n[this].srcfmt,n[this].sfunc)}):e&&k.sortorder&&g&&G.orderBy(k.sortname,"DESC"===k.sortorder.toUpperCase()?"d":"a",n[e].stype,n[e].srcfmt,n[e].sfunc);k.lastSelectedData=G.select();var B=parseInt(k.rowNum,10),F=k.lastSelectedData.length,J=parseInt(k.page,10),Oa=Math.ceil(F/B),K={};if(k.grouping&&
k.groupingView._locgr){k.groupingView.groups=[];var O,P,N;if(k.footerrow&&k.userDataOnFooter){for(P in k.userData)k.userData.hasOwnProperty(P)&&(k.userData[P]=0);N=!0}for(O=0;O<F;O++){if(N)for(P in k.userData)k.userData.hasOwnProperty(P)&&(k.userData[P]+=parseFloat(k.lastSelectedData[O][P]||0));c.groupingPrepare.call(d,k.lastSelectedData[O],O,B)}}n=G=null;d=k.localReader;K[d.total]=Oa;K[d.page]=J;K[d.records]=F;K[d.root]=k.lastSelectedData.slice((J-1)*B,J*B);K[d.userdata]=k.userData;return K},eb=
function(b){var c=b.outerWidth();0>=c&&(c=a(this).closest(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px",a(document.body).append("<div id='testpg' class='"+F("gBox","ui-jqgrid")+"' style='font-size:"+c+";visibility:hidden;margin:0;padding:0;' ></div>"),a(b).clone().appendTo("#testpg"),c=a("#testpg>.ui-pg-table").width(),a("#testpg").remove());0<c&&b.parent().width(c);return c},Oa=function(b,c){var d=this,e=a(d),f=d.grid,g,l,m,n,p,q,r=k.pager||"",t=k.pager?"_"+k.pager.substr(1):"";g=f.bDiv;
var u=a.fmatter?a.fmatter.NumberFormat:null,x=k.toppager?"_"+k.toppager.substr(1):"",z=F("states.hover"),y=F("states.disabled");l=parseInt(k.page,10)-1;0>l&&(l=0);l*=parseInt(k.rowNum,10);n=l+k.reccount;if(k.scroll){q=a(Ga(21,g)[0].rows).slice(1);l=n-q.length;k.reccount=q.length;if(q=q.outerHeight()||f.prevRowHeight)m=l*q,p=v.fixMaxHeightOfDiv.call(d,parseInt(k.records,10)*q),a(g).children("div").first().css({height:p+"px"}).children("div").first().css({height:m+"px",display:m+"px"?"":"none"}),0===
g.scrollTop&&1<k.page&&(g.scrollTop=k.rowNum*(k.page-1)*q);g.scrollLeft=f.hDiv.scrollLeft}if(r+=k.toppager?(r?",":"")+k.toppager:"")q=w.call(h,"formatter.integer")||{},f=N(k.page),g=N(k.lastpage),a(".selbox",r)[I]("disabled",!1),!0===k.pginput&&(a(".ui-pg-input",r).val(k.page),m=k.toppager?"#sp_1"+t+",#sp_1"+x:"#sp_1"+t,a(m).html(a.fmatter?u(k.lastpage,q):k.lastpage).closest(".ui-pg-table").each(function(){eb.call(d,a(this))})),k.viewrecords&&(0===k.reccount?a(".ui-paging-info",r).html(C("emptyrecords")):
...
(l[q.order]=k.sortorder);null!==k.rowTotal&&null!==q.totalrows&&(l[q.totalrows]=k.rowTotal);var r=m(k.loadComplete),t=r?k.loadComplete:null,u=0;b=b||1;1<b?null!==q.npage?(l[q.npage]=b,u=b-1,b=1):t=function(a){k.page++;g.hDiv.loading=!1;r&&k.loadComplete.call(e,a);fa.call(e,b-1)}:null!==q.npage&&delete k.postData[q.npage];if(k.grouping&&c.groupingSetup){c.groupingSetup.call(f);var x=k.groupingView,w,C="",z,y,E;for(w=0;w<x.groupField.length;w++){z=x.groupField[w];for(y=0;y<k.colModel.length;y++)E=k.colModel[y],
E.name===z&&E.index&&(z=E.index);C+=z+" "+x.groupOrder[w]+", "}l[q.sort]=C+l[q.sort]}n(k.postData,l);var I=k.scroll?e.rows.length-1:1,B=function(){G.call(e);var a=f.width(),b=f.closest(".ui-jqgrid-view").width(),d=f.css("height");b<a&&0===k.reccount?f.css("height","1px"):"0"!==d&&"0px"!==d&&f.css("height","");k.autowidth||void 0!==k.widthOrg&&"auto"!==k.widthOrg&&"100%"!==k.widthOrg||c.setGridWidth.call(f,k.tblwidth+k.scrollOffset,!1)},F=function(){var a;if(k.autoresizeOnLoad)c.autoResizeAllColumns.call(f);
else for(a=0;a<k.columnsToReResizing.length;a++)c.autoResizeColumn.call(f,k.columnsToReResizing[a]);V(k.columnsToReResizing)},q=function(){Q.call(e,"loadComplete",p);F();f.triggerHandler("jqGridAfterLoadComplete",[p]);Ia.call(e);k.datatype="local";k.datastr=null;B()},A=function(a){f.triggerHandler("jqGridLoadComplete",[a]);t&&t.call(e,a);F();f.triggerHandler("jqGridAfterLoadComplete",[a]);h&&g.populateVisible.call(e);1===b&&Ia.call(e);B()},J=function(){var a=db.call(e);Ea.call(e,a,I,1<b,u);A(a)};
if(Q.call(e,"beforeRequest"))if(m(k.datatype))k.datatype.call(e,k.postData,"load_"+k.id,I,b,u);else switch(l=k.datatype.toLowerCase(),l){case "json":case "jsonp":case "xml":case "script":a.ajax(n({url:k.url,type:k.mtype,dataType:l,data:v.serializeFeedback.call(d,k.serializeGridData,"jqGridSerializeGridData",k.postData),success:function(a,c,d){k.jqXhr=null;if(m(k.beforeProcessing)&&!1===k.beforeProcessing.call(e,a,c,d))Ia.call(e);else if(Ea.call(e,a,I,1<b,u),A(a),k.loadonce||k.treeGrid)k.dataTypeOrg=
k.datatype,k.datatype="local",k.forceClientSorting&&J()},error:function(a,c,d){k.jqXhr=null;m(k.loadError)&&k.loadError.call(e,a,c,d);1===b&&Ia.call(e)},beforeSend:function(a,b){var c=!0;m(k.loadBeforeSend)&&(c=k.loadBeforeSend.call(e,a,b));void 0===c&&(c=!0);if(!1===c)return!1;k.jqXhr=a;Pa.call(e)}},v.ajaxOptions,k.ajaxGridOptions));break;case "xmlstring":Pa.call(e);p="string"===typeof k.datastr?a.parseXML(k.datastr):k.datastr;Ea.call(e,p);q();k.forceClientSorting&&J();break;case "jsonstring":Pa.call(e);
p="string"===typeof k.datastr?v.parse(k.datastr):k.datastr;Ea.call(e,p);q();k.forceClientSorting&&J();break;case "local":case "clientside":Pa.call(e),k.datatype="local",J()}}},jb=function(b){var c=this.grid;a(k.cb,c.hDiv)[k.propOrAttr]("checked",b);if(k.frozenColumns)a(k.cb,c.fhDiv)[k.propOrAttr]("checked",b)},vb=function(b,c){var e=F("states.hover"),f=F("states.disabled"),g="<td class='ui-pg-button "+f+"'><span class='ui-separator'></span></td>",h="",l="<table "+(Aa?"cellspacing='0' ":"")+"style='table-layout:auto;white-space: pre;"+
...
n+"' class='ui-pager-control' role='group'><table "+(Aa?"cellspacing='0' ":"")+"class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;'><tbody><tr><td id='"+p+"' style='text-align:left;'></td><td id='"+q+"' style='text-align:center;white-space:pre;'></td><td id='"+r+"' style='text-align:right;'></td></tr></tbody></table></div>").attr("dir","ltr");n="#"+H(n);if(0<k.rowList.length){m="<td dir='"+oa+"'>";p=C("pgrecs");m+="<select class='"+F("pagerSelect","ui-pg-selbox")+"' "+(p?"title='"+
p+"'":"")+">";for(p=0;p<k.rowList.length;p++)q=k.rowList[p].toString().split(":"),1===q.length&&(q[1]=q[0]),m+="<option value='"+q[0]+"'"+(N(k.rowNum,0)===N(q[0],0)?" selected='selected'":"")+">"+q[1]+"</option>";m+="</select></td>"}"rtl"===oa&&(l+=m);!0===k.pginput&&(h="<td dir='"+oa+"'>"+v.format(C("pgtext")||"","<input class='"+F("pagerInput","ui-pg-input")+"' type='text' size='2' maxlength='7' value='0'/>","<span id='sp_1_"+b+"'>0</span>")+"</td>");b="#"+H(b);if(!0===k.pgbuttons){q=["first","prev",
"next","last"];var u=F("pagerButton","ui-pg-button");r=function(a){var b=C("pg"+a);return"<td role='button' tabindex='0' id='"+a+c+"' class='"+u+"' "+(b?"title='"+b+"'":"")+"><span class='"+B("pager."+a)+"'></span></td>"};"rtl"===oa&&q.reverse();for(p=0;p<q.length;p++)l+=r(q[p]),1===p&&(l+=""!==h?g+h+g:"")}else""!==h&&(l+=h);"ltr"===oa&&(l+=m);l+="</tr></tbody></table>";!0===k.viewrecords&&a("td"+b+"_"+k.recordpos,n).append("<span dir='"+oa+"' style='text-align:"+k.recordpos+"' class='ui-paging-info'></span>");
...
f)?this.style.cursor="default":(a(this).addClass(e),this.style.cursor="pointer")},function(){ca(this,f)||(a(this).removeClass(e),this.style.cursor="default")}),a("#first"+H(c)+", #prev"+H(c)+", #next"+H(c)+", #last"+H(c)).click(function(){if(ca(this,f))return!1;var a=N(k.page,1),b=a,e=this.id,g=N(k.lastpage,1),h=!1,l=!0,m=!0,n=!0,p=!0;0===g||1===g?(1>=a&&(m=l=!1),p=n=!1):1<g&&1<=a?1===a?m=l=!1:a===g&&(p=n=!1):1<g&&0===a&&(p=n=!1,a=g-1);this.id==="first"+c&&l&&(e="first",b=1,h=!0);this.id==="prev"+
...
k.multiPageSelection||(k.selrow=null,k.multiselect&&(jb.call(this,!1),V(k.selarrrow))),V(k.savedRow),k.scroll&&(m=h.bDiv.scrollLeft,z.emptyRows.call(this,!0,!1),h.hDiv.scrollLeft=m),k.subGrid&&"local"===k.datatype&&a("td.sgexpanded","#"+H(k.id)).each(function(){a(this).trigger("click")}),fa.call(this),k.lastsort=d,k.sortname!==b&&d&&(k.lastsort=d)):k.lastsort=d}},Fb=function(){var a=0,b=v.cell_width?0:N(k.cellLayout,0),c=0,d,e=N(k.scrollOffset,0),f,g=!1,h,l=0,m,n=v.isCellClassHidden;r(k.colModel,
...
c;break}return b-a},fb;-1===p(k.multikey,["shiftKey","altKey","ctrlKey"])&&(k.multikey=!1);k.keyName=!1;k.sortorder=k.sortorder.toLowerCase();v.cell_width=v.cellWidth();var kb=v.cmTemplate,Z,oa;for(Z=0;Z<k.colModel.length;Z++)S=k.colModel[Z],fb="string"===typeof S.template?null==kb||"object"!==typeof kb[S.template]&&!a.isFunction(kb[S.template])?{}:kb[S.template]:S.template,m(fb)&&(fb=fb.call(d,{cm:S,iCol:Z})),S=n(!0,{},k.cmTemplate,fb||{},S),!1===k.keyName&&!0===S.key&&(k.keyName=S.name),k.colModel[Z]=
...
k.cellLayout:k.rownumWidth,labelClasses:"jqgh_rn",sortable:!1,resizable:!1,hidedlg:!0,search:!1,align:"center",fixed:!0,frozen:!0}));k.iColByName=J(k.colModel);k.xmlReader=n(!0,{root:"rows",row:"row",page:"rows>page",total:"rows>total",records:"rows>records",repeatitems:!0,cell:"cell",id:"[id]",userdata:"userdata",subgrid:{root:"rows",row:"row",repeatitems:!0,cell:"cell"}},k.xmlReader);k.jsonReader=n(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!0,cell:"cell",id:"id",userdata:"userdata",
subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},k.jsonReader);k.localReader=n(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},k.localReader);k.scroll&&(k.pgbuttons=!1,k.pginput=!1,k.rowList=[]);if(!0===k.treeGrid){try{c.setTreeGrid.call(h)}catch(tb){}"local"!==k.datatype&&(k.localReader={id:"_id_"});k.iPropByName=K(k.additionalProperties)}L();D();k.data.length&&(xa.call(d),mb());
if(!0===k.shrinkToFit&&!0===k.forceFit)for(Z=k.colModel.length-1;0<=Z;Z--)if(!0!==k.colModel[Z].hidden){k.colModel[Z].resizable=!1;break}var da,ea,R,ga,S,ta,ja,la,qa=[],Ca=[],ka=[],ia="<thead><tr class='ui-jqgrid-labels' role='row'>",za,ua="<tbody><tr>",ra=F("states.hover"),sa=F("states.disabled");if(k.multiSort){var qa=k.sortname.split(","),va;for(va=0;va<qa.length;va++)ka=q(qa[va]).split(" "),qa[va]=q(ka[0]),Ca[va]=ka[1]?q(ka[1]):k.sortorder||"asc"}for(Z=0;Z<k.colNames.length;Z++){S=k.colModel[Z];
ta=k.headertitles||S.headerTitle?" title='"+ib("string"===typeof S.headerTitle?S.headerTitle:k.colNames[Z])+"'":"";ia+="<th id='"+k.id+"_"+S.name+"' class='"+F("colHeaders","ui-th-column ui-th-"+oa+" "+(S.labelClasses||""))+"'"+ta+">";da=S.index||S.name;switch(S.labelAlign){case "left":ja="text-align:left;";break;case "right":ja="text-align:right;"+(!1===S.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;");break;case "likeData":ja=void 0===S.align||"left"===S.align?"text-align:left;":
"right"===S.align?"text-align:right;"+(!1===S.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;"):"";break;default:ja=""}ia+="<div id='jqgh_"+k.id+"_"+S.name+"'"+(U?" class='ui-th-div-ie'":"")+(""===ja?"":" style='"+ja+"'")+">";za=S.autoResizable&&"actions"!==S.formatter?"<span class='"+k.autoResizing.wrapperClassName+"'>"+k.colNames[Z]+"</span>":k.colNames[Z];k.sortIconsBeforeText?(ia+=(k.builderSortIcons||v.builderSortIcons).call(d,Z),ia+=za):(ia+=za,ia+=(k.builderSortIcons||
v.builderSortIcons).call(d,Z));ia+="</div></th>";ua+="<td></td>";S.width=S.width?parseInt(S.width,10):150;"boolean"!==typeof S.title&&(S.title=!0);S.lso="";da===k.sortname&&(k.lastsort=Z,S.lso=k.sortorder||S.firstsortorder||"asc");k.multiSort&&(ka=p(da,qa),-1!==ka&&(S.lso=Ca[ka]))}var ia=ia+"</tr></thead>",ua=ua+"</tr></tbody>",wa=a("<table class='"+F("hTable","ui-jqgrid-htable")+"' style='width:1px' role='presentation' aria-labelledby='gbox_"+k.id+"'"+(Aa?" cellspacing='0'":"")+">"+ia+ua+"</table>");
a(wa[0].tHead).children("tr").children("th").hover(function(){a(this).addClass(ra)},function(){a(this).removeClass(ra)});k.multiselect&&a(k.cb,wa).bind("click",function(){var b=F("states.select"),c,e=[],f=k.iColByName.cb,g=function(c,d){a(c)[d?"addClass":"removeClass"](b).attr(d?{"aria-selected":"true",tabindex:"0"}:{"aria-selected":"false",tabindex:"-1"});if(void 0!==f)a(c.cells[f]).children("input.cbox")[k.propOrAttr]("checked",d)},h=z.fbRows,l=sa+" ui-subgrid jqgroup jqfoot jqgfirstrow",m,n=k._index;
V(k.selarrrow);if(this.checked){if(c=!0,k.selrow=1<d.rows.length?d.rows[d.rows.length-1].id:null,k.multiPageSelection&&("local"===k.datatype||k.treeGrid)&&null!=k.data&&0<k.data.length&&null!=n)for(m in n)n.hasOwnProperty(m)&&k.selarrrow.push(k.idPrefix+m)}else c=!1,k.selrow=null;a(d.rows).each(function(a){ca(this,l)||(g(this,c),(c?k.selarrrow:e).push(this.id),h&&g(h[a],c))});Q.call(d,"onSelectAll",c?k.selarrrow:e,c)});if(!0===k.autowidth){var Ja=Math.floor(a(X).innerWidth());k.width=0<Ja?Ja:"nw"}isNaN(k.width)?
...
m)||5<Math.abs(b.pageX-l)||5<Math.abs(b.pageX-m)))return!1;Q.call(d,"resizeDblClick",e,g,b)&&g.autoResizable&&c.autoResizeColumn.call(h,e);Q.call(d,"afterResizeDblClick",{iCol:e,cm:g,cmName:g.name});return!1});a(P).css("width",z.width+"px");var Ua="";k.footerrow&&(Ua+="<table role='presentation' style='width:"+k.tblwidth+"px' class='ui-jqgrid-ftable'"+(Aa?" cellspacing='0'":"")+"><tbody><tr role='row' class='"+F("rowFooter","footrow footrow-"+oa)+"'>");var ya="<tr class='jqgfirstrow' role='row' style='height:auto'>";
k.disableClick=!1;a("th",wa[0].tHead.rows[0]).each(function(b){var c=k.colModel[b],d=c.name,e=a(this),f=e.children("div"),g=f.children("span.s-ico"),h=k.showOneSortIcon;ea=c.width;void 0===c.resizable&&(c.resizable=!0);c.resizable?(R=document.createElement("span"),a(R).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+oa).bind("selectstart",function(){return!1}),e.addClass(k.resizeclass)):R="";e.css("width",ea+"px").prepend(R);R=null;var l="";!0===c.hidden&&(e.css("display","none"),l="display:none;");
ya+="<td role='gridcell' "+(c.classes?"class='"+c.classes+"' ":"")+"style='height:0;width:"+ea+"px;"+l+"'></td>";z.headers[b]={width:ea,el:this};ga=c.sortable;"boolean"!==typeof ga&&(ga=c.sortable=!0);"cb"!==d&&"subgrid"!==d&&"rn"!==d&&ga&&k.viewsortcols[2]&&f.addClass("ui-jqgrid-sortable");ga&&(k.multiSort?(d="desc"===c.lso?"asc":"desc",k.viewsortcols[0]?(g.css("display",""),c.lso&&(g.children("span.ui-icon-"+c.lso).removeClass(sa),h&&g.children("span.ui-icon-"+d).hide())):c.lso&&(g.css("display",
...
b,e(),c)),!1}).click(function(b){if(k.disableClick)return k.disableClick=!1;var c="th.ui-th-column>div",e,f,c=k.viewsortcols[2]?c+".ui-jqgrid-sortable":c+">span.s-ico>span.ui-grid-ico-sort";b=a(b.target).closest(c);if(1===b.length)return k.viewsortcols[2]||(e=!0,f=b.hasClass("ui-icon-desc")?"desc":"asc"),b=k.iColByName[(this.id||"").substring(k.id.length+1)],null!=b&&wb.call(d,a("div",this)[0].id,b,e,f,this),!1});if(k.sortable&&a.fn.sortable)try{c.sortableColumns.call(h,a(wa[0].tHead.rows[0]))}catch(tb){}k.footerrow&&
(Ua+="</tr></tbody></table>");ya+="</tr>";a(d).html("<tbody>"+ya+"</tbody>");h.addClass(F("grid","ui-jqgrid-btable"));var Ba=k.caption&&!0===k.hiddengrid?!0:!1,bb=a("<div class='ui-jqgrid-hbox"+("rtl"===oa?"-rtl":"")+"'></div>"),Da=F("bottom");z.hDiv=document.createElement("div");a(z.hDiv).css({width:z.width+"px"}).addClass(F("hDiv","ui-jqgrid-hdiv")).append(bb).scroll(function(){var b=a(this).next(".ui-jqgrid-bdiv")[0];b&&(b.scrollLeft=this.scrollLeft)});a(bb).append(wa);wa=null;Ba&&a(z.hDiv).hide();
k.rowNum=parseInt(k.rowNum,10);if(isNaN(k.rowNum)||0>=k.rowNum)k.rowNum=k.maxRowNum;if(k.pager){var Qa,Va;"string"===typeof k.pager&&"#"!==k.pager.substr(0,1)?(Va=k.pager,Qa=a("#"+H(k.pager))):!0===k.pager?(Va=Ha(),Qa=a("<div id='"+Va+"'></div>"),Qa.appendTo("body"),k.pager="#"+H(Va)):(Qa=a(k.pager),Va=Qa.attr("id"));0<Qa.length?(Qa.css({width:z.width+"px"}).addClass(F("pager","ui-jqgrid-pager "+Da)).appendTo(X),Ba&&Qa.hide(),vb.call(d,Va,""),k.pager="#"+H(Va)):k.pager=""}!1===k.cellEdit&&!0===k.hoverrows&&
h.bind("mouseover",function(b){la=a(b.target).closest("tr.jqgrow");"ui-subgrid"!==a(la).attr("class")&&a(la).addClass(ra)}).bind("mouseout",function(b){la=a(b.target).closest("tr.jqgrow");a(la).removeClass(ra)});var pa,Ka,Sa,La=function(b){var c,d;do if(c=a(b).closest("td"),0<c.length){b=c.parent();d=b.parent().parent();if(b.is(".jqgrow")&&(d[0]===this||d.is("table.ui-jqgrid-btable")&&(d[0].id||"").replace("_frozen","")===this.id))break;b=c.parent()}while(0<c.length);return c};h.before(z.hDiv).click(function(b){var e=
F("states.select"),f=b.target,g=La.call(this,f),l=g.parent();if(0!==l.length&&!ca(l,sa)){pa=l[0].id;var m=a(f).hasClass("cbox"),n=Q.call(d,"beforeSelectRow",pa,b),p=v.detectRowEditing.call(d,pa),p=null!=p&&"cellEditing"!==p.mode;if("A"!==f.tagName&&(!p||m))if(Ka=g[0].cellIndex,Sa=g.html(),Q.call(d,"onCellSelect",pa,Ka,Sa,b),!0===k.cellEdit)if(k.multiselect&&m&&n)t.call(h,pa,!0,b);else{pa=l[0].rowIndex;try{c.editCell.call(h,pa,Ka,!0)}catch(q){}}else if(n)if(k.multikey)b[k.multikey]?t.call(h,pa,!0,
b):k.multiselect&&m&&(m=a("#jqg_"+H(k.id)+"_"+pa).is(":checked"),a("#jqg_"+H(k.id)+"_"+pa)[I]("checked",!m));else if(k.multiselect&&k.multiboxonly){if(!m){var r=k.frozenColumns?k.id+"_frozen":"";a(k.selarrrow).each(function(b,d){var f=c.getGridRowById.call(h,d);f&&a(f).removeClass(e);a("#jqg_"+H(k.id)+"_"+H(d))[k.propOrAttr]("checked",!1);r&&(a("#"+H(d),"#"+H(r)).removeClass(e),a("#jqg_"+H(k.id)+"_"+H(d),"#"+H(r))[k.propOrAttr]("checked",!1))});V(k.selarrrow)}t.call(h,pa,!0,b)}else f=k.selrow,t.call(h,
...
d.current&&e.selectionPreserver.call(this);"local"===k.datatype?(k.multiPageSelection||c.resetSelection.call(f),k.data.length&&(xa.call(this),mb())):k.treeGrid||k.multiPageSelection||(k.selrow=null,k.multiselect&&(V(k.selarrrow),jb.call(this,!1)),V(k.savedRow));k.iRow=-1;k.iCol=-1;k.scroll&&z.emptyRows.call(this,!0,!1);if(d.page){var g=parseInt(d.page,10);g>k.lastpage&&(g=k.lastpage);1>g&&(g=1);k.page=g;e.bDiv.scrollTop=e.prevRowHeight?(g-1)*e.prevRowHeight*k.rowNum:0}e.prevRowHeight&&k.scroll&&void 0===
d.page?(delete k.lastpage,e.populateVisible.call(this)):e.populate.call(this);!0===k._inlinenav&&f.jqGrid("showAddEditButtons",!1);return!1}).dblclick(function(a){var b=La.call(this,a.target),c=b.parent();if(0<b.length&&!Q.call(d,"ondblClickRow",c.attr("id"),c[0].rowIndex,b[0].cellIndex,a))return!1}).bind("contextmenu",function(a){var b=La.call(this,a.target),c=b.parent(),e=c.attr("id");if(0!==b.length&&(k.multiselect||t.call(h,e,!0,a),!Q.call(d,"onRightClickRow",e,c[0].rowIndex,b[0].cellIndex,a)))return!1});
z.bDiv=document.createElement("div");U&&"auto"===String(k.height).toLowerCase()&&(k.height="100%");a(z.bDiv).append(a("<div style='position:relative;"+(Aa?"height:0.01%;":"")+"'></div>").append("<div></div>").append(d)).addClass("ui-jqgrid-bdiv").css({height:k.height+(isNaN(k.height)?"":"px"),width:z.width+"px"}).scroll(z.scrollGrid);k.maxHeight&&a(z.bDiv).css("max-height",k.maxHeight+(isNaN(k.maxHeight)?"":"px"));h.css({width:"1px"});a.support.tbody||2===a(">tbody",d).length&&a(">tbody:gt(0)",d).remove();
k.multikey&&a(z.bDiv).bind(v.msie?"selectstart":"mousedown",function(){return!1});Ba&&a(z.bDiv).hide();z.cDiv=document.createElement("div");var Ma=B("gridMinimize.visible"),Wa=B("gridMinimize.hidden"),Xa=C("showhide"),Ra=!0===k.hidegrid?a("<a role='link' class='"+F("titleButton","ui-jqgrid-titlebar-close")+"'"+(Xa?" title='"+Xa+"'":"")+"/>").hover(function(){Ra.addClass(ra)},function(){Ra.removeClass(ra)}).append("<span class='"+Ma+"'></span>"):"";a(z.cDiv).append("<span class='ui-jqgrid-title'>"+
k.caption+"</span>").append(Ra).addClass(F("gridTitle","ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===oa?"-rtl":"")));a(z.cDiv).insertBefore(z.hDiv);if(k.toolbar[0]){z.uDiv=document.createElement("div");"top"===k.toolbar[1]?a(z.uDiv).insertBefore(z.hDiv):"bottom"===k.toolbar[1]&&a(z.uDiv).insertAfter(z.hDiv);var Ya=F("toolbarUpper","ui-userdata");"both"===k.toolbar[1]?(z.ubDiv=document.createElement("div"),a(z.uDiv).addClass(Ya).attr("id","t_"+k.id).insertBefore(z.hDiv),a(z.ubDiv).addClass(F("toolbarBottom",
"ui-userdata")).attr("id","tb_"+k.id).insertAfter(z.hDiv),Ba&&a(z.ubDiv).hide()):a(z.uDiv).width(z.width).addClass(Ya).attr("id","t_"+k.id);Ba&&a(z.uDiv).hide()}"string"===typeof k.datatype&&(k.datatype=k.datatype.toLowerCase());k.toppager?(k.toppager=k.id+"_toppager",z.topDiv=a("<div id='"+k.toppager+"'></div>")[0],a(z.topDiv).addClass(F("pager","ui-jqgrid-toppager")).css({width:z.width+"px"}).insertBefore(z.hDiv),vb.call(d,k.toppager,"_t"),k.toppager="#"+H(k.toppager)):""!==k.pager||k.scroll||(k.rowNum=
k.maxRowNum);k.footerrow&&(z.sDiv=a("<div class='ui-jqgrid-sdiv'></div>")[0],bb=a("<div class='ui-jqgrid-hbox"+("rtl"===oa?"-rtl":"")+"'></div>"),a(z.sDiv).append(bb).width(z.width).insertAfter(z.hDiv),a(bb).append(Ua),z.footers=a(".ui-jqgrid-ftable",z.sDiv)[0].rows[0].cells,k.rownumbers&&(z.footers[0].className=F("rowNum","jqgrid-rownum")),Ba&&a(z.sDiv).hide());bb=null;if(k.caption){var cb=k.datatype;!0===k.hidegrid&&(a(".ui-jqgrid-titlebar-close",z.cDiv).click(function(b){var c=".ui-jqgrid-bdiv,.ui-jqgrid-hdiv,.ui-jqgrid-pager,.ui-jqgrid-sdiv",
e=this;!0===k.toolbar[0]&&("both"===k.toolbar[1]&&(c+=",#"+H(a(z.ubDiv).attr("id"))),c+=",#"+H(a(z.uDiv).attr("id")));var f=a(c,k.gView).length;k.toppager&&(c+=","+k.toppager);"visible"===k.gridstate?a(c,k.gBox).slideUp("fast",function(){f--;0===f&&(a("span",e).removeClass(Ma).addClass(Wa),k.gridstate="hidden",a(k.gBox).hasClass("ui-resizable")&&a(".ui-resizable-handle",k.gBox).hide(),a(z.cDiv).addClass(Da),Ba||Q.call(d,"onHeaderClick",k.gridstate,b))}):"hidden"===k.gridstate&&(a(z.cDiv).removeClass(Da),
a(c,k.gBox).slideDown("fast",function(){f--;0===f&&(a("span",e).removeClass(Wa).addClass(Ma),Ba&&(k.datatype=cb,fa.call(d),Ba=!1),k.gridstate="visible",a(k.gBox).hasClass("ui-resizable")&&a(".ui-resizable-handle",k.gBox).show(),Ba||Q.call(d,"onHeaderClick",k.gridstate,b))}));return!1}),Ba&&(k.datatype="local",a(".ui-jqgrid-titlebar-close",z.cDiv).trigger("click")))}else a(z.cDiv).hide(),a(z.cDiv).nextAll("div:visible").first().addClass("ui-corner-top");a(z.hDiv).after(z.bDiv);a(X).click(ha).dblclick(function(b){var e=
a(k.rs),f=e.offset(),g=e.data("idx"),l=e.data("delta"),m=k.colModel[g],n=a(this).data("pageX")||e.data("pageX");if(null==n||null==m)return!1;var n=String(n).split(";"),p=parseFloat(n[0]),q=parseFloat(n[1]);if(2===n.length&&(5<Math.abs(p-q)||5<Math.abs(b.pageX-p)||5<Math.abs(b.pageX-q)))return!1;Q.call(d,"resizeDblClick",g,m)&&f.left-1<=b.pageX+l&&b.pageX+l<=f.left+e.outerWidth()+1&&m.autoResizable&&c.autoResizeColumn.call(h,g);Q.call(d,"afterResizeDblClick",{iCol:g,cm:m,cmName:m.name});return!1});
k.pager||a(z.cDiv).nextAll("div:visible").filter(":last").addClass(Da);a(".ui-jqgrid-labels",z.hDiv).bind("selectstart",function(){return!1});d.formatCol=Y;d.sortData=wb;d.updatepager=Oa;d.refreshIndex=mb;d.setHeadCheckBox=jb;d.fixScrollOffsetAndhBoxPadding=G;d.constructTr=ba;d.formatter=Db;n(z,{populate:fa,emptyRows:M,beginReq:Pa,endReq:Ia});d.addXmlData=Ea;d.addJSONData=Ea;d.rebuildRowIndexes=O;d.grid.cols=d.rows[0].cells;Q.call(d,"onInitGrid");k.treeGrid&&"local"===k.datatype&&null!=k.data&&0<
k.data.length&&(k.datatype="jsonstring",k.datastr=k.data,k.data=[]);fa.call(d);k.hiddengrid=!1}}}})};var D=a.fn.jqGrid;v.extend({getGridRes:function(b){var c=this[0];if(!c||!c.grid||!c.p)return null;c=v.getRes(Fa[c.p.locale],b)||v.getRes(Fa["en-US"],b);b=v.getRes(v,b);return"object"!==typeof c||null===c||a.isArray(c)?void 0!==b?b:c:a.extend(!0,{},c,b||{})},getGuiStyles:function(b,c){var e=this instanceof a&&0<this.length?this[0]:this;return e&&e.grid&&e.p?v.mergeCssClasses(v.getRes(v.guiStyles[e.p.guiStyle||
...
u=a(this),E=this.rows,B=0,F=D.getGridRowById,k=y.colModel,C={},I=y.additionalProperties;p||(void 0!==b?b=String(b):(b=Ha(),!1!==y.keyName&&(q=y.keyName,void 0!==c[0][q]&&(b=c[0][q]))));for(r=y.altclass;B<A;){t=c[B];h=[];if(p)try{b=t[q],void 0===b&&(b=Ha())}catch(G){b=Ha()}x=b;for(l=0;l<k.length;l++)w=k[l],g=w.name,"rn"!==g&&"cb"!==g&&"subgrid"!==g&&(n=lb.call(this,t[g],w,void 0,x,{},l),a.isFunction(w.saveLocally)?w.saveLocally.call(this,{newValue:n,newItem:C,oldItem:{},id:x,cm:w,cmName:g,iCol:l}):
void 0!==n&&(C[g]=n));for(l=0;l<I.length;l++)g=I[l],"object"===typeof g&&g.hasOwnProperty("name")&&(g=g.name),n=ma(t,g),void 0!==n&&(C[g]=n);"local"===y.datatype&&(C[y.localReader.id]=x,y._index[x]=y.data.length,y.data.push(C));h=v.parseDataToHtml.call(this,1,[b],[t]);h=h.join("");if(0===E.length)a(this.tBodies[0]).append(h);else{if("afterSelected"===e||"beforeSelected"===e)void 0===d&&null!==y.selrow?(d=y.selrow,e="afterSelected"===e?"after":"before"):e="afterSelected"===e?"last":"first";switch(e){case "last":a(E[E.length-
...
l[m];"local"===h.datatype&&(A=Na(h.idPrefix,b),n=h._index[A],void 0!==n&&(q=h.data[n]));if(null==q)for(n=0;n<r.cells.length;n++){if(n!==m&&(w=v.getDataFieldOfCell.call(this,r,n),0<w.length)){try{x=a.unformat.call(this,w,{rowId:b,colModel:l[n]},n)}catch(u){x=Da(w[0].innerHTML)}y[l[n].name]=x}}else y=q;y[p.name]=e;l=this.formatter(b,e,m,y,"edit");h=h.colModel[m].title?{title:ib(l)}:{};t.html(l).attr(h);null!=q&&(l=lb.call(this,e,p,q[p.name],A,q,m),a.isFunction(p.saveLocally)?p.saveLocally.call(this,
{newValue:l,newItem:q,oldItem:q,id:A,cm:p,cmName:p.name,iCol:m}):q[p.name]=l)}if(d||f){t=v.getCell.call(this,r,m);if(d)t["string"===typeof d?"addClass":"css"](d);"object"===typeof f&&t.attr(f)}}})},getCell:function(b,c){var e=!1;this.each(function(){var d,f=this.p,g,h;if(this.grid&&(d=isNaN(c)?f.iColByName[c]:parseInt(c,10),0<=d&&(g=D.getGridRowById.call(a(this),b)))){h=v.getDataFieldOfCell.call(this,g,d).first();try{e=a.unformat.call(this,h,{rowId:g.id,colModel:f.colModel[d]},d)}catch(m){e=Da(h.html())}}});
return e},getCol:function(b,c,e){var d=[],f,g=0,h,m,l;c="boolean"!==typeof c?!1:c;void 0===e&&(e=!1);this.each(function(){var n,p=this.p,q;if(this.grid&&(n=isNaN(b)?p.iColByName[b]:parseInt(b,10),0<=n)){var r=this.rows,t=r.length,w=0,x=0,y;if(t&&0<t){for(;w<t;){y=r[w];if(a(y).hasClass("jqgrow")){q=v.getDataFieldOfCell.call(this,y,n).first();try{f=a.unformat.call(this,q,{rowId:y.id,colModel:p.colModel[n]},n)}catch(A){f=Da(q.html())}e?(l=parseFloat(f),isNaN(l)||(g+=l,void 0===m&&(m=h=l),h=Math.min(h,
...
n,!1);c.autoResizing.fixWidthOnShrink=l;c.autoResizing.adjustGridWidth=m;c.shrinkToFit=h})}});var ba=function(a,c){return v.mergeCssClasses(v.getRes(v.guiStyles[this.p.guiStyle],"states."+a),c||"")},va=function(b,c){var e=this.grid.fbRows;return a((null!=e&&e[0].cells.length>c?e[b.rowIndex]:b).cells[c])};v.extend({editCell:function(b,c,e){return this.each(function(){var d=this,f=a(d),g=d.p,h,m,l,n;h=d.rows;if(d.grid&&!0===g.cellEdit&&null!=h&&null!=h[b]&&(b=parseInt(b,10),c=parseInt(c,10),!isNaN(b)&&
!isNaN(c))){var p=h[b],q=null!=p?p.id:null,r=a(p),t=parseInt(g.iCol,10),w=parseInt(g.iRow,10),x=a(h[w]),y=g.savedRow;if(null!=q){g.selrow=q;g.knv||f.jqGrid("GridNav");if(0<y.length){if(!0===e&&b===w&&c===t)return;f.jqGrid("saveCell",y[0].id,y[0].ic)}else setTimeout(function(){a("#"+v.jqID(g.knv)).attr("tabindex","-1").focus()},1);n=g.colModel[c];h=n.name;if("subgrid"!==h&&"cb"!==h&&"rn"!==h){l=va.call(d,p,c);p=n.editable;a.isFunction(p)&&(p=p.call(d,{rowid:q,iCol:c,iRow:b,name:h,cm:n,mode:"cell"}));
var A=ba.call(d,"select","edit-cell"),u=ba.call(d,"hover","selected-row");if(!0!==p||!0!==e||l.hasClass("not-editable-cell"))0<=t&&0<=w&&(va.call(d,x[0],t).removeClass(A),x.removeClass(u)),l.addClass(A),r.addClass(u),m=l.html().replace(/\&#160\;/ig,""),Q.call(d,"onSelectCell",q,h,m,b,c);else{0<=t&&0<=w&&(va.call(d,x[0],t).removeClass(A),x.removeClass(u));l.addClass(A);r.addClass(u);n.edittype||(n.edittype="text");r=n.edittype;try{m=a.unformat.call(d,l,{rowId:q,colModel:n},c)}catch(B){m="textarea"===
...
"-1").focus()},0)}})},restoreCell:function(b,c){return this.each(function(){var e=this.p,d=this.rows[b],f=d.id,g,h;if(this.grid&&!0===e.cellEdit){var m=e.savedRow;g=va.call(this,d,c);if(1<=m.length){if(a.isFunction(a.fn.datepicker))try{a("input.hasDatepicker",g).datepicker("hide")}catch(l){}d=e.colModel[c];!0===e.treeGrid&&d.name===e.ExpandColumn?g.children("span.cell-wrapperleaf,span.cell-wrapper").empty():g.empty();g.attr("tabindex","-1");g=m[0].v;h=d.formatoptions||{};"date"===d.formatter&&!0!==
...
[];b||(b="all");this.each(function(){var e=this,d=e.p,f=v.htmlDecode,g=e.rows;e.grid&&!0===d.cellEdit&&a(g).each(function(h){var m={};if(a(this).hasClass("edited")){var l=this;a(this.cells).each(function(c){var p=d.colModel[c],q=p.name,r=va.call(e,l,c);if("cb"!==q&&"subgrid"!==q&&"rn"!==q&&("dirty"!==b||r.hasClass("dirty-cell")))try{m[q]=a.unformat.call(e,r[0],{rowId:g[h].id,colModel:p},c)}catch(t){m[q]=f(r.html())}});m.id=this.id;c.push(m)}})});return c}});var ga=v.getMethod("getGridRes"),aa=function(a,
...
void 0!==d&&a.isArray(d)&&a.merge(e,d);a.each(c,function(c,d){-1===a.inArray(c,e)&&a(b).attr(c,d)});c.hasOwnProperty("id")||a(b).attr("id",v.randId())}var h="",m=this,l=m.p,n=v.info_dialog,p=ga.call(a(m),"errors.errcap"),q=ga.call(a(m),"edit"),r=q.msg,q=q.bClose;switch(b){case "textarea":h=document.createElement("textarea");d?c.cols||a(h).css({width:"100%","box-sizing":"border-box"}):c.cols||(c.cols=20);c.rows||(c.rows=2);if("&nbsp;"===e||"&#160;"===e||1===e.length&&160===e.charCodeAt(0))e="";h.value=
...
v.ajaxOptions,f.ajaxSelectOptions||{}));else{var D,H,X;w?(D=void 0===w.value?"":w.value,H=void 0===w.separator?":":w.separator,X=void 0===w.delimiter?";":w.delimiter):x&&(D=void 0===x.value?"":x.value,H=void 0===x.separator?":":x.separator,X=void 0===x.delimiter?";":x.delimiter);if(D){var L=document.createElement("select");L.style.width="100%";a(L).attr({name:this.index||this.name,id:"gs_"+this.name});var Y;if("string"===typeof D)for(e=D.split(X),Y=0;Y<e.length;Y++)D=e[Y].split(H),X=document.createElement("option"),
...
b));return g};this.createTableRowForRule=function(b,c){var e=this,f=l(),g=a("<tr></tr>"),h,p,q,r="",k;g.append("<td class='first'></td>");var C=a("<td class='columns'></td>");g.append(C);var I=a("<select></select>"),G,J=[];C.append(I);I.bind("change",function(){b.field=a(I).val();var c=a(this).parents("tr:first"),d,g;for(g=0;g<e.p.columns.length;g++)if(e.p.columns[g].name===b.field){d=e.p.columns[g];break}if(d){var h=a.extend({},d.searchoptions||{},{id:v.randId(),name:d.name,mode:"search"});m&&"text"===
d.inputtype&&!h.size&&(h.size=10);var k=v.createEl.call(f,d.inputtype,h,"",!0,e.p.ajaxSelectOptions||{},!0);a(k).addClass("input-elm");p=h.sopt?h.sopt:e.p.sopt?e.p.sopt:-1!==a.inArray(d.searchtype,e.p.strarr)?e.p.stropts:e.p.numopts;d="";var l=0,n,q;J=[];a.each(e.p.ops,function(){J.push(this.oper)});e.p.cops&&a.each(e.p.cops,function(a){J.push(a)});for(g=0;g<p.length;g++)q=p[g],G=a.inArray(p[g],J),-1!==G&&(n=e.p.ops[G],n=void 0!==n?n.text:e.p.cops[q].text,0===l&&(b.op=q),d+="<option value='"+q+"'>"+
...
setTimeout(function(){b.data=a(k).val();e.onchange()},0)}});var C=0,K,O;for(h=0;h<e.p.columns.length;h++)if(k=void 0===e.p.columns[h].search?!0:e.p.columns[h].search,K=!0===e.p.columns[h].hidden,(O=!0===e.p.columns[h].searchoptions.searchhidden)&&k||k&&!K)k="",b.field===e.p.columns[h].name&&(k=" selected='selected'",C=h),r+="<option value='"+e.p.columns[h].name+"'"+k+">"+e.p.columns[h].label+"</option>";I.append(r);r=a("<td class='operators'></td>");g.append(r);q=d.columns[C];m&&"text"===q.inputtype&&
...
b.unshift(g);return Wa.apply(e,b)};"string"===typeof t&&(t=""!==a.trim(t)?v.parse(t):void 0);!0===g.recreateFilter?a(n).remove():d.data("searchProp")&&a.extend(g,d.data("searchProp"));if(void 0!==a(n)[0])c(a("#fbox_"+f.idSel));else{var x=a("<div><div id='"+h+"' class='searchFilter' style='overflow:auto'></div></div>").insertBefore(q);"rtl"===f.direction&&x.attr("dir","rtl");var y="",A="",u,E=!1,B,F=-1,k=a.extend([],f.colModel);B=ea.call(e,h+"_search",g.Find,na(m,g.findDialogIcon),"right");var C=ea.call(e,
h+"_reset",g.Reset,na(m,g.resetDialogIcon),"left");g.showQuery&&(y=ea.call(e,h+"_query","Query",na(m,g.queryDialogIcon),"left")+"&#160;");g.searchForAdditionalProperties&&r(f.additionalProperties,function(){var a="string"===typeof this?{name:this}:this;a.label||(a.label=a.name);a.isAddProp=!0;k.push(a)});g.columns.length?(k=g.columns,F=0,u=k[0].index||k[0].name):r(k,function(a,b){b.label||(b.label=b.isAddProp?b.name:f.colNames[a]);if(!E){var c=void 0===b.search?!0:b.search,d=!0===b.hidden;if(b.searchoptions&&
...
function(){var b=a(this).val();"default"===b?a(h).jqFilter("addFilter",t):a(h).jqFilter("addFilter",g.tmplFilters[parseInt(b,10)]);return!1});!0===g.multipleGroup&&(g.multipleSearch=!0);w("onInitialize",a(h));g.layer?ya.call(e,l,x,g,q,a(p)[0],"#"+H(g.layer),{position:"relative"}):ya.call(e,l,x,g,q,a(p)[0]);(g.searchOnEnter||g.closeOnEscape)&&a(n).keydown(function(b){var c=a(b.target);if(!(!g.searchOnEnter||13!==b.which||c.hasClass("add-group")||c.hasClass("add-rule")||c.hasClass("delete-group")||
...
""!==f?(a(d,c)[K]("checked",!0),a(d,c)[K]("defaultChecked",!0)):(a(d,c)[K]("checked",!1),a(d,c)[K]("defaultChecked",!1));break;case "custom":try{if(n[g].editoptions&&a.isFunction(n[g].editoptions.custom_value))n[g].editoptions.custom_value.call(r,a(d,c),"set",f);else throw"e1";}catch(h){"e1"===h?Xa.call(r,X,"function 'custom_value' "+u.msg.nodefined,u.bClose):Xa.call(r,X,h.message,u.bClose)}}e++}}),0<e&&a("#id_g",k).val(b))}}function g(){var b=u.url||w.editurl;a.each(O,function(c,d){var e=d.name,
...
A.call(t,c[2]),da(G,{gb:J,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form})):u.clearAfterAdd&&f("_empty",E)):(u.reloadAfterSubmit?(t.trigger("reloadGrid",g),u.closeAfterEdit||setTimeout(function(){A.call(t,z[h])},1E3)):!0===w.treeGrid?D.setTreeRow.call(t,z[h],z):D.setRowData.call(t,z[h],z),u.closeAfterEdit&&da(G,{gb:J,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form}));if(a.isFunction(u.afterComplete)){var m=
...
v.errors.nourl));c[0]&&(u.useDataProxy?(d=w.dataProxy.call(r,p,"set_"+x),void 0===d&&(d=[!0,""]),!1===d[0]?(c[0]=!1,c[1]=d[1]||"Error deleting the selected row!"):(p.data.oper===e.addoper&&u.closeAfterAdd&&da(G,{gb:J,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form}),p.data.oper===e.editoper&&u.closeAfterEdit&&da(G,{gb:J,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form}))):"clientArray"===p.url?(u.reloadAfterSubmit=
...
b);else{var c=c.savedRow,d=r.rows[c.id];D.restoreCell.call(t,c.id,c.ic);a(d.cells[c.ic]).removeClass("edit-cell "+$a);a(d).addClass($a).attr({"aria-selected":"true",tabindex:"0"})}}function p(b,c){var d=c[1].length-1;0===b?a("#pData",C).addClass(T):void 0!==c[1][b-1]&&ca(a("#"+H(c[1][b-1])),T)?a("#pData",C).addClass(T):a("#pData",C).removeClass(T);b===d?a("#nData",C).addClass(T):void 0!==c[1][b+1]&&ca(a("#"+H(c[1][b+1])),T)?a("#nData",C).addClass(T):a("#nData",C).removeClass(T)}function q(){var b=
...
x,modalhead:"edithd"+x,modalcontent:"editcnt"+x,resizeAlso:E},G="#"+H(I.themodal),J=w.gBox,K=w.propOrAttr,O=w.colModel,Za=w.iColByName,ha=1,N=0,z,P,U,Aa=u.commonIconClass,X=y.call(t,"errors.errcap"),L=function(){var b=a.makeArray(arguments);b.unshift("");b.unshift("AddEdit");b.unshift(u);return Wa.apply(r,b)},Y=ba.call(r,"hover"),T=ba.call(r,"disabled"),$a=ba.call(r,"select"),Q=ba.call(r,"active"),M=ba.call(r,"error"),E="#"+H(E);"new"===b?(b="_empty",U="add",u.caption=u.addCaption):(u.caption=u.editCaption,
U="edit");if(!u.recreateForm){var xa=t.data("formProp");xa&&(xa.top=Math.max(xa.top,0),xa.left=Math.max(xa.left,0),a.extend(u,xa))}xa=!0;!u.checkOnUpdate||!0!==u.jqModal&&void 0!==u.jqModal||u.modal||(xa=!1);var W=isNaN(u.dataheight)?u.dataheight:u.dataheight+"px",V=isNaN(u.datawidth)?u.datawidth:u.datawidth+"px",B=a("<form name='FormPost' id='"+B+"' class='FormGrid' onSubmit='return false;' style='width:"+V+";overflow:auto;position:relative;height:"+W+";'></form>").data("disabled",!1),R=a("<table id='"+
...
B,U)){n();W=(M="rtl"===w.direction?!0:!1)?"nData":"pData";V=M?"pData":"nData";d(b,R,ha);var W=ea.call(r,W,"",na(Aa,u.prevIcon),"","left"),V=ea.call(r,V,"",na(Aa,u.nextIcon),"","right"),ab=ea.call(r,"sData",u.bSubmit),Ea=ea.call(r,"cData",u.bCancel),F="<table"+(v.msie&&8>v.msiever()?" cellspacing='0'":"")+" class='EditTable' id='"+F+"_2'><tbody><tr><td colspan='2'><hr class='"+aa.call(r,"dialog.hr")+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton navButton-"+w.direction+
"'>"+(M?V+W:W+V)+"</td><td class='EditButton EditButton-"+w.direction+"'>"+ab+"&#160;"+Ea+"</td></tr>",F=F+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+(u.bottominfo||"&#160;")+"</td></tr>"),F=F+"</tbody></table>";if(0<N){var db=[];a.each(a(R)[0].rows,function(a,b){db[a]=b});db.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(db,function(b,c){a("tbody",R).append(c)})}u.gbox=J;var eb=!1;!0===u.closeOnEscape&&(u.closeOnEscape=!1,eb=!0);F=a("<div></div>").append(B).append(F);
ya.call(r,I,F,u,w.gView,a(J)[0]);u.topinfo&&a(".tinfo",k).show();u.bottominfo&&a(".binfo",C).show();F=F=null;a(G).keydown(function(b){var c=(b.target.tagName||"").toUpperCase(),d,e;if(!0===a(E).data("disabled"))return!1;if(13===b.which&&"TEXTAREA"!==c){d=a(C).find(":focus");e=d.attr("id");if(0<d.length&&0<=a.inArray(e,["pData","nData","cData"]))return d.trigger("click"),!1;if(!0===u.savekey[0]&&13===u.savekey[1])return a("#sData",C).trigger("click"),!1}if(!0===u.savekey[0]&&b.which===u.savekey[1]&&
...
G).unbind("click").click(function(){if(!l())return!1;da(G,{gb:J,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form});return!1}));Ka(a("#sData",C),u.saveicon,Aa);Ka(a("#cData",C),u.closeicon,Aa);if(u.checkOnSubmit||u.checkOnUpdate)ab=ea.call(r,"sNew",u.bYes),V=ea.call(r,"nNew",u.bNo),Ea=ea.call(r,"cNew",u.bExit),I=u.zIndex||999,I++,a("<div class='"+u.overlayClass+" jqgrid-overlay confirm' style='z-index:"+I+";display:none;'>&#160;</div><div class='"+aa.call(r,
"dialog.content","confirm ui-jqconfirm")+"' style='z-index:"+(I+1)+"'>"+u.saveData+"<br/><br/>"+ab+V+Ea+"</div>").insertAfter(E),a("#sNew",G).click(function(){h();a(E).data("disabled",!1);a(".confirm",G).hide();return!1}),a("#nNew",G).click(function(){a(".confirm",G).hide();a(E).data("disabled",!1);setTimeout(function(){a(":input:visible",E)[0].focus()},0);return!1}),a("#cNew",G).click(function(){a(".confirm",G).hide();a(E).data("disabled",!1);da(G,{gb:J,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,
formprop:!u.recreateForm,form:u.form});return!1});L("onInitializeForm",a(E),U);"_empty"!==b&&u.viewPagerButtons?a("#pData,#nData",C).show():a("#pData,#nData",C).hide();L("beforeShowForm",a(E),U);a(G).data("onClose",u.onClose);Ja(G,{gbox:J,jqm:u.jqModal,overlay:u.overlay,modal:u.modal,overlayClass:u.overlayClass,toTop:u.toTop,onHide:function(a){nb.call(t,"formProp",E,a)}});xa||a("."+H(u.overlayClass)).click(function(){if(!l())return!1;da(G,{gb:J,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,
formprop:!u.recreateForm,form:u.form});return!1});a(".fm-button",G).hover(function(){a(this).addClass(Y)},function(){a(this).removeClass(Y)});a("#sData",C).click(function(){z={};a("#FormError",k).hide();e();"_empty"===z[x+"_id"]?h():!0===u.checkOnSubmit?(P=m(z,u._savedData))?(a(E).data("disabled",!0),a(".confirm",G).show()):h():h();return!1});a("#cData",C).click(function(){if(!l())return!1;da(G,{gb:J,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form});
...
g.editrules.edithidden?!1:!0===g.hidden?!0:!1;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&(c=H("v_"+c),a("#"+c+" span",t).html(v.getDataFieldOfCell.call(m,f,b).html()),d&&a("#"+c,t).parents("tr:first").hide(),e++)}),0<e&&a("#id_g",t).val(b))}function g(b,c){var d=c[1].length-1;0===b?a("#pData",w).addClass(J):void 0!==c[1][b-1]&&ca(a("#"+H(c[1][b-1])),J)?a("#pData",w).addClass(J):a("#pData",w).removeClass(J);b===d?a("#nData",w).addClass(J):void 0!==c[1][b+1]&&ca(a("#"+H(c[1][b+1])),J)?a("#nData",w).addClass(J):
a("#nData",w).removeClass(J)}function h(){var b=D.getDataIDs.call(l),c=a("#id_g",t).val();return[a.inArray(c,b),b]}var m=this,l=a(m),n=m.p;if(m.grid&&null!=n&&b){var p=n.id,q=a.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,closeOnEscape:!1,labelswidth:"30%",navkeys:[!1,38,40],onClose:null,beforeShowForm:null,beforeInitData:null,viewPagerButtons:!0,recreateForm:!1,removemodal:!0,form:"view"},D.getGridRes.call(l,"view"),v.view||{},n.formViewing||
{},c||{}),r="#ViewGrid_"+H(p),t="#ViewTbl_"+H(p),w=t+"_2",x="ViewGrid_"+p,y="ViewTbl_"+p,A=q.commonIconClass,u={themodal:"viewmod"+p,modalhead:"viewhd"+p,modalcontent:"viewcnt"+p,resizeAlso:x},E="#"+H(u.themodal),B=n.gBox,F=n.colModel,k=1,C=0,I=function(){var b=a.makeArray(arguments);b.unshift("");b.unshift("View");b.unshift(q);return Wa.apply(m,b)},G=ba.call(m,"hover"),J=ba.call(m,"disabled");q.recreateForm||l.data("viewProp")&&a.extend(q,l.data("viewProp"));var p=isNaN(q.dataheight)?q.dataheight:
q.dataheight+"px",K=isNaN(q.datawidth)?q.datawidth:q.datawidth+"px",x=a("<form name='FormPost' id='"+x+"' class='FormGrid' style='width:"+K+";overflow:auto;position:relative;height:"+p+";'></form>"),O=a("<table id='"+y+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");a(F).each(function(){var a=this.formoptions;k=Math.max(k,a?a.colpos||0:0);C=Math.max(C,a?a.rowpos||0:0)});x.append(O);if(I("beforeInitData",x)){d(b,O,k);var M=(p="rtl"===
n.direction?!0:!1)?"pData":"nData",K=ea.call(m,p?"nData":"pData","",na(A,q.prevIcon),"","left"),M=ea.call(m,M,"",na(A,q.nextIcon),"","right"),ha=ea.call(m,"cData",q.bClose);if(0<C){var N=[];a.each(a(O)[0].rows,function(a,b){N[a]=b});N.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(N,function(b,c){a("tbody",O).append(c)})}q.gbox=B;y=a("<div></div>").append(x).append("<table border='0' class='EditTable' id='"+y+"_2'><tbody><tr id='Act_Buttons'><td class='navButton navButton-"+n.direction+
"' width='"+(q.labelswidth||"auto")+"'>"+(p?M+K:K+M)+"</td><td class='EditButton EditButton-"+n.direction+"'>"+ha+"</td></tr></tbody></table>");ya.call(m,u,y,q,n.gView,a(n.gView)[0]);q.viewPagerButtons||a("#pData, #nData",w).hide();y=null;a(E).keydown(function(b){var c,d;if(!0===a(r).data("disabled"))return!1;if(13===b.which&&(c=a(w).find(":focus"),d=c.attr("id"),0<c.length&&0<=a.inArray(d,["pData","nData","cData"])))return c.trigger("click"),!1;if(27===b.which)return q.closeOnEscape&&da(E,{gb:B,
jqm:q.jqModal,onClose:q.onClose,removemodal:q.removemodal,formprop:!q.recreateForm,form:q.form}),!1;if(!0===q.navkeys[0]){if(b.which===q.navkeys[1])return a("#pData",w).trigger("click"),!1;if(b.which===q.navkeys[2])return a("#nData",w).trigger("click"),!1}});Ka(a("#cData",w),q.closeicon,A);I("beforeShowForm",a(r));Ja(E,{gbox:B,jqm:q.jqModal,overlay:q.overlay,toTop:q.toTop,modal:q.modal,onHide:function(a){nb.call(l,"viewProp",r,a)}});a(".fm-button:not(."+J.split(" ").join(".")+")",w).hover(function(){a(this).addClass(G)},
...
10)/2-f.left,e=e/2-25-f.top),ya.call(m,y,"<div>"+q.alerttext+"</div><span tabindex='0'><span tabindex='-1' id='"+p+"_jqg_alrt'></span></span>",{gbox:w,jqModal:q.jqModal,drag:!0,resize:!0,caption:q.alertcap,top:null!=q.alerttop?q.alerttop:e,left:null!=q.alertleft?q.alertleft:d,width:q.alertwidth,height:q.alertheight,closeOnEscape:q.closeOnEscape,zIndex:q.alertzIndex,removemodal:q.removemodal},l.gView,a(w)[0],!1));Ja("#"+H(y.themodal),{gbox:w,toTop:q.alertToTop,jqm:q.jqModal});var g=a("#"+H(y.modalhead)).find(".ui-jqdialog-titlebar-close");
g.attr({tabindex:"0",href:"#",role:"button"});setTimeout(function(){g.focus()},50)}}(),u,E=function(b){if(13===b.which&&(b=a(this).find(".ui-pg-button").filter(":focus"),0<b.length))return b.trigger("click"),!1},B=ba.call(m,"hover"),F=ba.call(m,"disabled");if(m.grid){m.modalAlert=A;void 0===b&&(l.pager?(b=l.pager,l.toppager&&(q.cloneToTop=!0)):l.toppager&&(b=l.toppager));var k=1,C,I,G,J,K,O=["left","center","right"],M="<div class='ui-pg-button "+F+"'><span class='ui-separator'></span></div>",ha=function(){ca(this,
...
0;G<O.length;G++)O[G]!==q.position&&(K=a(I+"_"+O[G],I),0===K.length||0===K[0].childNodes.length?K.hide():1===K[0].childNodes.length&&(J=K[0].firstChild,!a(J).is("table.ui-pg-table")||0!==J.rows&&0!==J.rows[0].cells.length||K.hide()));l._nvtd&&(r>l._nvtd[0]&&(a(I+"_"+q.position,I).width(r),l._nvtd[0]=r),l._nvtd[1]=r);m.nav=!0;u.bind("keydown.jqGrid",E)}n.triggerHandler("jqGridResetFrozenHeights")}}})},navButtonAdd:function(b,c){"object"===typeof b&&(c=b,b=void 0);return this.each(function(){var e=
this,d=e.p;if(e.grid){var f=a.extend({caption:"newButton",title:"",onClickButton:null,position:"last",cursor:"pointer",iconsOverText:!1},D.getGridRes.call(a(e),"nav"),v.nav||{},d.navOptions||{},c||{}),g=ba.call(e,"hover"),h=ba.call(e,"disabled");if(void 0===b)if(d.pager)if(D.navButtonAdd.call(a(e),d.pager,f),d.toppager)b=d.toppager;else return;else d.toppager&&(b=d.toppager);"string"===typeof b&&0!==b.indexOf("#")&&(b="#"+H(b));var d=a(".navtable",b),m=f.commonIconClass;if(0<d.length&&!(f.id&&0<d.find("#"+
H(f.id)).length)){var l=a("<div tabindex='0' role='button'></div>");"NONE"===f.buttonicon.toString().toUpperCase()?a(l).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'>"+(f.caption?"<span class='ui-pg-button-text"+(f.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+f.caption+"</span>":"")+"</div>"):a(l).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'><span class='"+(f.iconsOverText?na("ui-pg-button-icon-over-text",m,f.buttonicon):na(m,f.buttonicon))+
...
C.idx+"' "+(r.groupCollapse&&0<C.idx?"style='display:none;' ":"")+"role='row' class='"+B+" "+q+"'>";var I=a.isFunction(r.groupText[C.idx])?r.groupText[C.idx].call(f,m,C.cnt,C.summary):v.template(r.groupText[C.idx],m,C.cnt,C.summary),G=1,J,K,O;O=0;K=x-1===C.idx;"string"!==typeof I&&"number"!==typeof I&&(I=m);"header"===r.groupSummaryPos[C.idx]?(G=1,"cb"!==A[0].name&&"cb"!==A[1].name||G++,"subgrid"!==A[0].name&&"subgrid"!==A[1].name||G++,d+=e(k,0,C,G,n+"<span class='cell-wrapper'>"+I+"</span>")):d+=
"<td role='gridcell' style='padding-left:"+12*C.idx+"px;' colspan='"+u+"'>"+n+I+"</td>";d+="</tr>";if(K){I=y[k+1];K=C.startRow;G=void 0!==I?I.startRow:y[k].startRow+y[k].cnt;r._locgr&&(O=(E-1)*c,O>C.startRow&&(K=O));for(;K<G&&b[K-O];K++)d+=b[K-O].join("");if("header"!==r.groupSummaryPos[C.idx]){if(void 0!==I){for(J=0;J<r.groupField.length&&I.dataIndex!==r.groupField[J];J++);h=r.groupField.length-J}for(O=0;O<h;O++)t[O]&&(d+="<tr data-jqfootlevel='"+(C.idx-O)+(r.groupCollapse&&(0<C.idx-O||!r.showSummaryOnHide)?
"' style='display:none;'":"'")+" role='row' class='"+F+"'>",d+=e(k,O,y[C.idx-O],0),d+="</tr>");h=J}}});this.unbind("jqGridShowHideCol.groupingRender").bind("jqGridShowHideCol.groupingRender",function(){var b=g.iColByName[r.iconColumnName],c,d,e;if(0<=a.inArray("header",r.groupSummaryPos)){for(c=0;c<A.length;c++)if(!A[c].hidden){e=c;break}if(void 0!==e&&b!==e){for(c=0;c<f.rows.length;c++)d=f.rows[c],a(d).hasClass("jqgroup")&&(a(d.cells[e]).html(d.cells[b].innerHTML),a(d.cells[b]).html("&nbsp;"));r.iconColumnName=
...
d.colModel.splice(d.colModel.length-1));switch(b.exptype){case "xmlstring":c="<"+b.root+">"+wa.json2xml(d,b.ident)+"</"+b.root+">";break;case "jsonstring":c="{"+wa.toJson(d,b.root,b.ident,!1)+"}",void 0!==d.postData.filters&&(c=c.replace(/filters":"/,'filters":'),c=c.replace(/\}\]\}"/,"}]}"))}}});return c},excelExport:function(b){b=a.extend({exptype:"remote",url:null,oper:"oper",tag:"excel",exportOptions:{}},b||{});return this.each(function(){var c;this.grid&&"remote"===b.exptype&&(c=a.extend({},
...
focusField:!0},v.inlineEdit,e.inlineEditing||{},p),q=d.jqGrid("getInd",b,!0),k=n.focusField,C="object"===typeof k&&null!=k?a(k.target||k).closest("tr.jqgrow>td")[0]:null;if(!1!==q&&(n.extraparam[m.oper]===m.addoper||Ya.call(c,n,"beforeEditRow",n,b))&&"0"===(a(q).attr("editable")||"0")&&!a(q).hasClass("not-editable-row")){m=v.detectRowEditing.call(c,b);if(null!=m&&"cellEditing"===m.mode){var m=m.savedRow,I=c.rows[m.id],G=ba.call(c,"select");d.jqGrid("restoreCell",m.id,m.ic);a(I.cells[m.ic]).removeClass("edit-cell "+
...
""===l&&(l="null");w[d.name]=l}),!1===B[0])try{var G=q.jqGrid("getGridRowById",b),D=v.findPos(G);t.call(p,k,B[1],C,{left:D[0],top:D[1]+a(G).outerHeight()})}catch(K){alert(B[1])}else if(G=b,A=r.prmNames,D=!1===r.keyName?A.id:r.keyName,w&&(w[A.oper]=A.editoper,void 0===w[D]||""===w[D]?w[D]=b:E.id!==r.idPrefix+w[D]&&(E=v.stripPref(r.idPrefix,b),void 0!==r._index[E]&&(r._index[w[D]]=r._index[E],delete r._index[E]),b=r.idPrefix+w[D],F.attr("id",b),r.selrow===G&&(r.selrow=b),a.isArray(r.selarrrow)&&(E=
...
a.fn[b].apply(c,a.makeArray(arguments).slice(2)):a.isFunction(b)&&b.apply(c,a.makeArray(arguments).slice(2)))}var e=this,d=e[0].p,f,g,h={},m=[],l,n,p=d.colModel;l=p.length;n=d.colNames;var q=function(a){return R&&R.prototype&&a.data(R.prototype.widgetFullName||R.prototype.widgetName)||a.data("ui-multiselect")||a.data("multiselect")};if(!a("#colchooser_"+H(d.id)).length){f=a('<div id="colchooser_'+d.id+'" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>');
...
return{index:-1,result:0}};la.prototype.getIndexOfDifferences=function(a,c){return null===c||null===a?0:this.compareVectorsEx(a,c).index};la.prototype.compareVectors=function(a,c){var e=this.compareVectorsEx(a,c);return 0<(0<=e.index?this.fieldSortDirection[e.index]:1)?e.result:-e.result};la.prototype.getItem=function(a){return this.items[a]};la.prototype.getIndexLength=function(){return this.items.length};la.prototype.getIndexesOfSourceData=function(a){return this.indexesOfSourceData[a]};la.prototype.createDataIndex=
...
e.template&&void 0===e.formatter&&m.defaultFormatting&&(e.template="count"===e.aggregator?"integer":"number"),H.push(ba(a,e,d,b,c))};N=function(b,c,d){var f,g,h,k;for(f=G-1;f>=c;f--)if(K[f]){for(g=0;g<=f;g++)T=J[g].groupHeaders,T[T.length-1].numberOfColumns+=D;r=E[f];h=r.totalHeader;k=r.headerOnTop;for(g=f+1;g<=G-1;g++)J[g].groupHeaders.push({titleText:k&&g===f+1||!k&&g===G-1?a.isFunction(h)?h.call(e,d,f):v.template.call(e,h||"",d[f],f):"",startColumnName:"y"+(b-1)+"t"+f+(1===D?"":"a0"),numberOfColumns:D})}};
var aa=function(a){a=new ua("count"===B[a].aggregator?"sum":B[a].aggregator,e,c);a.groupInfo={iRows:[],rows:[],ys:[],iYs:[]};return a},ca=function(){var a,b;for(a=G-1;0<=a;a--)if(K[a])for(null==Q[a]&&(Q[a]=Array(D)),b=0;b<D;b++)Q[a][b]=aa(b)},da=function(a,b,c,d){var e,f=R.getIndexOfDifferences(b,c),g,h;if(null!==c)for(f=Math.max(f,0),e=G-1;e>=f;e--)g="y"+a+"t"+e+(1<D?"a"+d:""),K[e]&&void 0===L[g]&&(h=Q[e][d],h.getResult(L,g),L.pivotInfos[g]={colType:1,iA:d,a:B[d],level:e,iRows:h.groupInfo.iRows,
rows:h.groupInfo.rows,ys:h.groupInfo.ys,iYs:h.groupInfo.iYs},b!==c&&(Q[e][d]=aa(d)))},ea=function(c,d,e,f,g,h,k){var l;if(c!==d)for(d=G-1;0<=d;d--)K[d]&&(l=Q[d][f],l.calc(g[e.member],e.member,g,h,b),l=l.groupInfo,0>a.inArray(k,l.iYs)&&(l.iYs.push(k),l.ys.push(c)),0>a.inArray(h,l.iRows)&&(l.iRows.push(h),l.rows.push(g)))};if(0===C||0===D)throw"xDimension or aggregates options are not set!";W=n(u,m.skipSortByX,m.compareVectorsByX);R=n(E,m.skipSortByY,m.compareVectorsByY);c.xIndex=W;c.yIndex=R;for(n=
0;n<C;n++)p=u[n],t={name:"x"+n,label:null!=p.label?a.isFunction(p.label)?p.label.call(e,p,n,m):p.label:p.dataName,frozen:m.frozenStaticCols},n<C-1&&(g.groupField.push(t.name),g.groupSummary.push(m.groupSummary),g.groupSummaryPos.push(m.groupSummaryPos)),t=a.extend(t,p),delete t.dataName,delete t.footerText,H.push(t);2>C&&(h.grouping=!1);h.sortname=H[C-1].name;g.hideFirstGroupCol=!0;for(n=0;n<x;n++)r=E[n],K.push(r.totals||r.rowTotals||r.totalText||r.totalHeader?!0:!1);Y=R.getItem(0);y(0,x-1,0);g=R.getIndexLength();
for(t=1;t<g;t++){P=R.getItem(t);n=R.getIndexOfDifferences(P,Y);for(p=G-1;p>=n;p--)K[p]&&y(1,p,t-1);Y=P;y(0,x-1,t)}for(n=G-1;0<=n;n--)K[n]&&y(1,n,g-1);q&&y(2);Y=R.getItem(0);for(p=0;p<G;p++)J.push({useColSpanStyle:m.useColSpanStyle,groupHeaders:[{titleText:Y[p],startColumnName:1===D?"y0":"y0a0",numberOfColumns:D}]});for(t=1;t<g;t++){P=R.getItem(t);n=R.getIndexOfDifferences(P,Y);N(t,n,Y);for(p=G-1;p>=n;p--)J[p].groupHeaders.push({titleText:P[p],startColumnName:"y"+t+(1===D?"":"a0"),numberOfColumns:D});
for(p=0;p<n;p++)T=J[p].groupHeaders,T[T.length-1].numberOfColumns+=D;Y=P}N(g,0,Y);if(q)for(n=0;n<G;n++)J[n].groupHeaders.push({titleText:n<G-1?"":m.totalHeader||"",startColumnName:"t"+(1===D?"":"a0"),numberOfColumns:D});N=W.getIndexLength();for(x=0;x<N;x++){p=W.getItem(x);y={iX:x,x:p};L={pivotInfos:y};for(n=0;n<C;n++)L["x"+n]=p[n];z=W.getIndexesOfSourceData(x);if(q)for(p=0;p<D;p++)M[p]=aa(p);Y=null;ca();for(t=0;t<g;t++){P=R.getItem(t);U=R.getIndexesOfSourceData(t);for(p=0;p<D;p++){null!==Y&&da(t-
...
P}if(null!==Y)for(p=0;p<D;p++)da(g-1,Y,Y,p);if(q)for(p=0;p<D;p++)l="t"+(1===D?"":"a"+p),k=M[p],k.getResult(L,l),k=k.groupInfo,y[l]={colType:2,iA:p,a:B[p],iRows:k.iRows,rows:k.rows,iYs:k.iYs,ys:k.ys};d.push(L)}if(m.footerTotals||m.colTotals){q=d.length;for(n=0;n<C;n++)f["x"+n]=u[n].footerText||"";for(n=C;n<H.length;n++){l=H[n].name;F=new ua(m.footerAggregator||"sum",e,c);for(w=0;w<q;w++)L=d[w],F.calc(L[l],l,L,w,d);F.getResult(f,l)}}c.colHeaders=J;return{colModel:H,options:c,rows:d,groupOptions:h,groupHeaders:J,
...
d.attr("value")}else b[m[c].name]=a(this).html();c++});0<c&&n.push(b)});b.empty();b.jqGrid(a.extend({datatype:"local",width:d,colNames:l,colModel:m,multiselect:f},c||{}));for(d=0;d<n.length;d++)g=null,0<p.length&&(g=p[d])&&g.replace&&(g=encodeURIComponent(g).replace(/[.\-%]/g,"_")),null===g&&(g=a.jgrid.randId()),b.jqGrid("addRowData",g,n[d]);for(d=0;d<q.length;d++)b.jqGrid("setSelection",q[d])}})};var Ca=function(){var b=a.makeArray(arguments);b[0]="treeGrid"+b[0].charAt(0).toUpperCase()+b[0].substring(1);
b.unshift("");b.unshift("");b.unshift(this.p);return v.feedback.apply(this,b)};v.extend({setTreeNode:function(){return this.each(function(){var b=a(this),c=this.p;if(this.grid&&c.treeGrid){var e=c.treeReader.expanded_field,d=c.treeReader.leaf_field;b.unbind("jqGridBeforeSelectRow.setTreeNode");b.bind("jqGridBeforeSelectRow.setTreeNode",function(f,g,h){if(null!=h){f=a(h.target);h=f.closest("tr.jqgrow>td");var m=h.parent(),l=function(a){a=c.data[c._index[Na(c.idPrefix,a)]];var f=a[e]?"collapse":"expand";
...
if(Ca.call(this,"beforeExpandRow",{rowid:f,item:b})){var g=D.getNodeChildren.call(c,b);a(g).each(function(){var b=e.idPrefix+ma(this,e.localReader.id);a(D.getGridRowById.call(c,b)).css("display","");this[d]&&D.expandRow.call(c,this)});Ca.call(this,"afterExpandRow",{rowid:f,item:b})}}})},collapseRow:function(b){this.each(function(){var c=a(this),e=this.p;if(this.grid&&e.treeGrid){var d=e.treeReader.expanded_field,f=b[e.localReader.id];if(Ca.call(this,"beforeCollapseRow",{rowid:f,item:b})){var g=D.getNodeChildren.call(c,
b);a(g).each(function(){var b=e.idPrefix+ma(this,e.localReader.id);a(D.getGridRowById.call(c,b)).css("display","none");this[d]&&D.collapseRow.call(c,this)});Ca.call(this,"afterCollapseRow",{rowid:f,item:b})}}})},getRootNodes:function(){var b=[];this.each(function(){var c=this.p;if(this.grid&&c.treeGrid)switch(c.treeGridModel){case "nested":var e=c.treeReader.level_field;a(c.data).each(function(){parseInt(this[e],10)===parseInt(c.tree_root_level,10)&&b.push(this)});break;case "adjacency":var d=c.treeReader.parent_id_field;
...
c.treedatatype,D.setGridParam.call(a(this),{postData:"nested"===c.treeGridModel?{nodeid:l,n_level:b[g],n_left:b[h],n_right:b[m]}:{nodeid:l,n_level:b[g],parentid:b[d]}}),a(this).trigger("reloadGrid"),b[f]=!0,D.setGridParam.call(a(this),{postData:"nested"===c.treeGridModel?{nodeid:"",n_level:"",n_left:"",n_right:""}:{nodeid:"",n_level:"",parentid:""}}));Ca.call(this,"afterExpandNode",{rowid:l,item:b})}}}})},collapseNode:function(b){return this.each(function(){var c=this.p;if(this.grid&&c.treeGrid){var e=
c.treeReader.expanded_field;if(b[e]){var d=ma(b,c.localReader.id);Ca.call(this,"beforeCollapseNode",{rowid:d,item:b})&&(b[e]=!1,e=a("#"+c.idPrefix+H(d),this.grid.bDiv)[0],a("div.treeclick",e).removeClass(c.treeIcons.minus+" tree-minus").addClass(c.treeIcons.commonIconClass).addClass(c.treeIcons.plus+" tree-plus"),Ca.call(this,"afterCollapseNode",{rowid:d,item:b}))}}})},SortTree:function(b,c,e,d){return this.each(function(){var f=this,g=f.p,h=a(f);if(f.grid&&g.treeGrid){var m,l,n,p=[];m=D.getRootNodes.call(h);
...
1;var C=D.getFullTreeNode.call(f,p);if(C.length){var I,G,H;for(I=0;I<C.length;I++)H=C[I][h.localReader.id],G=m.call(f,H),G>r&&(r=G,t=H)}r++;p[x]&&(w=!0,p[y]=!0,a(g.rows[k]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(h.treeIcons.leaf+" tree-leaf").addClass(h.treeIcons.commonIconClass).addClass(h.treeIcons.minus+" tree-minus"),h.data[n][x]=!1,p[F]=!0)}m=r+1;void 0===e[y]&&(e[y]=!1);void 0===e[F]&&(e[F]=!1);e[A]=q;void 0===
e[x]&&(e[x]=!0);"adjacency"===h.treeGridModel&&(e[u]=c);if("nested"===h.treeGridModel){var K;if(null!==c){x=parseInt(p[B],10);h=v.from.call(g,h.data);h=h.greaterOrEquals(B,x,{stype:"integer"});A=h.select();if(A.length)for(K in A)A.hasOwnProperty(K)&&(A[K][E]=A[K][E]>x?parseInt(A[K][E],10)+2:A[K][E],A[K][B]=A[K][B]>=x?parseInt(A[K][B],10)+2:A[K][B]);e[E]=x;e[B]=x+1}else{x=parseInt(D.getCol.call(f,B,!1,"max"),10);A=v.from.call(g,h.data).greater(E,x,{stype:"integer"}).select();if(A.length)for(K in A)A.hasOwnProperty(K)&&
(A[K][E]=parseInt(A[K][E],10)+2);A=v.from.call(g,h.data).greater(B,x,{stype:"integer"}).select();if(A.length)for(K in A)A.hasOwnProperty(K)&&(A[K][B]=parseInt(A[K][B],10)+2);e[E]=x+1;e[B]=x+2}}if(null===c||D.isNodeLoaded.call(f,p)||w)D.addRowData.call(f,b,e,l,t),D.setTreeNode.call(f,r,m);p&&!p[y]&&d&&a(g.rows[k]).find("div.treeclick").click()}}});var ra="mousedown",ka="mousemove",za="mouseup",yb=function(a){var c=a.originalEvent.targetTouches;return c?(c=c[0],{x:c.pageX,y:c.pageY}):{x:a.pageX,y:a.pageY}},
La={drag:function(a){var c=a.data,e=c.e,d=c.dnr,f=c.ar,c=c.dnrAr;a=yb(a);"move"===d.k?e.css({left:d.X+a.x-d.pX,top:d.Y+a.y-d.pY}):(e.css({width:Math.max(a.x-d.pX+d.W,0),height:Math.max(a.y-d.pY+d.H,0)}),c&&f.css({width:Math.max(a.x-c.pX+c.W,0),height:Math.max(a.y-c.pY+c.H,0)}));return!1},stop:function(){a(document).unbind(ka,La.drag).unbind(za,La.stop)}},zb=function(b,c,e,d){return b.each(function(){c=c?a(c,b):b;c.bind(ra,{e:b,k:e},function(b){var c=b.data,e={},m,l,n=function(a,b){return parseInt(a.css(b),
...
n(l,"height")||0,pX:p.x,pY:p.y,k:c.k}:!1;c=b.find("input.hasDatepicker");if(0<c.length)try{c.datepicker("hide")}catch(q){}b={e:b,dnr:m,ar:l,dnrAr:e};a(document).bind(ka,b,La.drag);a(document).bind(za,b,La.stop);return!1}})})};window.PointerEvent?(ra+=".jqGrid pointerdown.jqGrid",ka+=".jqGrid pointermove.jqGrid",za+=".jqGrid pointerup.jqGrid"):window.MSPointerEvent?(ra+=".jqGrid mspointerdown.jqGrid",ka+=".jqGrid mspointermove.jqGrid",za+=".jqGrid mspointerup"):(ra+=".jqGrid touchstart.jqGrid",ka+=
".jqGrid touchmove.jqGrid",za+=".jqGrid touchend.jqGrid");a.jqDnR=La;a.fn.jqDrag=function(a){return zb(this,a,"move")};a.fn.jqResize=function(a,c){return zb(this,a,"resize",c)};var Ma=0,ja,sa=[],pb=function(b){try{a(":input:visible",b.w).first().focus()}catch(c){}},Ib=function(b){var c=ja[sa[sa.length-1]],e=!a(b.target).parents(".jqmID"+c.s)[0],d=a(b.target).offset(),f=void 0!==b.pageX?b.pageX:d.left,g=void 0!==b.pageY?b.pageY:d.top,d=function(){var b=!1;a(".jqmID"+c.s).each(function(){var c=a(this),
