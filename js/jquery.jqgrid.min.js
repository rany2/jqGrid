...
c&&"abort"!==d){var e=a(this.grid.eDiv),f=b.getResponseHeader("Content-Type"),g=e.children(".ui-jqgrid-error"),h=b.responseText||"";if("text/html"===f){var l=document.createElement("div"),m;m=/<body[^>]*>([\s\S]*)<\/body\s*>/gim.exec(h);l.innerHTML=null!=m&&2===m.length?m[1]:h;h=l.getElementsByTagName("script");for(m=h.length;m--;)h[m].parentNode.removeChild(h[m]);h=l.innerHTML}else if("application/json"===f)try{l=a.parseJSON(h);f=[];for(m in l)"StackTrace"!==m&&f.push(m+": "+l[m]);h=f.join("<br />")}catch(n){}500!==
b.status&&0!==b.status&&(h=(c||d)+" "+b.status+" "+b.statusText+(""!==a.trim(a(h).text())?"<hr />"+h:""));g.html(h||c||d);e.show();k.errorDisplayTimeout&&setTimeout(function(){g.empty();e.hide()},k.errorDisplayTimeout)}},loadBeforeSend:null,afterInsertRow:null,beforeRequest:null,beforeProcessing:null,onHeaderClick:null,viewrecords:!1,loadonce:!1,forceClientSorting:!1,multiselect:!1,multikey:!1,editurl:"clientArray",search:!1,caption:"",hidegrid:!0,hiddengrid:!1,useUnformattedDataForCellAttr:!0,postData:{},
userData:{},treeGrid:!1,treeGridModel:"nested",treeReader:{},treeANode:-1,ExpandColumn:null,tree_root_level:0,prmNames:{page:"page",rows:"rows",sort:"sidx",order:"sord",search:"_search",nd:"nd",id:"id",oper:"oper",editoper:"edit",addoper:"add",deloper:"del",subgridid:"id",npage:null,totalrows:"totalrows"},forceFit:!1,gridstate:"visible",cellEdit:!1,iCol:-1,iRow:-1,nv:0,loadui:"enable",toolbar:[!1,""],scroll:!1,multiboxonly:!1,deselectAfterSort:!0,multiPageSelection:!1,scrollrows:!1,autowidth:!1,scrollOffset:18,
cellLayout:5,subGridWidth:16,multiselectWidth:16,multiselectPosition:"left",gridview:null==b||null==b.afterInsertRow,rownumWidth:25,rownumbers:!1,pagerpos:"center",footerrow:!1,userDataOnFooter:!1,hoverrows:!0,altclass:"ui-priority-secondary",viewsortcols:[!1,"vertical",!0],resizeclass:"",autoencode:!1,autoEncodeOnEdit:!1,remapColumns:[],cmNamesInputOrder:[],ajaxGridOptions:{},direction:A,toppager:!1,headertitles:!1,scrollTimeout:40,maxItemsToJoin:32768,data:[],lastSelectedData:[],quickEmpty:"quickest",
_index:{},iColByName:{},iPropByName:{},reservedColumnNames:["rn","cb","subgrid"],grouping:!1,groupingView:{groupField:[],groupOrder:[],groupText:[],groupColumnShow:[],groupSummary:[],showSummaryOnHide:!1,sortitems:[],sortnames:[],summary:[],summaryval:[],displayField:[],groupSummaryPos:[],formatDisplayField:[],_locgr:!1,commonIconClass:B("grouping.common"),plusicon:B("grouping.plus"),minusicon:B("grouping.minus")},ignoreCase:!0,cmTemplate:{},idPrefix:"",iconSet:u,guiStyle:E,locale:y,multiSort:!1,
treeIcons:{commonIconClass:B("treeGrid.common"),plusLtr:B("treeGrid.plusLtr"),plusRtl:B("treeGrid.plusRtl"),minus:B("treeGrid.minus"),leaf:B("treeGrid.leaf")},subGridOptions:{commonIconClass:B("subgrid.common"),plusicon:B("subgrid.plus"),minusicon:B("subgrid.minus")}},Ta,{navOptions:n(!0,{commonIconClass:B("nav.common"),editicon:B("nav.edit"),addicon:B("nav.add"),delicon:B("nav.del"),searchicon:B("nav.search"),refreshicon:B("nav.refresh"),viewicon:B("nav.view"),saveicon:B("nav.save"),cancelicon:B("nav.cancel"),
buttonicon:B("nav.newbutton")},v.nav||{}),actionsNavOptions:n(!0,{commonIconClass:B("actions.common"),editicon:B("actions.edit"),delicon:B("actions.del"),saveicon:B("actions.save"),cancelicon:B("actions.cancel")},v.actionsNav||{}),formEditing:n(!0,{commonIconClass:B("form.common"),prevIcon:B("form.prev"),nextIcon:B("form.next"),saveicon:[!0,"left",B("form.save")],closeicon:[!0,"left",B("form.undo")]},v.edit||{}),searching:n(!0,{commonIconClass:B("search.common"),findDialogIcon:B("search.search"),
resetDialogIcon:B("search.reset"),queryDialogIcon:B("search.query")},v.search||{}),formViewing:n(!0,{commonIconClass:B("form.common"),prevIcon:B("form.prev"),nextIcon:B("form.next"),closeicon:[!0,"left",B("form.cancel")]},v.view||{}),formDeleting:n(!0,{commonIconClass:B("form.common"),delicon:[!0,"left",B("form.del")],cancelicon:[!0,"left",B("form.cancel")]},v.del||{})},b||{}),C=function(a){var b=v.getRes(k,a);return void 0!==b?b:w.call(h,"defaults."+a)};k.recordpos=k.recordpos||("rtl"===k.direction?
"left":"right");k.subGridOptions.openicon="rtl"===k.direction?B("subgrid.openRtl"):B("subgrid.openLtr");k.autoResizing.widthOfVisiblePartOfSortIcon=void 0!==k.autoResizing.widthOfVisiblePartOfSortIcon?k.autoResizing.widthOfVisiblePartOfSortIcon:"fontAwesome"===k.iconSet?13:12;k.datatype=void 0!==k.datatype?k.datatype:void 0!==e||null==k.url?"local":null!=k.jsonReader&&"object"===typeof k.jsonReader?"json":"xml";k.jsonReader=k.jsonReader||{};k.url=k.url||"";k.cellsubmit=void 0!==k.cellsubmit?k.cellsubmit:
void 0===k.cellurl?"clientArray":"remote";k.gridview=void 0!==k.gridview?k.gridview:null==k.afterInsertRow;void 0!==e&&(k.data=e,b.data=e);void 0!==g&&(k.datastr=g,b.datastr=g);if("TABLE"!==d.tagName.toUpperCase())x("Element is not a table!");else if(""===d.id&&h.attr("id",Ia()),void 0!==document.documentMode&&5>=document.documentMode)x("Grid can not be used in this ('quirks') mode!");else{h.empty().attr("tabindex","0");d.p=k;k.id=d.id;k.idSel="#"+I(d.id);k.gBoxId=hb.call(d,0);k.gBox=gb.call(d,0);
k.gViewId=hb.call(d,8);k.gView=gb.call(d,8);k.rsId=hb.call(d,43);k.rs=gb.call(d,43);k.cbId=hb.call(d,45);k.cb=gb.call(d,45);k.useProp=!!a.fn.prop;k.propOrAttr=k.useProp?"prop":"attr";var H=k.propOrAttr,G=v.fixScrollOffsetAndhBoxPadding,K=function(a){var b={},c,d=a.length;for(c=0;c<d;c++)b[a[c].name]=c;return b},J=function(a){var b={},c,d=a.length,e;for(c=0;c<d;c++)e=a[c],b["string"===typeof e?e:e.name]=c;return b},O=function(){var b={},c,d;this.p.rowIndexes=b;for(d=0;d<this.rows.length;d++)c=this.rows[d],
a(c).hasClass("jqgrow")&&(b[c.id]=c.rowIndex)},D=function(){var b,c=k.colModel;b=k.cmNamesInputOrder;var d=k.additionalProperties,e=b.length,f,g,h,l;k.arrayReaderInfos={};f=k.arrayReaderInfos;for(l=0;l<e;l++)g=b[l],0>p(g,k.reservedColumnNames)&&!f.hasOwnProperty(g)&&(h=k.iColByName[g],void 0!==h?f[g]={name:c[h].name,index:h,order:l,type:0}:(h=k.iPropByName[g],void 0!==h?f[g]={name:c[h].name,index:h,order:l,type:1}:g===(k.prmNames.rowidName||"rowid")&&(f[g]={index:h,type:2})));e=c.length;for(b=0;b<
e;b++)g=c[b].name,0>p(g,k.reservedColumnNames)&&!f.hasOwnProperty(g)&&(f[g]={name:g,index:b,order:l,type:0},l++);e=d.length;for(b=0;b<e;b++)g=d[b],null==g||f.hasOwnProperty(g)||("object"===typeof g&&"string"===a.type(g.name)&&(g=g.name),f[g]={name:g,index:b,order:l,type:1},l++)},ha=function(b){var c=a(this).data("pageX");c?(c=String(c).split(";"),c=c[c.length-1],a(this).data("pageX",c+";"+b.pageX)):a(this).data("pageX",b.pageX)},N=function(a,b){a=parseInt(a,10);return isNaN(a)?b||0:a},z={headers:[],
...
e-c.pageX);ha.call(this.curGbox,c);Q.call(Ha(21,f)[0],"resizeStart",c,b);document.onselectstart=function(){return!1};a(document).bind("mousemove.jqGrid",function(a){if(z.resizing)return z.dragMove(a),!1}).bind("mouseup.jqGrid"+k.id,function(){if(z.resizing)return z.dragEnd(),!1})},dragMove:function(b){var c=this.resizing;if(c){var d=b.pageX+c.delta-c.startX,e=this.headers;b=e[c.idx];var f="ltr"===k.direction?b.width+d:b.width-d,g=((k.colModel[c.idx]||{}).autoResizing||{}).minColWidth||k.minResizingWidth;
c.moved=!0;f>g&&(null==this.curGbox&&(this.curGbox=a(k.rs)),this.curGbox.css({left:c.sOL+d}),!0===k.forceFit?(c=e[c.idx+k.nv],d="ltr"===k.direction?c.width-d:c.width+d,d>k.autoResizing.minColWidth&&(b.newWidth=f,c.newWidth=d)):(this.newWidth="ltr"===k.direction?k.tblwidth+d:k.tblwidth-d,b.newWidth=f))}},resizeColumn:function(b,d,e){var f=this.headers,g=this.footers,h=f[b],l=h.newWidth||h.width,m=Ha(21,this.bDiv),n=Ha(14,this.hDiv).children("thead").children("tr").first()[0].cells,l=parseInt(l,10);
k.colModel[b].width=l;h.width=l;n[b].style.width=l+"px";this.cols[b].style.width=l+"px";this.fbRows&&(a(this.fbRows[0].cells[b]).css("width",l),a(Ha(31,this.fhDiv)[0].rows[0].cells[b]).css("width",l),k.footerrow&&a(Ha(36,this.fsDiv)[0].rows[0].cells[b]).css("width",l));0<g.length&&(g[b].style.width=l+"px");!0!==e&&G.call(m[0]);!0===k.forceFit?(f=f[b+k.nv],l=f.newWidth||f.width,f.width=l,n[b+k.nv].style.width=l+"px",this.cols[b+k.nv].style.width=l+"px",0<g.length&&(g[b+k.nv].style.width=l+"px"),k.colModel[b+
k.nv].width=l):(k.tblwidth=this.newWidth||k.tblwidth,!0!==e&&(this.hDiv.scrollLeft=this.bDiv.scrollLeft,k.footerrow&&(Ha(27,this.sDiv).css("width",k.tblwidth+"px"),this.sDiv.scrollLeft=this.bDiv.scrollLeft)));k.autowidth||void 0!==k.widthOrg&&"auto"!==k.widthOrg&&"100%"!==k.widthOrg||!0===e||c.setGridWidth.call(m,this.newWidth+k.scrollOffset,!1);d||Q.call(m[0],"resizeStop",l,b)},dragEnd:function(){this.hDiv.style.cursor="default";this.resizing&&(null!==this.resizing&&!0===this.resizing.moved&&(a(this.headers[this.resizing.idx].el).removeData("autoResized"),
this.resizeColumn(this.resizing.idx,!1)),a(k.rs).removeData("pageX"),this.resizing=!1,setTimeout(function(){a(k.rs).css("display","none").prependTo(k.gBox)},k.doubleClickSensitivity));this.curGbox=null;document.onselectstart=function(){return!0};a(document).unbind("mousemove.jqGrid").unbind("mouseup.jqGrid"+k.id)},populateVisible:function(){var b=this,c=a(b),d=b.grid,e=d.bDiv,f=a(e);d.timer&&clearTimeout(d.timer);d.timer=null;if(f=f.height()){var g,h;if(b.rows.length)try{h=(g=b.rows[1])?a(g).outerHeight()||
d.prevRowHeight:d.prevRowHeight}catch(l){h=d.prevRowHeight}if(h){d.prevRowHeight=h;g=k.rowNum;d.scrollTop=e.scrollTop;var e=d.scrollTop,m=Math.round(c.position().top)-e,c=m+c.height();h*=g;var n,p,r;c<f&&0>=m&&(void 0===k.lastpage||(parseInt((c+e+h-1)/h,10)||0)<=k.lastpage)&&(p=parseInt((f-c+h-1)/h,10)||1,0<=c||2>p||!0===k.scroll?(n=(Math.round((c+e)/h)||0)+1,m=-1):m=1);0<m&&(n=(parseInt(e/h,10)||0)+1,p=(parseInt((e+f)/h,10)||0)+2-n,r=!0);!p||k.lastpage&&(n>k.lastpage||1===k.lastpage||n===k.page&&
n===k.lastpage)||(d.hDiv.loading?d.timer=setTimeout(function(){d.populateVisible.call(b)},k.scrollTimeout):(k.page=n,r&&(d.selectionPreserver.call(b),d.emptyRows.call(b,!1,!1)),d.populate.call(b,p)))}}},scrollGrid:function(a){var b=Ha(21,this);a&&a.stopPropagation();if(0===b.length)return!0;var c=b[0].grid;k.scroll&&(a=this.scrollTop,void 0===c.scrollTop&&(c.scrollTop=0),a!==c.scrollTop&&(c.scrollTop=a,c.timer&&clearTimeout(c.timer),c.timer=setTimeout(function(){c.populateVisible.call(b[0])},k.scrollTimeout)));
c.hDiv.scrollLeft=this.scrollLeft;k.footerrow&&(c.sDiv.scrollLeft=this.scrollLeft)},selectionPreserver:function(){var b=a(this),c=k.selrow,d=k.selarrrow?a.makeArray(k.selarrrow):null,e=this.grid.bDiv,f=e.scrollLeft,g=function(){var a;k.selrow=null;if(!k.multiPageSelection){V(k.selarrrow);if(k.multiselect&&d&&0<d.length)for(a=0;a<d.length;a++)d[a]!==c&&t.call(b,d[a],!1,null);c&&t.call(b,c,!1,null)}e.scrollLeft=f;b.unbind(".selectionPreserver",g)};b.bind("jqGridGridComplete.selectionPreserver",g)}};
d.grid=z;Q.call(d,"beforeInitGrid");k.iColByName=K(k.colModel);k.iPropByName=J(k.additionalProperties);var P=a("<div class='ui-jqgrid-view' role='grid' aria-multiselectable='"+!!k.multiselect+"'></div>"),U=v.msie,Ba=U&&8>v.msiever();k.direction=q(k.direction.toLowerCase());-1===p(k.direction,["ltr","rtl"])&&(k.direction="ltr");la=k.direction;a(P).insertBefore(d);h.removeClass("scroll").appendTo(P);var X=a("<div class='"+F("gBox","ui-jqgrid")+"'></div>");a(X).attr({id:k.gBoxId,dir:la}).insertBefore(P);
a(P).attr("id",k.gViewId).appendTo(X);a("<div class='"+F("overlay","jqgrid-overlay")+"' id='lui_"+k.id+"'></div>").insertBefore(P);a("<div class='"+F("loading","loading")+"' id='load_"+k.id+"'>"+C("loadtext")+"</div>").insertBefore(P);Ba&&h.attr({cellspacing:"0"});h.attr({role:"presentation","aria-labelledby":"gbox_"+d.id});var L=function(){var a=k.remapColumns,b=k.colModel,c=b.length,d=[],e,f;for(e=0;e<c;e++)f=b[e].name,0>p(f,k.reservedColumnNames)&&d.push(f);if(null!=a)for(b=d.slice(),e=0;e<a.length;e++)d[e]=
b[a[e]];k.cmNamesInputOrder=d},Y=function(a,b,c,e,f,g){var h=k.colModel[a],l=c,n=h.classes,p=h.align?"text-align:"+h.align+";":"",r,q=function(a){return"string"===typeof a?a.replace(/\'/g,"&#39;"):a},t=" aria-describedby='"+k.id+"_"+h.name+"'";!0===h.hidden&&(p+="display:none;");if(0===b)p+="width: "+z.headers[a].width+"px;";else if(m(h.cellattr)||"string"===typeof h.cellattr&&null!=v.cellattr&&m(v.cellattr[h.cellattr]))if(a=m(h.cellattr)?h.cellattr:v.cellattr[h.cellattr],k.useUnformattedDataForCellAttr&&
null!=g?l=g[h.name]:h.autoResizable&&(l="<span class='"+k.autoResizing.wrapperClassName+"'>",l=c.substring(l.length,c.length-7)),e=a.call(d,f,l,e,h,g),"string"===typeof e)for(e=e.replace(/\n/g,"&#xA;");;){c=/^\s*(\w+[\w|\-]*)\s*=\s*([\"|\'])(.*?)\2(.*)/.exec(e);if(null===c||5>c.length)return!r&&h.title&&(r=l),t+" style='"+q(p)+"'"+(n?" class='"+q(n)+"'":"")+(r?" title='"+q(r)+"'":"");f=c[3];e=c[4];switch(c[1].toLowerCase()){case "class":n=n?n+(" "+f):f;break;case "title":r=f;break;case "style":p+=
f;break;default:t+=" "+c[1]+"="+c[2]+f+c[2]}}h=(""!==p?"style='"+p+"'":"")+((void 0!==n?" class='"+n+"'":"")+(h.title&&l?" title='"+ib(c).replace(/\'/g,"&apos;")+"'":""));return h+=t},T=function(a){return null==a||""===a?"&#160;":k.autoencode?sb(a):String(a)},$a=function(a){var b=k.treeReader,c=b.loaded,d=b.leaf_field,e=b.expanded_field,f=function(a){return!0===a||"true"===a||"1"===a};if("nested"===k.treeGridModel&&!a[d]){var g=parseInt(a[b.left_field],10),b=parseInt(a[b.right_field],10);a[d]=b===
g+1?!0:!1}void 0!==a[c]&&(a[c]=f(a[c]));a[d]=f(a[d]);a[e]=f(a[e])},Db=function(b,c,e,f,g,h){var l=k.colModel[e];if(void 0!==l.formatter){b=""!==String(k.idPrefix)?Oa(k.idPrefix,b):b;var n={rowId:b,colModel:l,gid:k.id,pos:e,rowData:h};c=m(l.cellBuilder)?l.cellBuilder.call(d,c,n,f,g):m(l.formatter)?l.formatter.call(d,c,n,f,g):a.fmatter?a.fn.fmatter.call(d,l.formatter,c,n,f,g):T(c)}else c=T(c);c=l.autoResizable&&"actions"!==l.formatter?"<span class='"+k.autoResizing.wrapperClassName+"'>"+c+"</span>":
c;k.treeGrid&&"edit"!==g&&(void 0===k.ExpandColumn&&0===e||k.ExpandColumn===l.name)&&(null==h&&(h=k.data[k._index[b]]),b=parseInt(h[k.treeReader.level_field]||0,10),b=0===parseInt(k.tree_root_level,10)?b:b-1,e=h[k.treeReader.leaf_field],g=h[k.treeReader.expanded_field],h=h[k.treeReader.icon_field],c="<div class='tree-wrap' style='width:"+18*(b+1)+"px;'><div class='"+oa(k.treeIcons.commonIconClass,e?(null!=h&&""!==h?h:k.treeIcons.leaf)+" tree-leaf":g?k.treeIcons.minus+" tree-minus":k.treeIcons.plus+
" tree-plus","treeclick")+"' style='"+(!0===k.ExpandColClick?"cursor:pointer;":"")+("rtl"===k.direction?"margin-right:":"margin-left:")+18*b+"px;'></div></div><span class='cell-wrapper"+(e?"leaf":"")+"'"+(k.ExpandColClick?" style='cursor:pointer;'":"")+">"+c+"</span>");return c},M=function(b,c){var d=z.bDiv,e=null!=z.fbDiv?z.fbDiv.children(".ui-jqgrid-btable")[0]:null,f=function(b){if(b){var c=b.rows,d=c[0];if(k.deepempty)c&&a(c).slice(1).remove();else if(k.quickEmpty)if("quickest"===k.quickEmpty)b.replaceChild(document.createElement("tbody"),
b.tBodies[0]),b.firstChild.appendChild(d);else for(;1<c.length;)b.deleteRow(c.length-1);else a(b.firstChild).empty().append(d)}};a(this).unbind(".jqGridFormatter");f(this);f(e);b&&k.scroll&&(a(d.firstChild).css({height:"auto"}),a(d.firstChild.firstChild).css({height:0,display:"none"}),0!==d.scrollTop&&(d.scrollTop=0));!0===c&&k.treeGrid&&(V(k.data),V(k.lastSelectedData),k._index={});k.rowIndexes={};k.iRow=-1;k.iCol=-1},ya=function(){var a=k.data,b=a.length,c,e,f,g,h,p,r,q=k.localReader,t=k.additionalProperties,
u=q.cell,w,v,x,z=k.arrayReaderInfos;if("local"!==k.datatype||!0!==q.repeatitems){if(k.treeGrid)for(c=0;c<b;c++)$a(a[c])}else for(g=!1===k.keyName?m(q.id)?q.id.call(d,a):q.id:k.keyName,isNaN(g)?m(g)||null==k.arrayReaderInfos[g]||(h=k.arrayReaderInfos[g].order):h=Number(g),c=0;c<b;c++){e=a[c];f=u?na(e,u)||e:e;v=l(f);r={};for(w in z)z.hasOwnProperty(w)&&(x=z[w],p=na(f,v?x.order:x.name),1===x.type&&(x=t[x.index],null!=x&&m(x.convert)&&(p=x.convert(p,f))),void 0!==p&&(r[w]=p));void 0!==r[g]?e=void 0!==
r[g]?r[g]:Ia():(e=na(e,l(e)?h:g),void 0===e&&(e=na(f,l(f)?h:g)),void 0===e&&(e=Ia()));e=String(e);r[q.id]=e;k.treeGrid&&$a(r);n(a[c],r)}},mb=function(){var a=k.data.length,b,c,d;b=!1===k.keyName||k.loadonce?k.localReader.id:k.keyName;k._index={};for(c=0;c<a;c++)d=na(k.data[c],b),void 0===d&&(d=String(c+1)),k._index[d]=c},ba=function(b,d,e,f,g,h){var l="-1",n="",p,r=d?"display:none;":"";e=F("gridRow","jqgrow ui-row-"+k.direction)+(e?" "+e:"")+(h?" "+F("states.select"):"");h=a(this).triggerHandler("jqGridRowAttr",
[f,g,b]);"object"!==typeof h&&(h=m(k.rowattr)?k.rowattr.call(this,f,g,b):"string"===typeof k.rowattr&&null!=v.rowattr&&m(v.rowattr[k.rowattr])?v.rowattr[k.rowattr].call(this,f,g,b):{});if(null!=h&&!a.isEmptyObject(h)){h.hasOwnProperty("id")&&(b=h.id,delete h.id);h.hasOwnProperty("tabindex")&&(l=h.tabindex,delete h.tabindex);h.hasOwnProperty("style")&&(r+=h.style,delete h.style);h.hasOwnProperty("class")&&(e+=" "+h["class"],delete h["class"]);try{delete h.role}catch(q){}for(p in h)h.hasOwnProperty(p)&&
(n+=" "+p+"="+h[p])}k.treeGrid&&parseInt(f[k.treeReader.level_field],10)!==parseInt(k.tree_root_level,10)&&(((f=c.getNodeParent.call(a(this),f))&&f.hasOwnProperty(k.treeReader.expanded_field)?f[k.treeReader.expanded_field]:1)||d||(r+="display:none;"));return'<tr role="row" id="'+b+'" tabindex="'+l+'" class="'+e+'"'+(""===r?"":' style="'+r+'"')+n+">"},aa=function(){var b,c,d=a.fn.fmatter;for(b=0;b<k.colModel.length;b++)c=k.colModel[b].formatter,"string"===typeof c&&null!=d&&m(d[c])&&m(d[c].pageFinalization)&&
d[c].pageFinalization.call(this,b)},ab=function(b,c){var e,f,g=k.colModel,h=g.length,l,n=function(a){return null==a||""===a?"&#160;":sb(a)},p=function(a){return null==a||""===a?"&#160;":String(a)};for(e=0;e<h;e++)f=g[e],f.cellBuilder=null,b||(l={colModel:f,gid:k.id,pos:e},void 0===f.formatter?f.cellBuilder=k.autoencode?n:p:"string"===typeof f.formatter&&null!=a.fn.fmatter&&m(a.fn.fmatter.getCellBuilder)?f.cellBuilder=a.fn.fmatter.getCellBuilder.call(d,f.formatter,l,c||"add"):m(f.getCellBuilder)&&
(f.cellBuilder=f.getCellBuilder.call(d,l,c||"add")))},Fa=function(b,d,e,f){var g=a(this),h=new Date,n=k.datatype,p="local"!==n&&k.loadonce||"xmlstring"===n||"jsonstring"===n,r=("xmlstring"===n||"xml"===n)&&a.isXMLDoc(b),q=k.localReader,t=na;if(b&&("xml"!==n||r)){-1!==k.treeANode||k.scroll?d=1<d?d:1:(z.emptyRows.call(this,!1,!0),d=1);p&&(V(k.data),V(k.lastSelectedData),k._index={},k.grouping&&null!=k.groupingView&&(k.groupingView.groups=[],k.groupingView._locgr=!1),k.localReader.id="_id_");k.reccount=
0;switch(n){case "xml":case "xmlstring":q=k.xmlReader;t=v.getXmlData;break;case "json":case "jsonp":case "jsonstring":q=k.jsonReader}var u,w,x,C,E,y={},H,B=k.colModel,G=B.length,A,F,K,va,J,P=k.arrayReaderInfos,ha={},D=function(a){return function(b){b=b.getAttribute(a);return null!==b?b:void 0}},Pa=function(a){return function(){var b=ha[a];if(null!=b)return b=b.childNodes,0<b.length?b[0].nodeValue:void 0}};k.page=N(t(b,q.page),k.page);k.lastpage=N(t(b,q.total),1);k.records=N(t(b,q.records));m(q.userdata)?
k.userData=q.userdata.call(this,b)||{}:r?t(b,q.userdata,!0).each(function(){k.userData[this.getAttribute("name")]=a(this).text()}):k.userData=t(b,q.userdata)||{};ab();var U={},Ja=k.additionalProperties,I=function(a,b){r&&"string"===typeof b&&(/^\w+$/.test(b)?U[a]=Pa(b):/^\[\w+\]$/.test(b)&&(U[a]=D(b.substring(1,b.length-1))))},fa=function(a){var b=a.name,c=r?a.xmlmap||b:"local"===n&&!k.dataTypeOrg||"json"===n||"jsonp"===n?a.jsonmap||b:b;!1!==k.keyName&&!0===a.key&&(k.keyName=b);if("string"===typeof c||
m(c))U[b]=c;m(c)||I(b,c)};for(u=0;u<G;u++)fa(B[u]);G=Ja.length;for(u=0;u<G;u++)F=Ja[u],"object"===typeof F&&null!=F?fa(F):I(F,F);C=!1===k.keyName?m(q.id)?q.id.call(this,b):q.id:k.keyName;isNaN(C)?m(C)||(P[C]&&(E=P[C].order),r&&("string"===typeof C&&/^\[\w+\]$/.test(C)?C=D(C.substring(1,C.length-1)):"string"===typeof C&&/^\w+$/.test(C)&&(C=Pa(C)))):E=Number(C);x=t(b,q.root,!0);if(q.row)if(1===x.length&&"string"===typeof q.row&&/^\w+$/.test(q.row)){G=[];K=x[0].childNodes;va=K.length;for(F=0;F<va;F++)J=
K[F],1===J.nodeType&&J.nodeName===q.row&&G.push(J);x=G}else x=t(x,q.row,!0);null==x&&l(b)&&(x=b);x||(x=[]);b=x.length;0<b&&0>=k.page&&(k.page=1);fa=parseInt(k.rowNum,10);f&&(fa*=f+1);var B=[],Za=[],L,G=[];for(u=0;u<b;u++){L=x[u];w=q.repeatitems&&q.cell?t(L,q.cell,!0)||L:L;H=q.repeatitems&&(r||l(w));y={};ha={};if(r&&!H&&null!=w)for(K=w.childNodes,va=K.length,F=0;F<va;F++)J=K[F],1===J.nodeType&&(ha[J.nodeName]=J);for(A in P)P.hasOwnProperty(A)&&(F=P[A],H?(K=w[F.order],r&&null!=K&&(K=K.textContent||
K.text)):K=null!=U[A]&&"string"!==typeof U[A]?U[A](w):t(w,"string"===typeof U[A]?U[A]:F.name),1===F.type&&(F=Ja[F.index],null!=F&&m(F.convert)&&(K=F.convert(K,w))),void 0!==K&&(y[A]=K));void 0!==y[C]?L=void 0!==y[C]?y[C]:Ia():(L=t(L,l(L)?E:C),void 0===L&&(L=t(w,l(w)?E:C)),void 0===L&&(L=Ia()));L=String(L);H=k.idPrefix+L;k.treeGrid&&$a(y);if(u<fa)Za.push(H),B.push(w),G.push(y);else if(!p)break;if(p||!0===k.treeGrid)y._id_=L,k.data.push(y),k._index[y._id_]=k.data.length-1}if(!p||!k.forceClientSorting||
!0===k.treeGrid){d=v.parseDataToHtml.call(this,b,Za,G,B,d,f,p);ab(!0);f=-1<k.treeANode?k.treeANode:0;q=a(this.tBodies[0]);!0===k.treeGrid&&0<f?a(this.rows[f]).after(d.join("")):k.scroll?q.append(d.join("")):(null==this.firstElementChild||void 0!==document.documentMode&&9>=document.documentMode?q.html(q.html()+d.join("")):this.firstElementChild.innerHTML+=d.join(""),this.grid.cols=this.rows[0].cells);k.grouping&&O.call(this);if(!0===k.subGrid)try{c.addSubGrid.call(g,k.iColByName.subgrid)}catch(T){}if(!1===
k.gridview||m(k.afterInsertRow))for(u=0;u<Math.min(b,fa);u++)Q.call(this,"afterInsertRow",Za[u],G[u],B[u]);k.totaltime=new Date-h;0<u&&0===k.records&&(k.records=b);V(d);if(!0===k.treeGrid)try{c.setTreeNode.call(g,f+1,u+f+1)}catch(T){}k.reccount=Math.min(b,fa);k.treeANode=-1;k.userDataOnFooter&&c.footerData.call(g,"set",k.userData,!0);p&&(k.records=b,k.lastpage=Math.ceil(b/fa));e||this.updatepager(!1,!0);aa.call(this)}}},db=function(){function b(a){var c=0,d,e,f,g,h,l,p;if(null!=a.groups){(e=a.groups.length&&
"OR"===a.groupOp.toString().toUpperCase())&&G.orBegin();for(d=0;d<a.groups.length;d++){0<c&&e&&G.or();try{b(a.groups[d])}catch(q){x(q)}c++}e&&G.orEnd()}if(null!=a.rules)try{(f=a.rules.length&&"OR"===a.groupOp.toString().toUpperCase())&&G.orBegin();for(d=0;d<a.rules.length;d++)h=a.rules[d],g=a.groupOp.toString().toUpperCase(),H[h.op]&&h.field?(0<c&&g&&"OR"===g&&(G=G.or()),p=n[h.field],l=p.reader,G=H[h.op](G,g)(m(l)?'jQuery.jgrid.getAccessor(this,jQuery("'+k.idSel+'")[0].p.colModel['+p.iCol+"].jsonmap)":
"jQuery.jgrid.getAccessor(this,'"+l+"')",h.data,n[h.field])):null!=k.customSortOperations&&null!=k.customSortOperations[h.op]&&m(k.customSortOperations[h.op].filter)&&(G=G.custom(h.op,h.field,h.data)),c++;f&&G.orEnd()}catch(q){x(q)}}var d=a(this),e=k.multiSort?[]:"",f={},g=!1,n={},p=[],q=[],t=w.call(h,"formatter.date.srcformat"),u=w.call(h,"formatter.date.newformat");if(!l(k.data))return{};k.multiSort&&ub(e,f);var C=k.grouping?k.groupingView:!1,z,y,E=function(a,b,c){var d=a.index||a.name,f=a.sorttype||
"text";n[a.name]={reader:k.dataTypeOrg?a.name:a.jsonmap||a.name,iCol:b,stype:f,srcfmt:"",newfmt:"",sfunc:a.sortfunc||null,isAddProp:!0===c?!0:!1};if("date"===f||"datetime"===f)a.formatter&&"string"===typeof a.formatter&&"date"===a.formatter?(b=a.formatoptions&&a.formatoptions.srcformat?a.formatoptions.srcformat:t,c=a.formatoptions&&a.formatoptions.newformat?a.formatoptions.newformat:u):b=c=a.datefmt||"Y-m-d",n[a.name].srcfmt=b,n[a.name].newfmt=c;if(k.grouping)for(y=0,z=C.groupField.length;y<z;y++)a.name===
C.groupField[y]&&(p[y]=n[d],q[y]=d);k.multiSort||g||a.index!==k.sortname&&a.name!==k.sortname||(e=a.name,g=!0)};r(k.colModel,function(a){E(this,a)});r(k.additionalProperties,function(a){E("string"===typeof this?{name:this}:this,a,!0)});if(k.treeGrid)return c.SortTree.call(d,e,k.sortorder,null!=n[e]&&n[e].stype?n[e].stype:"text",null!=n[e]&&n[e].srcfmt?n[e].srcfmt:""),!1;var H={eq:function(a){return a.equals},ne:function(a){return a.notEquals},lt:function(a){return a.less},le:function(a){return a.lessOrEquals},
...
nn:function(a,b){return"OR"===b?a.orNot().isNull:a.andNot().isNull}},G=v.from.call(this,k.data);k.ignoreCase&&(G=G.ignoreCase());if(!0===k.search){var B=k.postData.filters;if(B)"string"===typeof B&&(B=v.parse(B)),b(B);else try{G=H[k.postData.searchOper](G)(k.postData.searchField,k.postData.searchString,n[k.postData.searchField])}catch(F){}}if(k.grouping)for(y=0;y<z;y++)G.orderBy(q[y],C.groupOrder[y],p[y].stype,p[y].srcfmt);k.multiSort?r(e,function(){G.orderBy(this,f[this],n[this].stype,n[this].srcfmt,
n[this].sfunc)}):e&&k.sortorder&&g&&G.orderBy(k.sortname,"DESC"===k.sortorder.toUpperCase()?"d":"a",n[e].stype,n[e].srcfmt,n[e].sfunc);k.lastSelectedData=G.select();var B=parseInt(k.rowNum,10),A=k.lastSelectedData.length,K=parseInt(k.page,10),va=Math.ceil(A/B),J={};if(k.grouping&&k.groupingView._locgr){k.groupingView.groups=[];var O,P,N;if(k.footerrow&&k.userDataOnFooter){for(P in k.userData)k.userData.hasOwnProperty(P)&&(k.userData[P]=0);N=!0}for(O=0;O<A;O++){if(N)for(P in k.userData)k.userData.hasOwnProperty(P)&&
(k.userData[P]+=parseFloat(k.lastSelectedData[O][P]||0));c.groupingPrepare.call(d,k.lastSelectedData[O],O,B)}}n=G=null;d=k.localReader;J[d.total]=va;J[d.page]=K;J[d.records]=A;J[d.root]=k.lastSelectedData.slice((K-1)*B,K*B);J[d.userdata]=k.userData;return J},eb=function(b){var c=b.outerWidth();0>=c&&(c=a(this).closest(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px",a(document.body).append("<div id='testpg' class='"+F("gBox","ui-jqgrid")+"' style='font-size:"+c+";visibility:hidden;margin:0;padding:0;' ></div>"),
a(b).clone().appendTo("#testpg"),c=a("#testpg>.ui-pg-table").width(),a("#testpg").remove());0<c&&b.parent().width(c);return c},va=function(b,c){var d=this,e=a(d),f=d.grid,g,l,m,n,p,q,r=k.pager||"",t=k.pager?"_"+k.pager.substr(1):"";g=f.bDiv;var u=a.fmatter?a.fmatter.NumberFormat:null,x=k.toppager?"_"+k.toppager.substr(1):"",z=F("states.hover"),y=F("states.disabled");l=parseInt(k.page,10)-1;0>l&&(l=0);l*=parseInt(k.rowNum,10);n=l+k.reccount;if(k.scroll){q=a(Ha(21,g)[0].rows).slice(1);l=n-q.length;
k.reccount=q.length;if(q=q.outerHeight()||f.prevRowHeight)m=l*q,p=v.fixMaxHeightOfDiv.call(d,parseInt(k.records,10)*q),a(g).children("div").first().css({height:p+"px"}).children("div").first().css({height:m+"px",display:m+"px"?"":"none"}),0===g.scrollTop&&1<k.page&&(g.scrollTop=k.rowNum*(k.page-1)*q);g.scrollLeft=f.hDiv.scrollLeft}if(r+=k.toppager?(r?",":"")+k.toppager:"")q=w.call(h,"formatter.integer")||{},f=N(k.page),g=N(k.lastpage),a(".selbox",r)[H]("disabled",!1),!0===k.pginput&&(a(".ui-pg-input",
r).val(k.page),m=k.toppager?"#sp_1"+t+",#sp_1"+x:"#sp_1"+t,a(m).html(a.fmatter?u(k.lastpage,q):k.lastpage).closest(".ui-pg-table").each(function(){eb.call(d,a(this))})),k.viewrecords&&(0===k.reccount?a(".ui-paging-info",r).html(C("emptyrecords")):(m=l+1,p=k.records,a.fmatter&&(m=u(m,q),n=u(n,q),p=u(p,q)),a(".ui-paging-info",r).html(v.format(C("recordtext"),m,n,p)))),!0===k.pgbuttons&&(0>=g&&(f=0),0>=f&&(f=g=0),1===f||0===f?(a("#first"+t+", #prev"+t).addClass(y).removeClass(z),k.toppager&&a("#first_t"+
x+", #prev_t"+x).addClass(y).removeClass(z)):(a("#first"+t+", #prev"+t).removeClass(y),k.toppager&&a("#first_t"+x+", #prev_t"+x).removeClass(y)),f===g||0===f?(a("#next"+t+", #last"+t).addClass(y).removeClass(z),k.toppager&&a("#next_t"+x+", #last_t"+x).addClass(y).removeClass(z)):(a("#next"+t+", #last"+t).removeClass(y),k.toppager&&a("#next_t"+x+", #last_t"+x).removeClass(y)));!0===b&&!0===k.rownumbers&&a(">td.jqgrid-rownum",d.rows).each(function(b){a(this).html(l+1+b)});c&&k.jqgdnd&&e.jqGrid("gridDnD",
"updateDnD");Q.call(d,"gridComplete");e.triggerHandler("jqGridAfterGridComplete")},Pa=function(){this.grid.hDiv.loading=!0;k.hiddengrid||c.progressBar.call(a(this),{method:"show",loadtype:k.loadui,htmlcontent:C("loadtext")})},Ja=function(){this.grid.hDiv.loading=!1;c.progressBar.call(a(this),{method:"hide",loadtype:k.loadui})},fa=function(b){var e=this,f=a(e),g=e.grid;if(!g.hDiv.loading){var h=k.scroll&&!1===b,l={},p,q=k.prmNames;0>=k.page&&(k.page=Math.min(1,k.lastpage));null!==q.search&&(l[q.search]=
k.search);null!==q.nd&&(l[q.nd]=(new Date).getTime());if(isNaN(parseInt(k.rowNum,10))||0>=parseInt(k.rowNum,10))k.rowNum=k.maxRowNum;null!==q.rows&&(l[q.rows]=k.rowNum);null!==q.page&&(l[q.page]=k.page);null!==q.sort&&(l[q.sort]=k.sortname);null!==q.order&&(l[q.order]=k.sortorder);null!==k.rowTotal&&null!==q.totalrows&&(l[q.totalrows]=k.rowTotal);var r=m(k.loadComplete),t=r?k.loadComplete:null,u=0;b=b||1;1<b?null!==q.npage?(l[q.npage]=b,u=b-1,b=1):t=function(a){k.page++;g.hDiv.loading=!1;r&&k.loadComplete.call(e,
a);fa.call(e,b-1)}:null!==q.npage&&delete k.postData[q.npage];if(k.grouping&&c.groupingSetup){c.groupingSetup.call(f);var x=k.groupingView,w,C="",y,E,H;for(w=0;w<x.groupField.length;w++){y=x.groupField[w];for(E=0;E<k.colModel.length;E++)H=k.colModel[E],H.name===y&&H.index&&(y=H.index);C+=y+" "+x.groupOrder[w]+", "}l[q.sort]=C+l[q.sort]}n(k.postData,l);var B=k.scroll?e.rows.length-1:1,A=function(){G.call(e);var a=f.width(),b=f.closest(".ui-jqgrid-view").width(),d=f.css("height");b<a&&0===k.reccount?
...
"local";k.datastr=null;A()},K=function(a){f.triggerHandler("jqGridLoadComplete",[a]);t&&t.call(e,a);F();f.triggerHandler("jqGridAfterLoadComplete",[a]);h&&g.populateVisible.call(e);1===b&&Ja.call(e);A()},va=function(){var a=db.call(e);Fa.call(e,a,B,1<b,u);K(a)};if(Q.call(e,"beforeRequest"))if(m(k.datatype))k.datatype.call(e,k.postData,"load_"+k.id,B,b,u);else switch(l=k.datatype.toLowerCase(),l){case "json":case "jsonp":case "xml":case "script":a.ajax(n({url:k.url,type:k.mtype,dataType:l,data:v.serializeFeedback.call(d,
k.serializeGridData,"jqGridSerializeGridData",k.postData),success:function(c,d,f){k.jqXhr=null;a(z.eDiv).hide();if(m(k.beforeProcessing)&&!1===k.beforeProcessing.call(e,c,d,f))Ja.call(e);else if(Fa.call(e,c,B,1<b,u),K(c),k.loadonce||k.treeGrid)k.dataTypeOrg=k.datatype,k.datatype="local",k.forceClientSorting&&va()},error:function(a,c,d){k.jqXhr=null;m(k.loadError)&&k.loadError.call(e,a,c,d);1===b&&Ja.call(e)},beforeSend:function(a,b){var c=!0;m(k.loadBeforeSend)&&(c=k.loadBeforeSend.call(e,a,b));void 0===
c&&(c=!0);if(!1===c)return!1;k.jqXhr=a;Pa.call(e)}},v.ajaxOptions,k.ajaxGridOptions));break;case "xmlstring":Pa.call(e);p="string"===typeof k.datastr?a.parseXML(k.datastr):k.datastr;Fa.call(e,p);q();k.forceClientSorting&&va();break;case "jsonstring":Pa.call(e);p="string"===typeof k.datastr?v.parse(k.datastr):k.datastr;Fa.call(e,p);q();k.forceClientSorting&&va();break;case "local":case "clientside":Pa.call(e),k.datatype="local",va()}}},jb=function(b){var c=this.grid;a(k.cb,c.hDiv)[k.propOrAttr]("checked",
b);if(k.frozenColumns)a(k.cb,c.fhDiv)[k.propOrAttr]("checked",b)},vb=function(b,c){var e=F("states.hover"),f=F("states.disabled"),g="<td class='ui-pg-button "+f+"'><span class='ui-separator'></span></td>",h="",l="<table "+(Ba?"cellspacing='0' ":"")+"style='table-layout:auto;white-space: pre;"+("left"===k.pagerpos?"margin-right:auto;":"right"===k.pagerpos?"margin-left:auto;":"margin-left:auto;margin-right:auto;")+"' class='ui-pg-table'><tbody><tr>",m="",n,p,q,r,t=function(a,b,c){if(!Q.call(d,"onPaging",
a,{newPage:b,currentPage:N(k.page,1),lastPage:N(k.lastpage,1),currentRowNum:N(k.rowNum,10),newRowNum:c}))return!1;k.selrow=null;k.multiselect&&(k.multiPageSelection||V(k.selarrrow),jb.call(d,!1));V(k.savedRow);return!0};c+="_"+b;n="pg_"+b;p=b+"_left";q=b+"_center";r=b+"_right";a("#"+I(b)).append("<div id='"+n+"' class='ui-pager-control' role='group'><table "+(Ba?"cellspacing='0' ":"")+"class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;'><tbody><tr><td id='"+p+"' style='text-align:left;'></td><td id='"+
q+"' style='text-align:center;white-space:pre;'></td><td id='"+r+"' style='text-align:right;'></td></tr></tbody></table></div>").attr("dir","ltr");n="#"+I(n);if(0<k.rowList.length){m="<td dir='"+la+"'>";p=C("pgrecs");m+="<select class='"+F("pagerSelect","ui-pg-selbox")+"' "+(p?"title='"+p+"'":"")+">";for(p=0;p<k.rowList.length;p++)q=k.rowList[p].toString().split(":"),1===q.length&&(q[1]=q[0]),m+="<option value='"+q[0]+"'"+(N(k.rowNum,0)===N(q[0],0)?" selected='selected'":"")+">"+q[1]+"</option>";
m+="</select></td>"}"rtl"===la&&(l+=m);!0===k.pginput&&(h="<td dir='"+la+"'>"+v.format(C("pgtext")||"","<input class='"+F("pagerInput","ui-pg-input")+"' type='text' size='2' maxlength='7' value='0'/>","<span id='sp_1_"+b+"'>0</span>")+"</td>");b="#"+I(b);if(!0===k.pgbuttons){q=["first","prev","next","last"];var u=F("pagerButton","ui-pg-button");r=function(a){var b=C("pg"+a);return"<td role='button' tabindex='0' id='"+a+c+"' class='"+u+"' "+(b?"title='"+b+"'":"")+"><span class='"+B("pager."+a)+"'></span></td>"};
"rtl"===la&&q.reverse();for(p=0;p<q.length;p++)l+=r(q[p]),1===p&&(l+=""!==h?g+h+g:"")}else""!==h&&(l+=h);"ltr"===la&&(l+=m);l+="</tr></tbody></table>";!0===k.viewrecords&&a("td"+b+"_"+k.recordpos,n).append("<span dir='"+la+"' style='text-align:"+k.recordpos+"' class='ui-paging-info'></span>");var w=a("td"+b+"_"+k.pagerpos,n);w.append(l);g=eb.call(this,w.children(".ui-pg-table"));k._nvtd=[];k._nvtd[0]=g?Math.floor((k.width-g)/2):Math.floor(k.width/3);k._nvtd[1]=0;l=null;a(".ui-pg-selbox",n).bind("change",
function(){var b=N(this.value,10),c=Math.round(k.rowNum*(k.page-1)/b-.5)+1;if(!t("records",c,b))return!1;k.page=c;k.rowNum=b;k.pager&&a(".ui-pg-selbox",k.pager).val(b);k.toppager&&a(".ui-pg-selbox",k.toppager).val(b);fa.call(d);return!1});!0===k.pgbuttons&&(a(".ui-pg-button",n).hover(function(){ca(this,f)?this.style.cursor="default":(a(this).addClass(e),this.style.cursor="pointer")},function(){ca(this,f)||(a(this).removeClass(e),this.style.cursor="default")}),a("#first"+I(c)+", #prev"+I(c)+", #next"+
I(c)+", #last"+I(c)).click(function(){if(ca(this,f))return!1;var a=N(k.page,1),b=a,e=this.id,g=N(k.lastpage,1),h=!1,l=!0,m=!0,n=!0,p=!0;0===g||1===g?(1>=a&&(m=l=!1),p=n=!1):1<g&&1<=a?1===a?m=l=!1:a===g&&(p=n=!1):1<g&&0===a&&(p=n=!1,a=g-1);this.id==="first"+c&&l&&(e="first",b=1,h=!0);this.id==="prev"+c&&m&&(e="prev",b=a-1,h=!0);this.id==="next"+c&&n&&(e="next",b=a+1,h=!0);this.id==="last"+c&&p&&(e="last",b=g,h=!0);if(!t(e,b,N(k.rowNum,10)))return!1;k.page=b;h&&fa.call(d);return!1}));!0===k.pginput&&
a("input.ui-pg-input",n).bind("keypress.jqGrid",function(b){b=b.charCode||b.keyCode||0;var c=N(a(this).val(),1);if(13===b){if(!t("user",c,N(k.rowNum,10)))return!1;a(this).val(c);k.page=0<a(this).val()?a(this).val():k.page;fa.call(d);return!1}return this});w.children(".ui-pg-table").bind("keydown.jqGrid",function(a){13===a.which&&(a=w.find(":focus"),0<a.length&&a.trigger("click"))})},ub=function(b,c,d){r((k.sortname+" "+k.sortorder).split(","),function(){var c=a.trim(this).split(" ");2===c.length&&
b.push(c[0])});if(null!=d){var e=a.inArray(d.index||d.name,b);""!==d.lso&&0>e?b.push(d.index||d.name):""===d.lso&&0<=e&&b.splice(e,1)}r(k.colModel,function(){var d=this.index||this.name,e;this.lso&&(e=this.lso.split("-"),0>a.inArray(d,b)&&b.push(d),c[d]=e[e.length-1])})},Eb=function(b,c){var e="",f=k.colModel[b],g="",h=F("states.disabled"),l=k.frozenColumns?a(c):a(d.grid.headers[b].el),g=l.find("span.s-ico"),m=g.children("span.ui-icon-asc"),n=g.children("span.ui-icon-desc"),p=m,q=n,t=[],u={};l.find("span.ui-grid-ico-sort").addClass(h);
l.attr("aria-selected","false");f.lso?(g.show(),g=f.lso.split("-"),g=g[g.length-1],"desc"===g&&(p=n,q=m),p.removeClass(h).css("display",""),k.showOneSortIcon&&q.hide(),l.attr("aria-selected","true")):k.viewsortcols[0]||g.hide();ub(t,u,f);r(t,function(){0<e.length&&(e+=", ");e+=this+" "+u[this];k.sortorder=u[this]});k.sortname=e.substring(0,e.length-k.sortorder.length-1)},wb=function(b,d,e,f,g){var h=this.grid,l=k.colModel[d],m=F("states.disabled");if(null!=l&&l.sortable&&!(0<k.savedRow.length)){e||
(k.lastsort===d&&""!==k.sortname?(k.sortorder="asc"===k.sortorder?"desc":"desc"===k.sortorder?"asc":l.firstsortorder||"asc",l.lso?"asc"===l.lso?l.lso+="-desc":"desc"===l.lso?l.lso+="-asc":"asc-desc"!==l.lso&&"desc-asc"!==l.lso||!k.threeStateSort&&!k.multiSort||(l.lso=""):l.lso=l.firstsortorder||"asc"):l.lso=k.sortorder=l.firstsortorder||"asc",k.page=1);if(k.multiSort)Eb(d,g);else{if(f){if(k.lastsort===d&&k.sortorder===f&&!e)return;k.sortorder=f}l=h.headers;e=h.fhDiv;f=l[k.lastsort]?a(l[k.lastsort].el):
a();g=k.frozenColumns?a(g):a(l[d].el);var n=g.find("span.s-ico"),p=n.children("span.ui-icon-"+k.sortorder),q=n.children("span.ui-icon-"+("asc"===k.sortorder?"desc":"asc")),l=k.colModel[k.lastsort];f.find("span.ui-grid-ico-sort").addClass(m);f.attr("aria-selected","false");k.frozenColumns&&(e.find("span.ui-grid-ico-sort").addClass(m),e.find("th").attr("aria-selected","false"));k.viewsortcols[0]||(k.lastsort!==d?(k.frozenColumns&&e.find("span.s-ico").hide(),f.find("span.s-ico").hide(),n.show()):""===
k.sortname&&n.show());k.lastsort!==d&&"true"===f.data("autoResized")&&(null!=l&&null!=l.autoResizing&&l.autoResizing.compact||k.autoResizing.compact)&&k.columnsToReResizing.push(k.lastsort);l=k.colModel[d];n.css("display","");""!==l.lso?(p.removeClass(m).css("display",""),k.showOneSortIcon&&q.removeClass(m).hide(),g.attr("aria-selected","true")):(g.attr("aria-selected","false"),k.threeStateSort&&(k.sortorder="",k.viewsortcols[0]||n.hide()));k.lastsort!==d&&"true"===g.data("autoResized")&&(null!=l&&
null!=l.autoResizing&&l.autoResizing.compact||k.autoResizing.compact)&&k.columnsToReResizing.push(d);b=b.substring(5+k.id.length+1);k.sortname=l.index||b}Q.call(this,"onSortCol",k.sortname,d,k.sortorder)?("local"===k.datatype?k.deselectAfterSort&&!k.multiPageSelection&&c.resetSelection.call(a(this)):k.multiPageSelection||(k.selrow=null,k.multiselect&&(jb.call(this,!1),V(k.selarrrow))),V(k.savedRow),k.scroll&&(m=h.bDiv.scrollLeft,z.emptyRows.call(this,!0,!1),h.hDiv.scrollLeft=m),k.subGrid&&"local"===
k.datatype&&a("td.sgexpanded","#"+I(k.id)).each(function(){a(this).trigger("click")}),fa.call(this),k.lastsort=d,k.sortname!==b&&d&&(k.lastsort=d)):k.lastsort=d}},Fb=function(){var a=0,b=v.cell_width?0:N(k.cellLayout,0),c=0,d,e=N(k.scrollOffset,0),f,g=!1,h,l=0,m,n=v.isCellClassHidden;r(k.colModel,function(){void 0===this.hidden&&(this.hidden=!1);if(k.grouping&&k.autowidth){var d=p(this.name,k.groupingView.groupField);0<=d&&k.groupingView.groupColumnShow.length>d&&(this.hidden=!k.groupingView.groupColumnShow[d])}this.widthOrg=
...
c)-e):g||1===Math.abs(z.width-l-(a+b*c))||(m=z.width-l-(a+b*c)),k.colModel[d].width+=m,k.tblwidth=a+m+b*c+l,k.tblwidth>k.width&&(k.colModel[d].width-=k.tblwidth-parseInt(k.width,10),k.tblwidth=k.width))},Gb=function(a){var b=a,c;for(c=a+1;c<k.colModel.length;c++)if(!0!==k.colModel[c].hidden){b=c;break}return b-a},fb;-1===p(k.multikey,["shiftKey","altKey","ctrlKey"])&&(k.multikey=!1);k.keyName=!1;k.sortorder=k.sortorder.toLowerCase();v.cell_width=v.cellWidth();var kb=v.cmTemplate,Z,la;for(Z=0;Z<k.colModel.length;Z++)S=
k.colModel[Z],fb="string"===typeof S.template?null==kb||"object"!==typeof kb[S.template]&&!a.isFunction(kb[S.template])?{}:kb[S.template]:S.template,m(fb)&&(fb=fb.call(d,{cm:S,iCol:Z})),S=n(!0,{},k.cmTemplate,fb||{},S),!1===k.keyName&&!0===S.key&&(k.keyName=S.name),k.colModel[Z]=S;for(Z=0;Z<k.additionalProperties.length;Z++)S=k.additionalProperties[Z],!1===k.keyName&&!0===S.key&&(k.keyName=S.name);if(0===k.colNames.length)for(Z=0;Z<k.colModel.length;Z++)k.colNames[Z]=void 0!==k.colModel[Z].label?
k.colModel[Z].label:k.colModel[Z].name;if(k.colNames.length!==k.colModel.length)x(w.call(h,"errors.model"));else{!0===k.grouping&&(k.scroll=!1,k.rownumbers=!1,k.treeGrid=!1,k.gridview=!0);if(k.subGrid)try{c.setSubGrid.call(h)}catch(tb){}if(k.multiselect&&("left"===k.multiselectPosition||"right"===k.multiselectPosition)){var W="left"===k.multiselectPosition?"unshift":"push";k.colNames[W]("<input id='"+k.cbId+"' class='cbox' type='checkbox' aria-checked='false'/>");k.colModel[W]({name:"cb",width:v.cell_width?
...
cell:"cell"}},k.localReader);k.scroll&&(k.pgbuttons=!1,k.pginput=!1,k.rowList=[]);if(!0===k.treeGrid){try{c.setTreeGrid.call(h)}catch(tb){}"local"!==k.datatype&&(k.localReader={id:"_id_"});k.iPropByName=J(k.additionalProperties)}L();D();k.data.length&&(ya.call(d),mb());if(!0===k.shrinkToFit&&!0===k.forceFit)for(Z=k.colModel.length-1;0<=Z;Z--)if(!0!==k.colModel[Z].hidden){k.colModel[Z].resizable=!1;break}var da,ea,R,ga,S,ta,ja,ma,qa=[],Da=[],ka=[],ia="<thead><tr class='ui-jqgrid-labels' role='row'>",
Aa,ua="<tbody><tr>",ra=F("states.hover"),sa=F("states.disabled");if(k.multiSort){var qa=k.sortname.split(","),wa;for(wa=0;wa<qa.length;wa++)ka=q(qa[wa]).split(" "),qa[wa]=q(ka[0]),Da[wa]=ka[1]?q(ka[1]):k.sortorder||"asc"}for(Z=0;Z<k.colNames.length;Z++){S=k.colModel[Z];ta=k.headertitles||S.headerTitle?" title='"+ib("string"===typeof S.headerTitle?S.headerTitle:k.colNames[Z])+"'":"";ia+="<th id='"+k.id+"_"+S.name+"' class='"+F("colHeaders","ui-th-column ui-th-"+la+" "+(S.labelClasses||""))+"'"+ta+
">";da=S.index||S.name;switch(S.labelAlign){case "left":ja="text-align:left;";break;case "right":ja="text-align:right;"+(!1===S.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;");break;case "likeData":ja=void 0===S.align||"left"===S.align?"text-align:left;":"right"===S.align?"text-align:right;"+(!1===S.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;"):"";break;default:ja=""}ia+="<div id='jqgh_"+k.id+"_"+S.name+"'"+(U?" class='ui-th-div-ie'":
"")+(""===ja?"":" style='"+ja+"'")+">";Aa=S.autoResizable&&"actions"!==S.formatter?"<span class='"+k.autoResizing.wrapperClassName+"'>"+k.colNames[Z]+"</span>":k.colNames[Z];k.sortIconsBeforeText?(ia+=(k.builderSortIcons||v.builderSortIcons).call(d,Z),ia+=Aa):(ia+=Aa,ia+=(k.builderSortIcons||v.builderSortIcons).call(d,Z));ia+="</div></th>";ua+="<td></td>";S.width=S.width?parseInt(S.width,10):150;"boolean"!==typeof S.title&&(S.title=!0);S.lso="";da===k.sortname&&(k.lastsort=Z,S.lso=k.sortorder||S.firstsortorder||
"asc");k.multiSort&&(ka=p(da,qa),-1!==ka&&(S.lso=Da[ka]))}var ia=ia+"</tr></thead>",ua=ua+"</tr></tbody>",xa=a("<table class='"+F("hTable","ui-jqgrid-htable")+"' style='width:1px' role='presentation' aria-labelledby='gbox_"+k.id+"'"+(Ba?" cellspacing='0'":"")+">"+ia+ua+"</table>");a(xa[0].tHead).children("tr").children("th").hover(function(){a(this).addClass(ra)},function(){a(this).removeClass(ra)});k.multiselect&&a(k.cb,xa).bind("click",function(){var b=F("states.select"),c,e=[],f=k.iColByName.cb,
...
k.selarrrow.push(k.idPrefix+m)}else c=!1,k.selrow=null;a(d.rows).each(function(a){ca(this,l)||(g(this,c),(c?k.selarrrow:e).push(this.id),h&&g(h[a],c))});Q.call(d,"onSelectAll",c?k.selarrrow:e,c)});if(!0===k.autowidth){var Ka=Math.floor(a(X).innerWidth());k.width=0<Ka?Ka:"nw"}isNaN(k.width)?isNaN(parseFloat(k.width))||(k.width=parseFloat(k.width)):k.width=Number(k.width);k.widthOrg=k.width;Fb();a(X).css("width",z.width+"px").append("<div class='"+F("resizer","ui-jqgrid-resize-mark")+"' id='"+k.rsId+
"'>&#160;</div>");a(k.rs).bind("selectstart",function(){return!1}).click(ha).dblclick(function(b){var e=a(this).data("idx"),f=a(this).data("pageX"),g=k.colModel[e];if(null==f||null==g)return!1;var f=String(f).split(";"),l=parseFloat(f[0]),m=parseFloat(f[1]);if(2===f.length&&(5<Math.abs(l-m)||5<Math.abs(b.pageX-l)||5<Math.abs(b.pageX-m)))return!1;Q.call(d,"resizeDblClick",e,g,b)&&g.autoResizable&&c.autoResizeColumn.call(h,e);Q.call(d,"afterResizeDblClick",{iCol:e,cm:g,cmName:g.name});return!1});a(P).css("width",
z.width+"px");var Ua="";k.footerrow&&(Ua+="<table role='presentation' style='width:"+k.tblwidth+"px' class='ui-jqgrid-ftable'"+(Ba?" cellspacing='0'":"")+"><tbody><tr role='row' class='"+F("rowFooter","footrow footrow-"+la)+"'>");var za="<tr class='jqgfirstrow' role='row' style='height:auto'>";k.disableClick=!1;a("th",xa[0].tHead.rows[0]).each(function(b){var c=k.colModel[b],d=c.name,e=a(this),f=e.children("div"),g=f.children("span.s-ico"),h=k.showOneSortIcon;ea=c.width;void 0===c.resizable&&(c.resizable=
!0);c.resizable?(R=document.createElement("span"),a(R).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+la).bind("selectstart",function(){return!1}),e.addClass(k.resizeclass)):R="";e.css("width",ea+"px").prepend(R);R=null;var l="";!0===c.hidden&&(e.css("display","none"),l="display:none;");za+="<td role='gridcell' "+(c.classes?"class='"+c.classes+"' ":"")+"style='height:0;width:"+ea+"px;"+l+"'></td>";z.headers[b]={width:ea,el:this};ga=c.sortable;"boolean"!==typeof ga&&(ga=c.sortable=!0);
"cb"!==d&&"subgrid"!==d&&"rn"!==d&&ga&&k.viewsortcols[2]&&f.addClass("ui-jqgrid-sortable");ga&&(k.multiSort?(d="desc"===c.lso?"asc":"desc",k.viewsortcols[0]?(g.css("display",""),c.lso&&(g.children("span.ui-icon-"+c.lso).removeClass(sa),h&&g.children("span.ui-icon-"+d).hide())):c.lso&&(g.css("display",""),g.children("span.ui-icon-"+c.lso).removeClass(sa),h&&g.children("span.ui-icon-"+d).hide())):(d="desc"===k.sortorder?"asc":"desc",k.viewsortcols[0]?(g.css("display",""),b===k.lastsort&&(g.children("span.ui-icon-"+
k.sortorder).removeClass(sa),h&&g.children("span.ui-icon-"+d).hide())):b===k.lastsort&&""!==c.lso&&(g.css("display",""),g.children("span.ui-icon-"+k.sortorder).removeClass(sa),h&&g.children("span.ui-icon-"+d).hide())));k.footerrow&&(Ua+="<td role='gridcell' "+Y(b,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(b){var c=a(this),d=c.closest(".ui-jqgrid-hdiv").hasClass("frozen-div"),e=function(){var b=[c.position().left+c.outerWidth()];"rtl"===k.direction&&(b[0]=k.width-b[0]);b[0]-=d?0:z.bDiv.scrollLeft;
...
a.target),c=b.parent();if(0<b.length&&!Q.call(d,"ondblClickRow",c.attr("id"),c[0].rowIndex,b[0].cellIndex,a))return!1}).bind("contextmenu",function(a){var b=Ma.call(this,a.target),c=b.parent(),e=c.attr("id");if(0!==b.length&&(k.multiselect||t.call(h,e,!0,a),!Q.call(d,"onRightClickRow",e,c[0].rowIndex,b[0].cellIndex,a)))return!1});z.bDiv=document.createElement("div");U&&"auto"===String(k.height).toLowerCase()&&(k.height="100%");a(z.bDiv).append(a("<div style='position:relative;"+(Ba?"height:0.01%;":
...
(c+=","+k.toppager);"visible"===k.gridstate?a(c,k.gBox).slideUp("fast",function(){f--;0===f&&(a("span",e).removeClass(Na).addClass(Wa),k.gridstate="hidden",a(k.gBox).hasClass("ui-resizable")&&a(".ui-resizable-handle",k.gBox).hide(),a(z.cDiv).addClass(Ea),Ca||Q.call(d,"onHeaderClick",k.gridstate,b))}):"hidden"===k.gridstate&&(a(z.cDiv).removeClass(Ea),a(c,k.gBox).slideDown("fast",function(){f--;0===f&&(a("span",e).removeClass(Wa).addClass(Na),Ca&&(k.datatype=cb,fa.call(d),Ca=!1),k.gridstate="visible",
...
this.hidden||q(this.classes)||this.fixed||(this.width=d=Math.round(this.widthOrg*C),g+=d,y[a].width=d,H[a].style.width=d+"px",e.footerrow&&(A[a].style.width=d+"px"),k&&(F[a].style.width=d+"px"),h=a)});if(!h)return;n=0;l?r-p-(g+x*m)!==w&&(n=r-p-(g+x*m)-w):1!==Math.abs(r-p-(g+x*m))&&(n=r-p-(g+x*m));t=t[h];t.width+=n;e.tblwidth=parseInt(g+n+x*m+p,10);e.tblwidth>r&&(n=e.tblwidth-parseInt(r,10),e.tblwidth=r,t.width-=n);d=t.width;r=y[h];r.width=d;H[h].style.width=d+"px";k&&(F[h].style.width=d+"px");e.footerrow&&
...
n,!1);c.autoResizing.fixWidthOnShrink=l;c.autoResizing.adjustGridWidth=m;c.shrinkToFit=h})}});var ba=function(a,c){return v.mergeCssClasses(v.getRes(v.guiStyles[this.p.guiStyle],"states."+a),c||"")},wa=function(b,c){var e=this.grid.fbRows;return a((null!=e&&e[0].cells.length>c?e[b.rowIndex]:b).cells[c])};v.extend({editCell:function(b,c,e){return this.each(function(){var d=this,f=a(d),g=d.p,h,m,l,n;h=d.rows;if(d.grid&&!0===g.cellEdit&&null!=h&&null!=h[b]&&(b=parseInt(b,10),c=parseInt(c,10),!isNaN(b)&&
...
[];b||(b="all");this.each(function(){var e=this,d=e.p,f=v.htmlDecode,g=e.rows;e.grid&&!0===d.cellEdit&&a(g).each(function(h){var m={};if(a(this).hasClass("edited")){var l=this;a(this.cells).each(function(c){var p=d.colModel[c],q=p.name,r=wa.call(e,l,c);if("cb"!==q&&"subgrid"!==q&&"rn"!==q&&("dirty"!==b||r.hasClass("dirty-cell")))try{m[q]=a.unformat.call(e,r[0],{rowId:g[h].id,colModel:p},c)}catch(t){m[q]=f(r.html())}});m.id=this.id;c.push(m)}})});return c}});var ga=v.getMethod("getGridRes"),aa=function(a,
