...
resizeColumn:function(b,d,e){var f=this.headers,g=this.footers,h=f[b],l=h.newWidth||h.width,m=Ha(21,this.bDiv),n=Ha(14,this.hDiv).children("thead").children("tr").first()[0].cells,l=parseInt(l,10);k.colModel[b].width=l;h.width=l;n[b].style.width=l+"px";this.cols[b].style.width=l+"px";this.fbRows&&(a(this.fbRows[0].cells[b]).css("width",l),a(Ha(31,this.fhDiv)[0].rows[0].cells[b]).css("width",l),k.footerrow&&a(Ha(36,this.fsDiv)[0].rows[0].cells[b]).css("width",l));0<g.length&&(g[b].style.width=l+"px");
...
if(k.multiselect&&d&&0<d.length)for(a=0;a<d.length;a++)d[a]!==c&&t.call(b,d[a],!1,null);c&&t.call(b,c,!1,null)}e.scrollLeft=f;b.unbind(".selectionPreserver",g)};b.bind("jqGridGridComplete.selectionPreserver",g)}};d.grid=z;Q.call(d,"beforeInitGrid");k.iColByName=L(k.colModel);k.iPropByName=J(k.additionalProperties);var P=a("<div class='ui-jqgrid-view' role='grid' aria-multiselectable='"+!!k.multiselect+"'></div>"),U=v.msie,Ba=U&&8>v.msiever();k.direction=q(k.direction.toLowerCase());-1===p(k.direction,
["ltr","rtl"])&&(k.direction="ltr");pa=k.direction;a(P).insertBefore(d);h.removeClass("scroll").appendTo(P);var X=a("<div class='"+F("gBox","ui-jqgrid")+"'></div>");a(X).attr({id:k.gBoxId,dir:pa}).insertBefore(P);a(P).attr("id",k.gViewId).appendTo(X);a("<div class='"+F("overlay","jqgrid-overlay")+"' id='lui_"+k.id+"'></div>").insertBefore(P);a("<div class='"+F("loading","loading")+"' id='load_"+k.id+"'>"+C("loadtext")+"</div>").insertBefore(P);Ba&&h.attr({cellspacing:"0"});h.attr({role:"presentation",
...
display:"none"}),0!==d.scrollTop&&(d.scrollTop=0));!0===c&&k.treeGrid&&(V(k.data),V(k.lastSelectedData),k._index={});k.rowIndexes={};k.iRow=-1;k.iCol=-1},ya=function(){var a=k.data,b=a.length,c,e,f,g,h,p,r,q=k.localReader,t=k.additionalProperties,u=q.cell,w,v,x,C=k.arrayReaderInfos;if("local"!==k.datatype||!0!==q.repeatitems){if(k.treeGrid)for(c=0;c<b;c++)$a(a[c])}else for(g=!1===k.keyName?m(q.id)?q.id.call(d,a):q.id:k.keyName,isNaN(g)?m(g)||null==k.arrayReaderInfos[g]||(h=k.arrayReaderInfos[g].order):
...
b.getAttribute(a);return null!==b?b:void 0}},Pa=function(a){return function(){var b=ia[a];if(null!=b)return b=b.childNodes,0<b.length?b[0].nodeValue:void 0}};k.page=O(t(b,q.page),k.page);k.lastpage=O(t(b,q.total),1);k.records=O(t(b,q.records));m(q.userdata)?k.userData=q.userdata.call(this,b)||{}:r?t(b,q.userdata,!0).each(function(){k.userData[this.getAttribute("name")]=a(this).text()}):k.userData=t(b,q.userdata)||{};ab();var U={},Ja=k.additionalProperties,H=function(a,b){r&&"string"===typeof b&&(/^\w+$/.test(b)?
U[a]=Pa(b):/^\[\w+\]$/.test(b)&&(U[a]=D(b.substring(1,b.length-1))))},ga=function(a){var b=a.name,c=r?a.xmlmap||b:"local"===n&&!k.dataTypeOrg||"json"===n||"jsonp"===n?a.jsonmap||b:b;!1!==k.keyName&&!0===a.key&&(k.keyName=b);if("string"===typeof c||m(c))U[b]=c;m(c)||H(b,c)};for(u=0;u<G;u++)ga(B[u]);G=Ja.length;for(u=0;u<G;u++)F=Ja[u],"object"===typeof F&&null!=F?ga(F):H(F,F);C=!1===k.keyName?m(q.id)?q.id.call(this,b):q.id:k.keyName;isNaN(C)?m(C)||(P[C]&&(E=P[C].order),r&&("string"===typeof C&&/^\[\w+\]$/.test(C)?
C=D(C.substring(1,C.length-1)):"string"===typeof C&&/^\w+$/.test(C)&&(C=Pa(C)))):E=Number(C);x=t(b,q.root,!0);if(q.row)if(1===x.length&&"string"===typeof q.row&&/^\w+$/.test(q.row)){G=[];ba=x[0].childNodes;L=ba.length;for(F=0;F<L;F++)J=ba[F],1===J.nodeType&&J.nodeName===q.row&&G.push(J);x=G}else x=t(x,q.row,!0);null==x&&l(b)&&(x=b);x||(x=[]);b=x.length;0<b&&0>=k.page&&(k.page=1);ga=parseInt(k.rowNum,10);f&&(ga*=f+1);var B=[],Za=[],K,G=[];for(u=0;u<b;u++){K=x[u];w=q.repeatitems&&q.cell?t(K,q.cell,
!0)||K:K;I=q.repeatitems&&(r||l(w));y={};ia={};if(r&&!I&&null!=w)for(ba=w.childNodes,L=ba.length,F=0;F<L;F++)J=ba[F],1===J.nodeType&&(ia[J.nodeName]=J);for(A in P)P.hasOwnProperty(A)&&(F=P[A],I?(ba=w[F.order],r&&null!=ba&&(ba=ba.textContent||ba.text)):ba=null!=U[A]&&"string"!==typeof U[A]?U[A](w):t(w,"string"===typeof U[A]?U[A]:F.name),1===F.type&&(F=Ja[F.index],null!=F&&m(F.convert)&&(ba=F.convert(ba,w))),void 0!==ba&&(y[A]=ba));void 0!==y[C]?K=void 0!==y[C]?y[C]:Ia():(K=t(K,l(K)?E:C),void 0===K&&
(K=t(w,l(w)?E:C)),void 0===K&&(K=Ia()));K=String(K);I=k.idPrefix+K;k.treeGrid&&$a(y);if(u<ga)Za.push(I),B.push(w),G.push(y);else if(!p)break;if(p||!0===k.treeGrid)y._id_=K,k.data.push(y),k._index[y._id_]=k.data.length-1}if(!p||!k.forceClientSorting||!0===k.treeGrid){d=v.parseDataToHtml.call(this,b,Za,G,B,d,f,p);ab(!0);f=-1<k.treeANode?k.treeANode:0;q=a(this.tBodies[0]);!0===k.treeGrid&&0<f?a(this.rows[f]).after(d.join("")):k.scroll?q.append(d.join("")):(null==this.firstElementChild||void 0!==document.documentMode&&
9>=document.documentMode?q.html(q.html()+d.join("")):this.firstElementChild.innerHTML+=d.join(""),this.grid.cols=this.rows[0].cells);k.grouping&&M.call(this);if(!0===k.subGrid)try{c.addSubGrid.call(g,k.iColByName.subgrid)}catch(T){}if(!1===k.gridview||m(k.afterInsertRow))for(u=0;u<Math.min(b,ga);u++)Q.call(this,"afterInsertRow",Za[u],G[u],B[u]);k.totaltime=new Date-h;0<u&&0===k.records&&(k.records=b);V(d);if(!0===k.treeGrid)try{c.setTreeNode.call(g,f+1,u+f+1)}catch(T){}k.reccount=Math.min(b,ga);k.treeANode=
...
var u=a.fmatter?a.fmatter.NumberFormat:null,x=k.toppager?"_"+k.toppager.substr(1):"",z=F("states.hover"),y=F("states.disabled");l=parseInt(k.page,10)-1;0>l&&(l=0);l*=parseInt(k.rowNum,10);n=l+k.reccount;if(k.scroll){r=a(Ha(21,g)[0].rows).slice(1);l=n-r.length;k.reccount=r.length;if(r=r.outerHeight()||f.prevRowHeight)m=l*r,p=v.fixMaxHeightOfDiv.call(d,parseInt(k.records,10)*r),a(g).children("div").first().css({height:p+"px"}).children("div").first().css({height:m+"px",display:m+"px"?"":"none"}),0===
...
l.firstsortorder||"asc"):l.lso=k.sortorder=l.firstsortorder||"asc",k.page=1);if(k.multiSort)Eb(d,g);else{if(f){if(k.lastsort===d&&k.sortorder===f&&!e)return;k.sortorder=f}l=h.headers;e=h.fhDiv;f=l[k.lastsort]?a(l[k.lastsort].el):a();g=k.frozenColumns?a(g):a(l[d].el);var n=g.find("span.s-ico"),p=n.children("span.ui-icon-"+k.sortorder),r=n.children("span.ui-icon-"+("asc"===k.sortorder?"desc":"asc")),l=k.colModel[k.lastsort];f.find("span.ui-grid-ico-sort").addClass(m);f.attr("aria-selected","false");
...
subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},k.jsonReader);k.localReader=n(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},k.localReader);k.scroll&&(k.pgbuttons=!1,k.pginput=!1,k.rowList=[]);if(!0===k.treeGrid){try{c.setTreeGrid.call(h)}catch(tb){}"local"!==k.datatype&&(k.localReader={id:"_id_"});k.iPropByName=J(k.additionalProperties)}K();D();k.data.length&&(ya.call(d),mb());
if(!0===k.shrinkToFit&&!0===k.forceFit)for(Z=k.colModel.length-1;0<=Z;Z--)if(!0!==k.colModel[Z].hidden){k.colModel[Z].resizable=!1;break}var ea,fa,R,ha,S,ua,ka,ma,ra=[],Da=[],la=[],ja="<thead><tr class='ui-jqgrid-labels' role='row'>",Aa,va="<tbody><tr>",sa=F("states.hover"),ta=F("states.disabled");if(k.multiSort){var ra=k.sortname.split(","),wa;for(wa=0;wa<ra.length;wa++)la=q(ra[wa]).split(" "),ra[wa]=q(la[0]),Da[wa]=la[1]?q(la[1]):k.sortorder||"asc"}for(Z=0;Z<k.colNames.length;Z++){S=k.colModel[Z];
...
"right"===S.align?"text-align:right;"+(!1===S.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;"):"";break;default:ka=""}ja+="<div id='jqgh_"+k.id+"_"+S.name+"'"+(U?" class='ui-th-div-ie'":"")+(""===ka?"":" style='"+ka+"'")+">";Aa=S.autoResizable&&"actions"!==S.formatter?"<span class='"+k.autoResizing.wrapperClassName+"'>"+k.colNames[Z]+"</span>":k.colNames[Z];k.sortIconsBeforeText?(ja+=(k.builderSortIcons||v.builderSortIcons).call(d,Z),ja+=Aa):(ja+=Aa,ja+=(k.builderSortIcons||
v.builderSortIcons).call(d,Z));ja+="</div></th>";va+="<td></td>";S.width=S.width?parseInt(S.width,10):150;"boolean"!==typeof S.title&&(S.title=!0);S.lso="";ea===k.sortname&&(k.lastsort=Z,S.lso=k.sortorder||S.firstsortorder||"asc");k.multiSort&&(la=p(ea,ra),-1!==la&&(S.lso=Da[la]))}var ja=ja+"</tr></thead>",va=va+"</tr></tbody>",xa=a("<table class='"+F("hTable","ui-jqgrid-htable")+"' style='width:1px' role='presentation' aria-labelledby='gbox_"+k.id+"'"+(Ba?" cellspacing='0'":"")+">"+ja+va+"</table>");
...
V(k.selarrrow);if(this.checked){if(c=!0,k.selrow=1<d.rows.length?d.rows[d.rows.length-1].id:null,k.multiPageSelection&&("local"===k.datatype||k.treeGrid)&&null!=k.data&&0<k.data.length&&null!=n)for(m in n)n.hasOwnProperty(m)&&k.selarrrow.push(k.idPrefix+m)}else c=!1,k.selrow=null;a(d.rows).each(function(a){da(this,l)||(g(this,c),(c?k.selarrrow:e).push(this.id),h&&g(h[a],c))});Q.call(d,"onSelectAll",c?k.selarrrow:e,c)});if(!0===k.autowidth){var Ka=Math.floor(a(X).innerWidth());k.width=0<Ka?Ka:"nw"}isNaN(k.width)?
isNaN(parseFloat(k.width))||(k.width=parseFloat(k.width)):k.width=Number(k.width);k.widthOrg=k.width;Fb();a(X).css("width",z.width+"px").append("<div class='"+F("resizer","ui-jqgrid-resize-mark")+"' id='"+k.rsId+"'>&#160;</div>");a(k.rs).bind("selectstart",function(){return!1}).click(ia).dblclick(function(b){var e=a(this).data("idx"),f=a(this).data("pageX"),g=k.colModel[e];if(null==f||null==g)return!1;var f=String(f).split(";"),l=parseFloat(f[0]),m=parseFloat(f[1]);if(2===f.length&&(5<Math.abs(l-
m)||5<Math.abs(b.pageX-l)||5<Math.abs(b.pageX-m)))return!1;Q.call(d,"resizeDblClick",e,g,b)&&g.autoResizable&&c.autoResizeColumn.call(h,e);Q.call(d,"afterResizeDblClick",{iCol:e,cm:g,cmName:g.name});return!1});a(P).css("width",z.width+"px");var Ua="";k.footerrow&&(Ua+="<table role='presentation' style='width:"+k.tblwidth+"px' class='ui-jqgrid-ftable'"+(Ba?" cellspacing='0'":"")+"><tbody><tr role='row' class='"+F("rowFooter","footrow footrow-"+pa)+"'>");var za="<tr class='jqgfirstrow' role='row' style='height:auto'>";
...
""),g.children("span.ui-icon-"+c.lso).removeClass(ta),h&&g.children("span.ui-icon-"+d).hide())):(d="desc"===k.sortorder?"asc":"desc",k.viewsortcols[0]?(g.css("display",""),b===k.lastsort&&(g.children("span.ui-icon-"+k.sortorder).removeClass(ta),h&&g.children("span.ui-icon-"+d).hide())):b===k.lastsort&&""!==c.lso&&(g.css("display",""),g.children("span.ui-icon-"+k.sortorder).removeClass(ta),h&&g.children("span.ui-icon-"+d).hide())));k.footerrow&&(Ua+="<td role='gridcell' "+Y(b,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(b){var c=
...
k.multikey&&a(z.bDiv).bind(v.msie?"selectstart":"mousedown",function(){return!1});Ca&&a(z.bDiv).hide();z.cDiv=document.createElement("div");var Na=B("gridMinimize.visible"),Wa=B("gridMinimize.hidden"),Xa=C("showhide"),Ra=!0===k.hidegrid?a("<a role='link' class='"+F("titleButton","ui-jqgrid-titlebar-close")+"'"+(Xa?" title='"+Xa+"'":"")+"/>").hover(function(){Ra.addClass(sa)},function(){Ra.removeClass(sa)}).append("<span class='"+Na+"'></span>"):"";a(z.cDiv).append("<span class='ui-jqgrid-title'>"+
k.caption+"</span>").append(Ra).addClass(F("gridTitle","ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===pa?"-rtl":"")));a(z.cDiv).insertBefore(z.hDiv);if(k.toolbar[0]){z.uDiv=document.createElement("div");"top"===k.toolbar[1]?a(z.uDiv).insertBefore(z.hDiv):"bottom"===k.toolbar[1]&&a(z.uDiv).insertAfter(z.hDiv);var Ya=F("toolbarUpper","ui-userdata");"both"===k.toolbar[1]?(z.ubDiv=document.createElement("div"),a(z.uDiv).addClass(Ya).attr("id","t_"+k.id).insertBefore(z.hDiv),a(z.ubDiv).addClass(F("toolbarBottom",
...
k.maxRowNum);k.footerrow&&(z.sDiv=a("<div class='ui-jqgrid-sdiv'></div>")[0],bb=a("<div class='ui-jqgrid-hbox"+("rtl"===pa?"-rtl":"")+"'></div>"),a(z.sDiv).append(bb).width(z.width).insertAfter(z.hDiv),a(bb).append(Ua),z.footers=a(".ui-jqgrid-ftable",z.sDiv)[0].rows[0].cells,k.rownumbers&&(z.footers[0].className=F("rowNum","jqgrid-rownum")),Ca&&a(z.sDiv).hide());bb=null;if(k.caption){var cb=k.datatype;!0===k.hidegrid&&(a(".ui-jqgrid-titlebar-close",z.cDiv).click(function(b){var c=".ui-jqgrid-bdiv,.ui-jqgrid-hdiv,.ui-jqgrid-pager,.ui-jqgrid-sdiv",
e=this;!0===k.toolbar[0]&&("both"===k.toolbar[1]&&(c+=",#"+H(a(z.ubDiv).attr("id"))),c+=",#"+H(a(z.uDiv).attr("id")));var f=a(c,k.gView).length;k.toppager&&(c+=","+k.toppager);"visible"===k.gridstate?a(c,k.gBox).slideUp("fast",function(){f--;0===f&&(a("span",e).removeClass(Na).addClass(Wa),k.gridstate="hidden",a(k.gBox).hasClass("ui-resizable")&&a(".ui-resizable-handle",k.gBox).hide(),a(z.cDiv).addClass(Ea),Ca||Q.call(d,"onHeaderClick",k.gridstate,b))}):"hidden"===k.gridstate&&(a(z.cDiv).removeClass(Ea),
a(c,k.gBox).slideDown("fast",function(){f--;0===f&&(a("span",e).removeClass(Wa).addClass(Na),Ca&&(k.datatype=cb,ga.call(d),Ca=!1),k.gridstate="visible",a(k.gBox).hasClass("ui-resizable")&&a(".ui-resizable-handle",k.gBox).show(),Ca||Q.call(d,"onHeaderClick",k.gridstate,b))}));return!1}),Ca&&(k.datatype="local",a(".ui-jqgrid-titlebar-close",z.cDiv).trigger("click")))}else a(z.cDiv).hide(),a(z.cDiv).nextAll("div:visible").first().addClass("ui-corner-top");a(z.hDiv).after(z.bDiv);a(X).click(ia).dblclick(function(b){var e=
...
k.pager||a(z.cDiv).nextAll("div:visible").filter(":last").addClass(Ea);a(".ui-jqgrid-labels",z.hDiv).bind("selectstart",function(){return!1});d.formatCol=Y;d.sortData=wb;d.updatepager=ba;d.refreshIndex=mb;d.setHeadCheckBox=jb;d.fixScrollOffsetAndhBoxPadding=G;d.constructTr=ca;d.formatter=Db;n(z,{populate:ga,emptyRows:N,beginReq:Pa,endReq:Ja});d.addXmlData=Fa;d.addJSONData=Fa;d.rebuildRowIndexes=M;d.grid.cols=d.rows[0].cells;Q.call(d,"onInitGrid");k.treeGrid&&"local"===k.datatype&&null!=k.data&&0<
...
a(".customelement",this),c=this.name;if(b.length){if(c=b.attr("name"),b=Za[c],void 0!==b&&(b=M[b],b=b.editoptions||{},a.isFunction(b.custom_value))){try{if(z[c]=b.custom_value.call(r,a("#"+H(c),k),"get"),void 0===z[c])throw"e1";}catch(d){"e1"===d?Xa.call(r,X,"function 'custom_value' "+u.msg.novalue,u.bClose):Xa.call(r,X,d.message,u.bClose)}return!0}}else switch(b=a(this)[0].type,b){case "checkbox":z[c]=a(this).is(":checked")?a(this).val():a(this).data("offval");break;case "select-one":z[c]=a("option:selected",
this).val();break;case "select-multiple":z[c]=a(this).val();z[c]=z[c]?z[c].join(","):"";a("option:selected",this).each(function(b,c){a(c).text()});break;case "date":z[c]=a(this).val();3===String(z[c]).split("-").length&&(b=Za[c],void 0!==b&&(b=M[b],b=b.formatoptions||{},b=b.newformat||y.call(t,"formatter.date.newformat"),z[c]=v.parseDate.call(t[0],"Y-m-d",z[c],b)));break;default:void 0!==b&&0>a.inArray(b,u.skipPostTypes)&&(z[c]=a(this).val())}});return!0}function d(b,c,d){var e=0,f=[],g=!1,h="",k;
...
""!==f?(a(d,c)[J]("checked",!0),a(d,c)[J]("defaultChecked",!0)):(a(d,c)[J]("checked",!1),a(d,c)[J]("defaultChecked",!1));break;case "custom":try{if(n[g].editoptions&&a.isFunction(n[g].editoptions.custom_value))n[g].editoptions.custom_value.call(r,a(d,c),"set",f);else throw"e1";}catch(h){"e1"===h?Xa.call(r,X,"function 'custom_value' "+u.msg.nodefined,u.bClose):Xa.call(r,X,h.message,u.bClose)}}e++}}),0<e&&a("#id_g",k).val(b))}}function g(){var b=u.url||w.editurl;a.each(M,function(c,d){var e=d.name,
...
z,a(E),U))&&"object"===typeof q&&(z=q);for(m in z)if(z.hasOwnProperty(m)&&(q=w.iColByName[m],c=v.checkValues.call(r,z[m],m,void 0,void 0,{oldValue:"_empty"===b?null:D.getCell.call(t,b,q),newValue:z[m],cmName:m,rowid:b,cm:M[q],iCol:q,iRow:B,tr:y,td:null==y?null:y.cells[q],mode:"_empty"===b?"addForm":"editForm"}),!1===c[0]))break;g();c[0]&&(d=t.triggerHandler("jqGridAddEditClickSubmit",[u,z,U]),void 0===d&&a.isFunction(u.onclickSubmit)&&(d=u.onclickSubmit.call(r,u,z,U)||{}),c=t.triggerHandler("jqGridAddEditBeforeSubmit",
...
A.call(t,c[2]),ea(G,{gb:L,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form})):u.clearAfterAdd&&f("_empty",E)):(u.reloadAfterSubmit?(t.trigger("reloadGrid",g),u.closeAfterEdit||setTimeout(function(){A.call(t,z[h])},1E3)):!0===w.treeGrid?D.setTreeRow.call(t,z[h],z):D.setRowData.call(t,z[h],z),u.closeAfterEdit&&ea(G,{gb:L,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form}));if(a.isFunction(u.afterComplete)){var m=
...
v.errors.nourl));c[0]&&(u.useDataProxy?(d=w.dataProxy.call(r,p,"set_"+x),void 0===d&&(d=[!0,""]),!1===d[0]?(c[0]=!1,c[1]=d[1]||"Error deleting the selected row!"):(p.data.oper===e.addoper&&u.closeAfterAdd&&ea(G,{gb:L,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form}),p.data.oper===e.editoper&&u.closeAfterEdit&&ea(G,{gb:L,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form}))):"clientArray"===p.url?(u.reloadAfterSubmit=
...
b);else{var c=c.savedRow,d=r.rows[c.id];D.restoreCell.call(t,c.id,c.ic);a(d.cells[c.ic]).removeClass("edit-cell "+$a);a(d).addClass($a).attr({"aria-selected":"true",tabindex:"0"})}}function p(b,c){var d=c[1].length-1;0===b?a("#pData",C).addClass(T):void 0!==c[1][b-1]&&da(a("#"+H(c[1][b-1])),T)?a("#pData",C).addClass(T):a("#pData",C).removeClass(T);b===d?a("#nData",C).addClass(T):void 0!==c[1][b+1]&&da(a("#"+H(c[1][b+1])),T)?a("#nData",C).addClass(T):a("#nData",C).removeClass(T)}function q(){var b=
...
x,modalhead:"edithd"+x,modalcontent:"editcnt"+x,resizeAlso:E},G="#"+H(I.themodal),L=w.gBox,J=w.propOrAttr,M=w.colModel,Za=w.iColByName,ia=1,O=0,z,P,U,Ba=u.commonIconClass,X=y.call(t,"errors.errcap"),K=function(){var b=a.makeArray(arguments);b.unshift("");b.unshift("AddEdit");b.unshift(u);return Wa.apply(r,b)},Y=ca.call(r,"hover"),T=ca.call(r,"disabled"),$a=ca.call(r,"select"),Q=ca.call(r,"active"),N=ca.call(r,"error"),E="#"+H(E);"new"===b?(b="_empty",U="add",u.caption=u.addCaption):(u.caption=u.editCaption,
...
F+"' class='EditTable'"+(v.msie&&8>v.msiever()?" cellspacing='0'":"")+"><tbody></tbody></table>");a(M).each(function(){var a=this.formoptions;ia=Math.max(ia,a?a.colpos||0:0);O=Math.max(O,a?a.rowpos||0:0)});a(B).append(R);N=a("<tr id='FormError' style='display:none'><td class='"+N+"' colspan='"+2*ia+"'>&#160;</td></tr>");N[0].rp=0;a(R).append(N);N=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*ia+"'>"+(u.topinfo||"&#160;")+"</td></tr>");N[0].rp=0;a(R).append(N);if(K("beforeInitData",
B,U)){n();W=(N="rtl"===w.direction?!0:!1)?"nData":"pData";V=N?"pData":"nData";d(b,R,ia);var W=fa.call(r,W,"",oa(Ba,u.prevIcon),"","left"),V=fa.call(r,V,"",oa(Ba,u.nextIcon),"","right"),ab=fa.call(r,"sData",u.bSubmit),Fa=fa.call(r,"cData",u.bCancel),F="<table"+(v.msie&&8>v.msiever()?" cellspacing='0'":"")+" class='EditTable' id='"+F+"_2'><tbody><tr><td colspan='2'><hr class='"+aa.call(r,"dialog.hr")+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton navButton-"+w.direction+
"'>"+(N?V+W:W+V)+"</td><td class='EditButton EditButton-"+w.direction+"'>"+ab+"&#160;"+Fa+"</td></tr>",F=F+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+(u.bottominfo||"&#160;")+"</td></tr>"),F=F+"</tbody></table>";if(0<O){var db=[];a.each(a(R)[0].rows,function(a,b){db[a]=b});db.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(db,function(b,c){a("tbody",R).append(c)})}u.gbox=L;var eb=!1;!0===u.closeOnEscape&&(u.closeOnEscape=!1,eb=!0);F=a("<div></div>").append(B).append(F);
za.call(r,I,F,u,w.gView,a(L)[0]);u.topinfo&&a(".tinfo",k).show();u.bottominfo&&a(".binfo",C).show();F=F=null;a(G).keydown(function(b){var c=(b.target.tagName||"").toUpperCase(),d,e;if(!0===a(E).data("disabled"))return!1;if(13===b.which&&"TEXTAREA"!==c){d=a(C).find(":focus");e=d.attr("id");if(0<d.length&&0<=a.inArray(e,["pData","nData","cData"]))return d.trigger("click"),!1;if(!0===u.savekey[0]&&13===u.savekey[1])return a("#sData",C).trigger("click"),!1}if(!0===u.savekey[0]&&b.which===u.savekey[1]&&
...
G).unbind("click").click(function(){if(!l())return!1;ea(G,{gb:L,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form});return!1}));La(a("#sData",C),u.saveicon,Ba);La(a("#cData",C),u.closeicon,Ba);if(u.checkOnSubmit||u.checkOnUpdate)ab=fa.call(r,"sNew",u.bYes),V=fa.call(r,"nNew",u.bNo),Fa=fa.call(r,"cNew",u.bExit),I=u.zIndex||999,I++,a("<div class='"+u.overlayClass+" jqgrid-overlay confirm' style='z-index:"+I+";display:none;'>&#160;</div><div class='"+aa.call(r,
"dialog.content","confirm ui-jqconfirm")+"' style='z-index:"+(I+1)+"'>"+u.saveData+"<br/><br/>"+ab+V+Fa+"</div>").insertAfter(E),a("#sNew",G).click(function(){h();a(E).data("disabled",!1);a(".confirm",G).hide();return!1}),a("#nNew",G).click(function(){a(".confirm",G).hide();a(E).data("disabled",!1);setTimeout(function(){a(":input:visible",E)[0].focus()},0);return!1}),a("#cNew",G).click(function(){a(".confirm",G).hide();a(E).data("disabled",!1);ea(G,{gb:L,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,
formprop:!u.recreateForm,form:u.form});return!1});K("onInitializeForm",a(E),U);"_empty"!==b&&u.viewPagerButtons?a("#pData,#nData",C).show():a("#pData,#nData",C).hide();K("beforeShowForm",a(E),U);a(G).data("onClose",u.onClose);Ka(G,{gbox:L,jqm:u.jqModal,overlay:u.overlay,modal:u.modal,overlayClass:u.overlayClass,toTop:u.toTop,onHide:function(a){nb.call(t,"formProp",E,a)}});ya||a("."+H(u.overlayClass)).click(function(){if(!l())return!1;ea(G,{gb:L,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,
formprop:!u.recreateForm,form:u.form});return!1});a(".fm-button",G).hover(function(){a(this).addClass(Y)},function(){a(this).removeClass(Y)});a("#sData",C).click(function(){z={};a("#FormError",k).hide();e();"_empty"===z[x+"_id"]?h():!0===u.checkOnSubmit?(P=m(z,u._savedData))?(a(E).data("disabled",!0),a(".confirm",G).show()):h():h();return!1});a("#cData",C).click(function(){if(!l())return!1;ea(G,{gb:L,jqm:u.jqModal,onClose:u.onClose,removemodal:u.removemodal,formprop:!u.recreateForm,form:u.form});
return!1});a("#nData",C).click(function(){if(!l())return!1;a("#FormError",k).hide();var b=q();b[0]=parseInt(b[0],10);if(-1!==b[0]&&b[1][b[0]+1]){if(!K("onclickPgButtons","next",a(E),b[1][b[0]]))return!1;f(b[1][b[0]+1],E);A.call(t,b[1][b[0]+1]);K("afterclickPgButtons","next",a(E),b[1][b[0]+1]);p(b[0]+1,b)}return!1});a("#pData",C).click(function(){if(!l())return!1;a("#FormError",k).hide();var b=q();if(-1!==b[0]&&b[1][b[0]-1]){if(!K("onclickPgButtons","prev",a(E),b[1][b[0]])||da(a("#"+H(b[1][b[0]-1])),
T))return!1;f(b[1][b[0]-1],E);A.call(t,b[1][b[0]-1]);K("afterclickPgButtons","prev",a(E),b[1][b[0]-1]);p(b[0]-1,b)}return!1});K("afterShowForm",a(E),U);I=q();p(I[0],I)}}})},viewGridRow:function(b,c){return this.each(function(){function e(){!0!==q.closeOnEscape&&!0!==q.navkeys[0]||setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+H(u.modalhead)).attr("tabindex","-1").focus()},0)}function d(b,c,d){var e,f,g,h=0,k,p,r=[],t=D.getInd.call(l,b),u;u=aa.call(m,"dialog.viewData","DataTD form-view-data");
var w=aa.call(m,"dialog.viewLabel","CaptionTD form-view-label"),C="<td class='"+w+"' width='"+q.labelswidth+"'>&#160;</td><td class='"+u+" ui-helper-reset'>&#160;</td>",x="",w="<td class='"+w+"'></td><td class='"+u+"'></td>",B=["integer","number","currency"],E=0,y=0,A,I,G;for(u=1;u<=d;u++)x+=1===u?C:w;a(F).each(function(){(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==a.inArray(this.formatter,B)?E=Math.max(E,parseInt(this.width,
...
(parseInt(l.colpos,10)||1),10);if(l.rowabove){var w=a("<tr><td class='contentinfo' colspan='"+2*d+"'>"+l.rowcontent+"</td></tr>");a(c).append(w);w[0].rp=q}g=a(c).find("tr[data-rowpos="+q+"]");0===g.length&&(g=a("<tr "+p+" data-rowpos='"+q+"'></tr>").addClass("FormData").attr("id","trv_"+e),a(g).append(x),a(c).append(g),g[0].rp=q);l=void 0===l.label?n.colNames[b]:l.label;q=a("td:eq("+(u-1)+")",g[0]);a("td:eq("+(u-2)+")",g[0]).html("<b>"+(l||"&nbsp;")+"</b>");q[Sa(q.html())?"html":"append"]("<span>"+
...
g.editrules.edithidden?!1:!0===g.hidden?!0:!1;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&(c=H("v_"+c),a("#"+c+" span",t).html(v.getDataFieldOfCell.call(m,f,b).html()),d&&a("#"+c,t).parents("tr:first").hide(),e++)}),0<e&&a("#id_g",t).val(b))}function g(b,c){var d=c[1].length-1;0===b?a("#pData",w).addClass(L):void 0!==c[1][b-1]&&da(a("#"+H(c[1][b-1])),L)?a("#pData",w).addClass(L):a("#pData",w).removeClass(L);b===d?a("#nData",w).addClass(L):void 0!==c[1][b+1]&&da(a("#"+H(c[1][b+1])),L)?a("#nData",w).addClass(L):
a("#nData",w).removeClass(L)}function h(){var b=D.getDataIDs.call(l),c=a("#id_g",t).val();return[a.inArray(c,b),b]}var m=this,l=a(m),n=m.p;if(m.grid&&null!=n&&b){var p=n.id,q=a.extend(!0,{top:0,left:0,width:0,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,closeOnEscape:!1,labelswidth:"30%",navkeys:[!1,38,40],onClose:null,beforeShowForm:null,beforeInitData:null,viewPagerButtons:!0,recreateForm:!1,removemodal:!0,form:"view"},D.getGridRes.call(l,"view"),v.view||{},n.formViewing||
{},c||{}),r="#ViewGrid_"+H(p),t="#ViewTbl_"+H(p),w=t+"_2",x="ViewGrid_"+p,y="ViewTbl_"+p,A=q.commonIconClass,u={themodal:"viewmod"+p,modalhead:"viewhd"+p,modalcontent:"viewcnt"+p,resizeAlso:x},E="#"+H(u.themodal),B=n.gBox,F=n.colModel,k=1,C=0,I=function(){var b=a.makeArray(arguments);b.unshift("");b.unshift("View");b.unshift(q);return Wa.apply(m,b)},G=ca.call(m,"hover"),L=ca.call(m,"disabled");q.recreateForm||l.data("viewProp")&&a.extend(q,l.data("viewProp"));var p=isNaN(q.dataheight)?q.dataheight:
q.dataheight+"px",J=isNaN(q.datawidth)?q.datawidth:q.datawidth+"px",x=a("<form name='FormPost' id='"+x+"' class='FormGrid' style='width:"+J+";overflow:auto;position:relative;height:"+p+";'></form>"),M=a("<table id='"+y+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");a(F).each(function(){var a=this.formoptions;k=Math.max(k,a?a.colpos||0:0);C=Math.max(C,a?a.rowpos||0:0)});x.append(M);if(I("beforeInitData",x)){d(b,M,k);var N=(p="rtl"===
n.direction?!0:!1)?"pData":"nData",J=fa.call(m,p?"nData":"pData","",oa(A,q.prevIcon),"","left"),N=fa.call(m,N,"",oa(A,q.nextIcon),"","right"),ia=fa.call(m,"cData",q.bClose);if(0<C){var O=[];a.each(a(M)[0].rows,function(a,b){O[a]=b});O.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(O,function(b,c){a("tbody",M).append(c)})}q.gbox=B;y=a("<div></div>").append(x).append("<table border='0' class='EditTable' id='"+y+"_2'><tbody><tr id='Act_Buttons'><td class='navButton navButton-"+n.direction+
"' width='"+(q.labelswidth||"auto")+"'>"+(p?N+J:J+N)+"</td><td class='EditButton EditButton-"+n.direction+"'>"+ia+"</td></tr></tbody></table>");za.call(m,u,y,q,n.gView,a(n.gView)[0]);q.viewPagerButtons||a("#pData, #nData",w).hide();y=null;a(E).keydown(function(b){var c,d;if(!0===a(r).data("disabled"))return!1;if(13===b.which&&(c=a(w).find(":focus"),d=c.attr("id"),0<c.length&&0<=a.inArray(d,["pData","nData","cData"])))return c.trigger("click"),!1;if(27===b.which)return q.closeOnEscape&&ea(E,{gb:B,
jqm:q.jqModal,onClose:q.onClose,removemodal:q.removemodal,formprop:!q.recreateForm,form:q.form}),!1;if(!0===q.navkeys[0]){if(b.which===q.navkeys[1])return a("#pData",w).trigger("click"),!1;if(b.which===q.navkeys[2])return a("#nData",w).trigger("click"),!1}});La(a("#cData",w),q.closeicon,A);I("beforeShowForm",a(r));Ka(E,{gbox:B,jqm:q.jqModal,overlay:q.overlay,toTop:q.toTop,modal:q.modal,onHide:function(a){nb.call(l,"viewProp",r,a)}});a(".fm-button:not(."+L.split(" ").join(".")+")",w).hover(function(){a(this).addClass(G)},
...
B=fa.call(e,"dData",h.bSubmit),k=fa.call(e,"eData",h.bCancel),F=F+("<table"+(v.msie&&8>v.msiever()?" cellspacing='0'":"")+" class='EditTable' id='"+m+"_2'><tbody><tr><td><hr class='"+aa.call(e,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton EditButton-"+d.direction+"'>"+B+"&#160;"+k+"</td></tr></tbody></table>");h.gbox=x;za.call(e,t,F,h,d.gView,a(d.gView)[0]);a("#DelData>td",l).data("rowids",b);if(!A("beforeInitData",a(F)))return;a(".fm-button",l+"_2").hover(function(){a(this).addClass(u)},
...
g.attr({tabindex:"0",href:"#",role:"button"});setTimeout(function(){g.focus()},50)}}(),u,E=function(b){if(13===b.which&&(b=a(this).find(".ui-pg-button").filter(":focus"),0<b.length))return b.trigger("click"),!1},B=ca.call(m,"hover"),F=ca.call(m,"disabled");if(m.grid){m.modalAlert=A;void 0===b&&(l.pager?(b=l.pager,l.toppager&&(q.cloneToTop=!0)):l.toppager&&(b=l.toppager));var k=1,C,I,G,L,J,M=["left","center","right"],N="<div class='ui-pg-button "+F+"'><span class='ui-separator'></span></div>",ia=function(){da(this,
F)||a(this).addClass(B)},O=function(){a(this).removeClass(B)},z=function(){da(this,F)||(a.isFunction(q.addfunc)?q.addfunc.call(m):D.editGridRow.call(n,"new",d));return!1},P=function(b,c,d){if(!da(this,F)){var e=l.selrow;e?a.isFunction(b)?b.call(m,e):D[c].call(n,e,d):A()}return!1},U=function(){return P.call(this,q.editfunc,"editGridRow",e)},Q=function(){return P.call(this,q.viewfunc,"viewGridRow",h)},X=function(){var b;da(this,F)||(l.multiselect?(b=l.selarrrow,0===b.length&&(b=null)):b=l.selrow,b?
a.isFunction(q.delfunc)?q.delfunc.call(m,b):D.delGridRow.call(n,b,f):A());return!1},K=function(){da(this,F)||(a.isFunction(q.searchfunc)?q.searchfunc.call(m,g):D.searchGrid.call(n,g));return!1},Y=function(){if(!da(this,F)){a.isFunction(q.beforeRefresh)&&q.beforeRefresh.call(m);l.search=!1;l.resetsearch=!0;try{if("currentfilter"!==q.refreshstate){l.postData.filters="";try{a("#fbox_"+t).jqFilter("resetFilter")}catch(b){}a.isFunction(m.clearToolbar)&&m.clearToolbar(!1)}}catch(b){}switch(q.refreshstate){case "firstpage":n.trigger("reloadGrid",
...
(q.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+k+"</span>":"")+"</div>");a(e).append(g);g.attr({title:q[b+"title"]||"",id:c||b+"_"+f}).click(d).hover(ia,O);return g};q.cloneToTop&&l.toppager&&(k=2);for(C=0;C<k;C++){u=a("<div class='ui-pg-table navtable' role='toolbar' style='float:"+("rtl"===l.direction?"right":"left")+";table-layout:auto;'></div>");0===C?(I=b,G=p,I===l.toppager&&(G+="_top",k=1)):(I=l.toppager,G=p+"_top");q.add&&T("add",d.id,z,u,G);q.edit&&T("edit",e.id,U,u,G);q.view&&T("view",
h.id,Q,u,G);q.del&&T("del",f.id,X,u,G);(q.add||q.edit||q.del||q.view)&&a(u).append(N);q.search&&(r=T("search",g.id,K,u,G),g.showOnLoad&&!0===g.showOnLoad&&a(r,u).click());q.refresh&&T("refresh","",Y,u,G);r=a(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px";a("body").append("<div id='testpg2' class='"+aa.call(m,"gBox","ui-jqgrid")+"' style='font-size:"+r+";visibility:hidden;' ></div>");r=a(u).clone().appendTo("#testpg2").width();a("#testpg2").remove();a(I+"_"+q.position,I).append(u);if(q.hideEmptyPagerParts)for(G=
0;G<M.length;G++)M[G]!==q.position&&(J=a(I+"_"+M[G],I),0===J.length||0===J[0].childNodes.length?J.hide():1===J[0].childNodes.length&&(L=J[0].firstChild,!a(L).is("table.ui-pg-table")||0!==L.rows&&0!==L.rows[0].cells.length||J.hide()));l._nvtd&&(r>l._nvtd[0]&&(a(I+"_"+q.position,I).width(r),l._nvtd[0]=r),l._nvtd[1]=r);m.nav=!0;u.bind("keydown.jqGrid",E)}n.triggerHandler("jqGridResetFrozenHeights")}}})},navButtonAdd:function(b,c){"object"===typeof b&&(c=b,b=void 0);return this.each(function(){var e=
this,d=e.p;if(e.grid){var f=a.extend({caption:"newButton",title:"",onClickButton:null,position:"last",cursor:"pointer",iconsOverText:!1},D.getGridRes.call(a(e),"nav"),v.nav||{},d.navOptions||{},c||{}),g=ca.call(e,"hover"),h=ca.call(e,"disabled");if(void 0===b)if(d.pager)if(D.navButtonAdd.call(a(e),d.pager,f),d.toppager)b=d.toppager;else return;else d.toppager&&(b=d.toppager);"string"===typeof b&&0!==b.indexOf("#")&&(b="#"+H(b));var d=a(".navtable",b),m=f.commonIconClass;if(0<d.length&&!(f.id&&0<d.find("#"+
...
"'></span>"+(f.caption?"<span class='ui-pg-button-text"+(f.iconsOverText?" ui-pg-button-icon-over-text":"")+"'>"+f.caption+"</span>":"")+"</div>");f.id&&a(l).attr("id",f.id);"first"===f.position&&0<d.children("div.ui-pg-button").length?d.children("div.ui-pg-button").first().before(l):d.append(l);a(l,d).attr("title",f.title||"").click(function(b){da(this,h)||a.isFunction(f.onClickButton)&&f.onClickButton.call(e,f,b);return!1}).hover(function(){da(this,h)||a(this).addClass(g)},function(){a(this).removeClass(g)});
a(e).triggerHandler("jqGridResetFrozenHeights")}}})},navSeparatorAdd:function(b,c){c=a.extend({sepclass:"ui-separator",sepcontent:"",position:"last"},c||{});return this.each(function(){if(this.grid){var e=this.p;if(void 0===b)if(e.pager)if(D.navSeparatorAdd.call(a(this),e.pager,c),e.toppager)b=e.toppager;else return;else e.toppager&&(b=e.toppager);"string"===typeof b&&0!==b.indexOf("#")&&(b="#"+H(b));e=a(".navtable",b);if(0<e.length){var d="<div class='ui-pg-button "+ca.call(this,"disabled")+"'><span class='"+
...
focusField:!0},v.inlineEdit,e.inlineEditing||{},p),q=d.jqGrid("getInd",b,!0),k=n.focusField,C="object"===typeof k&&null!=k?a(k.target||k).closest("tr.jqgrow>td")[0]:null;if(!1!==q&&(n.extraparam[m.oper]===m.addoper||Ya.call(c,n,"beforeEditRow",n,b))&&"0"===(a(q).attr("editable")||"0")&&!a(q).hasClass("not-editable-row")){m=v.detectRowEditing.call(c,b);if(null!=m&&"cellEditing"===m.mode){var m=m.savedRow,I=c.rows[m.id],G=ca.call(c,"select");d.jqGrid("restoreCell",m.id,m.ic);a(I.cells[m.ic]).removeClass("edit-cell "+
...
(e=f[0],w=f[1]||w):e=f;if(!0===e){r.autoEncodeOnEdit&&a.each(w,function(a,b){w[a]=v.oldDecodePostedData(b)});w=a.extend({},w,x);q.jqGrid("setRowData",b,w);F.attr("editable","0");for(e=0;e<r.savedRow.length;e++)if(String(r.savedRow[e].id)===String(b)){u=e;break}0<=u&&r.savedRow.splice(u,1);ra.call(p,n.aftersavefunc,"jqGridInlineAfterSaveRow",b,c,w,n);F.removeClass("jqgrid-new-row").unbind("keydown")}else ra.call(p,n.errorfunc,"jqGridInlineErrorSaveRow",b,c,d,null,n),!0===n.restoreAfterError&&q.jqGrid("restoreRow",
b,n.afterrestorefunc)}},error:function(c,d,e){a("#lui_"+v.jqID(r.id)).hide();q.triggerHandler("jqGridInlineErrorSaveRow",[b,c,d,e,n]);if(a.isFunction(n.errorfunc))n.errorfunc.call(p,b,c,d,e);else{c=c.responseText||c.statusText;try{t.call(p,k,'<div class="'+ca.call(p,"error")+'">'+c+"</div>",C,{buttonalign:"right"})}catch(f){alert(c)}}!0===n.restoreAfterError&&q.jqGrid("restoreRow",b,n.afterrestorefunc)}},v.ajaxOptions,r.ajaxRowOptions,n.ajaxSaveOptions||{}));else{w=a.extend({},w,x);E=q.jqGrid("setRowData",
b,w);F.attr("editable","0");for(l=0;l<r.savedRow.length;l++)if(String(r.savedRow[l].id)===String(G)){u=l;break}0<=u&&r.savedRow.splice(u,1);ra.call(p,n.aftersavefunc,"jqGridInlineAfterSaveRow",b,E,w,n);F.removeClass("jqgrid-new-row").unbind("keydown")}}},restoreRow:function(b,c){var e=a.makeArray(arguments).slice(1),d={};"object"===a.type(e[0])?d=e[0]:a.isFunction(c)&&(d.afterrestorefunc=c);return this.each(function(){var c=this,e=a(c),h=c.p,m=-1,l={},n;if(c.grid){var p=a.extend(!0,{},v.inlineEdit,
...
c).addClass("jqgrid-new-row"),f.useFormatter?a("#"+v.jqID(f.rowID)+" .ui-inline-edit",c).click():(d=d.prmNames,f.addRowParams.extraparam[d.oper]=d.addoper,e.jqGrid("editRow",f.rowID,f.addRowParams),e.jqGrid("setSelection",f.rowID)))}})},inlineNav:function(b,c){"object"===typeof b&&(c=b,b=void 0);return this.each(function(){var e=this,d=a(e),f=e.p;if(this.grid&&null!=f){var g,h=b===f.toppager?f.idSel+"_top":f.idSel,m=b===f.toppager?f.id+"_top":f.id,l=ca.call(e,"disabled"),n=a.extend(!0,{edit:!0,editicon:"ui-icon-pencil",
...
for(t=1;t<g;t++){P=R.getItem(t);n=R.getIndexOfDifferences(P,Y);for(p=G-1;p>=n;p--)J[p]&&y(1,p,t-1);Y=P;y(0,x-1,t)}for(n=G-1;0<=n;n--)J[n]&&y(1,n,g-1);q&&y(2);Y=R.getItem(0);for(p=0;p<G;p++)H.push({useColSpanStyle:m.useColSpanStyle,groupHeaders:[{titleText:Y[p],startColumnName:1===D?"y0":"y0a0",numberOfColumns:D}]});for(t=1;t<g;t++){P=R.getItem(t);n=R.getIndexOfDifferences(P,Y);O(t,n,Y);for(p=G-1;p>=n;p--)H[p].groupHeaders.push({titleText:P[p],startColumnName:"y"+t+(1===D?"":"a0"),numberOfColumns:D});
for(p=0;p<n;p++)T=H[p].groupHeaders,T[T.length-1].numberOfColumns+=D;Y=P}O(g,0,Y);if(q)for(n=0;n<G;n++)H[n].groupHeaders.push({titleText:n<G-1?"":m.totalHeader||"",startColumnName:"t"+(1===D?"":"a0"),numberOfColumns:D});O=W.getIndexLength();for(x=0;x<O;x++){p=W.getItem(x);y={iX:x,x:p};K={pivotInfos:y};for(n=0;n<C;n++)K["x"+n]=p[n];z=W.getIndexesOfSourceData(x);if(q)for(p=0;p<D;p++)N[p]=aa(p);Y=null;da();for(t=0;t<g;t++){P=R.getItem(t);U=R.getIndexesOfSourceData(t);for(p=0;p<D;p++){null!==Y&&ea(t-
1,P,Y,p);V=[];for(n=0;n<U.length;n++)w=U[n],0<=a.inArray(w,z)&&V.push(w);if(0<V.length){A=Array(V.length);X=B[p];F=new va(X.aggregator,e,c);for(w=0;w<V.length;w++)n=V[w],l=b[n],A[w]=l,F.calc(l[X.member],X.member,l,n,b),q&&(k=N[p],k.calc(l[X.member],X.member,l,n,b),k=k.groupInfo,0>a.inArray(n,k.iYs)&&(k.iYs.push(t),k.ys.push(P)),0>a.inArray(n,k.iRows)&&(k.iRows.push(n),k.rows.push(l))),fa(P,Y,X,p,l,n,t);l="y"+t+(1===D?"":"a"+p);F.getResult(K,l);y[l]={colType:0,iY:t,y:P,iA:p,a:X,iRows:V,rows:A}}}Y=
P}if(null!==Y)for(p=0;p<D;p++)ea(g-1,Y,Y,p);if(q)for(p=0;p<D;p++)l="t"+(1===D?"":"a"+p),k=N[p],k.getResult(K,l),k=k.groupInfo,y[l]={colType:2,iA:p,a:B[p],iRows:k.iRows,rows:k.rows,iYs:k.iYs,ys:k.ys};d.push(K)}if(m.footerTotals||m.colTotals){q=d.length;for(n=0;n<C;n++)f["x"+n]=u[n].footerText||"";for(n=C;n<M.length;n++){l=M[n].name;F=new va(m.footerAggregator||"sum",e,c);for(w=0;w<q;w++)K=d[w],F.calc(K[l],l,K,w,d);F.getResult(f,l)}}c.colHeaders=H;return{colModel:M,options:c,rows:d,groupOptions:h,groupHeaders:H,
...
0,pX:p.x,pY:p.y,k:c.k}:!1;c=b.find("input.hasDatepicker");if(0<c.length)try{c.datepicker("hide")}catch(q){}b={e:b,dnr:m,ar:l,dnrAr:e};a(document).bind(la,b,Ma.drag);a(document).bind(Aa,b,Ma.stop);return!1}})})};window.PointerEvent?(sa+=".jqGrid pointerdown.jqGrid",la+=".jqGrid pointermove.jqGrid",Aa+=".jqGrid pointerup.jqGrid"):window.MSPointerEvent?(sa+=".jqGrid mspointerdown.jqGrid",la+=".jqGrid mspointermove.jqGrid",Aa+=".jqGrid mspointerup"):(sa+=".jqGrid touchstart.jqGrid",la+=".jqGrid touchmove.jqGrid",
Aa+=".jqGrid touchend.jqGrid");a.jqDnR=Ma;a.fn.jqDrag=function(a){return zb(this,a,"move")};a.fn.jqResize=function(a,c){return zb(this,a,"resize",c)};var Na=0,ka,ta=[],pb=function(b){try{a(":input:visible",b.w).first().focus()}catch(c){}},Ib=function(b){var c=ka[ta[ta.length-1]],e=!a(b.target).parents(".jqmID"+c.s)[0],d=a(b.target).offset(),f=void 0!==b.pageX?b.pageX:d.left,g=void 0!==b.pageY?b.pageY:d.top,d=function(){var b=!1;a(".jqmID"+c.s).each(function(){var c=a(this),d=c.offset();if(d.top<=
