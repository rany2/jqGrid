...
parseDate:function(a,c,e,d){var f,g,h,m=0,l=0;f="string"===typeof c?c.match(/^\/Date\((([\-+])?[0-9]+)(([\-+])([0-9]{2})([0-9]{2}))?\)\/$/):null;var n=function(b,a){b=String(b);for(a=parseInt(a,10)||2;b.length<a;)b="0"+b;return b},m={m:1,d:1,y:1970,h:0,i:0,s:0,u:0},p=function(b,a){0===b?12===a&&(a=0):12!==a&&(a+=12);return a};d=function(b,a){var c="AmPm dayNames masks monthNames userLocalTime parseRe S srcformat".split(" "),d=a||{},e=(u.formatter||{}).date||{},k=null==b||null==b.locale?{}:((Ha[b.locale]||
...
"rowNum","jqgrid-rownum")+"' "+L(b,a,c,null,a,!0)+">"+c+"</td>"};1>=H&&(l.rowIndexes={});if("local"===l.datatype&&!l.deselectAfterSort||l.multiPageSelection)y=!0;g&&(k*=g+1);for(g=0;g<Math.min(a,k);g++){t=c[g];w=e[g];x=null!=d?d[g]:w;p=1===f?0:f;q=1===(p+g)%2?A:"";y&&(l.multiselect?(r=-1!==b.inArray(t,l.selarrrow))&&null===l.selrow&&(l.selrow=t):r=t===l.selrow);B=v.length;v.push("");for(p=0;p<l.colModel.length;p++)switch(D=l.colModel[p].name,D){case "rn":v.push(pa(p,g,l.page,l.rowNum));break;case "cb":v.push(S(t,
p,g,r,w));break;case "subgrid":v.push(I.addSubGridCell.call(n,p,g+f,t,w));break;default:v.push(J(t,w[D],p,g+f,x,w))}v[B]=m.constructTr(t,E,q,w,x,r);v.push("</tr>");l.rowIndexes[t]=H;H++;l.grouping&&I.groupingPrepare&&(F.push(v),l.groupingView._locgr||I.groupingPrepare.call(n,w,g),v=[]);v.length>l.maxItemsToJoin&&(v=[v.join("")])}l.grouping&&I.groupingRender&&(h&&(l.groupingView._locgr=!0),v=[I.groupingRender.call(n,F,k)],u.clearArray(F));return v},getMethod:function(a){return this.getAccessor(b.fn.jqGrid,
a)},extend:function(a){b.extend(b.fn.jqGrid,a);this.no_legacy_api||b.fn.extend(a)}});var W=u.clearArray,G=u.jqID,fb=u.getGridComponentIdSelector,gb=u.getGridComponentId,$a=u.getGridComponent,Na=u.stripPref,Da=u.randId,qa=u.getAccessor,Xa=u.convertOnSaveLocally,lb=u.stripHtml,pb=u.htmlEncode,Aa=u.htmlDecode,xa=u.mergeCssClasses,ca=u.hasOneFromClasses,Q=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("");a.unshift(this.p);return u.feedback.apply(this,a)};b.fn.jqGrid=function(a){var c=
b.fn.jqGrid,e;if("string"===typeof a){e=c[a];if(!e)throw"jqGrid - No such method: "+a;return e.apply(this,b.makeArray(arguments).slice(1))}return this.each(function(){if(!this.grid){var d=this,e,g,h=b(d),m=b.isFunction,l=b.isArray,n=b.extend,p=b.inArray,q=b.trim,r=b.each,t=c.setSelection,w=c.getGridRes,x=m(Ia.fatalError)?Ia.fatalError:alert,B=a.locale||Ia.locale||"en-US",y=null!=Ha[B]&&"boolean"===typeof Ha[B].isRTL?Ha[B].isRTL?"rtl":"ltr":"ltr",v=a.iconSet||Ia.iconSet||("bootstrap"===(a.guiStyle||
Ia.guiStyle)||"bootstrapPrimary"===(a.guiStyle||Ia.guiStyle)?"glyph":"jQueryUI"),F=a.guiStyle||Ia.guiStyle||"jQueryUI",A=function(b){return c.getIconRes.call(d,b)},E=function(b,a){return h.jqGrid("getGuiStyles",b,a)};null==a&&(a={datatype:"local"});void 0!==a.datastr&&l(a.datastr)&&(g=a.datastr,a.datastr=[]);void 0!==a.data&&(e=a.data,a.data=[]);null!=u.formatter&&null!=u.formatter.unused||x("CRITICAL ERROR!!!\n\n\nOne uses probably\n\n\t$.extend($.jgrid.defaults, {...});\n\nto set default settings of jqGrid instead of the usage the DEEP version of jQuery.extend (with true as the first parameter):\n\n\t$.extend(true, $.jgrid.defaults, {...});\n\nOne other possible reason:\n\nyou included some OLD version of language file (grid.locale-en.js for example) AFTER jquery.jqGrid.min.js. For example all language files of jqGrid 4.7.0 uses non-deep call of jQuery.extend.\n\n\nSome options of jqGrid could still work, but another one will be broken.");
...
10);return isNaN(b)?a||0:b},z={headers:[],cols:[],footers:[],dragStart:function(a,c,d,e){var f=b(this.bDiv),g=f.closest(k.gBox).offset();e=e.offset().left+("rtl"===k.direction?0:this.headers[a].width+(u.cell_width?0:P(k.cellLayout,0))-2);this.resizing={idx:a,startX:e,sOL:e,moved:!1,delta:e-c.pageX};this.curGbox=b(k.rs);this.curGbox.prependTo("body");this.curGbox.css({display:"block",left:e,top:d[1]+g.top+1,height:d[2]});this.curGbox.css("height",d[2]-(this.curGbox.outerHeight()-this.curGbox.height())+
"px");this.curGbox.data("idx",a);this.curGbox.data("delta",e-c.pageX);pa.call(this.curGbox,c);Q.call($a(21,f)[0],"resizeStart",c,a);document.onselectstart=function(){return!1};b(document).bind("mousemove.jqGrid",function(b){if(z.resizing)return z.dragMove(b),!1}).bind("mouseup.jqGrid"+k.id,function(){if(z.resizing)return z.dragEnd(),!1})},dragMove:function(a){var c=this.resizing;if(c){var d=a.pageX+c.delta-c.startX,e=this.headers;a=e[c.idx];var f="ltr"===k.direction?a.width+d:a.width-d,g=((k.colModel[c.idx]||
{}).autoResizing||{}).minColWidth||k.minResizingWidth;c.moved=!0;f>g&&(null==this.curGbox&&(this.curGbox=b(k.rs)),this.curGbox.css({left:c.sOL+d}),!0===k.forceFit?(c=e[c.idx+k.nv],d="ltr"===k.direction?c.width-d:c.width+d,d>k.autoResizing.minColWidth&&(a.newWidth=f,c.newWidth=d)):(this.newWidth="ltr"===k.direction?k.tblwidth+d:k.tblwidth-d,a.newWidth=f))}},resizeColumn:function(a,d,e){var f=this.headers,g=this.footers,h=f[a],l=h.newWidth||h.width,m=$a(21,this.bDiv),n=$a(14,this.hDiv).children("thead").children("tr").first()[0].cells,
...
b.makeArray(k.selarrrow):null,e=this.grid.bDiv,f=e.scrollLeft,g=function(){var b;k.selrow=null;if(!k.multiPageSelection){W(k.selarrrow);if(k.multiselect&&d&&0<d.length)for(b=0;b<d.length;b++)d[b]!==c&&t.call(a,d[b],!1,null);c&&t.call(a,c,!1,null)}e.scrollLeft=f;a.unbind(".selectionPreserver",g)};a.bind("jqGridGridComplete.selectionPreserver",g)}};d.grid=z;Q.call(d,"beforeInitGrid");k.iColByName=H(k.colModel);k.iPropByName=L(k.additionalProperties);var C=b("<div class='"+E("gView","ui-jqgrid-view")+
"' role='grid' aria-multiselectable='"+!!k.multiselect+"'></div>"),M=u.msie,ba;k.direction=q(k.direction.toLowerCase());-1===p(k.direction,["ltr","rtl"])&&(k.direction="ltr");ba=k.direction;b(C).insertBefore(d);h.removeClass("scroll").appendTo(C);var O=b("<div class='"+E("gBox","ui-jqgrid")+"'></div>");b(O).attr({id:k.gBoxId,dir:ba}).insertBefore(C);b(C).attr("id",k.gViewId).appendTo(O);b("<div class='"+E("overlay","jqgrid-overlay")+"' id='lui_"+k.id+"'></div>").insertBefore(C);b("<div class='"+E("loading",
"loading")+"' id='load_"+k.id+"'>"+D("loadtext")+"</div>").insertBefore(C);h.attr({role:"presentation","aria-labelledby":"gbox_"+d.id});var eb=function(){var b=k.remapColumns,a=k.colModel,c=a.length,d=[],e,f;for(e=0;e<c;e++)f=a[e].name,0>p(f,k.reservedColumnNames)&&d.push(f);if(null!=b)for(a=d.slice(),e=0;e<b.length;e++)d[e]=a[b[e]];k.cmNamesInputOrder=d},T=function(b,a,c,e,f,g){var h=k.colModel[b],l=c,n=h.classes,p=h.align?"text-align:"+h.align+";":"",r,q=function(b){return"string"===typeof b?b.replace(/\'/g,
...
b(d.firstChild.firstChild).css({height:0,display:"none"}),0!==d.scrollTop&&(d.scrollTop=0));!0===c&&k.treeGrid&&(W(k.data),W(k.lastSelectedData),k._index={});k.rowIndexes={};k.iRow=-1;k.iCol=-1},ja=function(){var b=k.data,a=b.length,c,e,f,g,h,p,r,q=k.localReader,v=k.additionalProperties,t=q.cell,u,x,w,y=k.arrayReaderInfos;if("local"!==k.datatype||!0!==q.repeatitems){if(k.treeGrid)for(c=0;c<a;c++)V(b[c])}else for(g=!1===k.keyName?m(q.id)?q.id.call(d,b):q.id:k.keyName,isNaN(g)?m(g)||null==k.arrayReaderInfos[g]||
(h=k.arrayReaderInfos[g].order):h=Number(g),c=0;c<a;c++){e=b[c];f=t?qa(e,t)||e:e;x=l(f);r={};for(u in y)y.hasOwnProperty(u)&&(w=y[u],p=qa(f,x?w.order:w.name),1===w.type&&(w=v[w.index],null!=w&&m(w.convert)&&(p=w.convert(p,f))),void 0!==p&&(r[u]=p));void 0!==r[g]?e=void 0!==r[g]?r[g]:Da():(e=qa(e,l(e)?h:g),void 0===e&&(e=qa(f,l(f)?h:g)),void 0===e&&(e=Da()));e=String(e);r[q.id]=e;k.treeGrid&&V(r);n(b[c],r)}},ra=function(){var b=k.data.length,a,c,d,e;a=!1===k.keyName||k.loadonce?k.localReader.id:k.keyName;
k._index={};for(c=0;c<b;c++)e=k.data[c],d=qa(e,a),void 0===d&&(d=String(Da()),void 0===e[a]&&(e[a]=d)),k._index[d]=c},sa=function(a,d,e,f,g,h){var l="-1",n="",p,r=d?"display:none;":"";e=E("gridRow","jqgrow ui-row-"+k.direction)+(e?" "+e:"")+(h?" "+E("states.select"):"");h=b(this).triggerHandler("jqGridRowAttr",[f,g,a]);"object"!==typeof h&&(h=m(k.rowattr)?k.rowattr.call(this,f,g,a):"string"===typeof k.rowattr&&null!=u.rowattr&&m(u.rowattr[k.rowattr])?u.rowattr[k.rowattr].call(this,f,g,a):{});if(null!=
...
n||"xml"===n)&&b.isXMLDoc(a),q=k.localReader,v=qa;if(a&&("xml"!==n||r)){-1!==k.treeANode||k.scroll?d=1<d?d:1:(z.emptyRows.call(this,!1,!0),d=1);p&&(W(k.data),W(k.lastSelectedData),k._index={},k.grouping&&null!=k.groupingView&&(k.groupingView.groups=[],k.groupingView._locgr=!1),k.localReader.id="_id_");k.reccount=0;switch(n){case "xml":case "xmlstring":q=k.xmlReader;v=u.getXmlData;break;case "json":case "jsonp":case "jsonstring":q=k.jsonReader}var t,w,x,y,D,A={},B,L=k.colModel,E=L.length,F,I,da,H,
S,M=k.arrayReaderInfos,ba={},C=function(b){return function(a){a=a.getAttribute(b);return null!==a?a:void 0}},pa=function(b){return function(){var a=ba[b];if(null!=a)return a=a.childNodes,0<a.length?a[0].nodeValue:void 0}};k.page=P(v(a,q.page),k.page);k.lastpage=P(v(a,q.total),1);k.records=P(v(a,q.records));m(q.userdata)?k.userData=q.userdata.call(this,a)||{}:r?v(a,q.userdata,!0).each(function(){k.userData[this.getAttribute("name")]=b(this).text()}):k.userData=v(a,q.userdata)||{};K();var O={},Ja=k.additionalProperties,
eb=function(b,a){r&&"string"===typeof a&&(/^\w+$/.test(a)?O[b]=pa(a):/^\[\w+\]$/.test(a)&&(O[b]=C(a.substring(1,a.length-1))))},ha=function(b){var a=b.name,c=r?b.xmlmap||a:"local"===n&&!k.dataTypeOrg||"json"===n||"jsonp"===n?b.jsonmap||a:a;!1!==k.keyName&&!0===b.key&&(k.keyName=a);if("string"===typeof c||m(c))O[a]=c;m(c)||eb(a,c)};for(t=0;t<E;t++)ha(L[t]);E=Ja.length;for(t=0;t<E;t++)I=Ja[t],"object"===typeof I&&null!=I?ha(I):eb(I,I);y=!1===k.keyName?m(q.id)?q.id.call(this,a):q.id:k.keyName;isNaN(y)?
m(y)||(M[y]&&(D=M[y].order),r&&("string"===typeof y&&/^\[\w+\]$/.test(y)?y=C(y.substring(1,y.length-1)):"string"===typeof y&&/^\w+$/.test(y)&&(y=pa(y)))):D=Number(y);x=v(a,q.root,!0);if(q.row)if(1===x.length&&"string"===typeof q.row&&/^\w+$/.test(q.row)){E=[];da=x[0].childNodes;H=da.length;for(I=0;I<H;I++)S=da[I],1===S.nodeType&&S.nodeName===q.row&&E.push(S);x=E}else x=v(x,q.row,!0);null==x&&l(a)&&(x=a);x||(x=[]);a=x.length;0<a&&0>=k.page&&(k.page=1);ha=parseInt(k.rowNum,10);f&&(ha*=f+1);var L=[],
kb=[],G,E=[];for(t=0;t<a;t++){G=x[t];w=q.repeatitems&&q.cell?v(G,q.cell,!0)||G:G;B=q.repeatitems&&(r||l(w));A={};ba={};if(r&&!B&&null!=w)for(da=w.childNodes,H=da.length,I=0;I<H;I++)S=da[I],1===S.nodeType&&(ba[S.nodeName]=S);for(F in M)M.hasOwnProperty(F)&&(I=M[F],B?(da=w[I.order],r&&null!=da&&(da=da.textContent||da.text)):da=null!=O[F]&&"string"!==typeof O[F]?O[F](w):v(w,"string"===typeof O[F]?O[F]:I.name),1===I.type&&(I=Ja[I.index],null!=I&&m(I.convert)&&(da=I.convert(da,w))),void 0!==da&&(A[F]=
da));void 0!==A[y]?G=void 0!==A[y]?A[y]:Da():(G=v(G,l(G)?D:y),void 0===G&&(G=v(w,l(w)?D:y)),void 0===G&&(G=Da()));void 0===A[y]&&(A[y]=G);G=String(G);B=k.idPrefix+G;k.treeGrid&&V(A);if(t<ha)kb.push(B),L.push(w),E.push(A);else if(!p)break;if(p||!0===k.treeGrid)A._id_=G,k.data.push(A),k._index[A._id_]=k.data.length-1}if(!p||!k.forceClientSorting||!0===k.treeGrid){d=u.parseDataToHtml.call(this,a,kb,E,L,d,f,p);K(!0);f=-1<k.treeANode?k.treeANode:0;q=b(this.tBodies[0]);!0===k.treeGrid&&0<f?b(this.rows[f]).after(d.join("")):
k.scroll?q.append(d.join("")):(null==this.firstElementChild||void 0!==document.documentMode&&9>=document.documentMode?q.html(q.html()+d.join("")):this.firstElementChild.innerHTML+=d.join(""),this.grid.cols=this.rows[0].cells);k.grouping&&J.call(this);if(!0===k.subGrid)try{c.addSubGrid.call(g,k.iColByName.subgrid)}catch(Z){}if(!1===k.gridview||m(k.afterInsertRow))for(t=0;t<Math.min(a,ha);t++)Q.call(this,"afterInsertRow",kb[t],E[t],L[t]);k.totaltime=new Date-h;0<t&&0===k.records&&(k.records=a);W(d);
if(!0===k.treeGrid)try{c.setTreeNode.call(g,f+1,t+f+1)}catch(Z){}k.reccount=Math.min(a,ha);k.treeANode=-1;k.userDataOnFooter&&c.footerData.call(g,"set",k.userData,!0);p&&(k.records=a,k.lastpage=Math.ceil(a/ha));e||this.updatepager(!1,!0);Ea.call(this)}}},ab=function(){function a(b){var c=0,d,e,f,g,h,l,p;if(null!=b.groups){(e=b.groups.length&&"OR"===b.groupOp.toString().toUpperCase())&&L.orBegin();for(d=0;d<b.groups.length;d++){0<c&&e&&L.or();try{a(b.groups[d])}catch(r){x(r)}c++}e&&L.orEnd()}if(null!=
...
(L=L.custom(h.op,h.field,h.data)),c++;f&&L.orEnd()}catch(r){x(r)}}var d=b(this),e=k.multiSort?[]:"",f={},g=!1,n={},p=[],q=[],v=w.call(h,"formatter.date.srcformat"),t=w.call(h,"formatter.date.newformat");if(!l(k.data))return{};k.multiSort&&rb(e,f);var y=k.grouping?k.groupingView:!1,z,A,D=function(b,a,c){var d=b.index||b.name,f=b.sorttype||"text";n[b.name]={reader:k.dataTypeOrg?b.name:b.jsonmap||b.name,iCol:a,stype:f,srcfmt:"",newfmt:"",sfunc:b.sortfunc||null,isAddProp:!0===c?!0:!1};if("date"===f||
"datetime"===f)b.formatter&&"string"===typeof b.formatter&&"date"===b.formatter?(a=b.formatoptions&&b.formatoptions.srcformat?b.formatoptions.srcformat:v,c=b.formatoptions&&b.formatoptions.newformat?b.formatoptions.newformat:t):a=c=b.datefmt||"Y-m-d",n[b.name].srcfmt=a,n[b.name].newfmt=c;if(k.grouping)for(A=0,z=y.groupField.length;A<z;A++)b.name===y.groupField[A]&&(p[A]=n[d],q[A]=d);k.multiSort||g||b.index!==k.sortname&&b.name!==k.sortname||(e=b.name,g=!0)};r(k.colModel,function(b){D(this,b)});r(k.additionalProperties,
function(b){D("string"===typeof this?{name:this}:this,b,!0)});if(k.treeGrid)return c.SortTree.call(d,e,k.sortorder,null!=n[e]&&n[e].stype?n[e].stype:"text",null!=n[e]&&n[e].srcfmt?n[e].srcfmt:""),!1;var B={eq:function(b){return b.equals},ne:function(b){return b.notEquals},lt:function(b){return b.less},le:function(b){return b.lessOrEquals},gt:function(b){return b.greater},ge:function(b){return b.greaterOrEquals},cn:function(b){return b.contains},nc:function(b,a){return"OR"===a?b.orNot().contains:b.andNot().contains},
...
k.postData.filters;if(J)"string"===typeof J&&(J=b.parseJSON(J)),a(J);else try{var E=n[k.postData.searchField],L=B[k.postData.searchOper](L)(m(E.reader)?'jQuery.jgrid.getAccessor(this,jQuery("'+k.idSel+'")[0].p.colModel['+E.iCol+"].jsonmap)":"jQuery.jgrid.getAccessor(this,'"+E.reader+"')",k.postData.searchString,n[k.postData.searchField])}catch(I){}}if(k.grouping)for(A=0;A<z;A++)L.orderBy(q[A],y.groupOrder[A],p[A].stype,p[A].srcfmt);k.multiSort?r(e,function(){L.orderBy(this,f[this],n[this].stype,n[this].srcfmt,
n[this].sfunc)}):e&&k.sortorder&&g&&L.orderBy(k.sortname,"DESC"===k.sortorder.toUpperCase()?"d":"a",n[e].stype,n[e].srcfmt,n[e].sfunc);k.lastSelectedData=L.select();var J=parseInt(k.rowNum,10),E=k.lastSelectedData.length,F=parseInt(k.page,10),da=Math.ceil(E/J),H={};if(k.grouping&&k.groupingView._locgr){k.groupingView.groups=[];var S,M,P;if(k.footerrow&&k.userDataOnFooter){for(M in k.userData)k.userData.hasOwnProperty(M)&&(k.userData[M]=0);P=!0}for(S=0;S<E;S++){if(P)for(M in k.userData)k.userData.hasOwnProperty(M)&&
(k.userData[M]+=parseFloat(k.lastSelectedData[S][M]||0));c.groupingPrepare.call(d,k.lastSelectedData[S],S,J)}}n=L=null;d=k.localReader;H[d.total]=da;H[d.page]=F;H[d.records]=E;H[d.root]=k.lastSelectedData.slice((F-1)*J,F*J);H[d.userdata]=k.userData;return H},Ya=function(a){var c=a.outerWidth();0>=c&&(c=b(this).closest(".ui-jqgrid>.ui-jqgrid-view").css("font-size")||"11px",b(document.body).append("<div id='testpg' class='"+E("gBox","ui-jqgrid")+"' style='font-size:"+c+";visibility:hidden;margin:0;padding:0;' ></div>"),
b(a).clone().appendTo("#testpg"),c=b("#testpg>.ui-pg-table").width(),b("#testpg").remove());0<c&&a.parent().width(c);return c},hb=function(a,c){var d=this,e=b(d),f=d.grid,g,l,m,n,p,r,q=k.pager||"",v=k.pager?"_"+k.pager.substr(1):"";g=f.bDiv;var t=b.fmatter?b.fmatter.NumberFormat:null,y=k.toppager?"_"+k.toppager.substr(1):"",x=E("states.hover"),A=E("states.disabled");l=parseInt(k.page,10)-1;0>l&&(l=0);l*=parseInt(k.rowNum,10);n=l+k.reccount;if(k.scroll){r=b($a(21,g)[0].rows).slice(1);l=n-r.length;
k.reccount=r.length;if(r=r.outerHeight()||f.prevRowHeight)m=l*r,p=u.fixMaxHeightOfDiv.call(d,parseInt(k.records,10)*r),b(g).children("div").first().css({height:p+"px"}).children("div").first().css({height:m+"px",display:m+"px"?"":"none"}),0===g.scrollTop&&1<k.page&&(g.scrollTop=k.rowNum*(k.page-1)*r);g.scrollLeft=f.hDiv.scrollLeft}if(q+=k.toppager?(q?",":"")+k.toppager:"")r=w.call(h,"formatter.integer")||{},f=P(k.page),g=P(k.lastpage),b(".selbox",q).prop("disabled",!1),!0===k.pginput&&(b(".ui-pg-input",
q).val(k.page),m=k.toppager?"#sp_1"+v+",#sp_1"+y:"#sp_1"+v,b(m).html(b.fmatter?t(k.lastpage,r):k.lastpage).closest(".ui-pg-table").each(function(){Ya.call(d,b(this))})),k.viewrecords&&(0===k.reccount?b(".ui-paging-info",q).html(D("emptyrecords")):(m=l+1,p=k.records,b.fmatter&&(m=t(m,r),n=t(n,r),p=t(p,r)),b(".ui-paging-info",q).html(u.format(D("recordtext"),m,n,p)))),!0===k.pgbuttons&&(0>=g&&(f=0),0>=f&&(f=g=0),1===f||0===f?(b("#first"+v+", #prev"+v).addClass(A).removeClass(x),k.toppager&&b("#first_t"+
...
b);ha.call(e,a-1)}:null!==r.npage&&delete k.postData[r.npage];if(k.grouping&&c.groupingSetup){c.groupingSetup.call(f);var y=k.groupingView,x,w="",A,L,D;for(x=0;x<y.groupField.length;x++){A=y.groupField[x];for(L=0;L<k.colModel.length;L++)D=k.colModel[L],D.name===A&&D.index&&(A=D.index);w+=A+" "+y.groupOrder[x]+", "}l[r.sort]=w+l[r.sort]}n(k.postData,l);var B=k.scroll?e.rows.length-1:1,J=function(){I.call(e);var b=f.width(),a=f.closest(".ui-jqgrid-view").width(),d=f.css("height");a<b&&0===k.reccount?
f.css("height","1px"):"0"!==d&&"0px"!==d&&f.css("height","");k.autowidth||void 0!==k.widthOrg&&"auto"!==k.widthOrg&&"100%"!==k.widthOrg||c.setGridWidth.call(f,k.tblwidth+k.scrollOffset,!1)},E=function(){var b;if(k.autoresizeOnLoad)c.autoResizeAllColumns.call(f);else for(b=0;b<k.columnsToReResizing.length;b++)c.autoResizeColumn.call(f,k.columnsToReResizing[b]);W(k.columnsToReResizing)},r=function(){Q.call(e,"loadComplete",p);E();f.triggerHandler("jqGridAfterLoadComplete",[p]);Ja.call(e);k.datatype=
"local";k.datastr=null;J()},F=function(b){f.triggerHandler("jqGridLoadComplete",[b]);v&&v.call(e,b);E();f.triggerHandler("jqGridAfterLoadComplete",[b]);h&&g.populateVisible.call(e);1===a&&Ja.call(e);J()},H=function(){var b=ab.call(e);Fa.call(e,b,B,1<a,t);F(b)};if(Q.call(e,"beforeRequest"))if(m(k.datatype))k.datatype.call(e,k.postData,"load_"+k.id,B,a,t);else switch(l=k.datatype.toLowerCase(),l){case "json":case "jsonp":case "xml":case "script":b.ajax(n({url:k.url,type:k.mtype,dataType:l,data:u.serializeFeedback.call(d,
k.serializeGridData,"jqGridSerializeGridData",k.postData),success:function(c,d,f){k.jqXhr=null;b(z.eDiv).hide();if(m(k.beforeProcessing)&&!1===k.beforeProcessing.call(e,c,d,f))Ja.call(e);else if(Fa.call(e,c,B,1<a,t),F(c),k.loadonce||k.treeGrid)k.dataTypeOrg=k.datatype,k.datatype="local",k.forceClientSorting&&H()},error:function(b,c,d){k.jqXhr=null;m(k.loadError)&&k.loadError.call(e,b,c,d);1===a&&Ja.call(e)},beforeSend:function(b,a){var c=!0;m(k.loadBeforeSend)&&(c=k.loadBeforeSend.call(e,b,a));void 0===
c&&(c=!0);if(!1===c)return!1;k.jqXhr=b;da.call(e)}},u.ajaxOptions,k.ajaxGridOptions));break;case "xmlstring":da.call(e);p="string"===typeof k.datastr?b.parseXML(k.datastr):k.datastr;Fa.call(e,p);r();k.forceClientSorting&&H();break;case "jsonstring":da.call(e);p=k.datastr&&"string"===typeof k.datastr?b.parseJSON(k.datastr):k.datastr;Fa.call(e,p);r();k.forceClientSorting&&H();break;case "local":case "clientside":da.call(e),k.datatype="local",H()}}},ib=function(a){var c=this.grid;b(k.cb,c.hDiv).prop("checked",
a);k.frozenColumns&&b(k.cb,c.fhDiv).prop("checked",a)},sb=function(a,c){var e=E("states.hover"),f=E("states.disabled"),g="<td class='ui-pg-button "+f+"'><span class='ui-separator'></span></td>",h="",l="<table style='table-layout:auto;white-space: pre;"+("left"===k.pagerpos?"margin-right:auto;":"right"===k.pagerpos?"margin-left:auto;":"margin-left:auto;margin-right:auto;")+"' class='ui-pg-table'><tbody><tr>",m="",n,p,r,q,v=function(b,a,c){if(!Q.call(d,"onPaging",b,{newPage:a,currentPage:P(k.page,1),
lastPage:P(k.lastpage,1),currentRowNum:P(k.rowNum,10),newRowNum:c}))return!1;k.selrow=null;k.multiselect&&(k.multiPageSelection||W(k.selarrrow),ib.call(d,!1));W(k.savedRow);return!0};c+="_"+a;n="pg_"+a;p=a+"_left";r=a+"_center";q=a+"_right";b("#"+G(a)).append("<div id='"+n+"' class='ui-pager-control' role='group'><table class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;'><tbody><tr><td id='"+p+"' style='text-align:left;"+(void 0!==k.pagerLeftWidth?"width:"+k.pagerLeftWidth+"px;":
"")+"'></td><td id='"+r+"' style='text-align:center;white-space:pre;"+(void 0!==k.pagerCenterWidth?"width:"+k.pagerCenterWidth+"px;":"")+"'></td><td id='"+q+"' style='text-align:right;"+(void 0!==k.pagerRightWidth?"width:"+k.pagerRightWidth+"px;":"")+"'></td></tr></tbody></table></div>").attr("dir","ltr");n="#"+G(n);if(0<k.rowList.length){m="<td dir='"+ba+"'>";p=D("pgrecs");m+="<select class='"+E("pager.pagerSelect","ui-pg-selbox")+"' "+(p?"title='"+p+"'":"")+">";for(p=0;p<k.rowList.length;p++)r=
k.rowList[p].toString().split(":"),1===r.length&&(r[1]=r[0]),m+="<option value='"+r[0]+"'"+(P(k.rowNum,0)===P(r[0],0)?" selected='selected'":"")+">"+r[1]+"</option>";m+="</select></td>"}"rtl"===ba&&(l+=m);!0===k.pginput&&(h="<td dir='"+ba+"'>"+u.format(D("pgtext")||"","<input class='"+E("pager.pagerInput","ui-pg-input")+"' type='text' size='2' maxlength='7' value='0'/>","<span id='sp_1_"+a+"'>0</span>")+"</td>");a="#"+G(a);if(!0===k.pgbuttons){r=["first","prev","next","last"];var t=E("pager.pagerButton",
"ui-pg-button");q=function(b){var a=D("pg"+b);return"<td role='button' tabindex='0' id='"+b+c+"' class='"+t+"' "+(a?"title='"+a+"'":"")+"><span class='"+A("pager."+b)+"'></span></td>"};"rtl"===ba&&r.reverse();for(p=0;p<r.length;p++)l+=q(r[p]),1===p&&(l+=""!==h?g+h+g:"")}else""!==h&&(l+=h);"ltr"===ba&&(l+=m);l+="</tr></tbody></table>";!0===k.viewrecords&&b("td"+a+"_"+k.recordpos,n).append("<span dir='"+ba+"' style='text-align:"+k.recordpos+"' class='ui-paging-info'></span>");var y=b("td"+a+"_"+k.pagerpos,
n);y.append(l);g=Ya.call(this,y.children(".ui-pg-table"));k._nvtd=[];k._nvtd[0]=g?Math.floor((k.width-g)/2):Math.floor(k.width/3);k._nvtd[1]=0;l=null;b(".ui-pg-selbox",n).bind("change",function(){var a=P(this.value,10),c=Math.round(k.rowNum*(k.page-1)/a-.5)+1;if(!v("records",c,a))return!1;k.page=c;k.rowNum=a;k.pager&&b(".ui-pg-selbox",k.pager).val(a);k.toppager&&b(".ui-pg-selbox",k.toppager).val(a);ha.call(d);return!1});!0===k.pgbuttons&&(b(".ui-pg-button",n).hover(function(){ca(this,f)?this.style.cursor=
"default":(b(this).addClass(e),this.style.cursor="pointer")},function(){ca(this,f)||(b(this).removeClass(e),this.style.cursor="default")}),b("#first"+G(c)+", #prev"+G(c)+", #next"+G(c)+", #last"+G(c)).click(function(){if(ca(this,f))return!1;var b=P(k.page,1),a=b,e=this.id,g=P(k.lastpage,1),h=!1,l=!0,m=!0,n=!0,p=!0;0===g||1===g?(1>=b&&(m=l=!1),p=n=!1):1<g&&1<=b?1===b?m=l=!1:b===g&&(p=n=!1):1<g&&0===b&&(p=n=!1,b=g-1);this.id==="first"+c&&l&&(e="first",a=1,h=!0);this.id==="prev"+c&&m&&(e="prev",a=b-
1,h=!0);this.id==="next"+c&&n&&(e="next",a=b+1,h=!0);this.id==="last"+c&&p&&(e="last",a=g,h=!0);if(!v(e,a,P(k.rowNum,10)))return!1;k.page=a;h&&ha.call(d);return!1}));!0===k.pginput&&b("input.ui-pg-input",n).bind("keypress.jqGrid",function(a){a=a.charCode||a.keyCode||0;var c=P(b(this).val(),1);if(13===a){if(!v("user",c,P(k.rowNum,10)))return!1;b(this).val(c);k.page=0<b(this).val()?b(this).val():k.page;ha.call(d);return!1}return this});y.children(".ui-pg-table").bind("keydown.jqGrid",function(b){13===
b.which&&(b=y.find(":focus"),0<b.length&&b.trigger("click"))})},rb=function(a,c,d){r((k.sortname+" "+k.sortorder).split(","),function(){var c=b.trim(this).split(" ");2===c.length&&a.push(c[0])});if(null!=d){var e=b.inArray(d.index||d.name,a);""!==d.lso&&0>e?a.push(d.index||d.name):""===d.lso&&0<=e&&a.splice(e,1)}r(k.colModel,function(){var d=this.index||this.name,e;this.lso&&(e=this.lso.split("-"),0>b.inArray(d,a)&&a.push(d),c[d]=e[e.length-1])})},Db=function(a,c){var e="",f=k.colModel[a],g,h=E("states.disabled"),
...
t[this]});k.sortname=e.substring(0,e.length-k.sortorder.length-1)},tb=function(a,d,e,f,g){var h=this.grid,l=k.colModel[d],m=E("states.disabled");if(null!=l&&l.sortable&&!(0<k.savedRow.length)){e||(k.lastsort===d&&""!==k.sortname?(k.sortorder="asc"===k.sortorder?"desc":"desc"===k.sortorder?"asc":l.firstsortorder||"asc",l.lso?"asc"===l.lso?l.lso+="-desc":"desc"===l.lso?l.lso+="-asc":"asc-desc"!==l.lso&&"desc-asc"!==l.lso||!k.threeStateSort&&!k.multiSort||(l.lso=""):l.lso=l.firstsortorder||"asc"):l.lso=
k.sortorder=l.firstsortorder||"asc",k.page=1);if(k.multiSort)Db(d,g);else{if(f){if(k.lastsort===d&&k.sortorder===f&&!e)return;k.sortorder=f}l=h.headers;e=h.fhDiv;f=l[k.lastsort]?b(l[k.lastsort].el):b();g=k.frozenColumns?b(g):b(l[d].el);var n=g.find("span.s-ico"),p=n.children("span.ui-icon-"+k.sortorder),r=n.children("span.ui-icon-"+("asc"===k.sortorder?"desc":"asc")),l=k.colModel[k.lastsort];f.find("span.ui-grid-ico-sort").addClass(m);f.attr("aria-selected","false");k.frozenColumns&&(e.find("span.ui-grid-ico-sort").addClass(m),
...
"true")):(g.attr("aria-selected","false"),k.threeStateSort&&(k.sortorder="",k.viewsortcols[0]||n.hide()));k.lastsort!==d&&"true"===g.data("autoResized")&&(null!=l&&null!=l.autoResizing&&l.autoResizing.compact||k.autoResizing.compact)&&k.columnsToReResizing.push(d);a=a.substring(5+k.id.length+1);k.sortname=l.index||a}Q.call(this,"onSortCol",k.sortname,d,k.sortorder)?("local"===k.datatype?k.deselectAfterSort&&!k.multiPageSelection&&c.resetSelection.call(b(this)):k.multiPageSelection||(k.selrow=null,
k.multiselect&&(ib.call(this,!1),W(k.selarrrow))),W(k.savedRow),k.scroll&&(m=h.bDiv.scrollLeft,z.emptyRows.call(this,!0,!1),h.hDiv.scrollLeft=m),k.subGrid&&"local"===k.datatype&&b("td.sgexpanded","#"+G(k.id)).each(function(){b(this).trigger("click")}),ha.call(this),k.lastsort=d,k.sortname!==a&&d&&(k.lastsort=d)):k.lastsort=d}},Eb=function(){var b=0,a=u.cell_width?0:P(k.cellLayout,0),c=0,d,e=P(k.scrollOffset,0),f,g=!1,h,l=0,m,n=u.isCellClassHidden;r(k.colModel,function(){void 0===this.hidden&&(this.hidden=
!1);if(k.grouping&&k.autowidth){var d=p(this.name,k.groupingView.groupField);0<=d&&k.groupingView.groupColumnShow.length>d&&(this.hidden=!k.groupingView.groupColumnShow[d])}this.widthOrg=f=P(this.width,0);!1!==this.hidden||n(this.classes)||(b+=f+a,this.fixed?l+=f+a:c++)});isNaN(k.width)&&(k.width=b+(!1!==k.shrinkToFit||isNaN(k.height)?0:e));z.width=k.width;k.tblwidth=b;!1===k.shrinkToFit&&!0===k.forceFit&&(k.forceFit=!1);!0===k.shrinkToFit&&0<c&&(h=z.width-a*c-l,isNaN(k.height)||(h-=e,g=!0),b=0,r(k.colModel,
function(e){!1!==this.hidden||n(this.classes)||this.fixed||(this.width=f=Math.round(h*this.width/(k.tblwidth-a*c-l)),b+=f,d=e)}),m=0,g?z.width-l-(b+a*c)!==e&&(m=z.width-l-(b+a*c)-e):g||1===Math.abs(z.width-l-(b+a*c))||(m=z.width-l-(b+a*c)),k.colModel[d].width+=m,k.tblwidth=b+m+a*c+l,k.tblwidth>k.width&&(k.colModel[d].width-=k.tblwidth-parseInt(k.width,10),k.tblwidth=k.width))},aa=function(b){var a=b,c;for(c=b+1;c<k.colModel.length;c++)if(!0!==k.colModel[c].hidden){a=c;break}return a-b},bb;-1===p(k.multikey,
["shiftKey","altKey","ctrlKey"])&&(k.multikey=!1);k.keyName=!1;k.sortorder=k.sortorder.toLowerCase();u.cell_width=u.cellWidth();var jb=u.cmTemplate,Y,R;for(Y=0;Y<k.colModel.length;Y++)R=k.colModel[Y],bb="string"===typeof R.template?null==jb||"object"!==typeof jb[R.template]&&!b.isFunction(jb[R.template])?{}:jb[R.template]:R.template,m(bb)&&(bb=bb.call(d,{cm:R,iCol:Y})),R=n(!0,{},k.cmTemplate,bb||{},R),!1===k.keyName&&!0===R.key&&(k.keyName=R.name),k.colModel[Y]=R;for(Y=0;Y<k.additionalProperties.length;Y++)R=
k.additionalProperties[Y],!1===k.keyName&&!0===R.key&&(k.keyName=R.name);if(0===k.colNames.length)for(Y=0;Y<k.colModel.length;Y++)k.colNames[Y]=void 0!==k.colModel[Y].label?k.colModel[Y].label:k.colModel[Y].name;if(k.colNames.length!==k.colModel.length)x(w.call(h,"errors.model"));else{!0===k.grouping&&(k.scroll=!1,k.rownumbers=!1,k.treeGrid=!1,k.gridview=!0);if(k.subGrid)try{c.setSubGrid.call(h)}catch(qb){}if(k.multiselect&&("left"===k.multiselectPosition||"right"===k.multiselectPosition)){var ub=
...
cell:"cell"}},k.jsonReader);k.localReader=n(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},k.localReader);k.scroll&&(k.pgbuttons=!1,k.pginput=!1,k.rowList=[]);if(!0===k.treeGrid){try{c.setTreeGrid.call(h)}catch(qb){}"local"!==k.datatype&&(k.localReader={id:"_id_"});k.iPropByName=L(k.additionalProperties)}eb();S();k.data.length&&(ja.call(d),ra());if(!0===k.shrinkToFit&&!0===k.forceFit)for(Y=
k.colModel.length-1;0<=Y;Y--)if(!0!==k.colModel[Y].hidden){k.colModel[Y].resizable=!1;break}var U,ea,cb,fa,la,ga,ma,oa=[],Ca=[],ia=[],ka="<thead><tr class='ui-jqgrid-labels' role='row'>",za,va="<tbody><tr style='display:none;'>",na=E("states.hover"),ua=E("states.disabled");if(k.multiSort){var oa=k.sortname.split(","),wa;for(wa=0;wa<oa.length;wa++)ia=q(oa[wa]).split(" "),oa[wa]=q(ia[0]),Ca[wa]=ia[1]?q(ia[1]):k.sortorder||"asc"}for(Y=0;Y<k.colNames.length;Y++){R=k.colModel[Y];la=k.headertitles||R.headerTitle?
" title='"+lb("string"===typeof R.headerTitle?R.headerTitle:k.colNames[Y])+"'":"";ka+="<th id='"+k.id+"_"+R.name+"' class='"+E("colHeaders","ui-th-column ui-th-"+ba+" "+(R.labelClasses||""))+"'"+la+">";U=R.index||R.name;switch(R.labelAlign){case "left":ga="text-align:left;";break;case "right":ga="text-align:right;"+(!1===R.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;");break;case "likeData":ga=void 0===R.align||"left"===R.align?"text-align:left;":"right"===R.align?
"text-align:right;"+(!1===R.sortable?"":"padding-right:"+k.autoResizing.widthOfVisiblePartOfSortIcon+"px;"):"";break;default:ga=""}ka+="<div id='jqgh_"+k.id+"_"+R.name+"'"+(M?" class='ui-th-div-ie'":"")+(""===ga?"":" style='"+ga+"'")+">";za=R.autoResizable&&"actions"!==R.formatter?"<span class='"+k.autoResizing.wrapperClassName+"'>"+k.colNames[Y]+"</span>":k.colNames[Y];k.sortIconsBeforeText?(ka+=(k.builderSortIcons||u.builderSortIcons).call(d,Y),ka+=za):(ka+=za,ka+=(k.builderSortIcons||u.builderSortIcons).call(d,
Y));ka+="</div></th>";va+="<td></td>";R.width=R.width?parseInt(R.width,10):150;"boolean"!==typeof R.title&&(R.title=!0);R.lso="";U===k.sortname&&(k.lastsort=Y,R.lso=k.sortorder||R.firstsortorder||"asc");k.multiSort&&(ia=p(U,oa),-1!==ia&&(R.lso=Ca[ia]))}var ka=ka+"</tr></thead>",va=va+"</tr></tbody>",ya=b("<table class='"+E("hTable","ui-jqgrid-htable")+"' style='width:1px' role='presentation' aria-labelledby='gbox_"+k.id+"'>"+ka+va+"</table>");b(ya[0].tHead).children("tr").children("th").hover(function(){b(this).addClass(na)},
function(){b(this).removeClass(na)});k.multiselect&&b(k.cb,ya).bind("click",function(){var a=E("states.select"),c,e=[],f=k.iColByName.cb,g=function(c,d){b(c)[d?"addClass":"removeClass"](a).attr(d?{"aria-selected":"true",tabindex:"0"}:{"aria-selected":"false",tabindex:"-1"});void 0!==f&&b(c.cells[f]).children("input.cbox").prop("checked",d)},h=z.fbRows,l=ua+" ui-subgrid jqgroup jqfoot jqgfirstrow jqgskipselect",m,n=k._index;W(k.selarrrow);if(this.checked){if(c=!0,k.selrow=1<d.rows.length?d.rows[d.rows.length-
1].id:null,k.multiPageSelection&&("local"===k.datatype||k.treeGrid)&&null!=k.data&&0<k.data.length&&null!=n)for(m in n)n.hasOwnProperty(m)&&k.selarrrow.push(k.idPrefix+m)}else c=!1,k.selrow=null;var p=c?k.selarrrow:e;b(d.rows).each(function(a){ca(this,l)||(g(this,c),0>b.inArray(this.id,p)&&p.push(this.id),h&&g(h[a],c))});Q.call(d,"onSelectAll",c?k.selarrrow:e,c)});if(!0===k.autowidth){var Ka=Math.floor(b(O).innerWidth());k.width=0<Ka?Ka:"nw"}isNaN(k.width)?isNaN(parseFloat(k.width))||(k.width=parseFloat(k.width)):
k.width=Number(k.width);k.widthOrg=k.width;Eb();b(O).css("width",z.width+"px").append("<div class='"+E("resizer","ui-jqgrid-resize-mark")+"' id='"+k.rsId+"'>&#160;</div>");b(k.rs).bind("selectstart",function(){return!1}).click(pa).dblclick(function(a){var e=b(this).data("idx"),f=b(this).data("pageX"),g=k.colModel[e];if(null==f||null==g)return!1;var f=String(f).split(";"),l=parseFloat(f[0]),m=parseFloat(f[1]);if(2===f.length&&(5<Math.abs(l-m)||5<Math.abs(a.pageX-l)||5<Math.abs(a.pageX-m)))return!1;
Q.call(d,"resizeDblClick",e,g,a)&&g.autoResizable&&c.autoResizeColumn.call(h,e);Q.call(d,"afterResizeDblClick",{iCol:e,cm:g,cmName:g.name});return!1});b(C).css("width",z.width+"px");var Ta="";k.footerrow&&(Ta+="<table role='presentation' style='width:1px' class='"+E("gridFooter","ui-jqgrid-ftable")+"'><tbody><tr role='row' class='"+E("rowFooter","footrow footrow-"+ba)+"'>");var Aa="<tr class='jqgfirstrow' role='row' style='height:auto'>";k.disableClick=!1;b("th",ya[0].tHead.rows[0]).each(function(a){var c=
k.colModel[a],d=c.name,e=b(this),f=e.children("div"),g=f.children("span.s-ico"),h=k.showOneSortIcon;ea=c.width;void 0===c.resizable&&(c.resizable=!0);c.resizable?(cb=document.createElement("span"),b(cb).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+ba).bind("selectstart",function(){return!1}),e.addClass(k.resizeclass)):cb="";e.css("width",ea+"px").prepend(cb);cb=null;var l="";!0===c.hidden&&(e.css("display","none"),l="display:none;");Aa+="<td role='gridcell' "+(c.classes?"class='"+
...
h&&g.children("span.ui-icon-"+d).hide())):(d="desc"===k.sortorder?"asc":"desc",k.viewsortcols[0]?(g.css("display",""),a===k.lastsort&&(g.children("span.ui-icon-"+k.sortorder).removeClass(ua),h&&g.children("span.ui-icon-"+d).hide())):a===k.lastsort&&""!==c.lso&&(g.css("display",""),g.children("span.ui-icon-"+k.sortorder).removeClass(ua),h&&g.children("span.ui-icon-"+d).hide())));k.footerrow&&(Ta+="<td role='gridcell' "+T(a,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(a){var c=b(this),d=c.closest(".ui-jqgrid-hdiv").hasClass("frozen-div"),
e=function(){var a=[c.position().left+c.outerWidth()];"rtl"===k.direction&&(a[0]=k.width-a[0]);a[0]-=d?0:z.bDiv.scrollLeft;a.push(b(z.hDiv).position().top);a.push(b(z.bDiv).offset().top-b(z.hDiv).offset().top+b(z.bDiv).height()+(z.sDiv?b(z.sDiv).height():0));return a},f;if(1===b(a.target).closest("th>span.ui-jqgrid-resize").length)return f=k.iColByName[(this.id||"").substring(k.id.length+1)],null!=f&&(!0===k.forceFit&&(k.nv=aa(f)),z.dragStart(f,a,e(),c)),!1}).click(function(a){if(k.disableClick)return k.disableClick=
!1;var c="th.ui-th-column>div",e,f,c=k.viewsortcols[2]?c+".ui-jqgrid-sortable":c+">span.s-ico>span.ui-grid-ico-sort";a=b(a.target).closest(c);if(1===a.length)return k.viewsortcols[2]||(e=!0,f=a.hasClass("ui-icon-desc")?"desc":"asc"),a=k.iColByName[(this.id||"").substring(k.id.length+1)],null!=a&&tb.call(d,b("div",this)[0].id,a,e,f,this),!1});if(k.sortable&&b.fn.sortable)try{c.sortableColumns.call(h,b(ya[0].tHead.rows[0]))}catch(qb){}k.footerrow&&(Ta+="</tr></tbody></table>");Aa+="</tr>";h.html("<tbody>"+
Aa+"</tbody>");h.addClass(E("grid","ui-jqgrid-btable"+(!0===k.altRows&&h.jqGrid("isBootstrapGuiStyle")?" table-striped":"")));var Ba=k.caption&&!0===k.hiddengrid?!0:!1,Za=b("<div class='ui-jqgrid-hbox"+("rtl"===ba?"-rtl":"")+"'></div>"),Qa=E("top"),Ga=E("bottom");z.hDiv=document.createElement("div");b(z.hDiv).css({width:z.width+"px"}).addClass(E("hDiv","ui-jqgrid-hdiv")).append(Za).scroll(function(){var a=b(this).next(".ui-jqgrid-bdiv")[0];a&&(a.scrollLeft=this.scrollLeft);return!1});b(Za).append(ya);
ya=null;Ba&&b(z.hDiv).hide();k.rowNum=parseInt(k.rowNum,10);if(isNaN(k.rowNum)||0>=k.rowNum)k.rowNum=k.maxRowNum;if(k.pager){var Oa,Ua;"string"===typeof k.pager&&"#"!==k.pager.substr(0,1)?(Ua=k.pager,Oa=b("#"+G(k.pager))):!0===k.pager?(Ua=Da(),Oa=b("<div id='"+Ua+"'></div>"),Oa.appendTo("body"),k.pager="#"+G(Ua)):(Oa=b(k.pager),Ua=Oa.attr("id"));0<Oa.length?(Oa.css({width:z.width+"px"}).addClass(E("pager.pager","ui-jqgrid-pager "+Ga)).appendTo(O),Ba&&Oa.hide(),sb.call(d,Ua,""),k.pager="#"+G(Ua)):
...
d.current&&e.selectionPreserver.call(this);"local"===k.datatype?(k.multiPageSelection||c.resetSelection.call(f),k.data.length&&(ja.call(this),ra())):k.treeGrid||k.multiPageSelection||(k.selrow=null,k.multiselect&&(W(k.selarrrow),ib.call(this,!1)),W(k.savedRow));k.iRow=-1;k.iCol=-1;k.scroll&&z.emptyRows.call(this,!0,!1);if(d.page){var g=parseInt(d.page,10);g>k.lastpage&&(g=k.lastpage);1>g&&(g=1);k.page=g;e.bDiv.scrollTop=e.prevRowHeight?(g-1)*e.prevRowHeight*k.rowNum:0}e.prevRowHeight&&k.scroll&&void 0===
d.page?(delete k.lastpage,e.populateVisible.call(this)):e.populate.call(this);!0===k._inlinenav&&f.jqGrid("showAddEditButtons",!1);return!1}).dblclick(function(b){var a=Ma.call(this,b.target),c=a.parent();if(0<a.length&&!Q.call(d,"ondblClickRow",c.attr("id"),c[0].rowIndex,a[0].cellIndex,b))return!1}).bind("contextmenu",function(b){var a=Ma.call(this,b.target),c=a.parent(),e=c.attr("id");if(0!==a.length&&(k.multiselect||t.call(h,e,!0,b),!Q.call(d,"onRightClickRow",e,c[0].rowIndex,a[0].cellIndex,b)))return!1});
z.bDiv=document.createElement("div");M&&"auto"===String(k.height).toLowerCase()&&(k.height="100%");b(z.bDiv).append(b("<div style='position:relative;'></div>").append("<div></div>").append(d)).addClass("ui-jqgrid-bdiv").css({height:k.height+(isNaN(k.height)?"":"px"),width:z.width+"px"}).scroll(z.scrollGrid);k.maxHeight&&b(z.bDiv).css("max-height",k.maxHeight+(isNaN(k.maxHeight)?"":"px"));h.css({width:"1px"});b.support.tbody||2===b(">tbody",d).length&&b(">tbody:gt(0)",d).remove();k.multikey&&b(z.bDiv).bind(u.msie?
"selectstart":"mousedown",function(){return!1});Ba&&b(z.bDiv).hide();z.cDiv=document.createElement("div");var Pa=A("gridMinimize.visible"),Va=A("gridMinimize.hidden"),Wa=D("showhide"),Sa=!0===k.hidegrid?b("<a role='link' class='"+E("titleButton","ui-jqgrid-titlebar-close")+"'"+(Wa?" title='"+Wa+"'":"")+"/>").hover(function(){Sa.addClass(na)},function(){Sa.removeClass(na)}).append("<span class='"+Pa+"'></span>"):"";b(z.cDiv).append("<span class='ui-jqgrid-title'>"+k.caption+"</span>").append(Sa).addClass(E("gridTitle",
"ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===ba?"-rtl ":" ")+Qa));b(z.cDiv).insertBefore(z.hDiv);if(k.toolbar[0]){z.uDiv=document.createElement("div");"top"===k.toolbar[1]?b(z.uDiv).insertBefore(z.hDiv):"bottom"===k.toolbar[1]&&b(z.uDiv).insertAfter(z.hDiv);var Xa=E("toolbarUpper","ui-userdata");"both"===k.toolbar[1]?(z.ubDiv=document.createElement("div"),b(z.uDiv).addClass(Xa).attr("id","t_"+k.id).insertBefore(z.hDiv),b(z.ubDiv).addClass(E("toolbarBottom","ui-userdata")).attr("id","tb_"+k.id).insertAfter(z.hDiv),
Ba&&b(z.ubDiv).hide()):b(z.uDiv).width(z.width).addClass(Xa).attr("id","t_"+k.id);Ba&&b(z.uDiv).hide()}"string"===typeof k.datatype&&(k.datatype=k.datatype.toLowerCase());k.toppager?(k.toppager=k.id+"_toppager",z.topDiv=b("<div id='"+k.toppager+"'></div>")[0],b(z.topDiv).addClass(E("pager.pager","ui-jqgrid-toppager"+(k.caption?"":" "+Qa))).css({width:z.width+"px"}).insertBefore(z.hDiv),sb.call(d,k.toppager,"_t"),k.toppager="#"+G(k.toppager)):""!==k.pager||k.scroll||(k.rowNum=k.maxRowNum);k.footerrow&&
(z.sDiv=b("<div class='ui-jqgrid-sdiv'></div>")[0],Za=b("<div class='ui-jqgrid-hbox"+("rtl"===ba?"-rtl":"")+"'></div>"),b(z.sDiv).append(Za).width(z.width).insertAfter(z.hDiv),b(Za).append(Ta),z.footers=b(".ui-jqgrid-ftable",z.sDiv)[0].rows[0].cells,k.rownumbers&&(z.footers[0].className=E("rowNum","jqgrid-rownum")),Ba&&b(z.sDiv).hide());Za=null;if(k.caption){var db=k.datatype;!0===k.hidegrid&&(b(".ui-jqgrid-titlebar-close",z.cDiv).click(function(a){var c=".ui-jqgrid-bdiv,.ui-jqgrid-hdiv,.ui-jqgrid-pager,.ui-jqgrid-sdiv",
e=this;!0===k.toolbar[0]&&("both"===k.toolbar[1]&&(c+=",#"+G(b(z.ubDiv).attr("id"))),c+=",#"+G(b(z.uDiv).attr("id")));var f=b(c,k.gView).length;k.toppager&&(c+=","+k.toppager);"visible"===k.gridstate?b(c,k.gBox).slideUp("fast",function(){f--;0===f&&(b("span",e).removeClass(Pa).addClass(Va),k.gridstate="hidden",b(k.gBox).hasClass("ui-resizable")&&b(".ui-resizable-handle",k.gBox).hide(),b(z.cDiv).addClass(Ga),Ba||Q.call(d,"onHeaderClick",k.gridstate,a))}):"hidden"===k.gridstate&&(b(z.cDiv).removeClass(Ga),
b(c,k.gBox).slideDown("fast",function(){f--;0===f&&(b("span",e).removeClass(Va).addClass(Pa),Ba&&(k.datatype=db,ha.call(d),Ba=!1),k.gridstate="visible",b(k.gBox).hasClass("ui-resizable")&&b(".ui-resizable-handle",k.gBox).show(),Ba||Q.call(d,"onHeaderClick",k.gridstate,a))}));return!1}),Ba&&(k.datatype="local",b(".ui-jqgrid-titlebar-close",z.cDiv).trigger("click")))}else b(z.cDiv).hide(),b(z.cDiv).nextAll("div:visible").first().addClass("ui-corner-top");b(z.hDiv).after(z.bDiv);z.eDiv=b("<div class='"+
E("gridError","ui-jqgrid-errorbar ui-jqgrid-errorbar-"+ba)+"' style='display:none;'><span class='ui-jqgrid-error'></span></div>")[0];b(z.hDiv).after(z.eDiv);b(O).click(pa).dblclick(function(a){var e=b(k.rs),f=e.offset(),g=e.data("idx"),l=e.data("delta"),m=k.colModel[g],n=b(this).data("pageX")||e.data("pageX");if(null==n||null==m)return!1;var n=String(n).split(";"),p=parseFloat(n[0]),r=parseFloat(n[1]);if(2===n.length&&(5<Math.abs(p-r)||5<Math.abs(a.pageX-p)||5<Math.abs(a.pageX-r)))return!1;Q.call(d,
"resizeDblClick",g,m)&&f.left-1<=a.pageX+l&&a.pageX+l<=f.left+e.outerWidth()+1&&m.autoResizable&&c.autoResizeColumn.call(h,g);Q.call(d,"afterResizeDblClick",{iCol:g,cm:m,cmName:m.name});return!1});k.pager||b(z.cDiv).nextAll("div:visible").filter(":last").addClass(Ga);b(".ui-jqgrid-labels",z.hDiv).bind("selectstart",function(){return!1});d.formatCol=T;d.sortData=tb;d.updatepager=hb;d.refreshIndex=ra;d.setHeadCheckBox=ib;d.fixScrollOffsetAndhBoxPadding=I;d.constructTr=sa;d.formatter=N;n(z,{populate:ha,
emptyRows:X,beginReq:da,endReq:Ja});d.addXmlData=Fa;d.addJSONData=Fa;d.rebuildRowIndexes=J;d.grid.cols=d.rows[0].cells;Q.call(d,"onInitGrid");k.treeGrid&&"local"===k.datatype&&null!=k.data&&0<k.data.length&&(k.datatype="jsonstring",k.datastr=k.data,k.data=[]);ha.call(d);k.hiddengrid=!1}}}})};var C=b.fn.jqGrid;u.extend({getGridRes:function(a){var c=this[0];if(!c||!c.grid||!c.p)return null;c=u.getRes(Ha[c.p.locale],a)||u.getRes(Ha["en-US"],a);a=u.getRes(u,a);return"object"!==typeof c||null===c||b.isArray(c)?
...
f.call(c,e.selrow),p(c),e.selrow=null);!0===e.cellEdit&&0<=parseInt(e.iCol,10)&&0<=parseInt(e.iRow,10)&&(c=this.rows[e.iRow],null!=c&&(b(c.cells[e.iCol]).removeClass(h),b(c).removeClass(d)),n&&(c=n[e.iRow],null!=c&&(b(c.cells[e.iCol]).removeClass(h),b(c).removeClass(d))));W(e.savedRow)})},getRowData:function(a,c){var e={},d;"object"===typeof a&&(c=a,a=void 0);c=c||{};this.each(function(){var f=this.p,g=!1,h,m=2,l=0,n=this.rows,p,q,r,t,u;if(void 0===a)g=!0,d=[],m=n.length;else if(h=C.getGridRowById.call(b(this),
a),!h)return e;for(;l<m;){g&&(h=n[l]);if(b(h).hasClass("jqgrow")){q=b("td[role=gridcell]",h);for(p=0;p<q.length;p++)if(r=f.colModel[p],t=r.name,!("cb"===t||"subgrid"===t||"rn"===t||"actions"===r.formatter||c.skipHidden&&r.hidden))if(u=q[p],!0===f.treeGrid&&t===f.ExpandColumn)e[t]=Aa(b("span",u).first().html());else try{e[t]=b.unformat.call(this,u,{rowId:h.id,colModel:r},p)}catch(x){e[t]=Aa(b(u).html())}!c.includeId||!1!==f.keyName&&null!=e[f.keyName]||(e[f.prmNames.id]=Na(f.idPrefix,h.id));g&&(d.push(e),
...
t,l))}Q.call(f,"afterSetRow",{rowid:a,inputData:c,iData:q,iRow:h.rowIndex,tr:h,localData:l,cssProp:e})}catch(u){d=!1}d&&("string"===m?b(h).addClass(e):null!==e&&"object"===m&&b(h).css(e))});return d},addRowData:function(a,c,e,d){0>b.inArray(e,"first last before after afterSelected beforeSelected".split(" "))&&(e="last");var f=!1,g,h,m,l,n,p,q,r,t,w,x;c&&(b.isArray(c)?(p=!0,q=a):(c=[c],p=!1),this.each(function(){var B=this.p,y=c.length,v=b(this),F=this.rows,A=0,E=C.getGridRowById,k=B.colModel,D,I=
B.additionalProperties;p||(void 0!==a?a=String(a):(a=Da(),!1!==B.keyName&&(q=B.keyName,void 0!==c[0][q]&&(a=c[0][q]))));for(r=B.altclass;A<y;){t=c[A];h=[];if(p)try{a=t[q],void 0===a&&(a=Da())}catch(H){a=Da()}x=a;D={};for(l=0;l<k.length;l++)w=k[l],g=w.name,"rn"!==g&&"cb"!==g&&"subgrid"!==g&&(n=Xa.call(this,t[g],w,void 0,x,{},l),b.isFunction(w.saveLocally)?w.saveLocally.call(this,{newValue:n,newItem:D,oldItem:{},id:x,cm:w,cmName:g,iCol:l}):void 0!==n&&(D[g]=n));for(l=0;l<I.length;l++)g=I[l],"object"===
typeof g&&g.hasOwnProperty("name")&&(g=g.name),n=qa(t,g),void 0!==n&&(D[g]=n);"local"===B.datatype&&(D[B.localReader.id]=x,B._index[x]=B.data.length,B.data.push(D));h=u.parseDataToHtml.call(this,1,[a],[t]);h=h.join("");if(0===F.length)b(this.tBodies[0]).append(h);else{if("afterSelected"===e||"beforeSelected"===e)void 0===d&&null!==B.selrow?(d=B.selrow,e="afterSelected"===e?"after":"before"):e="afterSelected"===e?"last":"first";switch(e){case "last":b(F[F.length-1]).after(h);m=F.length-1;break;case "first":b(F[0]).after(h);
m=1;break;case "after":if(m=E.call(v,d))b(F[m.rowIndex+1]).hasClass("ui-subgrid")?(b(F[m.rowIndex+1]).after(h),m=m.rowIndex+2):(b(m).after(h),m=m.rowIndex+1);break;case "before":if(m=E.call(v,d))b(m).before(h),m=m.rowIndex-1}}!0===B.subGrid&&C.addSubGrid.call(v,B.iColByName.subgrid,m);B.records++;B.reccount++;0===B.lastpage&&(B.lastpage=1);Q.call(this,"afterAddRow",{rowid:a,inputData:c,position:e,srcRowid:d,iRow:m,localData:D,iData:B.data.length-1});A++}!0!==B.altRows||p||v.jqGrid("isBootstrapGuiStyle")||
...
this.hidden||q(this.classes)||(d=this.widthOrg,g+=d+x,this.fixed?p+=this.width+x:m++)});if(0===m)return;e.tblwidth=parseInt(g,10);n=r-x*m-p;!isNaN(e.height)&&(v.clientHeight<v.scrollHeight||1===this.rows.length)&&(l=!0,n-=w);D=n/(e.tblwidth-x*m-p);if(0>D)return;g=0;k=0<E.length;b.each(t,function(b){!1!==this.hidden||q(this.classes)||this.fixed||(this.width=d=Math.round(this.widthOrg*D),g+=d,B[b].width=d,I[b].style.width=d+"px",e.footerrow&&(y[b].style.width=d+"px"),k&&(E[b].style.width=d+"px"),h=
b)});if(!h)return;n=0;l?r-p-(g+x*m)!==w&&(n=r-p-(g+x*m)-w):1!==Math.abs(r-p-(g+x*m))&&(n=r-p-(g+x*m));t=t[h];t.width+=n;e.tblwidth=parseInt(g+n+x*m+p,10);e.tblwidth>r&&(n=e.tblwidth-parseInt(r,10),e.tblwidth=r,t.width-=n);d=t.width;r=B[h];r.width=d;I[h].style.width=d+"px";k&&(E[h].style.width=d+"px");e.footerrow&&(y[h].style.width=d+"px");e.tblwidth+(l?w:0)<e.width&&H(e.tblwidth+(l?w:0));v.offsetWidth>v.clientWidth&&(e.autowidth||void 0!==e.widthOrg&&"auto"!==e.widthOrg&&"100%"!==e.widthOrg||H(v.offsetWidth))}e.tblwidth&&
...
f.jqGrid("prevCell",a,c):f.jqGrid("nextCell",a,c)}e.stopPropagation()});Q.call(d,"afterEditCell",q,h,m,a,c);f.triggerHandler("jqGridAfterEditCell",[q,h,m,a,c])}g.iCol=c;g.iRow=a}}}})},saveCell:function(a,c){return this.each(function(){var e=this,d=b(e),f=e.p,g=u.info_dialog,h=u.jqID;if(e.grid&&!0===f.cellEdit){var m=d.jqGrid("getGridRes","errors"),l=m.errcap,n=d.jqGrid("getGridRes","edit").bClose,p=f.savedRow,q=1<=p.length?0:null;if(null!==q){var r=e.rows[a],t=r.id,w=b(r),x=f.colModel[c],B=x.name,
y,v=ya.call(e,r,c),F={},A=u.getEditedValue.call(e,v,x,F);if(A!==p[q].v){y=d.triggerHandler("jqGridBeforeSaveCell",[t,B,A,a,c]);void 0!==y&&(A=y);b.isFunction(f.beforeSaveCell)&&(y=f.beforeSaveCell.call(e,t,B,A,a,c),void 0!==y&&(A=y));var E=u.checkValues.call(e,A,c,void 0,void 0,{oldValue:p[q].v,newValue:A,cmName:B,rowid:t,iCol:c,iRow:a,cm:x,tr:r,td:v,mode:"cell"}),r=x.formatoptions||{};if(!0===E[0]){q=d.triggerHandler("jqGridBeforeSubmitCell",[t,B,A,a,c])||{};b.isFunction(f.beforeSubmitCell)&&((q=
f.beforeSubmitCell.call(e,t,B,A,a,c))||(q={}));0<b("input.hasDatepicker",v).length&&b("input.hasDatepicker",v).datepicker("hide");"date"===x.formatter&&!0!==r.sendFormatted&&(A=b.unformat.date.call(e,A,x));if("remote"===f.cellsubmit)if(f.cellurl){var k={};k[B]=A;var m=f.prmNames,r=m.oper,D=e.grid.hDiv;k[m.id]=u.stripPref(f.idPrefix,t);k[r]=m.editoper;k=b.extend(q,k);f.autoEncodeOnEdit&&b.each(k,function(a,c){b.isFunction(c)||(k[a]=u.oldEncodePostedData(c))});d.jqGrid("progressBar",{method:"show",
loadtype:f.loadui,htmlcontent:u.defaults.savetext||"Saving..."});D.loading=!0;b.ajax(b.extend({url:b.isFunction(f.cellurl)?f.cellurl.call(e,f.cellurl,a,c,t,A,B):f.cellurl,data:u.serializeFeedback.call(e,f.serializeCellData,"jqGridSerializeCellData",k),type:"POST",complete:function(h){d.jqGrid("progressBar",{method:"hide",loadtype:f.loadui});D.loading=!1;if((300>h.status||304===h.status)&&(0!==h.status||4!==h.readyState)){var m=d.triggerHandler("jqGridAfterSubmitCell",[e,h,k.id,B,A,a,c])||[!0,""];
!0===m[0]&&b.isFunction(f.afterSubmitCell)&&(m=f.afterSubmitCell.call(e,h,k.id,B,A,a,c));!0===m[0]?(d.jqGrid("setCell",t,c,A,!1,!1,!0),v.addClass("dirty-cell"),w.addClass("edited"),Q.call(e,"afterSaveCell",t,B,A,a,c),p.splice(0,1)):(g.call(e,l,m[1],n),d.jqGrid("restoreCell",a,c))}},error:function(k,m,p){b("#lui_"+h(f.id)).hide();D.loading=!1;d.triggerHandler("jqGridErrorCell",[k,m,p]);b.isFunction(f.errorCell)?f.errorCell.call(e,k,m,p):g.call(e,l,k.status+" : "+k.statusText+"<br/>"+m,n);d.jqGrid("restoreCell",
a,c)}},u.ajaxOptions,f.ajaxCellOptions||{}))}else try{g.call(e,l,m.nourl,n),d.jqGrid("restoreCell",a,c)}catch(I){}"clientArray"===f.cellsubmit&&(d.jqGrid("setCell",t,c,"select"===x.edittype&&"select"!==x.formatter?F.text:A,!1,!1,!0),v.addClass("dirty-cell"),w.addClass("edited"),Q.call(e,"afterSaveCell",t,B,A,a,c),p.splice(0,1))}else try{setTimeout(function(){g.call(e,l,A+" "+E[1],n)},100),d.jqGrid("restoreCell",a,c)}catch(I){}}else d.jqGrid("restoreCell",a,c)}setTimeout(function(){b("#"+h(f.knv)).attr("tabindex",
"-1").focus()},0)}})},restoreCell:function(a,c){return this.each(function(){var e=this.p,d=this.rows[a],f=d.id,g,h;if(this.grid&&!0===e.cellEdit){var m=e.savedRow;g=ya.call(this,d,c);if(1<=m.length){if(b.isFunction(b.fn.datepicker))try{b("input.hasDatepicker",g).datepicker("hide")}catch(l){}d=e.colModel[c];!0===e.treeGrid&&d.name===e.ExpandColumn?g.children("span.cell-wrapperleaf,span.cell-wrapper").empty():g.empty();g.attr("tabindex","-1");g=m[0].v;h=d.formatoptions||{};"date"===d.formatter&&!0!==
h.sendFormatted&&(g=b.unformat.date.call(this,g,d));b(this).jqGrid("setCell",f,c,g,!1,!1,!0);Q.call(this,"afterRestoreCell",f,g,a,c);m.splice(0,1)}setTimeout(function(){b("#"+e.knv).attr("tabindex","-1").focus()},0)}})},nextCell:function(a,c){return this.each(function(){var e=b(this),d=this.p,f=!1,g,h,m,l=this.rows;if(this.grid&&!0===d.cellEdit&&null!=l&&null!=l[a]){for(g=c+1;g<d.colModel.length;g++)if(m=d.colModel[g],h=m.editable,b.isFunction(h)&&(h=h.call(this,{rowid:l[a].id,iCol:g,iRow:a,name:m.name,
cm:m,mode:"cell"})),!0===h){f=g;break}!1!==f?e.jqGrid("editCell",a,f,!0):0<d.savedRow.length&&e.jqGrid("saveCell",a,c)}})},prevCell:function(a,c){return this.each(function(){var e=b(this),d=this.p,f=!1,g,h,m,l=this.rows;if(this.grid&&!0===d.cellEdit&&null!=l&&null!=l[a]){for(g=c-1;0<=g;g--)if(m=d.colModel[g],h=m.editable,b.isFunction(h)&&(h=h.call(this,{rowid:l[a].id,iCol:g,iRow:a,name:m.name,cm:m,mode:"cell"})),!0===h){f=g;break}!1!==f?e.jqGrid("editCell",a,f,!0):0<d.savedRow.length&&e.jqGrid("saveCell",
...
m=b.keyCode;"rtl"===f.direction&&(37===m?m=39:39===m&&(m=37));switch(m){case 38:0<g-1&&(a(g-1,l,"vu"),d.jqGrid("editCell",g-1,l,!1));break;case 40:g+1<=e.rows.length-1&&(a(g+1,l,"vd"),d.jqGrid("editCell",g+1,l,!1));break;case 37:0<=l-1&&(h=c(l-1,"lft"),a(g,h,"h"),d.jqGrid("editCell",g,h,!1));break;case 39:l+1<=f.colModel.length-1&&(h=c(l+1,"rgt"),a(g,h,"h"),d.jqGrid("editCell",g,h,!1));break;case 13:0<=l&&0<=g&&d.jqGrid("editCell",g,l,!0);break;default:return!0}return!1})}})},getChangedCells:function(a){var c=
[];a||(a="all");this.each(function(){var e=this,d=e.p,f=u.htmlDecode,g=e.rows;e.grid&&!0===d.cellEdit&&b(g).each(function(h){var m={};if(b(this).hasClass("edited")){var l=this;b(this.cells).each(function(c){var p=d.colModel[c],q=p.name,r=ya.call(e,l,c);if("cb"!==q&&"subgrid"!==q&&"rn"!==q&&("dirty"!==a||r.hasClass("dirty-cell")))try{m[q]=b.unformat.call(e,r[0],{rowId:g[h].id,colModel:p},c)}catch(t){m[q]=f(r.html())}});m.id=this.id;c.push(m)}})});return c}});var N=C.getGuiStyles,la=C.getGridRes;u.jqModal=
...
a.modalcontent);b(p).append(c);t.appendChild(p);b(t).prepend(r);!0===g?b("body").append(l):"string"===typeof g?b(g).append(l):b(l).insertBefore(d);b(l).css(h);void 0===e.jqModal&&(e.jqModal=!0);c={};if(b.fn.jqm&&!0===e.jqModal)0===e.left&&0===e.top&&e.overlay&&(g=[],g=u.findPos(f),e.left=g[0]+4,e.top=g[1]+4),c.top=e.top+"px",c.left=e.left;else if(0!==e.left||0!==e.top)c.left=e.left,c.top=e.top+"px";b("a.ui-jqdialog-titlebar-close",r).click(function(){var a=b(n).data("onClose")||e.onClose,c=b(n).data("gbox")||
...
l.afterSearch.call(c)},E=p("search.odata")||[],k=f.customSortOperations,D=function(a,e,g){b("#sopt_menu").remove();e=parseInt(e,10);g=parseInt(g,10)+18;var h,p=0,r=[],q=b(a).data("soper"),p=b(a).data("colname"),v=b(".ui-jqgrid-view").css("font-size")||"11px";e="<ul id='sopt_menu' class='"+N.call(c,"searchToolbar.menu","ui-search-menu")+"' role='menu' tabindex='0' style='z-index:9999;display:block;font-size:"+v+";left:"+e+"px;top:"+g+"px;'>";p=f.iColByName[p];if(void 0!==p){p=n[p];g=b.extend({},p.searchoptions);
var t,u;g.sopt||(g.sopt=[],g.sopt[0]="select"===p.stype?"eq":l.defaultSearch);b.each(E,function(){r.push(this.oper)});null!=k&&b.each(k,function(b){r.push(b)});for(p=0;p<g.sopt.length;p++)v=g.sopt[p],h=b.inArray(v,r),-1!==h&&(h=E[h],void 0!==h?(u=l.operands[v],t=h.text):null!=k&&(t=k[v],u=t.operand,t=t.text),h=q===v?x:"",e+='<li class="ui-menu-item '+h+'" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="'+m(v)+'" data-oper="'+m(u)+'"><table><tr><td style="width:25px">'+
...
d.searchtitle:p("search.operandTitle"))+"' data-soper='"+e+"' class='"+N.call(c,"searchToolbar.operButton","soptclass")+"' data-colname='"+this.name+"'>"+m+"</a>"}b("td",O).first().data("colindex",a).append(e);null!=d.sopt&&1!==d.sopt.length||b("td.ui-search-oper",O).hide();f.search&&null!=y[this.name]&&(d.defaultValue=y[this.name].data);void 0===d.clearSearch&&(d.clearSearch="text"===this.stype?!0:!1);d.clearSearch?(e=p("search.resetTitle")||"Clear Search Value",b("td",O).eq(2).append("<a title='"+
...
u.ajaxOptions,f.ajaxSelectOptions||{}));else{var T,Z,V;this.searchoptions?(T=void 0===x.value?D.value||"":x.value,Z=void 0===x.separator?D.separator||":":x.separator,V=void 0===x.delimiter?D.delimiter||";":x.delimiter):this.editoptions&&(T=void 0===D.value?"":D.value,Z=void 0===D.separator?":":D.separator,V=void 0===D.delimiter?";":D.delimiter);if(T){x=document.createElement("select");x.style.width="100%";b(x).attr({name:this.index||this.name,id:v(this.name)});var K,X,ja;if("string"===typeof T)for(e=
...
d);try{d.removeAttr("rowSpan")}catch(n){d.attr("rowSpan",1)}m.append(d);f=d.children("span.ui-jqgrid-resize");0<f.length&&(f[0].style.height="");d.children("div")[0].style.top=""}b(h).children("tr.ui-jqgrid-labels").remove();b(h).prepend(m);!0===a&&b(this).jqGrid("setGridParam",{groupHeader:null})}})},setGroupHeaders:function(a){a=b.extend({useColSpanStyle:!1,applyLabelClasses:!0,groupHeaders:[]},a||{});return this.each(function(){this.p.groupHeader=a;var c,e,d=0,f,g,h,m,l,n,p=this.p,q=p.colModel,
...
m&&"text"===d.inputtype&&!h.size&&(h.size=10);var k=u.createEl.call(f,d.inputtype,h,"",!0,e.p.ajaxSelectOptions||{},!0);b(k).addClass(n("searchDialog.elem","input-elm"));r=h.sopt?h.sopt:e.p.sopt?e.p.sopt:-1!==b.inArray(d.searchtype,e.p.strarr)?e.p.stropts:e.p.numopts;d="";var l=0,p,t;S=[];b.each(e.p.ops,function(){S.push(this.oper)});e.p.cops&&b.each(e.p.cops,function(b){S.push(b)});for(g=0;g<r.length;g++)t=r[g],J=b.inArray(r[g],S),-1!==J&&(p=e.p.ops[J],p=void 0!==p?p.text:e.p.cops[t].text,0===l&&
...
"get"):c.value;e.onchange()});setTimeout(function(){a.data=b(k).val();e.onchange()},0)}});var H=0,C,P;for(h=0;h<e.p.columns.length;h++)if(w=void 0===e.p.columns[h].search?!0:e.p.columns[h].search,C=!0===e.p.columns[h].hidden,(P=!0===e.p.columns[h].searchoptions.searchhidden)&&w||w&&!C)w="",a.field===e.p.columns[h].name&&(w=" selected='selected'",H=h),t+="<option value='"+e.p.columns[h].name+"'"+w+">"+e.p.columns[h].label+"</option>";L.append(t);t=b("<td class='operators'></td>");g.append(t);k=d.columns[H];
...
n="#"+G(l.themodal),p=f.gBox,q=f.gView,r=b.each,t=f.postData[g.sFilter],w=function(){var a=b.makeArray(arguments);a.unshift("Search");a.unshift("Filter");a.unshift(g);return Pa.apply(e,a)},x=function(){u.hideModal(n,{gb:p,jqm:g.jqModal,onClose:g.onClose,removemodal:g.removemodal})};"string"===typeof t&&(t=""!==b.trim(t)?b.parseJSON(t):void 0);b(n).remove();if(void 0!==b(n)[0])c(b("#fbox_"+f.idSel));else{var B=b("<div><div id='"+h+"' class='"+N.call(e,"dialog.body","searchFilter")+"' style='overflow:auto'></div></div>").insertBefore(q);
"rtl"===f.direction&&B.attr("dir","rtl");var y="",v="",F,A=!1,E,k=-1,D=b.extend([],f.colModel);E=ea.call(e,h+"_search",g.Find,xa(m,g.findDialogIcon),"right");var I=ea.call(e,h+"_reset",g.Reset,xa(m,g.resetDialogIcon),"left");g.showQuery&&(y=ea.call(e,h+"_query","Query",xa(m,g.queryDialogIcon),"left")+"&#160;");g.searchForAdditionalProperties&&r(f.additionalProperties,function(){var b="string"===typeof this?{name:this}:this;b.label||(b.label=b.name);b.isAddProp=!0;D.push(b)});g.columns.length?(D=g.columns,
k=0,F=D[0].index||D[0].name):r(D,function(b,a){a.label||(a.label=a.isAddProp?a.name:f.colNames[b]);if(!A){var c=void 0===a.search?!0:a.search,d=!0===a.hidden;if(a.searchoptions&&!0===a.searchoptions.searchhidden&&c||c&&!d)A=!0,F=a.index||a.name,k=b}});if(!t&&F||!1===g.multipleSearch)m="eq",0<=k&&D[k].searchoptions&&D[k].searchoptions.sopt?m=D[k].searchoptions.sopt[0]:g.sopt&&g.sopt.length&&(m=g.sopt[0]),t={groupOp:"AND",rules:[{field:F,op:m,data:""}]};A=!1;g.tmplNames&&g.tmplNames.length&&(A=!0,v=
g.tmplLabel,v+="<select class='ui-template'>",v+="<option value='default'>Default</option>",r(g.tmplNames,function(b,a){v+="<option value='"+b+"'>"+a+"</option>"}),v+="</select>");E="<div class='"+N.call(e,"dialog.footer")+"'><table class='EditTable' style='border:0px none;margin-top:5px' id='"+h+"_2'><tbody><tr><td colspan='2'><hr class='"+N.call(e,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='EditButton EditButton-"+f.direction+"'  style='float:"+("rtl"===f.direction?"right":"left")+
";'>"+I+v+"</td><td class='EditButton EditButton-"+f.direction+"'>"+y+E+"</td></tr></tbody></table></div>";h=G(h);g.gbox=p;g.height="auto";h="#"+h;b(h).jqFilter({columns:D,filter:g.loadDefaults?t:null,showQuery:g.showQuery,errorcheck:g.errorcheck,sopt:g.sopt,groupButton:g.multipleGroup,ruleButtons:g.multipleSearch,afterRedraw:g.afterRedraw,ops:g.odata,cops:f.customSortOperations,operands:g.operands,ajaxSelectOptions:f.ajaxSelectOptions,groupOps:g.groupOps,onChange:function(){this.p.showQuery&&b(".query",
this).html(this.toUserFriendlyString());Ca.call(e,g.afterChange,"jqGridFilterAfterChange",b(h),g)},direction:f.direction,id:f.id});B.append(E);A&&g.tmplFilters&&g.tmplFilters.length&&b(".ui-template",B).bind("change",function(){var a=b(this).val();"default"===a?b(h).jqFilter("addFilter",t):b(h).jqFilter("addFilter",g.tmplFilters[parseInt(a,10)]);return!1});!0===g.multipleGroup&&(g.multipleSearch=!0);w("onInitialize",b(h));g.layer?u.createModal.call(e,l,B,g,q,b(p)[0],"#"+G(g.layer),{position:"relative"}):
...
g=0>g.search(/(false|f|0|no|n|off|undefined)/i)&&""!==g);b(d,c).prop({checked:g,defaultChecked:g});break;case "custom":try{if(m[f].editoptions&&b.isFunction(m[f].editoptions.custom_value))m[f].editoptions.custom_value.call(r,b(d,c),"set",g);else throw"e1";}catch(h){"e1"===h?u.info_dialog.call(r,Q,"function 'custom_value' "+v.msg.nodefined,v.bClose):u.info_dialog.call(r,Q,h.message,v.bClose)}}e++}}),0<e&&b("#id_g",k).val(a))}}function g(){var a=v.url||w.editurl;b.each(J,function(c,d){var e=d.name,
f=z[e];"date"!==d.formatter||null!=d.formatoptions&&!0===d.formatoptions.sendFormatted||(z[e]=b.unformat.date.call(r,f,d));"clientArray"!==a&&d.editoptions&&!0===d.editoptions.NullIfEmpty&&z.hasOwnProperty(e)&&""===f&&(z[e]="null")})}function h(){var c=[!0,"",""],d={},e=w.prmNames,h,l,m,n,p,q,A=C.getInd.call(t,a),E=!1===A?null:r.rows[A];(q=t.triggerHandler("jqGridAddEditBeforeCheckValues",[b(F),M]))&&"object"===typeof q&&(z=q);A=!1===A?-1:A;b.isFunction(v.beforeCheckValues)&&(q=v.beforeCheckValues.call(r,
z,b(F),M))&&"object"===typeof q&&(z=q);for(m in z)if(z.hasOwnProperty(m)&&(q=w.iColByName[m],c=u.checkValues.call(r,z[m],m,void 0,void 0,{oldValue:"_empty"===a?null:C.getCell.call(t,a,q),newValue:z[m],cmName:m,rowid:a,cm:J[q],iCol:q,iRow:A,tr:E,td:null==E?null:E.cells[q],mode:"_empty"===a?"addForm":"editForm"}),!1===c[0]))break;g();c[0]&&(d=t.triggerHandler("jqGridAddEditClickSubmit",[v,z,M]),void 0===d&&b.isFunction(v.onclickSubmit)&&(d=v.onclickSubmit.call(r,v,z,M)||{}),c=t.triggerHandler("jqGridAddEditBeforeSubmit",
[z,b(F),M]),null==c&&(c=[!0,"",""]),c[0]&&b.isFunction(v.beforeSubmit)&&(c=v.beforeSubmit.call(r,z,b(F),M),null==c&&(c=[!0,"",""])));if(c[0]&&!v.processing){v.processing=!0;b("#sData",D).addClass(X);m=v.url||w.editurl;l=e.oper;h="clientArray"===m&&!1!==w.keyName?w.keyName:e.id;z[l]="_empty"===b.trim(z[x+"_id"])?e.addoper:e.editoper;z[l]!==e.addoper?z[h]=z[x+"_id"]:void 0===z[h]&&(z[h]=z[x+"_id"]);delete z[x+"_id"];z=b.extend(z,v.editData,d);if(!0===w.treeGrid)for(p in z[l]===e.addoper&&(n=w.selrow,
z["adjacency"===w.treeGridModel?w.treeReader.parent_id_field:"parent_id"]=n),w.treeReader)w.treeReader.hasOwnProperty(p)&&(d=w.treeReader[p],!z.hasOwnProperty(d)||z[l]===e.addoper&&"parent_id_field"===p||delete z[d]);z[h]=u.stripPref(w.idPrefix,z[h]);w.autoEncodeOnEdit&&b.each(z,function(a,c){b.isFunction(c)||(z[a]=u.oldEncodePostedData(c))});p=b.extend({url:b.isFunction(m)?m.call(r,z[h],M,z,v):m,type:b.isFunction(v.mtype)?v.mtype.call(r,M,v,z[h],z):v.mtype,data:u.serializeFeedback.call(r,b.isFunction(v.serializeEditData)?
v.serializeEditData:w.serializeEditData,"jqGridAddEditSerializeEditData",z),complete:function(a,d){b("#sData",D).removeClass(X);z[h]=b("#id_g",k).val();300<=a.status&&304!==a.status||0===a.status&&4===a.readyState?(c[0]=!1,c[1]=t.triggerHandler("jqGridAddEditErrorTextFormat",[a,M]),b.isFunction(v.errorTextFormat)?c[1]=v.errorTextFormat.call(r,a,M):c[1]=d+" Status: '"+a.statusText+"'. Error code: "+a.status):(c=t.triggerHandler("jqGridAddEditAfterSubmit",[a,z,M]),null==c&&(c=[!0,"",""]),c[0]&&b.isFunction(v.afterSubmit)&&
(c=v.afterSubmit.call(r,a,z,M),null==c&&(c=[!0,"",""])));if(!1===c[0])b("#FormError>td",k).html(c[1]),b("#FormError",k).show();else{w.autoEncodeOnEdit&&b.each(z,function(b,a){z[b]=u.oldDecodePostedData(a)});var g=[b.extend({},v.reloadGridOptions||{})];z[l]===e.addoper?(c[2]||(c[2]=u.randId()),null==z[h]||"_empty"===z[h]||z[l]===e.addoper?z[h]=c[2]:c[2]=z[h],v.reloadAfterSubmit?t.trigger("reloadGrid",g):!0===w.treeGrid?C.addChildNode.call(t,c[2],n,z):C.addRowData.call(t,c[2],z,v.addedrow),v.closeAfterAdd?
(!0!==w.treeGrid&&y.call(t,c[2]),O()):v.clearAfterAdd&&f("_empty",F)):(v.reloadAfterSubmit?(t.trigger("reloadGrid",g),v.closeAfterEdit||setTimeout(function(){y.call(t,z[h])},1E3)):!0===w.treeGrid?C.setTreeRow.call(t,z[h],z):C.setRowData.call(t,z[h],z),v.closeAfterEdit&&O());if(b.isFunction(v.afterComplete)){var m=a;setTimeout(function(){t.triggerHandler("jqGridAddEditAfterComplete",[m,z,b(F),M]);v.afterComplete.call(r,m,z,b(F),M);m=null},50)}if(v.checkOnSubmit||v.checkOnUpdate)if(b(F).data("disabled",
!1),"_empty"!==v._savedData[x+"_id"])for(var p in v._savedData)v._savedData.hasOwnProperty(p)&&z[p]&&(v._savedData[p]=z[p])}v.processing=!1;try{b(":input:visible",F)[0].focus()}catch(q){}}},u.ajaxOptions,v.ajaxEditOptions);p.url||v.useDataProxy||(b.isFunction(w.dataProxy)?v.useDataProxy=!0:(c[0]=!1,c[1]+=" "+u.errors.nourl));c[0]&&(v.useDataProxy?(d=w.dataProxy.call(r,p,"set_"+x),void 0===d&&(d=[!0,""]),!1===d[0]?(c[0]=!1,c[1]=d[1]||"Error deleting the selected row!"):(p.data.oper===e.addoper&&v.closeAfterAdd&&
O(),p.data.oper===e.editoper&&v.closeAfterEdit&&O())):"clientArray"===p.url?(v.reloadAfterSubmit=!1,z=p.data,p.complete({status:200,statusText:""},"")):b.ajax(p))}!1===c[0]&&(b("#FormError>td",k).html(c[1]),b("#FormError",k).show())}function m(b,a){var c=!1,d;for(d in b)if(b.hasOwnProperty(d)&&String(b[d])!==String(a[d])){c=!0;break}return c}function l(){var a=!0;b("#FormError",k).hide();v.checkOnUpdate&&(z={},e(),K=m(z,v._savedData))&&(b(F).data("disabled",!0),b(".confirm",H).show(),a=!1);return a}
function n(){var c=u.detectRowEditing.call(r,a);if(null!=c)if("inlineEditing"===c.mode)C.restoreRow.call(t,a);else{var c=c.savedRow,d=r.rows[c.id];C.restoreCell.call(t,c.id,c.ic);b(d.cells[c.ic]).removeClass("edit-cell "+U);b(d).addClass(U).attr({"aria-selected":"true",tabindex:"0"})}}function p(a,c){var d=c[1].length-1;0===a?b("#pData",D).addClass(V):void 0!==c[1][a-1]&&ca(b("#"+G(c[1][a-1])),V)?b("#pData",D).addClass(V):b("#pData",D).removeClass(V);a===d?b("#nData",D).addClass(V):void 0!==c[1][a+
1]&&ca(b("#"+G(c[1][a+1])),V)?b("#nData",D).addClass(V):b("#nData",D).removeClass(V)}function q(){var a=C.getDataIDs.call(t),c=b("#id_g",k).val();return[b.inArray(c,a),a]}var r=this,t=b(r),w=r.p;if(r.grid&&null!=w&&a){var x=w.id,B=C.getGridRes,y=C.setSelection,v=b.extend(!0,{top:0,left:0,width:300,datawidth:"auto",height:"auto",dataheight:"auto",drag:!0,resize:!0,url:null,mtype:"POST",clearAfterAdd:!0,closeAfterEdit:!1,reloadAfterSubmit:!0,onInitializeForm:null,beforeInitData:null,beforeShowForm:null,
...
{},c||{}),F="FrmGrid_"+x,A=F,E="TblGrid_"+x,k="#"+G(E),D=k+"_2",I={themodal:"editmod"+x,modalhead:"edithd"+x,modalcontent:"editcnt"+x,resizeAlso:F},H="#"+G(I.themodal),L=w.gBox,J=w.colModel,S=w.iColByName,pa=1,P=0,z,K,M,ba=v.commonIconClass,O=function(){u.hideModal(H,{gb:L,jqm:v.jqModal,onClose:v.onClose,removemodal:v.removemodal})},Q=B.call(t,"errors.errcap"),T=function(){var a=b.makeArray(arguments);a.unshift("");a.unshift("AddEdit");a.unshift(v);return Pa.apply(r,a)},Z=aa.call(r,"hover"),V=aa.call(r,
"disabled"),U=aa.call(r,"select"),X=aa.call(r,"active"),ja=aa.call(r,"error");b(H).remove();F="#"+G(F);"new"===a?(a="_empty",M="add",v.caption=v.addCaption):(v.caption=v.editCaption,M="edit");var ra=!0;!v.checkOnUpdate||!0!==v.jqModal&&void 0!==v.jqModal||v.modal||(ra=!1);var sa=isNaN(v.dataheight)?v.dataheight:v.dataheight+"px",Ea=isNaN(v.datawidth)?v.datawidth:v.datawidth+"px",A=b("<form name='FormPost' id='"+A+"' class='FormGrid' onSubmit='return false;' style='width:"+Ea+";overflow:auto;position:relative;height:"+
sa+";'></form>").data("disabled",!1),W=b("<table id='"+E+"' class='EditTable'><tbody></tbody></table>");b(J).each(function(){var b=this.formoptions;pa=Math.max(pa,b?b.colpos||0:0);P=Math.max(P,b?b.rowpos||0:0)});b(A).append(W);ja=b("<tr id='FormError' style='display:none'><td class='"+ja+"' colspan='"+2*pa+"'>&#160;</td></tr>");ja[0].rp=0;b(W).append(ja);ja=b("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*pa+"'>"+(v.topinfo||"&#160;")+"</td></tr>");ja[0].rp=0;b(W).append(ja);
if(T("beforeInitData",A,M)){n();sa=(ja="rtl"===w.direction?!0:!1)?"nData":"pData";Ea=ja?"pData":"nData";d(a,W,pa);var sa=ea.call(r,sa,"",xa(ba,v.prevIcon),"","left"),Ea=ea.call(r,Ea,"",xa(ba,v.nextIcon),"","right"),Fa=ea.call(r,"sData",v.bSubmit),ab=ea.call(r,"cData",v.bCancel),E="<div class='"+N.call(r,"dialog.footer")+"'><table class='EditTable' id='"+E+"_2'><tbody><tr><td colspan='2'><hr class='"+N.call(r,"dialog.hr")+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton navButton-"+
w.direction+"'>"+(ja?Ea+sa:sa+Ea)+"</td><td class='EditButton EditButton-"+w.direction+"'>"+Fa+"&#160;"+ab+"</td></tr>",E=E+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+(v.bottominfo||"&#160;")+"</td></tr>"),E=E+"</tbody></table></div>";if(0<P){var Ya=[];b.each(b(W)[0].rows,function(b,a){Ya[b]=a});Ya.sort(function(b,a){return b.rp>a.rp?1:b.rp<a.rp?-1:0});b.each(Ya,function(a,c){b("tbody",W).append(c)})}v.gbox=L;var hb=!1;!0===v.closeOnEscape&&(v.closeOnEscape=!1,hb=
!0);E=b("<div></div>").append(b("<div class='"+N.call(r,"dialog.body")+"'></div>").append(A)).append(E);u.createModal.call(r,I,E,v,w.gView,b(L)[0]);v.topinfo&&b(".tinfo",k).show();v.bottominfo&&b(".binfo",D).show();E=E=null;b(H).keydown(function(a){var c=(a.target.tagName||"").toUpperCase(),d,e;if(!0===b(F).data("disabled"))return!1;if(13===a.which&&"TEXTAREA"!==c){d=b(D).find(":focus");e=d.attr("id");if(0<d.length&&0<=b.inArray(e,["pData","nData","cData"]))return d.trigger("click"),!1;if(!0===v.savekey[0]&&
13===v.savekey[1])return b("#sData",D).trigger("click"),!1}if(!0===v.savekey[0]&&a.which===v.savekey[1]&&"TEXTAREA"!==c)return b("#sData",D).trigger("click"),!1;if(27===a.which){if(!l())return!1;hb&&O();return!1}if(!0===v.navkeys[0]){if("_empty"===b("#id_g",k).val())return!0;if(a.which===v.navkeys[1])return b("#pData",D).trigger("click"),!1;if(a.which===v.navkeys[2])return b("#nData",D).trigger("click"),!1}});v.checkOnUpdate&&(b("a.ui-jqdialog-titlebar-close span",H).removeClass("jqmClose"),b("a.ui-jqdialog-titlebar-close",
H).unbind("click").click(function(){if(!l())return!1;O();return!1}));Qa(b("#sData",D),v.saveicon,ba);Qa(b("#cData",D),v.closeicon,ba);if(v.checkOnSubmit||v.checkOnUpdate)Fa=ea.call(r,"sNew",v.bYes),Ea=ea.call(r,"nNew",v.bNo),ab=ea.call(r,"cNew",v.bExit),I=v.zIndex||999,I++,b("<div class='"+v.overlayClass+" jqgrid-overlay confirm' style='z-index:"+I+";display:none;'>&#160;</div><div class='"+N.call(r,"dialog.content","confirm ui-jqconfirm")+"' style='z-index:"+(I+1)+"'>"+v.saveData+"<br/><br/>"+Fa+
Ea+ab+"</div>").insertAfter(F),b("#sNew",H).click(function(){h();b(F).data("disabled",!1);b(".confirm",H).hide();return!1}),b("#nNew",H).click(function(){b(".confirm",H).hide();b(F).data("disabled",!1);setTimeout(function(){b(":input:visible",F)[0].focus()},0);return!1}),b("#cNew",H).click(function(){b(".confirm",H).hide();b(F).data("disabled",!1);O();return!1});T("onInitializeForm",b(F),M);"_empty"!==a&&v.viewPagerButtons?b("#pData,#nData",D).show():b("#pData,#nData",D).hide();T("beforeShowForm",
b(F),M);b(H).data("onClose",v.onClose);u.viewModal.call(r,H,{gbox:L,jqm:v.jqModal,overlay:v.overlay,modal:v.modal,overlayClass:v.overlayClass,toTop:v.toTop,onHide:function(b){b.w.remove();b.o&&b.o.remove()}});ra||b("."+G(v.overlayClass)).click(function(){if(!l())return!1;O();return!1});b(".fm-button",H).hover(function(){b(this).addClass(Z)},function(){b(this).removeClass(Z)});b("#sData",D).click(function(){z={};b("#FormError",k).hide();e();"_empty"===z[x+"_id"]?h():!0===v.checkOnSubmit?(K=m(z,v._savedData))?
(b(F).data("disabled",!0),b(".confirm",H).show()):h():h();return!1});b("#cData",D).click(function(){if(!l())return!1;O();return!1});b("#nData",D).click(function(){if(!l())return!1;b("#FormError",k).hide();var a=q();a[0]=parseInt(a[0],10);if(-1!==a[0]&&a[1][a[0]+1]){if(!T("onclickPgButtons","next",b(F),a[1][a[0]]))return!1;f(a[1][a[0]+1],F);y.call(t,a[1][a[0]+1]);T("afterclickPgButtons","next",b(F),a[1][a[0]+1]);p(a[0]+1,a)}return!1});b("#pData",D).click(function(){if(!l())return!1;b("#FormError",
k).hide();var a=q();if(-1!==a[0]&&a[1][a[0]-1]){if(!T("onclickPgButtons","prev",b(F),a[1][a[0]])||ca(b("#"+G(a[1][a[0]-1])),V))return!1;f(a[1][a[0]-1],F);y.call(t,a[1][a[0]-1]);T("afterclickPgButtons","prev",b(F),a[1][a[0]-1]);p(a[0]-1,a)}return!1});T("afterShowForm",b(F),M);ra=q();p(ra[0],ra)}}})},viewGridRow:function(a,c){return this.each(function(){function e(){!0!==q.closeOnEscape&&!0!==q.navkeys[0]||setTimeout(function(){b("#cData").focus()},0)}function d(a,c,d){var e,f,g,h=0,k,p,r=[],t=C.getInd.call(l,
a),v;v=N.call(m,"dialog.viewData","DataTD form-view-data");var w=N.call(m,"dialog.viewLabel","CaptionTD form-view-label"),x="<td class='"+w+"' width='"+q.labelswidth+"'>&#160;</td><td class='"+v+" ui-helper-reset'>&#160;</td>",z="",w="<td class='"+w+"'></td><td class='"+v+"'></td>",D=["integer","number","currency"],y=0,E=0,F,B,I;for(v=1;v<=d;v++)z+=1===v?x:w;b(A).each(function(){(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==
b.inArray(this.formatter,D)?y=Math.max(y,parseInt(this.width,10)):E=Math.max(E,parseInt(this.width,10)))});F=0!==y?y:0!==E?E:0;b(A).each(function(a){e=this.name;B=!1;p=(f=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";I="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==e&&"subgrid"!==e&&"rn"!==e&&I){k=!1===t?"":u.getDataFieldOfCell.call(m,m.rows[t],a).html();B="right"===this.align&&0!==F?!0:!1;var l=b.extend({},{rowabove:!1,rowcontent:""},
...
a.unshift("");a.unshift("Delete");a.unshift(h);return Pa.apply(e,a)},v=aa.call(e,"hover"),F=aa.call(e,"active"),A=aa.call(e,"error");b.isArray(a)||(a=[String(a)]);if(void 0!==b(w)[0]){if(!y("beforeInitData",b(l)))return;b("#DelData>td",l).text(a.join()).data("rowids",a);b("#DelError",l).hide();!0===h.processing&&(h.processing=!1,b("#dData",l).removeClass(F));y("beforeShowForm",b(l));u.viewModal.call(e,w,{gbox:x,jqm:h.jqModal,jqM:!1,overlay:h.overlay,toTop:h.toTop,modal:h.modal})}else{var E=isNaN(h.dataheight)?
h.dataheight:h.dataheight+"px",k=isNaN(h.datawidth)?h.datawidth:h.datawidth+"px",E="<div class='"+N.call(e,"dialog.body")+"'><div id='"+m+"' class='formdata' style='width:"+k+";overflow:auto;position:relative;height:"+E+";'>",E=E+"<table class='DelTable'><tbody>"+("<tr id='DelError' style='display:none'><td class='"+A+"'></td></tr>"),E=E+("<tr id='DelData' style='display:none'><td >"+a.join()+"</td></tr>"),E=E+("<tr><td class='delmsg' style='white-space:pre;'>"+h.msg+"</td></tr>"),E=E+"</tbody></table></div></div>",
A=ea.call(e,"dData",h.bSubmit),k=ea.call(e,"eData",h.bCancel),E=E+("<div class='"+N.call(e,"dialog.footer")+"'><table class='EditTable' id='"+m+"_2'><tbody><tr><td><hr class='"+N.call(e,"dialog.hr")+"' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton EditButton-"+d.direction+"'>"+A+"&#160;"+k+"</td></tr></tbody></table></div>");h.gbox=x;u.createModal.call(e,t,E,h,d.gView,b(d.gView)[0]);b("#DelData>td",l).data("rowids",a);if(!y("beforeInitData",b(E)))return;b(".fm-button",l+"_2").hover(function(){b(this).addClass(v)},
function(){b(this).removeClass(v)});Qa(b("#dData",l+"_2"),h.delicon,B);Qa(b("#eData",l+"_2"),h.cancelicon,B);b("#dData",l+"_2").click(function(){var a=[!0,""],c,k=b("#DelData>td",l),m=k.text(),t=k.data("rowids"),k={};b.isFunction(h.onclickSubmit)&&(k=h.onclickSubmit.call(e,h,m)||{});b.isFunction(h.beforeSubmit)&&(a=h.beforeSubmit.call(e,m)||a);if(a[0]&&!h.processing){h.processing=!0;q=d.prmNames;n=b.extend({},h.delData,k);r=q.oper;n[r]=q.deloper;p=q.id;m=t.slice();if(!m.length)return!1;for(c in m)m.hasOwnProperty(c)&&
...
!1}},A=aa.call(m,"hover"),E=aa.call(m,"disabled"),k=N.call(m,"navButton","ui-pg-button");if(m.grid){m.modalAlert=y;void 0===a&&(l.pager?(a=l.pager,l.toppager&&(q.cloneToTop=!0)):l.toppager&&(a=l.toppager));var D=1,I,H,L,J,S,K,P=["left","center","right"],z="<div class='"+N.call(m,"navButton","ui-pg-button "+aa.call(m,"disabled"))+"'><span class='ui-separator'></span></div>",Q=function(){ca(this,E)||b(this).addClass(A)},M=function(){b(this).removeClass(A)},ba=function(){ca(this,E)||(b.isFunction(q.addfunc)?
q.addfunc.call(m):C.editGridRow.call(n,"new",d));return!1},O=function(a,c,d){if(!ca(this,E)){var e=l.selrow;e?b.isFunction(a)?a.call(m,e):C[c].call(n,e,d):y()}return!1},W=function(){return O.call(this,q.editfunc,"editGridRow",e)},T=function(){return O.call(this,q.viewfunc,"viewGridRow",h)},Z=function(){var a;ca(this,E)||(l.multiselect?(a=l.selarrrow,0===a.length&&(a=null)):a=l.selrow,a?b.isFunction(q.delfunc)?q.delfunc.call(m,a):C.delGridRow.call(n,a,f):y());return!1},V=function(){ca(this,E)||(b.isFunction(q.searchfunc)?
q.searchfunc.call(m,g):C.searchGrid.call(n,g));return!1},U=function(){if(!ca(this,E)){b.isFunction(q.beforeRefresh)&&q.beforeRefresh.call(m);l.search=!1;l.resetsearch=!0;try{if("currentfilter"!==q.refreshstate){l.postData.filters="";try{b("#fbox_"+t).jqFilter("resetFilter")}catch(a){}b.isFunction(m.clearToolbar)&&m.clearToolbar(!1)}}catch(a){}switch(q.refreshstate){case "firstpage":n.trigger("reloadGrid",[b.extend({},q.reloadGridOptions||{},{page:1})]);break;case "current":case "currentfilter":n.trigger("reloadGrid",
...
"title"]||"",id:c||a+"_"+L}).click(d).hover(Q,M);return e};q.cloneToTop&&l.toppager&&(D=2);for(I=0;I<D;I++){v=b("<div class='ui-pg-table navtable' role='toolbar' style='float:"+("rtl"===l.direction?"right":"left")+";table-layout:auto;'></div>");0===I?(H=a,L=p,H===l.toppager&&(L+="_top",D=1)):(H=l.toppager,L=p+"_top");q.add&&X("add",d.id,ba);q.edit&&X("edit",e.id,W);q.view&&X("view",h.id,T);q.del&&X("del",f.id,Z);(q.add||q.edit||q.del||q.view)&&b(v).append(z);q.search&&(r=X("search",g.id,V),g.showOnLoad&&
...
(S=K[0].firstChild,!b(S).is("table.ui-pg-table")||0!==S.rows&&0!==S.rows[0].cells.length||K.hide()));l._nvtd&&(r>l._nvtd[0]&&(b(H+"_"+q.position,H).width(r),l._nvtd[0]=r),l._nvtd[1]=r);m.nav=!0;v.bind("keydown.jqGrid",F)}n.triggerHandler("jqGridResetFrozenHeights")}}})},navButtonAdd:function(a,c){"object"===typeof a&&(c=a,a=void 0);return this.each(function(){var e=this,d=e.p;if(e.grid){var f=b.extend({caption:"newButton",title:"",onClickButton:null,position:"last",cursor:"pointer",iconsOverText:!1},
C.getGridRes.call(b(e),"nav"),u.nav||{},d.navOptions||{},c||{}),g=aa.call(e,"hover"),h=aa.call(e,"disabled"),m=N.call(e,"navButton","ui-pg-button");if(void 0===a)if(d.pager)if(C.navButtonAdd.call(b(e),d.pager,f),d.toppager)a=d.toppager;else return;else d.toppager&&(a=d.toppager);"string"===typeof a&&0!==a.indexOf("#")&&(a="#"+G(a));var d=b(".navtable",a),l=f.commonIconClass;if(0<d.length&&!(f.id&&0<d.find("#"+G(f.id)).length)){var n=b("<div tabindex='0' role='button'></div>");"NONE"===f.buttonicon.toString().toUpperCase()?
...
b(this).triggerHandler("jqGridResetFrozenHeights",[{header:{resizeDiv:!1,resizedRows:{iRowStart:-1,iRowEnd:-1}},resizeFooter:!1,body:{resizeDiv:!0,resizedRows:{iRowStart:l,iRowEnd:h.length?h[0].rowIndex-1:-1}}}]);this.fixScrollOffsetAndhBoxPadding();b(this).triggerHandler("jqGridGroupingClickGroup",[a,p]);b.isFunction(e.onClickGroup)&&e.onClickGroup.call(this,a,p)});return!1},groupingRender:function(a,c){function e(a,c,d,e,h){var l=B[a],m,n="",p,q,t,w=0,x,A,E,F=!0;if(0!==c&&0!==B[a].idx)for(m=a;0<=
m;m--)if(B[m].idx===B[a].idx-c){l=B[m];break}a=l.cnt;for(x=void 0===h?e:0;x<v;x++){c="&#160;";m=y[x];for(p=0;p<l.summary.length;p++)if(q=l.summary[p],A=b.isArray(q.st)?q.st[d.idx]:q.st,E=b.isArray(m.summaryTpl)?m.summaryTpl[d.idx]:m.summaryTpl||"{0}",q.nm===m.name){"string"===typeof A&&"avg"===A.toLowerCase()&&(q.sd&&q.vd?q.v/=q.vd:q.v&&0<a&&(q.v/=a));try{q.groupCount=l.cnt,q.groupIndex=l.dataIndex,q.groupValue=l.value,t=f.formatter("",q.v,x,q)}catch(C){t=q.v}c=u.format(E,t);break}q=p=!1;void 0!==
...
"gridRow","jqgroup ui-row-"+g.direction),E=C.getGuiStyles.call(f,"gridRow","jqfoot ui-row-"+g.direction);b.each(y,function(b,a){var c;for(c=0;c<x;c++)if(r.groupField[c]===a.name){l[c]=b;break}});t.reverse();b.each(B,function(k,D){if(r._locgr&&!(D.startRow+D.cnt>(F-1)*c&&D.startRow<F*c))return!0;h++;q=g.id+"ghead_"+D.idx;p=q+"_"+k;n="<span style='cursor:pointer;margin-"+("rtl"===g.direction?"right:":"left:")+12*D.idx+"px;' class='"+r.commonIconClass+" "+w+"' onclick=\"jQuery('#"+u.jqID(g.id).replace("\\",
"\\\\")+"').jqGrid('groupingToggle','"+p+"', this);return false;\"></span>";try{b.isArray(r.formatDisplayField)&&b.isFunction(r.formatDisplayField[D.idx])?(D.displayValue=r.formatDisplayField[D.idx].call(f,D.displayValue,D.value,y[l[D.idx]],D.idx,r),m=D.displayValue):m=f.formatter(p,D.displayValue,l[D.idx],D.value)}catch(C){m=D.displayValue}d+="<tr id='"+p+"' data-jqgrouplevel='"+D.idx+"' "+(r.groupCollapse&&0<D.idx?"style='display:none;' ":"")+"role='row' class='"+A+" "+q+"'>";var I=b.isFunction(r.groupText[D.idx])?
r.groupText[D.idx].call(f,m,D.cnt,D.summary):u.template(r.groupText[D.idx],m,D.cnt,D.summary),H=1,L,J,G;G=0;J=x-1===D.idx;"string"!==typeof I&&"number"!==typeof I&&(I=m);"header"===r.groupSummaryPos[D.idx]?(H=1,"cb"!==y[0].name&&"cb"!==y[1].name||H++,"subgrid"!==y[0].name&&"subgrid"!==y[1].name||H++,d+=e(k,0,D,H,n+"<span class='cell-wrapper'>"+I+"</span>")):d+="<td role='gridcell' style='padding-left:"+12*D.idx+"px;' colspan='"+v+"'>"+n+I+"</td>";d+="</tr>";if(J){I=B[k+1];J=D.startRow;H=void 0!==
I?I.startRow:B[k].startRow+B[k].cnt;r._locgr&&(G=(F-1)*c,G>D.startRow&&(J=G));for(;J<H&&a[J-G];J++)d+=a[J-G].join("");if("header"!==r.groupSummaryPos[D.idx]){if(void 0!==I){for(L=0;L<r.groupField.length&&I.dataIndex!==r.groupField[L];L++);h=r.groupField.length-L}for(G=0;G<h;G++)t[G]&&(d+="<tr data-jqfootlevel='"+(D.idx-G)+(r.groupCollapse&&(0<D.idx-G||!r.showSummaryOnHide)?"' style='display:none;'":"'")+" role='row' class='"+E+"'>",d+=e(k,G,B[D.idx-G],0),d+="</tr>");h=L}}});this.unbind("jqGridShowHideCol.groupingRender").bind("jqGridShowHideCol.groupingRender",
...
n));return this.each(function(){var c=this,d=b(c),e=c.p,f=0,g=null,h={},l=e.colModel,m=e.prmNames;if(c.grid){var n=b.extend(!0,{keys:!1,oneditfunc:null,successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,beforeEditRow:null,mtype:"POST",focusField:!0},u.inlineEdit,e.inlineEditing||{},p),q=d.jqGrid("getInd",a,!0),k=n.focusField,D="object"===typeof k&&null!=k?b(k.target||k).closest("tr.jqgrow>td")[0]:null;if(!1!==q&&(n.extraparam[m.oper]===
...
g),b.isFunction(h)&&(n.afterrestorefunc=h),b.isFunction(m)&&(n.beforeSaveRow=m));var l=function(b){return q.jqGrid("getGridRes",b)},n=b.extend(!0,{successfunc:null,url:null,extraparam:{},aftersavefunc:null,errorfunc:null,afterrestorefunc:null,restoreAfterError:!0,beforeSaveRow:null,ajaxSaveOptions:{},serializeSaveData:null,mtype:"POST",saveui:"enable",savetext:l("defaults.savetext")||"Saving..."},u.inlineEdit,r.inlineEditing||{},n),w={},x={},B={},y,v,F,A;F=q.jqGrid("getInd",a,!0);var E=b(F);y=r.prmNames;
var k=l("errors.errcap"),D=l("edit.bClose"),I;if(!1!==F&&(l=n.extraparam[y.oper]===y.addoper?"add":"edit",Va.call(p,n,"beforeSaveRow",n,a,l)&&(y=E.attr("editable"),n.url=n.url||r.editurl,I="clientArray"!==n.url,"1"===y)))if(u.enumEditableCells.call(p,F,E.hasClass("jqgrid-new-row")?"add":"edit",function(c){var d=c.cm,e=d.formatter,f=d.editoptions||{},g=d.formatoptions||{},h={},k=(b.jgrid.detectRowEditing.call(p,a)||{}).savedRow,l=u.getEditedValue.call(p,b(c.dataElement),d,h,c.editable);"select"===
d.edittype&&"select"!==d.formatter&&(x[d.name]=h.text);A=u.checkValues.call(p,l,c.iCol,void 0,void 0,b.extend(c,{oldValue:null!=k?k[d.name]:null,newValue:l,oldRowData:k}));if(!1===A[0])return!1;"date"===e&&!0!==g.sendFormatted&&(l=b.unformat.date.call(p,l,d));I&&!0===f.NullIfEmpty&&""===l&&(l="null");w[d.name]=l}),!1===A[0])try{var H=q.jqGrid("getGridRowById",a),C=u.findPos(H);t.call(p,k,A[1],D,{left:C[0],top:C[1]+b(H).outerHeight()})}catch(J){alert(A[1])}else if(H=a,y=r.prmNames,C=!1===r.keyName?
y.id:r.keyName,w&&(w[y.oper]=y.editoper,void 0===w[C]||""===w[C]?w[C]=a:F.id!==r.idPrefix+w[C]&&(F=u.stripPref(r.idPrefix,a),void 0!==r._index[F]&&(r._index[w[C]]=r._index[F],delete r._index[F]),a=r.idPrefix+w[C],E.attr("id",a),r.selrow===H&&(r.selrow=a),b.isArray(r.selarrrow)&&(F=b.inArray(H,r.selarrrow),0<=F&&(r.selarrrow[F]=a)),r.multiselect&&(F="jqg_"+r.id+"_"+a,E.find("input.cbox").attr("id",F).attr("name",F))),w=b.extend({},w,r.inlineData||{},n.extraparam)),I)q.jqGrid("progressBar",{method:"show",
...
{method:"hide",loadtype:n.saveui,htmlcontent:n.savetext});if((300>c.status||304===c.status)&&(0!==c.status||4!==c.readyState)){var e,f;f=q.triggerHandler("jqGridInlineSuccessSaveRow",[c,a,n]);b.isArray(f)||(f=[!0,w]);f[0]&&b.isFunction(n.successfunc)&&(f=n.successfunc.call(p,c));b.isArray(f)?(e=f[0],w=f[1]||w):e=f;if(!0===e){r.autoEncodeOnEdit&&b.each(w,function(b,a){w[b]=u.oldDecodePostedData(a)});w=b.extend({},w,x);q.jqGrid("setRowData",a,w);E.attr("editable","0");for(e=0;e<r.savedRow.length;e++)if(String(r.savedRow[e].id)===
String(a)){v=e;break}0<=v&&r.savedRow.splice(v,1);Ca.call(p,n.aftersavefunc,"jqGridInlineAfterSaveRow",a,c,w,n);E.removeClass("jqgrid-new-row").unbind("keydown")}else Ca.call(p,n.errorfunc,"jqGridInlineErrorSaveRow",a,c,d,null,n),!0===n.restoreAfterError&&q.jqGrid("restoreRow",a,n.afterrestorefunc)}},error:function(c,d,e){b("#lui_"+u.jqID(r.id)).hide();q.triggerHandler("jqGridInlineErrorSaveRow",[a,c,d,e,n]);if(b.isFunction(n.errorfunc))n.errorfunc.call(p,a,c,d,e);else{c=c.responseText||c.statusText;
try{t.call(p,k,'<div class="'+aa.call(p,"error")+'">'+c+"</div>",D,{buttonalign:"right"})}catch(f){alert(c)}}!0===n.restoreAfterError&&q.jqGrid("restoreRow",a,n.afterrestorefunc)}},u.ajaxOptions,r.ajaxRowOptions,n.ajaxSaveOptions||{}));else{w=b.extend({},w,x);F=q.jqGrid("setRowData",a,w);E.attr("editable","0");for(l=0;l<r.savedRow.length;l++)if(String(r.savedRow[l].id)===String(H)){v=l;break}0<=v&&r.savedRow.splice(v,1);Ca.call(p,n.aftersavefunc,"jqGridInlineAfterSaveRow",a,F,w,n);E.removeClass("jqgrid-new-row").unbind("keydown")}}},
restoreRow:function(a,c){var e=b.makeArray(arguments).slice(1),d={};"object"===b.type(e[0])?d=e[0]:b.isFunction(c)&&(d.afterrestorefunc=c);return this.each(function(){var c=this,e=b(c),h=c.p,m=-1,l={},n;if(c.grid){var p=b.extend(!0,{},u.inlineEdit,h.inlineEditing||{},d),q=e.jqGrid("getInd",a,!0);if(!1!==q&&Va.call(c,p,"beforeCancelRow",p,a)){for(n=0;n<h.savedRow.length;n++)if(String(h.savedRow[n].id)===String(a)){m=n;break}if(0<=m){if(b.isFunction(b.fn.datepicker))try{b("input.hasDatepicker","#"+
...
(c=a,a=void 0);return this.each(function(){var e=this,d=b(e),f=e.p;if(this.grid&&null!=f){var g,h=a===f.toppager?f.idSel+"_top":f.idSel,m=a===f.toppager?f.id+"_top":f.id,l=aa.call(e,"disabled"),n=b.extend(!0,{edit:!0,editicon:"ui-icon-pencil",add:!0,addicon:"ui-icon-plus",save:!0,saveicon:"ui-icon-disk",cancel:!0,cancelicon:"ui-icon-cancel",commonIconClass:"ui-icon",iconsOverText:!1,addParams:{addRowParams:{extraparam:{}}},editParams:{},restoreAfterSelect:!0},d.jqGrid("getGridRes","nav"),u.nav||{},
...
groupSummary:[],groupSummaryPos:[]},h={grouping:!0,groupingView:g},m=b.extend({totals:!1,useColSpanStyle:!1,trimByCollect:!0,skipSortByX:!1,skipSortByY:!1,caseSensitive:!1,footerTotals:!1,groupSummary:!0,groupSummaryPos:"header",frozenStaticCols:!1,defaultFormatting:!0,data:a},c||{}),l,n,p,q=a.length,r,t,w,x,B,y,v=m.xDimension,F=m.yDimension,A=m.aggregates,E,q=m.totalText||m.totals||m.rowTotals||m.totalHeader,k,D=d(v)?v.length:0;x=d(F)?F.length:0;var C=d(A)?A.length:0,H=x-(1===C?1:0),G=[],J=[],K=
[],d=[],N=Array(C),P=Array(x),z,Q,M,W,O,U,T,Z,V,aa,X;n=function(c,d,e){c=new oa(m.trimByCollect,m.caseSensitive,d,c);b.isFunction(e)&&(c.compareVectorsEx=e);c.createDataIndex(a);return c};var ca=function(a,c,d,f,g){var k,h;switch(a){case 1:k=F[f].totalText||"{0} {1} {2}";h="y"+g+"t"+f;break;case 2:k=m.totalText||"{0}";h="t";break;default:k=1<C?c.label||"{0}":X.getItem(g)[f],h="y"+g}a=b.extend({},c,{name:h+(1<C?"a"+d:""),label:b.isFunction(k)?k.call(e,2===a?{aggregate:c,iAggregate:d,pivotOptions:m}:
{yIndex:X.getItem(g),aggregate:c,iAggregate:d,yLevel:f,pivotOptions:m}):u.template.apply(e,2===a?[k,c.aggregator,c.member,d]:[k,c.aggregator,c.member,X.getItem(g)[f],f])});delete a.member;delete a.aggregator;return a};B=function(a,b,c){var d,e;for(d=0;d<C;d++)e=A[d],void 0===e.template&&void 0===e.formatter&&m.defaultFormatting&&(e.template="count"===e.aggregator?"integer":"number"),K.push(ca(a,e,d,b,c))};z=function(a,c,d){var f,g,k,h;for(f=H-1;f>=c;f--)if(J[f]){for(g=0;g<=f;g++)V=G[g].groupHeaders,
V[V.length-1].numberOfColumns+=C;r=F[f];k=r.totalHeader;h=r.headerOnTop;for(g=f+1;g<=H-1;g++)G[g].groupHeaders.push({titleText:h&&g===f+1||!h&&g===H-1?b.isFunction(k)?k.call(e,d,f):u.template.call(e,k||"",d[f],f):"",startColumnName:"y"+(a-1)+"t"+f+(1===C?"":"a0"),numberOfColumns:C})}};var ea=function(a){a=new na("count"===A[a].aggregator?"sum":A[a].aggregator,e,c);a.groupInfo={iRows:[],rows:[],ys:[],iYs:[]};return a},fa=function(){var a,b;for(a=H-1;0<=a;a--)if(J[a])for(null==P[a]&&(P[a]=Array(C)),
b=0;b<C;b++)P[a][b]=ea(b)},ga=function(a,b,c,d){var e,f=X.getIndexOfDifferences(b,c),g,k;if(null!==c)for(f=Math.max(f,0),e=H-1;e>=f;e--)g="y"+a+"t"+e+(1<C?"a"+d:""),J[e]&&void 0===T[g]&&(k=P[e][d],k.getResult(T,g),T.pivotInfos[g]={colType:1,iA:d,a:A[d],level:e,iRows:k.groupInfo.iRows,rows:k.groupInfo.rows,ys:k.groupInfo.ys,iYs:k.groupInfo.iYs},b!==c&&(P[e][d]=ea(d)))},ia=function(c,d,e,f,g,k,h){var l;if(c!==d)for(d=H-1;0<=d;d--)J[d]&&(l=P[d][f],l.calc(g[e.member],e.member,g,k,a),l=l.groupInfo,0>b.inArray(h,
l.iYs)&&(l.iYs.push(h),l.ys.push(c)),0>b.inArray(k,l.iRows)&&(l.iRows.push(k),l.rows.push(g)))};if(0===D||0===C)throw"xDimension or aggregates options are not set!";aa=n(v,m.skipSortByX,m.compareVectorsByX);X=n(F,m.skipSortByY,m.compareVectorsByY);c.xIndex=aa;c.yIndex=X;for(n=0;n<D;n++)p=v[n],t={name:"x"+n,label:null!=p.label?b.isFunction(p.label)?p.label.call(e,p,n,m):p.label:p.dataName,frozen:m.frozenStaticCols},n<D-1&&(g.groupField.push(t.name),g.groupSummary.push(m.groupSummary),g.groupSummaryPos.push(m.groupSummaryPos)),
t=b.extend(t,p),delete t.dataName,delete t.footerText,K.push(t);2>D&&(h.grouping=!1);h.sortname=K[D-1].name;g.hideFirstGroupCol=!0;for(n=0;n<x;n++)r=F[n],J.push(r.totals||r.rowTotals||r.totalText||r.totalHeader?!0:!1);Z=X.getItem(0);B(0,x-1,0);g=X.getIndexLength();for(t=1;t<g;t++){M=X.getItem(t);n=X.getIndexOfDifferences(M,Z);for(p=H-1;p>=n;p--)J[p]&&B(1,p,t-1);Z=M;B(0,x-1,t)}for(n=H-1;0<=n;n--)J[n]&&B(1,n,g-1);q&&B(2);Z=X.getItem(0);for(p=0;p<H;p++)G.push({useColSpanStyle:m.useColSpanStyle,groupHeaders:[{titleText:Z[p],
startColumnName:1===C?"y0":"y0a0",numberOfColumns:C}]});for(t=1;t<g;t++){M=X.getItem(t);n=X.getIndexOfDifferences(M,Z);z(t,n,Z);for(p=H-1;p>=n;p--)G[p].groupHeaders.push({titleText:M[p],startColumnName:"y"+t+(1===C?"":"a0"),numberOfColumns:C});for(p=0;p<n;p++)V=G[p].groupHeaders,V[V.length-1].numberOfColumns+=C;Z=M}z(g,0,Z);if(q)for(n=0;n<H;n++)G[n].groupHeaders.push({titleText:n<H-1?"":m.totalHeader||"",startColumnName:"t"+(1===C?"":"a0"),numberOfColumns:C});z=aa.getIndexLength();for(x=0;x<z;x++){p=
aa.getItem(x);B={iX:x,x:p};T={pivotInfos:B};for(n=0;n<D;n++)T["x"+n]=p[n];Q=aa.getIndexesOfSourceData(x);if(q)for(p=0;p<C;p++)N[p]=ea(p);Z=null;fa();for(t=0;t<g;t++){M=X.getItem(t);W=X.getIndexesOfSourceData(t);for(p=0;p<C;p++){null!==Z&&ga(t-1,M,Z,p);O=[];for(n=0;n<W.length;n++)w=W[n],0<=b.inArray(w,Q)&&O.push(w);if(0<O.length){y=Array(O.length);U=A[p];E=new na(U.aggregator,e,c);for(w=0;w<O.length;w++)n=O[w],l=a[n],y[w]=l,E.calc(l[U.member],U.member,l,n,a),q&&(k=N[p],k.calc(l[U.member],U.member,
l,n,a),k=k.groupInfo,0>b.inArray(n,k.iYs)&&(k.iYs.push(t),k.ys.push(M)),0>b.inArray(n,k.iRows)&&(k.iRows.push(n),k.rows.push(l))),ia(M,Z,U,p,l,n,t);l="y"+t+(1===C?"":"a"+p);E.getResult(T,l);B[l]={colType:0,iY:t,y:M,iA:p,a:U,iRows:O,rows:y}}}Z=M}if(null!==Z)for(p=0;p<C;p++)ga(g-1,Z,Z,p);if(q)for(p=0;p<C;p++)l="t"+(1===C?"":"a"+p),k=N[p],k.getResult(T,l),k=k.groupInfo,B[l]={colType:2,iA:p,a:A[p],iRows:k.iRows,rows:k.rows,iYs:k.iYs,ys:k.ys};d.push(T)}if(m.footerTotals||m.colTotals){q=d.length;for(n=
0;n<D;n++)f["x"+n]=v[n].footerText||"";for(n=D;n<K.length;n++){l=K[n].name;E=new na(m.footerAggregator||"sum",e,c);for(w=0;w<q;w++)T=d[w],E.calc(T[l],l,T,w,d);E.getResult(f,l)}}c.colHeaders=G;return{colModel:K,options:c,rows:d,groupOptions:h,groupHeaders:G,summary:f}},jqPivot:function(a,c,e,d){return this.each(function(){function f(){var d=m.pivotSetup.call(h,a,c),f=d.groupHeaders,p=d.summary,q=0,r;for(r in p)p.hasOwnProperty(r)&&q++;p=0<q?!0:!1;q=d.groupOptions.groupingView;r=u.from.call(g,d.rows);
...
0;t<f.length;t++)f[t]&&f[t].groupHeaders.length&&m.setGroupHeaders.call(h,f[t]);c.frozenStaticCols&&m.setFrozenColumns.call(h)}var g=this,h=b(g),m=b.fn.jqGrid;"string"===typeof a?b.ajax(b.extend({url:a,dataType:"json",success:function(b){a=u.getAccessor(b,d&&d.reader?d.reader:"rows");f()}},d||{})):f()})}});var vb=function(){var a=b.makeArray(arguments);a[0]="subGrid"+a[0].charAt(0).toUpperCase()+a[0].substring(1);a.unshift("");a.unshift("");a.unshift(this.p);return u.feedback.apply(this,a)},db=function(a,
...
v=h.treeReader.parent_id_field,F=h.treeReader.left_field,A=h.treeReader.right_field,E=h.treeReader.loaded;void 0===d&&(d=!1);if(null==a){r=h.data.length-1;if(0<=r)for(;0<=r;)l=Math.max(l,parseInt(h.data[r][h.localReader.id],10)),r--;a=l+1}var k=m.call(f,c);w=!1;if(void 0===c||null===c||""===c)t=c=null,l="last",q=h.tree_root_level,r=h.data.length+1;else{l="after";n=h._index[c];p=h.data[n];c=p[h.localReader.id];r=m.call(f,c);q=parseInt(p[y],10)+1;var D=C.getFullTreeNode.call(f,p);if(D.length){var G,
H,K;for(G=0;G<D.length;G++)K=D[G][h.localReader.id],H=m.call(f,K),H>r&&(r=H,t=K)}r++;p[x]&&(w=!0,p[B]=!0,b(g.rows[k]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(h.treeIcons.leaf+" tree-leaf").addClass(h.treeIcons.commonIconClass).addClass(h.treeIcons.minus+" tree-minus"),h.data[n][x]=!1,p[E]=!0)}m=r+1;void 0===e[B]&&(e[B]=!1);void 0===e[E]&&(e[E]=!1);e[y]=q;void 0===e[x]&&(e[x]=!0);"adjacency"===h.treeGridModel&&(e[v]=
...
e);m&&e.w.jqmAddClose(b(m,e.w));mb(e)})):m&&e.w.jqmAddClose(b(m,e.w));g.toTop&&e.o&&(d=e.w.parent().offset(),f=parseFloat(e.w.css("left")||0),h=parseFloat(e.w.css("top")||0),e.w.before('<span id="jqmP'+e.w[0]._jqm+'"></span>').insertAfter(e.o),e.w.css({top:d.top+h,left:d.left+f}));if(g.onShow)g.onShow(e);else e.w.show();mb(e);return!1},close:function(a){a=ga[a];if(!a.a)return!1;a.a=!1;wa[0]&&(wa.pop(),wa[0]||yb("unbind"));a.c.toTop&&a.o&&b("#jqmP"+a.w[0]._jqm).after(a.w).remove();if(a.c.onHide)a.c.onHide(a);
...
{}));g.target&&(h="target="+n(g.target));f=n(g.baseLinkUrl)+n(g.showAction);m=g.idName?encodeURIComponent(n(g.idName))+"="+encodeURIComponent(n(g.rowId)||c.rowId):"";l=n(g.addParam);"object"===typeof l&&null!==l&&(l=(""!==m?"&":"")+b.param(l));f+=m||l?"?"+m+l:"";""===f&&(f=n(g.hrefDefaultValue));return"string"===typeof a||U.isNumber(a)||b.isFunction(g.cellValue)?"<a "+h+" href='"+f+"'>"+(b.isFunction(g.cellValue)?n(g.cellValue):a)+"</a>":ma(a,g)};K.showlink.getCellBuilder=function(a){var c={baseLinkUrl:a.baseLinkUrl,
...
cm:d,cmName:d.name,cellValue:b(this).text(),a:this,event:e})};if(null!=d.formatoptions&&b.isFunction(d.formatoptions.onClick))for(f=0;f<h;f++)m=g[f],b(m).hasClass("jqgrow")&&(m=m.cells[a],d.autoResizable&&null!=m&&b(m.firstChild).hasClass(e.autoResizing.wrapperClassName)&&(m=m.firstChild),null!=m&&b(m.firstChild).bind("click",l))};var Sa=function(a,b){a=b.prefix?b.prefix+a:a;return b.suffix?a+b.suffix:a},nb=function(a,c,e){var d=c.colModel;c=b.extend({},c[e]);null!=d&&(c=b.extend({},c,d.formatoptions||
...
q[r].split(h),2<m.length&&(m[1]=b.map(m,p).join(h)),t=b.trim(m[0]),d.defaultValue===t&&(f=m[1]),l)-1<b.inArray(t,n)&&e.push(m[1]);else if(t===b.trim(a)){e=[m[1]];break}}else U.isObject(g)&&(f=g[d.defaultValue],e=l?b.map(n,function(a){return g[a]}):[void 0===g[a]?"":g[a]])}a=e.join(", ");return""!==a?a:void 0!==d.defaultValue?f:ma(a,d)};K.select.getCellBuilder=function(a){a=a.colModel;var c=K.defaultFormat,e=b.extend({},a.editoptions||{},a.formatoptions||{}),d=e.value;a=e.separator||":";var f=e.delimiter||
